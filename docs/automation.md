...
| `matic_robot_plan_finished` | One managed plan run ended; includes `run_id`, `outcome`, `reason_code`, `cause`, safe trigger/service labels, terminal activity, and aggregate verified room counts |
