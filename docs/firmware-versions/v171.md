...
status: initial BLE credential issuance and authenticated reads verified with the 0.3.4 candidate; controls pending<br>
first_observed_pacific: 2026-08-09<br>
integration_version: 0.3.4 candidate (0.3.3 affected release)<br>
...
- The 0.3.4 candidate requests the same active sweep and then accepts a
  ...
  completed. Release 0.3.3 is the affected preceding version.
