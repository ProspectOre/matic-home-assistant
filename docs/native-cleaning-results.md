...
Use room results to build completion notifications and last-cleaned dashboards.
...
credits only verified completed rooms. Older saved history is not rewritten.
