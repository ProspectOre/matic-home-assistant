...
`;var a3=Symbol.for(""),R7=L=>{if(L?.r===a3)return L?._$litStatic$},H1=L=>({_$litStatic$:L,r:a3});var i3=new Map,t5=L=>(C,...H)=>{let V=H.length,e,r,t=[],M=[],o,i=0,a=!1;for(;i<V;){for(o=C[i];i<V&&(r=H[i],(e=R7(r))!==void 0);)o+=e+C[++i],a=!0;i!==V&&M.push(r),t.push(o),i++}if(i===V&&t.push(C[V]),a){let n=t.join("$$lit$$");(C=i3.get(n))===void 0&&(t.raw=t,i3.set(n,C=t)),H=M}return L(C,...H)},x=t5(p),J4=t5(L3),C9=t5(e3);var n3=import.meta.url.match(/\/matic_robot\/[^/]+-([a-f0-9]{12})\/map-studio-v4(?:\/|$)/u)?.[1]??"dev",I1=n3==="dev"?"":`-${n3}`,A1=`matic-map-canvas-v4${I1}`,W1=`matic-precision-controls-v4${I1}`,g1=`matic-map-workflow-v4${I1}`,s1=`matic-map-shell-v4${I1}`,M5=`matic-map-panel-v0-4-0${I1}`;var V1=w`
.ms-btn, .ms-row {
...
><path d=${L}></path></svg>`;var E7=["outline","paint","erase","pan"],A2=(L,C,H)=>{let{draw:V}=L,e=`${V.brushMeters.toFixed(2)} m`;return p`
    ...
    >
      ${E7.map(r=>p`
        ...
        >${Z(r==="outline"?l2:r==="paint"?H0:r==="erase"?L0:e0)}<span class="ms-btn__label">${r==="outline"?C.t("v4_zone_tool","Zone"):r==="paint"?C.t("area_paint","Paint"):r==="erase"?C.t("area_erase","Erase"):C.t("move_map","Move map")}</span></button>
      `)}
      <button
        class="ms-btn"
        type="button"
  ...
  `]}#C;#H;#V;#r;#e;#L;#o;#i;#a;#A;#u;#M(H,V,e){return E(this.localize,H,V,e)}connectedCallback(){super.connectedCallback(),this.#l()}firstUpdated(){let H=this.renderRoot.querySelector(".map-root"),V=this.renderRoot.querySelector(".scene-canvas"),e=this.renderRoot.querySelector(".overlay-canvas");!H||!V||!e||(this.#H=new c2(V,e,{onViewport:()=>{this.#u.cancel(),this.requestUpdate()},onCamera:(r,t,M)=>{this.#s({type:"set-camera",view:this.state.workflow==="draw"?"top":this.state.view,camera:{yaw:r.yaw,pitch:r.pitch,zoom:t/100,targetX:r.targetX,targetZ:r.targetZ}}),this.state.workflow==="draw"&&t!==this.state.draw.zoomPercent&&this.#s({type:"set-zoom",value:t,...M?{originX:M.xPercent,originY:M.yPercent}:{}})},onRoom:r=>this.#s({type:"toggle-room",roomId:r}),onProblem:()=>this.#S("renderer-problem")}),this.#V=new s2(H,this.#H,{state:()=>this.state,onOutlinePoint:r=>this.#u.addPoint(r),onCircles:(r,t,M,o)=>this.#s({type:"set-draft-circles",circles:r,record:t,...M?{previous:M,previousOutline:o??null}:{},...!t&&M?{outline:o??null}:{}}),onRoom:r=>this.#s({type:"toggle-room",roomId:r})}),this.#H.setState(this.state),this.#h())}disconnectedCallback(){this.#m(),this.#u.cancel(),this.#V?.dispose(),this.#V=null,this.#H?.dispose(),this.#H=null,super.disconnectedCallback()}updated(H){this.#e&&(this.#e=!1,this.renderRoot.querySelector(".navigation-help button")?.focus()),H.has("state")&&(this.#H?.setState(this.state),this.state.draw.tool==="outline"&&this.requestUpdate())}#y(){let H=this.renderRoot?.querySelector(".map-root");!H||!this.#H||this.#H.setPalette(m0(H))}#h(){this.#n(),this.#i=window.requestAnimationFrame(()=>{this.#i=null,this.#a=window.setTimeout(()=>{this.#a=null,this.#y()},0)})}#n(){this.#i!==null&&window.cancelAnimationFrame(this.#i),this.#a!==null&&window.clearTimeout(this.#a),this.#i=null,this.#a=null}#v;#l(){if(!(typeof document>"u"||this.#L)&&(this.#L=new MutationObserver(this.#v),this.#L.observe(document.documentElement,{attributes:!0,attributeFilter:["style","class"]}),typeof window.matchMedia=="function")){this.#o=[window.matchMedia("(prefers-color-scheme: dark)"),window.matchMedia("(forced-colors: active)")];for(let H of this.#o)H.addEventListener("change",this.#v)}}#m(){this.#n(),this.#L?.disconnect(),this.#L=null;for(let H of this.#o)H.removeEventListener("change",this.#v);this.#o=[]}#s(H){this.dispatchEvent(new CustomEvent(e1,{detail:H,bubbles:!0,composed:!0}))}#S(H){this.dispatchEvent(new CustomEvent(v2,{detail:{id:H},bubbles:!0,composed:!0}))}#t(H){this.#C=H.currentTarget,this.#r=!this.#r,this.#e=this.#r,this.requestUpdate()}#x(){if(!this.#r)return;this.#r=!1,this.requestUpdate();let H=this.#C;H?.isConnected&&H.focus()}#f(){for(let H of this.state.selection.roomIds)this.#s({type:"toggle-room",roomId:H})}#d(H,V){this.#H?.orbitBy(H,V)}#p(H){if(!d2(H)&&!(H.ctrlKey||H.metaKey||H.altKey)&&H.key==="Escape"){if(H.preventDefault(),this.#r){this.#x();return}this.#s({type:"dismiss-top-layer"});return}}rendererDiagnostics(){return this.#H?.diagnostics()??null}canvasIdentity(){return{scene:this.renderRoot.querySelector(".scene-canvas"),overlay:this.renderRoot.querySelector(".overlay-canvas")}}#c(){return this.state.host.connected?this.state.host.administrator?this.state.host.robotCount===0?{title:this.#M("v4_no_robot","No Matic robot set up"),detail:this.#M("v4_no_robot_detail","Set up a robot before opening its map.")}:this.state.dataMode==="live"&&this.state.floor.readOnly&&this.state.map.available&&this.state.notice?{title:this.#M("v4_saved_map_read_only_title","Saved map is read only"),detail:this.state.notice.text}:this.state.dataMode==="history"?!this.state.map.available&&this.state.resources.scene.status==="loading"?{title:this.#M("v4_loading_saved_map","Loading saved map"),detail:this.#M("v4_loading_saved_map_detail","This read-only snapshot is still preparing.")}:this.state.map.available?null:{title:this.#M("v4_saved_map_unavailable","Saved map unavailable"),detail:this.#M("v4_saved_map_unavailable_detail","Choose another snapshot or return to the live map.")}:this.state.host.robotConnected?this.state.coherence==="verifying"||this.state.coherence==="booting"?{title:this.#M("v4_locating_map","Locating the current map"),detail:this.#M("v4_locating_map_detail","Map controls will return after the floor is verified.")}:!this.state.map.available&&this.state.resources.scene.status==="loading"?{title:this.#M("v4_loading_verified_map","Loading the verified map"),detail:this.#M("v4_loading_verified_map_detail","The current floor is verified. The private scene is still preparing.")}:this.state.map.available?this.state.activity==="problem"?{title:this.#M("v4_robot_attention","Robot needs attention"),detail:this.#M("v4_robot_attention_detail","Check the robot before starting another task.")}:null:{title:this.#M("v4_map_unavailable","Map unavailable"),detail:this.#M("v4_map_unavailable_detail","The private scene is not ready. No map data is shown until it is verified.")}:{title:this.#M("v4_robot_offline","Robot offline"),detail:this.#M("v4_robot_offline_detail","The last verified map stays read only and has no live position.")}:{title:this.#M("v4_admin_required","Administrator access required"),detail:this.#M("v4_private_map_hidden","Private map data is hidden.")}:{title:this.#M("v4_reconnecting","Reconnecting"),detail:this.#M("v4_reconnecting_detail","The verified map is read only until Home Assistant reconnects.")}}#Z(H,V){let e=this.state,r=this.narrow,t=e.workflow==="draw",M=this.#M("v4_how_to_move","How to move the map"),o=H&&!t,i=o&&!r&&e.view==="top",a=o&&e.view==="three",n=!V,A=!r&&!t;return p`
    ...
    `}#k(H){let V=this.state;if(!H)return s;if(V.workflow==="draw"&&!this.narrow)return p`
        <div class="map-dock ms-surface ms-surface--floating" data-map-control>
          ${A2(V,{intent:r=>this.#s(r),openBrush:()=>this.#s({type:"set-precision-open",value:!V.precisionOpen}),t:(r,t)=>this.#M(r,t)},"row")}
        </div>
...
`]}#C(H,V){return E(this.localize,H,V)}#H(H){this.dispatchEvent(new CustomEvent(e1,{detail:H,bubbles:!0,composed:!0}))}#V(H){let V=H.currentTarget.valueAsNumber;Number.isFinite(V)&&this.#H({type:"set-brush",value:V})}render(){let{draw:H}=this.state;return p`
    ...
    `}};customElements.get(W1)||customElements.define(W1,d5);var Z0={ATTRIBUTE:1,CHILD:2,PROPERTY:3,BOOLEAN_ATTRIBUTE:4,EVENT:5,ELEMENT:6},S0=L=>(...C)=>({_$litDirective$:L,values:C}),u2=class{constructor(C){}get _$AU(){return this._$AM._$AU}_$AT(C,H,V){this._$Ct=C,this._$AM=H,this._$Ci=V}_$AS(C,H){return this.update(C,H)}update(C,H){return this.render(...H)}};var{I:j7}=M3,f0=L=>L;var g0=()=>document.createComment(""),w1=(L,C,H)=>{let V=L._$AA.parentNode,e=C===void 0?L._$AB:C._$AA;if(H===void 0){let r=V.insertBefore(g0(),e),t=V.insertBefore(g0(),e);H=new j7(r,t,L,L.options)}else{let r=H._$AB.nextSibling,t=H._$AM,M=t!==L;if(M){let o;H._$AQ?.(L),H._$AM=L,H._$AP!==void 0&&(o=L._$AU)!==t._$AU&&H._$AP(o)}if(r!==e||M){let o=H._$AA;for(;o!==r;){let i=f0(o).nextSibling;f0(V).insertBefore(o,e),o=i}}}return H},r1=(L,C,H=L)=>(L._$AI(C,H),L),Y7={},y0=(L,C=Y7)=>L._$AH=C,b0=L=>L._$AH,x2=L=>{L._$AR(),L._$AA.remove()};var O0=(L,C,H)=>{let V=new Map;for(let e=C;e<=H;e++)V.set(L[e],e);return V},w0=S0(class extends u2{constructor(L){if(super(L),L.type!==Z0.CHILD)throw Error("repeat() can only be used in text expressions")}dt(L,C,H){let V;H===void 0?H=C:C!==void 0&&(V=C);let e=[],r=[],t=0;for(let M of L)e[t]=V?V(M,t):t,r[t]=H(M,t),t++;return{values:r,keys:e}}render(L,C,H){return this.dt(L,C,H).values}update(L,[C,H,V]){let e=b0(L),{values:r,keys:t}=this.dt(C,H,V);if(!Array.isArray(e))return this.ut=t,r;let M=this.ut??=[],o=[],i,a,n=0,A=e.length-1,l=0,d=r.length-1;for(;n<=A&&l<=d;)if(e[n]===null)n++;else if(e[A]===null)A--;else if(M[n]===t[l])o[l]=r1(e[n],r[l]),n++,l++;else if(M[A]===t[d])o[d]=r1(e[A],r[d]),A--,d--;else if(M[n]===t[d])o[d]=r1(e[n],r[d]),w1(L,o[d+1],e[n]),n++,d--;else if(M[A]===t[l])o[l]=r1(e[A],r[l]),w1(L,e[n],e[A]),A--,l++;else if(i===void 0&&(i=O0(t,l,d),a=O0(M,n,A)),i.has(M[n]))if(i.has(M[A])){let m=a.get(t[l]),c=m!==void 0?e[m]:null;if(c===null){let h=w1(L,e[n]);r1(h,r[l]),o[l]=h}else o[l]=r1(c,r[l]),w1(L,e[n],c),e[m]=null;l++}else x2(e[A]),A--;else x2(e[n]),n++;for(;l<=d;){let m=w1(L,o[d+1]);r1(m,r[l]),o[l++]=m}for(;n<=A;){let m=e[n++];m!==null&&x2(m)}return this.ut=t,y0(L,o),j}});var p5=["vacuum","mop","vacuum_and_mop"],m5=["quick","standard","heavy_duty"],N=L=>L.currentTarget.value,k0=L=>L.currentTarget.checked,c5=class extends k{constructor(){super(...arguments);this.state=g();this._copyStatus="idle"}static{this.properties={state:{attribute:!1},localize:{attribute:!1},_copyStatus:{state:!0}}}static{this.styles=[$,I,V1,w`
...
`),e=typeof navigator>"u"?void 0:navigator.clipboard;if(e&&typeof e.writeText=="function")try{await e.writeText(V),this.#t("copied");return}catch{}this.#t(this.#x(V,H instanceof HTMLElement?H:null)?"copied":"failed")}#d(){let H=this.#S(),V=this._copyStatus==="copied"?this.#H("v4_copied","Copied"):this._copyStatus==="failed"?this.#H("v4_copy_failed","The summary could not be copied. Select the text to copy it by hand."):"";return p`
    ...
    `}#z(H,V,e,r,t=!1){return x`
      ...
      >
        ...
        <span class="ms-row__trail">${Z(n2)}</span>
      </button>
    ...
    `}#L1(H,V){let e=(S,O,y)=>this.#C(S,O,y),r=this.#z(e("v4_map_history","Map history"),a5,()=>this.#l("history"),e("v4_map_history_detail","Saved maps are floor-scoped and read only.")),t=this.#z(e("v4_map_diagnostics","Map diagnostics"),i0,()=>this.#l("support"),e("v4_map_support_detail","Private geometry is never included.")),{host:M}=H;if(!M.connected)return this.#W(e("v4_reconnecting_title","Reconnecting to Home Assistant"),e("v4_reconnecting_body","The last verified map stays read-only until the connection returns."));if(!M.administrator)return this.#W(e("v4_admin_title","Administrator access required"),e("v4_admin_body","Ask a Home Assistant administrator to open this map."));if(M.robotCount===0)return this.#W(e("v4_no_robot_title","No Matic robot set up"),e("v4_no_robot_body","Add the Matic integration to see a map here."),x`<a class="ms-btn ms-btn--secondary" href="/config/integrations/integration/matic_robot">${e("v4_open_integration","Open the Matic integration")}</a>`);if(!M.robotConnected)return x`
      ...
      <h3 class="shelf-heading">${e("v4_more","Map tools")}</h3>
      <div class="shelf">
        ${this.#z(e("v4_custom_areas","Clean a custom area"),l2,()=>this.#l("draw"),f,o)}
        ${r}
    ...
    ></${_0}>`}#Y(H,V){let e=T0(H,this.localize);return x`
      <div class="panel-heading">
        ${H.workflow!=="none"?x`
          ...
          >${Z(a2)}<span class="ms-btn__label">${H.workflow==="plan"?this.#C("v4_your_plans","Your plans"):this.#C("v4_all_tasks","All tasks")}</span></button>
        `:s}
            ...
            <div class="canvas">
              ...
              ${!V&&c?x`
                <div class="precision-popover">
                  <${h2} compact .state=${H} .localize=${this.localize}></${h2}>
                </div>
              `:s}
            </div>
              ...
              ${V?x`
                ...
                ${m?x`
                  <div class="sheet-tools">
                    ${A2(H,{intent:h=>this.#n(h),openBrush:()=>this.#_(),t:(h,f)=>this.#C(h,f)},"grid")}
                    ${c?x`
                      <div class="precision-popover">
                        <${h2} compact inline .state=${H} .localize=${this.localize}></${h2}>
                      </div>
                    `:s}
                  </div>
                `:s}
...
`]}static{this.properties={hass:{attribute:!1},narrow:{type:Boolean},route:{attribute:!1},panel:{attribute:!1},_workspace:{state:!0},_classic:{state:!0},entryOverride:{state:!0}}}#C;#H;#V;#r;#e;#L;#o;#i;connectedCallback(){super.connectedCallback(),this._classic=t7()==="v3",this.#r=this.#H.subscribe(H=>{this._workspace=H,this.#u(H)}),this._classic||this.#a()}disconnectedCallback(){this.#r?.(),this.#r=null,this.#A(),super.disconnectedCallback()}#a(){if(!this.#L&&(this.#V=this.#C.project(this.hass,this.panel,this.entryOverride),this.#e=new f2(()=>this.hass),this.#L=new P2(this.#H,this.#e),this.#o=new _2(this.#H),this.#o.start(),this.#V)){this.#L.sync(this.#V,this.panel);let{host:H}=this.#V;H.connected&&H.administrator&&H.robotCount>0&&this.#L.refreshCatalog(this.#H.value.selection.floorId==="current")}}#A(){this.#o?.dispose(),this.#o=null,this.#L?.dispose(),this.#L=null,this.#e=null}#u(H){if(!this.#L)return;let V={version:4,view:H.view,appearance:H.appearance,labels:H.labelsVisible,quality:H.quality,cameras:H.cameras},e=JSON.stringify(V);e!==this.#i&&(this.#i=e,this.#L.schedulePreferences(V))}willUpdate(H){if(H.has("hass")||H.has("panel")||H.has("entryOverride")){let V=this.#C.project(this.hass,this.panel,this.entryOverride);if(V!==this.#V){this.#V=V;let e=V.host.connected?V.host.robotCount===0?"unavailable":V.host.administrator?"verifying":"blocked":"degraded";this.#H.replace({...this.#H.value,coherence:e,activity:V.activity,batteryPercent:V.batteryPercent,host:V.host,fullMap:V.host.administrator&&V.host.robotCount>0&&this.#H.value.fullMap,robotLabel:V.robotLabel,robots:V.robots,locale:V.language})}this._classic||this.#L?.sync(V,this.panel)}H.has("narrow")&&this.#H.value.narrowHint!==this.narrow&&this.#H.dispatch({type:"set-narrow-hint",value:this.narrow})}#M(H){if(!v1(H.detail))return;H.stopPropagation();let V=H.detail;if(V.type==="dismiss-top-layer"||V.type==="exit-full-map"){this.#o?.dismissTop()||this.#H.dispatch(V);return}if(V.type==="open-workflow"&&V.workflow!=="none"){this.#L?.openWorkflow(V.workflow);return}if(V.type==="set-floor"){this.#L?.selectFloor(V.floorId);return}if(V.type==="select-entry"){if(!this._workspace.robots.some(e=>e.entryId===V.entryId))return;this.entryOverride=V.entryId;return}if(V.type==="set-history"){this.#L?.selectHistory(V.historyId);return}if(V.type==="select-plan"){this.#L?.selectPlan(V.planId);return}if(V.type==="select-area"){this.#L?.selectArea(V.areaId),V.workflow==="areaReview"&&this.#L?.openWorkflow("areaReview");return}this.#H.dispatch(V)}#y(H){if(H.stopPropagation(),typeof H.detail?.id=="string"){if(H.detail.id==="use-classic"){f5("v3")&&(this.#A(),this._classic=!0);return}this.#L?.executeAction(H.detail.id),this.dispatchEvent(new CustomEvent("matic-map-v4-action-requested",{detail:{id:H.detail.id},bubbles:!0,composed:!0}))}}#h(){f5("v4")&&(this._classic=!1,this.#a(),this.requestUpdate())}updated(){if(!this._classic)return;let H=this.renderRoot.querySelector("matic-map-panel-v0-3-1");H&&(H.hass=this.hass,H.narrow=this.narrow,H.route=this.route,H.panel=this.panel)}getWorkspaceSnapshot(){return this.#H.value}render(){return this._classic?x`
      ...
      ></${l7}>
    `}};customElements.get(M5)||customElements.define(M5,y5);export{X1 as CoherenceMachine,T1 as DRAW_BRUSH_MAX_METERS,c1 as DRAW_BRUSH_MIN_METERS,q2 as GALLERY_SCENARIOS,C2 as HassAdapter,$2 as MAP_PIXELS_PER_METER_AT_100,k5 as MAP_ZOOM_MAX,_1 as MAP_ZOOM_MIN,M5 as MATIC_MAP_PANEL_TAG,y5 as MaticMapPanelV4,x5 as MaticMapStudioGalleryV4,h1 as WorkspaceStore,g4 as brushCursorPixels,_ as canEditCoordinates,I2 as canReadFloorResources,W2 as canResumeMotion,Y1 as canShowExactPose,Z1 as canShowLiveMap,x1 as canStartMotion,N2 as canStopMotion,y4 as commandState,Q2 as createGalleryState,j1 as draftForPlan,g as initialWorkspaceState,v1 as isWorkspaceIntent,R5 as mapScale,m7 as normalizeBrush,P5 as normalizeZoom,c7 as reduceWorkspace,U2 as selectPrimaryAction,B5 as selectStopSecondaryAction};
