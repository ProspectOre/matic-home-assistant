...
`;var f5=Symbol.for(""),n0=L=>{if(L?.r===f5)return L?._$litStatic$},N=L=>({_$litStatic$:L,r:f5});var h5=new Map,b2=L=>(C,...H)=>{let V=H.length,e,r,M=[],t=[],i,o=0,a=!1;for(;o<V;){for(i=C[o];o<V&&(r=H[o],(e=n0(r))!==void 0);)i+=e+C[++o],a=!0;o!==V&&t.push(r),M.push(i),o++}if(o===V&&M.push(C[V]),a){let A=M.join("$$lit$$");(C=h5.get(A))===void 0&&(M.raw=M,h5.set(A,C=M)),H=t}return L(C,...H)},p=b2(y),v7=b2(x5),c7=b2(u5);var g5=import.meta.url.match(/\/matic_robot\/[^/]+-([a-f0-9]{12})\/map-studio-v4(?:\/|$)/u)?.[1]??"dev",O1=g5==="dev"?"":`-${g5}`,w1=`matic-map-canvas-v4${O1}`,e1=`matic-precision-controls-v4${O1}`,s1=`matic-map-workflow-v4${O1}`,r1=`matic-map-shell-v4${O1}`,O2=`matic-map-panel-v0-4-0${O1}`;var G1=h`
.ms-btn, .ms-row {
...
.map-root { border: 1px solid CanvasText; }
  ...
  `]}#C;#H;#r;#V;#e(H,V,e){return P(this.localize,H,V,e)}firstUpdated(){let H=this.renderRoot.querySelector(".map-root"),V=this.renderRoot.querySelector(".scene-canvas"),e=this.renderRoot.querySelector(".overlay-canvas");!H||!V||!e||(this.#H=new q1(V,e,{onCamera:(r,M,t)=>{this.#L({type:"set-camera",view:this.state.workflow==="draw"?"top":this.state.view,camera:{yaw:r.yaw,pitch:r.pitch,zoom:M/100,targetX:r.targetX,targetZ:r.targetZ}}),this.state.workflow==="draw"&&M!==this.state.draw.zoomPercent&&this.#L({type:"set-zoom",value:M,...t?{originX:t.xPercent,originY:t.yPercent}:{}})},onRoom:r=>this.#L({type:"toggle-room",roomId:r}),onProblem:()=>this.#o("renderer-problem")}),this.#r=new Q1(H,this.#H,{state:()=>this.state,onCircles:(r,M,t)=>this.#L({type:"set-draft-circles",circles:r,record:M,...t?{previous:t}:{}}),onRoom:r=>this.#L({type:"toggle-room",roomId:r})}),this.#H.setState(this.state))}disconnectedCallback(){this.#r?.dispose(),this.#r=null,this.#H?.dispose(),this.#H=null,super.disconnectedCallback()}updated(H){if(!H.has("state"))return;H.get("state")?.fullMap&&!this.state.fullMap&&this.#C&&this.#C.focus(),this.#H?.setState(this.state)}#L(H){this.dispatchEvent(new CustomEvent(t1,{detail:H,bubbles:!0,composed:!0}))}#o(H){this.dispatchEvent(new CustomEvent(K1,{detail:{id:H},bubbles:!0,composed:!0}))}#a(H){this.#C=H.currentTarget,this.#L({type:this.state.fullMap?"exit-full-map":"enter-full-map"})}#A(H,V){this.#H?.orbitBy(H,V)}#t(H){if(!(H.ctrlKey||H.metaKey||H.altKey)&&H.key==="Escape"){if(H.preventDefault(),this.#V){this.#V=!1,this.requestUpdate();return}this.#L({type:"dismiss-top-layer"});return}}rendererDiagnostics(){return this.#H?.diagnostics()??null}canvasIdentity(){return{scene:this.renderRoot.querySelector(".scene-canvas"),overlay:this.renderRoot.querySelector(".overlay-canvas")}}#p(){return this.state.host.connected?this.state.host.administrator?this.state.host.robotCount===0?{title:this.#e("v4_no_robot","No Matic robot set up"),detail:this.#e("v4_no_robot_detail","Set up a robot before opening its map.")}:this.state.host.robotConnected?this.state.coherence==="verifying"||this.state.coherence==="booting"?{title:this.#e("v4_locating_map","Locating the current map"),detail:this.#e("v4_locating_map_detail","Map controls will return after the floor is verified.")}:!this.state.map.available&&this.state.resources.scene.status==="loading"?{title:this.#e("v4_loading_verified_map","Loading the verified map"),detail:this.#e("v4_loading_verified_map_detail","The current floor is verified. The private scene is still preparing.")}:this.state.map.available?this.state.activity==="problem"?{title:this.#e("v4_robot_attention","Robot needs attention"),detail:this.#e("v4_robot_attention_detail","Check the robot before starting another task.")}:null:{title:this.#e("v4_map_unavailable","Map unavailable"),detail:this.#e("v4_map_unavailable_detail","The private scene is not ready. No map data is shown until it is verified.")}:{title:this.#e("v4_robot_offline","Robot offline"),detail:this.#e("v4_robot_offline_detail","The last verified map stays read only and has no live position.")}:{title:this.#e("v4_admin_required","Administrator access required"),detail:this.#e("v4_private_map_hidden","Private map data is hidden.")}:{title:this.#e("v4_reconnecting","Reconnecting"),detail:this.#e("v4_reconnecting_detail","The verified map is read only until Home Assistant reconnects.")}}render(){let H=this.state,V=Y2(H),e=this.#p(),r=H.map.available&&(n1(H)||H.dataMode==="history"),M=H.workflow==="draw"&&r,t=H.coherence==="verifying"||H.coherence==="booting";return y`
    ...
    `}};customElements.get(w1)||customElements.define(w1,k2);var P2=class extends f{constructor(){super(...arguments);this.state=O();this.compact=!1}static{this.properties={state:{attribute:!1},localize:{attribute:!1},compact:{type:Boolean,reflect:!0}}}static{this.styles=[F,E,G1,h`
...
`]}#C(H,V){return P(this.localize,H,V)}#H(H){this.dispatchEvent(new CustomEvent(t1,{detail:H,bubbles:!0,composed:!0}))}#r(H,V){let e=H.currentTarget.valueAsNumber;Number.isFinite(e)&&this.#H(V==="zoom"?{type:"set-zoom",value:e}:{type:"set-brush",value:e})}render(){let{draw:H}=this.state;return y`
  ...
  `]}#C(H,V,e){return P(this.localize,H,V,e)}#H(H){return H==="vacuum"?this.#C("vacuum","Vacuum"):H==="mop"?this.#C("mop","Mop"):this.#C("vacuum_and_mop","Vacuum + mop")}#r(H){return H==="quick"?this.#C("quick","Quick"):H==="standard"?this.#C("standard","Optimal"):this.#C("heavy_duty","Heavy Duty")}#V(H){this.dispatchEvent(new CustomEvent(t1,{detail:H,bubbles:!0,composed:!0}))}#e(){return this.state.notice?p`
      <div class="notice" data-tone=${this.state.notice.tone} role=${this.state.notice.tone==="error"?"alert":"status"}>
        ${this.state.notice.text}
      </div>
    `:l}#L(H,V,e){return H==="loading"||H==="idle"?p`<div class="loading" role="status">${this.#C("map_loading","Loading\u2026")}</div>`:H==="error"?p`<div class="problem" role="alert">${this.#C("v4_workspace_unavailable","This workspace is unavailable right now.")} ${V==="request-failed"?this.#C("v4_try_again","Try again shortly."):this.#C("v4_return_live_retry","Return to the live map and retry.")}</div>`:H==="empty"?p`<div class="empty">${this.#C("v4_nothing_saved","Nothing saved yet.")}</div>`:e}#o(){let H=this.state.resources.plans;return this.#L(H.status,H.problem,p`
      <div class="stack">
        <div class="list" role="group" aria-label=${this.#C("v4_rooms_to_clean","Rooms to clean")}>
          ${(H.value?.rooms||[]).map(V=>{let e=this.state.selection.roomIds.includes(V.roomId);return p`
              <div class="room" data-selected=${String(e)}>
                <label class="room-choice">
                  ...
                  ${e?p`<small>${this.#C("v4_room_ready","Ready")}</small>`:l}
                </label>
    ...
    `)}#a(H,V){return p`
      <div class="split room-settings">
        <label class="field">${this.#C("v4_cleaning_system","Cleaning system")}
          <select
          ...
          >${B2.map(e=>p`<option value=${e} ?selected=${e===V.cleaningMode}>${this.#H(e)}</option>`)}</select>
        </label>
        <label class="field">${this.#C("cleaning_mode","Cleaning mode")}
          <select
          ...
          >${T2.map(e=>p`<option value=${e} ?selected=${e===V.coverageSetting}>${this.#r(e)}</option>`)}</select>
        </label>
      </div>
    `}#A(H){let V=this.state.planDraft.rooms,r=V.find(M=>M.roomId===H)?V.filter(M=>M.roomId!==H):[...V,{roomId:H,cleaningMode:"vacuum",coverageSetting:"standard"}];this.#V({type:"patch-plan-draft",patch:{rooms:r}})}#t(H,V){let e=this.state.planDraft.rooms.map((r,M)=>M===H?{...r,...V}:r);this.#V({type:"patch-plan-draft",patch:{rooms:e}})}#p(H,V){let e=H+V,r=[...this.state.planDraft.rooms];if(e<0||e>=r.length)return;let[M]=r.splice(H,1);M&&(r.splice(e,0,M),this.#V({type:"patch-plan-draft",patch:{rooms:r}}))}#v(){let H=this.state.resources.plans,V=H.value,e=this.state.planDraft,r=e.rooms.map(i=>({room:i,label:V?.rooms.find(o=>o.roomId===i.roomId)?.name||"Room",selected:!0})),M=(V?.rooms||[]).filter(i=>!e.rooms.some(o=>o.roomId===i.roomId)).map(i=>({room:{roomId:i.roomId,cleaningMode:"vacuum",coverageSetting:"standard"},label:i.name,selected:!1})),t=[...r,...M];return this.#L(H.status,H.problem,p`
      <div class="stack">
        <div class="split">
          <label class="field">${this.#C("v4_saved_plan","Saved plan")}
            <select
            ...
            >
              ...
              ${(V?.plans||[]).map(i=>p`<option value=${i.id}>${i.name}</option>`)}
            </select>
          </label>
          <button class="list-button" type="button" @click=${()=>this.#V({type:"select-plan",planId:null})}>\uff0b ${this.#C("plan_new","New plan")}</button>
        </div>
        <label class="field">${this.#C("plan_name","Plan name")}
          <input
            maxlength="128"
            autocomplete="off"
            .value=${e.name}
        ...
        <div class="split">
          <label class="field">${this.#C("plan_run_behavior","Run order")}
            <select
              .value=${e.runBehavior}
        ...
        <div class="plan-options" aria-label=${this.#C("v4_completion_options","Completion options")}>
          ...
          ${e.finishCurrentRoom?p`<label class="field">${this.#C("plan_threshold","Finish threshold")} \u00b7 ${e.finishCurrentRoomThreshold}%<input type="range" min="0" max="100" step="5" .value=${String(e.finishCurrentRoomThreshold)} @input=${i=>this.#V({type:"patch-plan-draft",patch:{finishCurrentRoomThreshold:Number(D(i))}})}></label>`:l}
        </div>
        <div class="list" aria-label=${this.#C("plan_rooms","Plan rooms")}>
          ${t.map(({room:i,label:o,selected:a})=>{let A=a?e.rooms.findIndex(n=>n.roomId===i.roomId):-1;return p`
              <div class="room plan-room" data-selected=${String(a)}>
                <label class="room-choice">
                  ...
                  ${a?p`
                    <span>
                      <button class="icon-button" type="button" aria-label=${this.#C("move_room_up","Move {room} earlier",{room:o})} ?disabled=${A===0} @click=${n=>{n.preventDefault(),this.#p(A,-1)}}>\u2191</button>
                      <button class="icon-button" type="button" aria-label=${this.#C("move_room_down","Move {room} later",{room:o})} ?disabled=${A===e.rooms.length-1} @click=${n=>{n.preventDefault(),this.#p(A,1)}}>\u2193</button>
                    </span>
                  `:l}
                </label>
                ${a?p`
                  <div class="split room-settings">
                    <label class="field">${this.#C("v4_cleaning_system","Cleaning system")}
                      <select .value=${i.cleaningMode} @change=${n=>this.#t(A,{cleaningMode:D(n)})}>${B2.map(n=>p`<option value=${n} ?selected=${n===i.cleaningMode}>${this.#H(n)}</option>`)}</select>
                    </label>
                    <label class="field">${this.#C("cleaning_mode","Cleaning mode")}
                      <select .value=${i.coverageSetting} @change=${n=>this.#t(A,{coverageSetting:D(n)})}>${T2.map(n=>p`<option value=${n} ?selected=${n===i.coverageSetting}>${this.#r(n)}</option>`)}</select>
                    </label>
                  </div>
                `:l}
              </div>
    ...
    `)}#u(){let H=this.state.resources.areas;return p`
      <div class="stack">
        ...
        ${this.#L(H.status,H.problem,p`
          <div class="list" aria-label=${this.#C("area_workspace_title","Saved custom areas")}>
            <button class="list-button" type="button" @click=${()=>this.#V({type:"select-area",areaId:null})}>\uff0b ${this.#C("area_new","New outline")}</button>
            ${(H.value?.areas||[]).map(V=>p`
              <button class="list-button" type="button" @click=${()=>{this.#V({type:"select-area",areaId:V.id}),this.#V({type:"open-workflow",workflow:"areaReview"})}}>
                <span>${V.name}</span>
    ...
    `}#n(){let H=this.state.areaDraft,V=H.canRebind||H.status==="review",e=H.status==="stale"||H.status==="unknown";return p`
      <div class="stack">
        ${V?p`<div class="notice" data-tone="warning" role="status">${this.#C("area_review_required","Review the saved outline on this current map, then confirm it.")}</div>`:l}
        ${e?p`<div class="problem" role="alert">${this.#C("area_redraw_required","This outline no longer matches the current room map. Redraw it before saving.")}</div>`:l}
        <label class="field">${this.#C("area_name","Area name")}
          <input maxlength="128" autocomplete="off" .value=${H.name} @input=${r=>this.#V({type:"patch-area-draft",patch:{name:D(r)}})}>
        </label>
        <div class="split">
          <label class="field">${this.#C("v4_cleaning_system","Cleaning system")}
            <select .value=${H.cleaningMode} @change=${r=>this.#V({type:"patch-area-draft",patch:{cleaningMode:D(r)}})}>${B2.map(r=>p`<option value=${r} ?selected=${r===H.cleaningMode}>${this.#H(r)}</option>`)}</select>
          </label>
          <label class="field">${this.#C("cleaning_mode","Cleaning mode")}
            <select .value=${H.coverageSetting} @change=${r=>this.#V({type:"patch-area-draft",patch:{coverageSetting:D(r)}})}>${T2.map(r=>p`<option value=${r} ?selected=${r===H.coverageSetting}>${this.#r(r)}</option>`)}</select>
          </label>
        </div>
        ...
        <div class="toolbar">
          <button type="button" @click=${()=>this.#V({type:"open-workflow",workflow:"draw"})}>${this.#C("v4_edit_outline","Edit outline")}</button>
          ${H.id?p`
            <button
              class="danger"
              type="button"
    ...
    `}#Z(){let H=this.state.resources.history,V=H.value,e=V?.floors.find(t=>t.id===this.state.selection.floorId)||V?.floors.find(t=>t.active)||V?.floors[0],r=e?.snapshots||[],M=this.state.selection.historyId?Math.max(0,r.findIndex(t=>t.id===this.state.selection.historyId)):r.length;return this.#L(H.status,H.problem,p`
      <div class="stack">
        ...
        `:l}
        <div class="timeline">
          <label class="field">${this.#C("map_timeline_label","Map timeline")}
            <input
              type="range"
              min="0"
              max=${String(r.length)}
          ...
          <div class="list">
            <button class="snapshot" type="button" aria-current=${String(!this.state.selection.historyId)} @click=${()=>this.#V({type:"set-history",historyId:null})}><span>${this.#C("map_timeline_live_action","Live")}</span><small>${this.#C("v4_current","Current")}</small></button>
            ${r.map((t,i)=>p`
              <button class="snapshot" type="button" aria-current=${String(t.id===this.state.selection.historyId)} @click=${()=>this.#V({type:"set-history",historyId:t.id})}>
                <span>${this.#s(t.createdAt)}</span><small>${i+1} of ${r.length}</small>
              </button>
            `)}
          </div>
        </div>
    ...
    `)}#s(H){try{return new Intl.DateTimeFormat(this.state.locale,{dateStyle:"medium",timeStyle:"short"}).format(new Date(H))}catch{return this.#C("v4_saved_map","Saved map")}}#i(){let H=this.state.resources.entry;return p`
      <div class="stack">
  ...
  `]}#C;#H;connectedCallback(){super.connectedCallback(),this.#H=this.#C.subscribe(H=>{this._workspace=H})}disconnectedCallback(){this.#H?.(),this.#H=null,super.disconnectedCallback()}willUpdate(H){H.has("scenario")?this.#C.replace({...d2(this.scenario),narrowHint:this.narrow}):H.has("narrow")&&this.#C.dispatch({type:"set-narrow-hint",value:this.narrow})}setScenario(H){l2.includes(H)&&(this.scenario=H)}getWorkspaceSnapshot(){return structuredClone(this.#C.value)}replaceWorkspaceState(H){this.#C.replace(structuredClone(H))}#r(H){E1(H.detail)&&(H.stopPropagation(),this.#C.dispatch(H.detail))}render(){return p`
      ${this.controls?p`
    ...
    `}};customElements.get("matic-map-studio-gallery-v0-4-0")||customElements.define("matic-map-studio-gallery-v0-4-0",E2);var p3="/api/matic_robot/slam_entries";var s=class extends Error{constructor(C){super(C),this.name="ContractError",this.code=C}},R=(L,C)=>{if(!L||typeof L!="object"||Array.isArray(L))throw new s(C);return L},g=(L,C,H)=>{if(typeof L!="string")throw new s(H);let V=L.trim();if(!V||Array.from(V).length>C||/[\u0000-\u001f\u007f]/u.test(V))throw new s(H);return V},f0=L=>{if(L==null||L==="")return null;try{return g(L,128,"invalid-floor-label")}catch{return null}},v1=(L,C,H,V)=>{if(typeof L!="number"||!Number.isFinite(L)||L<C||L>H)throw new s(V);return L},W=(L,C,H,V)=>{let e=v1(L,C,H,V);if(!Number.isInteger(e))throw new s(V);return e},D2=(L,C)=>L==null?null:W(L,1,C,"invalid-floor-ordinal"),S=(L,C)=>{if(typeof L!="boolean")throw new s(C);return L},g0=(L,C)=>L===null?null:S(L,C),s3=L=>{if(L==null)return null;let C=g(L,64,"invalid-map-session-key");if(!/^[0-9a-f]{64}$/u.test(C))throw new s("invalid-map-session-key");return C},y0=L=>{if(L==null)return null;if(L==="bootstrap_empty"||L==="map_session_unverified"||L==="floor_plan_unavailable"||L==="floor_plan_mismatch")return L;throw new s("invalid-map-block-reason")},b0=L=>{if(L===void 0)return"not_started";if(L==="not_started"||L==="running"||L==="complete"||L==="partial"||L==="failed")return L;throw new s("invalid-bootstrap-state")},K=(L,C)=>{let H=g(L,512,C);if(!H.startsWith("/")||H.startsWith("//")||H.includes("\\"))throw new s(C);return H},O0=L=>{let C=typeof L.map_health=="string"?L.map_health.toLowerCase():"",H=typeof L.stream_state=="string"?L.stream_state.toLowerCase():"",V=typeof L.invalid_tiles=="number"?L.invalid_tiles:0;return C.includes("error")||C.includes("fail")||C.includes("degrad")||V>0?"problem":L.map_truncated===!0||C.includes("truncat")||C.includes("limit")?"limited":L.map_complete===!0?"ready":H.includes("connect")||H.includes("collect")||H.includes("run")?"building":"unknown"},m3=L=>{let C=R(L,"invalid-catalog");if(!Array.isArray(C.entries)||C.entries.length>64)throw new s("invalid-catalog-entries");return C.entries.map(H=>{let V=R(H,"invalid-catalog-entry"),e=W(V.map_revision,0,Number.MAX_SAFE_INTEGER,"invalid-map-revision");return{entryId:g(V.entry_id,128,"invalid-entry-id"),sceneUrl:K(V.scene_url,"invalid-scene-url"),deltaUrl:V.delta_url===void 0||V.delta_url===null?null:K(V.delta_url,"invalid-delta-url"),poseUrl:K(V.pose_url,"invalid-pose-url"),historyUrl:K(V.history_url,"invalid-history-url"),areasUrl:K(V.areas_url,"invalid-areas-url"),plansUrl:K(V.plans_url,"invalid-plans-url"),mapRevision:e,mapFloorCoherent:S(V.map_floor_coherent,"invalid-floor-coherence"),mapSessionVerified:S(V.map_session_verified,"invalid-session-state"),mapSessionKey:s3(V.map_session_key),mapBlockReason:y0(V.map_block_reason),runnerLocked:S(V.runner_locked,"invalid-runner-lock"),stopSettlePending:S(V.stop_settle_pending,"invalid-stop-settle"),activePlan:S(V.active_plan,"invalid-active-plan"),nativeReconciliationPending:S(V.native_reconciliation_pending,"invalid-native-reconciliation"),nativeSessionActive:g0(V.native_session_active,"invalid-native-session"),mapComplete:S(V.map_complete,"invalid-map-complete"),mapTruncated:S(V.map_truncated,"invalid-map-truncated"),selectedFloorOrdinal:D2(V.selected_floor_ordinal,128),mapFloorOrdinal:D2(V.map_floor_ordinal,128),historyCount:W(V.history_count,0,12,"invalid-history-count"),historyFloorCount:W(V.history_floor_count,0,128,"invalid-floor-count"),health:O0(V),streamFailures:W(V.stream_failures,0,Number.MAX_SAFE_INTEGER,"invalid-stream-failures"),bootstrapState:b0(V.bootstrap_state),bootstrapPhotoSeen:V.bootstrap_photo_seen===void 0?!1:S(V.bootstrap_photo_seen,"invalid-bootstrap-photo"),bootstrapStructureSeen:V.bootstrap_structure_seen===void 0?!1:S(V.bootstrap_structure_seen,"invalid-bootstrap-structure"),bootstrapFailures:V.bootstrap_failures===void 0?0:W(V.bootstrap_failures,0,2,"invalid-bootstrap-failures")}})},v3=(L,C)=>{if(!Array.isArray(L)||L.length!==2)throw new s(C);return[v1(L[0],-1e6,1e6,C),v1(L[1],-1e6,1e6,C)]},w0=(L,C)=>{if(!Array.isArray(L)||L.length<3||L.length>8192)throw new s(C);return L.map(H=>v3(H,C))},c3=(L,C)=>{if(!Array.isArray(L)||L.length>256)throw new s("invalid-rooms");return L.map(H=>{let V=R(H,"invalid-room");return{roomId:g(V.room_id,128,"invalid-room-id"),name:g(V.name,128,"invalid-room-name"),boundary:C?w0(V.boundary,"invalid-room-boundary"):[]}})},k0=L=>{let C=R(L,"invalid-history-snapshot"),H=g(C.created_at,64,"invalid-history-time");if(!Number.isFinite(Date.parse(H)))throw new s("invalid-history-time");return{id:g(C.id,128,"invalid-history-id"),createdAt:H,revision:W(C.revision,0,Number.MAX_SAFE_INTEGER,"invalid-history-revision"),pointCount:W(C.point_count,1,15e5,"invalid-history-points"),sceneUrl:K(C.scene_url,"invalid-history-scene-url")}},x3=L=>{let C=R(L,"invalid-history");if(!Array.isArray(C.floors)||C.floors.length<1||C.floors.length>128)throw new s("invalid-history-floors");return{entryId:g(C.entry_id,128,"invalid-history-entry"),liveAvailable:S(C.live_available,"invalid-history-live"),floors:C.floors.map(H=>{let V=R(H,"invalid-history-floor");if(!Array.isArray(V.snapshots)||V.snapshots.length>12)throw new s("invalid-history-snapshots");return{id:g(V.id,128,"invalid-history-floor-id"),active:S(V.active,"invalid-history-floor-active"),readOnly:S(V.read_only,"invalid-history-floor-read-only"),liveAvailable:V.live_available===void 0?!1:S(V.live_available,"invalid-history-floor-live"),label:f0(V.label),ordinal:V.ordinal===void 0?null:D2(V.ordinal,128),snapshots:V.snapshots.map(k0)}})}},u3=L=>{if(L==="vacuum"||L==="mop"||L==="vacuum_and_mop")return L;throw new s("invalid-cleaning-mode")},Z3=L=>{if(L==="quick"||L==="standard"||L==="heavy_duty")return L;throw new s("invalid-coverage-setting")},P0=L=>{let C=R(L,"invalid-area-circle");return{x:v1(C.x,-1e6,1e6,"invalid-area-circle"),y:v1(C.y,-1e6,1e6,"invalid-area-circle"),radius:v1(C.radius,.05,2.5,"invalid-area-circle")}},B0=L=>L==="current"||L==="review"||L==="stale"?L:"unknown",S3=L=>{let C=R(L,"invalid-areas");if(!Array.isArray(C.areas)||C.areas.length>256)throw new s("invalid-area-list");return{sceneUrl:K(C.scene_url,"invalid-area-scene-url"),rooms:c3(C.rooms,!0),areas:C.areas.map(H=>{let V=R(H,"invalid-area");if(!Array.isArray(V.circles)||V.circles.length>512)throw new s("invalid-area-circles");return{id:g(V.id,128,"invalid-area-id"),name:g(V.name,128,"invalid-area-name"),circles:V.circles.map(P0),cleaningMode:u3(V.cleaning_mode),coverageSetting:Z3(V.coverage_setting),status:B0(V.status),canRebind:S(V.can_rebind,"invalid-area-rebind")}})}},h3=L=>{let C=R(L,"invalid-plans");if(!Array.isArray(C.plans)||C.plans.length>256)throw new s("invalid-plan-list");return{rooms:c3(C.rooms,!1).map(({roomId:V,name:e})=>({roomId:V,name:e})),selectedPlan:C.selected_plan===null||C.selected_plan===void 0?null:g(C.selected_plan,128,"invalid-selected-plan"),plans:C.plans.map(V=>{let e=R(V,"invalid-plan");if(!Array.isArray(e.rooms)||e.rooms.length>256||!Array.isArray(e.room_order))throw new s("invalid-plan-rooms");let r=e.run_behavior;if(r!=="intelligent"&&r!=="ordered")throw new s("invalid-run-behavior");return{id:g(e.id,128,"invalid-plan-id"),name:g(e.name,128,"invalid-plan-name"),enabled:S(e.enabled,"invalid-plan-enabled"),runBehavior:r,rooms:e.rooms.map(M=>{let t=R(M,"invalid-plan-room");return{roomId:g(t.room_id,128,"invalid-plan-room-id"),cleaningMode:u3(t.cleaning_mode),coverageSetting:Z3(t.coverage_setting)}}),roomOrder:e.room_order.slice(0,256).map(M=>g(M,128,"invalid-room-order")),returnToBase:S(e.return_to_base,"invalid-return-to-base"),finishCurrentRoom:S(e.finish_current_room,"invalid-finish-room"),finishCurrentRoomThreshold:W(e.finish_current_room_threshold,0,100,"invalid-finish-threshold")}})}},f3=L=>{let C=R(L,"invalid-pose"),H=C.position,V=H===null?null:v3(H,"invalid-pose-position"),e=C.pose_freshness;if(e!=="live"&&e!=="coordinator_fallback")throw new s("invalid-pose-freshness");return{position:V,source:g(C.source,64,"invalid-pose-source"),revision:W(C.revision,0,Number.MAX_SAFE_INTEGER,"invalid-pose-revision"),poseRevision:W(C.pose_revision,0,Number.MAX_SAFE_INTEGER,"invalid-pose-sequence"),floorCoherent:S(C.map_floor_coherent,"invalid-pose-floor"),mapSessionKey:s3(C.map_session_key),freshness:e}},g3=L=>{try{return K(L,"invalid-private-path"),!0}catch{return!1}};var y3=L=>{let r=()=>{throw new Error("invalid-scene")};(!(L instanceof ArrayBuffer)||L.byteLength<24||L.byteLength>16777216)&&r();let M=new DataView(L),t=new Uint8Array(L,0,8),i=String.fromCharCode(...t),o=M.getUint16(8,!0),a=M.getUint16(10,!0),A=M.getUint32(12,!0),n=M.getUint32(16,!0),d=M.getUint32(20,!0),v=n+d,u=24+A;(i!=="MATIC3D\0"||o!==1||a!==8||A>1024*1024||v<1||v>15e5||u+v*a!==L.byteLength)&&r();let x;try{x=JSON.parse(new TextDecoder("utf-8",{fatal:!0}).decode(new Uint8Array(L,24,A)))}catch{r()}(!x||typeof x!="object"||Array.isArray(x))&&r();let m=x,b=m.meters_per_cell,Z=m.origin_cells,B=m.span_cells;(typeof b!="number"||!Number.isFinite(b)||b<.001||b>.1||!Array.isArray(Z)||Z.length!==2||!Z.every(_=>typeof _=="number"&&Number.isFinite(_))||!Array.isArray(B)||B.length!==2||!B.every(_=>typeof _=="number"&&Number.isFinite(_)&&_>=1&&_<=65536))&&r();let T1=(Array.isArray(m.rooms)?m.rooms.slice(0,128):[]).flatMap((_,N3)=>{if(!_||typeof _!="object"||Array.isArray(_))return[];let Y=_,R1=typeof Y.name=="string"?Y.name.trim():"";if(!R1||Array.from(R1).length>128||/[\u0000-\u001f\u007f]/u.test(R1))return[];if(!Array.isArray(Y.boundary)||Y.boundary.length<3||Y.boundary.length>8192)return[];let Q2=Y.boundary.flatMap(M2=>{if(!Array.isArray(M2)||M2.length!==2)return[];let[t2,i2]=M2;return typeof t2=="number"&&Number.isFinite(t2)&&typeof i2=="number"&&Number.isFinite(i2)?[[t2,i2]]:[]}),L2=Y.center;if(Q2.length<3||!Array.isArray(L2)||L2.length!==2)return[];let[e2,r2]=L2;return typeof e2!="number"||!Number.isFinite(e2)||typeof r2!="number"||!Number.isFinite(r2)?[]:[{id:`scene-room-${N3+1}`,name:R1,boundary:Q2,center:[e2,r2]}]}),W3=typeof m.sample_step=="number"&&Number.isInteger(m.sample_step)?Math.max(1,Math.min(15e5,m.sample_step)):1,U2=Z,G2=B;return{buffer:L,pointOffset:u,floorCount:n,surfaceCount:d,total:v,metadata:{metersPerCell:b,origin:[U2[0],U2[1]],span:[G2[0],G2[1]],sampleStep:W3,rooms:T1}}},F0=L=>{if(L.byteLength>16777216||L.byteLength<24||!1||!1)throw new s("invalid-scene");try{return y3(L)}catch{throw new s("invalid-scene")}},E0=()=>`
...
`]}static{this.properties={hass:{attribute:!1},narrow:{type:Boolean},route:{attribute:!1},panel:{attribute:!1},_workspace:{state:!0},_classic:{state:!0},entryOverride:{state:!0}}}#C;#H;#r;#V;#e;#L;#o;#a;connectedCallback(){super.connectedCallback(),this._classic=R3()==="v3",this.#V=this.#H.subscribe(H=>{this._workspace=H,this.#p(H)}),this._classic||this.#A()}disconnectedCallback(){this.#V?.(),this.#V=null,this.#t(),super.disconnectedCallback()}#A(){this.#L||(this.#e=new j1(()=>this.hass),this.#L=new H2(this.#H,this.#e),this.#o=new V2(this.#H),this.#o.start(),this.#r&&this.#L.sync(this.#r,this.panel))}#t(){this.#o?.dispose(),this.#o=null,this.#L?.dispose(),this.#L=null,this.#e=null}#p(H){if(!this.#L)return;let V={version:4,view:H.view,appearance:H.appearance,labels:H.labelsVisible,quality:H.quality,cameras:H.cameras},e=JSON.stringify(V);e!==this.#a&&(this.#a=e,this.#L.schedulePreferences(V))}willUpdate(H){if(H.has("hass")||H.has("panel")||H.has("entryOverride")){let V=this.#C.project(this.hass,this.panel,this.entryOverride);if(V!==this.#r){this.#r=V;let e=V.host.connected?V.host.robotCount===0?"unavailable":V.host.administrator?"verifying":"blocked":"degraded";this.#H.replace({...this.#H.value,coherence:e,activity:V.activity,batteryPercent:V.batteryPercent,host:V.host,fullMap:V.host.administrator&&V.host.robotCount>0&&this.#H.value.fullMap,robotLabel:V.robotLabel,robots:V.robots,locale:V.language})}this._classic||this.#L?.sync(V,this.panel)}H.has("narrow")&&this.#H.value.narrowHint!==this.narrow&&this.#H.dispatch({type:"set-narrow-hint",value:this.narrow})}#v(H){if(!E1(H.detail))return;H.stopPropagation();let V=H.detail;if(V.type==="dismiss-top-layer"||V.type==="exit-full-map"){this.#o?.dismissTop()||this.#H.dispatch(V);return}if(V.type==="open-workflow"&&V.workflow!=="none"){this.#L?.openWorkflow(V.workflow);return}if(V.type==="set-floor"){this.#L?.selectFloor(V.floorId);return}if(V.type==="select-entry"){if(!this._workspace.robots.some(e=>e.entryId===V.entryId))return;this.entryOverride=V.entryId;return}if(V.type==="set-history"){this.#L?.selectHistory(V.historyId);return}if(V.type==="select-plan"){this.#L?.selectPlan(V.planId);return}if(V.type==="select-area"){this.#L?.selectArea(V.areaId);return}this.#H.dispatch(V)}#u(H){if(H.stopPropagation(),typeof H.detail?.id=="string"){if(H.detail.id==="use-classic"){W2("v3")&&(this.#t(),this._classic=!0);return}this.#L?.executeAction(H.detail.id),this.dispatchEvent(new CustomEvent("matic-map-v4-action-requested",{detail:{id:H.detail.id},bubbles:!0,composed:!0}))}}#n(){W2("v4")&&(this._classic=!1,this.#A(),this.requestUpdate())}updated(){if(!this._classic)return;let H=this.renderRoot.querySelector("matic-map-panel-v0-3-1");H&&(H.hass=this.hass,H.narrow=this.narrow,H.route=this.route,H.panel=this.panel)}getWorkspaceSnapshot(){return this.#H.value}render(){return this._classic?p`
      ...
      ></${I3}>
    `}};customElements.get(O2)||customElements.define(O2,z2);export{D1 as CoherenceMachine,F1 as DRAW_BRUSH_MAX_METERS,x1 as DRAW_BRUSH_MIN_METERS,l2 as GALLERY_SCENARIOS,I1 as HassAdapter,o2 as MAP_PIXELS_PER_METER_AT_100,_1 as MAP_ZOOM_MAX,J as MAP_ZOOM_MIN,O2 as MATIC_MAP_PANEL_TAG,z2 as MaticMapPanelV4,E2 as MaticMapStudioGalleryV4,A1 as WorkspaceStore,U0 as brushCursorPixels,Q as canEditCoordinates,a2 as canReadFloorResources,K2 as canShowExactPose,n1 as canShowLiveMap,a1 as canStartMotion,G0 as commandState,d2 as createGalleryState,O as initialWorkspaceState,E1 as isWorkspaceIntent,Y2 as mapScale,U3 as normalizeBrush,q2 as normalizeZoom,G3 as reduceWorkspace,j2 as selectPausedSecondaryAction,X2 as selectPrimaryAction};
