...
`;var j5=Symbol.for(""),S7=L=>{if(L?.r===j5)return L?._$litStatic$},C1=L=>({_$litStatic$:L,r:j5});var Y5=new Map,Q2=L=>(C,...H)=>{let V=H.length,e,r,t=[],o=[],M,i=0,a=!1;for(;i<V;){for(M=C[i];i<V&&(r=H[i],(e=S7(r))!==void 0);)M+=e+C[++i],a=!0;i!==V&&o.push(r),t.push(M),i++}if(i===V&&t.push(C[V]),a){let n=t.join("$$lit$$");(C=Y5.get(n))===void 0&&(t.raw=t,Y5.set(n,C=t)),H=o}return L(C,...H)},u=Q2(m),N4=Q2(U5),z4=Q2(G5);var J5=import.meta.url.match(/\/matic_robot\/[^/]+-([a-f0-9]{12})\/map-studio-v4(?:\/|$)/u)?.[1]??"dev",$1=J5==="dev"?"":`-${J5}`,A1=`matic-map-canvas-v4${$1}`,I1=`matic-precision-controls-v4${$1}`,l1=`matic-map-workflow-v4${$1}`,s1=`matic-map-shell-v4${$1}`,K2=`matic-map-panel-v0-4-0${$1}`;var H1=O`
.ms-btn, .ms-row {
...
`]}#C(H,V){return T(this.localize,H,V)}#H(H){this.dispatchEvent(new CustomEvent(V1,{detail:H,bubbles:!0,composed:!0}))}#V(H){let V=H.currentTarget.valueAsNumber;Number.isFinite(V)&&this.#H({type:"set-brush",value:V})}render(){let{draw:H}=this.state;return m`
    ...
    `}};customElements.get(I1)||customElements.define(I1,V5);var A0={ATTRIBUTE:1,CHILD:2,PROPERTY:3,BOOLEAN_ATTRIBUTE:4,EVENT:5,ELEMENT:6},l0=L=>(...C)=>({_$litDirective$:L,values:C}),n2=class{constructor(C){}get _$AU(){return this._$AM._$AU}_$AT(C,H,V){this._$Ct=C,this._$AM=H,this._$Ci=V}_$AS(C,H){return this.update(C,H)}update(C,H){return this.render(...H)}};var{I:E7}=q5,s0=L=>L;var d0=()=>document.createComment(""),O1=(L,C,H)=>{let V=L._$AA.parentNode,e=C===void 0?L._$AB:C._$AA;if(H===void 0){let r=V.insertBefore(d0(),e),t=V.insertBefore(d0(),e);H=new E7(r,t,L,L.options)}else{let r=H._$AB.nextSibling,t=H._$AM,o=t!==L;if(o){let M;H._$AQ?.(L),H._$AM=L,H._$AP!==void 0&&(M=L._$AU)!==t._$AU&&H._$AP(M)}if(r!==e||o){let M=H._$AA;for(;M!==r;){let i=s0(M).nextSibling;s0(V).insertBefore(M,e),M=i}}}return H},L1=(L,C,H=L)=>(L._$AI(C,H),L),D7={},p0=(L,C=D7)=>L._$AH=C,m0=L=>L._$AH,A2=L=>{L._$AR(),L._$AA.remove()};var v0=(L,C,H)=>{let V=new Map;for(let e=C;e<=H;e++)V.set(L[e],e);return V},c0=l0(class extends n2{constructor(L){if(super(L),L.type!==A0.CHILD)throw Error("repeat() can only be used in text expressions")}dt(L,C,H){let V;H===void 0?H=C:C!==void 0&&(V=C);let e=[],r=[],t=0;for(let o of L)e[t]=V?V(o,t):t,r[t]=H(o,t),t++;return{values:r,keys:e}}render(L,C,H){return this.dt(L,C,H).values}update(L,[C,H,V]){let e=m0(L),{values:r,keys:t}=this.dt(C,H,V);if(!Array.isArray(e))return this.ut=t,r;let o=this.ut??=[],M=[],i,a,n=0,A=e.length-1,l=0,d=r.length-1;for(;n<=A&&l<=d;)if(e[n]===null)n++;else if(e[A]===null)A--;else if(o[n]===t[l])M[l]=L1(e[n],r[l]),n++,l++;else if(o[A]===t[d])M[d]=L1(e[A],r[d]),A--,d--;else if(o[n]===t[d])M[d]=L1(e[n],r[d]),O1(L,M[d+1],e[n]),n++,d--;else if(o[A]===t[l])M[l]=L1(e[A],r[l]),O1(L,e[n],e[A]),A--,l++;else if(i===void 0&&(i=v0(t,l,d),a=v0(o,n,A)),i.has(o[n]))if(i.has(o[A])){let p=a.get(t[l]),Z=p!==void 0?e[p]:null;if(Z===null){let x=O1(L,e[n]);L1(x,r[l]),M[l]=x}else M[l]=L1(Z,r[l]),O1(L,e[n],Z),e[p]=null;l++}else A2(e[A]),A--;else A2(e[n]),n++;for(;l<=d;){let p=O1(L,M[d+1]);L1(p,r[l]),M[l++]=p}for(;n<=A;){let p=e[n++];p!==null&&A2(p)}return this.ut=t,p0(L,M),Y}});var L5=["vacuum","mop","vacuum_and_mop"],e5=["quick","standard","heavy_duty"],I=L=>L.currentTarget.value,u0=L=>L.currentTarget.checked,r5=class extends w{constructor(){super(...arguments);this.state=y();this._copyStatus="idle"}static{this.properties={state:{attribute:!1},localize:{attribute:!1},_copyStatus:{state:!0}}}static{this.styles=[D,$,H1,O`
...
`),e=typeof navigator>"u"?void 0:navigator.clipboard;if(e&&typeof e.writeText=="function")try{await e.writeText(V),this.#g("copied");return}catch{}this.#g(this.#r(V,H instanceof HTMLElement?H:null)?"copied":"failed")}#h(){let H=this.#u(),V=this._copyStatus==="copied"?this.#H("v4_copied","Copied"):this._copyStatus==="failed"?this.#H("v4_copy_failed","The summary could not be copied. Select the text to copy it by hand."):"";return m`
    ...
    `}#L1(H,V){let e=(f,g,P)=>this.#C(f,g,P),r=this.#G(e("v4_map_history","Map history"),Y2,()=>this.#o("history"),e("v4_map_history_detail","Saved maps are floor-scoped and read only.")),t=this.#G(e("v4_map_diagnostics","Map diagnostics"),J3,()=>this.#o("support"),e("v4_map_support_detail","Private geometry is never included.")),{host:o}=H;if(!o.connected)return this.#I(e("v4_reconnecting_title","Reconnecting to Home Assistant"),e("v4_reconnecting_body","The last verified map stays read-only until the connection returns."));if(!o.administrator)return this.#I(e("v4_admin_title","Administrator access required"),e("v4_admin_body","Ask a Home Assistant administrator to open this map."));if(o.robotCount===0)return this.#I(e("v4_no_robot_title","No Matic robot set up"),e("v4_no_robot_body","Add the Matic integration to see a map here."),u`<a class="ms-btn ms-btn--secondary" href="/config/integrations/integration/matic_robot">${e("v4_open_integration","Open the Matic integration")}</a>`);if(!o.robotConnected)return u`
          ...
          <div class="quick-actions" aria-label=${e("v4_cleaning_choices","Cleaning choices")}>
            ...
            >
              ...
              <span class="ms-row__body">
                ...
                <small>${x??(l?e("v4_plans_loading_hint","Reading routines for this floor"):d?e("v4_plans_unavailable_hint","Try again to load saved routines"):A?A===1?e("v4_saved_routine","1 saved routine"):e("v4_saved_routines","{count} saved routines",{count:A}):e("v4_no_plans_hint","Save a room routine you can repeat"))}</small>
              </span>
              <span class="ms-row__trail">${h(t2)}</span>
            </button>
          </div>
      ...
      `:s}
    `}#e1(H,V){return H.workflow==="none"?this.#L1(H,V):u`<${Z0}
      .state=${H}
      .localize=${this.localize}
      @matic-workspace-intent=${this.#X}
    ></${Z0}>`}#J(H,V){let e=h0(H,this.localize);return u`
    ...
    `}render(){let H=this.state,V=H.narrowHint||this._measuredNarrow,e=$7(H,this.localize),r=P2({...H,narrowHint:V}),t=h5(H),o=!V&&r.id==="stop"?r:!V&&t?.id==="stop"?t:null,M=o&&o===r?null:r,i=H.workflow==="draw"&&H.dataMode==="live"?{id:"clear-draft",label:"Clear drawing",labelKey:"v4_clear_drawing",kind:"neutral",enabled:H.draw.circles.length>0}:null,a=o&&o===t?null:t??i,n=H.fullMap&&(H.coherence==="verifying"||H.coherence==="booting"),A=H.fullMap||H.host.administrator&&H.host.robotCount>0&&H.map.available,l=G7(H.dialog,this.localize,H.workflow==="plan"),d=V&&!H.fullMap?`--map-sheet-offset:${this._sheetOffset}px`:"--map-sheet-offset:0px",p=V&&H.workflow==="draw",Z=H.precisionOpen&&H.workflow==="draw";return u`
            ...
            >
              ${V?u`
                ...
                >
                  ...
                  ${H.workflow!=="none"&&this._sheetDetent==="peek"?u`
                    <button
                ...
                ${p?u`
                  <div class="sheet-tools">
                    ${M2(H,{intent:x=>this.#n(x),openBrush:()=>this.#E(),t:(x,S)=>this.#C(x,S)},"grid")}
                    ${Z?u`
                      <div class="precision-popover">
    ...
    `}};customElements.get(s1)||customElements.define(s1,M5);var g0=C1(s1),o5=class extends w{constructor(){super(...arguments);this.scenario="ready";this.narrow=!1;this.controls=!0;this._workspace=B2("ready");this.#C=new Z1(this._workspace);this.#H=null}static{this.properties={scenario:{type:String,reflect:!0},narrow:{type:Boolean,reflect:!0},controls:{type:Boolean,reflect:!0},_workspace:{state:!0}}}static{this.styles=[D,$,O`
    :host {
      display: block;
      color: #1f2933;
      background: #e8edef;
  ...
  `]}#C;#H;connectedCallback(){super.connectedCallback(),this.#H=this.#C.subscribe(H=>{this._workspace=H})}disconnectedCallback(){this.#H?.(),this.#H=null,super.disconnectedCallback()}willUpdate(H){H.has("scenario")?this.#C.replace({...B2(this.scenario),narrowHint:this.narrow}):H.has("narrow")&&this.#C.dispatch({type:"set-narrow-hint",value:this.narrow})}setScenario(H){R2.includes(H)&&(this.scenario=H)}getWorkspaceSnapshot(){return structuredClone(this.#C.value)}replaceWorkspaceState(H){this.#C.replace(structuredClone(H))}#V(H){c1(H.detail)&&(H.stopPropagation(),this.#C.dispatch(H.detail))}render(){return u`
      ${this.controls?u`
