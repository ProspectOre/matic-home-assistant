...
`;var t3=Symbol.for(""),_7=L=>{if(L?.r===t3)return L?._$litStatic$},H1=L=>({_$litStatic$:L,r:t3});var r3=new Map,H5=L=>(C,...H)=>{let V=H.length,e,r,t=[],o=[],M,i=0,a=!1;for(;i<V;){for(M=C[i];i<V&&(r=H[i],(e=_7(r))!==void 0);)M+=e+C[++i],a=!0;i!==V&&o.push(r),t.push(M),i++}if(i===V&&t.push(C[V]),a){let n=t.join("$$lit$$");(C=r3.get(n))===void 0&&(t.raw=t,r3.set(n,C=t)),H=o}return L(C,...H)},x=H5(p),j4=H5(J5),Y4=H5(C3);var M3=import.meta.url.match(/\/matic_robot\/[^/]+-([a-f0-9]{12})\/map-studio-v4(?:\/|$)/u)?.[1]??"dev",I1=M3==="dev"?"":`-${M3}`,A1=`matic-map-canvas-v4${I1}`,W1=`matic-precision-controls-v4${I1}`,s1=`matic-map-workflow-v4${I1}`,d1=`matic-map-shell-v4${I1}`,V5=`matic-map-panel-v0-4-0${I1}`;var V1=w`
.ms-btn, .ms-row {
...
><path d=${L}></path></svg>`;var T7=["outline","paint","erase","pan"],n2=(L,C,H)=>{let{draw:V}=L,e=`${V.brushMeters.toFixed(2)} m`;return p`
    ...
    >
      ${T7.map(r=>p`
        ...
        >${Z(r==="outline"?a2:r==="paint"?j3:r==="erase"?J3:C0)}<span class="ms-btn__label">${r==="outline"?C.t("v4_zone_tool","Zone"):r==="paint"?C.t("area_paint","Paint"):r==="erase"?C.t("area_erase","Erase"):C.t("move_map","Move map")}</span></button>
      `)}
      <button
        class="ms-btn"
        type="button"
  ...
  `};var M0=(L,C)=>Math.hypot(L.x-C.x,L.y-C.y),o0=(L,C)=>({x:(L.x+C.x)/2,y:(L.y+C.y)/2}),i0=(L,C)=>Math.atan2(C.y-L.y,C.x-L.x),B7=L=>{let C=L;for(;C>Math.PI;)C-=Math.PI*2;for(;C<-Math.PI;)C+=Math.PI*2;return C},p1=(L,C,H)=>Math.max(C,Math.min(H,L)),z1=L=>L.map(C=>({...C})),R7="button, input, select, textarea, a, [contenteditable='true'], [role='button'], [role='menuitem'], [data-map-control]",L1=L=>L.composedPath().some(C=>C instanceof Element&&C.matches(R7)),A2=L=>L.composedPath().some(C=>C instanceof Element&&C.matches("select")),l2=class{#C;#H;#V;#e=new Map;#r=!1;#L="idle";#o=[];#i=null;#a=[];#A=null;#u=0;#M=null;#y=0;#h=null;#n=null;#v=null;#l=0;#p=null;#s=!1;#S=null;#t=!1;constructor(C,H,V){this.#C=C,this.#H=H,this.#V=V,C.addEventListener("pointerdown",this.#x),C.addEventListener("pointermove",this.#f),C.addEventListener("pointerup",this.#d),C.addEventListener("pointercancel",this.#d),C.addEventListener("wheel",this.#c,{passive:!1}),C.addEventListener("gesturestart",this.#Z,{passive:!1}),C.addEventListener("gesturechange",this.#w,{passive:!1}),C.addEventListener("gestureend",this.#b,{passive:!1}),C.addEventListener("dblclick",this.#g),C.addEventListener("contextmenu",this.#_),C.addEventListener("keydown",this.#k),C.addEventListener("keyup",this.#B),C.addEventListener("blur",this.#P)}#x=C=>{if(this.#t||!C.isPrimary&&C.pointerType==="mouse"||L1(C))return;this.#C.focus({preventScroll:!0}),this.#O(),C.pointerType==="touch"&&!C.isPrimary&&this.#e.size===0&&this.#V.state().draw.tool==="outline"&&(this.#s=!0);let H=performance.now(),V={id:C.pointerId,type:C.pointerType,startX:C.clientX,startY:C.clientY,x:C.clientX,y:C.clientY,lastX:C.clientX,lastY:C.clientY,lastTime:H,velocityX:0,velocityY:0};if(this.#e.set(C.pointerId,V),this.#C.setPointerCapture?.(C.pointerId),this.#e.size>=2){this.#E(),(this.#L==="paint"||this.#L==="erase")&&(this.#a=z1(this.#o),this.#V.onCircles(this.#a,!1,this.#o,this.#i)),this.#L="pinch",this.#C.classList.add("navigating"),this.#s=!0;let[o,M]=[...this.#e.values()];o&&M&&(this.#u=Math.max(1,M0(o,M)),this.#M=o0(o,M),this.#y=i0(o,M),this.#h=this.#H.camera),C.preventDefault();return}let e=this.#V.state(),r=e.workflow==="draw"&&e.map.available&&!e.floor.readOnly;this.#s||this.#r||C.button===1||C.button===2||e.draw.tool==="pan"?(this.#L="pan",this.#n=this.#H.camera):r&&e.draw.tool==="outline"&&_(e)?this.#L="outline":r&&(e.draw.tool==="paint"||e.draw.tool==="erase")?(this.#o=z1(e.draw.circles),this.#i=e.draw.outline??null,this.#a=z1(e.draw.circles),C.pointerType==="touch"?(this.#L="idle",this.#S=window.setTimeout(()=>{if(this.#S=null,this.#e.size!==1||this.#s)return;this.#L=e.draw.tool;let o=this.#e.get(C.pointerId);o&&this.#m(o.x,o.y)},110)):(this.#L=e.draw.tool,this.#m(C.clientX,C.clientY))):(this.#L=e.view==="three"&&!C.shiftKey?"orbit":"pan",this.#n=this.#H.camera),(this.#L==="pan"||this.#L==="orbit")&&this.#C.classList.add("navigating"),C.preventDefault()};#f=C=>{let H=this.#e.get(C.pointerId);if(!H){let a=this.#H.screenToMap(C.clientX,C.clientY);this.#H.setCursor(a);return}let e=(C.getCoalescedEvents?.()||[]).at(-1)||C,r=performance.now(),t=Math.max(1,r-H.lastTime),o=(e.clientX-H.lastX)/t,M=(e.clientY-H.lastY)/t;if(H.velocityX=H.velocityX*.62+o*.38,H.velocityY=H.velocityY*.62+M*.38,H.lastX=e.clientX,H.lastY=e.clientY,H.lastTime=r,H.x=e.clientX,H.y=e.clientY,this.#L==="pinch"&&this.#e.size>=2){let[a,n]=[...this.#e.values()];if(!a||!n)return;let A=Math.max(1,M0(a,n)),l=o0(a,n),d=i0(a,n),m=this.#h;if(m&&this.#M){let u={...m,distance:m.distance*this.#u/A,yaw:m.yaw+B7(d-this.#y),pitch:m.orthographic?m.pitch:m.pitch-(l.y-this.#M.y)*.0035};this.#H.setCamera(this.#H.cameraAfterPan(u,l.x-this.#M.x,l.y-this.#M.y))}C.preventDefault();return}this.#L==="paint"||this.#L==="erase"?this.#m(C.clientX,C.clientY):this.#L==="pan"?this.#n&&this.#H.setCamera(this.#H.cameraAfterPan(this.#n,e.clientX-H.startX,e.clientY-H.startY)):this.#L==="orbit"&&this.#n&&this.#H.setCamera({...this.#n,yaw:this.#n.yaw+(e.clientX-H.startX)*.0045,pitch:this.#n.pitch-(e.clientY-H.startY)*.004});let i=this.#H.screenToMap(e.clientX,e.clientY);this.#H.setCursor(i),C.preventDefault()};#d=C=>{let H=this.#e.get(C.pointerId);if(!H)return;let V=this.#L;if(this.#e.delete(C.pointerId),this.#C.releasePointerCapture?.(C.pointerId),this.#E(),this.#L==="outline"&&C.type!=="pointercancel"&&Math.hypot(H.x-H.startX,H.y-H.startY)<7){let e=this.#H.screenToMap(H.x,H.y);e&&this.#V.onOutlinePoint?.(e)}if((this.#L==="paint"||this.#L==="erase")&&JSON.stringify(this.#a)!==JSON.stringify(this.#o))this.#V.onCircles(this.#a,!0,this.#o,this.#i);else if(this.#L!=="pinch"&&!this.#s&&Math.hypot(H.x-H.startX,H.y-H.startY)<7&&this.#V.state().workflow==="rooms"){let e=this.#H.roomAt(H.x,H.y);e&&this.#V.onRoom(e)}if(this.#e.size===0)this.#L="idle",this.#C.classList.remove("navigating"),this.#s=!1,this.#M=null,this.#h=null,this.#n=null,this.#A=null,(V==="pan"||V==="orbit")&&H.type!=="mouse"&&this.#R(H.velocityX,H.velocityY,V);else if(this.#L==="pinch"){this.#L="pan",this.#s=!0;let e=this.#e.values().next().value;e&&(e.startX=e.x,e.startY=e.y,e.velocityX=0,e.velocityY=0),this.#n=this.#H.camera,this.#h=null}C.preventDefault()};#m(C,H,V=!0){let e=this.#H.screenToMap(C,H);if(!e)return;let r=this.#V.state(),t=r.draw.brushMeters/2;if(this.#L==="erase")this.#a=this.#a.filter(o=>Math.hypot(o.x-e.x,o.y-e.y)>o.radius+t);else{if(!this.#H.containsMapPoint(e))return;let o=Math.max(.04,t*.55),M=this.#A||e,i=Math.hypot(e.x-M.x,e.y-M.y),a=Math.max(1,Math.ceil(i/o));for(let n=0;n<=a&&this.#a.length<512;n+=1){let A=n/a,l={x:M.x+(e.x-M.x)*A,y:M.y+(e.y-M.y)*A};this.#a.some(d=>Math.hypot(d.x-l.x,d.y-l.y)<Math.max(.025,t*.28))||this.#a.push({x:Math.round(l.x*1e4)/1e4,y:Math.round(l.y*1e4)/1e4,radius:Math.round(t*100)/100})}}this.#A=e,V&&JSON.stringify(this.#a)!==JSON.stringify(r.draw.circles)&&this.#V.onCircles(this.#a,!1)}#c=C=>{if(L1(C))return;C.preventDefault(),this.#C.focus({preventScroll:!0}),this.#O();let H=C.deltaMode===WheelEvent.DOM_DELTA_LINE?16:C.deltaMode===WheelEvent.DOM_DELTA_PAGE?Math.max(1,this.#C.clientHeight):1,V=C.deltaX*H,e=C.deltaY*H;if(C.ctrlKey||C.metaKey){this.#H.zoomAt(Math.exp(p1(-e*.008,-.28,.28)),C.clientX,C.clientY);return}if(C.altKey&&this.#V.state().view==="three"){this.#H.orbitBy(0,p1(e,-80,80)*.75);return}if(C.deltaMode!==WheelEvent.DOM_DELTA_PIXEL||Math.abs(V)<.5&&Math.abs(e)>=50){this.#H.zoomAt(Math.exp(p1(-e*.0025,-.28,.28)),C.clientX,C.clientY);return}this.#H.panBy(-p1(V,-80,80),-p1(e,-80,80))};#Z=C=>{this.#t||L1(C)||(this.#C.focus({preventScroll:!0}),this.#O(),this.#C.classList.add("navigating"),this.#v=this.#H.camera,this.#l=Number.isFinite(C.rotation)?C.rotation:0,C.preventDefault())};#w=C=>{if(this.#t||L1(C))return;let H=this.#v;if(!H||this.#e.size>=2)return;let V=Number.isFinite(C.scale)&&C.scale>0?Math.max(.1,C.scale):1,e=Number.isFinite(C.rotation)?C.rotation:0;this.#H.setCamera({...H,distance:H.distance/V,yaw:H.yaw+(e-this.#l)*Math.PI/180}),C.preventDefault()};#b=C=>{let H=this.#v!==null;this.#v=null,this.#l=0,this.#C.classList.remove("navigating"),H&&!L1(C)&&C.preventDefault()};#F(C){let H=this.#V.state();if(C.repeat||this.#t||this.#e.size||C.composedPath()[0]!==this.#C||!this.#C.matches(":focus")||H.workflow!=="draw"||!_(H)||H.command!=="idle"&&H.command!=="failed"||H.draw.tool!=="paint"&&H.draw.tool!=="erase"&&H.draw.tool!=="outline")return;let e=this.#C.querySelector(".scene-canvas")?.getBoundingClientRect();if(!(!e?.width||!e.height)){if(C.preventDefault(),this.#O(),H.draw.tool==="outline"){let r=this.#H.screenToMap(e.left+e.width/2,e.top+e.height/2);r&&this.#V.onOutlinePoint?.(r);return}this.#o=z1(H.draw.circles),this.#i=H.draw.outline??null,this.#a=z1(H.draw.circles),this.#A=null,this.#L=H.draw.tool,this.#m(e.left+e.width/2,e.top+e.height/2,!1),this.#L="idle",this.#A=null,JSON.stringify(this.#a)!==JSON.stringify(this.#o)&&this.#V.onCircles(this.#a,!0,this.#o,this.#i)}}#k=C=>{if(L1(C)||C.defaultPrevented||C.ctrlKey||C.metaKey||C.altKey)return;if(C.key==="Enter"){this.#F(C);return}if(C.code==="Space"){this.#r=!0,C.preventDefault();return}this.#O();let H=this.#V.state(),V=C.key.toLocaleLowerCase();if(C.key==="+"||C.key==="=")this.#H.zoomAt(1.25);else if(C.key==="-")this.#H.zoomAt(.8);else if(C.key==="0")this.#H.fit();else if(V==="3")this.#T({type:"set-view",view:"three"});else if(V==="t")this.#T({type:"set-view",view:"top"});else if(C.key==="[")this.#H.orbitBy(-40,0);else if(C.key==="]")this.#H.orbitBy(40,0);else if(C.key==="PageUp")this.#H.orbitBy(0,-30);else if(C.key==="PageDown")this.#H.orbitBy(0,30);else if(V==="d"&&H.workflow==="draw")this.#T({type:"set-draw-tool",tool:"paint"});else if(V==="e"&&H.workflow==="draw")this.#T({type:"set-draw-tool",tool:"erase"});else if(["arrowleft","arrowright","arrowup","arrowdown"].includes(V))if(H.view==="three"&&!C.shiftKey){let e=V==="arrowleft"?-24:V==="arrowright"?24:0,r=V==="arrowup"?-20:V==="arrowdown"?20:0;this.#H.orbitBy(e,r)}else{let e=V==="arrowleft"?30:V==="arrowright"?-30:0,r=V==="arrowup"?30:V==="arrowdown"?-30:0;this.#H.panBy(e,r)}else if(H.workflow!=="draw"&&["w","a","s","d"].includes(V))this.#H.panBy(V==="a"?34:V==="d"?-34:0,V==="w"?34:V==="s"?-34:0);else if(H.workflow!=="draw"&&(V==="q"||V==="e"))this.#H.orbitBy(V==="q"?-30:30,0);else return;C.preventDefault()};#B=C=>{C.code==="Space"&&(this.#r=!1)};#P=()=>{this.#r=!1,this.#E(),this.#H.setCursor(null),this.#C.classList.remove("navigating")};#g=C=>{L1(C)||(this.#O(),this.#H.zoomAt(C.shiftKey?1/1.6:1.6,C.clientX,C.clientY),C.preventDefault())};#_=C=>{L1(C)||C.preventDefault()};#T(C){this.#C.dispatchEvent(new CustomEvent("matic-workspace-intent",{detail:C,bubbles:!0,composed:!0}))}#R(C,H,V){if(window.matchMedia("(prefers-reduced-motion: reduce)").matches)return;let e=p1(C,-.55,.55),r=p1(H,-.55,.55);if(Math.hypot(e,r)<.02)return;let t=performance.now(),o=M=>{let i=Math.min(32,M-t);t=M,V==="orbit"?this.#H.orbitBy(e*i,r*i):this.#H.panBy(e*i,r*i);let a=.9**(i/16);e*=a,r*=a,Math.hypot(e,r)>=.01?this.#p=window.requestAnimationFrame(o):this.#p=null};this.#p=window.requestAnimationFrame(o)}#O(){this.#p!==null&&window.cancelAnimationFrame(this.#p),this.#p=null}#E(){this.#S!==null&&window.clearTimeout(this.#S),this.#S=null}dispose(){this.#t||(this.#t=!0,this.#E(),this.#O(),this.#C.removeEventListener("pointerdown",this.#x),this.#C.removeEventListener("pointermove",this.#f),this.#C.removeEventListener("pointerup",this.#d),this.#C.removeEventListener("pointercancel",this.#d),this.#C.removeEventListener("wheel",this.#c),this.#C.removeEventListener("gesturestart",this.#Z),this.#C.removeEventListener("gesturechange",this.#w),this.#C.removeEventListener("gestureend",this.#b),this.#C.removeEventListener("dblclick",this.#g),this.#C.removeEventListener("contextmenu",this.#_),this.#C.removeEventListener("keydown",this.#k),this.#C.removeEventListener("keyup",this.#B),this.#C.removeEventListener("blur",this.#P),this.#e.clear())}};var E7=L=>L.matches(":disabled, [aria-disabled='true']"),m1=class{#C;#H;#V=null;#e=null;constructor(C,H){this.#C=C,this.#H=H,C.addController(this)}hostConnected(){this.#C.addEventListener("focusin",this.#o)}hostDisconnected(){this.#C.removeEventListener("focusin",this.#o),this.#V?.removeEventListener("keydown",this.#i),this.#V=null,this.#e=null}hostUpdated(){let C=this.#H.container();C!==this.#V&&(this.#V?.removeEventListener("keydown",this.#i),C?.addEventListener("keydown",this.#i),this.#V=C),this.#L()}#r(){let C=this.#V;return C?[...C.querySelectorAll(this.#H.items)].filter(H=>!E7(H)):[]}#L(){let C=this.#r(),H=(this.#e&&C.includes(this.#e)?this.#e:null)??C.find(e=>e.matches("[aria-pressed='true'], [aria-checked='true']"))??C[0]??null;this.#e=H;let V=this.#V?.querySelectorAll(this.#H.items)??[];for(let e of V)e.tabIndex=e===H?0:-1}#o=C=>{let H=C.composedPath()[0];!(H instanceof HTMLElement)||!this.#V?.contains(H)||H.matches(this.#H.items)&&(this.#e=H,this.#L())};#i=C=>{if(C.defaultPrevented||C.ctrlKey||C.metaKey||C.altKey)return;let H=this.#H.orientation??"horizontal",V=H!=="vertical",e=H!=="horizontal",r=this.#r();if(!r.length)return;let t=C.composedPath()[0],o=Math.max(0,r.findIndex(a=>a===this.#e||t instanceof Node&&a.contains(t))),M;switch(C.key){case"ArrowLeft":if(!V)return;M=o-1;break;case"ArrowRight":if(!V)return;M=o+1;break;case"ArrowUp":if(!e)return;M=o-1;break;case"ArrowDown":if(!e)return;M=o+1;break;case"Home":M=0;break;case"End":M=r.length-1;break;default:return}C.preventDefault();let i=r[(M+r.length)%r.length];i&&(this.#e=i,this.#L(),i.focus())}};var N1=(L,C,H)=>{let V=H.x-C.x,e=H.y-C.y,r=Math.max(0,Math.min(1,((L.x-C.x)*V+(L.y-C.y)*e)/(V*V+e*e||1)));return Math.hypot(L.x-C.x-r*V,L.y-C.y-r*e)},F7=(L,C)=>{let H=!1;for(let V=0,e=C.length-1;V<C.length;e=V++){let r=C[V],t=C[e];r.y>L.y!=t.y>L.y&&L.x<(t.x-r.x)*(L.y-r.y)/(t.y-r.y)+r.x&&(H=!H)}return H},s2=(L,C,H)=>(C.x-L.x)*(H.y-L.y)-(C.y-L.y)*(H.x-L.x),O1=({points:L,closed:C})=>{if(L.length>64||C&&L.length<3||L.some(V=>!Number.isFinite(V.x)||!Number.isFinite(V.y)||Math.abs(V.x)>1e4||Math.abs(V.y)>1e4))return!1;let H=C?L.length:L.length-1;for(let V=0;V<H;V++){let e=L[V],r=L[(V+1)%L.length];if(Math.hypot(e.x-r.x,e.y-r.y)<.01)return!1;for(let t=V+2;t<H;t++){if(C&&V===0&&t===H-1)continue;let o=L[t],M=L[(t+1)%L.length];if(Math.min(N1(e,o,M),N1(r,o,M),N1(o,e,r),N1(M,e,r))<1e-5||s2(e,r,o)*s2(e,r,M)<0&&s2(o,M,e)*s2(o,M,r)<0)return!1}}return!C||Math.abs(L.reduce((V,e,r)=>{let t=L[(r+1)%L.length];return V+e.x*t.y-t.x*e.y},0))>.01},a0=(L,C)=>{if(!L.closed||!O1(L))return[];let{points:H}=L,V=Math.min(...H.map(i=>i.x)),e=Math.max(...H.map(i=>i.x)),r=Math.min(...H.map(i=>i.y)),t=Math.max(...H.map(i=>i.y)),o=[];for(let i=0;i<32;i++)for(let a=0;a<32;a++){let n={x:Math.round((V+(a+.5)*(e-V)/32)*1e4)/1e4,y:Math.round((r+(i+.5)*(t-r)/32)*1e4)/1e4};if(!F7(n,H)||!C(n))continue;let A=Math.min(...H.map((d,m)=>N1(n,d,H[(m+1)%H.length]))),l=Math.floor(Math.min(2.5,A-1e-4)*1e4)/1e4;l>=.05&&o.push({...n,radius:l})}o.sort((i,a)=>a.radius-i.radius);let M=[];for(let i of o){if(M.length>=512)break;M.some(a=>Math.hypot(a.x-i.x,a.y-i.y)+i.radius*.5<=a.radius)||M.push(i)}return M};var d2=class{constructor(C,H,V,e,r,t){this.state=C;this.renderer=H;this.intent=V;this.update=e;this.t=r;this.focusPoint=t}#C=null;#H="";#V=null;#e(){let C=this.state();return!C.dialog&&C.workflow==="draw"&&C.draw.tool==="outline"&&_(C)&&(C.command==="idle"||C.command==="failed")}#r(C){if(!this.#e())return;if(!O1(C)){this.#H=this.t("v4_zone_invalid","Keep the outline from crossing itself."),this.update();return}let H=a0(C,V=>this.renderer()?.containsMapPoint(V)??!1);if(C.closed&&!H.length){this.#H=this.t("v4_zone_empty","Make the zone wider and keep it on mapped floor."),this.update();return}this.#H="",this.intent({type:"set-draft-circles",circles:H,outline:C})}addPoint(C){if(!this.#e()||!this.renderer()?.containsMapPoint(C))return;let H=this.state().draw.outline??{points:[],closed:!1};H.closed||H.points.length>=64||this.#r({points:[...H.points,C],closed:!1})}#L(){let C=this.state().draw.outline;C&&C.points.length>=3&&this.#r({...C,closed:!0})}#o(C){let H=this.state().draw.outline;if(!H)return;this.#V=null;let V=H.points.filter((e,r)=>r!==C);this.#r({points:V,closed:H.closed&&V.length>=3}),this.focusPoint(Math.min(C,V.length-1))}#i(C){let H=this.state().draw.outline;if(!H||H.points.length>=64)return;let V=H.points[C],e=H.points[(C+1)%H.points.length];if(!V||!e||!H.closed&&C===H.points.length-1)return;let r={x:(V.x+e.x)/2,y:(V.y+e.y)/2};this.#r({...H,points:[...H.points.slice(0,C+1),r,...H.points.slice(C+1)]}),this.focusPoint(C+1)}#a(C,H){if(!this.#e()||C.button!==0||this.#C||C.pointerType==="touch"&&!C.isPrimary)return;this.#V=H,this.update();let V=this.state().draw.outline;if(!V)return;C.stopPropagation(),C.preventDefault();let e=C.currentTarget;e.focus({preventScroll:!0}),e.setPointerCapture(C.pointerId),this.#C={index:H,pointer:C.pointerId,baseline:V,preview:V,target:e}}#A(C){let H=this.#C;if(!H||H.pointer!==C.pointerId)return;if(C.stopPropagation(),C.preventDefault(),!this.#e()||this.state().draw.outline!==H.baseline){this.cancel();return}let V=this.renderer()?.screenToMap(C.clientX,C.clientY);!V||!this.renderer()?.containsMapPoint(V)||(H.preview={...H.baseline,points:H.baseline.points.map((e,r)=>r===H.index?V:e)},this.update())}#u(C){let H=this.#C;!H||H.pointer!==C.pointerId||(C.stopPropagation(),C.preventDefault(),this.#C=null,H.target.releasePointerCapture(C.pointerId),this.state().draw.outline===H.baseline&&this.#e()&&(H.preview!==H.baseline?this.#r(H.preview):H.index===0&&!H.baseline.closed&&this.#L()),this.update())}cancel(){let C=this.#C;C&&(this.#C=null,C.target.hasPointerCapture(C.pointer)&&C.target.releasePointerCapture(C.pointer),this.update())}#M(C,H){if(C.ctrlKey||C.altKey||C.metaKey)return;if(C.key==="Escape"){C.stopPropagation(),this.cancel();return}let V=this.state().draw.outline;if(!V||!this.#e())return;if(C.key==="Delete"||C.key==="Backspace"){C.preventDefault(),C.stopPropagation(),this.#o(H);return}let e=C.shiftKey?.1:.02,r=C.key==="ArrowLeft"?-e:C.key==="ArrowRight"?e:0,t=C.key==="ArrowUp"?-e:C.key==="ArrowDown"?e:0;if(!r&&!t)return;C.preventDefault(),C.stopPropagation();let o=V.points[H],M=this.renderer()?.offsetMapPoint(o,r,t);M&&this.renderer()?.containsMapPoint(M)&&this.#r({...V,points:V.points.map((i,a)=>a===H?M:i)})}render(){if(!this.#e())return s;let C=this.#C?.preview??this.state().draw.outline,H=C?.points??[],V=H.map(o=>this.renderer()?.mapToScreen(o)),e=V.map((o,M)=>o?`${M?"L":"M"}${o.x},${o.y}`:"").join(" "),r=!C||O1(C),t=this.#V!==null&&this.#V<H.length?this.#V:null;return p`
    ...
    `}};var n0={accent:["--ms-accent","Highlight",[6,120,206]],onAccent:["--ms-on-accent","HighlightText",[255,255,255]],text:["--ms-text","CanvasText",[38,50,56]],quiet:["--ms-text-quiet","GrayText",[75,92,105]],plate:["--ms-surface-card","Canvas",[250,252,253]],roomFill:["--ms-surface-sunken","Canvas",[231,238,242]]},D7=L=>Math.max(0,Math.min(255,Math.round(L))),l0=L=>{let C=L.trim(),H=C.match(/^#([\da-f]{3}|[\da-f]{4}|[\da-f]{6}|[\da-f]{8})$/i)?.[1];if(H){let a=H.length<=4?[H[0],H[1],H[2]].map(d=>Number.parseInt(`${d}${d}`,16)):[H.slice(0,2),H.slice(2,4),H.slice(4,6)].map(d=>Number.parseInt(d,16)),[n,A,l]=a;return n===void 0||A===void 0||l===void 0?null:[n,A,l]}let V=C.startsWith("color(srgb"),e=C.slice(C.indexOf("(")+1).match(/-?\d*\.?\d+/g);if(!e||e.length<3)return null;let r=V?255:1,t=e.slice(0,3).map(a=>D7(Number(a)*r)),[o,M,i]=t;return o===void 0||M===void 0||i===void 0||[o,M,i].some(a=>Number.isNaN(a))?null:[o,M,i]},T=(L,C)=>`rgba(${L[0]},${L[1]},${L[2]},${C})`,A0=L=>{let C=window.matchMedia?.("(forced-colors: active)").matches??!1;if(!C){let e=document.createElement("span"),r=document.createElement("canvas");r.width=1,r.height=1;let t=r.getContext("2d",{colorSpace:"srgb",willReadFrequently:!0});e.setAttribute("aria-hidden","true"),e.style.cssText="position:absolute;inline-size:0;block-size:0;overflow:hidden;visibility:hidden;pointer-events:none",L.append(e);let o=M=>{let[i,,a]=n0[M];e.style.color=`var(${i}, transparent)`;let n=getComputedStyle(e).color;if(t){t.clearRect(0,0,1,1),t.fillStyle="transparent",t.fillStyle=n,t.fillRect(0,0,1,1);let[A,l,d,m]=t.getImageData(0,0,1,1).data;if(A!==void 0&&l!==void 0&&d!==void 0&&m!==void 0&&m!==0)return[A,l,d]}return l0(n)??a};try{return{accent:o("accent"),onAccent:o("onAccent"),text:o("text"),quiet:o("quiet"),plate:o("plate"),roomFill:o("roomFill"),forced:C}}finally{e.remove()}}let H=document.createElement("span");H.setAttribute("aria-hidden","true"),H.style.cssText="position:absolute;inline-size:0;block-size:0;overflow:hidden;visibility:hidden;pointer-events:none",L.append(H);let V=e=>{let[,r,t]=n0[e];return H.style.color=r,l0(getComputedStyle(H).color)??t};try{return{accent:V("accent"),onAccent:V("onAccent"),text:V("text"),quiet:V("quiet"),plate:V("plate"),roomFill:V("roomFill"),forced:C}}finally{H.remove()}};var B=(L,C,H)=>Math.max(C,Math.min(H,L)),U1=L=>{let C=L;for(;C>Math.PI;)C-=Math.PI*2;for(;C<-Math.PI;)C+=Math.PI*2;return C},$7=L=>{switch(L){case"efficient":return .35;case"balanced":return .65;case"maximum":case"auto":return 1}},I7={accent:[6,120,206],onAccent:[255,255,255],text:[38,50,56],quiet:[75,92,105],plate:[250,252,253],roomFill:[231,238,242],forced:!1},d0=Math.PI/3.15,W7=1.08,z7=(L,C)=>{let H=d0/2,V=Math.atan(Math.tan(H)*Math.max(.2,C));return L/Math.sin(Math.min(H,V))*W7},N7=(L,C)=>{let H=new Float32Array(16);for(let V=0;V<4;V+=1)for(let e=0;e<4;e+=1){let r=0;for(let t=0;t<4;t+=1)r+=(L[t*4+e]??0)*(C[V*4+t]??0);H[V*4+e]=r}return H},U7=(L,C,H,V)=>{let e=1/Math.tan(L/2),r=new Float32Array(16);return r[0]=e/C,r[5]=e,r[10]=(V+H)/(H-V),r[11]=-1,r[14]=2*V*H/(H-V),r},G7=(L,C,H,V,e,r)=>{let t=new Float32Array(16);return t[0]=2/(C-L),t[5]=2/(V-H),t[10]=-2/(r-e),t[12]=-(C+L)/(C-L),t[13]=-(V+H)/(V-H),t[14]=-(r+e)/(r-e),t[15]=1,t},K7=(L,C)=>{let H=Math.hypot((L[0]??0)-(C[0]??0),(L[1]??0)-(C[1]??0),(L[2]??0)-(C[2]??0))||1,V=[((L[0]??0)-(C[0]??0))/H,((L[1]??0)-(C[1]??0))/H,((L[2]??0)-(C[2]??0))/H],e=Math.hypot(V[2]??0,V[0]??0)||1,r=[(V[2]??0)/e,0,-(V[0]??0)/e],t=[(V[1]??0)*(r[2]??0),(V[2]??0)*(r[0]??0)-(V[0]??0)*(r[2]??0),-(V[1]??0)*(r[0]??0)];return new Float32Array([r[0]??0,t[0]??0,V[0]??0,0,r[1]??0,t[1]??0,V[1]??0,0,r[2]??0,t[2]??0,V[2]??0,0,-((r[0]??0)*(L[0]??0)+(r[1]??0)*(L[1]??0)+(r[2]??0)*(L[2]??0)),-((t[0]??0)*(L[0]??0)+(t[1]??0)*(L[1]??0)+(t[2]??0)*(L[2]??0)),-((V[0]??0)*(L[0]??0)+(V[1]??0)*(L[1]??0)+(V[2]??0)*(L[2]??0)),1])},s0=(L,C,H)=>{let V=!1,e=H.at(-1);if(!e)return!1;for(let r of H){let[t,o]=r,[M,i]=e;o>C!=i>C&&L<(M-t)*(C-o)/(i-o)+t&&(V=!V),e=r}return V},p2=class{#C;#H;#V;#e=null;#r=null;#L=null;#o=null;#i=null;#a=null;#A=null;#u=null;#M=null;#y=null;#h=null;#n=null;#v=null;#l=null;#p=null;#s=null;#S;#t={yaw:-Math.PI/4,pitch:.82,distance:12,targetX:0,targetZ:0,orthographic:!1};#x=12;#f=8;#d=4;#m=new Float32Array(16);#c=null;#Z="unavailable";#w=0;#b=0;#F=0;#k=0;#B=1;#P={width:1,height:1,left:0,top:0};#g=!0;#_=!1;#T=I7;constructor(C,H,V={}){this.#C=C,this.#H=H,this.#V=V,this.#r=H.getContext("2d",{alpha:!0}),this.#C.addEventListener("webglcontextlost",this.#t1),this.#C.addEventListener("webglcontextrestored",this.#M1),this.#U(),this.#S=new ResizeObserver(()=>{let e=this.#x,r=this.#f;this.#G(),this.#g&&(e!==this.#x||r!==this.#f)?this.fit(!1):this.requestRender()}),this.#S.observe(C)}get camera(){return{...this.#t}}#R(){return{minimum:Math.max(.2,this.#d*.04),maximum:this.#d*8}}#O(){let C=this.#l?.metadata.span,H=this.#l?.metadata.metersPerCell;return!C||H===void 0?{x:this.#d,z:this.#d}:{x:Math.max(.5,C[0]*H*.55),z:Math.max(.5,C[1]*H*.55)}}setCamera(C,H=!0){let V=this.#R(),e=this.#O();this.#t={yaw:U1(C.yaw),pitch:C.orthographic?Math.PI/2-.018:B(C.pitch,.18,1.38),distance:B(C.distance,V.minimum,V.maximum),targetX:B(C.targetX,-e.x,e.x),targetZ:B(C.targetZ,-e.z,e.z),orthographic:C.orthographic},this.#g=!1,this.requestRender(),H&&this.#q()}cameraAfterPan(C,H,V){let e=this.#$(),r=C.distance*1.75/Math.max(200,e.height),t=Math.cos(C.yaw),o=-Math.sin(C.yaw),M=-Math.sin(C.yaw),i=-Math.cos(C.yaw),a=this.#O();return{...C,targetX:B(C.targetX-H*r*t+V*r*M,-a.x,a.x),targetZ:B(C.targetZ-H*r*o+V*r*i,-a.z,a.z)}}setState(C){if(this.#_)return;let H=this.#v;this.#v=C;let V=C.resources.scene.value;V!==this.#l&&(this.#l=V,this.#H1(V)),(!H||H.quality!==C.quality)&&(this.#B=$7(C.quality),this.#k=0);let e=H?.workflow!=="draw"&&C.workflow==="draw",r=H?.workflow==="draw"&&C.workflow!=="draw";if(!H||H.view!==C.view||e||r){let t=C.workflow==="draw"?"top":C.view;this.#t=this.#E(t,C),this.#g=this.#D(t,C)}C.workflow==="draw"&&H?.draw.zoomPercent!==C.draw.zoomPercent&&(this.#t={...this.#t,orthographic:!0,pitch:Math.PI/2-.018,distance:this.#f*100/C.draw.zoomPercent},this.#g=C.draw.zoomPercent===100&&Math.abs(this.#t.targetX)<.001&&Math.abs(this.#t.targetZ)<.001&&Math.abs(U1(this.#t.yaw))<.001),this.requestRender()}#E(C,H){let V=C==="top",e=V?this.#f:this.#x,r=H.cameras[C];return r?{yaw:r.yaw,pitch:V?Math.PI/2-.018:r.pitch,distance:B(e/B(r.zoom,.01,100),Math.max(.2,this.#d*.04),this.#d*8),targetX:B(r.targetX,-this.#d,this.#d),targetZ:B(r.targetZ,-this.#d,this.#d),orthographic:V}:V?{yaw:0,pitch:Math.PI/2-.018,distance:e,targetX:0,targetZ:0,orthographic:!0}:{yaw:-Math.PI/4,pitch:.82,distance:e,targetX:0,targetZ:0,orthographic:!1}}#D(C,H){let V=H.cameras[C];if(!V)return!0;let e=C==="top";return Math.abs(V.zoom-1)<.001&&Math.abs(V.targetX)<.001&&Math.abs(V.targetZ)<.001&&Math.abs(U1(V.yaw-(e?0:-Math.PI/4)))<.001&&(e||Math.abs(V.pitch-.82)<.001)}#X(C,H){let V=this.#e;if(!V)throw new Error("webgl-unavailable");let e=V.createShader(C);if(!e)throw new Error("shader-unavailable");if(V.shaderSource(e,H),V.compileShader(e),!V.getShaderParameter(e,V.COMPILE_STATUS))throw V.deleteShader(e),new Error("shader-failed");return e}#U(){try{this.#e=this.#C.getContext("webgl2",{alpha:!0,antialias:!0,depth:!0,powerPreference:"high-performance"});let C=this.#e;if(!C)throw new Error("webgl2-unavailable");let H=this.#X(C.VERTEX_SHADER,`#version 300 es
      ...
      `),e=C.createProgram();if(!e)throw new Error("program-unavailable");if(C.attachShader(e,H),C.attachShader(e,V),C.linkProgram(e),C.deleteShader(H),C.deleteShader(V),!C.getProgramParameter(e,C.LINK_STATUS))throw new Error("program-failed");this.#i=e,this.#u=C.getUniformLocation(e,"uViewProjection"),this.#M=C.getUniformLocation(e,"uCenter"),this.#y=C.getUniformLocation(e,"uMetersPerCell"),this.#h=C.getUniformLocation(e,"uPointPixels"),this.#n=C.getUniformLocation(e,"uMaxPointPixels"),this.#a=C.createBuffer(),this.#A=C.createVertexArray(),C.bindVertexArray(this.#A),C.bindBuffer(C.ARRAY_BUFFER,this.#a),C.enableVertexAttribArray(0),C.vertexAttribIPointer(0,2,C.UNSIGNED_SHORT,8,0),C.enableVertexAttribArray(1),C.vertexAttribIPointer(1,1,C.UNSIGNED_BYTE,8,4),C.enableVertexAttribArray(2),C.vertexAttribPointer(2,3,C.UNSIGNED_BYTE,!0,8,5),C.bindVertexArray(null),C.enable(C.DEPTH_TEST),C.depthFunc(C.LEQUAL),C.enable(C.BLEND),C.blendFunc(C.SRC_ALPHA,C.ONE_MINUS_SRC_ALPHA),this.#Z="webgl2",this.#w+=1,this.#l&&this.#j(this.#l)}catch{this.#C1(),this.#Y()}}#H1(C){if(this.#K(),!C){this.#b=0,this.requestRender();return}let[H,V]=C.metadata.span,e=C.metadata.metersPerCell,r=H*e,t=V*e;this.#d=Math.max(1,Math.hypot(r,t)/2),this.#G(),this.fit(!1),this.#Z==="webgl2"?this.#j(C):this.#W(C)}#G(){let C=this.#l;if(!C)return;let[H,V]=C.metadata.span,e=C.metadata.metersPerCell,r=H*e,t=V*e,o=this.#$(),M=Math.max(.2,o.width/Math.max(1,o.height));this.#x=z7(this.#d,M),this.#f=Math.max(t/2,r/(2*M))*1.12}#j(C){let H=this.#e;if(!H||!this.#a)return;let V=new Uint8Array(C.buffer,C.pointOffset,C.total*8);H.bindBuffer(H.ARRAY_BUFFER,this.#a),H.bufferData(H.ARRAY_BUFFER,V,H.STATIC_DRAW),this.#b=C.total}#Y(){this.#Z="canvas2d",this.#o=document.createElement("canvas"),this.#o.width=1024,this.#o.height=1024,this.#L=this.#o.getContext("2d",{alpha:!0}),this.#L?this.#l&&this.#W(this.#l):(this.#Z="unavailable",this.#V.onProblem?.("renderer-unavailable"))}#W(C){let H=this.#L;if(!H||!this.#o)return;H.clearRect(0,0,this.#o.width,this.#o.height);let V=new DataView(C.buffer,C.pointOffset,C.total*8),e=Math.min(C.total,5e4),r=Math.max(1,Math.ceil(C.total/e)),t=0,o=0,M=()=>{if(this.#_||C!==this.#l||!this.#o)return;let i=Math.min(C.total,t+r*4e3);for(;t<i;t+=r){let a=t*8,n=V.getUint16(a,!0)/Math.max(1,C.metadata.span[0])*this.#o.width,A=V.getUint16(a+2,!0)/Math.max(1,C.metadata.span[1])*this.#o.height,l=V.getUint8(a+5),d=V.getUint8(a+6),m=V.getUint8(a+7);H.fillStyle=`rgb(${l} ${d} ${m})`,H.fillRect(n,A,1.5,1.5),o+=1}this.#b=o,this.requestRender(),t<C.total?this.#s=window.setTimeout(M,0):this.#s=null};M()}#K(){this.#s!==null&&window.clearTimeout(this.#s),this.#s=null}#$(){let C=this.#C.getBoundingClientRect();return this.#P={width:C.width,height:C.height,left:C.left,top:C.top},this.#P}#z(){let C=!1,H=this.#$(),V=Math.min(window.devicePixelRatio||1,3),e=Math.max(1,Math.round(H.width*V)),r=Math.max(1,Math.round(H.height*V));for(let t of[this.#C,this.#H])(t.width!==e||t.height!==r)&&(t.width=e,t.height=r,C=!0);C&&this.#V.onViewport?.()}#N(){let C=this.#P,H=Math.max(.2,C.width/Math.max(1,C.height)),V=Math.cos(this.#t.pitch)*this.#t.distance,e=[this.#t.targetX+Math.sin(this.#t.yaw)*V,Math.sin(this.#t.pitch)*this.#t.distance,this.#t.targetZ+Math.cos(this.#t.yaw)*V],r=[this.#t.targetX,0,this.#t.targetZ],t=K7(e,r),o=this.#t.orthographic?G7(-this.#t.distance*H,this.#t.distance*H,-this.#t.distance,this.#t.distance,-this.#d*4,this.#d*4):U7(d0,H,.02,Math.max(60,this.#d*12));return N7(o,t)}requestRender(){this.#p!==null||this.#_||(this.#p=window.requestAnimationFrame(()=>{this.#p=null,this.#V1()}))}#V1(){let C=performance.now();this.#z(),this.#m=this.#N(),this.#Z==="webgl2"?this.#L1():this.#e1(),this.#o1(),this.#F=performance.now()-C,this.#F>18?(this.#k+=1,this.#k>=3&&this.#v?.quality==="auto"&&(this.#B=Math.max(.25,this.#B*.75))):this.#k=Math.max(0,this.#k-1)}#L1(){let C=this.#e,H=this.#l;if(!C||(C.viewport(0,0,this.#C.width,this.#C.height),C.clearColor(0,0,0,0),C.clear(C.COLOR_BUFFER_BIT|C.DEPTH_BUFFER_BIT),!H||!this.#i||!this.#A))return;if(this.#v?.view==="top"&&this.#v.appearance==="rooms"){this.#b=0;return}C.useProgram(this.#i),C.bindVertexArray(this.#A),C.uniformMatrix4fv(this.#u,!1,this.#m),C.uniform2f(this.#M,(H.metadata.span[0]-1)/2,(H.metadata.span[1]-1)/2),C.uniform1f(this.#y,H.metadata.metersPerCell);let V=Math.min(window.devicePixelRatio||1,3),e=Math.max(1,Math.floor(H.total*this.#B)),r=Math.min(H.floorCount,e),t=Math.min(H.surfaceCount,Math.max(0,e-r));C.uniform1f(this.#h,this.#C.height*.038),C.uniform1f(this.#n,4.5*V),C.drawArrays(C.POINTS,0,r),C.uniform1f(this.#h,this.#C.height*.05),C.uniform1f(this.#n,7*V),C.drawArrays(C.POINTS,H.floorCount,t),C.bindVertexArray(null),this.#b=r+t}#e1(){}#J(C,H,V=0){let e=this.#l;return e?[-(C-(e.metadata.span[0]-1)/2)*e.metadata.metersPerCell,V*e.metadata.metersPerCell,(H-(e.metadata.span[1]-1)/2)*e.metadata.metersPerCell]:null}#Q(C,H,V=0,e=!0,r=this.#m){let t=this.#J(C,H,V);if(!t)return null;let[o,M,i]=t,a=(r[0]??0)*o+(r[4]??0)*M+(r[8]??0)*i+(r[12]??0),n=(r[1]??0)*o+(r[5]??0)*M+(r[9]??0)*i+(r[13]??0),A=(r[3]??0)*o+(r[7]??0)*M+(r[11]??0)*i+(r[15]??0);if(A<=.001)return null;let l=a/A,d=n/A;if(!Number.isFinite(l)||!Number.isFinite(d)||e&&(Math.abs(l)>1.15||Math.abs(d)>1.15))return null;let m=this.#P;return{x:(l*.5+.5)*m.width,y:(-d*.5+.5)*m.height}}#I(C,H,V=0,e=!0,r=this.#m){let t=this.#l;if(!t)return null;let o=C/t.metadata.metersPerCell-t.metadata.origin[0],M=H/t.metadata.metersPerCell-t.metadata.origin[1];return this.#Q(o,M,V,e,r)}#o1(){let C=this.#r,H=this.#l,V=this.#v;if(!C)return;let e=Math.min(window.devicePixelRatio||1,3),r=this.#P;if(C.setTransform(e,0,0,e,0,0),C.clearRect(0,0,r.width,r.height),!H||!V)return;let t=this.#T;if(this.#Z==="canvas2d"&&this.#o&&!(V.view==="top"&&V.appearance==="rooms")){let n=this.#f/this.#t.distance,A=r.width*n,l=r.height*n,d=(r.width-A)/2-this.#t.targetX*32*n,m=(r.height-l)/2-this.#t.targetZ*32*n;C.drawImage(this.#o,d,m,A,l)}let o=this.#i1(V);if(V.labelsVisible||V.view==="top"&&V.appearance==="rooms"){C.lineWidth=1.5,C.font="600 12px system-ui, sans-serif",C.textAlign="center",C.textBaseline="middle";let n=[];for(let A of H.metadata.rooms){let l=o.has(A.name.toLocaleLowerCase());C.strokeStyle=l?T(t.accent,1):T(t.quiet,.7),C.fillStyle=l?T(t.accent,.26):V.view==="top"&&V.appearance==="rooms"?T(t.roomFill,.94):T(t.plate,.04),C.beginPath();let d=Math.max(1,Math.ceil(A.boundary.length/512)),m=!1;for(let S=0;S<A.boundary.length;S+=d){let O=A.boundary[S];if(!O)continue;let g=this.#Q(O[0],O[1],.2,!1);g&&(m?C.lineTo(g.x,g.y):C.moveTo(g.x,g.y),m=!0)}if(m&&(C.closePath(),C.fill(),C.stroke()),!V.labelsVisible)continue;let u=this.#Q(A.center[0],A.center[1],1);if(!u)continue;let h=C.measureText(A.name).width,f=new DOMRect(u.x-h/2-6,u.y-10,h+12,20);n.some(S=>f.left<S.right+8&&f.right+8>S.left&&f.top<S.bottom+4&&f.bottom+4>S.top)||(n.push(f),C.fillStyle=T(t.plate,.88),C.fillRect(f.x,f.y,f.width,f.height),C.fillStyle=T(t.text,1),C.fillText(A.name,u.x,u.y))}}let M=V.draw.circles;if((V.workflow==="draw"||V.workflow==="areaReview")&&M.length)if(C.fillStyle=T(t.accent,.22),C.strokeStyle=T(t.accent,.92),C.lineWidth=1.5,V.draw.outline?.closed){C.beginPath();for(let n of M)this.#r1(C,n,!1);C.fill()}else for(let n of M)this.#r1(C,n);let i=V.draw.outline;if(i&&(V.workflow==="draw"||V.workflow==="areaReview")&&!(V.workflow==="draw"&&V.draw.tool==="outline")&&(C.beginPath(),i.points.forEach((n,A)=>{let l=this.#I(n.x,n.y,0,!1);l&&(A===0?C.moveTo(l.x,l.y):C.lineTo(l.x,l.y))}),i.closed&&C.closePath(),C.strokeStyle=T(t.accent,1),C.lineWidth=2,C.stroke()),this.#c&&V.workflow==="draw"&&(V.draw.tool==="paint"||V.draw.tool==="erase")){let n=this.#I(this.#c.x,this.#c.y),A=this.#I(this.#c.x+V.draw.brushMeters/2,this.#c.y);n&&A&&(C.beginPath(),C.arc(n.x,n.y,Math.max(2,Math.hypot(A.x-n.x,A.y-n.y)),0,Math.PI*2),C.strokeStyle=T(t.accent,1),C.lineWidth=2,C.stroke())}let a=V.resources.pose.value;if(V.map.exactPose&&a?.position&&V.dataMode==="live"){let n=this.#I(a.position[0],a.position[1],3);n&&(C.beginPath(),C.arc(n.x,n.y,7,0,Math.PI*2),C.fillStyle=T(t.accent,1),C.fill(),C.strokeStyle=T(t.onAccent,1),C.lineWidth=3,C.stroke())}}#i1(C){let H=C.resources.plans.value?.rooms||C.resources.areas.value?.rooms||[];return new Set(H.filter(V=>C.selection.roomIds.includes(V.roomId)).map(V=>V.name.toLocaleLowerCase()))}#r1(C,H,V=!0){let e=this.#I(H.x,H.y),r=this.#I(H.x+H.radius,H.y);if(!e||!r)return;let t=Math.max(1,Math.hypot(r.x-e.x,r.y-e.y));V&&C.beginPath(),C.moveTo(e.x+t,e.y),C.arc(e.x,e.y,t,0,Math.PI*2),V&&(C.fill(),C.stroke())}setPalette(C){this.#T=C,this.requestRender()}setCursor(C){this.#c=C,this.requestRender()}mapToScreen(C){if(!this.#l||!this.#t.orthographic)return null;let H=this.#$();return!H.width||!H.height?null:this.#I(C.x,C.y,0,!1,this.#N())}offsetMapPoint(C,H,V){let e=this.mapToScreen(C);if(!e)return null;let r=this.#P,t=this.#t.distance*2/r.height;return this.screenToMap(r.left+e.x+H/t,r.top+e.y+V/t)}screenToMap(C,H){let V=this.#l;if(!V||!this.#t.orthographic)return null;let e=this.#$();if(!e.width||!e.height)return null;let r=this.#N(),t=r[0],o=r[8],M=r[1],i=r[9],a=t*i-o*M;if(!Number.isFinite(a)||Math.abs(a)<1e-12)return null;let n=(C-e.left)/e.width*2-1-r[12],A=1-(H-e.top)/e.height*2-r[13],l=(n*i-o*A)/a,d=(t*A-n*M)/a,m=-l/V.metadata.metersPerCell+(V.metadata.span[0]-1)/2,u=d/V.metadata.metersPerCell+(V.metadata.span[1]-1)/2;return{x:(m+V.metadata.origin[0])*V.metadata.metersPerCell,y:(u+V.metadata.origin[1])*V.metadata.metersPerCell}}roomAt(C,H){let V=this.screenToMap(C,H),e=this.#l,r=this.#v;if(!V||!e||!r)return null;let t=V.x/e.metadata.metersPerCell-e.metadata.origin[0],o=V.y/e.metadata.metersPerCell-e.metadata.origin[1],M=e.metadata.rooms.find(i=>s0(t,o,i.boundary));return M?this.#a1(M,r):null}containsMapPoint(C){let H=this.#l;if(!H)return!1;let V=C.x/H.metadata.metersPerCell-H.metadata.origin[0],e=C.y/H.metadata.metersPerCell-H.metadata.origin[1];return H.metadata.rooms.some(r=>s0(V,e,r.boundary))}#a1(C,H){return(H.resources.plans.value?.rooms||H.resources.areas.value?.rooms||[]).find(e=>e.name.localeCompare(C.name,void 0,{sensitivity:"base"})===0)?.roomId||C.id}selectRoomAt(C,H){let V=this.roomAt(C,H);V&&this.#V.onRoom?.(V)}fit(C=!0){let H=this.#v?.view==="top"||this.#v?.workflow==="draw";this.#t=H?{yaw:0,pitch:Math.PI/2-.018,distance:this.#f,targetX:0,targetZ:0,orthographic:!0}:{yaw:-Math.PI/4,pitch:.82,distance:this.#x,targetX:0,targetZ:0,orthographic:!1},this.#g=!0,this.requestRender(),C&&this.#q()}zoomAt(C,H,V){let e=H===void 0||V===void 0?null:this.screenToMap(H,V),r=this.#R();if(this.#t={...this.#t,distance:B(this.#t.distance/C,r.minimum,r.maximum)},this.#g=!1,e&&H!==void 0&&V!==void 0){let t=this.screenToMap(H,V);t&&(this.#t={...this.#t,targetX:this.#t.targetX-(e.x-t.x),targetZ:this.#t.targetZ+(e.y-t.y)})}this.requestRender(),this.#q(H,V)}panBy(C,H){this.setCamera(this.cameraAfterPan(this.#t,C,H))}orbitBy(C,H){if(this.#t.orthographic){this.panBy(C,H);return}this.#t={...this.#t,yaw:U1(this.#t.yaw+C*.006),pitch:B(this.#t.pitch-H*.004,.18,1.38)},this.#g=!1,this.requestRender(),this.#q()}rotateBy(C){this.#t={...this.#t,yaw:U1(this.#t.yaw+C)},this.#g=!1,this.requestRender(),this.#q()}#q(C,H){let V=this.#t.orthographic?this.#f:this.#x,e=C===void 0||H===void 0?this.#P:this.#$(),r=C===void 0||H===void 0||!e.width||!e.height?void 0:{xPercent:B((C-e.left)/e.width*100,0,100),yPercent:B((H-e.top)/e.height*100,0,100)};this.#V.onCamera?.(this.camera,Math.round(V/this.#t.distance*100),r)}diagnostics(){return{mode:this.#Z,contextGeneration:this.#w,sceneRevision:this.#l?.revision??null,sourcePoints:this.#l?.total??0,renderedPoints:this.#b,lastFrameMs:Math.round(this.#F*100)/100,slowFrames:this.#k,cameraDistance:this.#t.distance,fitDistance:this.#t.orthographic?this.#f:this.#x,fitActive:this.#g}}#t1=C=>{C.preventDefault(),this.#C1(),this.#Y(),this.requestRender()};#M1=()=>{this.#C1(),this.#U(),this.requestRender()};#C1(){let C=this.#e;C&&(this.#a&&C.deleteBuffer(this.#a),this.#A&&C.deleteVertexArray(this.#A),this.#i&&C.deleteProgram(this.#i)),this.#a=null,this.#A=null,this.#i=null,this.#e=null}dispose(){this.#_||(this.#_=!0,this.#S.disconnect(),this.#C.removeEventListener("webglcontextlost",this.#t1),this.#C.removeEventListener("webglcontextrestored",this.#M1),this.#p!==null&&window.cancelAnimationFrame(this.#p),this.#p=null,this.#K(),this.#C1(),this.#o=null,this.#L=null,this.#r=null,this.#l=null,this.#v=null)}};var p0="component.matic_robot.common.",R=(L,C,H,V)=>{let e=V?{...V}:void 0,r=L?.(`${p0}${C}`,e);return r&&r!==`${p0}${C}`?r:V?Object.entries(V).reduce((t,[o,M])=>t.replaceAll(`{${o}}`,String(M)),H):H};var e1="matic-workspace-intent",m2="matic-workspace-action",m0="navigation-help",c0=(L,C)=>{let H=(e,r,t)=>R(C,e,r,t);if(L.dataMode==="history")return L.map.available?H("v4_saved_map_description","Saved read-only map for {floor}. Live robot position is hidden.",{floor:L.floor.displayName}):L.resources.scene.status==="loading"?H("v4_saved_map_loading_description","The saved map is loading."):H("v4_saved_map_unavailable_description","This saved map is unavailable.");if(!S1(L))return H("v4_private_map_unavailable","The current private map is not available.");let V=O5(L)?H("v4_robot_position_verified","The robot position is verified."):H("v4_robot_position_hidden","The robot position is not shown.");return H("v4_live_map_description","Live map for {floor}. {pose}",{floor:L.floor.displayName,pose:V})},i5=class extends k{constructor(){super();this.state=y();this.narrow=!1;this.#C=null;this.#H=null;this.#V=null;this.#e=!1;this.#r=!1;this.#L=null;this.#o=[];this.#i=null;this.#a=null;this.#A={capture:!0,handleEvent:H=>{H.pointerType==="touch"&&!H.isPrimary&&this.#u.cancel()}};this.#u=new d2(()=>this.state,()=>this.#H,H=>this.#s(H),()=>this.requestUpdate(),(H,V)=>this.#M(H,V),H=>{this.updateComplete.then(()=>{(this.renderRoot.querySelector(`[data-zone-index="${H}"]`)??this.renderRoot.querySelector(".map-root"))?.focus({preventScroll:!0})})});this.#v=()=>{this.#h()};new m1(this,{container:()=>this.renderRoot?.querySelector(".camera-steps")??null,items:"button"}),new m1(this,{container:()=>this.renderRoot?.querySelector(".draw-tools")??null,items:"button"})}static{this.properties={state:{attribute:!1},localize:{attribute:!1},narrow:{type:Boolean,reflect:!0}}}static{this.styles=[$,I,V1,w`
    :host {
      display: block;
      min-width: 0;
      min-height: 0;
...
.map-root { border: 1px solid CanvasText; }
  ...
  `]}#C;#H;#V;#e;#r;#L;#o;#i;#a;#A;#u;#M(H,V,e){return R(this.localize,H,V,e)}connectedCallback(){super.connectedCallback(),this.#l()}firstUpdated(){let H=this.renderRoot.querySelector(".map-root"),V=this.renderRoot.querySelector(".scene-canvas"),e=this.renderRoot.querySelector(".overlay-canvas");!H||!V||!e||(this.#H=new p2(V,e,{onViewport:()=>{this.#u.cancel(),this.requestUpdate()},onCamera:(r,t,o)=>{this.#s({type:"set-camera",view:this.state.workflow==="draw"?"top":this.state.view,camera:{yaw:r.yaw,pitch:r.pitch,zoom:t/100,targetX:r.targetX,targetZ:r.targetZ}}),this.state.workflow==="draw"&&t!==this.state.draw.zoomPercent&&this.#s({type:"set-zoom",value:t,...o?{originX:o.xPercent,originY:o.yPercent}:{}})},onRoom:r=>this.#s({type:"toggle-room",roomId:r}),onProblem:()=>this.#S("renderer-problem")}),this.#V=new l2(H,this.#H,{state:()=>this.state,onOutlinePoint:r=>this.#u.addPoint(r),onCircles:(r,t,o,M)=>this.#s({type:"set-draft-circles",circles:r,record:t,...o?{previous:o,previousOutline:M??null}:{},...!t&&o?{outline:M??null}:{}}),onRoom:r=>this.#s({type:"toggle-room",roomId:r})}),this.#H.setState(this.state),this.#h())}disconnectedCallback(){this.#p(),this.#u.cancel(),this.#V?.dispose(),this.#V=null,this.#H?.dispose(),this.#H=null,super.disconnectedCallback()}updated(H){this.#r&&(this.#r=!1,this.renderRoot.querySelector(".navigation-help button")?.focus()),H.has("state")&&(this.#H?.setState(this.state),this.state.draw.tool==="outline"&&this.requestUpdate())}#y(){let H=this.renderRoot?.querySelector(".map-root");!H||!this.#H||this.#H.setPalette(A0(H))}#h(){this.#n(),this.#i=window.requestAnimationFrame(()=>{this.#i=null,this.#a=window.setTimeout(()=>{this.#a=null,this.#y()},0)})}#n(){this.#i!==null&&window.cancelAnimationFrame(this.#i),this.#a!==null&&window.clearTimeout(this.#a),this.#i=null,this.#a=null}#v;#l(){if(!(typeof document>"u"||this.#L)&&(this.#L=new MutationObserver(this.#v),this.#L.observe(document.documentElement,{attributes:!0,attributeFilter:["style","class"]}),typeof window.matchMedia=="function")){this.#o=[window.matchMedia("(prefers-color-scheme: dark)"),window.matchMedia("(forced-colors: active)")];for(let H of this.#o)H.addEventListener("change",this.#v)}}#p(){this.#n(),this.#L?.disconnect(),this.#L=null;for(let H of this.#o)H.removeEventListener("change",this.#v);this.#o=[]}#s(H){this.dispatchEvent(new CustomEvent(e1,{detail:H,bubbles:!0,composed:!0}))}#S(H){this.dispatchEvent(new CustomEvent(m2,{detail:{id:H},bubbles:!0,composed:!0}))}#t(H){this.#C=H.currentTarget,this.#e=!this.#e,this.#r=this.#e,this.requestUpdate()}#x(){if(!this.#e)return;this.#e=!1,this.requestUpdate();let H=this.#C;H?.isConnected&&H.focus()}#f(){for(let H of this.state.selection.roomIds)this.#s({type:"toggle-room",roomId:H})}#d(H,V){this.#H?.orbitBy(H,V)}#m(H){if(!A2(H)&&!(H.ctrlKey||H.metaKey||H.altKey)&&H.key==="Escape"){if(H.preventDefault(),this.#e){this.#x();return}this.#s({type:"dismiss-top-layer"});return}}rendererDiagnostics(){return this.#H?.diagnostics()??null}canvasIdentity(){return{scene:this.renderRoot.querySelector(".scene-canvas"),overlay:this.renderRoot.querySelector(".overlay-canvas")}}#c(){return this.state.host.connected?this.state.host.administrator?this.state.host.robotCount===0?{title:this.#M("v4_no_robot","No Matic robot set up"),detail:this.#M("v4_no_robot_detail","Set up a robot before opening its map.")}:this.state.dataMode==="history"?!this.state.map.available&&this.state.resources.scene.status==="loading"?{title:this.#M("v4_loading_saved_map","Loading saved map"),detail:this.#M("v4_loading_saved_map_detail","This read-only snapshot is still preparing.")}:this.state.map.available?null:{title:this.#M("v4_saved_map_unavailable","Saved map unavailable"),detail:this.#M("v4_saved_map_unavailable_detail","Choose another snapshot or return to the live map.")}:this.state.host.robotConnected?this.state.coherence==="verifying"||this.state.coherence==="booting"?{title:this.#M("v4_locating_map","Locating the current map"),detail:this.#M("v4_locating_map_detail","Map controls will return after the floor is verified.")}:!this.state.map.available&&this.state.resources.scene.status==="loading"?{title:this.#M("v4_loading_verified_map","Loading the verified map"),detail:this.#M("v4_loading_verified_map_detail","The current floor is verified. The private scene is still preparing.")}:this.state.map.available?this.state.activity==="problem"?{title:this.#M("v4_robot_attention","Robot needs attention"),detail:this.#M("v4_robot_attention_detail","Check the robot before starting another task.")}:null:{title:this.#M("v4_map_unavailable","Map unavailable"),detail:this.#M("v4_map_unavailable_detail","The private scene is not ready. No map data is shown until it is verified.")}:{title:this.#M("v4_robot_offline","Robot offline"),detail:this.#M("v4_robot_offline_detail","The last verified map stays read only and has no live position.")}:{title:this.#M("v4_admin_required","Administrator access required"),detail:this.#M("v4_private_map_hidden","Private map data is hidden.")}:{title:this.#M("v4_reconnecting","Reconnecting"),detail:this.#M("v4_reconnecting_detail","The verified map is read only until Home Assistant reconnects.")}}#Z(H,V){let e=this.state,r=this.narrow,t=e.workflow==="draw",o=this.#M("v4_how_to_move","How to move the map"),M=H&&!t,i=M&&!r&&e.view==="top",a=M&&e.view==="three",n=!V,A=!r&&!t;return p`
    ...
    `}#w(H){let V=this.state;if(!H)return s;if(V.workflow==="draw"&&!this.narrow)return p`
      ...
      `:s}render(){let H=this.state,V=P5(H),e=this.#c(),r=H.map.available&&(S1(H)||H.dataMode==="history"),t=H.workflow==="draw"&&r,o=H.coherence==="verifying"||H.coherence==="booting";return p`
      <section
        class="map-root"
        tabindex="0"
...
`]}#C(H,V){return R(this.localize,H,V)}#H(H){this.dispatchEvent(new CustomEvent(e1,{detail:H,bubbles:!0,composed:!0}))}#V(H){let V=H.currentTarget.valueAsNumber;Number.isFinite(V)&&this.#H({type:"set-brush",value:V})}render(){let{draw:H}=this.state;return p`
    ...
    `}};customElements.get(W1)||customElements.define(W1,a5);var v0={ATTRIBUTE:1,CHILD:2,PROPERTY:3,BOOLEAN_ATTRIBUTE:4,EVENT:5,ELEMENT:6},u0=L=>(...C)=>({_$litDirective$:L,values:C}),c2=class{constructor(C){}get _$AU(){return this._$AM._$AU}_$AT(C,H,V){this._$Ct=C,this._$AM=H,this._$Ci=V}_$AS(C,H){return this.update(C,H)}update(C,H){return this.render(...H)}};var{I:Q7}=L3,x0=L=>L;var h0=()=>document.createComment(""),w1=(L,C,H)=>{let V=L._$AA.parentNode,e=C===void 0?L._$AB:C._$AA;if(H===void 0){let r=V.insertBefore(h0(),e),t=V.insertBefore(h0(),e);H=new Q7(r,t,L,L.options)}else{let r=H._$AB.nextSibling,t=H._$AM,o=t!==L;if(o){let M;H._$AQ?.(L),H._$AM=L,H._$AP!==void 0&&(M=L._$AU)!==t._$AU&&H._$AP(M)}if(r!==e||o){let M=H._$AA;for(;M!==r;){let i=x0(M).nextSibling;x0(V).insertBefore(M,e),M=i}}}return H},r1=(L,C,H=L)=>(L._$AI(C,H),L),q7={},Z0=(L,C=q7)=>L._$AH=C,S0=L=>L._$AH,v2=L=>{L._$AR(),L._$AA.remove()};var f0=(L,C,H)=>{let V=new Map;for(let e=C;e<=H;e++)V.set(L[e],e);return V},g0=u0(class extends c2{constructor(L){if(super(L),L.type!==v0.CHILD)throw Error("repeat() can only be used in text expressions")}dt(L,C,H){let V;H===void 0?H=C:C!==void 0&&(V=C);let e=[],r=[],t=0;for(let o of L)e[t]=V?V(o,t):t,r[t]=H(o,t),t++;return{values:r,keys:e}}render(L,C,H){return this.dt(L,C,H).values}update(L,[C,H,V]){let e=S0(L),{values:r,keys:t}=this.dt(C,H,V);if(!Array.isArray(e))return this.ut=t,r;let o=this.ut??=[],M=[],i,a,n=0,A=e.length-1,l=0,d=r.length-1;for(;n<=A&&l<=d;)if(e[n]===null)n++;else if(e[A]===null)A--;else if(o[n]===t[l])M[l]=r1(e[n],r[l]),n++,l++;else if(o[A]===t[d])M[d]=r1(e[A],r[d]),A--,d--;else if(o[n]===t[d])M[d]=r1(e[n],r[d]),w1(L,M[d+1],e[n]),n++,d--;else if(o[A]===t[l])M[l]=r1(e[A],r[l]),w1(L,e[n],e[A]),A--,l++;else if(i===void 0&&(i=f0(t,l,d),a=f0(o,n,A)),i.has(o[n]))if(i.has(o[A])){let m=a.get(t[l]),u=m!==void 0?e[m]:null;if(u===null){let h=w1(L,e[n]);r1(h,r[l]),M[l]=h}else M[l]=r1(u,r[l]),w1(L,e[n],u),e[m]=null;l++}else v2(e[A]),A--;else v2(e[n]),n++;for(;l<=d;){let m=w1(L,M[d+1]);r1(m,r[l]),M[l++]=m}for(;n<=A;){let m=e[n++];m!==null&&v2(m)}return this.ut=t,Z0(L,M),j}});var n5=["vacuum","mop","vacuum_and_mop"],l5=["quick","standard","heavy_duty"],W=L=>L.currentTarget.value,y0=L=>L.currentTarget.checked,A5=class extends k{constructor(){super(...arguments);this.state=y();this._copyStatus="idle"}static{this.properties={state:{attribute:!1},localize:{attribute:!1},_copyStatus:{state:!0}}}static{this.styles=[$,I,V1,w`
    ...
    `}#u(H){let V=this.state.planDraft.rooms,r=V.find(t=>t.roomId===H)?V.filter(t=>t.roomId!==H):[...V,{roomId:H,cleaningMode:"vacuum",coverageSetting:"standard"}];this.#r({type:"patch-plan-draft",patch:{rooms:r}})}#M(H,V){let e=this.state.planDraft.rooms.map((r,t)=>t===H?{...r,...V}:r);this.#r({type:"patch-plan-draft",patch:{rooms:e}})}#y(H,V){let e=H+V,r=[...this.state.planDraft.rooms];if(e<0||e>=r.length)return;let[t]=r.splice(H,1);t&&(r.splice(e,0,t),this.#r({type:"patch-plan-draft",patch:{rooms:r}}))}#h(){let H=this.state.resources.plans,V=H.value,e=this.state.planDraft,r=e.rooms.map(i=>({room:i,label:V?.rooms.find(a=>a.roomId===i.roomId)?.name||"Room",selected:!0})),t=(V?.rooms||[]).filter(i=>!e.rooms.some(a=>a.roomId===i.roomId)).map(i=>({room:{roomId:i.roomId,cleaningMode:"vacuum",coverageSetting:"standard"},label:i.name,selected:!1})),o=[...r,...t],M=new Set(e.rooms.map(i=>`${i.cleaningMode}:${i.coverageSetting}`)).size>1;return this.#i(H.status,H.problem,p`
      <div class="stack">
        ...
        <div class="list" role="group" aria-labelledby="plan-rooms-heading">
          ${g0(o,({room:i})=>i.roomId,({room:i,label:a,selected:n})=>{let A=n?e.rooms.findIndex(l=>l.roomId===i.roomId):-1;return p`
              <div class="room plan-room ms-row ms-row--stack" data-selected=${String(n)}>
                <div class="room-choice">
                  ...
                  ${n?p`
                    <span>
                      <button class="icon-button ms-btn ms-btn--icon" type="button" aria-label=${this.#H("move_room_up","Move {room} earlier",{room:a})} ?disabled=${A===0} @click=${l=>{l.preventDefault(),this.#y(A,-1)}}>${Z(V0)}</button>
                      <button class="icon-button ms-btn ms-btn--icon" type="button" aria-label=${this.#H("move_room_down","Move {room} later",{room:a})} ?disabled=${A===e.rooms.length-1} @click=${l=>{l.preventDefault(),this.#y(A,1)}}>${Z(L0)}</button>
                    </span>
                  `:s}
                </div>
                ${n?p`
                  <div class="split room-settings">
                    <label class="field ms-field">${this.#H("v4_cleaning_system","Cleaning system")}
                      <select aria-label=${this.#H("v4_room_cleaning_system_named","Cleaning system for {room}",{room:a})} .value=${i.cleaningMode} @change=${l=>this.#M(A,{cleaningMode:W(l)})}>${n5.map(l=>p`<option value=${l} ?selected=${l===i.cleaningMode}>${this.#V(l)}</option>`)}</select>
                    </label>
                    <label class="field ms-field">${this.#H("cleaning_mode","Cleaning mode")}
                      <select aria-label=${this.#H("v4_room_cleaning_mode_named","Cleaning mode for {room}",{room:a})} .value=${i.coverageSetting} @change=${l=>this.#M(A,{coverageSetting:W(l)})}>${l5.map(l=>p`<option value=${l} ?selected=${l===i.coverageSetting}>${this.#e(l)}</option>`)}</select>
                    </label>
                  </div>
                `:s}
              </div>
        ...
        <div class="timeline">
          <label class="field ms-field">${this.#H("map_timeline_label","Map timeline")}
            <input
              ...
              step="1"
              .value=${String(t)}
              aria-valuetext=${M?this.#p(M.createdAt):o}
              ?disabled=${!r.length}
...
`),e=typeof navigator>"u"?void 0:navigator.clipboard;if(e&&typeof e.writeText=="function")try{await e.writeText(V),this.#S("copied");return}catch{}this.#S(this.#t(V,H instanceof HTMLElement?H:null)?"copied":"failed")}#f(){let H=this.#s(),V=this._copyStatus==="copied"?this.#H("v4_copied","Copied"):this._copyStatus==="failed"?this.#H("v4_copy_failed","The summary could not be copied. Select the text to copy it by hand."):"";return p`
    ...
    `}#K(H){let V=H.resources.plans.value?.rooms??H.resources.areas.value?.rooms??[];return H.selection.roomIds.map(e=>V.find(r=>r.roomId===e)?.name??e)}#$(H,V,e){let r=V?.enabled&&H.workflow==="rooms"&&V.id==="clean-rooms"?[this.#K(H).join(", "),H.planDraft.returnToBase?this.#C("v4_returns_to_dock","returns to the dock"):""].filter(Boolean).join(" \xB7 "):"";return x`
      <div class="action-bar">
        ${r?x`<p class="action-summary">${r}</p>`:s}
        ${V?this.#W(V,"ms-btn ms-btn--block ms-btn--lg ms-btn--primary","primary-reason"):s}
        ${e?this.#W(e,"ms-btn ms-btn--block ms-btn--lg ms-btn--secondary","secondary-reason"):s}
      </div>
    `}#z(H,V,e=s){return x`
    ...
    `}#V1(H){let V=H.resources.history.value?.floors||[],e=V.length?V.map((r,t)=>({id:r.active?"current":r.id,label:`${r.label||(r.active?this.#C("v4_current_floor","Current floor"):this.#C("v4_saved_floor","Saved floor {number}",{number:r.ordinal??t+1}))}${!r.active&&r.snapshots.length===0?` \xB7 ${this.#C("v4_floor_not_captured","Visit floor to capture")}`:""}`,disabled:!r.active&&r.snapshots.length===0})):[{id:H.selection.floorId,label:H.floor.displayName,disabled:!1}];return x`
      ...
      `)}</select>
    `}#L1(H,V){let e=(S,O,g)=>this.#C(S,O,g),r=this.#N(e("v4_map_history","Map history"),r5,()=>this.#l("history"),e("v4_map_history_detail","Saved maps are floor-scoped and read only.")),t=this.#N(e("v4_map_diagnostics","Map diagnostics"),r0,()=>this.#l("support"),e("v4_map_support_detail","Private geometry is never included.")),{host:o}=H;if(!o.connected)return this.#z(e("v4_reconnecting_title","Reconnecting to Home Assistant"),e("v4_reconnecting_body","The last verified map stays read-only until the connection returns."));if(!o.administrator)return this.#z(e("v4_admin_title","Administrator access required"),e("v4_admin_body","Ask a Home Assistant administrator to open this map."));if(o.robotCount===0)return this.#z(e("v4_no_robot_title","No Matic robot set up"),e("v4_no_robot_body","Add the Matic integration to see a map here."),x`<a class="ms-btn ms-btn--secondary" href="/config/integrations/integration/matic_robot">${e("v4_open_integration","Open the Matic integration")}</a>`);if(!o.robotConnected)return x`
        ${this.#z(e("v4_robot_offline_title","Robot offline"),e("v4_robot_offline_body","Showing the last verified map. Cleaning is unavailable until the robot reconnects."))}
        <h3 class="shelf-heading">${e("v4_more","Map tools")}</h3>
        <div class="shelf">${r}${t}</div>
      `;if(P0(H))return x`
        ${this.#z(e("v4_saved_map_read_only_notice","Cleaning is unavailable on a saved map"),e("v4_saved_map_read_only_notice_detail","Saved maps are view only. Return to the live map below to choose rooms, run a plan, or draw a custom area."))}
        <h3 class="shelf-heading">${e("v4_more","Map tools")}</h3>
        <div class="shelf">
          ${r}
          ${t}
      ...
      `;let M=H.coherence==="verifying"||H.coherence==="booting",i=H.resources.plans,a=i.value,n=a!==null&&a.rooms.length===0,A=a?.plans.length??0,l=i.status==="loading",d=i.status==="error",m=M||n,u=M?e("v4_reason_locating","Waiting for the robot to confirm which floor it is on."):n?e("v4_no_rooms_reason","This floor has no named rooms yet."):null,h=M?e("v4_reason_locating","Waiting for the robot to confirm which floor it is on."):null,f=M?e("v4_reason_locating","Waiting for the robot to confirm which floor it is on."):e("v4_areas_quick_detail","Sketch a one-time zone on the map");return x`
      ${H.activity==="problem"?this.#z(e("v4_attention_title","The robot needs attention"),e("v4_attention_body","Check the robot, then start a new task.")):x`
      ...
      <h3 class="shelf-heading">${e("v4_more","Map tools")}</h3>
      <div class="shelf">
        ${this.#N(e("v4_custom_areas","Clean a custom area"),a2,()=>this.#l("draw"),f,M)}
        ${r}
    ...
    ></${O0}>`}#J(H,V){let e=w0(H,this.localize);return x`
      ...
      ${this.#e1(H,V)}
    `}#Q(H,V){let r=w0(H,this.localize).title;return H.workflow==="rooms"&&H.selection.roomIds.length&&(r=`${this.#C("v4_rooms_selected","Rooms selected: {count}",{count:H.selection.roomIds.length})} \xB7 ${this.#K(H).join(", ")}`),this._sheetDetent!=="peek"?V.detail?`${V.title} \xB7 ${V.detail}`:V.title:V.notable?`${V.title} \xB7 ${r}`:r}#I(){let H=(V,e)=>this.#C(V,e);return x`
    ...
    `}render(){let H=this.state,V=H.narrowHint||this._measuredNarrow,e=X7(H,this.localize),r=$2({...H,narrowHint:V}),t=k5(H),o=!V&&r.id==="stop"?r:!V&&t?.id==="stop"?t:null,M=o&&o===r?null:r,i=H.workflow==="draw"&&H.dataMode==="live"?{id:"clear-draft",label:"Clear drawing",labelKey:"v4_clear_drawing",kind:"neutral",enabled:H.draw.circles.length>0||!!H.draw.outline?.points.length}:null,a=o&&o===t?null:t??i,n=H.fullMap&&(H.coherence==="verifying"||H.coherence==="booting"),A=H.fullMap||H.host.administrator&&H.host.robotCount>0&&H.map.available,l=V4(H.dialog,this.localize,H.workflow==="plan"),d=V&&!H.fullMap?`--map-sheet-offset:${this._sheetOffset}px`:"--map-sheet-offset:0px",m=V&&H.workflow==="draw",u=H.precisionOpen&&H.workflow==="draw";return x`
          ...
          <main class=${`workspace ${H.fullMap?"full-map":""}`} style=${d}>
            ...
            >
              ${V?x`
                ...
                ${m?x`
                  <div class="sheet-tools">
                    ${n2(H,{intent:h=>this.#n(h),openBrush:()=>this.#E(),t:(h,f)=>this.#C(h,f)},"grid")}
                    ${u?x`
                      <div class="precision-popover">
              ...
              `:x`
                <div class="status-strip">
                  ...
                  ${o?this.#W(o,"status-action ms-btn ms-btn--secondary","status-reason"):s}
                </div>
            ...
            ${H.fullMap?x`
              ...
              >
                ...
                ${n&&r.id!=="stop"?s:this.#W(r,"ms-btn ms-btn--lg ms-btn--primary","hud-reason")}
                ${t&&(!n||t.id==="stop")?this.#W(t,"ms-btn ms-btn--lg ms-btn--secondary","hud-secondary-reason"):s}
              </section>
            `:s}
          </main>
        </div>
...
`,h2=class{#C=null;#H=null;#V=0;#e=new Map;constructor(){if(!(typeof Worker!="function"||typeof URL?.createObjectURL!="function"))try{this.#H=URL.createObjectURL(new Blob([d4()],{type:"text/javascript"})),this.#C=new Worker(this.#H),this.#C.onmessage=C=>{let H=this.#e.get(C.data.id);H&&(this.#e.delete(C.data.id),C.data.ok&&C.data.parsed?H.resolve(C.data.parsed):H.reject(new c(C.data.problem||"invalid-scene")))},this.#C.onerror=()=>this.#r("scene-worker-failed")}catch{this.#C=null,this.#H&&URL.revokeObjectURL(this.#H),this.#H=null}}async parse(C,H){if(H?.aborted)throw new DOMException("Aborted","AbortError");if(!this.#C){if(await new Promise(e=>window.setTimeout(e,0)),H?.aborted)throw new DOMException("Aborted","AbortError");return s4(C)}let V=++this.#V;return new Promise((e,r)=>{let t=()=>{this.#e.delete(V),r(new DOMException("Aborted","AbortError"))};H?.addEventListener("abort",t,{once:!0}),this.#e.set(V,{resolve:o=>{H?.removeEventListener("abort",t),e(o)},reject:o=>{H?.removeEventListener("abort",t),r(o)}}),this.#C?.postMessage({id:V,buffer:C},[C])})}#r(C){for(let H of this.#e.values())H.reject(new c(C));this.#e.clear(),this.#C?.terminate(),this.#C=null}dispose(){this.#r("scene-parser-disposed"),this.#H&&URL.revokeObjectURL(this.#H),this.#H=null}};var J={catalog:1e4,scene:6e4,delta:35e3,pose:1e4,history:15e3,workflow:15e3,mutation:2e4},F=class extends Error{constructor(C,H=null){super(C),this.name="BackendError",this.code=C,this.status=H}},G1=36,P1=16*1024*1024,q0=(L,C)=>{let H=Number(L);if(!Number.isSafeInteger(H)||H<0)throw new c(C);return H},X0=(L,C)=>{let H=L.headers.get("X-Matic-Revision");if(H===null)return C;let V=Number(H);if(!Number.isSafeInteger(V)||V<0)throw new c("invalid-scene-revision");return V},j0=(L,C)=>{let H=L.headers.get("X-Matic-Floor-Coherent");if(H===null)return C;if(H==="1")return!0;if(H==="0")return!1;throw new c("invalid-scene-floor-header")},Z2=class{#C;#H=new h2;constructor(C){this.#C=C}async#V(C,H){let V=C.body?.getReader();if(!V)return new ArrayBuffer(0);let e=()=>{V.cancel().catch(()=>{})};H.addEventListener("abort",e,{once:!0});try{if(H.aborted)throw e(),new DOMException("Aborted","AbortError");let r=[],t=0;for(;;){let i=await V.read();if(H.aborted)throw new DOMException("Aborted","AbortError");if(i.done)break;r.push(i.value),t+=i.value.byteLength}let o=new Uint8Array(t),M=0;for(let i of r)o.set(i,M),M+=i.byteLength;return o.buffer}finally{H.removeEventListener("abort",e),V.releaseLock()}}async#e(C,H,V,e,r){if(!K0(C))throw new F("invalid-private-path");if(e?.aborted)throw new DOMException("Aborted","AbortError");let t=new AbortController,o=()=>{},M=new Promise((A,l)=>{o=l}),i=()=>{t.abort(),o(new DOMException("Aborted","AbortError"))};e?.addEventListener("abort",i,{once:!0});let a=!1,n=window.setTimeout(()=>{a=!0,i()},V);try{let A=this.#C(),l=new Headers(H.headers),d={...H,cache:"no-store",credentials:"same-origin",headers:Object.fromEntries(l.entries()),signal:t.signal},m=async()=>{let u;if(typeof A?.fetchWithAuth=="function")u=await A.fetchWithAuth(C,d);else{let h=A?.auth?.accessToken||A?.auth?.data?.access_token;h&&l.set("Authorization",`Bearer ${h}`);let f=typeof A?.hassUrl=="function"?A.hassUrl(C):C;u=await fetch(f,{...d,headers:l})}try{if(t.signal.aborted)throw new DOMException("Aborted","AbortError");return await r(u,t.signal)}finally{u.body&&!u.body.locked&&u.body.cancel().catch(()=>{})}};return await Promise.race([m(),M])}catch(A){throw a&&!e?.aborted?new F("request-timeout"):t.signal.aborted?new DOMException("Aborted","AbortError"):A}finally{window.clearTimeout(n),e?.removeEventListener("abort",i)}}async#r(C,H,V,e={}){return this.#e(C,{...e,headers:{Accept:"application/json",...e.headers||{}}},H,V,async(r,t)=>{if(!r.ok){let o=r.headers.get("X-Matic-Plans-Conflict");throw new F(o==="map-rechecking"?"map-rechecking":"request-failed",r.status)}try{return JSON.parse(new TextDecoder().decode(await this.#V(r,t)))}catch{throw new c("invalid-json-response")}})}async catalog(C){return F0(await this.#r(T0,J.catalog,C))}async scene(C,H,V,e,r,t){let o=new Headers({Accept:"application/vnd.matic.slam-scene"});return e==="live"&&o.set("X-Matic-Prefer-Cached","1"),t&&o.set("If-None-Match",t),this.#e(C,{headers:o},J.scene,r,async(M,i)=>{let a=X0(M,H),n=j0(M,V);if(M.status===304)return{scene:null,floorCoherent:n,revision:a,notModified:!0};if(!M.ok)throw new F("scene-request-failed",M.status);if(M.headers.get("Content-Type")?.split(";",1)[0]!=="application/vnd.matic.slam-scene")throw new c("invalid-scene-content-type");return{scene:{...await this.#H.parse(await this.#V(M,i),i),revision:a,etag:M.headers.get("ETag"),source:e},floorCoherent:n,revision:a,notModified:!1}})}async#L(C,H,V){if(!Number.isSafeInteger(H)||H<1||H>P1||typeof DecompressionStream!="function")throw new c("invalid-scene-delta");let r=new Blob([C]).stream().pipeThrough(new DecompressionStream("deflate")).getReader(),t=new Uint8Array(H),o=0,M=()=>{r.cancel()};V?.addEventListener("abort",M,{once:!0});try{for(;;){if(V?.aborted)throw new DOMException("Aborted","AbortError");let{done:i,value:a}=await r.read();if(i)break;if(!(a instanceof Uint8Array)||o+a.byteLength>H)throw new c("invalid-scene-delta");t.set(a,o),o+=a.byteLength}}finally{V?.removeEventListener("abort",M),r.releaseLock()}if(o!==H)throw new c("invalid-scene-delta");return t}async#o(C,H,V){if(C.byteLength<G1||C.byteLength>G1+P1||H.buffer.byteLength>P1)throw new c("invalid-scene-delta");let e=new DataView(C),r=new TextDecoder().decode(new Uint8Array(C,0,8)),t=e.getUint16(8,!0),o=e.getUint16(10,!0),M=q0(e.getBigUint64(12,!0),"invalid-scene-delta"),i=q0(e.getBigUint64(20,!0),"invalid-scene-delta"),a=e.getUint32(28,!0),n=e.getUint32(32,!0);if(r!=="MATICDLT"||t!==1||o!==1||M!==H.revision||i<=H.revision||a<x2||a>P1||n>P1||n+G1!==C.byteLength)throw new c("invalid-scene-delta");let A=new Uint8Array(C,G1,n),l=new Uint8Array(H.buffer),m=(await this.#L(A,Math.max(l.byteLength,a),V)).slice(),u=1024*1024;for(let S=0;S<l.byteLength;S+=u){if(V?.aborted)throw new DOMException("Aborted","AbortError");let O=Math.min(l.byteLength,S+u);for(let g=S;g<O;g+=1)m[g]=(m[g]??0)^(l[g]??0);O<l.byteLength&&await new Promise(g=>window.setTimeout(g,0))}let h=m.slice(0,a).buffer;return{parsed:{...await this.#H.parse(h,V),revision:i,etag:null,source:"live"},revision:i}}async sceneDelta(C,H,V,e){let r=C.includes("?")?"&":"?";return this.#e(`${C}${r}since=${encodeURIComponent(H.revision)}`,{headers:{Accept:"application/vnd.matic.slam-delta, application/vnd.matic.slam-scene"}},J.delta,e,async(t,o)=>{let M=X0(t,H.revision),i=j0(t,V);if(t.status===204){if(M!==H.revision)throw new c("invalid-scene-delta-revision");return{scene:null,floorCoherent:i,revision:M,notModified:!0}}if(!t.ok)throw new F("delta-request-failed",t.status);if(M<=H.revision)throw new c("invalid-scene-delta-revision");let a=Number(t.headers.get("Content-Length"));if(Number.isFinite(a)&&a>G1+P1)throw new c("invalid-scene-delta-size");let n=t.headers.get("Content-Type")?.split(";",1)[0],A=await this.#V(t,o);if(n==="application/vnd.matic.slam-delta"){let d=Number(t.headers.get("X-Matic-Base-Revision"));if(!Number.isSafeInteger(d)||d!==H.revision)throw new c("invalid-scene-delta-base");let m=await this.#o(A,H,o);if(m.revision!==M)throw new c("invalid-scene-delta-revision");return{scene:{...m.parsed,etag:t.headers.get("ETag")},floorCoherent:i,revision:M,notModified:!1}}if(n!=="application/vnd.matic.slam-scene")throw new c("invalid-scene-delta-content-type");return{scene:{...await this.#H.parse(A,o),revision:M,etag:t.headers.get("ETag"),source:"live"},floorCoherent:i,revision:M,notModified:!1}})}async pose(C,H){return G0(await this.#r(C,J.pose,H))}async history(C,H){return I0(await this.#r(C,J.history,H))}async plans(C,H){return U0(await this.#r(C,J.workflow,H))}async areas(C,H){return N0(await this.#r(C,J.workflow,H))}async saveArea(C,H,V){let e=await this.#r(C,J.mutation,V,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({...H.areaId?{area_id:H.areaId}:{},name:H.name,circles:H.circles,...H.outline?.closed?{outline:H.outline.points}:{},cleaning_mode:H.cleaningMode,coverage_setting:H.coverageSetting})});if(!e||typeof e!="object"||typeof e.id!="string")throw new c("invalid-area-save-response");return e.id}async deleteArea(C,H,V){await this.#e(`${C}?area_id=${encodeURIComponent(H)}`,{method:"DELETE",headers:{Accept:"application/json"}},J.mutation,V,async e=>{if(!e.ok)throw new F("area-delete-failed",e.status)})}async service(C,H,V,e){let r=this.#C();if(typeof r?.callService!="function")throw new F("service-unavailable");await r.callService(C,H,V,{entity_id:e})}dispose(){this.#H.dispose()}};var J0=()=>({version:4,view:"top",appearance:"photo",labels:!0,quality:"auto",cameras:{}}),K1=(L,C,H)=>Math.max(C,Math.min(H,L)),C7=L=>L.replaceAll(/[^a-zA-Z0-9_-]/g,"").slice(0,128)||"local-user",v5=(L,C=4)=>`matic-map-studio:v${C}:${C7(L)}`,p4=L=>{if(!L||typeof L!="object")return null;let C=L;return["yaw","pitch","zoom","targetX","targetZ"].every(V=>typeof C[V]=="number"&&Number.isFinite(C[V]))?{yaw:K1(C.yaw,-Math.PI,Math.PI),pitch:K1(C.pitch,.18,Math.PI/2-.018),zoom:K1(C.zoom,.01,100),targetX:K1(C.targetX,-1e4,1e4),targetZ:K1(C.targetZ,-1e4,1e4)}:null},Y0=L=>{let C=J0();if(!L||typeof L!="object")return C;let H=L,V=H.view==="three"||H.view==="top"||H.view==="rooms"?H.view:C.view,e=V==="rooms"?"top":V,r=H.quality==="auto"||H.quality==="efficient"||H.quality==="balanced"||H.quality==="maximum"?H.quality:C.quality,t=H.cameras&&typeof H.cameras=="object"?H.cameras:{},o={};for(let M of["three","top"]){let i=p4(t[M]);i&&(o[M]=i)}return{version:4,view:e,appearance:H.appearance==="rooms"||H.appearance==="photo"?H.appearance:C.appearance,labels:typeof H.labels=="boolean"?H.labels:C.labels,quality:r,cameras:o}},S2=class{#C="local-user";#H=null;#V=null;load(C){this.#e(),this.#C=C7(C);try{let H=window.localStorage.getItem(v5(this.#C));if(H)return Y0(JSON.parse(H));for(let V of[3,2]){let e=window.localStorage.getItem(v5(this.#C,V));if(e)return Y0(JSON.parse(e))}}catch{}return J0()}schedule(C){this.#H!==null&&window.clearTimeout(this.#H),this.#V={key:v5(this.#C),value:C},this.#H=window.setTimeout(()=>this.#e(),250)}#e(){this.#H!==null&&window.clearTimeout(this.#H),this.#H=null;let C=this.#V;if(this.#V=null,!!C)try{window.localStorage.setItem(C.key,JSON.stringify(C.value))}catch{}}dispose(){this.#e()}},H7="matic-map-studio:preferred-frontend",V7=()=>{try{return window.localStorage.getItem(H7)==="v3"?"v3":"v4"}catch{return"v4"}},u5=L=>{try{return window.localStorage.setItem(H7,L),!0}catch{return!1}};var v=(L,C,H=null)=>({status:L,value:C,problem:H}),G=L=>L instanceof DOMException&&L.name==="AbortError",c1=(L,C)=>L instanceof F||L&&typeof L=="object"&&"code"in L&&typeof L.code=="string"?L.code:C,f2=L=>[L.selectedFloorOrdinal??"none",L.mapFloorOrdinal??"none",L.mapFloorCoherent?"coherent":"transition"].join(":"),g2=L=>[L.mapFloorOrdinal??"none",L.mapSessionVerified?"verified":"unverified",L.mapSessionKey??"no-session"].join(":"),K=L=>[L.entryId,L.selectedFloorOrdinal??"none",L.mapFloorOrdinal??"none"].join("|"),L7=L=>[L.entryId,f2(L),g2(L),L.mapRevision].join("|"),e7=L=>L.runnerLocked||L.stopSettlePending||L.activePlan||L.nativeReconciliationPending||L.nativeSessionActive===!0,m4=(L,C)=>L.entryKey===C.entryKey&&L.generation===C.generation&&L.floorKey===C.floorKey&&L.missionKey===C.missionKey,r7="Live map updates paused while the current map is rechecked.",t7="Reconnecting. The last verified map remains read only.",c4=1e3,v4=["rooms","plan","draw","areaReview"],x5=(L,C)=>L.label?L.label:L.active?"Current floor":`Saved floor ${L.ordinal??C}`,y2=class{#C;#H=new X1;#V;#e=new S2;#r=new Map;#L=null;#o;#i=null;#a=null;#A=null;#u=0;#M=!1;#y=!1;#h=!1;#n=Promise.resolve();#v=!1;#l=!1;#p="";#s=0;#S="";#t=!1;#x=!0;constructor(C,H){this.#C=C,this.#V=H}sync(C,H){if(this.#t)return;let V=this.#C.value.owner;V&&(V.entryKey!==C.entryKey||V.userKey!==C.userKey)&&(this.#b("context-changed"),this.#M&&(this.#h=!0));let e=this.#x;if(this.#x=C.host.connected,this.#L=C,this.#o=H,this.#C.patch({owner:{userKey:C.userKey,entryKey:C.entryKey},host:C.host,activity:C.activity,batteryPercent:C.batteryPercent,robotLabel:C.robotLabel,robots:C.robots,locale:C.language}),C.userKey!==this.#S){this.#S=C.userKey;let r=this.#e.load(C.userKey);this.#C.patch({view:r.view,appearance:r.appearance,labelsVisible:r.labels,quality:r.quality,cameras:r.cameras})}if(!C.host.administrator){this.#d(),this.#b("access-required");return}if(!C.host.connected){this.#d(),this.#h=!1,this.#l=!1,this.#Z();let r=this.#C.value,t=r.resources.scene.value;this.#C.patch({coherence:t?"degraded":"unavailable",resources:{...r.resources,catalog:r.resources.catalog.status==="loading"?v("idle",r.resources.catalog.value):r.resources.catalog,plans:r.resources.plans.status==="loading"?v("idle",r.resources.plans.value):r.resources.plans,areas:r.resources.areas.status==="loading"?v("idle",r.resources.areas.value):r.resources.areas,pose:v("idle",null)},map:{...r.map,available:t!==null,exactPose:!1},notice:t?{tone:"warning",text:t7}:r.notice});return}if(C.host.robotCount===0){this.#d(),this.#b("map-unavailable");return}if(this.#f(),!e){this.#C.value.notice?.text===t7&&this.#C.patch({notice:null}),this.refreshCatalog(!0);return}(this.#C.value.resources.catalog.status==="idle"||C.entryKey&&C.entryKey!==this.#C.value.selection.entryId)&&this.refreshCatalog(!0)}schedulePreferences(C){this.#e.schedule(C)}#f(){this.#i===null&&(this.#i=window.setInterval(()=>{document.visibilityState==="visible"&&this.refreshCatalog()},5e3)),this.#a===null&&(this.#a=window.setInterval(()=>{document.visibilityState==="visible"&&this.refreshPose()},c4))}#d(){this.#i!==null&&window.clearInterval(this.#i),this.#a!==null&&window.clearInterval(this.#a),this.#i=null,this.#a=null}#m(C){this.#r.get(C)?.abort();let H=new AbortController;return this.#r.set(C,H),H}#c(C,H){this.#r.get(C)===H&&this.#r.delete(C)}#Z(C=[]){let H=!1;for(let[V,e]of this.#r)C.includes(V)||(H||=V==="plan-mutation"||V==="area-mutation",e.abort(),this.#r.delete(V));H&&this.#C.value.command==="pending"&&this.#C.patch({command:"idle",notice:null})}#w(){this.#u+=1,this.#A!==null&&window.clearTimeout(this.#A),this.#A=null}#b(C){this.#w(),this.#Z(),this.#H.invalidate(),this.#p="";let H=this.#C.value,V=y();this.#C.patch({command:"idle",dataMode:V.dataMode,floor:V.floor,managedLock:!1,workflow:"none",dialog:null,notice:null,draftFloorOrdinal:null,draw:V.draw,planDraft:V.planDraft,areaDraft:V.areaDraft,generation:this.#H.generation,coherence:H.host.administrator?"unavailable":"blocked",fullMap:!1,precisionOpen:!1,resources:{catalog:v("error",null,C),entry:null,scene:v("idle",null),pose:v("idle",null),history:v("idle",null),plans:v("idle",null),areas:v("idle",null)},map:{available:!1,complete:!1,floorCoherent:!1,sessionVerified:!1,exactPose:!1},selection:{...V.selection,entryId:null,floorId:"current",historyId:null}})}async refreshCatalog(C=!1){if(this.#t||!this.#L?.host.administrator||!this.#L.host.connected||this.#L.host.robotCount===0)return;if(this.#M)return C&&!this.#y&&(this.#h=!0,this.#r.get("catalog")?.abort()),this.#n;this.#M=!0,this.#y=C;let H;this.#n=new Promise(r=>{H=r});let V=this.#m("catalog"),e=this.#C.value.resources.catalog.value;this.#C.patch({resources:{...this.#C.value.resources,catalog:v("loading",e)}});try{let r=await this.#V.catalog(V.signal);if(V.signal.aborted||this.#t)return;let t=this.#o?.config?.entry_id,o=typeof t=="string"?t:null,M=r.find(n=>n.entryId===this.#L?.entryKey)||r.find(n=>n.entryId===o)||r[0]||null,i=this.#C.value.resources.entry;if(M&&i&&K(M)===K(i)&&f2(M)===f2(i)&&g2(M)===g2(i)&&M.mapRevision<i.mapRevision&&(M={...M,mapRevision:i.mapRevision}),this.#C.patch({managedLock:M?e7(M):!1,resources:{...this.#C.value.resources,catalog:v(r.length?"ready":"empty",r),entry:M}}),!M){this.#b("no-loaded-robot");return}if(this.#C.value.selection.floorId!=="current"&&!C)return;let a=L7(M);if(!C&&a===this.#p){let n=this.#C.value,A=M.mapFloorCoherent&&M.mapSessionVerified,l=M.health==="problem"||M.health==="limited";this.#C.patch({coherence:A?l?"degraded":"current":"verifying",map:{...n.map,available:A&&n.resources.scene.value!==null,complete:M.mapComplete&&!M.mapTruncated,floorCoherent:M.mapFloorCoherent,sessionVerified:M.mapSessionVerified,exactPose:A?n.map.exactPose:!1},floor:{...n.floor,classifiedCount:Math.max(1,M.historyFloorCount)}}),A&&this.#C.value.resources.plans.problem==="map-rechecking"&&this.loadPlans(),this.#R();return}this.#p=a,this.#F(M,i)}catch(r){if(G(r))return;this.#C.patch({coherence:this.#C.value.resources.scene.value?"degraded":"unavailable",resources:{...this.#C.value.resources,catalog:v("error",e,c1(r,"catalog-unavailable"))}})}finally{this.#c("catalog",V),this.#M=!1;let r=this.#h;this.#y=!1;try{r&&!this.#t&&(this.#h=!1,await this.refreshCatalog(!0))}finally{H()}}}#F(C,H){let V=this.#C.value,e=!!(H&&K(H)===K(C)),r=C.mapFloorCoherent&&C.mapSessionVerified;this.#Z(e?["catalog","plans","areas","plan-mutation","area-mutation"]:["catalog"]);let t=e?V.resources.scene.value:null,o=V.resources.pose.value,M=e&&r&&C.mapSessionKey!==null&&o?.position&&o.mapSessionKey===C.mapSessionKey?o:null,i=this.#H.begin(C.entryId,f2(C),g2(C),C.mapRevision),a=V.draftFloorOrdinal??(H?.mapFloorCoherent&&H.mapSessionVerified?H.mapFloorOrdinal:null),n=r?C.mapFloorOrdinal:null,A=H!==null&&H.entryId!==C.entryId||a!==null&&n!==null&&a!==n;A&&this.#w();let l=y(),d=C.health==="problem"||C.health==="limited",m=this.#C.value;this.#C.patch({...A?{command:"idle",workflow:"none",dialog:null,precisionOpen:!1,fullMap:!1,draw:l.draw,planDraft:l.planDraft,areaDraft:l.areaDraft,notice:{tone:"info",text:"The active map changed. Choose a task on this map."}}:{},draftFloorOrdinal:n??a,managedLock:e7(C),generation:i.generation,coherence:r?d?"degraded":"current":"verifying",dataMode:"live",resources:{...m.resources,entry:C,scene:v(r?"loading":"idle",t),pose:v(r?"loading":"idle",M),history:v("loading",m.resources.history.value),plans:e?m.resources.plans:v("idle",null),areas:e?m.resources.areas:v("idle",null)},map:{available:r&&t!==null,complete:C.mapComplete&&!C.mapTruncated,floorCoherent:C.mapFloorCoherent,sessionVerified:C.mapSessionVerified,exactPose:r&&M!==null},floor:{classifiedCount:Math.max(1,C.historyFloorCount),displayName:C.selectedFloorOrdinal?`Floor ${C.selectedFloorOrdinal}`:"Current floor",readOnly:!1},selection:{...m.selection,entryId:C.entryId,floorId:"current",historyId:null,roomIds:A?[]:m.selection.roomIds,roomSettings:A?[]:m.selection.roomSettings,planId:A?null:m.selection.planId,areaId:A?null:m.selection.areaId}}),this.#P(C,i),r&&this.#C.value.resources.plans.status==="idle"&&this.loadPlans(),this.#R(),r&&(this.#k(C,i),this.#g(C,i))}async#k(C,H){let V=this.#m("scene");try{let e=await this.#V.scene(C.sceneUrl,C.mapRevision,C.mapFloorCoherent,"live",V.signal);if(!this.#H.accepts(H)||e.revision!==H.revision||!e.floorCoherent||!e.scene)return;let r=this.#C.value;this.#C.patch({resources:{...r.resources,scene:v("ready",e.scene)},map:{...r.map,available:!0},notice:r.notice?.text===r7?null:r.notice});let t=this.#C.value.resources.plans;if((t.status==="idle"||t.problem==="map-rechecking")&&this.loadPlans(),this.#R(),C.deltaUrl){let o=++this.#s;this.#B(C,H,e.scene,o)}}catch(e){if(G(e)||!this.#H.accepts(H))return;if(e instanceof F&&e.code==="request-timeout"){let M=this.#C.value;this.#C.patch({resources:{...M.resources,scene:v("loading",M.resources.scene.value,"scene-building")}}),window.setTimeout(()=>{this.#t||!this.#H.accepts(H)||this.#C.value.selection.floorId!=="current"||this.#k(C,H)},250);return}let r=this.#C.value,t=r.resources.pose.value,o=r.resources.scene.value!==null&&C.mapSessionKey!==null&&t?.position!==null&&t?.mapSessionKey===C.mapSessionKey;this.#C.patch({coherence:"degraded",resources:{...r.resources,scene:v("error",r.resources.scene.value,c1(e,"scene-unavailable"))},map:{...r.map,available:r.resources.scene.value!==null,exactPose:o}})}finally{this.#c("scene",V)}}async#B(C,H,V,e){if(!C.deltaUrl||typeof DecompressionStream!="function")return;let r=C.deltaUrl,t=C,o=H,M=V;try{for(;!this.#t&&e===this.#s&&this.#H.accepts(o)&&this.#C.value.selection.floorId==="current";){let i=this.#m("delta");try{let a=await this.#V.sceneDelta(r,M,t.mapFloorCoherent,i.signal);if(i.signal.aborted||this.#t||e!==this.#s||!this.#H.accepts(o))return;if(!a.floorCoherent){this.#C.patch({coherence:"verifying",map:{...this.#C.value.map,available:!1,floorCoherent:!1,exactPose:!1},resources:{...this.#C.value.resources,pose:v("idle",null)}}),this.#p="",this.refreshCatalog(!0);return}if(a.notModified||!a.scene){await new Promise(l=>window.setTimeout(l,100));continue}let n=this.#H.advance(o,a.revision);if(!n)return;o=n,M=a.scene,t={...t,mapRevision:a.revision},this.#p=L7(t);let A=this.#C.value;this.#C.patch({resources:{...A.resources,entry:t,scene:v("ready",M)},map:{...A.map,available:!0,floorCoherent:!0}}),this.#g(t,o)}finally{this.#c("delta",i)}}}catch(i){if(G(i)||this.#t||e!==this.#s||!this.#H.accepts(o))return;this.#C.patch({coherence:"degraded",notice:{tone:"warning",text:r7}}),this.#p="",this.refreshCatalog(!0)}}async#P(C,H){let V=this.#m("history");try{let e=await this.#V.history(C.historyUrl,V.signal);if(!this.#H.accepts(H)||e.entryId!==C.entryId)return;let r=this.#C.value,t=e.floors.find(i=>i.id===r.selection.floorId),o=!r.selection.historyId||t?.snapshots.some(i=>i.id===r.selection.historyId),M=r.dataMode==="live"?e.floors.find(i=>i.active):t;if(this.#C.patch({resources:{...this.#C.value.resources,history:v("ready",e)},floor:{...this.#C.value.floor,classifiedCount:e.floors.length,...M?{displayName:x5(M,1)}:{}}}),r.dataMode==="history"&&(!t||!o)){let i=t||e.floors.find(n=>n.active)||e.floors[0],a=this.selectFloor(i?.id||"current");!this.#t&&r.workflow==="history"&&this.#C.dispatch({type:"open-workflow",workflow:"history"}),await a}}catch(e){if(G(e)||!this.#H.accepts(H))return;this.#C.patch({resources:{...this.#C.value.resources,history:v("error",null,c1(e,"history-unavailable"))}})}finally{this.#c("history",V)}}async refreshPose(){let C=this.#C.value.resources.entry,H=this.#H.current();!C||!H||this.#C.value.selection.floorId!=="current"||!C.mapFloorCoherent||!C.mapSessionVerified||await this.#g(C,H)}async#g(C,H){if(this.#t||!this.#x||!this.#L?.host.connected)return;if(this.#v){this.#l=!0;return}this.#v=!0;let V=this.#m("pose");try{let e=await this.#V.pose(C.poseUrl,V.signal),r=this.#H.current(),t=this.#C.value.resources.entry;if(!r||!m4(H,r)||!t||!e.floorCoherent)return;if(e.mapSessionKey===null||e.mapSessionKey!==t.mapSessionKey){this.#C.patch({resources:{...this.#C.value.resources,pose:v("idle",null)},map:{...this.#C.value.map,exactPose:!1}}),this.#p="",this.refreshCatalog(!0);return}let o=this.#C.value,M=o.resources.pose.value,i=!!(o.map.exactPose&&M?.position&&M.mapSessionKey===t.mapSessionKey);if(e.position===null&&i){this.#C.patch({resources:{...o.resources,pose:v("ready",M)}});return}this.#C.patch({resources:{...o.resources,pose:v("ready",e)},map:{...o.map,exactPose:e.position!==null}})}catch(e){if(G(e)||!this.#H.accepts(H))return;let r=this.#C.value,t=r.resources.pose.value,o=!!(r.map.exactPose&&t?.position&&t.mapSessionKey===r.resources.entry?.mapSessionKey);this.#C.patch({resources:{...r.resources,pose:v("error",o?t:null,c1(e,"pose-unavailable"))},map:{...r.map,exactPose:o}})}finally{if(this.#c("pose",V),this.#v=!1,this.#l&&!this.#t&&this.#x&&this.#L?.host.connected&&this.#L.host.administrator&&this.#L.host.robotCount>0){this.#l=!1;let e=this.#C.value.resources.entry,r=this.#H.current();e&&r&&this.#g(e,r)}else this.#l=!1}}async selectFloor(C){let H=this.#C.value.resources.history.value,V=this.#C.value.resources.entry;if(!H||!V)return;let e=H.floors.find(M=>M.id===C);if(!e&&C!=="current")return;let r=this.#C.value;if(r.workflow==="draw"&&(r.draw.dirty||r.areaDraft.dirty)||r.workflow==="areaReview"&&(r.draw.dirty||r.areaDraft.dirty))return;if(!e||e.active){this.#p="";let M=this.#C.value;this.#C.patch({resources:{...M.resources,plans:v("idle",null),areas:v("idle",null),scene:v("idle",null),pose:v("idle",null)},map:{...M.map,available:!1,exactPose:!1},coherence:"verifying",floor:{...M.floor,readOnly:!1,displayName:"Current floor"},workflow:"none",precisionOpen:!1}),this.#C.dispatch({type:"set-floor",floorId:"current"}),await this.refreshCatalog(!0);return}let t=e.snapshots.at(-1);this.#Z(["catalog"]);let o=this.#H.begin(V.entryId,e.id,t?.id||e.id,t?.revision||0);this.#C.patch({generation:o.generation,coherence:"current",dataMode:"history",floor:{classifiedCount:H.floors.length,displayName:x5(e,H.floors.indexOf(e)+1),readOnly:!0},selection:{...this.#C.value.selection,floorId:e.id,historyId:t?.id||null},resources:{...this.#C.value.resources,scene:v(t?"loading":"empty",null),pose:v("idle",null),plans:v("idle",null),areas:v("idle",null)},workflow:"none",precisionOpen:!1,map:{available:!1,complete:!0,floorCoherent:!0,sessionVerified:!0,exactPose:!1}}),t&&await this.#_(t,o)}async selectHistory(C){let H=this.#C.value.resources.history.value,V=this.#C.value.resources.entry;if(!H||!V)return;if(!C){await this.selectFloor("current");return}let e=H.floors.find(o=>o.snapshots.some(M=>M.id===C)),r=e?.snapshots.find(o=>o.id===C);if(!e||!r)return;let t=this.#H.begin(V.entryId,e.id,r.id,r.revision);this.#Z(["catalog"]),this.#C.patch({generation:t.generation,dataMode:"history",floor:{classifiedCount:H.floors.length,displayName:x5(e,H.floors.indexOf(e)+1),readOnly:!0},selection:{...this.#C.value.selection,floorId:e.id,historyId:r.id},resources:{...this.#C.value.resources,scene:v("loading",null),pose:v("idle",null)},map:{...this.#C.value.map,available:!1,exactPose:!1}}),await this.#_(r,t)}async#_(C,H){let V=this.#m("history-scene");try{let e=await this.#V.scene(C.sceneUrl,C.revision,!0,"history",V.signal);if(!this.#H.accepts(H)||!e.scene)return;this.#C.patch({resources:{...this.#C.value.resources,scene:v("ready",e.scene)},map:{...this.#C.value.map,available:!0,exactPose:!1}})}catch(e){if(G(e)||!this.#H.accepts(H))return;this.#C.patch({resources:{...this.#C.value.resources,scene:v("error",null,c1(e,"history-scene-unavailable"))}})}finally{this.#c("history-scene",V)}}async openWorkflow(C){let H=this.#C.value;if((H.dataMode==="history"||H.floor.readOnly)&&v4.includes(C))return;let V=this.#C.value.workflow;if(C==="draw"&&V!=="draw"&&V!=="areaReview"&&this.selectArea(null),this.#C.dispatch({type:"open-workflow",workflow:C}),C==="history"){let e=this.#C.value.resources.entry,r=this.#H.current();e&&r&&(this.#C.patch({resources:{...this.#C.value.resources,history:v("loading",this.#C.value.resources.history.value)}}),await this.#P(e,r))}(C==="plan"||C==="rooms")&&await this.loadPlans(),(C==="draw"||C==="areaReview")&&await this.loadAreas()}async loadPlans(){let C=this.#C.value.resources.entry;if(!C||!this.#H.current()||!R2(this.#C.value)||this.#C.value.resources.plans.status==="loading")return;let H=K(C),V=this.#m("plans");this.#C.patch({resources:{...this.#C.value.resources,plans:v("loading",null)}});try{let e=await this.#V.plans(C.plansUrl,V.signal),r=this.#C.value.resources.entry;if(V.signal.aborted||this.#t||!r||K(r)!==H)return;if(this.#C.value.planDraft.dirty){this.#C.patch({resources:{...this.#C.value.resources,plans:v("ready",e)}});return}let t=e.selectedPlan||e.plans[0]?.id||null,o=e.plans.find(M=>M.id===t);this.#C.patch({resources:{...this.#C.value.resources,plans:v("ready",e)},selection:{...this.#C.value.selection,planId:t},planDraft:o?this.#T(o):{...this.#C.value.planDraft,id:null,name:"",rooms:[],dirty:!1}})}catch(e){let r=this.#C.value.resources.entry;if(G(e)||V.signal.aborted||this.#t||!r||K(r)!==H)return;let t=e instanceof F&&e.code==="map-rechecking"?"map-rechecking":c1(e,"plans-unavailable");this.#C.patch({resources:{...this.#C.value.resources,plans:v("error",null,t)}})}finally{this.#c("plans",V)}}selectPlan(C){let H=this.#C.value.resources.plans.value?.plans.find(V=>V.id===C);this.#C.patch({selection:{...this.#C.value.selection,planId:C},planDraft:H?this.#T(H):{...this.#C.value.planDraft,id:null,name:"",rooms:[],dirty:!1}})}#T(C){return{id:C.id,name:C.name,enabled:C.enabled,runBehavior:C.runBehavior,rooms:(C.roomOrder.length?C.roomOrder.flatMap(H=>{let V=C.rooms.find(e=>e.roomId===H);return V?[V]:[]}):C.rooms).map(H=>({...H})),returnToBase:C.returnToBase,finishCurrentRoom:C.finishCurrentRoom,finishCurrentRoomThreshold:C.finishCurrentRoomThreshold,dirty:!1}}#R(){let C=this.#C.value;(C.workflow==="draw"||C.workflow==="areaReview")&&C.resources.areas.status==="idle"&&this.loadAreas()}async loadAreas(){let C=this.#C.value.resources.entry;if(!C||!this.#H.current()||!R2(this.#C.value))return;let H=K(C),V=this.#m("areas");this.#C.patch({resources:{...this.#C.value.resources,areas:v("loading",null)}});try{let e=await this.#V.areas(C.areasUrl,V.signal),r=this.#C.value.resources.entry;if(V.signal.aborted||this.#t||!r||K(r)!==H)return;if(e.sceneUrl!==r.sceneUrl)throw new F("areas-unavailable");this.#C.patch({resources:{...this.#C.value.resources,areas:v("ready",e)}});let t=this.#C.value.selection.areaId,o=this.#C.value,M=e.areas.some(i=>i.id===t);(!o.draw.dirty&&!o.areaDraft.dirty||t!==null&&!M)&&this.selectArea(M?t:null)}catch(e){let r=this.#C.value.resources.entry;if(G(e)||V.signal.aborted||this.#t||!r||K(r)!==H)return;this.#C.patch({resources:{...this.#C.value.resources,areas:v("error",null,c1(e,"areas-unavailable"))}})}finally{this.#c("areas",V)}}selectArea(C){let H=this.#C.value.resources.areas.value?.areas.find(e=>e.id===C),V=this.#C.value;this.#C.patch({selection:{...V.selection,areaId:C},areaDraft:H?this.#O(H):{id:null,name:"",cleaningMode:"vacuum",coverageSetting:"standard",status:"new",canRebind:!1,dirty:!1},draw:{...V.draw,circles:H?.circles||[],outline:H?.outline??null,outlineUndo:[],outlineRedo:[],tool:!H||H.outline?"outline":"paint",undo:[],redo:[],dirty:!1,strokeCount:0}})}#O(C){return{id:C.id,name:C.name,cleaningMode:C.cleaningMode,coverageSetting:C.coverageSetting,status:C.status,canRebind:C.canRebind,dirty:!1}}async saveArea(){let C=this.#C.value,H=C.resources.entry,V=C.areaDraft;if(!H||C.command==="pending"||!_(C)||!V.name.trim()||!C.draw.circles.length)return;let e=this.#m("area-mutation"),r=()=>!this.#t&&!e.signal.aborted;this.#C.patch({command:"pending",notice:{tone:"info",text:"Saving area\u2026"}});try{let t=await this.#V.saveArea(H.areasUrl,{areaId:V.id,name:V.name.trim(),circles:C.draw.circles,outline:C.draw.outline??null,cleaningMode:V.cleaningMode,coverageSetting:V.coverageSetting},e.signal);if(!r())return;this.#C.patch({command:"idle",notice:{tone:"success",text:"Area saved"}}),await this.loadAreas(),r()&&this.selectArea(t)}catch(t){if(G(t)||!r())return;this.#C.patch({command:"failed",notice:{tone:"error",text:"Area could not be saved"}})}finally{this.#c("area-mutation",e)}}async deleteArea(){let C=this.#C.value.resources.entry,H=this.#C.value.selection.areaId;if(!C||!H||this.#C.value.command==="pending"||!_(this.#C.value))return;let V=this.#m("area-mutation"),e=()=>!this.#t&&!V.signal.aborted;this.#C.patch({command:"pending",notice:null});try{if(await this.#V.deleteArea(C.areasUrl,H,V.signal),!e())return;this.#C.patch({command:"idle",notice:{tone:"success",text:"Area deleted"}}),await this.loadAreas()}catch(r){!G(r)&&e()&&this.#C.patch({command:"failed",notice:{tone:"error",text:"Area could not be deleted"}})}finally{this.#c("area-mutation",V)}}async savePlan(){let C=this.#C.value,H=C.planDraft,V=C.resources.plans.value;if(!V||!H.name.trim()||!H.rooms.length||!_(C))return;let e=H.rooms;await this.#E("save_plan",{...H.id?{plan_id:H.id}:{},name:H.name.trim(),enabled:H.enabled,run_behavior:H.runBehavior,rooms:e.map(t=>({room:t.roomId,cleaning_mode:t.cleaningMode,coverage_setting:t.coverageSetting})),return_to_base:H.returnToBase,finish_current_room:H.finishCurrentRoom,finish_current_room_threshold:H.finishCurrentRoomThreshold,select:!H.id||V.selectedPlan===H.id},"Plan saved","Plan could not be saved")&&(this.#C.patch({planDraft:{...this.#C.value.planDraft,dirty:!1}}),await this.loadPlans())}async deletePlan(){let C=this.#C.value.selection.planId,H=this.#C.value.selection.entryId;if(!C)return;await this.#E("delete_plan",{plan:C},"Plan deleted","Plan could not be deleted")&&(this.#C.value.selection.entryId===H&&this.#C.value.planDraft.id===C&&this.selectPlan(null),await this.loadPlans())}async executeAction(C){switch(C){case"recheck-status":{let H=this.#C.value.selection.entryId;await this.refreshCatalog(!0);let V=this.#C.value;!this.#t&&V.selection.entryId===H&&V.resources.catalog.status==="ready"&&V.host.connected&&V.host.robotConnected&&V.coherence==="current"&&V.command==="failed"&&this.#C.patch({command:"idle",notice:{tone:"info",text:"Status refreshed. Review the robot state before trying again."}});return}case"stop":await this.#D("matic_robot","stop_intelligent_cleaning",{include_unmanaged:!0});return;case"resume":await this.#D("vacuum","send_command",{command:"resume"});return;case"run-plan":{let H=this.#C.value.selection.planId||this.#C.value.resources.plans.value?.selectedPlan;H&&await this.#D("matic_robot","run_selected_plan",{plan:H});return}case"clean-rooms":{let V=this.#C.value.selection.roomSettings.map(e=>({room:e.roomId,cleaning_mode:e.cleaningMode,coverage_setting:e.coverageSetting}));V.length&&await this.#D("matic_robot","clean_room_sequence",{rooms:V,return_to_base:!0});return}case"run-area":{let H=this.#C.value.selection.areaId;H&&await this.#D("matic_robot","clean_area",{area:H});return}case"review-area":this.#C.dispatch({type:"open-workflow",workflow:"areaReview"});return;case"save-area":await this.saveArea();return;case"save-plan":await this.savePlan();return;case"delete-plan":await this.deletePlan();return;case"delete-area":await this.deleteArea();return}}async#E(C,H,V,e){let r=this.#L?.vacuumEntityId;if(!r||!_(this.#C.value)||this.#C.value.command==="pending")return!1;let t=this.#m("plan-mutation"),o=this.#L?.entryKey,M=this.#L?.userKey,i=()=>!this.#t&&!t.signal.aborted&&o===this.#L?.entryKey&&M===this.#L?.userKey;this.#C.patch({command:"pending",notice:{tone:"info",text:"Saving\u2026"}});try{return await this.#V.service("matic_robot",C,H,r),i()?(this.#C.patch({command:"idle",notice:{tone:"success",text:V}}),!0):!1}catch{return i()&&this.#C.patch({command:"failed",notice:{tone:"error",text:e}}),!1}finally{this.#c("plan-mutation",t)}}async#D(C,H,V){let e=this.#C.value,r=this.#L?.vacuumEntityId,t=H==="stop_intelligent_cleaning"||C==="vacuum"&&H==="return_to_base",o=C==="vacuum"&&H==="send_command"&&V.command==="resume";if(!r||e.selection.entryId!==this.#L?.entryKey||(t?!D2(e):o?!E2(e):!h1(e)))return;let M=++this.#u,i=this.#L?.entryKey,a=()=>!this.#t&&M===this.#u&&i===this.#L?.entryKey,n=t?"settling":"starting";this.#A!==null&&window.clearTimeout(this.#A),this.#A=null,this.#C.patch({command:n,notice:null});try{if(await this.#V.service(C,H,V,r),!a())return;if(C==="matic_robot"&&(H==="clean_room_sequence"||H==="run_selected_plan")){this.#C.patch({command:"idle"}),this.refreshCatalog(!0);return}this.#C.patch({command:n}),this.#A!==null&&window.clearTimeout(this.#A),this.#A=window.setTimeout(()=>{this.#A=null,a()&&this.#C.value.command===n&&this.#C.patch({command:"idle"})},15e3)}catch{if(!a())return;this.#C.patch({command:"failed",notice:{tone:"error",text:"The action could not be confirmed. Check the robot status before trying again."}})}}updateDraftCircles(C,H=!0,V){this.#C.dispatch({type:"set-draft-circles",circles:C,record:H,...V?{previous:V}:{}}),this.#C.dispatch({type:"patch-area-draft",patch:{dirty:!0}})}dispose(){this.#t||(this.#t=!0,this.#d(),this.#Z(),this.#A!==null&&window.clearTimeout(this.#A),this.#A=null,this.#e.dispose(),this.#V.dispose(),this.#H.invalidate())}};var M7=L=>(L.workflow==="none"?0:1)+(L.fullMap?1:0)+(L.precisionOpen?1:0)+(L.dialog?1:0),o7=L=>{if(!L||typeof L!="object")return null;let C=L.maticMapLayer;if(!C||typeof C!="object")return null;let H=C.owner,V=C.depth;return typeof H=="string"&&Number.isInteger(V)&&Number(V)>=0?{owner:H,depth:Number(V)}:null},b2=class{#C;#H=`matic-map-${crypto.randomUUID?.()||Math.random().toString(36).slice(2)}`;#V=0;#e=null;#r=!1;#L=!1;constructor(C){this.#C=C}start(){this.#e||(this.#V=M7(this.#C.value),this.#e=this.#C.subscribe(C=>this.#o(C)),window.addEventListener("popstate",this.#i))}#o(C){let H=M7(C);if(this.#r){this.#r=!1,this.#V=H;return}if(H<this.#V){let V=o7(history.state);if(V?.owner===this.#H&&V.depth===this.#V){let e=H-this.#V;this.#V=H,this.#L=!0,history.go(e);return}}if(H>this.#V)for(let V=this.#V+1;V<=H;V+=1){let e=history.state&&typeof history.state=="object"?history.state:{};history.pushState({...e,maticMapLayer:{owner:this.#H,depth:V}},"",window.location.href)}this.#V=H}#i=()=>{if(this.#L){this.#L=!1;return}if(!(this.#V<1)){if(C1(this.#C.value,{type:"dismiss-top-layer"})){let C=history.state&&typeof history.state=="object"?history.state:{};history.pushState({...C,maticMapLayer:{owner:this.#H,depth:this.#V}},"",window.location.href),this.#C.dispatch({type:"open-dialog",dialog:"discardDraft"});return}this.#r=!0,this.#C.dispatch({type:"dismiss-top-layer"})}};dismissTop(){if(this.#V<1)return!1;let C=o7(history.state);return C?.owner===this.#H&&C.depth===this.#V?history.back():this.#C.dispatch({type:"dismiss-top-layer"}),!0}dispose(){this.#e?.(),this.#e=null,window.removeEventListener("popstate",this.#i),this.#V=0,this.#L=!1}};var i7=H1(d1),h5=class extends k{constructor(){super(...arguments);this.narrow=!1;this._workspace=y();this._classic=!1;this.entryOverride=null;this.#C=new Y1;this.#H=new Z1(this._workspace);this.#V=null;this.#e=null;this.#r=null;this.#L=null;this.#o=null;this.#i=""}static{this.styles=[$,I,w`
