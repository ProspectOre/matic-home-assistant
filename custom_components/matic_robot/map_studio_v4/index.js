...
`),V=typeof navigator>"u"?void 0:navigator.clipboard;if(V&&typeof V.writeText=="function")try{await V.writeText(H),this.#v("copied");return}catch{}this.#v(this.#M(H)?"copied":"failed")}#d(){let H=this.#Z(),V=this._copyStatus==="copied"?this.#H("v4_copied","Copied"):this._copyStatus==="failed"?this.#H("v4_copy_failed","The summary could not be copied. Select the text to copy it by hand."):"";return s`
      <div class="stack">
        ...
        <div class="toolbar">
          <button class="ms-btn ms-btn--secondary" type="button" @click=${()=>{this.#l()}}>${Z(R3)}<span>${this.#H("v4_copy_summary","Copy summary")}</span></button>
        </div>
