...
.map-root { border: 1px solid CanvasText; }
  ...
  `]}#C;#H;#L;#M;#t;#V;#a;#i;#A;#e(H,V,e){return T(this.localize,H,V,e)}connectedCallback(){super.connectedCallback(),this.#n()}firstUpdated(){let H=this.renderRoot.querySelector(".map-root"),V=this.renderRoot.querySelector(".scene-canvas"),e=this.renderRoot.querySelector(".overlay-canvas");!H||!V||!e||(this.#H=new H2(V,e,{onCamera:(r,t,o)=>{this.#o({type:"set-camera",view:this.state.workflow==="draw"?"top":this.state.view,camera:{yaw:r.yaw,pitch:r.pitch,zoom:t/100,targetX:r.targetX,targetZ:r.targetZ}}),this.state.workflow==="draw"&&t!==this.state.draw.zoomPercent&&this.#o({type:"set-zoom",value:t,...o?{originX:o.xPercent,originY:o.yPercent}:{}})},onRoom:r=>this.#o({type:"toggle-room",roomId:r}),onProblem:()=>this.#d("renderer-problem")}),this.#L=new C2(H,this.#H,{state:()=>this.state,onCircles:(r,t,o)=>this.#o({type:"set-draft-circles",circles:r,record:t,...o?{previous:o}:{}}),onRoom:r=>this.#o({type:"toggle-room",roomId:r})}),this.#H.setState(this.state),this.#f())}disconnectedCallback(){this.#c(),this.#L?.dispose(),this.#L=null,this.#H?.dispose(),this.#H=null,super.disconnectedCallback()}updated(H){this.#t&&(this.#t=!1,this.renderRoot.querySelector(".navigation-help button")?.focus()),H.has("state")&&this.#H?.setState(this.state)}#x(){let H=this.renderRoot?.querySelector(".map-root");!H||!this.#H||this.#H.setPalette(X3(H))}#f(){this.#Z(),this.#i=window.requestAnimationFrame(()=>{this.#i=null,this.#A=window.setTimeout(()=>{this.#A=null,this.#x()},0)})}#Z(){this.#i!==null&&window.cancelAnimationFrame(this.#i),this.#A!==null&&window.clearTimeout(this.#A),this.#i=null,this.#A=null}#s;#n(){if(!(typeof document>"u"||this.#V)&&(this.#V=new MutationObserver(this.#s),this.#V.observe(document.documentElement,{attributes:!0,attributeFilter:["style","class"]}),typeof window.matchMedia=="function")){this.#a=[window.matchMedia("(prefers-color-scheme: dark)"),window.matchMedia("(forced-colors: active)")];for(let H of this.#a)H.addEventListener("change",this.#s)}}#c(){this.#Z(),this.#V?.disconnect(),this.#V=null;for(let H of this.#a)H.removeEventListener("change",this.#s);this.#a=[]}#o(H){this.dispatchEvent(new CustomEvent(H1,{detail:H,bubbles:!0,composed:!0}))}#d(H){this.dispatchEvent(new CustomEvent(V2,{detail:{id:H},bubbles:!0,composed:!0}))}#u(H){this.#C=H.currentTarget,this.#M=!this.#M,this.#t=this.#M,this.requestUpdate()}#S(){if(!this.#M)return;this.#M=!1,this.requestUpdate();let H=this.#C;H?.isConnected&&H.focus()}#r(){for(let H of this.state.selection.roomIds)this.#o({type:"toggle-room",roomId:H})}#m(H,V){this.#H?.orbitBy(H,V)}#h(H){if(!(H.ctrlKey||H.metaKey||H.altKey)&&H.key==="Escape"){if(H.preventDefault(),this.#M){this.#S();return}this.#o({type:"dismiss-top-layer"});return}}rendererDiagnostics(){return this.#H?.diagnostics()??null}canvasIdentity(){return{scene:this.renderRoot.querySelector(".scene-canvas"),overlay:this.renderRoot.querySelector(".overlay-canvas")}}#l(){return this.state.host.connected?this.state.host.administrator?this.state.host.robotCount===0?{title:this.#e("v4_no_robot","No Matic robot set up"),detail:this.#e("v4_no_robot_detail","Set up a robot before opening its map.")}:this.state.dataMode==="history"?!this.state.map.available&&this.state.resources.scene.status==="loading"?{title:this.#e("v4_loading_saved_map","Loading saved map"),detail:this.#e("v4_loading_saved_map_detail","This read-only snapshot is still preparing.")}:this.state.map.available?null:{title:this.#e("v4_saved_map_unavailable","Saved map unavailable"),detail:this.#e("v4_saved_map_unavailable_detail","Choose another snapshot or return to the live map.")}:this.state.host.robotConnected?this.state.coherence==="verifying"||this.state.coherence==="booting"?{title:this.#e("v4_locating_map","Locating the current map"),detail:this.#e("v4_locating_map_detail","Map controls will return after the floor is verified.")}:!this.state.map.available&&this.state.resources.scene.status==="loading"?{title:this.#e("v4_loading_verified_map","Loading the verified map"),detail:this.#e("v4_loading_verified_map_detail","The current floor is verified. The private scene is still preparing.")}:this.state.map.available?this.state.activity==="problem"?{title:this.#e("v4_robot_attention","Robot needs attention"),detail:this.#e("v4_robot_attention_detail","Check the robot before starting another task.")}:null:{title:this.#e("v4_map_unavailable","Map unavailable"),detail:this.#e("v4_map_unavailable_detail","The private scene is not ready. No map data is shown until it is verified.")}:{title:this.#e("v4_robot_offline","Robot offline"),detail:this.#e("v4_robot_offline_detail","The last verified map stays read only and has no live position.")}:{title:this.#e("v4_admin_required","Administrator access required"),detail:this.#e("v4_private_map_hidden","Private map data is hidden.")}:{title:this.#e("v4_reconnecting","Reconnecting"),detail:this.#e("v4_reconnecting_detail","The verified map is read only until Home Assistant reconnects.")}}#v(H,V){let e=this.state,r=this.narrow,t=e.workflow==="draw",o=this.#e("v4_how_to_move","How to move the map"),M=H&&!t,i=M&&!r&&e.view==="top",a=M&&e.view==="three",n=!V,A=!r&&!t;return!M&&!n?s:d`
    ...
    `}#p(H){let V=this.state;if(!H)return s;if(V.workflow==="draw"&&!this.narrow)return d`
      ...
      `:s}render(){let H=this.state,V=v5(H),e=this.#l(),r=H.map.available&&(c1(H)||H.dataMode==="history"),t=H.workflow==="draw"&&r,o=H.coherence==="verifying"||H.coherence==="booting";return d`
      <section
        class="map-root"
        tabindex="0"
...
`]}#C(H,V){return T(this.localize,H,V)}#H(H){this.dispatchEvent(new CustomEvent(H1,{detail:H,bubbles:!0,composed:!0}))}#L(H){let V=H.currentTarget.valueAsNumber;Number.isFinite(V)&&this.#H({type:"set-brush",value:V})}render(){let{draw:H}=this.state;return d`
...
`]}#C;disconnectedCallback(){this.#C!==void 0&&clearTimeout(this.#C),this.#C=void 0,super.disconnectedCallback()}#H(H,V,e){return T(this.localize,H,V,e)}#L(H){return H==="vacuum"?this.#H("vacuum","Vacuum"):H==="mop"?this.#H("mop","Mop"):this.#H("vacuum_and_mop","Vacuum + mop")}#M(H){return H==="quick"?this.#H("quick","Quick"):H==="standard"?this.#H("standard","Optimal"):this.#H("heavy_duty","Heavy Duty")}#t(H){this.dispatchEvent(new CustomEvent(H1,{detail:H,bubbles:!0,composed:!0}))}#V(){return this.state.notice?d`
    ...
    `)}#e(H,V){let e=this.state.resources.plans.value?.rooms.find(r=>r.roomId===H)?.name||this.#H("v4_room","Room");return d`
      <div class="split room-settings">
        <label class="field ms-field">${this.#H("v4_cleaning_system","Cleaning system")}
          ...
          >${Y2.map(r=>d`<option value=${r} ?selected=${r===V.cleaningMode}>${this.#L(r)}</option>`)}</select>
        </label>
    ...
    `}#x(H){let V=this.state.planDraft.rooms,r=V.find(t=>t.roomId===H)?V.filter(t=>t.roomId!==H):[...V,{roomId:H,cleaningMode:"vacuum",coverageSetting:"standard"}];this.#t({type:"patch-plan-draft",patch:{rooms:r}})}#f(H,V){let e=this.state.planDraft.rooms.map((r,t)=>t===H?{...r,...V}:r);this.#t({type:"patch-plan-draft",patch:{rooms:e}})}#Z(H,V){let e=H+V,r=[...this.state.planDraft.rooms];if(e<0||e>=r.length)return;let[t]=r.splice(H,1);t&&(r.splice(e,0,t),this.#t({type:"patch-plan-draft",patch:{rooms:r}}))}#s(){let H=this.state.resources.plans,V=H.value,e=this.state.planDraft,r=e.rooms.map(M=>({room:M,label:V?.rooms.find(i=>i.roomId===M.roomId)?.name||"Room",selected:!0})),t=(V?.rooms||[]).filter(M=>!e.rooms.some(i=>i.roomId===M.roomId)).map(M=>({room:{roomId:M.roomId,cleaningMode:"vacuum",coverageSetting:"standard"},label:M.name,selected:!1})),o=[...r,...t];return this.#i(H.status,H.problem,d`
      <div class="stack">
        <div class="split">
          ...
          <button class="ms-btn ms-btn--secondary" type="button" @click=${()=>this.#t({type:"select-plan",planId:null})}>${Z($3)}<span class="ms-btn__label">${this.#H("plan_new","New plan")}</span></button>
        </div>
          ...
          ${o.map(({room:M,label:i,selected:a})=>{let n=a?e.rooms.findIndex(A=>A.roomId===M.roomId):-1;return d`
              <div class="room plan-room ms-row ms-row--stack" data-selected=${String(a)}>
                ...
                ${a?d`
                  <div class="split room-settings">
                    <label class="field ms-field">${this.#H("v4_cleaning_system","Cleaning system")}
                      <select aria-label=${this.#H("v4_room_cleaning_system_named","Cleaning system for {room}",{room:i})} .value=${M.cleaningMode} @change=${A=>this.#f(n,{cleaningMode:I(A)})}>${Y2.map(A=>d`<option value=${A} ?selected=${A===M.cleaningMode}>${this.#L(A)}</option>`)}</select>
                    </label>
                    <label class="field ms-field">${this.#H("cleaning_mode","Cleaning mode")}
    ...
    `}#c(){let H=this.state.areaDraft,V=H.canRebind||H.status==="review",e=!V&&(H.status==="stale"||H.status==="unknown");return d`
      <div class="stack">
        ...
        <div class="split">
          <label class="field ms-field">${this.#H("v4_cleaning_system","Cleaning system")}
            <select .value=${H.cleaningMode} @change=${r=>this.#t({type:"patch-area-draft",patch:{cleaningMode:I(r)}})}>${Y2.map(r=>d`<option value=${r} ?selected=${r===H.cleaningMode}>${this.#L(r)}</option>`)}</select>
          </label>
          <label class="field ms-field">${this.#H("cleaning_mode","Cleaning mode")}
...
`),e=typeof navigator>"u"?void 0:navigator.clipboard;if(e&&typeof e.writeText=="function")try{await e.writeText(V),this.#S("copied");return}catch{}this.#S(this.#r(V,H instanceof HTMLElement?H:null)?"copied":"failed")}#h(){let H=this.#u(),V=this._copyStatus==="copied"?this.#H("v4_copied","Copied"):this._copyStatus==="failed"?this.#H("v4_copy_failed","The summary could not be copied. Select the text to copy it by hand."):"";return d`
    ...
    `}render(){return d`<fieldset class="workflow-fields" ?disabled=${this.state.command!=="idle"&&this.state.command!=="failed"}>${this.#l()}</fieldset>`}#l(){switch(this.state.workflow){case"rooms":return this.#A();case"plan":return this.#s();case"draw":return this.#n();case"areaReview":return this.#c();case"history":return this.#o();case"support":return this.#h();case"none":return s}}};customElements.get(a1)||customElements.define(a1,J2);var t0=J(i1),L2=J(E1),M0=J(a1),a0=L=>L.dataMode==="history"||L.floor.readOnly,f7=(L,C)=>{let H=(e,r,t)=>T(C,e,r,t);if(!L.host.connected)return{title:H("v4_reconnecting","Reconnecting"),detail:H("v4_ha_offline","Home Assistant is offline"),icon:S1,notable:!0};if(!L.host.administrator)return{title:H("v4_access_required","Access required"),detail:H("v4_admin_only","Administrator only"),icon:S1,notable:!0};if(L.host.robotCount===0)return{title:H("v4_no_robot_short","No robot"),detail:H("v4_set_up_robot","Set up a Matic robot"),icon:S1,notable:!0};if(!L.host.robotConnected)return{title:H("v4_robot_offline","Robot offline"),detail:H("v4_last_map_read_only","Last verified map \xB7 read only"),icon:S1,notable:!0};if(L.activity==="problem")return{title:H("v4_needs_attention","Needs attention"),detail:H("v4_check_robot","Check the robot"),icon:S1,notable:!0};if(L.dataMode==="history"){let e=L.resources.history.value?.floors.find(o=>o.id===L.selection.floorId),r=e?.snapshots.findIndex(o=>o.id===L.selection.historyId)??-1,t=e?.snapshots.length??0;return{title:H("v4_saved_map","Saved map"),detail:r>=0?H("v4_read_only_position","Read only \xB7 {position} of {count}",{position:r+1,count:t}):H("v4_read_only","Read only"),icon:U2,notable:!1}}if(L.coherence==="verifying"||L.coherence==="booting")return{title:H("v4_locating","Locating"),detail:H("v4_finding_map","Finding the current map"),icon:h1,notable:!0};if(L.command==="starting"&&(L.activity==="idle"||L.activity==="docked"))return{title:H("v4_action_starting","Starting"),detail:H("v4_action_starting_detail","Waiting for the robot to begin"),icon:h1,notable:!0};if(L.activity==="cleaning")return{title:H("v4_cleaning","Cleaning"),detail:H("v4_cleaning_progress","Cleaning in progress"),icon:G2,notable:!0};if(L.activity==="recharging"){let e=L.batteryPercent===null?H("v4_recharging_detail","Will resume automatically when ready"):H("v4_recharging_battery","Charging to resume \xB7 {percent}% battery",{percent:L.batteryPercent});return{title:H("v4_recharging","Charging to resume"),detail:e,icon:Q3,notable:!0}}if(L.activity==="paused")return{title:H("v4_paused","Paused"),detail:H("v4_can_resume","Cleaning can resume"),icon:Q2,notable:!0};if(L.activity==="returning")return{title:H("v4_returning","Returning"),detail:H("v4_going_dock","Going to the dock"),icon:G2,notable:!0};if(L.activity==="stopping")return{title:H("v4_stopping","Stopping"),detail:H("v4_waiting_robot","Waiting for the robot"),icon:Q2,notable:!0};let V=L.batteryPercent===null?H("v4_ready","Ready"):H("v4_battery","{percent}% battery",{percent:L.batteryPercent});return{title:L.activity==="docked"?H("v4_docked","Docked"):H("v4_ready","Ready"),detail:V,icon:h1,notable:!1}},o0=(L,C)=>{let H=(V,e)=>T(C,V,e);switch(L.workflow){case"rooms":return{title:H("v4_choose_rooms","Choose rooms"),description:H("v4_choose_rooms_detail","Select on the map or from the list.")};case"draw":return{title:H("v4_draw_area","Draw an area"),description:H("v4_draw_area_detail","Paint on the verified map, then review the details.")};case"plan":return{title:H("v4_cleaning_plan","Cleaning plan"),description:H("v4_plan_detail","Review rooms and cleaning settings.")};case"areaReview":return{title:H("v4_name_this_area","Name this area"),description:H("area_details_hint","Name the area and choose cleaning settings.")};case"history":return{title:H("v4_map_history","Map history"),description:H("v4_map_history_detail","Saved maps are floor-scoped and read only.")};case"support":return{title:H("v4_map_diagnostics","Map diagnostics"),description:H("v4_map_support_detail","Private geometry is never included.")};case"none":return a0(L)?{title:H("v4_saved_map_read_only_title","Saved map is read only"),description:H("v4_saved_map_read_only_detail","Return to the live map to choose rooms, run a plan, or draw a custom area.")}:{title:H("v4_what_to_clean","What should the robot clean?"),description:H("v4_clean_detail","Choose rooms, a saved plan, or a custom area.")}}},V1=["peek","half","full"],i0={none:"half",rooms:"half",draw:"peek",plan:"full",areaReview:"half",history:"half",support:"full"},g7=.5,y7=100,b7=6,O7=48,w7=["button:not(:disabled)","a[href]","input:not(:disabled)","select:not(:disabled)","textarea:not(:disabled)","[tabindex]:not([tabindex='-1'])"].join(", "),k7=(L,C,H=!1)=>{let V=(e,r)=>T(C,e,r);switch(L){case"discardDraft":return{title:H?V("v4_discard_plan","Discard plan changes?"):V("v4_discard_area","Discard area changes?"),detail:H?V("v4_discard_plan_detail","Your plan changes have not been saved. Keep editing or discard them."):V("v4_discard_area_detail","Your area changes have not been saved. Keep editing or discard them."),cancelLabel:V("v4_keep_area_editing","Keep editing"),confirmLabel:V("v4_discard","Discard"),action:"discard"};case"confirmDeletePlan":return{title:V("v4_delete_plan","Delete this plan?"),detail:V("v4_delete_plan_detail","This removes the saved plan from Home Assistant. The robot will not move."),cancelLabel:V("v4_cancel","Cancel"),confirmLabel:V("plan_delete","Delete plan"),action:"delete-plan"};case"confirmDeleteArea":return{title:V("v4_delete_area","Delete this area?"),detail:V("v4_delete_area_detail","This removes the saved outline from Home Assistant. The robot will not move."),cancelLabel:V("v4_cancel","Cancel"),confirmLabel:V("area_delete","Delete area"),action:"delete-area"};case"confirmStop":return{title:V("v4_stop_cleaning","Stop cleaning?"),detail:V("v4_stop_cleaning_detail","The robot may take a moment to settle before another action is available."),cancelLabel:V("v4_keep_cleaning","Keep cleaning"),confirmLabel:V("v4_stop","Stop"),action:"stop"};case"error":return{title:V("v4_error","Something went wrong"),detail:V("v4_error_detail","No action was started. Close this message and try again when the map is ready."),cancelLabel:V("v4_close","Close"),confirmLabel:V("v4_close","Close"),action:null};case null:return null}},P7=(L=document)=>{let C=L.activeElement;for(;C?.shadowRoot?.activeElement;)C=C.shadowRoot.activeElement;return C},C5=L=>!!(L&&L.isConnected&&L.offsetParent!==null),H5=class extends w{constructor(){super(...arguments);this.state=y();this._measuredNarrow=!1;this._sheetOffset=0;this._overflowOpen=!1;this._helpOpen=!1;this._browserFullscreen=!1;this._sheetDetent="half";this._announcement="";this.#H=null;this.#L=null;this.#M=null;this.#t=null;this.#V=null;this.#a=null;this.#i=null;this.#A=null;this.#e=null;this.#x=()=>{this._browserFullscreen=document.fullscreenElement===this.renderRoot.querySelector(".app")};this.#f=H=>{if(!this._overflowOpen)return;let V=this.renderRoot.querySelector(".overflow-wrap");(!V||!H.composedPath().includes(V))&&(this._overflowOpen=!1)}}static{this.properties={state:{attribute:!1},localize:{attribute:!1},_measuredNarrow:{state:!0},_sheetOffset:{state:!0},_overflowOpen:{state:!0},_helpOpen:{state:!0},_browserFullscreen:{state:!0},_sheetDetent:{state:!0},_announcement:{state:!0}}}static{this.styles=Q5}#C(H,V,e){return T(this.localize,H,V,e)}#H;#L;#M;#t;#V;#a;#i;#A;#e;#x;#f;connectedCallback(){super.connectedCallback(),this.#H=new ResizeObserver(([H])=>{if(!H)return;let V=H.contentRect.width<768||H.contentRect.height<480;V!==this._measuredNarrow&&(this._measuredNarrow=V)}),this.#H.observe(this),window.addEventListener("pointerdown",this.#f,!0),document.addEventListener("fullscreenchange",this.#x),this.#L=new ResizeObserver(([H])=>{if(!H)return;let V=Math.ceil(H.target.getBoundingClientRect().height);V!==this._sheetOffset&&(this._sheetOffset=V)})}disconnectedCallback(){this.#H?.disconnect(),this.#H=null,this.#L?.disconnect(),this.#L=null,this.#M=null,window.removeEventListener("pointerdown",this.#f,!0),document.removeEventListener("fullscreenchange",this.#x),super.disconnectedCallback()}updated(H){let V=H,e=this.renderRoot.querySelector(".mobile-sheet");if(e!==this.#M&&(this.#L?.disconnect(),this.#M=e,e?this.#L?.observe(e):this._sheetOffset!==0&&(this._sheetOffset=0)),V.has("_overflowOpen")&&this._overflowOpen&&this.updateComplete.then(()=>{this.renderRoot.querySelector("#map-options select, #map-options button")?.focus()}),V.has("_helpOpen")){if(this._helpOpen)this.updateComplete.then(()=>{this.renderRoot.querySelector(".help-dialog [data-dialog-initial-focus]")?.focus()});else if(V.get("_helpOpen")){let r=this.#a;this.#a=null,this.updateComplete.then(()=>{requestAnimationFrame(()=>r?.focus({preventScroll:!0}))})}}if(H.has("state")){let r=H.get("state");if(r?.precisionOpen&&!this.state.precisionOpen&&this.#s()?.focus(),r?.fullMap&&!this.state.fullMap){let t=this.#V;this.#V=null,this.updateComplete.then(()=>{requestAnimationFrame(()=>{(this.renderRoot.querySelector(".workspace-toggle")??this.renderRoot.querySelector(".nav--menu")??(t?.isConnected?t:null))?.focus({preventScroll:!0})})})}if(!r?.dialog&&this.state.dialog){let t=P7(this.shadowRoot||document);t?.hasAttribute("data-dialog-launcher")&&(this.#t=t),this.updateComplete.then(()=>{(this.renderRoot.querySelector(".dialog [data-dialog-initial-focus]")??this.renderRoot.querySelector(".dialog button"))?.focus()})}else if(r?.dialog&&!this.state.dialog){r.dialog==="discardDraft"&&(this.#i=null,this.#S());let t=this.#t?.isConnected&&this.#t.hasAttribute("data-dialog-launcher")?this.#t:this.#W(r.dialog);this.#t=null,this.updateComplete.then(()=>{requestAnimationFrame(()=>t?.focus({preventScroll:!0}))})}r?r.workflow!==this.state.workflow&&(this._sheetDetent=i0[this.state.workflow],this.updateComplete.then(()=>this.#Z())):this._sheetDetent=i0[this.state.workflow]}}#Z(){let H=this.renderRoot.querySelector(".panel-heading h2");if(C5(H)){H.focus({preventScroll:!0});return}let V=this.renderRoot.querySelector(".action-bar .ms-btn--primary");C5(V)&&V.focus({preventScroll:!0})}#s(){let H=this.renderRoot.querySelector(".draw-brush");return C5(H)?H:this.renderRoot.querySelector(i1)?.shadowRoot?.querySelector(".draw-brush")??null}#n(H){if(e1(this.state,H)){this.#i=H,this.#n({type:"open-dialog",dialog:"discardDraft"});return}this.dispatchEvent(new CustomEvent(H1,{detail:H,bubbles:!0,composed:!0}))}#c(H){if(H.enabled){if(H.id==="return-live"){this.#n({type:"set-history",historyId:null});return}if(H.id==="clear-draft"){this.#n({type:"clear-draft"});return}this.#m(H.id)}}#o(H){this.#n({type:"open-workflow",workflow:H})}#d(){let H=this.#i;this.#i=null,H?.type==="select-plan"||H?.type==="select-area"?(this.#n({type:"patch-plan-draft",patch:{dirty:!1}}),this.#n({type:"patch-area-draft",patch:{dirty:!1}}),this.#n({type:"dismiss-top-layer"})):this.#n({type:"discard-draft"}),H&&queueMicrotask(()=>this.dispatchEvent(new CustomEvent(H1,{detail:H,bubbles:!0,composed:!0})))}#u(){this.#i=null,this.#r(),this.#S()}#S(){this.updateComplete.then(()=>{let H=this.renderRoot.querySelector(".floor-switcher");H&&(H.value=this.state.selection.floorId);let V=this.renderRoot.querySelector(".robot-switcher");V&&(V.value=this.state.selection.entryId??"");let r=this.renderRoot.querySelector(a1)?.shadowRoot?.querySelector('[name="saved-plan"]');r&&(r.value=this.state.selection.planId??"")})}#r(){let H=this.state.dialog,V=H&&this.#t?.isConnected&&this.#t.hasAttribute("data-dialog-launcher")?this.#t:H?this.#W(H):null;this.#n({type:"dismiss-top-layer"}),V&&requestAnimationFrame(()=>V.focus({preventScroll:!0}))}#m(H){this.dispatchEvent(new CustomEvent(V2,{detail:{id:H},bubbles:!0,composed:!0}))}#h(H){this.#n({type:"dismiss-top-layer"}),this.#m(H)}#l(H){if(H.action==="discard"){this.#d();return}if(H.action==="delete-plan"||H.action==="delete-area"){this.#h(H.action);return}this.#n({type:"dismiss-top-layer"}),H.action==="stop"&&this.#m("stop")}#v(H){H!==this._sheetDetent&&(this._sheetDetent=H,this._announcement=this.#C("v4_workspace_height","Map workspace, {height} height",{height:H}))}#p(H,V=!1){let r=V1.indexOf(this._sheetDetent)+H;V&&r>=V1.length&&(r=0),r=Math.max(0,Math.min(V1.length-1,r)),this.#v(V1[r]??this._sheetDetent)}#y(H){let V=this.renderRoot.querySelector(".workspace")?.clientHeight??H.parentElement?.clientHeight??H.offsetHeight,e=parseFloat(getComputedStyle(this).fontSize)||16,r=[".sheet-grip",".sheet-tools",".action-bar"].map(M=>H.querySelector(M)?.offsetHeight??0).reduce((M,i)=>M+i,0)+e*.75,t=Math.min(V*.92,V-e*4),o=Math.min(V*.48,e*26,t);return{peek:Math.min(r,o),half:o,full:t}}#O(){return this.renderRoot.querySelector(".mobile-sheet")}#k(H){if(H.pointerType==="mouse"&&H.button!==0||H.target?.closest("button, select, input, a"))return;let V=this.#O();!V||this.#A||(this.#A={pointerId:H.pointerId,startY:H.clientY,startHeight:V.offsetHeight,heights:this.#y(V),samples:[{y:H.clientY,t:H.timeStamp}],moved:!1},H.currentTarget.setPointerCapture(H.pointerId),V.classList.add("dragging"))}#F(H){let V=this.#A;if(!V||H.pointerId!==V.pointerId)return;let e=this.#O();if(!e)return;let r=H.clientY-V.startY;for(!V.moved&&Math.abs(r)>b7&&(V.moved=!0),V.samples.push({y:H.clientY,t:H.timeStamp});V.samples.length>2&&H.timeStamp-(V.samples[1]?.t??0)>y7;)V.samples.shift();if(!V.moved)return;let t=V.startHeight-V.heights.full,o=V.startHeight-V.heights.peek,M=Math.max(t,Math.min(o,r));e.style.transform=`translateY(${M}px)`}#w(H){let V=this.#A;if(!V||H.pointerId!==V.pointerId)return;this.#A=null;let e=this.#O();if(e&&(e.style.transform="",e.classList.remove("dragging")),H.type==="pointercancel")return;if(!V.moved){this.#p(1,!0);return}let r=H.clientY-V.startY,t=V1.indexOf(this._sheetDetent),o=V.samples[0],M=V.samples[V.samples.length-1],i=o&&M&&M!==o?(M.y-o.y)/Math.max(1,M.t-o.t):0;if(Math.abs(i)>g7){let l=Math.max(0,Math.min(V1.length-1,t+(i<0?1:-1)));this.#v(V1[l]??this._sheetDetent);return}let a=V.startHeight-r,n=this._sheetDetent,A=Number.POSITIVE_INFINITY;for(let l of V1){let p=Math.abs(V.heights[l]-a);p<A&&(A=p,n=l)}this.#v(n)}#T(H){if(H.pointerType==="mouse")return;let V=H.currentTarget;this.#e={pointerId:H.pointerId,startY:H.clientY,atTop:V.scrollTop===0,consumed:!1}}#b(H){let V=this.#e;if(!V||V.consumed||!V.atTop||H.pointerId!==V.pointerId)return;if(H.currentTarget.scrollTop>0){this.#e=null;return}H.clientY-V.startY<O7||(V.consumed=!0,this.#p(-1))}#g(){this.#e=null}#B(){this.dispatchEvent(new CustomEvent("hass-toggle-menu",{bubbles:!0,composed:!0}))}#P(H){this.#V=H.currentTarget,this.#n({type:this.state.fullMap?"exit-full-map":"enter-full-map"})}#_(H){this._overflowOpen=!1,H&&this.updateComplete.then(()=>{this.renderRoot.querySelector(".overflow")?.focus()})}#R(H){if(this.#_(H==="fullscreen"),H==="support"){this.#o("support");return}if(H==="fullscreen"){let V=this.renderRoot.querySelector(".app");document.fullscreenElement?document.exitFullscreen():V?.requestFullscreen();return}this.dispatchEvent(new CustomEvent(V2,{detail:{id:"use-classic"},bubbles:!0,composed:!0}))}#C1(){this.#n({type:"set-precision-open",value:!this.state.precisionOpen})}#H1(H){this.#a=H.currentTarget,this._helpOpen=!0}#q(H){let V=H;if(!d1(V.detail))return;if(e1(this.state,V.detail)){H.stopPropagation(),this.#n(V.detail);return}if(V.detail?.type!=="open-dialog")return;let e=V.composedPath().find(r=>r instanceof HTMLElement&&r.hasAttribute("data-dialog-launcher"));e instanceof HTMLElement&&(this.#t=e)}#W(H){return this.renderRoot.querySelector(a1)?.shadowRoot?.querySelector(`[data-dialog-launcher="${H}"]`)??null}#V1(H){if(!(H.defaultPrevented||H.ctrlKey||H.metaKey||H.altKey)&&H.key==="Escape"){if(H.preventDefault(),this._overflowOpen){this.#_(!0);return}if(this._helpOpen){this._helpOpen=!1;return}if(this.state.dialog==="discardDraft"){this.#u();return}this.#n({type:"dismiss-top-layer"})}}#N(H){if(H.key!=="Tab")return;let e=[...H.currentTarget.querySelectorAll(w7)],r=e[0],t=e.at(-1);if(!r||!t)return;let o=this.shadowRoot?.activeElement;H.shiftKey&&o===r?(H.preventDefault(),t.focus()):!H.shiftKey&&o===t&&(H.preventDefault(),r.focus())}#X(){let H=this.renderRoot.querySelector(i1);(H?.shadowRoot?.querySelector(".map-root")??H)?.focus()}#Y(){this._sheetDetent==="peek"&&this.#O()&&this.#v("half"),this.updateComplete.then(()=>this.#Z())}#E(H,V,e){if(H.id==="choose-cleaning")return s;let r=H.labelKey?this.#C(H.labelKey,H.label):H.label,t=!H.enabled&&H.reason?H.reasonKey?this.#C(H.reasonKey,H.reason):H.reason:null,o=H.id==="stop";return c`
      <button
        ...
        @click=${()=>this.#c(H)}
      >${r}</button>
      ${t?c`<p class="action-reason" id=${e}>${t}</p>`:s}
    `}#z(H){let V=H.resources.plans.value?.rooms??H.resources.areas.value?.rooms??[];return H.selection.roomIds.map(e=>V.find(r=>r.roomId===e)?.name??e)}#D(H,V,e){let r=V?.enabled&&H.workflow==="rooms"&&V.id==="clean-rooms"?[this.#z(H).join(", "),H.planDraft.returnToBase?this.#C("v4_returns_to_dock","returns to the dock"):""].filter(Boolean).join(" \xB7 "):"";return c`
      <div class="action-bar">
        ${r?c`<p class="action-summary">${r}</p>`:s}
        ${V?this.#E(V,"ms-btn ms-btn--block ms-btn--lg ms-btn--primary","primary-reason"):s}
        ${e?this.#E(e,"ms-btn ms-btn--block ms-btn--lg ms-btn--secondary","secondary-reason"):s}
      </div>
    `}#$(H,V,e=s){return c`
    ...
    `}#U(H,V,e,r,t=!1){return c`
      ...
      >
        ...
        <span class="ms-row__body"><strong>${H}</strong>${r?c`<small>${r}</small>`:s}</span>
    ...
    `}#L1(H,V){let e=(S,g,P)=>this.#C(S,g,P),r=this.#U(e("v4_map_history","Map history"),U2,()=>this.#o("history"),e("v4_map_history_detail","Saved maps are floor-scoped and read only.")),t=this.#U(e("v4_map_diagnostics","Map diagnostics"),G3,()=>this.#o("support"),e("v4_map_support_detail","Private geometry is never included.")),{host:o}=H;if(!o.connected)return this.#$(e("v4_reconnecting_title","Reconnecting to Home Assistant"),e("v4_reconnecting_body","The last verified map stays read-only until the connection returns."));if(!o.administrator)return this.#$(e("v4_admin_title","Administrator access required"),e("v4_admin_body","Ask a Home Assistant administrator to open this map."));if(o.robotCount===0)return this.#$(e("v4_no_robot_title","No Matic robot set up"),e("v4_no_robot_body","Add the Matic integration to see a map here."),c`<a class="ms-btn ms-btn--secondary" href="/config/integrations/integration/matic_robot">${e("v4_open_integration","Open the Matic integration")}</a>`);if(!o.robotConnected)return c`
      ...
      `;let M=H.coherence==="verifying"||H.coherence==="booting",i=H.resources.plans,a=i.value,n=a!==null&&a.rooms.length===0,A=a?.plans.length??0,l=i.status==="loading",p=i.status==="error",u=M||n,h=M?e("v4_reason_locating","Waiting for the robot to confirm which floor it is on."):n?e("v4_no_rooms_reason","This floor has no named rooms yet."):null,x=M?e("v4_reason_locating","Waiting for the robot to confirm which floor it is on."):null,f=M?e("v4_reason_locating","Waiting for the robot to confirm which floor it is on."):e("v4_areas_quick_detail","Sketch a one-time zone on the map");return c`
    ...
    `}render(){let H=this.state,V=H.narrowHint||this._measuredNarrow,e=f7(H,this.localize),r=Z2({...H,narrowHint:V}),t=m5(H),o=!V&&r.id==="stop"?r:!V&&t?.id==="stop"?t:null,M=o&&o===r?null:r,i=H.workflow==="draw"&&H.dataMode==="live"?{id:"clear-draft",label:"Clear drawing",labelKey:"v4_clear_drawing",kind:"neutral",enabled:H.draw.circles.length>0}:null,a=o&&o===t?null:t??i,n=H.fullMap&&(H.coherence==="verifying"||H.coherence==="booting"),A=H.fullMap||H.host.administrator&&H.host.robotCount>0&&H.map.available,l=k7(H.dialog,this.localize,H.workflow==="plan"),p=V&&!H.fullMap?`--map-sheet-offset:${this._sheetOffset}px`:"--map-sheet-offset:0px",u=V&&H.workflow==="draw",h=H.precisionOpen&&H.workflow==="draw";return c`
          ...
          <main class=${`workspace ${H.fullMap?"full-map":""}`} style=${p}>
            ...
            >
              ...
              `:c`
                <div class="status-strip">
                  ...
                  ${o?this.#E(o,"status-action ms-btn ms-btn--secondary","status-reason"):s}
                </div>
            ...
            ${H.fullMap?c`
              ...
              >
                ...
                ${n&&r.id!=="stop"?s:this.#E(r,"ms-btn ms-btn--lg ms-btn--primary","hud-reason")}
                ${t&&(!n||t.id==="stop")?this.#E(t,"ms-btn ms-btn--lg ms-btn--secondary","hud-secondary-reason"):s}
              </section>
            `:s}
          </main>
        </div>
  ...
  `]}#C;#H;connectedCallback(){super.connectedCallback(),this.#H=this.#C.subscribe(H=>{this._workspace=H})}disconnectedCallback(){this.#H?.(),this.#H=null,super.disconnectedCallback()}willUpdate(H){H.has("scenario")?this.#C.replace({...f2(this.scenario),narrowHint:this.narrow}):H.has("narrow")&&this.#C.dispatch({type:"set-narrow-hint",value:this.narrow})}setScenario(H){g2.includes(H)&&(this.scenario=H)}getWorkspaceSnapshot(){return structuredClone(this.#C.value)}replaceWorkspaceState(H){this.#C.replace(structuredClone(H))}#L(H){d1(H.detail)&&(H.stopPropagation(),this.#C.dispatch(H.detail))}render(){return c`
      ${this.controls?c`
...
`,e2=class{#C=null;#H=null;#L=0;#M=new Map;constructor(){if(!(typeof Worker!="function"||typeof URL?.createObjectURL!="function"))try{this.#H=URL.createObjectURL(new Blob([G7()],{type:"text/javascript"})),this.#C=new Worker(this.#H),this.#C.onmessage=C=>{let H=this.#M.get(C.data.id);H&&(this.#M.delete(C.data.id),C.data.ok&&C.data.parsed?H.resolve(C.data.parsed):H.reject(new m(C.data.problem||"invalid-scene")))},this.#C.onerror=()=>this.#t("scene-worker-failed")}catch{this.#C=null,this.#H&&URL.revokeObjectURL(this.#H),this.#H=null}}async parse(C,H){if(H?.aborted)throw new DOMException("Aborted","AbortError");if(!this.#C){if(await new Promise(e=>window.setTimeout(e,0)),H?.aborted)throw new DOMException("Aborted","AbortError");return U7(C)}let V=++this.#L;return new Promise((e,r)=>{let t=()=>{this.#M.delete(V),r(new DOMException("Aborted","AbortError"))};H?.addEventListener("abort",t,{once:!0}),this.#M.set(V,{resolve:o=>{H?.removeEventListener("abort",t),e(o)},reject:o=>{H?.removeEventListener("abort",t),r(o)}}),this.#C?.postMessage({id:V,buffer:C},[C])})}#t(C){for(let H of this.#M.values())H.reject(new m(C));this.#M.clear(),this.#C?.terminate(),this.#C=null}dispose(){this.#t("scene-parser-disposed"),this.#H&&URL.revokeObjectURL(this.#H),this.#H=null}};var Y={catalog:1e4,scene:6e4,delta:35e3,pose:1e4,history:15e3,workflow:15e3,mutation:2e4},F=class extends Error{constructor(C,H=null){super(C),this.name="BackendError",this.code=C,this.status=H}},$1=36,y1=16*1024*1024,f0=(L,C)=>{let H=Number(L);if(!Number.isSafeInteger(H)||H<0)throw new m(C);return H},g0=(L,C)=>{let H=L.headers.get("X-Matic-Revision");if(H===null)return C;let V=Number(H);if(!Number.isSafeInteger(V)||V<0)throw new m("invalid-scene-revision");return V},y0=(L,C)=>{let H=L.headers.get("X-Matic-Floor-Coherent");if(H===null)return C;if(H==="1")return!0;if(H==="0")return!1;throw new m("invalid-scene-floor-header")},r2=class{#C;#H=new e2;constructor(C){this.#C=C}async#L(C,H,V,e){if(!h0(C))throw new F("invalid-private-path");if(e?.aborted)throw new DOMException("Aborted","AbortError");let r=new AbortController,t=()=>r.abort();e?.addEventListener("abort",t,{once:!0});let o=!1,M=window.setTimeout(()=>{o=!0,r.abort()},V);try{let i=this.#C(),a=new Headers(H.headers),n={...H,cache:"no-store",credentials:"same-origin",headers:Object.fromEntries(a.entries()),signal:r.signal};if(typeof i?.fetchWithAuth=="function")return await i.fetchWithAuth(C,n);let A=i?.auth?.accessToken||i?.auth?.data?.access_token;A&&a.set("Authorization",`Bearer ${A}`);let l=typeof i?.hassUrl=="function"?i.hassUrl(C):C;return await fetch(l,{...n,headers:a})}catch(i){throw o&&!e?.aborted?new F("request-timeout"):r.signal.aborted?new DOMException("Aborted","AbortError"):i}finally{window.clearTimeout(M),e?.removeEventListener("abort",t)}}async#M(C,H,V,e={}){let r=await this.#L(C,{...e,headers:{Accept:"application/json",...e.headers||{}}},H,V);if(!r.ok){let t=r.headers.get("X-Matic-Plans-Conflict");throw new F(t==="map-rechecking"?"map-rechecking":"request-failed",r.status)}try{return await r.json()}catch{throw new m("invalid-json-response")}}async catalog(C){return s0(await this.#M(A0,Y.catalog,C))}async scene(C,H,V,e,r,t){let o=new Headers({Accept:"application/vnd.matic.slam-scene"});e==="live"&&o.set("X-Matic-Prefer-Cached","1"),t&&o.set("If-None-Match",t);let M=await this.#L(C,{headers:o},Y.scene,r),i=g0(M,H),a=y0(M,V);if(M.status===304)return{scene:null,floorCoherent:a,revision:i,notModified:!0};if(!M.ok)throw new F("scene-request-failed",M.status);if(M.headers.get("Content-Type")?.split(";",1)[0]!=="application/vnd.matic.slam-scene")throw new m("invalid-scene-content-type");return{scene:{...await this.#H.parse(await M.arrayBuffer(),r),revision:i,etag:M.headers.get("ETag"),source:e},floorCoherent:a,revision:i,notModified:!1}}async#t(C,H,V){if(!Number.isSafeInteger(H)||H<1||H>y1||typeof DecompressionStream!="function")throw new m("invalid-scene-delta");let r=new Blob([C]).stream().pipeThrough(new DecompressionStream("deflate")).getReader(),t=new Uint8Array(H),o=0,M=()=>{r.cancel()};V?.addEventListener("abort",M,{once:!0});try{for(;;){if(V?.aborted)throw new DOMException("Aborted","AbortError");let{done:i,value:a}=await r.read();if(i)break;if(!(a instanceof Uint8Array)||o+a.byteLength>H)throw new m("invalid-scene-delta");t.set(a,o),o+=a.byteLength}}finally{V?.removeEventListener("abort",M),r.releaseLock()}if(o!==H)throw new m("invalid-scene-delta");return t}async#V(C,H,V){if(C.byteLength<$1||C.byteLength>$1+y1||H.buffer.byteLength>y1)throw new m("invalid-scene-delta");let e=new DataView(C),r=new TextDecoder().decode(new Uint8Array(C,0,8)),t=e.getUint16(8,!0),o=e.getUint16(10,!0),M=f0(e.getBigUint64(12,!0),"invalid-scene-delta"),i=f0(e.getBigUint64(20,!0),"invalid-scene-delta"),a=e.getUint32(28,!0),n=e.getUint32(32,!0);if(r!=="MATICDLT"||t!==1||o!==1||M!==H.revision||i<=H.revision||a<24||a>y1||n>y1||n+$1!==C.byteLength)throw new m("invalid-scene-delta");let A=new Uint8Array(C,$1,n),l=new Uint8Array(H.buffer),u=(await this.#t(A,Math.max(l.byteLength,a),V)).slice(),h=1024*1024;for(let S=0;S<l.byteLength;S+=h){if(V?.aborted)throw new DOMException("Aborted","AbortError");let g=Math.min(l.byteLength,S+h);for(let P=S;P<g;P+=1)u[P]=(u[P]??0)^(l[P]??0);g<l.byteLength&&await new Promise(P=>window.setTimeout(P,0))}let x=u.slice(0,a).buffer;return{parsed:{...await this.#H.parse(x,V),revision:i,etag:null,source:"live"},revision:i}}async sceneDelta(C,H,V,e){let r=C.includes("?")?"&":"?",t=await this.#L(`${C}${r}since=${encodeURIComponent(H.revision)}`,{headers:{Accept:"application/vnd.matic.slam-delta, application/vnd.matic.slam-scene"}},Y.delta,e),o=g0(t,H.revision),M=y0(t,V);if(t.status===204){if(o!==H.revision)throw new m("invalid-scene-delta-revision");return{scene:null,floorCoherent:M,revision:o,notModified:!0}}if(!t.ok)throw new F("delta-request-failed",t.status);if(o<=H.revision)throw new m("invalid-scene-delta-revision");let i=Number(t.headers.get("Content-Length"));if(Number.isFinite(i)&&i>$1+y1)throw new m("invalid-scene-delta-size");let a=t.headers.get("Content-Type")?.split(";",1)[0],n=await t.arrayBuffer();if(a==="application/vnd.matic.slam-delta"){let l=Number(t.headers.get("X-Matic-Base-Revision"));if(!Number.isSafeInteger(l)||l!==H.revision)throw new m("invalid-scene-delta-base");let p=await this.#V(n,H,e);if(p.revision!==o)throw new m("invalid-scene-delta-revision");return{scene:{...p.parsed,etag:t.headers.get("ETag")},floorCoherent:M,revision:o,notModified:!1}}if(a!=="application/vnd.matic.slam-scene")throw new m("invalid-scene-delta-content-type");return{scene:{...await this.#H.parse(n,e),revision:o,etag:t.headers.get("ETag"),source:"live"},floorCoherent:M,revision:o,notModified:!1}}async pose(C,H){return Z0(await this.#M(C,Y.pose,H))}async history(C,H){return m0(await this.#M(C,Y.history,H))}async plans(C,H){return x0(await this.#M(C,Y.workflow,H))}async areas(C,H){return u0(await this.#M(C,Y.workflow,H))}async saveArea(C,H,V){let e=await this.#M(C,Y.mutation,V,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({...H.areaId?{area_id:H.areaId}:{},name:H.name,circles:H.circles,cleaning_mode:H.cleaningMode,coverage_setting:H.coverageSetting})});if(!e||typeof e!="object"||typeof e.id!="string")throw new m("invalid-area-save-response");return e.id}async deleteArea(C,H,V){let e=await this.#L(`${C}?area_id=${encodeURIComponent(H)}`,{method:"DELETE",headers:{Accept:"application/json"}},Y.mutation,V);if(!e.ok)throw new F("area-delete-failed",e.status)}async service(C,H,V,e){let r=this.#C();if(typeof r?.callService!="function")throw new F("service-unavailable");await r.callService(C,H,V,{entity_id:e})}dispose(){this.#H.dispose()}};var O0=()=>({version:4,view:"top",appearance:"photo",labels:!0,quality:"auto",cameras:{}}),I1=(L,C,H)=>Math.max(C,Math.min(H,L)),w0=L=>L.replaceAll(/[^a-zA-Z0-9_-]/g,"").slice(0,128)||"local-user",r5=(L,C=4)=>`matic-map-studio:v${C}:${w0(L)}`,Q7=L=>{if(!L||typeof L!="object")return null;let C=L;return["yaw","pitch","zoom","targetX","targetZ"].every(V=>typeof C[V]=="number"&&Number.isFinite(C[V]))?{yaw:I1(C.yaw,-Math.PI,Math.PI),pitch:I1(C.pitch,.18,Math.PI/2-.018),zoom:I1(C.zoom,.01,100),targetX:I1(C.targetX,-1e4,1e4),targetZ:I1(C.targetZ,-1e4,1e4)}:null},b0=L=>{let C=O0();if(!L||typeof L!="object")return C;let H=L,V=H.view==="three"||H.view==="top"||H.view==="rooms"?H.view:C.view,e=V==="rooms"?"top":V,r=H.quality==="auto"||H.quality==="efficient"||H.quality==="balanced"||H.quality==="maximum"?H.quality:C.quality,t=H.cameras&&typeof H.cameras=="object"?H.cameras:{},o={};for(let M of["three","top"]){let i=Q7(t[M]);i&&(o[M]=i)}return{version:4,view:e,appearance:H.appearance==="rooms"||H.appearance==="photo"?H.appearance:C.appearance,labels:typeof H.labels=="boolean"?H.labels:C.labels,quality:r,cameras:o}},t2=class{#C="local-user";#H=null;load(C){this.#C=w0(C);try{let H=window.localStorage.getItem(r5(this.#C));if(H)return b0(JSON.parse(H));for(let V of[3,2]){let e=window.localStorage.getItem(r5(this.#C,V));if(e)return b0(JSON.parse(e))}}catch{}return O0()}schedule(C){this.#H!==null&&window.clearTimeout(this.#H);let H=r5(this.#C);this.#H=window.setTimeout(()=>{this.#H=null;try{window.localStorage.setItem(H,JSON.stringify(C))}catch{}},250)}dispose(){this.#H!==null&&window.clearTimeout(this.#H),this.#H=null}},k0="matic-map-studio:preferred-frontend",P0=()=>{try{return window.localStorage.getItem(k0)==="v3"?"v3":"v4"}catch{return"v4"}},t5=L=>{try{return window.localStorage.setItem(k0,L),!0}catch{return!1}};var v=(L,C,H=null)=>({status:L,value:C,problem:H}),G=L=>L instanceof DOMException&&L.name==="AbortError",l1=(L,C)=>L instanceof F||L&&typeof L=="object"&&"code"in L&&typeof L.code=="string"?L.code:C,M2=L=>[L.selectedFloorOrdinal??"none",L.mapFloorOrdinal??"none",L.mapFloorCoherent?"coherent":"transition"].join(":"),o2=L=>[L.mapFloorOrdinal??"none",L.mapSessionVerified?"verified":"unverified",L.mapSessionKey??"no-session"].join(":"),Q=L=>[L.entryId,L.selectedFloorOrdinal??"none",L.mapFloorOrdinal??"none"].join("|"),_0=L=>[L.entryId,M2(L),o2(L),L.mapRevision].join("|"),T0=L=>L.runnerLocked||L.stopSettlePending||L.activePlan||L.nativeReconciliationPending||L.nativeSessionActive===!0,K7=(L,C)=>L.entryKey===C.entryKey&&L.generation===C.generation&&L.floorKey===C.floorKey&&L.missionKey===C.missionKey,B0="Live map updates paused while the current map is rechecked.",R0="Reconnecting. The last verified map remains read only.",q7=1e3,X7=["rooms","plan","draw","areaReview"],M5=(L,C)=>L.label?L.label:L.active?"Current floor":`Saved floor ${L.ordinal??C}`,i2=class{#C;#H=new z1;#L;#M=new t2;#t=new Map;#V=null;#a;#i=null;#A=null;#e=null;#x=0;#f=!1;#Z=!1;#s=!1;#n=Promise.resolve();#c=!1;#o=!1;#d="";#u=0;#S="";#r=!1;#m=!0;constructor(C,H){this.#C=C,this.#L=H}sync(C,H){if(this.#r)return;this.#V&&(this.#V.entryKey!==C.entryKey||this.#V.userKey!==C.userKey)&&this.#O("context-changed");let V=this.#m;if(this.#m=C.host.connected,this.#V=C,this.#a=H,this.#C.patch({host:C.host,activity:C.activity,batteryPercent:C.batteryPercent,robotLabel:C.robotLabel,robots:C.robots,locale:C.language}),C.userKey!==this.#S){this.#S=C.userKey;let e=this.#M.load(C.userKey);this.#C.patch({view:e.view,appearance:e.appearance,labelsVisible:e.labels,quality:e.quality,cameras:e.cameras})}if(!C.host.administrator){this.#l(),this.#O("access-required");return}if(!C.host.connected){this.#l(),this.#s=!1,this.#o=!1;let e=(this.#t.has("area-mutation")||this.#t.has("plan-mutation"))&&this.#C.value.command==="pending";this.#y();let r=this.#C.value,t=r.resources.scene.value;this.#C.patch({command:e?"idle":r.command,coherence:t?"degraded":"unavailable",resources:{...r.resources,catalog:r.resources.catalog.status==="loading"?v("idle",r.resources.catalog.value):r.resources.catalog,plans:r.resources.plans.status==="loading"?v("idle",r.resources.plans.value):r.resources.plans,areas:r.resources.areas.status==="loading"?v("idle",r.resources.areas.value):r.resources.areas,pose:v("idle",null)},map:{...r.map,available:t!==null,exactPose:!1},notice:t?{tone:"warning",text:R0}:r.notice});return}if(C.host.robotCount===0){this.#l(),this.#O("map-unavailable");return}if(this.#h(),!V){this.#C.value.notice?.text===R0&&this.#C.patch({notice:null}),this.refreshCatalog(!0);return}(this.#C.value.resources.catalog.status==="idle"||C.entryKey&&C.entryKey!==this.#C.value.selection.entryId)&&this.refreshCatalog(!0)}schedulePreferences(C){this.#M.schedule(C)}#h(){this.#i===null&&(this.#i=window.setInterval(()=>{document.visibilityState==="visible"&&this.refreshCatalog()},5e3)),this.#A===null&&(this.#A=window.setInterval(()=>{document.visibilityState==="visible"&&this.refreshPose()},q7))}#l(){this.#i!==null&&window.clearInterval(this.#i),this.#A!==null&&window.clearInterval(this.#A),this.#i=null,this.#A=null}#v(C){this.#t.get(C)?.abort();let H=new AbortController;return this.#t.set(C,H),H}#p(C,H){this.#t.get(C)===H&&this.#t.delete(C)}#y(C=[]){for(let[H,V]of this.#t)C.includes(H)||(V.abort(),this.#t.delete(H))}#O(C){this.#x+=1,this.#e!==null&&window.clearTimeout(this.#e),this.#e=null,this.#y(),this.#H.invalidate(),this.#d="";let H=this.#C.value,V=y();this.#C.patch({command:"idle",workflow:"none",notice:null,draw:V.draw,planDraft:V.planDraft,areaDraft:V.areaDraft,generation:this.#H.generation,coherence:H.host.administrator?"unavailable":"blocked",fullMap:!1,precisionOpen:!1,resources:{catalog:v("error",null,C),entry:null,scene:v("idle",null),pose:v("idle",null),history:v("idle",null),plans:v("idle",null),areas:v("idle",null)},map:{available:!1,complete:!1,floorCoherent:!1,sessionVerified:!1,exactPose:!1},selection:{...V.selection,entryId:null,floorId:"current",historyId:null}})}async refreshCatalog(C=!1){if(this.#r||!this.#V?.host.administrator||!this.#V.host.connected||this.#V.host.robotCount===0)return;if(this.#f)return C&&!this.#Z&&(this.#s=!0,this.#t.get("catalog")?.abort()),this.#n;this.#f=!0,this.#Z=C;let H;this.#n=new Promise(r=>{H=r});let V=this.#v("catalog"),e=this.#C.value.resources.catalog.value;this.#C.patch({resources:{...this.#C.value.resources,catalog:v("loading",e)}});try{let r=await this.#L.catalog(V.signal);if(V.signal.aborted||this.#r)return;let t=this.#a?.config?.entry_id,o=typeof t=="string"?t:null,M=r.find(n=>n.entryId===this.#V?.entryKey)||r.find(n=>n.entryId===o)||r[0]||null,i=this.#C.value.resources.entry;if(M&&i&&Q(M)===Q(i)&&M2(M)===M2(i)&&o2(M)===o2(i)&&M.mapRevision<i.mapRevision&&(M={...M,mapRevision:i.mapRevision}),this.#C.patch({managedLock:M?T0(M):!1,resources:{...this.#C.value.resources,catalog:v(r.length?"ready":"empty",r),entry:M}}),!M){this.#O("no-loaded-robot");return}if(this.#C.value.selection.floorId!=="current"&&!C)return;let a=_0(M);if(!C&&a===this.#d){let n=this.#C.value,A=M.mapFloorCoherent&&M.mapSessionVerified,l=M.health==="problem"||M.health==="limited";this.#C.patch({coherence:A?l?"degraded":"current":"verifying",map:{...n.map,available:A&&n.resources.scene.value!==null,complete:M.mapComplete&&!M.mapTruncated,floorCoherent:M.mapFloorCoherent,sessionVerified:M.mapSessionVerified,exactPose:A?n.map.exactPose:!1},floor:{...n.floor,classifiedCount:Math.max(1,M.historyFloorCount)}}),A&&this.#C.value.resources.plans.problem==="map-rechecking"&&this.loadPlans();return}this.#d=a,this.#k(M,i)}catch(r){if(G(r))return;this.#C.patch({coherence:this.#C.value.resources.scene.value?"degraded":"unavailable",resources:{...this.#C.value.resources,catalog:v("error",e,l1(r,"catalog-unavailable"))}})}finally{this.#p("catalog",V),this.#f=!1;let r=this.#s;this.#Z=!1;try{r&&!this.#r&&(this.#s=!1,await this.refreshCatalog(!0))}finally{H()}}}#k(C,H){let V=this.#C.value,e=!!(H&&Q(H)===Q(C)),r=C.mapFloorCoherent&&C.mapSessionVerified;this.#y(e?["catalog","plans","areas","plan-mutation","area-mutation"]:["catalog"]);let t=e?V.resources.scene.value:null,o=V.resources.pose.value,M=e&&r&&C.mapSessionKey!==null&&o?.position&&o.mapSessionKey===C.mapSessionKey?o:null,i=this.#H.begin(C.entryId,M2(C),o2(C),C.mapRevision),a=H!==null&&!e,n=y(),A=C.health==="problem"||C.health==="limited",l=this.#C.value;this.#C.patch({...a?{command:"idle",workflow:"none",draw:n.draw,planDraft:n.planDraft,areaDraft:n.areaDraft,notice:{tone:"info",text:"The active floor changed. Choose a task on this map."}}:{},managedLock:T0(C),generation:i.generation,coherence:r?A?"degraded":"current":"verifying",dataMode:"live",resources:{...l.resources,entry:C,scene:v(r?"loading":"idle",t),pose:v(r?"loading":"idle",M),history:v("loading",l.resources.history.value),plans:e?l.resources.plans:v("idle",null),areas:e?l.resources.areas:v("idle",null)},map:{available:r&&t!==null,complete:C.mapComplete&&!C.mapTruncated,floorCoherent:C.mapFloorCoherent,sessionVerified:C.mapSessionVerified,exactPose:r&&M!==null},floor:{classifiedCount:Math.max(1,C.historyFloorCount),displayName:C.selectedFloorOrdinal?`Floor ${C.selectedFloorOrdinal}`:"Current floor",readOnly:!1},selection:{...l.selection,entryId:C.entryId,floorId:"current",historyId:null,roomIds:e?l.selection.roomIds:[],roomSettings:e?l.selection.roomSettings:[],planId:e?l.selection.planId:null,areaId:e?l.selection.areaId:null}}),this.#T(C,i),r&&this.#C.value.resources.plans.status==="idle"&&this.loadPlans(),r&&(this.#F(C,i),this.#b(C,i))}async#F(C,H){let V=this.#v("scene");try{let e=await this.#L.scene(C.sceneUrl,C.mapRevision,C.mapFloorCoherent,"live",V.signal);if(!this.#H.accepts(H)||e.revision!==H.revision||!e.floorCoherent||!e.scene)return;let r=this.#C.value;this.#C.patch({resources:{...r.resources,scene:v("ready",e.scene)},map:{...r.map,available:!0},notice:r.notice?.text===B0?null:r.notice});let t=this.#C.value.resources.plans;if((t.status==="idle"||t.problem==="map-rechecking")&&this.loadPlans(),C.deltaUrl){let o=++this.#u;this.#w(C,H,e.scene,o)}}catch(e){if(G(e)||!this.#H.accepts(H))return;if(e instanceof F&&e.code==="request-timeout"){let M=this.#C.value;this.#C.patch({resources:{...M.resources,scene:v("loading",M.resources.scene.value,"scene-building")}}),window.setTimeout(()=>{this.#r||!this.#H.accepts(H)||this.#C.value.selection.floorId!=="current"||this.#F(C,H)},250);return}let r=this.#C.value,t=r.resources.pose.value,o=r.resources.scene.value!==null&&C.mapSessionKey!==null&&t?.position!==null&&t?.mapSessionKey===C.mapSessionKey;this.#C.patch({coherence:"degraded",resources:{...r.resources,scene:v("error",r.resources.scene.value,l1(e,"scene-unavailable"))},map:{...r.map,available:r.resources.scene.value!==null,exactPose:o}})}finally{this.#p("scene",V)}}async#w(C,H,V,e){if(!C.deltaUrl||typeof DecompressionStream!="function")return;let r=C.deltaUrl,t=C,o=H,M=V;try{for(;!this.#r&&e===this.#u&&this.#H.accepts(o)&&this.#C.value.selection.floorId==="current";){let i=this.#v("delta");try{let a=await this.#L.sceneDelta(r,M,t.mapFloorCoherent,i.signal);if(i.signal.aborted||this.#r||e!==this.#u||!this.#H.accepts(o))return;if(!a.floorCoherent){this.#C.patch({coherence:"verifying",map:{...this.#C.value.map,available:!1,floorCoherent:!1,exactPose:!1},resources:{...this.#C.value.resources,pose:v("idle",null)}}),this.#d="",this.refreshCatalog(!0);return}if(a.notModified||!a.scene){await new Promise(l=>window.setTimeout(l,100));continue}let n=this.#H.advance(o,a.revision);if(!n)return;o=n,M=a.scene,t={...t,mapRevision:a.revision},this.#d=_0(t);let A=this.#C.value;this.#C.patch({resources:{...A.resources,entry:t,scene:v("ready",M)},map:{...A.map,available:!0,floorCoherent:!0}}),this.#b(t,o)}finally{this.#p("delta",i)}}}catch(i){if(G(i)||this.#r||e!==this.#u||!this.#H.accepts(o))return;this.#C.patch({coherence:"degraded",notice:{tone:"warning",text:B0}}),this.#d="",this.refreshCatalog(!0)}}async#T(C,H){let V=this.#v("history");try{let e=await this.#L.history(C.historyUrl,V.signal);if(!this.#H.accepts(H)||e.entryId!==C.entryId)return;let r=this.#C.value,t=e.floors.find(i=>i.id===r.selection.floorId),o=!r.selection.historyId||t?.snapshots.some(i=>i.id===r.selection.historyId),M=r.dataMode==="live"?e.floors.find(i=>i.active):t;if(this.#C.patch({resources:{...this.#C.value.resources,history:v("ready",e)},floor:{...this.#C.value.floor,classifiedCount:e.floors.length,...M?{displayName:M5(M,1)}:{}}}),r.dataMode==="history"&&(!t||!o)){let i=t||e.floors.find(n=>n.active)||e.floors[0],a=this.selectFloor(i?.id||"current");!this.#r&&r.workflow==="history"&&this.#C.dispatch({type:"open-workflow",workflow:"history"}),await a}}catch(e){if(G(e)||!this.#H.accepts(H))return;this.#C.patch({resources:{...this.#C.value.resources,history:v("error",null,l1(e,"history-unavailable"))}})}finally{this.#p("history",V)}}async refreshPose(){let C=this.#C.value.resources.entry,H=this.#H.current();!C||!H||this.#C.value.selection.floorId!=="current"||!C.mapFloorCoherent||!C.mapSessionVerified||await this.#b(C,H)}async#b(C,H){if(this.#r||!this.#m||!this.#V?.host.connected)return;if(this.#c){this.#o=!0;return}this.#c=!0;let V=this.#v("pose");try{let e=await this.#L.pose(C.poseUrl,V.signal),r=this.#H.current(),t=this.#C.value.resources.entry;if(!r||!K7(H,r)||!t||!e.floorCoherent)return;if(e.mapSessionKey===null||e.mapSessionKey!==t.mapSessionKey){this.#C.patch({map:{...this.#C.value.map,exactPose:!1}}),this.#d="",this.refreshCatalog(!0);return}let o=this.#C.value,M=o.resources.pose.value,i=!!(o.map.exactPose&&M?.position&&M.mapSessionKey===t.mapSessionKey);if(e.position===null&&i){this.#C.patch({resources:{...o.resources,pose:v("ready",M)}});return}this.#C.patch({resources:{...o.resources,pose:v("ready",e)},map:{...o.map,exactPose:e.position!==null}})}catch(e){if(G(e)||!this.#H.accepts(H))return;let r=this.#C.value,t=r.resources.pose.value,o=!!(r.map.exactPose&&t?.position&&t.mapSessionKey===r.resources.entry?.mapSessionKey);this.#C.patch({resources:{...r.resources,pose:v("error",o?t:null,l1(e,"pose-unavailable"))},map:{...r.map,exactPose:o}})}finally{if(this.#p("pose",V),this.#c=!1,this.#o&&!this.#r&&this.#m&&this.#V?.host.connected&&this.#V.host.administrator&&this.#V.host.robotCount>0){this.#o=!1;let e=this.#C.value.resources.entry,r=this.#H.current();e&&r&&this.#b(e,r)}else this.#o=!1}}async selectFloor(C){let H=this.#C.value.resources.history.value,V=this.#C.value.resources.entry;if(!H||!V)return;let e=H.floors.find(M=>M.id===C);if(!e&&C!=="current")return;let r=this.#C.value;if(r.workflow==="draw"&&(r.draw.dirty||r.areaDraft.dirty)||r.workflow==="areaReview"&&(r.draw.dirty||r.areaDraft.dirty))return;if(!e||e.active){this.#d="";let M=this.#C.value;this.#C.patch({resources:{...M.resources,plans:v("idle",null),areas:v("idle",null),scene:v("idle",null),pose:v("idle",null)},map:{...M.map,available:!1,exactPose:!1},coherence:"verifying",floor:{...M.floor,readOnly:!1,displayName:"Current floor"},workflow:"none",precisionOpen:!1}),this.#C.dispatch({type:"set-floor",floorId:"current"}),await this.refreshCatalog(!0);return}let t=e.snapshots.at(-1);this.#y(["catalog"]);let o=this.#H.begin(V.entryId,e.id,t?.id||e.id,t?.revision||0);this.#C.patch({generation:o.generation,coherence:"current",dataMode:"history",floor:{classifiedCount:H.floors.length,displayName:M5(e,H.floors.indexOf(e)+1),readOnly:!0},selection:{...this.#C.value.selection,floorId:e.id,historyId:t?.id||null},resources:{...this.#C.value.resources,scene:v(t?"loading":"empty",null),pose:v("idle",null),plans:v("idle",null),areas:v("idle",null)},workflow:"none",precisionOpen:!1,map:{available:!1,complete:!0,floorCoherent:!0,sessionVerified:!0,exactPose:!1}}),t&&await this.#g(t,o)}async selectHistory(C){let H=this.#C.value.resources.history.value,V=this.#C.value.resources.entry;if(!H||!V)return;if(!C){await this.selectFloor("current");return}let e=H.floors.find(o=>o.snapshots.some(M=>M.id===C)),r=e?.snapshots.find(o=>o.id===C);if(!e||!r)return;let t=this.#H.begin(V.entryId,e.id,r.id,r.revision);this.#y(["catalog"]),this.#C.patch({generation:t.generation,dataMode:"history",floor:{classifiedCount:H.floors.length,displayName:M5(e,H.floors.indexOf(e)+1),readOnly:!0},selection:{...this.#C.value.selection,floorId:e.id,historyId:r.id},resources:{...this.#C.value.resources,scene:v("loading",null),pose:v("idle",null)},map:{...this.#C.value.map,available:!1,exactPose:!1}}),await this.#g(r,t)}async#g(C,H){let V=this.#v("history-scene");try{let e=await this.#L.scene(C.sceneUrl,C.revision,!0,"history",V.signal);if(!this.#H.accepts(H)||!e.scene)return;this.#C.patch({resources:{...this.#C.value.resources,scene:v("ready",e.scene)},map:{...this.#C.value.map,available:!0,exactPose:!1}})}catch(e){if(G(e)||!this.#H.accepts(H))return;this.#C.patch({resources:{...this.#C.value.resources,scene:v("error",null,l1(e,"history-scene-unavailable"))}})}finally{this.#p("history-scene",V)}}async openWorkflow(C){let H=this.#C.value;if((H.dataMode==="history"||H.floor.readOnly)&&X7.includes(C))return;let V=this.#C.value.workflow;if(C==="draw"&&V!=="draw"&&V!=="areaReview"&&this.selectArea(null),this.#C.dispatch({type:"open-workflow",workflow:C}),C==="history"){let e=this.#C.value.resources.entry,r=this.#H.current();e&&r&&(this.#C.patch({resources:{...this.#C.value.resources,history:v("loading",this.#C.value.resources.history.value)}}),await this.#T(e,r))}(C==="plan"||C==="rooms")&&await this.loadPlans(),(C==="draw"||C==="areaReview")&&await this.loadAreas()}async loadPlans(){let C=this.#C.value.resources.entry;if(!C||!this.#H.current()||!v2(this.#C.value)||this.#C.value.resources.plans.status==="loading")return;let H=Q(C),V=this.#v("plans");this.#C.patch({resources:{...this.#C.value.resources,plans:v("loading",null)}});try{let e=await this.#L.plans(C.plansUrl,V.signal),r=this.#C.value.resources.entry;if(V.signal.aborted||this.#r||!r||Q(r)!==H)return;if(this.#C.value.planDraft.dirty){this.#C.patch({resources:{...this.#C.value.resources,plans:v("ready",e)}});return}let t=e.selectedPlan||e.plans[0]?.id||null,o=e.plans.find(M=>M.id===t);this.#C.patch({resources:{...this.#C.value.resources,plans:v("ready",e)},selection:{...this.#C.value.selection,planId:t},planDraft:o?this.#B(o):{...this.#C.value.planDraft,id:null,name:"",rooms:[],dirty:!1}})}catch(e){let r=this.#C.value.resources.entry;if(G(e)||V.signal.aborted||this.#r||!r||Q(r)!==H)return;let t=e instanceof F&&e.code==="map-rechecking"?"map-rechecking":l1(e,"plans-unavailable");this.#C.patch({resources:{...this.#C.value.resources,plans:v("error",null,t)}})}finally{this.#p("plans",V)}}selectPlan(C){let H=this.#C.value.resources.plans.value?.plans.find(V=>V.id===C);this.#C.patch({selection:{...this.#C.value.selection,planId:C},planDraft:H?this.#B(H):{...this.#C.value.planDraft,id:null,name:"",rooms:[],dirty:!1}})}#B(C){return{id:C.id,name:C.name,enabled:C.enabled,runBehavior:C.runBehavior,rooms:(C.roomOrder.length?C.roomOrder.flatMap(H=>{let V=C.rooms.find(e=>e.roomId===H);return V?[V]:[]}):C.rooms).map(H=>({...H})),returnToBase:C.returnToBase,finishCurrentRoom:C.finishCurrentRoom,finishCurrentRoomThreshold:C.finishCurrentRoomThreshold,dirty:!1}}async loadAreas(){let C=this.#C.value.resources.entry;if(!C||!this.#H.current()||!v2(this.#C.value))return;let H=Q(C),V=this.#v("areas");this.#C.patch({resources:{...this.#C.value.resources,areas:v("loading",null)}});try{let e=await this.#L.areas(C.areasUrl,V.signal),r=this.#C.value.resources.entry;if(V.signal.aborted||this.#r||!r||Q(r)!==H||e.sceneUrl!==r.sceneUrl)return;this.#C.patch({resources:{...this.#C.value.resources,areas:v("ready",e)}});let t=this.#C.value.selection.areaId,o=this.#C.value;(t!==null||!o.draw.dirty&&!o.areaDraft.dirty)&&this.selectArea(e.areas.some(M=>M.id===t)?t:null)}catch(e){let r=this.#C.value.resources.entry;if(G(e)||V.signal.aborted||this.#r||!r||Q(r)!==H)return;this.#C.patch({resources:{...this.#C.value.resources,areas:v("error",null,l1(e,"areas-unavailable"))}})}finally{this.#p("areas",V)}}selectArea(C){let H=this.#C.value.resources.areas.value?.areas.find(e=>e.id===C),V=this.#C.value;this.#C.patch({selection:{...V.selection,areaId:C},areaDraft:H?this.#P(H):{id:null,name:"",cleaningMode:"vacuum",coverageSetting:"standard",status:"new",canRebind:!1,dirty:!1},draw:{...V.draw,circles:H?.circles||[],undo:[],redo:[],dirty:!1,strokeCount:0}})}#P(C){return{id:C.id,name:C.name,cleaningMode:C.cleaningMode,coverageSetting:C.coverageSetting,status:C.status,canRebind:C.canRebind,dirty:!1}}async saveArea(){let C=this.#C.value,H=C.resources.entry,V=C.areaDraft;if(!H||C.command==="pending"||!U(C)||!V.name.trim()||!C.draw.circles.length)return;let e=this.#v("area-mutation"),r=()=>!this.#r&&!e.signal.aborted;this.#C.patch({command:"pending",notice:{tone:"info",text:"Saving area\u2026"}});try{let t=await this.#L.saveArea(H.areasUrl,{areaId:V.id,name:V.name.trim(),circles:C.draw.circles,cleaningMode:V.cleaningMode,coverageSetting:V.coverageSetting},e.signal);if(!r())return;this.#C.patch({command:"idle",notice:{tone:"success",text:"Area saved"}}),await this.loadAreas(),r()&&this.selectArea(t)}catch(t){if(G(t)||!r())return;this.#C.patch({command:"failed",notice:{tone:"error",text:"Area could not be saved"}})}finally{this.#p("area-mutation",e)}}async deleteArea(){let C=this.#C.value.resources.entry,H=this.#C.value.selection.areaId;if(!C||!H||this.#C.value.command==="pending"||!U(this.#C.value))return;let V=this.#v("area-mutation"),e=()=>!this.#r&&!V.signal.aborted;this.#C.patch({command:"pending",notice:null});try{if(await this.#L.deleteArea(C.areasUrl,H,V.signal),!e())return;this.#C.patch({command:"idle",notice:{tone:"success",text:"Area deleted"}}),await this.loadAreas()}catch(r){!G(r)&&e()&&this.#C.patch({command:"failed",notice:{tone:"error",text:"Area could not be deleted"}})}finally{this.#p("area-mutation",V)}}async savePlan(){let C=this.#C.value,H=C.planDraft,V=C.resources.plans.value;if(!V||!H.name.trim()||!H.rooms.length||!U(C))return;let e=H.rooms;await this.#_("save_plan",{...H.id?{plan_id:H.id}:{},name:H.name.trim(),enabled:H.enabled,run_behavior:H.runBehavior,rooms:e.map(t=>({room:t.roomId,cleaning_mode:t.cleaningMode,coverage_setting:t.coverageSetting})),return_to_base:H.returnToBase,finish_current_room:H.finishCurrentRoom,finish_current_room_threshold:H.finishCurrentRoomThreshold,select:!H.id||V.selectedPlan===H.id},"Plan saved","Plan could not be saved")&&(this.#C.patch({planDraft:{...this.#C.value.planDraft,dirty:!1}}),await this.loadPlans())}async deletePlan(){let C=this.#C.value.selection.planId,H=this.#C.value.selection.entryId;if(!C)return;await this.#_("delete_plan",{plan:C},"Plan deleted","Plan could not be deleted")&&(this.#C.value.selection.entryId===H&&this.#C.value.planDraft.id===C&&this.selectPlan(null),await this.loadPlans())}async executeAction(C){switch(C){case"recheck-status":{let H=this.#C.value.selection.entryId;await this.refreshCatalog(!0);let V=this.#C.value;!this.#r&&V.selection.entryId===H&&V.resources.catalog.status==="ready"&&V.host.connected&&V.host.robotConnected&&V.coherence==="current"&&V.command==="failed"&&this.#C.patch({command:"idle",notice:{tone:"info",text:"Status refreshed. Review the robot state before trying again."}});return}case"stop":await this.#R("matic_robot","stop_intelligent_cleaning",{include_unmanaged:!0});return;case"resume":await this.#R("vacuum","send_command",{command:"resume"});return;case"run-plan":{let H=this.#C.value.selection.planId||this.#C.value.resources.plans.value?.selectedPlan;H&&await this.#R("matic_robot","run_selected_plan",{plan:H});return}case"clean-rooms":{let V=this.#C.value.selection.roomSettings.map(e=>({room:e.roomId,cleaning_mode:e.cleaningMode,coverage_setting:e.coverageSetting}));V.length&&await this.#R("matic_robot","clean_room_sequence",{rooms:V,return_to_base:!0});return}case"run-area":{let H=this.#C.value.selection.areaId;H&&await this.#R("matic_robot","clean_area",{area:H});return}case"review-area":this.#C.dispatch({type:"open-workflow",workflow:"areaReview"});return;case"save-area":await this.saveArea();return;case"save-plan":await this.savePlan();return;case"delete-plan":await this.deletePlan();return;case"delete-area":await this.deleteArea();return}}async#_(C,H,V,e){let r=this.#V?.vacuumEntityId;if(!r||!U(this.#C.value)||this.#C.value.command==="pending")return!1;let t=this.#v("plan-mutation"),o=this.#V?.entryKey,M=this.#V?.userKey,i=()=>!this.#r&&!t.signal.aborted&&o===this.#V?.entryKey&&M===this.#V?.userKey;this.#C.patch({command:"pending",notice:{tone:"info",text:"Saving\u2026"}});try{return await this.#L.service("matic_robot",C,H,r),i()?(this.#C.patch({command:"idle",notice:{tone:"success",text:V}}),!0):!1}catch{return i()&&this.#C.patch({command:"failed",notice:{tone:"error",text:e}}),!1}finally{this.#p("plan-mutation",t)}}async#R(C,H,V){let e=this.#C.value,r=this.#V?.vacuumEntityId,t=H==="stop_intelligent_cleaning"||C==="vacuum"&&H==="return_to_base",o=C==="vacuum"&&H==="send_command"&&V.command==="resume";if(!r||e.selection.entryId!==this.#V?.entryKey||(t?!x2(e):o?!c2(e):!m1(e)))return;let M=++this.#x,i=this.#V?.entryKey,a=()=>!this.#r&&M===this.#x&&i===this.#V?.entryKey,n=t?"settling":"starting";this.#e!==null&&window.clearTimeout(this.#e),this.#e=null,this.#C.patch({command:n,notice:null});try{if(await this.#L.service(C,H,V,r),!a())return;if(C==="matic_robot"&&(H==="clean_room_sequence"||H==="run_selected_plan")){this.#C.patch({command:"idle"}),this.refreshCatalog(!0);return}this.#C.patch({command:n}),this.#e!==null&&window.clearTimeout(this.#e),this.#e=window.setTimeout(()=>{this.#e=null,a()&&this.#C.value.command===n&&this.#C.patch({command:"idle"})},15e3)}catch{if(!a())return;this.#C.patch({command:"failed",notice:{tone:"error",text:"The action could not be confirmed. Check the robot status before trying again."}})}}updateDraftCircles(C,H=!0,V){this.#C.dispatch({type:"set-draft-circles",circles:C,record:H,...V?{previous:V}:{}}),this.#C.dispatch({type:"patch-area-draft",patch:{dirty:!0}})}dispose(){this.#r||(this.#r=!0,this.#l(),this.#y(),this.#e!==null&&window.clearTimeout(this.#e),this.#e=null,this.#M.dispose(),this.#L.dispose(),this.#H.invalidate())}};var F0=L=>(L.workflow==="none"?0:1)+(L.fullMap?1:0)+(L.precisionOpen?1:0)+(L.dialog?1:0),E0=L=>{if(!L||typeof L!="object")return null;let C=L.maticMapLayer;if(!C||typeof C!="object")return null;let H=C.owner,V=C.depth;return typeof H=="string"&&Number.isInteger(V)&&Number(V)>=0?{owner:H,depth:Number(V)}:null},a2=class{#C;#H=`matic-map-${crypto.randomUUID?.()||Math.random().toString(36).slice(2)}`;#L=0;#M=null;#t=!1;#V=!1;constructor(C){this.#C=C}start(){this.#M||(this.#L=F0(this.#C.value),this.#M=this.#C.subscribe(C=>this.#a(C)),window.addEventListener("popstate",this.#i))}#a(C){let H=F0(C);if(this.#t){this.#t=!1,this.#L=H;return}if(H<this.#L){let V=E0(history.state);if(V?.owner===this.#H&&V.depth===this.#L){let e=H-this.#L;this.#L=H,this.#V=!0,history.go(e);return}}if(H>this.#L)for(let V=this.#L+1;V<=H;V+=1){let e=history.state&&typeof history.state=="object"?history.state:{};history.pushState({...e,maticMapLayer:{owner:this.#H,depth:V}},"",window.location.href)}this.#L=H}#i=()=>{if(this.#V){this.#V=!1;return}if(!(this.#L<1)){if(e1(this.#C.value,{type:"dismiss-top-layer"})){let C=history.state&&typeof history.state=="object"?history.state:{};history.pushState({...C,maticMapLayer:{owner:this.#H,depth:this.#L}},"",window.location.href),this.#C.dispatch({type:"open-dialog",dialog:"discardDraft"});return}this.#t=!0,this.#C.dispatch({type:"dismiss-top-layer"})}};dismissTop(){if(this.#L<1)return!1;let C=E0(history.state);return C?.owner===this.#H&&C.depth===this.#L?history.back():this.#C.dispatch({type:"dismiss-top-layer"}),!0}dispose(){this.#M?.(),this.#M=null,window.removeEventListener("popstate",this.#i),this.#L=0,this.#V=!1}};var D0=J(n1),o5=class extends w{constructor(){super(...arguments);this.narrow=!1;this._workspace=y();this._classic=!1;this.entryOverride=null;this.#C=new G1;this.#H=new v1(this._workspace);this.#L=null;this.#M=null;this.#t=null;this.#V=null;this.#a=null;this.#i=""}static{this.styles=[D,$,O`
...
`]}static{this.properties={hass:{attribute:!1},narrow:{type:Boolean},route:{attribute:!1},panel:{attribute:!1},_workspace:{state:!0},_classic:{state:!0},entryOverride:{state:!0}}}#C;#H;#L;#M;#t;#V;#a;#i;connectedCallback(){super.connectedCallback(),this._classic=P0()==="v3",this.#M=this.#H.subscribe(H=>{this._workspace=H,this.#x(H)}),this._classic||this.#A()}disconnectedCallback(){this.#M?.(),this.#M=null,this.#e(),super.disconnectedCallback()}#A(){if(!this.#V&&(this.#L=this.#C.project(this.hass,this.panel,this.entryOverride),this.#t=new r2(()=>this.hass),this.#V=new i2(this.#H,this.#t),this.#a=new a2(this.#H),this.#a.start(),this.#L)){this.#V.sync(this.#L,this.panel);let{host:H}=this.#L;H.connected&&H.administrator&&H.robotCount>0&&this.#V.refreshCatalog(this.#H.value.selection.floorId==="current")}}#e(){this.#a?.dispose(),this.#a=null,this.#V?.dispose(),this.#V=null,this.#t=null}#x(H){if(!this.#V)return;let V={version:4,view:H.view,appearance:H.appearance,labels:H.labelsVisible,quality:H.quality,cameras:H.cameras},e=JSON.stringify(V);e!==this.#i&&(this.#i=e,this.#V.schedulePreferences(V))}willUpdate(H){if(H.has("hass")||H.has("panel")||H.has("entryOverride")){let V=this.#C.project(this.hass,this.panel,this.entryOverride);if(V!==this.#L){this.#L=V;let e=V.host.connected?V.host.robotCount===0?"unavailable":V.host.administrator?"verifying":"blocked":"degraded";this.#H.replace({...this.#H.value,coherence:e,activity:V.activity,batteryPercent:V.batteryPercent,host:V.host,fullMap:V.host.administrator&&V.host.robotCount>0&&this.#H.value.fullMap,robotLabel:V.robotLabel,robots:V.robots,locale:V.language})}this._classic||this.#V?.sync(V,this.panel)}H.has("narrow")&&this.#H.value.narrowHint!==this.narrow&&this.#H.dispatch({type:"set-narrow-hint",value:this.narrow})}#f(H){if(!d1(H.detail))return;H.stopPropagation();let V=H.detail;if(V.type==="dismiss-top-layer"||V.type==="exit-full-map"){this.#a?.dismissTop()||this.#H.dispatch(V);return}if(V.type==="open-workflow"&&V.workflow!=="none"){this.#V?.openWorkflow(V.workflow);return}if(V.type==="set-floor"){this.#V?.selectFloor(V.floorId);return}if(V.type==="select-entry"){if(!this._workspace.robots.some(e=>e.entryId===V.entryId))return;this.entryOverride=V.entryId;return}if(V.type==="set-history"){this.#V?.selectHistory(V.historyId);return}if(V.type==="select-plan"){this.#V?.selectPlan(V.planId);return}if(V.type==="select-area"){this.#V?.selectArea(V.areaId),V.workflow==="areaReview"&&this.#V?.openWorkflow("areaReview");return}this.#H.dispatch(V)}#Z(H){if(H.stopPropagation(),typeof H.detail?.id=="string"){if(H.detail.id==="use-classic"){t5("v3")&&(this.#e(),this._classic=!0);return}this.#V?.executeAction(H.detail.id),this.dispatchEvent(new CustomEvent("matic-map-v4-action-requested",{detail:{id:H.detail.id},bubbles:!0,composed:!0}))}}#s(){t5("v4")&&(this._classic=!1,this.#A(),this.requestUpdate())}updated(){if(!this._classic)return;let H=this.renderRoot.querySelector("matic-map-panel-v0-3-1");H&&(H.hass=this.hass,H.narrow=this.narrow,H.route=this.route,H.panel=this.panel)}getWorkspaceSnapshot(){return this.#H.value}render(){return this._classic?c`
        <div class="classic">
