var j=100,Le=1e3,be=.2,Te=2.5,at=64,ze=o=>!o||typeof o!="object"?!1:typeof o.type=="string";var ie=()=>({status:"idle",value:null,problem:null}),B=(o,e,t)=>Math.max(e,Math.min(t,o)),uo=o=>({yaw:B(Number.isFinite(o.yaw)?o.yaw:0,-Math.PI,Math.PI),pitch:B(Number.isFinite(o.pitch)?o.pitch:Math.PI/2-.018,.18,Math.PI/2-.018),zoom:B(Number.isFinite(o.zoom)?o.zoom:1,.01,100),targetX:B(Number.isFinite(o.targetX)?o.targetX:0,-1e4,1e4),targetZ:B(Number.isFinite(o.targetZ)?o.targetZ:0,-1e4,1e4)}),qt=o=>Math.round(B(Number.isFinite(o)?o:100,100,1e3)),ho=o=>Math.round(B(Number.isFinite(o)?o:.2,.2,2.5)*100)/100,M=()=>({generation:0,coherence:"verifying",dataMode:"live",activity:"unknown",workflow:"none",command:"idle",fullMap:!1,precisionOpen:!1,dialog:null,narrowHint:!1,view:"top",appearance:"photo",labelsVisible:!0,quality:"auto",cameras:{},managedLock:!1,batteryPercent:null,floor:{classifiedCount:1,displayName:"Current floor",readOnly:!1},map:{available:!1,complete:!1,floorCoherent:!1,sessionVerified:!1,exactPose:!1},host:{connected:!0,administrator:!0,robotConnected:!1,robotCount:0},draw:{zoomPercent:100,zoomOriginX:50,zoomOriginY:50,brushMeters:.6,tool:"paint",dirty:!1,strokeCount:0,circles:[],undo:[],redo:[]},resources:{catalog:ie(),entry:null,scene:ie(),pose:ie(),history:ie(),plans:ie(),areas:ie()},selection:{entryId:null,floorId:"current",historyId:null,roomIds:[],roomSettings:[],cleaningMode:"vacuum",coverageSetting:"standard",planId:null,areaId:null},planDraft:{id:null,name:"",enabled:!0,runBehavior:"intelligent",rooms:[],returnToBase:!0,finishCurrentRoom:!1,finishCurrentRoomThreshold:50,dirty:!1},areaDraft:{id:null,name:"",cleaningMode:"vacuum",coverageSetting:"standard",status:"new",canRebind:!1,dirty:!1},notice:null,robotLabel:"Matic robot",robots:[],locale:"en"}),N=(o,e)=>({...o,draw:{...o.draw,...e}}),po=(o,e)=>{switch(e.type){case"set-host":return{...o,host:e.host,fullMap:e.host.administrator&&e.host.robotCount>0?o.fullMap:!1};case"set-operational-state":return{...o,coherence:e.coherence,activity:e.activity,command:e.command??o.command};case"set-narrow-hint":return{...o,narrowHint:e.value};case"set-view":return{...o,view:e.view};case"set-appearance":return{...o,appearance:e.appearance};case"set-quality":return{...o,quality:e.quality};case"set-camera":return{...o,cameras:{...o.cameras,[e.view]:uo(e.camera)}};case"toggle-labels":return{...o,labelsVisible:!o.labelsVisible};case"open-workflow":return{...o,workflow:e.workflow,precisionOpen:!1};case"enter-full-map":return o.host.administrator&&o.host.robotCount>0&&o.map.available?{...o,fullMap:!0}:o;case"exit-full-map":return{...o,fullMap:!1,precisionOpen:!1};case"set-precision-open":return{...o,precisionOpen:e.value};case"set-zoom":return N(o,{zoomPercent:qt(e.value),...e.originX===void 0?{}:{zoomOriginX:B(e.originX,0,100)},...e.originY===void 0?{}:{zoomOriginY:B(e.originY,0,100)}});case"step-zoom":return N(o,{zoomPercent:qt(o.draw.zoomPercent*e.factor)});case"fit-map":return N(o,{zoomPercent:100,zoomOriginX:50,zoomOriginY:50});case"set-brush":return N(o,{brushMeters:ho(e.value)});case"set-draw-tool":return N(o,{tool:e.tool});case"mark-draft":{let t=Math.max(0,o.draw.strokeCount+e.strokeDelta);return N(o,{dirty:t>0,strokeCount:t})}case"undo-draft":{let t=o.draw.undo.at(-1);return t?N(o,{circles:t,undo:o.draw.undo.slice(0,-1),redo:[...o.draw.redo,o.draw.circles],dirty:!0,strokeCount:Math.max(0,o.draw.strokeCount-1)}):o}case"clear-draft":return o.draw.circles.length?N(o,{circles:[],undo:[...o.draw.undo.slice(-99),o.draw.circles],redo:[],dirty:!0,strokeCount:o.draw.strokeCount+1}):o;case"redo-draft":{let t=o.draw.redo.at(-1);return t?N(o,{circles:t,undo:[...o.draw.undo,o.draw.circles],redo:o.draw.redo.slice(0,-1),dirty:!0,strokeCount:o.draw.strokeCount+1}):o}case"set-draft-circles":{let t=e.circles.slice(0,512).map(n=>({...n})),r=e.record!==!1;return N(o,{circles:t,undo:r?[...o.draw.undo.slice(-99),e.previous??o.draw.circles]:o.draw.undo,redo:r?[]:o.draw.redo,dirty:!0,strokeCount:r?o.draw.strokeCount+1:o.draw.strokeCount})}case"discard-draft":return{...N(o,{dirty:!1,strokeCount:0,circles:[],undo:[],redo:[]}),dialog:null,workflow:"none",precisionOpen:!1};case"toggle-room":{let t=o.selection.roomIds.includes(e.roomId);return{...o,selection:{...o.selection,roomIds:t?o.selection.roomIds.filter(r=>r!==e.roomId):[...o.selection.roomIds,e.roomId],roomSettings:t?o.selection.roomSettings.filter(r=>r.roomId!==e.roomId):[...o.selection.roomSettings,{roomId:e.roomId,cleaningMode:"vacuum",coverageSetting:"standard"}]}}}case"patch-room-settings":return{...o,selection:{...o.selection,roomSettings:o.selection.roomSettings.map(t=>t.roomId===e.roomId?{...t,...e.cleaningMode?{cleaningMode:e.cleaningMode}:{},...e.coverageSetting?{coverageSetting:e.coverageSetting}:{}}:t)}};case"set-floor":return{...o,dataMode:e.floorId==="current"?"live":"history",selection:{...o.selection,floorId:e.floorId,historyId:null}};case"select-entry":return o;case"set-history":return{...o,dataMode:e.historyId?"history":"live",selection:{...o.selection,historyId:e.historyId}};case"select-plan":return{...o,selection:{...o.selection,planId:e.planId}};case"select-area":return{...o,selection:{...o.selection,areaId:e.areaId}};case"patch-plan-draft":return{...o,planDraft:{...o.planDraft,...e.patch,dirty:e.patch.dirty??!0}};case"patch-area-draft":return{...o,areaDraft:{...o.areaDraft,...e.patch,dirty:e.patch.dirty??!0}};case"set-notice":return{...o,notice:e.notice};case"open-dialog":return{...o,dialog:e.dialog};case"dismiss-top-layer":return o.dialog?{...o,dialog:null}:o.precisionOpen?{...o,precisionOpen:!1}:o.fullMap?{...o,fullMap:!1}:o.workflow!=="none"?{...o,workflow:"none",precisionOpen:!1}:o;case"return-live":return{...o,dataMode:"live",workflow:"none",floor:{...o.floor,readOnly:!1}}}},le=class{#e=new Set;#t;constructor(e=M()){this.#t=e}get value(){return this.#t}dispatch(e){let t=po(this.#t,e);if(t===this.#t)return t;this.#t=t;for(let r of this.#e)r(t);return t}replace(e){if(e!==this.#t){this.#t=e;for(let t of this.#e)t(e)}}patch(e){let t={...this.#t,...e};return this.replace(t),t}subscribe(e){return this.#e.add(e),e(this.#t),()=>this.#e.delete(e)}},De=class{#e=null;#t=0;get generation(){return this.#t}begin(e,t,r,n){return this.#t+=1,this.#e={entryKey:e,generation:this.#t,floorKey:t,missionKey:r,revision:n},this.#e}current(){return this.#e}accepts(e){let t=this.#e;return!!(t&&e.entryKey===t.entryKey&&e.generation===t.generation&&e.floorKey===t.floorKey&&e.missionKey===t.missionKey&&e.revision===t.revision)}advance(e,t){return!this.accepts(e)||!Number.isSafeInteger(t)||t<=e.revision?null:(this.#e={...e,revision:t},this.#e)}invalidate(){return this.#t+=1,this.#e=null,this.#t}},ce=o=>o.dataMode==="live"&&o.map.available&&(o.coherence==="current"||o.coherence==="degraded")&&o.host.administrator,Xt=o=>ce(o)&&(o.coherence==="current"||o.coherence==="degraded")&&o.map.floorCoherent&&o.map.sessionVerified&&o.map.exactPose&&o.host.connected&&o.host.robotConnected,q=o=>ce(o)&&o.coherence==="current"&&o.map.complete&&o.map.floorCoherent&&o.map.sessionVerified&&o.host.connected&&o.host.robotConnected&&!o.floor.readOnly,it=o=>ce(o)&&o.coherence==="current"&&o.map.floorCoherent&&o.map.sessionVerified&&o.host.connected&&o.host.robotConnected&&!o.floor.readOnly,se=o=>q(o)&&!o.managedLock&&o.command==="idle"&&(o.activity==="idle"||o.activity==="docked"),ge=(o,e,t)=>({id:o,label:e,kind:"neutral",enabled:!1,reason:t}),Vt=o=>{if(o.dataMode==="history")return{id:"return-live",label:"Return to Live",kind:"primary",enabled:!0};if(o.activity==="cleaning"||o.activity==="returning"||o.activity==="recharging")return{id:"stop",label:"Stop",kind:"danger",enabled:o.command==="idle"};if(o.activity==="stopping"||o.command==="settling")return ge("stopping","Stopping\u2026","Waiting for the robot to settle");if(o.activity==="paused")return{id:"resume",label:"Resume",kind:"primary",enabled:o.command==="idle"};if(!o.host.connected)return ge("reconnecting","Reconnecting\u2026","Home Assistant is offline");if(!o.host.administrator)return ge("administrator","Administrator required","This map is private");if(!o.host.robotConnected)return ge("robot-offline","Robot offline","Reconnect the robot first");if(o.coherence!=="current")return ge("locating","Locating\u2026","Waiting for the current map");if(o.workflow==="draw")return o.fullMap||o.narrowHint?{id:"review-area",label:"Review details",kind:"primary",enabled:o.draw.dirty,...o.draw.dirty?{}:{reason:"Draw an area first"}}:{id:"save-area",label:"Save area",kind:"primary",enabled:o.draw.dirty&&q(o),...o.draw.dirty?{}:{reason:"Draw an area first"}};if(o.workflow==="rooms"){let e=se(o)&&o.selection.roomIds.length>0;return{id:"clean-rooms",label:o.selection.roomIds.length?`Clean ${o.selection.roomIds.length} room${o.selection.roomIds.length===1?"":"s"}`:"Choose rooms",kind:"primary",enabled:e,...e?{}:{reason:o.selection.roomIds.length?"Map verification is required":"Select at least one room"}}}if(o.workflow==="plan"){if(o.planDraft.dirty||!o.planDraft.id){let e=q(o)&&o.planDraft.name.trim().length>0&&o.planDraft.rooms.length>0;return{id:"save-plan",label:"Save plan",kind:"primary",enabled:e,...e?{}:{reason:"Add a name and at least one room"}}}return{id:"run-plan",label:"Run plan",kind:"primary",enabled:se(o)&&o.planDraft.enabled,...se(o)?{}:{reason:"Map verification is required"}}}if(o.workflow==="areaReview"){if(o.areaDraft.dirty||o.draw.dirty||!o.areaDraft.id||o.areaDraft.canRebind){let t=q(o)&&o.areaDraft.name.trim().length>0&&o.draw.circles.length>0;return{id:"save-area",label:o.areaDraft.canRebind?"Confirm on this map":"Save area",kind:"primary",enabled:t,...t?{}:{reason:"Add a name and at least one mark"}}}let e=o.areaDraft.status==="current";return{id:"run-area",label:"Clean area",kind:"primary",enabled:e&&se(o),...e?{}:{reason:"Review or redraw this area first"}}}return{id:"choose-cleaning",label:"Choose what to clean",kind:"neutral",enabled:!1,reason:"Choose rooms, a plan, or a custom area"}},Kt=o=>o.activity==="paused"?{id:"stop",label:"Stop",kind:"danger",enabled:o.command==="idle"}:null,pn=o=>o.draw.brushMeters*64*(o.draw.zoomPercent/100),mo=[2,1,.5,.25,.1,.05],Yt=o=>{let e=64*(o.draw.zoomPercent/100),t=mo.reduce((r,n)=>{let a=Math.abs(n*e-64),i=Math.abs(r*e-64);return a<i?n:r});return{meters:t,pixels:t*e,label:t<1?`${Math.round(t*100)} cm`:`${t} m`}},mn=(o,e)=>({...o,command:e});var Gt="a".repeat(64),de=[{roomId:"room-a",name:"Kitchen",boundary:[[.5,.5],[4,.5],[4,3],[.5,3]]},{roomId:"room-b",name:"Living room",boundary:[[4.2,.5],[8.5,.5],[8.5,3.4],[4.2,3.4]]},{roomId:"room-c",name:"Office",boundary:[[.5,3.2],[3.8,3.2],[3.8,6.5],[.5,6.5]]},{roomId:"room-d",name:"Bedroom",boundary:[[4,3.6],[8.5,3.6],[8.5,6.5],[4,6.5]]}],jt=()=>{let o=[180,140],e={meters_per_cell:.05,origin_cells:[0,0],span_cells:o,sample_step:1,rooms:de.map(c=>{let d=c.boundary.map(([h,p])=>[h/.05,p/.05]),u=[d.reduce((h,[p])=>h+p,0)/d.length,d.reduce((h,[,p])=>h+p,0)/d.length];return{name:c.name,boundary:d,boundary_closed:!0,center:u}})},t=new TextEncoder().encode(JSON.stringify(e)),r=[];for(let c=10;c<130;c+=2)for(let d=10;d<170;d+=2){let u=d<80?c<65?0:2:c<72?1:3,h=[[185,219,224],[201,211,233],[210,226,194],[232,207,207]][u]||[190,205,215];r.push([d,c,0,...h])}let n=500;for(let c=0;c<n;c+=1){let d=c%4,u=c*7%120,h=d<2?d===0?10:168:10+u,p=d>=2?d===2?10:128:10+u;r.push([h,p,10+c%18,104,122,137])}let a=r.length-n,i=new ArrayBuffer(24+t.byteLength+r.length*8),s=new DataView(i);new Uint8Array(i,0,8).set(new TextEncoder().encode("MATIC3D\0")),s.setUint16(8,1,!0),s.setUint16(10,8,!0),s.setUint32(12,t.byteLength,!0),s.setUint32(16,a,!0),s.setUint32(20,n,!0),new Uint8Array(i,24,t.byteLength).set(t);let l=new DataView(i,24+t.byteLength);return r.forEach(([c=0,d=0,u=0,h=0,p=0,g=0],_)=>{let w=_*8;l.setUint16(w,c,!0),l.setUint16(w+2,d,!0),l.setUint8(w+4,u),l.setUint8(w+5,h),l.setUint8(w+6,p),l.setUint8(w+7,g)}),{buffer:i,pointOffset:24+t.byteLength,floorCount:a,surfaceCount:n,total:r.length,revision:7,etag:'"synthetic-scene"',source:"live",metadata:{metersPerCell:.05,origin:[0,0],span:o,sampleStep:1,rooms:e.rooms.map((c,d)=>({id:de[d]?.roomId||`room-${d}`,name:c.name,boundary:c.boundary,center:c.center}))}}},Oe=()=>({entryId:"synthetic-entry",sceneUrl:"/api/matic_robot/slam_scene/synthetic",deltaUrl:"/api/matic_robot/slam_delta/synthetic",poseUrl:"/api/matic_robot/slam_pose/synthetic",historyUrl:"/api/matic_robot/slam_history/synthetic",areasUrl:"/api/matic_robot/areas/synthetic",plansUrl:"/api/matic_robot/plans/synthetic",mapRevision:7,mapFloorCoherent:!0,mapSessionVerified:!0,mapSessionKey:Gt,mapBlockReason:null,runnerLocked:!1,stopSettlePending:!1,activePlan:!1,nativeReconciliationPending:!1,nativeSessionActive:!1,mapComplete:!0,mapTruncated:!1,selectedFloorOrdinal:1,mapFloorOrdinal:1,historyCount:2,historyFloorCount:2,health:"ready",streamFailures:0,bootstrapState:"complete",bootstrapPhotoSeen:!0,bootstrapStructureSeen:!0,bootstrapFailures:0}),st=()=>({rooms:de.map(({roomId:o,name:e})=>({roomId:o,name:e})),selectedPlan:"daily",plans:[{id:"daily",name:"Daily clean",enabled:!0,runBehavior:"intelligent",rooms:de.slice(0,3).map(({roomId:o})=>({roomId:o,cleaningMode:"vacuum",coverageSetting:"standard"})),roomOrder:de.slice(0,3).map(({roomId:o})=>o),returnToBase:!0,finishCurrentRoom:!1,finishCurrentRoomThreshold:50}]}),lt=()=>({sceneUrl:Oe().sceneUrl,rooms:de.map(o=>({...o,boundary:o.boundary.map(e=>[...e])})),areas:[{id:"entryway",name:"Entryway",circles:[{x:1.5,y:1.4,radius:.3},{x:1.9,y:1.6,radius:.3}],cleaningMode:"vacuum",coverageSetting:"standard",status:"current",canRebind:!1}]}),Zt=()=>({entryId:"synthetic-entry",liveAvailable:!0,floors:[{id:"current",active:!0,readOnly:!1,liveAvailable:!0,label:"House",ordinal:null,snapshots:[{id:"current-old",createdAt:"2026-08-29T14:00:00Z",revision:6,pointCount:5300,sceneUrl:"/synthetic-history-current-old"},{id:"current-new",createdAt:"2026-08-29T16:12:00Z",revision:7,pointCount:5300,sceneUrl:"/synthetic-history-current-new"}]},{id:"saved-1",active:!1,readOnly:!0,liveAvailable:!1,label:"Shed",ordinal:2,snapshots:[{id:"saved-one",createdAt:"2026-08-28T11:30:00Z",revision:3,pointCount:3100,sceneUrl:"/synthetic-history-saved"}]},{id:"saved-2",active:!1,readOnly:!0,liveAvailable:!1,label:"Annex",ordinal:3,snapshots:[]}]}),Qt=()=>({position:[4.475,3.475],source:"latest_pose",revision:7,poseRevision:4,floorCoherent:!0,mapSessionKey:Gt,freshness:"live"});var fo=()=>({...M(),coherence:"current",activity:"docked",batteryPercent:92,robots:[{entryId:"synthetic-entry",label:"Matic robot"}],host:{connected:!0,administrator:!0,robotConnected:!0,robotCount:1},floor:{classifiedCount:2,displayName:"House",readOnly:!1},map:{available:!0,complete:!0,floorCoherent:!0,sessionVerified:!0,exactPose:!0},resources:{catalog:{status:"ready",value:[Oe()],problem:null},entry:Oe(),scene:{status:"ready",value:jt(),problem:null},pose:{status:"ready",value:Qt(),problem:null},history:{status:"ready",value:Zt(),problem:null},plans:{status:"ready",value:st(),problem:null},areas:{status:"ready",value:lt(),problem:null}},selection:{...M().selection,entryId:"synthetic-entry",planId:"daily"},planDraft:{...M().planDraft,id:"daily",name:"Daily clean",rooms:st().plans[0]?.rooms||[]}}),ct=o=>{let e=fo();switch(o){case"ready":return e;case"cleaning":return{...e,activity:"cleaning"};case"paused":return{...e,activity:"paused"};case"returning":return{...e,activity:"returning"};case"recharging":return{...e,activity:"recharging",batteryPercent:18};case"rooms":return{...e,workflow:"rooms"};case"draw":return{...e,workflow:"draw",areaDraft:{...e.areaDraft,id:"entryway",name:"Entryway",status:"current"},selection:{...e.selection,areaId:"entryway"},draw:{...e.draw,dirty:!0,strokeCount:3,circles:lt().areas[0]?.circles||[]}};case"history":return{...e,dataMode:"history",workflow:"history",floor:{...e.floor,readOnly:!0},map:{...e.map,exactPose:!1},selection:{...e.selection,floorId:"saved-1",historyId:"saved-one"}};case"transition":return{...e,coherence:"verifying",activity:"unknown",map:{available:!1,complete:!1,floorCoherent:!1,sessionVerified:!1,exactPose:!1}};case"problem":return{...e,activity:"problem",coherence:"blocked"};case"ha-offline":return{...e,coherence:"degraded",host:{...e.host,connected:!1},map:{...e.map,exactPose:!1}};case"robot-offline":return{...e,coherence:"degraded",host:{...e.host,robotConnected:!1},map:{...e.map,exactPose:!1}};case"access":return{...e,coherence:"blocked",host:{...e.host,administrator:!1},map:{...e.map,available:!1,exactPose:!1}};case"empty":return{...e,coherence:"unavailable",host:{...e.host,robotConnected:!1,robotCount:0},map:{...e.map,available:!1,exactPose:!1}};case"unsupported":return{...e,coherence:"blocked",map:{...e.map,available:!1,exactPose:!1}};case"multi-robot":return{...e,host:{...e.host,robotCount:2},robots:[{entryId:"synthetic-entry",label:"Matic robot"},{entryId:"synthetic-entry-two",label:"Second robot"}]}}},dt=["ready","cleaning","paused","returning","recharging","rooms","draw","history","transition","problem","ha-offline","robot-offline","access","empty","unsupported","multi-robot"];var yo=(o,e)=>{if(e?.recharge_and_resume===!0&&e?.charging===!0)return"recharging";switch(o){case"cleaning":return"cleaning";case"paused":return"paused";case"returning":return"returning";case"docked":return"docked";case"idle":return"idle";case"error":return"problem";default:return"unknown"}},bo=o=>typeof o!="number"||!Number.isFinite(o)?null:Math.round(Math.max(0,Math.min(100,o))),go=o=>{let e=o.attributes?.matic_entry_id;return typeof e=="string"&&e.length>0?e:null},vo=o=>String(o||"local-user").replaceAll(/[^a-zA-Z0-9_-]/g,"").slice(0,128)||"local-user",Jt=o=>{if(typeof o!="string")return"Matic robot";let e=o.trim();return e&&Array.from(e).length<=128&&!/[\u0000-\u001f\u007f]/u.test(e)?e:"Matic robot"},Ne=class{#e="";#t=null;project(e,t,r=null){let n=e?.states??{},a=t?.config?.entry_id,i=typeof a=="string"?a:null,s=null,l=null,c=null,d=new Map;for(let[k,I]of Object.entries(n)){let P=go(I);if(!P||!k.startsWith("vacuum."))continue;d.set(P,{entryId:P,label:Jt(I.attributes?.friendly_name)});let Re=r||i;(!s||Re&&P===Re)&&(s=I,l=k,c=P)}let u={connected:e?.connected!==!1,administrator:e?.user?.is_admin===!0,robotConnected:s!==null&&s.state!=="unavailable"&&s.state!=="unknown",robotCount:d.size},h=s?yo(s.state,s.attributes):"unknown",p=bo(s?.attributes?.battery_level),g=e?.selectedLanguage||e?.language||"en",_=vo(e?.user?.id),w=Jt(s?.attributes?.friendly_name),b=[...d.values()].sort((k,I)=>k.label.localeCompare(I.label,g,{sensitivity:"base"})),C=[u.connected,u.administrator,u.robotConnected,u.robotCount,h,p??"none",g,_,l??"none",c??"none",w,b.map(k=>`${k.entryId}:${k.label}`).join(",")].join("|");return C===this.#e&&this.#t?this.#t:(this.#e=C,this.#t={host:u,activity:h,batteryPercent:p,language:g,userKey:_,vacuumEntityId:l,entryKey:c,robotLabel:w,robots:b},this.#t)}};var We=globalThis,Ue=We.ShadowRoot&&(We.ShadyCSS===void 0||We.ShadyCSS.nativeShadow)&&"adoptedStyleSheets"in Document.prototype&&"replace"in CSSStyleSheet.prototype,ut=Symbol(),er=new WeakMap,ve=class{constructor(e,t,r){if(this._$cssResult$=!0,r!==ut)throw Error("CSSResult is not constructable. Use `unsafeCSS` or `css` instead.");this.cssText=e,this.t=t}get styleSheet(){let e=this.o,t=this.t;if(Ue&&e===void 0){let r=t!==void 0&&t.length===1;r&&(e=er.get(t)),e===void 0&&((this.o=e=new CSSStyleSheet).replaceSync(this.cssText),r&&er.set(t,e))}return e}toString(){return this.cssText}},tr=o=>new ve(typeof o=="string"?o:o+"",void 0,ut),L=(o,...e)=>{let t=o.length===1?o[0]:e.reduce((r,n,a)=>r+(i=>{if(i._$cssResult$===!0)return i.cssText;if(typeof i=="number")return i;throw Error("Value passed to 'css' function must be a 'css' function result: "+i+". Use 'unsafeCSS' to pass non-literal values, but take care to ensure page security.")})(n)+o[a+1],o[0]);return new ve(t,o,ut)},rr=(o,e)=>{if(Ue)o.adoptedStyleSheets=e.map(t=>t instanceof CSSStyleSheet?t:t.styleSheet);else for(let t of e){let r=document.createElement("style"),n=We.litNonce;n!==void 0&&r.setAttribute("nonce",n),r.textContent=t.cssText,o.appendChild(r)}},ht=Ue?o=>o:o=>o instanceof CSSStyleSheet?(e=>{let t="";for(let r of e.cssRules)t+=r.cssText;return tr(t)})(o):o;var{is:wo,defineProperty:_o,getOwnPropertyDescriptor:ko,getOwnPropertyNames:So,getOwnPropertySymbols:xo,getPrototypeOf:$o}=Object,He=globalThis,or=He.trustedTypes,Co=or?or.emptyScript:"",Mo=He.reactiveElementPolyfillSupport,we=(o,e)=>o,pt={toAttribute(o,e){switch(e){case Boolean:o=o?Co:null;break;case Object:case Array:o=o==null?o:JSON.stringify(o)}return o},fromAttribute(o,e){let t=o;switch(e){case Boolean:t=o!==null;break;case Number:t=o===null?null:Number(o);break;case Object:case Array:try{t=JSON.parse(o)}catch{t=null}}return t}},ar=(o,e)=>!wo(o,e),nr={attribute:!0,type:String,converter:pt,reflect:!1,useDefault:!1,hasChanged:ar};Symbol.metadata??=Symbol("metadata"),He.litPropertyMetadata??=new WeakMap;var X=class extends HTMLElement{static addInitializer(e){this._$Ei(),(this.l??=[]).push(e)}static get observedAttributes(){return this.finalize(),this._$Eh&&[...this._$Eh.keys()]}static createProperty(e,t=nr){if(t.state&&(t.attribute=!1),this._$Ei(),this.prototype.hasOwnProperty(e)&&((t=Object.create(t)).wrapped=!0),this.elementProperties.set(e,t),!t.noAccessor){let r=Symbol(),n=this.getPropertyDescriptor(e,r,t);n!==void 0&&_o(this.prototype,e,n)}}static getPropertyDescriptor(e,t,r){let{get:n,set:a}=ko(this.prototype,e)??{get(){return this[t]},set(i){this[t]=i}};return{get:n,set(i){let s=n?.call(this);a?.call(this,i),this.requestUpdate(e,s,r)},configurable:!0,enumerable:!0}}static getPropertyOptions(e){return this.elementProperties.get(e)??nr}static _$Ei(){if(this.hasOwnProperty(we("elementProperties")))return;let e=$o(this);e.finalize(),e.l!==void 0&&(this.l=[...e.l]),this.elementProperties=new Map(e.elementProperties)}static finalize(){if(this.hasOwnProperty(we("finalized")))return;if(this.finalized=!0,this._$Ei(),this.hasOwnProperty(we("properties"))){let t=this.properties,r=[...So(t),...xo(t)];for(let n of r)this.createProperty(n,t[n])}let e=this[Symbol.metadata];if(e!==null){let t=litPropertyMetadata.get(e);if(t!==void 0)for(let[r,n]of t)this.elementProperties.set(r,n)}this._$Eh=new Map;for(let[t,r]of this.elementProperties){let n=this._$Eu(t,r);n!==void 0&&this._$Eh.set(n,t)}this.elementStyles=this.finalizeStyles(this.styles)}static finalizeStyles(e){let t=[];if(Array.isArray(e)){let r=new Set(e.flat(1/0).reverse());for(let n of r)t.unshift(ht(n))}else e!==void 0&&t.push(ht(e));return t}static _$Eu(e,t){let r=t.attribute;return r===!1?void 0:typeof r=="string"?r:typeof e=="string"?e.toLowerCase():void 0}constructor(){super(),this._$Ep=void 0,this.isUpdatePending=!1,this.hasUpdated=!1,this._$Em=null,this._$Ev()}_$Ev(){this._$ES=new Promise(e=>this.enableUpdating=e),this._$AL=new Map,this._$E_(),this.requestUpdate(),this.constructor.l?.forEach(e=>e(this))}addController(e){(this._$EO??=new Set).add(e),this.renderRoot!==void 0&&this.isConnected&&e.hostConnected?.()}removeController(e){this._$EO?.delete(e)}_$E_(){let e=new Map,t=this.constructor.elementProperties;for(let r of t.keys())this.hasOwnProperty(r)&&(e.set(r,this[r]),delete this[r]);e.size>0&&(this._$Ep=e)}createRenderRoot(){let e=this.shadowRoot??this.attachShadow(this.constructor.shadowRootOptions);return rr(e,this.constructor.elementStyles),e}connectedCallback(){this.renderRoot??=this.createRenderRoot(),this.enableUpdating(!0),this._$EO?.forEach(e=>e.hostConnected?.())}enableUpdating(e){}disconnectedCallback(){this._$EO?.forEach(e=>e.hostDisconnected?.())}attributeChangedCallback(e,t,r){this._$AK(e,r)}_$ET(e,t){let r=this.constructor.elementProperties.get(e),n=this.constructor._$Eu(e,r);if(n!==void 0&&r.reflect===!0){let a=(r.converter?.toAttribute!==void 0?r.converter:pt).toAttribute(t,r.type);this._$Em=e,a==null?this.removeAttribute(n):this.setAttribute(n,a),this._$Em=null}}_$AK(e,t){let r=this.constructor,n=r._$Eh.get(e);if(n!==void 0&&this._$Em!==n){let a=r.getPropertyOptions(n),i=typeof a.converter=="function"?{fromAttribute:a.converter}:a.converter?.fromAttribute!==void 0?a.converter:pt;this._$Em=n;let s=i.fromAttribute(t,a.type);this[n]=s??this._$Ej?.get(n)??s,this._$Em=null}}requestUpdate(e,t,r,n=!1,a){if(e!==void 0){let i=this.constructor;if(n===!1&&(a=this[e]),r??=i.getPropertyOptions(e),!((r.hasChanged??ar)(a,t)||r.useDefault&&r.reflect&&a===this._$Ej?.get(e)&&!this.hasAttribute(i._$Eu(e,r))))return;this.C(e,t,r)}this.isUpdatePending===!1&&(this._$ES=this._$EP())}C(e,t,{useDefault:r,reflect:n,wrapped:a},i){r&&!(this._$Ej??=new Map).has(e)&&(this._$Ej.set(e,i??t??this[e]),a!==!0||i!==void 0)||(this._$AL.has(e)||(this.hasUpdated||r||(t=void 0),this._$AL.set(e,t)),n===!0&&this._$Em!==e&&(this._$Eq??=new Set).add(e))}async _$EP(){this.isUpdatePending=!0;try{await this._$ES}catch(t){Promise.reject(t)}let e=this.scheduleUpdate();return e!=null&&await e,!this.isUpdatePending}scheduleUpdate(){return this.performUpdate()}performUpdate(){if(!this.isUpdatePending)return;if(!this.hasUpdated){if(this.renderRoot??=this.createRenderRoot(),this._$Ep){for(let[n,a]of this._$Ep)this[n]=a;this._$Ep=void 0}let r=this.constructor.elementProperties;if(r.size>0)for(let[n,a]of r){let{wrapped:i}=a,s=this[n];i!==!0||this._$AL.has(n)||s===void 0||this.C(n,void 0,a,s)}}let e=!1,t=this._$AL;try{e=this.shouldUpdate(t),e?(this.willUpdate(t),this._$EO?.forEach(r=>r.hostUpdate?.()),this.update(t)):this._$EM()}catch(r){throw e=!1,this._$EM(),r}e&&this._$AE(t)}willUpdate(e){}_$AE(e){this._$EO?.forEach(t=>t.hostUpdated?.()),this.hasUpdated||(this.hasUpdated=!0,this.firstUpdated(e)),this.updated(e)}_$EM(){this._$AL=new Map,this.isUpdatePending=!1}get updateComplete(){return this.getUpdateComplete()}getUpdateComplete(){return this._$ES}shouldUpdate(e){return!0}update(e){this._$Eq&&=this._$Eq.forEach(t=>this._$ET(t,this[t])),this._$EM()}updated(e){}firstUpdated(e){}};X.elementStyles=[],X.shadowRootOptions={mode:"open"},X[we("elementProperties")]=new Map,X[we("finalized")]=new Map,Mo?.({ReactiveElement:X}),(He.reactiveElementVersions??=[]).push("2.1.2");var wt=globalThis,ir=o=>o,Fe=wt.trustedTypes,sr=Fe?Fe.createPolicy("lit-html",{createHTML:o=>o}):void 0,pr="$lit$",Y=`lit$${Math.random().toFixed(9).slice(2)}$`,mr="?"+Y,Ao=`<${mr}>`,J=document,ke=()=>J.createComment(""),Se=o=>o===null||typeof o!="object"&&typeof o!="function",_t=Array.isArray,Po=o=>_t(o)||typeof o?.[Symbol.iterator]=="function",mt=`[ \t\n\f\r]`,_e=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,lr=/-->/g,cr=/>/g,Z=RegExp(`>|${mt}(?:([^\\s"'>=/]+)(${mt}*=${mt}*(?:[^ \t\n\f\r"'\`<>=]|("|')|))|$)`,"g"),dr=/'/g,ur=/"/g,fr=/^(?:script|style|textarea|title)$/i,kt=o=>(e,...t)=>({_$litType$:o,strings:e,values:t}),A=kt(1),yr=kt(2),br=kt(3),ee=Symbol.for("lit-noChange"),m=Symbol.for("lit-nothing"),hr=new WeakMap,Q=J.createTreeWalker(J,129);function gr(o,e){if(!_t(o)||!o.hasOwnProperty("raw"))throw Error("invalid template strings array");return sr!==void 0?sr.createHTML(e):e}var Eo=(o,e)=>{let t=o.length-1,r=[],n,a=e===2?"<svg>":e===3?"<math>":"",i=_e;for(let s=0;s<t;s++){let l=o[s],c,d,u=-1,h=0;for(;h<l.length&&(i.lastIndex=h,d=i.exec(l),d!==null);)h=i.lastIndex,i===_e?d[1]==="!--"?i=lr:d[1]!==void 0?i=cr:d[2]!==void 0?(fr.test(d[2])&&(n=RegExp("</"+d[2],"g")),i=Z):d[3]!==void 0&&(i=Z):i===Z?d[0]===">"?(i=n??_e,u=-1):d[1]===void 0?u=-2:(u=i.lastIndex-d[2].length,c=d[1],i=d[3]===void 0?Z:d[3]==='"'?ur:dr):i===ur||i===dr?i=Z:i===lr||i===cr?i=_e:(i=Z,n=void 0);let p=i===Z&&o[s+1].startsWith("/>")?" ":"";a+=i===_e?l+Ao:u>=0?(r.push(c),l.slice(0,u)+pr+l.slice(u)+Y+p):l+Y+(u===-2?s:p)}return[gr(o,a+(o[t]||"<?>")+(e===2?"</svg>":e===3?"</math>":"")),r]},xe=class o{constructor({strings:e,_$litType$:t},r){let n;this.parts=[];let a=0,i=0,s=e.length-1,l=this.parts,[c,d]=Eo(e,t);if(this.el=o.createElement(c,r),Q.currentNode=this.el.content,t===2||t===3){let u=this.el.content.firstChild;u.replaceWith(...u.childNodes)}for(;(n=Q.nextNode())!==null&&l.length<s;){if(n.nodeType===1){if(n.hasAttributes())for(let u of n.getAttributeNames())if(u.endsWith(pr)){let h=d[i++],p=n.getAttribute(u).split(Y),g=/([.?@])?(.*)/.exec(h);l.push({type:1,index:a,name:g[2],strings:p,ctor:g[1]==="."?yt:g[1]==="?"?bt:g[1]==="@"?gt:he}),n.removeAttribute(u)}else u.startsWith(Y)&&(l.push({type:6,index:a}),n.removeAttribute(u));if(fr.test(n.tagName)){let u=n.textContent.split(Y),h=u.length-1;if(h>0){n.textContent=Fe?Fe.emptyScript:"";for(let p=0;p<h;p++)n.append(u[p],ke()),Q.nextNode(),l.push({type:2,index:++a});n.append(u[h],ke())}}}else if(n.nodeType===8)if(n.data===mr)l.push({type:2,index:a});else{let u=-1;for(;(u=n.data.indexOf(Y,u+1))!==-1;)l.push({type:7,index:a}),u+=Y.length-1}a++}}static createElement(e,t){let r=J.createElement("template");return r.innerHTML=e,r}};function ue(o,e,t=o,r){if(e===ee)return e;let n=r!==void 0?t._$Co?.[r]:t._$Cl,a=Se(e)?void 0:e._$litDirective$;return n?.constructor!==a&&(n?._$AO?.(!1),a===void 0?n=void 0:(n=new a(o),n._$AT(o,t,r)),r!==void 0?(t._$Co??=[])[r]=n:t._$Cl=n),n!==void 0&&(e=ue(o,n._$AS(o,e.values),n,r)),e}var ft=class{constructor(e,t){this._$AV=[],this._$AN=void 0,this._$AD=e,this._$AM=t}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}u(e){let{el:{content:t},parts:r}=this._$AD,n=(e?.creationScope??J).importNode(t,!0);Q.currentNode=n;let a=Q.nextNode(),i=0,s=0,l=r[0];for(;l!==void 0;){if(i===l.index){let c;l.type===2?c=new $e(a,a.nextSibling,this,e):l.type===1?c=new l.ctor(a,l.name,l.strings,this,e):l.type===6&&(c=new vt(a,this,e)),this._$AV.push(c),l=r[++s]}i!==l?.index&&(a=Q.nextNode(),i++)}return Q.currentNode=J,n}p(e){let t=0;for(let r of this._$AV)r!==void 0&&(r.strings!==void 0?(r._$AI(e,r,t),t+=r.strings.length-2):r._$AI(e[t])),t++}},$e=class o{get _$AU(){return this._$AM?._$AU??this._$Cv}constructor(e,t,r,n){this.type=2,this._$AH=m,this._$AN=void 0,this._$AA=e,this._$AB=t,this._$AM=r,this.options=n,this._$Cv=n?.isConnected??!0}get parentNode(){let e=this._$AA.parentNode,t=this._$AM;return t!==void 0&&e?.nodeType===11&&(e=t.parentNode),e}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(e,t=this){e=ue(this,e,t),Se(e)?e===m||e==null||e===""?(this._$AH!==m&&this._$AR(),this._$AH=m):e!==this._$AH&&e!==ee&&this._(e):e._$litType$!==void 0?this.$(e):e.nodeType!==void 0?this.T(e):Po(e)?this.k(e):this._(e)}O(e){return this._$AA.parentNode.insertBefore(e,this._$AB)}T(e){this._$AH!==e&&(this._$AR(),this._$AH=this.O(e))}_(e){this._$AH!==m&&Se(this._$AH)?this._$AA.nextSibling.data=e:this.T(J.createTextNode(e)),this._$AH=e}$(e){let{values:t,_$litType$:r}=e,n=typeof r=="number"?this._$AC(e):(r.el===void 0&&(r.el=xe.createElement(gr(r.h,r.h[0]),this.options)),r);if(this._$AH?._$AD===n)this._$AH.p(t);else{let a=new ft(n,this),i=a.u(this.options);a.p(t),this.T(i),this._$AH=a}}_$AC(e){let t=hr.get(e.strings);return t===void 0&&hr.set(e.strings,t=new xe(e)),t}k(e){_t(this._$AH)||(this._$AH=[],this._$AR());let t=this._$AH,r,n=0;for(let a of e)n===t.length?t.push(r=new o(this.O(ke()),this.O(ke()),this,this.options)):r=t[n],r._$AI(a),n++;n<t.length&&(this._$AR(r&&r._$AB.nextSibling,n),t.length=n)}_$AR(e=this._$AA.nextSibling,t){for(this._$AP?.(!1,!0,t);e!==this._$AB;){let r=ir(e).nextSibling;ir(e).remove(),e=r}}setConnected(e){this._$AM===void 0&&(this._$Cv=e,this._$AP?.(e))}},he=class{get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}constructor(e,t,r,n,a){this.type=1,this._$AH=m,this._$AN=void 0,this.element=e,this.name=t,this._$AM=n,this.options=a,r.length>2||r[0]!==""||r[1]!==""?(this._$AH=Array(r.length-1).fill(new String),this.strings=r):this._$AH=m}_$AI(e,t=this,r,n){let a=this.strings,i=!1;if(a===void 0)e=ue(this,e,t,0),i=!Se(e)||e!==this._$AH&&e!==ee,i&&(this._$AH=e);else{let s=e,l,c;for(e=a[0],l=0;l<a.length-1;l++)c=ue(this,s[r+l],t,l),c===ee&&(c=this._$AH[l]),i||=!Se(c)||c!==this._$AH[l],c===m?e=m:e!==m&&(e+=(c??"")+a[l+1]),this._$AH[l]=c}i&&!n&&this.j(e)}j(e){e===m?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,e??"")}},yt=class extends he{constructor(){super(...arguments),this.type=3}j(e){this.element[this.name]=e===m?void 0:e}},bt=class extends he{constructor(){super(...arguments),this.type=4}j(e){this.element.toggleAttribute(this.name,!!e&&e!==m)}},gt=class extends he{constructor(e,t,r,n,a){super(e,t,r,n,a),this.type=5}_$AI(e,t=this){if((e=ue(this,e,t,0)??m)===ee)return;let r=this._$AH,n=e===m&&r!==m||e.capture!==r.capture||e.once!==r.once||e.passive!==r.passive,a=e!==m&&(r===m||n);n&&this.element.removeEventListener(this.name,this,r),a&&this.element.addEventListener(this.name,this,e),this._$AH=e}handleEvent(e){typeof this._$AH=="function"?this._$AH.call(this.options?.host??this.element,e):this._$AH.handleEvent(e)}},vt=class{constructor(e,t,r){this.element=e,this.type=6,this._$AN=void 0,this._$AM=t,this.options=r}get _$AU(){return this._$AM._$AU}_$AI(e){ue(this,e)}};var Ro=wt.litHtmlPolyfillSupport;Ro?.(xe,$e),(wt.litHtmlVersions??=[]).push("3.3.3");var vr=(o,e,t)=>{let r=t?.renderBefore??e,n=r._$litPart$;if(n===void 0){let a=t?.renderBefore??null;r._$litPart$=n=new $e(e.insertBefore(ke(),a),a,void 0,t??{})}return n._$AI(o),n};var St=globalThis,x=class extends X{constructor(){super(...arguments),this.renderOptions={host:this},this._$Do=void 0}createRenderRoot(){let e=super.createRenderRoot();return this.renderOptions.renderBefore??=e.firstChild,e}update(e){let t=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(e),this._$Do=vr(t,this.renderRoot,this.renderOptions)}connectedCallback(){super.connectedCallback(),this._$Do?.setConnected(!0)}disconnectedCallback(){super.disconnectedCallback(),this._$Do?.setConnected(!1)}render(){return ee}};x._$litElement$=!0,x.finalized=!0,St.litElementHydrateSupport?.({LitElement:x});var Io=St.litElementPolyfillSupport;Io?.({LitElement:x});(St.litElementVersions??=[]).push("4.2.2");var _r=Symbol.for(""),Lo=o=>{if(o?.r===_r)return o?._$litStatic$},U=o=>({_$litStatic$:o,r:_r});var wr=new Map,xt=o=>(e,...t)=>{let r=t.length,n,a,i=[],s=[],l,c=0,d=!1;for(;c<r;){for(l=e[c];c<r&&(a=t[c],(n=Lo(a))!==void 0);)l+=n+e[++c],d=!0;c!==r&&s.push(a),i.push(l),c++}if(c===r&&i.push(e[r]),d){let u=i.join("$$lit$$");(e=wr.get(u))===void 0&&(i.raw=i,wr.set(u,e=i)),t=s}return o(e,...t)},f=xt(A),Nn=xt(yr),Wn=xt(br);var kr=import.meta.url.match(/\/matic_robot\/[^/]+-([a-f0-9]{12})\/map-studio-v4(?:\/|$)/u)?.[1]??"dev",Ce=kr==="dev"?"":`-${kr}`,Me=`matic-map-canvas-v4${Ce}`,te=`matic-precision-controls-v4${Ce}`,pe=`matic-map-workflow-v4${Ce}`,re=`matic-map-shell-v4${Ce}`,$t=`matic-map-panel-v0-4-0${Ce}`;var Sr=(o,e)=>Math.hypot(o.x-e.x,o.y-e.y),xr=(o,e)=>({x:(o.x+e.x)/2,y:(o.y+e.y)/2}),$r=(o,e)=>Math.atan2(e.y-o.y,e.x-o.x),To=o=>{let e=o;for(;e>Math.PI;)e-=Math.PI*2;for(;e<-Math.PI;)e+=Math.PI*2;return e},oe=(o,e,t)=>Math.max(e,Math.min(t,o)),Ct=o=>o.map(e=>({...e})),me=o=>o instanceof Element&&!!o.closest("button, input, select, textarea, a, [role='button'], [role='menuitem']"),Be=class{#e;#t;#a;#r=new Map;#n=!1;#o="idle";#c=[];#d=[];#u=null;#s=0;#f=null;#g=0;#_=null;#h=null;#k=null;#y=0;#l=null;#w=!1;#$=null;#x=!1;constructor(e,t,r){this.#e=e,this.#t=t,this.#a=r,e.addEventListener("pointerdown",this.#i),e.addEventListener("pointermove",this.#p),e.addEventListener("pointerup",this.#b),e.addEventListener("pointercancel",this.#b),e.addEventListener("wheel",this.#E,{passive:!1}),e.addEventListener("gesturestart",this.#C,{passive:!1}),e.addEventListener("gesturechange",this.#M,{passive:!1}),e.addEventListener("gestureend",this.#A,{passive:!1}),e.addEventListener("dblclick",this.#L),e.addEventListener("contextmenu",this.#P),e.addEventListener("keydown",this.#S),e.addEventListener("keyup",this.#I),e.addEventListener("blur",this.#R)}#i=e=>{if(this.#x||!e.isPrimary&&e.pointerType==="mouse"||me(e.target))return;this.#e.focus({preventScroll:!0}),this.#T();let t=performance.now(),r={id:e.pointerId,type:e.pointerType,startX:e.clientX,startY:e.clientY,x:e.clientX,y:e.clientY,lastX:e.clientX,lastY:e.clientY,lastTime:t,velocityX:0,velocityY:0};if(this.#r.set(e.pointerId,r),this.#e.setPointerCapture?.(e.pointerId),this.#r.size>=2){this.#D(),(this.#o==="paint"||this.#o==="erase")&&(this.#d=Ct(this.#c),this.#a.onCircles(this.#d,!1)),this.#o="pinch",this.#e.classList.add("navigating"),this.#w=!0;let[s,l]=[...this.#r.values()];s&&l&&(this.#s=Math.max(1,Sr(s,l)),this.#f=xr(s,l),this.#g=$r(s,l),this.#_=this.#t.camera),e.preventDefault();return}let n=this.#a.state(),a=n.workflow==="draw"&&n.map.available&&!n.floor.readOnly;this.#w||this.#n||e.button===1||e.button===2||n.draw.tool==="pan"?(this.#o="pan",this.#h=this.#t.camera):a&&(n.draw.tool==="paint"||n.draw.tool==="erase")?(this.#c=Ct(n.draw.circles),this.#d=Ct(n.draw.circles),e.pointerType==="touch"?(this.#o="idle",this.#$=window.setTimeout(()=>{if(this.#$=null,this.#r.size!==1||this.#w)return;this.#o=n.draw.tool;let s=this.#r.get(e.pointerId);s&&this.#m(s.x,s.y)},110)):(this.#o=n.draw.tool,this.#m(e.clientX,e.clientY))):(this.#o=n.view==="three"&&!e.shiftKey?"orbit":"pan",this.#h=this.#t.camera),(this.#o==="pan"||this.#o==="orbit")&&this.#e.classList.add("navigating"),e.preventDefault()};#p=e=>{let t=this.#r.get(e.pointerId);if(!t){let d=this.#t.screenToMap(e.clientX,e.clientY);this.#t.setCursor(d);return}let n=(e.getCoalescedEvents?.()||[]).at(-1)||e,a=performance.now(),i=Math.max(1,a-t.lastTime),s=(n.clientX-t.lastX)/i,l=(n.clientY-t.lastY)/i;if(t.velocityX=t.velocityX*.62+s*.38,t.velocityY=t.velocityY*.62+l*.38,t.lastX=n.clientX,t.lastY=n.clientY,t.lastTime=a,t.x=n.clientX,t.y=n.clientY,this.#o==="pinch"&&this.#r.size>=2){let[d,u]=[...this.#r.values()];if(!d||!u)return;let h=Math.max(1,Sr(d,u)),p=xr(d,u),g=$r(d,u),_=this.#_;if(_&&this.#f){let w={..._,distance:_.distance*this.#s/h,yaw:_.yaw+To(g-this.#g),pitch:_.orthographic?_.pitch:_.pitch-(p.y-this.#f.y)*.0035};this.#t.setCamera(this.#t.cameraAfterPan(w,p.x-this.#f.x,p.y-this.#f.y))}e.preventDefault();return}this.#o==="paint"||this.#o==="erase"?this.#m(e.clientX,e.clientY):this.#o==="pan"?this.#h&&this.#t.setCamera(this.#t.cameraAfterPan(this.#h,n.clientX-t.startX,n.clientY-t.startY)):this.#o==="orbit"&&this.#h&&this.#t.setCamera({...this.#h,yaw:this.#h.yaw+(n.clientX-t.startX)*.0045,pitch:this.#h.pitch-(n.clientY-t.startY)*.004});let c=this.#t.screenToMap(n.clientX,n.clientY);this.#t.setCursor(c),e.preventDefault()};#b=e=>{let t=this.#r.get(e.pointerId);if(!t)return;let r=this.#o;if(this.#r.delete(e.pointerId),this.#e.releasePointerCapture?.(e.pointerId),this.#D(),(this.#o==="paint"||this.#o==="erase")&&JSON.stringify(this.#d)!==JSON.stringify(this.#c))this.#a.onCircles(this.#d,!0,this.#c);else if(this.#o!=="pinch"&&!this.#w&&Math.hypot(t.x-t.startX,t.y-t.startY)<7&&this.#a.state().workflow==="rooms"){let n=this.#t.roomAt(t.x,t.y);n&&this.#a.onRoom(n)}if(this.#r.size===0)this.#o="idle",this.#e.classList.remove("navigating"),this.#w=!1,this.#f=null,this.#_=null,this.#h=null,this.#u=null,(r==="pan"||r==="orbit")&&t.type!=="mouse"&&this.#z(t.velocityX,t.velocityY,r);else if(this.#o==="pinch"){this.#o="pan",this.#w=!0;let n=this.#r.values().next().value;n&&(n.startX=n.x,n.startY=n.y,n.velocityX=0,n.velocityY=0),this.#h=this.#t.camera,this.#_=null}e.preventDefault()};#m(e,t){let r=this.#t.screenToMap(e,t);if(!r)return;let a=this.#a.state().draw.brushMeters/2;if(this.#o==="erase")this.#d=this.#d.filter(i=>Math.hypot(i.x-r.x,i.y-r.y)>i.radius+a);else{if(!this.#t.containsMapPoint(r))return;let i=Math.max(.04,a*.55),s=this.#u||r,l=Math.hypot(r.x-s.x,r.y-s.y),c=Math.max(1,Math.ceil(l/i));for(let d=0;d<=c&&this.#d.length<512;d+=1){let u=d/c,h={x:s.x+(r.x-s.x)*u,y:s.y+(r.y-s.y)*u};this.#d.some(p=>Math.hypot(p.x-h.x,p.y-h.y)<Math.max(.025,a*.28))||this.#d.push({x:Math.round(h.x*1e4)/1e4,y:Math.round(h.y*1e4)/1e4,radius:Math.round(a*100)/100})}}this.#u=r,this.#a.onCircles(this.#d,!1)}#E=e=>{if(me(e.target))return;e.preventDefault(),this.#e.focus({preventScroll:!0}),this.#T();let t=e.deltaMode===WheelEvent.DOM_DELTA_LINE?16:e.deltaMode===WheelEvent.DOM_DELTA_PAGE?Math.max(1,this.#e.clientHeight):1,r=e.deltaX*t,n=e.deltaY*t;if(e.ctrlKey||e.metaKey){this.#t.zoomAt(Math.exp(oe(-n*.008,-.28,.28)),e.clientX,e.clientY);return}if(e.altKey&&this.#a.state().view==="three"){this.#t.orbitBy(0,oe(n,-80,80)*.75);return}if(e.deltaMode!==WheelEvent.DOM_DELTA_PIXEL||Math.abs(r)<.5&&Math.abs(n)>=50){this.#t.zoomAt(Math.exp(oe(-n*.0025,-.28,.28)),e.clientX,e.clientY);return}this.#t.panBy(-oe(r,-80,80),-oe(n,-80,80))};#C=e=>{this.#x||me(e.target)||(this.#e.focus({preventScroll:!0}),this.#T(),this.#e.classList.add("navigating"),this.#k=this.#t.camera,this.#y=Number.isFinite(e.rotation)?e.rotation:0,e.preventDefault())};#M=e=>{if(this.#x||me(e.target))return;let t=this.#k;if(!t||this.#r.size>=2)return;let r=Number.isFinite(e.scale)&&e.scale>0?Math.max(.1,e.scale):1,n=Number.isFinite(e.rotation)?e.rotation:0;this.#t.setCamera({...t,distance:t.distance/r,yaw:t.yaw+(n-this.#y)*Math.PI/180}),e.preventDefault()};#A=e=>{this.#k=null,this.#y=0,this.#e.classList.remove("navigating"),e.preventDefault()};#S=e=>{if(e.defaultPrevented||e.ctrlKey||e.metaKey||e.altKey)return;if(e.code==="Space"){this.#n=!0,e.preventDefault();return}this.#T();let t=this.#a.state(),r=e.key.toLocaleLowerCase();if(e.key==="+"||e.key==="=")this.#t.zoomAt(1.25);else if(e.key==="-")this.#t.zoomAt(.8);else if(e.key==="0")this.#t.fit();else if(r==="3")this.#v({type:"set-view",view:"three"});else if(r==="t")this.#v({type:"set-view",view:"top"});else if(e.key==="[")this.#t.orbitBy(-40,0);else if(e.key==="]")this.#t.orbitBy(40,0);else if(e.key==="PageUp")this.#t.orbitBy(0,-30);else if(e.key==="PageDown")this.#t.orbitBy(0,30);else if(r==="d"&&t.workflow==="draw")this.#v({type:"set-draw-tool",tool:"paint"});else if(r==="e"&&t.workflow==="draw")this.#v({type:"set-draw-tool",tool:"erase"});else if(["arrowleft","arrowright","arrowup","arrowdown"].includes(r))if(t.view==="three"&&!e.shiftKey){let n=r==="arrowleft"?-24:r==="arrowright"?24:0,a=r==="arrowup"?-20:r==="arrowdown"?20:0;this.#t.orbitBy(n,a)}else{let n=r==="arrowleft"?30:r==="arrowright"?-30:0,a=r==="arrowup"?30:r==="arrowdown"?-30:0;this.#t.panBy(n,a)}else if(t.workflow!=="draw"&&["w","a","s","d"].includes(r))this.#t.panBy(r==="a"?34:r==="d"?-34:0,r==="w"?34:r==="s"?-34:0);else if(t.workflow!=="draw"&&(r==="q"||r==="e"))this.#t.orbitBy(r==="q"?-30:30,0);else return;e.preventDefault()};#I=e=>{e.code==="Space"&&(this.#n=!1)};#R=()=>{this.#n=!1,this.#D(),this.#t.setCursor(null),this.#e.classList.remove("navigating")};#L=e=>{me(e.target)||(this.#T(),this.#t.zoomAt(e.shiftKey?1/1.6:1.6,e.clientX,e.clientY),e.preventDefault())};#P=e=>{me(e.target)||e.preventDefault()};#v(e){this.#e.dispatchEvent(new CustomEvent("matic-workspace-intent",{detail:e,bubbles:!0,composed:!0}))}#z(e,t,r){if(window.matchMedia("(prefers-reduced-motion: reduce)").matches)return;let n=oe(e,-.55,.55),a=oe(t,-.55,.55);if(Math.hypot(n,a)<.02)return;let i=performance.now(),s=l=>{let c=Math.min(32,l-i);i=l,r==="orbit"?this.#t.orbitBy(n*c,a*c):this.#t.panBy(n*c,a*c);let d=.9**(c/16);n*=d,a*=d,Math.hypot(n,a)>=.01?this.#l=window.requestAnimationFrame(s):this.#l=null};this.#l=window.requestAnimationFrame(s)}#T(){this.#l!==null&&window.cancelAnimationFrame(this.#l),this.#l=null}#D(){this.#$!==null&&window.clearTimeout(this.#$),this.#$=null}dispose(){this.#x||(this.#x=!0,this.#D(),this.#T(),this.#e.removeEventListener("pointerdown",this.#i),this.#e.removeEventListener("pointermove",this.#p),this.#e.removeEventListener("pointerup",this.#b),this.#e.removeEventListener("pointercancel",this.#b),this.#e.removeEventListener("wheel",this.#E),this.#e.removeEventListener("gesturestart",this.#C),this.#e.removeEventListener("gesturechange",this.#M),this.#e.removeEventListener("gestureend",this.#A),this.#e.removeEventListener("dblclick",this.#L),this.#e.removeEventListener("contextmenu",this.#P),this.#e.removeEventListener("keydown",this.#S),this.#e.removeEventListener("keyup",this.#I),this.#e.removeEventListener("blur",this.#R),this.#r.clear())}};var E=(o,e,t)=>Math.max(e,Math.min(t,o)),Ae=o=>{let e=o;for(;e>Math.PI;)e-=Math.PI*2;for(;e<-Math.PI;)e+=Math.PI*2;return e},zo=o=>{switch(o){case"efficient":return .35;case"balanced":return .65;case"maximum":case"auto":return 1}},Mr=Math.PI/3.15,Do=1.08,Oo=(o,e)=>{let t=Mr/2,r=Math.atan(Math.tan(t)*Math.max(.2,e));return o/Math.sin(Math.min(t,r))*Do},No=(o,e)=>{let t=new Float32Array(16);for(let r=0;r<4;r+=1)for(let n=0;n<4;n+=1){let a=0;for(let i=0;i<4;i+=1)a+=(o[i*4+n]??0)*(e[r*4+i]??0);t[r*4+n]=a}return t},Wo=(o,e,t,r)=>{let n=1/Math.tan(o/2),a=new Float32Array(16);return a[0]=n/e,a[5]=n,a[10]=(r+t)/(t-r),a[11]=-1,a[14]=2*r*t/(t-r),a},Uo=(o,e,t,r,n,a)=>{let i=new Float32Array(16);return i[0]=2/(e-o),i[5]=2/(r-t),i[10]=-2/(a-n),i[12]=-(e+o)/(e-o),i[13]=-(r+t)/(r-t),i[14]=-(a+n)/(a-n),i[15]=1,i},Ho=(o,e)=>{let t=Math.hypot((o[0]??0)-(e[0]??0),(o[1]??0)-(e[1]??0),(o[2]??0)-(e[2]??0))||1,r=[((o[0]??0)-(e[0]??0))/t,((o[1]??0)-(e[1]??0))/t,((o[2]??0)-(e[2]??0))/t],n=Math.hypot(r[2]??0,r[0]??0)||1,a=[(r[2]??0)/n,0,-(r[0]??0)/n],i=[(r[1]??0)*(a[2]??0),(r[2]??0)*(a[0]??0)-(r[0]??0)*(a[2]??0),-(r[1]??0)*(a[0]??0)];return new Float32Array([a[0]??0,i[0]??0,r[0]??0,0,a[1]??0,i[1]??0,r[1]??0,0,a[2]??0,i[2]??0,r[2]??0,0,-((a[0]??0)*(o[0]??0)+(a[1]??0)*(o[1]??0)+(a[2]??0)*(o[2]??0)),-((i[0]??0)*(o[0]??0)+(i[1]??0)*(o[1]??0)+(i[2]??0)*(o[2]??0)),-((r[0]??0)*(o[0]??0)+(r[1]??0)*(o[1]??0)+(r[2]??0)*(o[2]??0)),1])},Cr=(o,e,t)=>{let r=!1,n=t.at(-1);if(!n)return!1;for(let a of t){let[i,s]=a,[l,c]=n;s>e!=c>e&&o<(l-i)*(e-s)/(c-s)+i&&(r=!r),n=a}return r},qe=class{#e;#t;#a;#r=null;#n=null;#o=null;#c=null;#d=null;#u=null;#s=null;#f=null;#g=null;#_=null;#h=null;#k=null;#y=null;#l=null;#w=null;#$=null;#x;#i={yaw:-Math.PI/4,pitch:.82,distance:12,targetX:0,targetZ:0,orthographic:!1};#p=12;#b=8;#m=4;#E=new Float32Array(16);#C=null;#M="unavailable";#A=0;#S=0;#I=0;#R=0;#L=1;#P={width:1,height:1,left:0,top:0};#v=!0;#z=!1;constructor(e,t,r={}){this.#e=e,this.#t=t,this.#a=r,this.#n=t.getContext("2d",{alpha:!0}),this.#e.addEventListener("webglcontextlost",this.#G),this.#e.addEventListener("webglcontextrestored",this.#j),this.#B(),this.#x=new ResizeObserver(()=>{let n=this.#p,a=this.#b;this.#q(),this.#v&&(n!==this.#p||a!==this.#b)?this.fit(!1):this.requestRender()}),this.#x.observe(e)}get camera(){return{...this.#i}}#T(){return{minimum:Math.max(.2,this.#m*.04),maximum:this.#m*8}}#D(){let e=this.#l?.metadata.span,t=this.#l?.metadata.metersPerCell;return!e||t===void 0?{x:this.#m,z:this.#m}:{x:Math.max(.5,e[0]*t*.55),z:Math.max(.5,e[1]*t*.55)}}setCamera(e,t=!0){let r=this.#T(),n=this.#D();this.#i={yaw:Ae(e.yaw),pitch:e.orthographic?Math.PI/2-.018:E(e.pitch,.18,1.38),distance:E(e.distance,r.minimum,r.maximum),targetX:E(e.targetX,-n.x,n.x),targetZ:E(e.targetZ,-n.z,n.z),orthographic:e.orthographic},this.#v=!1,this.requestRender(),t&&this.#W()}cameraAfterPan(e,t,r){let n=this.#O(),a=e.distance*1.75/Math.max(200,n.height),i=Math.cos(e.yaw),s=-Math.sin(e.yaw),l=-Math.sin(e.yaw),c=-Math.cos(e.yaw),d=this.#D();return{...e,targetX:E(e.targetX-t*a*i+r*a*l,-d.x,d.x),targetZ:E(e.targetZ-t*a*s+r*a*c,-d.z,d.z)}}setState(e){if(this.#z)return;let t=this.#y;this.#y=e;let r=e.resources.scene.value;r!==this.#l&&(this.#l=r,this.#J(r)),(!t||t.quality!==e.quality)&&(this.#L=zo(e.quality),this.#R=0);let n=t?.workflow!=="draw"&&e.workflow==="draw",a=t?.workflow==="draw"&&e.workflow!=="draw";if(!t||t.view!==e.view||n||a){let i=e.workflow==="draw"?"top":e.view;this.#i=this.#Z(i,e),this.#v=this.#Q(i,e)}e.workflow==="draw"&&t?.draw.zoomPercent!==e.draw.zoomPercent&&(this.#i={...this.#i,orthographic:!0,pitch:Math.PI/2-.018,distance:this.#b*100/e.draw.zoomPercent},this.#v=e.draw.zoomPercent===100&&Math.abs(this.#i.targetX)<.001&&Math.abs(this.#i.targetZ)<.001&&Math.abs(Ae(this.#i.yaw))<.001),this.requestRender()}#Z(e,t){let r=e==="top",n=r?this.#b:this.#p,a=t.cameras[e];return a?{yaw:a.yaw,pitch:r?Math.PI/2-.018:a.pitch,distance:E(n/E(a.zoom,.01,100),Math.max(.2,this.#m*.04),this.#m*8),targetX:E(a.targetX,-this.#m,this.#m),targetZ:E(a.targetZ,-this.#m,this.#m),orthographic:r}:r?{yaw:0,pitch:Math.PI/2-.018,distance:n,targetX:0,targetZ:0,orthographic:!0}:{yaw:-Math.PI/4,pitch:.82,distance:n,targetX:0,targetZ:0,orthographic:!1}}#Q(e,t){let r=t.cameras[e];if(!r)return!0;let n=e==="top";return Math.abs(r.zoom-1)<.001&&Math.abs(r.targetX)<.001&&Math.abs(r.targetZ)<.001&&Math.abs(Ae(r.yaw-(n?0:-Math.PI/4)))<.001&&(n||Math.abs(r.pitch-.82)<.001)}#F(e,t){let r=this.#r;if(!r)throw new Error("webgl-unavailable");let n=r.createShader(e);if(!n)throw new Error("shader-unavailable");if(r.shaderSource(n,t),r.compileShader(n),!r.getShaderParameter(n,r.COMPILE_STATUS))throw r.deleteShader(n),new Error("shader-failed");return n}#B(){try{this.#r=this.#e.getContext("webgl2",{alpha:!0,antialias:!0,depth:!0,powerPreference:"high-performance"});let e=this.#r;if(!e)throw new Error("webgl2-unavailable");let t=this.#F(e.VERTEX_SHADER,`#version 300 es
  ...
  `}#e;#t;#a;#r;#n(t,r,n){return R(this.localize,t,r,n)}firstUpdated(){let t=this.renderRoot.querySelector(".map-root"),r=this.renderRoot.querySelector(".scene-canvas"),n=this.renderRoot.querySelector(".overlay-canvas");!t||!r||!n||(this.#t=new qe(r,n,{onCamera:(a,i,s)=>{this.#o({type:"set-camera",view:this.state.workflow==="draw"?"top":this.state.view,camera:{yaw:a.yaw,pitch:a.pitch,zoom:i/100,targetX:a.targetX,targetZ:a.targetZ}}),this.state.workflow==="draw"&&i!==this.state.draw.zoomPercent&&this.#o({type:"set-zoom",value:i,...s?{originX:s.xPercent,originY:s.yPercent}:{}})},onRoom:a=>this.#o({type:"toggle-room",roomId:a}),onProblem:()=>this.#c("renderer-problem")}),this.#a=new Be(t,this.#t,{state:()=>this.state,onCircles:(a,i,s)=>this.#o({type:"set-draft-circles",circles:a,record:i,...s?{previous:s}:{}}),onRoom:a=>this.#o({type:"toggle-room",roomId:a})}),this.#t.setState(this.state))}disconnectedCallback(){this.#a?.dispose(),this.#a=null,this.#t?.dispose(),this.#t=null,super.disconnectedCallback()}updated(t){if(!t.has("state"))return;t.get("state")?.fullMap&&!this.state.fullMap&&this.#e&&this.#e.focus(),this.#t?.setState(this.state)}#o(t){this.dispatchEvent(new CustomEvent(ne,{detail:t,bubbles:!0,composed:!0}))}#c(t){this.dispatchEvent(new CustomEvent(Xe,{detail:{id:t},bubbles:!0,composed:!0}))}#d(t){this.#e=t.currentTarget,this.#o({type:this.state.fullMap?"exit-full-map":"enter-full-map"})}#u(t,r){this.#t?.orbitBy(t,r)}#s(t){if(!(t.ctrlKey||t.metaKey||t.altKey)&&t.key==="Escape"){if(t.preventDefault(),this.#r){this.#r=!1,this.requestUpdate();return}this.#o({type:"dismiss-top-layer"});return}}rendererDiagnostics(){return this.#t?.diagnostics()??null}canvasIdentity(){return{scene:this.renderRoot.querySelector(".scene-canvas"),overlay:this.renderRoot.querySelector(".overlay-canvas")}}#f(){return this.state.host.connected?this.state.host.administrator?this.state.host.robotCount===0?{title:this.#n("v4_no_robot","No Matic robot set up"),detail:this.#n("v4_no_robot_detail","Set up a robot before opening its map.")}:this.state.host.robotConnected?this.state.coherence==="verifying"||this.state.coherence==="booting"?{title:this.#n("v4_locating_map","Locating the current map"),detail:this.#n("v4_locating_map_detail","Map controls will return after the floor is verified.")}:!this.state.map.available&&this.state.resources.scene.status==="loading"?{title:this.#n("v4_loading_verified_map","Loading the verified map"),detail:this.#n("v4_loading_verified_map_detail","The current floor is verified. The private scene is still preparing.")}:this.state.map.available?this.state.activity==="problem"?{title:this.#n("v4_robot_attention","Robot needs attention"),detail:this.#n("v4_robot_attention_detail","Check the robot before starting another task.")}:null:{title:this.#n("v4_map_unavailable","Map unavailable"),detail:this.#n("v4_map_unavailable_detail","The private scene is not ready. No map data is shown until it is verified.")}:{title:this.#n("v4_robot_offline","Robot offline"),detail:this.#n("v4_robot_offline_detail","The last verified map stays read only and has no live position.")}:{title:this.#n("v4_admin_required","Administrator access required"),detail:this.#n("v4_private_map_hidden","Private map data is hidden.")}:{title:this.#n("v4_reconnecting","Reconnecting"),detail:this.#n("v4_reconnecting_detail","The verified map is read only until Home Assistant reconnects.")}}render(){let t=this.state,r=Yt(t),n=this.#f(),a=t.map.available&&(ce(t)||t.dataMode==="history"),i=t.workflow==="draw"&&a,s=t.coherence==="verifying"||t.coherence==="booting";return A`
    ...
    `}};customElements.get(Me)||customElements.define(Me,Mt);var At=class extends x{constructor(){super(...arguments);this.state=M();this.compact=!1}static{this.properties={state:{attribute:!1},localize:{attribute:!1},compact:{type:Boolean,reflect:!0}}}static{this.styles=L`
  ...
  `}#e(t,r){return R(this.localize,t,r)}#t(t){this.dispatchEvent(new CustomEvent(ne,{detail:t,bubbles:!0,composed:!0}))}#a(t,r){let n=t.currentTarget.valueAsNumber;Number.isFinite(n)&&this.#t(r==="zoom"?{type:"set-zoom",value:n}:{type:"set-brush",value:n})}render(){let{draw:t}=this.state;return A`
    ...
    `}};customElements.get(te)||customElements.define(te,At);var Pt=["vacuum","mop","vacuum_and_mop"],Et=["quick","standard","heavy_duty"],D=o=>o.currentTarget.value,Rt=o=>o.currentTarget.checked,Er=U(te),It=class extends x{constructor(){super(...arguments);this.state=M()}static{this.properties={state:{attribute:!1},localize:{attribute:!1}}}static{this.styles=L`
  ...
  `}#e(t,r,n){return R(this.localize,t,r,n)}#t(t){return t==="vacuum"?this.#e("vacuum","Vacuum"):t==="mop"?this.#e("mop","Mop"):this.#e("vacuum_and_mop","Vacuum + mop")}#a(t){return t==="quick"?this.#e("quick","Quick"):t==="standard"?this.#e("standard","Optimal"):this.#e("heavy_duty","Heavy Duty")}#r(t){this.dispatchEvent(new CustomEvent(ne,{detail:t,bubbles:!0,composed:!0}))}#n(){return this.state.notice?f`
      ...
      <div class="split room-settings">
        <label class="field">${this.#e("v4_cleaning_system","Cleaning system")}
          <select
            ...
            @change=${n=>this.#r({type:"patch-room-settings",roomId:t,cleaningMode:D(n)})}
        ...
        <label class="field">${this.#e("cleaning_mode","Cleaning mode")}
          <select
            ...
            @change=${n=>this.#r({type:"patch-room-settings",roomId:t,coverageSetting:D(n)})}
      ...
      <div class="stack">
        <div class="split">
          <label class="field">${this.#e("v4_saved_plan","Saved plan")}
            <select
              ...
              @change=${l=>this.#r({type:"select-plan",planId:D(l)||null})}
            >
        ...
        <label class="field">${this.#e("plan_name","Plan name")}
          <input
            ...
            autocomplete="off"
            .value=${n.name}
            @input=${l=>this.#r({type:"patch-plan-draft",patch:{name:D(l)}})}
          >
        </label>
        <div class="split">
          <label class="field">${this.#e("plan_run_behavior","Run order")}
            <select
              .value=${n.runBehavior}
              @change=${l=>this.#r({type:"patch-plan-draft",patch:{runBehavior:D(l)==="ordered"?"ordered":"intelligent"}})}
            >
        ...
        <div class="plan-options" aria-label=${this.#e("v4_completion_options","Completion options")}>
          ...
          ${n.finishCurrentRoom?f`<label class="field">${this.#e("plan_threshold","Finish threshold")} \u00b7 ${n.finishCurrentRoomThreshold}%<input type="range" min="0" max="100" step="5" .value=${String(n.finishCurrentRoomThreshold)} @input=${l=>this.#r({type:"patch-plan-draft",patch:{finishCurrentRoomThreshold:Number(D(l))}})}></label>`:m}
        </div>
          ...
          ${s.map(({room:l,label:c,selected:d})=>{let u=d?n.rooms.findIndex(h=>h.roomId===l.roomId):-1;return f`
              <div class="room plan-room" data-selected=${String(d)}>
                ...
                ${d?f`
                  <div class="split room-settings">
                    <label class="field">${this.#e("v4_cleaning_system","Cleaning system")}
                      <select .value=${l.cleaningMode} @change=${h=>this.#s(u,{cleaningMode:D(h)})}>${Pt.map(h=>f`<option value=${h} ?selected=${h===l.cleaningMode}>${this.#t(h)}</option>`)}</select>
                    </label>
                    <label class="field">${this.#e("cleaning_mode","Cleaning mode")}
                      <select .value=${l.coverageSetting} @change=${h=>this.#s(u,{coverageSetting:D(h)})}>${Et.map(h=>f`<option value=${h} ?selected=${h===l.coverageSetting}>${this.#a(h)}</option>`)}</select>
                    </label>
                  </div>
                `:m}
              </div>
    ...
    `)}#_(){let t=this.state.resources.areas;return f`
      <div class="stack">
        <${Er} .state=${this.state} .localize=${this.localize}></${Er}>
    ...
    `}#h(){let t=this.state.areaDraft,r=t.canRebind||t.status==="review",n=t.status==="stale"||t.status==="unknown";return f`
      <div class="stack">
        ...
        <label class="field">${this.#e("area_name","Area name")}
          <input maxlength="128" autocomplete="off" .value=${t.name} @input=${a=>this.#r({type:"patch-area-draft",patch:{name:D(a)}})}>
        </label>
        <div class="split">
          <label class="field">${this.#e("v4_cleaning_system","Cleaning system")}
            <select .value=${t.cleaningMode} @change=${a=>this.#r({type:"patch-area-draft",patch:{cleaningMode:D(a)}})}>${Pt.map(a=>f`<option value=${a} ?selected=${a===t.cleaningMode}>${this.#t(a)}</option>`)}</select>
          </label>
          <label class="field">${this.#e("cleaning_mode","Cleaning mode")}
            <select .value=${t.coverageSetting} @change=${a=>this.#r({type:"patch-area-draft",patch:{coverageSetting:D(a)}})}>${Et.map(a=>f`<option value=${a} ?selected=${a===t.coverageSetting}>${this.#a(a)}</option>`)}</select>
          </label>
        </div>
        ...
        <div class="timeline">
          <label class="field">${this.#e("map_timeline_label","Map timeline")}
            <input
              ...
              .value=${String(i)}
              ?disabled=${!a.length}
              @input=${s=>{let l=Number(D(s));this.#r({type:"set-history",historyId:l===a.length?null:a[l]?.id||null})}}
            >
          </label>
          <div class="list">
  ...
  `}#e(t,r,n){return R(this.localize,t,r,n)}#t;#a;#r;#n;#o;#c;#d;#u;connectedCallback(){super.connectedCallback(),this.#t=new ResizeObserver(([t])=>{if(!t)return;let r=t.contentRect.width<768||t.contentRect.height<480;r!==this._measuredNarrow&&(this._measuredNarrow=r)}),this.#t.observe(this),window.addEventListener("pointerdown",this.#u,!0),document.addEventListener("fullscreenchange",this.#d),this.#a=new ResizeObserver(([t])=>{if(!t)return;let r=Math.ceil(t.target.getBoundingClientRect().height);r!==this._sheetOffset&&(this._sheetOffset=r)})}disconnectedCallback(){this.#t?.disconnect(),this.#t=null,this.#a?.disconnect(),this.#a=null,this.#r=null,window.removeEventListener("pointerdown",this.#u,!0),document.removeEventListener("fullscreenchange",this.#d),super.disconnectedCallback()}updated(t){let r=this.renderRoot.querySelector(".mobile-sheet");if(r!==this.#r&&(this.#a?.disconnect(),this.#r=r,r&&this.#a?.observe(r)),t.has("state")){let n=t.get("state");if(n?.precisionOpen&&!this.state.precisionOpen&&this.#n?.focus(),!n?.dialog&&this.state.dialog){let a=Xo(this.shadowRoot||document);a?.hasAttribute("data-dialog-launcher")&&(this.#o=a),this.updateComplete.then(()=>{this.renderRoot.querySelector(".dialog button")?.focus()})}else if(n?.dialog&&!this.state.dialog){let a=this.#o?.isConnected&&this.#o.hasAttribute("data-dialog-launcher")?this.#o:this.#E(n.dialog);this.#o=null,this.updateComplete.then(()=>{requestAnimationFrame(()=>a?.focus({preventScroll:!0}))})}(!n||n.workflow!==this.state.workflow)&&(this._sheetDetent="half")}}#s(t){this.dispatchEvent(new CustomEvent(ne,{detail:t,bubbles:!0,composed:!0}))}#f(t){if(t.enabled){if(t.id==="return-live"){this.#s({type:"set-history",historyId:null});return}this.#y(t.id)}}#g(t){if(this.state.workflow==="draw"&&this.state.draw.dirty&&t!=="draw"&&t!=="areaReview"){this.#c=t,this.#s({type:"open-dialog",dialog:"discardDraft"});return}this.#s({type:"open-workflow",workflow:t})}#_(){let t=this.#c;this.#c=null,this.#s({type:"discard-draft"}),t&&queueMicrotask(()=>this.#s({type:"open-workflow",workflow:t}))}#h(){this.#c=null,this.#k()}#k(){let t=this.state.dialog,r=t&&this.#o?.isConnected&&this.#o.hasAttribute("data-dialog-launcher")?this.#o:t?this.#E(t):null;this.#s({type:"dismiss-top-layer"}),r&&requestAnimationFrame(()=>r.focus({preventScroll:!0}))}#y(t){this.dispatchEvent(new CustomEvent(Xe,{detail:{id:t},bubbles:!0,composed:!0}))}#l(t){this.#s({type:"dismiss-top-layer"}),this.#y(t)}#w(t){if(t.action==="discard"){this.#_();return}if(t.action==="delete-plan"||t.action==="delete-area"){this.#l(t.action);return}this.#s({type:"dismiss-top-layer"}),t.action==="stop"&&this.#y("stop")}#$(){this._sheetDetent=this._sheetDetent==="peek"?"half":this._sheetDetent==="half"?"full":"peek"}#x(){if(this.state.precisionOpen||this.state.fullMap){this.#s({type:"dismiss-top-layer"});return}if(this.state.workflow!=="none"){this.#g("none");return}this.#i()}#i(){this.dispatchEvent(new CustomEvent("hass-toggle-menu",{bubbles:!0,composed:!0}))}#p(t){if(this._overflowOpen=!1,t==="support"){this.#g("support");return}if(t==="fullscreen"){let r=this.renderRoot.querySelector(".app");document.fullscreenElement?document.exitFullscreen():r?.requestFullscreen();return}this.dispatchEvent(new CustomEvent(Xe,{detail:{id:"use-classic"},bubbles:!0,composed:!0}))}#b(t){this.#n=t.currentTarget,this.#s({type:"set-precision-open",value:!this.state.precisionOpen})}#m(t){let r=t;if(r.detail?.type!=="open-dialog")return;let n=r.composedPath().find(a=>a instanceof HTMLElement&&a.hasAttribute("data-dialog-launcher"));n instanceof HTMLElement&&(this.#o=n)}#E(t){return this.renderRoot.querySelector(pe)?.shadowRoot?.querySelector(`[data-dialog-launcher="${t}"]`)??null}#C(t){if(!(t.defaultPrevented||t.ctrlKey||t.metaKey||t.altKey)&&t.key==="Escape"){if(t.preventDefault(),this._overflowOpen){this._overflowOpen=!1;return}this.#s({type:"dismiss-top-layer"})}}#M(t){if(t.key!=="Tab")return;let r=[...this.renderRoot.querySelectorAll(".dialog button:not(:disabled)")],n=r[0],a=r.at(-1);!n||!a||(t.shiftKey&&this.shadowRoot?.activeElement===n?(t.preventDefault(),a.focus()):!t.shiftKey&&this.shadowRoot?.activeElement===a&&(t.preventDefault(),n.focus()))}#A(t,r="primary-action"){if(t.id==="choose-cleaning")return m;let a={stop:["v4_stop","Stop"],resume:["v4_resume","Resume"],"review-area":["v4_review_details","Review details"],"save-area":["area_save","Save area"],"run-area":["area_run","Clean area"],"save-plan":["plan_save","Save plan"],"run-plan":["plan_run","Run plan"]}[t.id],i=t.id==="clean-rooms"?t.label:a?this.#e(a[0],a[1]):t.label;return f`
          ...
          <main class=${`workspace ${t.fullMap?"full-map":""}`}>
            ...
            ${u?f`
              <div class="precision-popover">
                ...
                >${this.#e("clear","Clear")}</button>
                ${t.precisionOpen?f`
                  <${Ir} compact .state=${t} .localize=${this.localize}></${Ir}>
                `:m}
              </div>
            `:m}
    ...
    `}};customElements.get(re)||customElements.define(re,Lt);var Tr=U(re),Tt=class extends x{constructor(){super(...arguments);this.scenario="ready";this.narrow=!1;this.controls=!0;this._workspace=ct("ready");this.#e=new le(this._workspace);this.#t=null}static{this.properties={scenario:{type:String,reflect:!0},narrow:{type:Boolean,reflect:!0},controls:{type:Boolean,reflect:!0},_workspace:{state:!0}}}static{this.styles=L`
    :host {
      display: block;
      color: #1f2933;
      background: #e8edef;
  ...
  `}#e;#t;connectedCallback(){super.connectedCallback(),this.#t=this.#e.subscribe(t=>{this._workspace=t})}disconnectedCallback(){this.#t?.(),this.#t=null,super.disconnectedCallback()}willUpdate(t){t.has("scenario")?this.#e.replace({...ct(this.scenario),narrowHint:this.narrow}):t.has("narrow")&&this.#e.dispatch({type:"set-narrow-hint",value:this.narrow})}setScenario(t){dt.includes(t)&&(this.scenario=t)}getWorkspaceSnapshot(){return structuredClone(this.#e.value)}replaceWorkspaceState(t){this.#e.replace(structuredClone(t))}#a(t){ze(t.detail)&&(t.stopPropagation(),this.#e.dispatch(t.detail))}render(){return f`
      ${this.controls?f`
    ...
    `}};customElements.get("matic-map-studio-gallery-v0-4-0")||customElements.define("matic-map-studio-gallery-v0-4-0",Tt);var zr="/api/matic_robot/slam_entries";var y=class extends Error{constructor(e){super(e),this.name="ContractError",this.code=e}},T=(o,e)=>{if(!o||typeof o!="object"||Array.isArray(o))throw new y(e);return o},$=(o,e,t)=>{if(typeof o!="string")throw new y(t);let r=o.trim();if(!r||Array.from(r).length>e||/[\u0000-\u001f\u007f]/u.test(r))throw new y(t);return r},Vo=o=>{if(o==null||o==="")return null;try{return $(o,128,"invalid-floor-label")}catch{return null}},fe=(o,e,t,r)=>{if(typeof o!="number"||!Number.isFinite(o)||o<e||o>t)throw new y(r);return o},W=(o,e,t,r)=>{let n=fe(o,e,t,r);if(!Number.isInteger(n))throw new y(r);return n},zt=(o,e)=>o==null?null:W(o,1,e,"invalid-floor-ordinal"),S=(o,e)=>{if(typeof o!="boolean")throw new y(e);return o},Ko=(o,e)=>o===null?null:S(o,e),Dr=o=>{if(o==null)return null;let e=$(o,64,"invalid-map-session-key");if(!/^[0-9a-f]{64}$/u.test(e))throw new y("invalid-map-session-key");return e},Yo=o=>{if(o==null)return null;if(o==="bootstrap_empty"||o==="map_session_unverified"||o==="floor_plan_unavailable"||o==="floor_plan_mismatch")return o;throw new y("invalid-map-block-reason")},Go=o=>{if(o===void 0)return"not_started";if(o==="not_started"||o==="running"||o==="complete"||o==="partial"||o==="failed")return o;throw new y("invalid-bootstrap-state")},V=(o,e)=>{let t=$(o,512,e);if(!t.startsWith("/")||t.startsWith("//")||t.includes("\\"))throw new y(e);return t},jo=o=>{let e=typeof o.map_health=="string"?o.map_health.toLowerCase():"",t=typeof o.stream_state=="string"?o.stream_state.toLowerCase():"",r=typeof o.invalid_tiles=="number"?o.invalid_tiles:0;return e.includes("error")||e.includes("fail")||e.includes("degrad")||r>0?"problem":o.map_truncated===!0||e.includes("truncat")||e.includes("limit")?"limited":o.map_complete===!0?"ready":t.includes("connect")||t.includes("collect")||t.includes("run")?"building":"unknown"},Or=o=>{let e=T(o,"invalid-catalog");if(!Array.isArray(e.entries)||e.entries.length>64)throw new y("invalid-catalog-entries");return e.entries.map(t=>{let r=T(t,"invalid-catalog-entry"),n=W(r.map_revision,0,Number.MAX_SAFE_INTEGER,"invalid-map-revision");return{entryId:$(r.entry_id,128,"invalid-entry-id"),sceneUrl:V(r.scene_url,"invalid-scene-url"),deltaUrl:r.delta_url===void 0||r.delta_url===null?null:V(r.delta_url,"invalid-delta-url"),poseUrl:V(r.pose_url,"invalid-pose-url"),historyUrl:V(r.history_url,"invalid-history-url"),areasUrl:V(r.areas_url,"invalid-areas-url"),plansUrl:V(r.plans_url,"invalid-plans-url"),mapRevision:n,mapFloorCoherent:S(r.map_floor_coherent,"invalid-floor-coherence"),mapSessionVerified:S(r.map_session_verified,"invalid-session-state"),mapSessionKey:Dr(r.map_session_key),mapBlockReason:Yo(r.map_block_reason),runnerLocked:S(r.runner_locked,"invalid-runner-lock"),stopSettlePending:S(r.stop_settle_pending,"invalid-stop-settle"),activePlan:S(r.active_plan,"invalid-active-plan"),nativeReconciliationPending:S(r.native_reconciliation_pending,"invalid-native-reconciliation"),nativeSessionActive:Ko(r.native_session_active,"invalid-native-session"),mapComplete:S(r.map_complete,"invalid-map-complete"),mapTruncated:S(r.map_truncated,"invalid-map-truncated"),selectedFloorOrdinal:zt(r.selected_floor_ordinal,128),mapFloorOrdinal:zt(r.map_floor_ordinal,128),historyCount:W(r.history_count,0,12,"invalid-history-count"),historyFloorCount:W(r.history_floor_count,0,128,"invalid-floor-count"),health:jo(r),streamFailures:W(r.stream_failures,0,Number.MAX_SAFE_INTEGER,"invalid-stream-failures"),bootstrapState:Go(r.bootstrap_state),bootstrapPhotoSeen:r.bootstrap_photo_seen===void 0?!1:S(r.bootstrap_photo_seen,"invalid-bootstrap-photo"),bootstrapStructureSeen:r.bootstrap_structure_seen===void 0?!1:S(r.bootstrap_structure_seen,"invalid-bootstrap-structure"),bootstrapFailures:r.bootstrap_failures===void 0?0:W(r.bootstrap_failures,0,2,"invalid-bootstrap-failures")}})},Nr=(o,e)=>{if(!Array.isArray(o)||o.length!==2)throw new y(e);return[fe(o[0],-1e6,1e6,e),fe(o[1],-1e6,1e6,e)]},Zo=(o,e)=>{if(!Array.isArray(o)||o.length<3||o.length>8192)throw new y(e);return o.map(t=>Nr(t,e))},Wr=(o,e)=>{if(!Array.isArray(o)||o.length>256)throw new y("invalid-rooms");return o.map(t=>{let r=T(t,"invalid-room");return{roomId:$(r.room_id,128,"invalid-room-id"),name:$(r.name,128,"invalid-room-name"),boundary:e?Zo(r.boundary,"invalid-room-boundary"):[]}})},Qo=o=>{let e=T(o,"invalid-history-snapshot"),t=$(e.created_at,64,"invalid-history-time");if(!Number.isFinite(Date.parse(t)))throw new y("invalid-history-time");return{id:$(e.id,128,"invalid-history-id"),createdAt:t,revision:W(e.revision,0,Number.MAX_SAFE_INTEGER,"invalid-history-revision"),pointCount:W(e.point_count,1,15e5,"invalid-history-points"),sceneUrl:V(e.scene_url,"invalid-history-scene-url")}},Ur=o=>{let e=T(o,"invalid-history");if(!Array.isArray(e.floors)||e.floors.length<1||e.floors.length>128)throw new y("invalid-history-floors");return{entryId:$(e.entry_id,128,"invalid-history-entry"),liveAvailable:S(e.live_available,"invalid-history-live"),floors:e.floors.map(t=>{let r=T(t,"invalid-history-floor");if(!Array.isArray(r.snapshots)||r.snapshots.length>12)throw new y("invalid-history-snapshots");return{id:$(r.id,128,"invalid-history-floor-id"),active:S(r.active,"invalid-history-floor-active"),readOnly:S(r.read_only,"invalid-history-floor-read-only"),liveAvailable:r.live_available===void 0?!1:S(r.live_available,"invalid-history-floor-live"),label:Vo(r.label),ordinal:r.ordinal===void 0?null:zt(r.ordinal,128),snapshots:r.snapshots.map(Qo)}})}},Hr=o=>{if(o==="vacuum"||o==="mop"||o==="vacuum_and_mop")return o;throw new y("invalid-cleaning-mode")},Fr=o=>{if(o==="quick"||o==="standard"||o==="heavy_duty")return o;throw new y("invalid-coverage-setting")},Jo=o=>{let e=T(o,"invalid-area-circle");return{x:fe(e.x,-1e6,1e6,"invalid-area-circle"),y:fe(e.y,-1e6,1e6,"invalid-area-circle"),radius:fe(e.radius,.05,2.5,"invalid-area-circle")}},en=o=>o==="current"||o==="review"||o==="stale"?o:"unknown",Br=o=>{let e=T(o,"invalid-areas");if(!Array.isArray(e.areas)||e.areas.length>256)throw new y("invalid-area-list");return{sceneUrl:V(e.scene_url,"invalid-area-scene-url"),rooms:Wr(e.rooms,!0),areas:e.areas.map(t=>{let r=T(t,"invalid-area");if(!Array.isArray(r.circles)||r.circles.length>512)throw new y("invalid-area-circles");return{id:$(r.id,128,"invalid-area-id"),name:$(r.name,128,"invalid-area-name"),circles:r.circles.map(Jo),cleaningMode:Hr(r.cleaning_mode),coverageSetting:Fr(r.coverage_setting),status:en(r.status),canRebind:S(r.can_rebind,"invalid-area-rebind")}})}},qr=o=>{let e=T(o,"invalid-plans");if(!Array.isArray(e.plans)||e.plans.length>256)throw new y("invalid-plan-list");return{rooms:Wr(e.rooms,!1).map(({roomId:r,name:n})=>({roomId:r,name:n})),selectedPlan:e.selected_plan===null||e.selected_plan===void 0?null:$(e.selected_plan,128,"invalid-selected-plan"),plans:e.plans.map(r=>{let n=T(r,"invalid-plan");if(!Array.isArray(n.rooms)||n.rooms.length>256||!Array.isArray(n.room_order))throw new y("invalid-plan-rooms");let a=n.run_behavior;if(a!=="intelligent"&&a!=="ordered")throw new y("invalid-run-behavior");return{id:$(n.id,128,"invalid-plan-id"),name:$(n.name,128,"invalid-plan-name"),enabled:S(n.enabled,"invalid-plan-enabled"),runBehavior:a,rooms:n.rooms.map(i=>{let s=T(i,"invalid-plan-room");return{roomId:$(s.room_id,128,"invalid-plan-room-id"),cleaningMode:Hr(s.cleaning_mode),coverageSetting:Fr(s.coverage_setting)}}),roomOrder:n.room_order.slice(0,256).map(i=>$(i,128,"invalid-room-order")),returnToBase:S(n.return_to_base,"invalid-return-to-base"),finishCurrentRoom:S(n.finish_current_room,"invalid-finish-room"),finishCurrentRoomThreshold:W(n.finish_current_room_threshold,0,100,"invalid-finish-threshold")}})}},Xr=o=>{let e=T(o,"invalid-pose"),t=e.position,r=t===null?null:Nr(t,"invalid-pose-position"),n=e.pose_freshness;if(n!=="live"&&n!=="coordinator_fallback")throw new y("invalid-pose-freshness");return{position:r,source:$(e.source,64,"invalid-pose-source"),revision:W(e.revision,0,Number.MAX_SAFE_INTEGER,"invalid-pose-revision"),poseRevision:W(e.pose_revision,0,Number.MAX_SAFE_INTEGER,"invalid-pose-sequence"),floorCoherent:S(e.map_floor_coherent,"invalid-pose-floor"),mapSessionKey:Dr(e.map_session_key),freshness:n}},Vr=o=>{try{return V(o,"invalid-private-path"),!0}catch{return!1}};var Kr=o=>{let a=()=>{throw new Error("invalid-scene")};(!(o instanceof ArrayBuffer)||o.byteLength<24||o.byteLength>16777216)&&a();let i=new DataView(o),s=new Uint8Array(o,0,8),l=String.fromCharCode(...s),c=i.getUint16(8,!0),d=i.getUint16(10,!0),u=i.getUint32(12,!0),h=i.getUint32(16,!0),p=i.getUint32(20,!0),g=h+p,_=24+u;(l!=="MATIC3D\0"||c!==1||d!==8||u>1024*1024||g<1||g>15e5||_+g*d!==o.byteLength)&&a();let w;try{w=JSON.parse(new TextDecoder("utf-8",{fatal:!0}).decode(new Uint8Array(o,24,u)))}catch{a()}(!w||typeof w!="object"||Array.isArray(w))&&a();let b=w,C=b.meters_per_cell,k=b.origin_cells,I=b.span_cells;(typeof C!="number"||!Number.isFinite(C)||C<.001||C>.1||!Array.isArray(k)||k.length!==2||!k.every(z=>typeof z=="number"&&Number.isFinite(z))||!Array.isArray(I)||I.length!==2||!I.every(z=>typeof z=="number"&&Number.isFinite(z)&&z>=1&&z<=65536))&&a();let Re=(Array.isArray(b.rooms)?b.rooms.slice(0,128):[]).flatMap((z,co)=>{if(!z||typeof z!="object"||Array.isArray(z))return[];let G=z,Ie=typeof G.name=="string"?G.name.trim():"";if(!Ie||Array.from(Ie).length>128||/[\u0000-\u001f\u007f]/u.test(Ie))return[];if(!Array.isArray(G.boundary)||G.boundary.length<3||G.boundary.length>8192)return[];let Bt=G.boundary.flatMap(rt=>{if(!Array.isArray(rt)||rt.length!==2)return[];let[ot,nt]=rt;return typeof ot=="number"&&Number.isFinite(ot)&&typeof nt=="number"&&Number.isFinite(nt)?[[ot,nt]]:[]}),Je=G.center;if(Bt.length<3||!Array.isArray(Je)||Je.length!==2)return[];let[et,tt]=Je;return typeof et!="number"||!Number.isFinite(et)||typeof tt!="number"||!Number.isFinite(tt)?[]:[{id:`scene-room-${co+1}`,name:Ie,boundary:Bt,center:[et,tt]}]}),lo=typeof b.sample_step=="number"&&Number.isInteger(b.sample_step)?Math.max(1,Math.min(15e5,b.sample_step)):1,Ht=k,Ft=I;return{buffer:o,pointOffset:_,floorCount:h,surfaceCount:p,total:g,metadata:{metersPerCell:C,origin:[Ht[0],Ht[1]],span:[Ft[0],Ft[1]],sampleStep:lo,rooms:Re}}},nn=o=>{if(o.byteLength>16777216||o.byteLength<24||!1||!1)throw new y("invalid-scene");try{return Kr(o)}catch{throw new y("invalid-scene")}},an=()=>`
  const parseTransfer = ${Kr.toString()};
...
`,Ve=class{#e=null;#t=null;#a=0;#r=new Map;constructor(){if(!(typeof Worker!="function"||typeof URL?.createObjectURL!="function"))try{this.#t=URL.createObjectURL(new Blob([an()],{type:"text/javascript"})),this.#e=new Worker(this.#t),this.#e.onmessage=e=>{let t=this.#r.get(e.data.id);t&&(this.#r.delete(e.data.id),e.data.ok&&e.data.parsed?t.resolve(e.data.parsed):t.reject(new y(e.data.problem||"invalid-scene")))},this.#e.onerror=()=>this.#n("scene-worker-failed")}catch{this.#e=null,this.#t&&URL.revokeObjectURL(this.#t),this.#t=null}}async parse(e,t){if(t?.aborted)throw new DOMException("Aborted","AbortError");if(!this.#e){if(await new Promise(n=>window.setTimeout(n,0)),t?.aborted)throw new DOMException("Aborted","AbortError");return nn(e)}let r=++this.#a;return new Promise((n,a)=>{let i=()=>{this.#r.delete(r),a(new DOMException("Aborted","AbortError"))};t?.addEventListener("abort",i,{once:!0}),this.#r.set(r,{resolve:s=>{t?.removeEventListener("abort",i),n(s)},reject:s=>{t?.removeEventListener("abort",i),a(s)}}),this.#e?.postMessage({id:r,buffer:e},[e])})}#n(e){for(let t of this.#r.values())t.reject(new y(e));this.#r.clear(),this.#e?.terminate(),this.#e=null}dispose(){this.#n("scene-parser-disposed"),this.#t&&URL.revokeObjectURL(this.#t),this.#t=null}};var K={catalog:1e4,scene:6e4,delta:35e3,pose:1e4,history:15e3,workflow:15e3,mutation:2e4},O=class extends Error{constructor(e,t=null){super(e),this.name="BackendError",this.code=e,this.status=t}},Pe=36,ye=16*1024*1024,Yr=(o,e)=>{let t=Number(o);if(!Number.isSafeInteger(t)||t<0)throw new y(e);return t},Gr=(o,e)=>{let t=o.headers.get("X-Matic-Revision");if(t===null)return e;let r=Number(t);if(!Number.isSafeInteger(r)||r<0)throw new y("invalid-scene-revision");return r},jr=(o,e)=>{let t=o.headers.get("X-Matic-Floor-Coherent");if(t===null)return e;if(t==="1")return!0;if(t==="0")return!1;throw new y("invalid-scene-floor-header")},Ke=class{#e;#t=new Ve;constructor(e){this.#e=e}async#a(e,t,r,n){if(!Vr(e))throw new O("invalid-private-path");if(n?.aborted)throw new DOMException("Aborted","AbortError");let a=new AbortController,i=()=>a.abort();n?.addEventListener("abort",i,{once:!0});let s=!1,l=window.setTimeout(()=>{s=!0,a.abort()},r);try{let c=this.#e(),d=new Headers(t.headers),u={...t,cache:"no-store",credentials:"same-origin",headers:Object.fromEntries(d.entries()),signal:a.signal};if(typeof c?.fetchWithAuth=="function")return await c.fetchWithAuth(e,u);let h=c?.auth?.accessToken||c?.auth?.data?.access_token;h&&d.set("Authorization",`Bearer ${h}`);let p=typeof c?.hassUrl=="function"?c.hassUrl(e):e;return await fetch(p,{...u,headers:d})}catch(c){throw s&&!n?.aborted?new O("request-timeout"):a.signal.aborted?new DOMException("Aborted","AbortError"):c}finally{window.clearTimeout(l),n?.removeEventListener("abort",i)}}async#r(e,t,r,n={}){let a=await this.#a(e,{...n,headers:{Accept:"application/json",...n.headers||{}}},t,r);if(!a.ok)throw new O("request-failed",a.status);try{return await a.json()}catch{throw new y("invalid-json-response")}}async catalog(e){return Or(await this.#r(zr,K.catalog,e))}async scene(e,t,r,n,a,i){let s=new Headers({Accept:"application/vnd.matic.slam-scene"});n==="live"&&s.set("X-Matic-Prefer-Cached","1"),i&&s.set("If-None-Match",i);let l=await this.#a(e,{headers:s},K.scene,a),c=Gr(l,t),d=jr(l,r);if(l.status===304)return{scene:null,floorCoherent:d,revision:c,notModified:!0};if(!l.ok)throw new O("scene-request-failed",l.status);if(l.headers.get("Content-Type")?.split(";",1)[0]!=="application/vnd.matic.slam-scene")throw new y("invalid-scene-content-type");return{scene:{...await this.#t.parse(await l.arrayBuffer(),a),revision:c,etag:l.headers.get("ETag"),source:n},floorCoherent:d,revision:c,notModified:!1}}async#n(e,t,r){if(!Number.isSafeInteger(t)||t<1||t>ye||typeof DecompressionStream!="function")throw new y("invalid-scene-delta");let a=new Blob([e]).stream().pipeThrough(new DecompressionStream("deflate")).getReader(),i=new Uint8Array(t),s=0,l=()=>{a.cancel()};r?.addEventListener("abort",l,{once:!0});try{for(;;){if(r?.aborted)throw new DOMException("Aborted","AbortError");let{done:c,value:d}=await a.read();if(c)break;if(!(d instanceof Uint8Array)||s+d.byteLength>t)throw new y("invalid-scene-delta");i.set(d,s),s+=d.byteLength}}finally{r?.removeEventListener("abort",l),a.releaseLock()}if(s!==t)throw new y("invalid-scene-delta");return i}async#o(e,t,r){if(e.byteLength<Pe||e.byteLength>Pe+ye||t.buffer.byteLength>ye)throw new y("invalid-scene-delta");let n=new DataView(e),a=new TextDecoder().decode(new Uint8Array(e,0,8)),i=n.getUint16(8,!0),s=n.getUint16(10,!0),l=Yr(n.getBigUint64(12,!0),"invalid-scene-delta"),c=Yr(n.getBigUint64(20,!0),"invalid-scene-delta"),d=n.getUint32(28,!0),u=n.getUint32(32,!0);if(a!=="MATICDLT"||i!==1||s!==1||l!==t.revision||c<=t.revision||d<24||d>ye||u>ye||u+Pe!==e.byteLength)throw new y("invalid-scene-delta");let h=new Uint8Array(e,Pe,u),p=new Uint8Array(t.buffer),_=(await this.#n(h,Math.max(p.byteLength,d),r)).slice(),w=1024*1024;for(let k=0;k<p.byteLength;k+=w){if(r?.aborted)throw new DOMException("Aborted","AbortError");let I=Math.min(p.byteLength,k+w);for(let P=k;P<I;P+=1)_[P]=(_[P]??0)^(p[P]??0);I<p.byteLength&&await new Promise(P=>window.setTimeout(P,0))}let b=_.slice(0,d).buffer;return{parsed:{...await this.#t.parse(b,r),revision:c,etag:null,source:"live"},revision:c}}async sceneDelta(e,t,r,n){let a=e.includes("?")?"&":"?",i=await this.#a(`${e}${a}since=${encodeURIComponent(t.revision)}`,{headers:{Accept:"application/vnd.matic.slam-delta, application/vnd.matic.slam-scene"}},K.delta,n),s=Gr(i,t.revision),l=jr(i,r);if(i.status===204){if(s!==t.revision)throw new y("invalid-scene-delta-revision");return{scene:null,floorCoherent:l,revision:s,notModified:!0}}if(!i.ok)throw new O("delta-request-failed",i.status);if(s<=t.revision)throw new y("invalid-scene-delta-revision");let c=Number(i.headers.get("Content-Length"));if(Number.isFinite(c)&&c>Pe+ye)throw new y("invalid-scene-delta-size");let d=i.headers.get("Content-Type")?.split(";",1)[0],u=await i.arrayBuffer();if(d==="application/vnd.matic.slam-delta"){let p=Number(i.headers.get("X-Matic-Base-Revision"));if(!Number.isSafeInteger(p)||p!==t.revision)throw new y("invalid-scene-delta-base");let g=await this.#o(u,t,n);if(g.revision!==s)throw new y("invalid-scene-delta-revision");return{scene:{...g.parsed,etag:i.headers.get("ETag")},floorCoherent:l,revision:s,notModified:!1}}if(d!=="application/vnd.matic.slam-scene")throw new y("invalid-scene-delta-content-type");return{scene:{...await this.#t.parse(u,n),revision:s,etag:i.headers.get("ETag"),source:"live"},floorCoherent:l,revision:s,notModified:!1}}async pose(e,t){return Xr(await this.#r(e,K.pose,t))}async history(e,t){return Ur(await this.#r(e,K.history,t))}async plans(e,t){return qr(await this.#r(e,K.workflow,t))}async areas(e,t){return Br(await this.#r(e,K.workflow,t))}async saveArea(e,t,r){let n=await this.#r(e,K.mutation,r,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({...t.areaId?{area_id:t.areaId}:{},name:t.name,circles:t.circles,cleaning_mode:t.cleaningMode,coverage_setting:t.coverageSetting})});if(!n||typeof n!="object"||typeof n.id!="string")throw new y("invalid-area-save-response");return n.id}async deleteArea(e,t,r){let n=await this.#a(`${e}?area_id=${encodeURIComponent(t)}`,{method:"DELETE",headers:{Accept:"application/json"}},K.mutation,r);if(!n.ok)throw new O("area-delete-failed",n.status)}async service(e,t,r,n){let a=this.#e();if(typeof a?.callService!="function")throw new O("service-unavailable");await a.callService(e,t,r,{entity_id:n})}dispose(){this.#t.dispose()}};var Qr=()=>({version:4,view:"top",appearance:"photo",labels:!0,quality:"auto",cameras:{}}),Ee=(o,e,t)=>Math.max(e,Math.min(t,o)),Jr=o=>o.replaceAll(/[^a-zA-Z0-9_-]/g,"").slice(0,128)||"local-user",Ot=(o,e=4)=>`matic-map-studio:v${e}:${Jr(o)}`,sn=o=>{if(!o||typeof o!="object")return null;let e=o;return["yaw","pitch","zoom","targetX","targetZ"].every(r=>typeof e[r]=="number"&&Number.isFinite(e[r]))?{yaw:Ee(e.yaw,-Math.PI,Math.PI),pitch:Ee(e.pitch,.18,Math.PI/2-.018),zoom:Ee(e.zoom,.01,100),targetX:Ee(e.targetX,-1e4,1e4),targetZ:Ee(e.targetZ,-1e4,1e4)}:null},Zr=o=>{let e=Qr();if(!o||typeof o!="object")return e;let t=o,r=t.view==="three"||t.view==="top"||t.view==="rooms"?t.view:e.view,n=r==="rooms"?"top":r,a=t.quality==="auto"||t.quality==="efficient"||t.quality==="balanced"||t.quality==="maximum"?t.quality:e.quality,i=t.cameras&&typeof t.cameras=="object"?t.cameras:{},s={};for(let l of["three","top"]){let c=sn(i[l]);c&&(s[l]=c)}return{version:4,view:n,appearance:t.appearance==="rooms"||t.appearance==="photo"?t.appearance:e.appearance,labels:typeof t.labels=="boolean"?t.labels:e.labels,quality:a,cameras:s}},Ye=class{#e="local-user";#t=null;load(e){this.#e=Jr(e);try{let t=window.localStorage.getItem(Ot(this.#e));if(t)return Zr(JSON.parse(t));for(let r of[3,2]){let n=window.localStorage.getItem(Ot(this.#e,r));if(n)return Zr(JSON.parse(n))}}catch{}return Qr()}schedule(e){this.#t!==null&&window.clearTimeout(this.#t),this.#t=window.setTimeout(()=>{this.#t=null;try{window.localStorage.setItem(Ot(this.#e),JSON.stringify(e))}catch{}},250)}dispose(){this.#t!==null&&window.clearTimeout(this.#t),this.#t=null}},eo="matic-map-studio:preferred-frontend",to=()=>{try{return window.localStorage.getItem(eo)==="v3"?"v3":"v4"}catch{return"v4"}},Nt=o=>{try{return window.localStorage.setItem(eo,o),!0}catch{return!1}};var v=(o,e,t=null)=>({status:o,value:e,problem:t}),H=o=>o instanceof DOMException&&o.name==="AbortError",ae=(o,e)=>o instanceof O||o&&typeof o=="object"&&"code"in o&&typeof o.code=="string"?o.code:e,Ge=o=>[o.selectedFloorOrdinal??"none",o.mapFloorOrdinal??"none",o.mapFloorCoherent?"coherent":"transition"].join(":"),je=o=>[o.mapFloorOrdinal??"none",o.mapSessionVerified?"verified":"unverified",o.mapSessionKey??"no-session"].join(":"),F=o=>[o.entryId,o.selectedFloorOrdinal??"none",o.mapFloorOrdinal??"none"].join("|"),ro=o=>[o.entryId,Ge(o),je(o),o.mapRevision].join("|"),oo=o=>o.runnerLocked||o.stopSettlePending||o.activePlan||o.nativeReconciliationPending||o.nativeSessionActive===!0,ln=(o,e)=>o.entryKey===e.entryKey&&o.generation===e.generation&&o.floorKey===e.floorKey&&o.missionKey===e.missionKey,no="Live map updates paused while the current map is rechecked.",ao="Reconnecting. The last verified map remains read only.",cn=1e3,Wt=(o,e)=>o.label?o.label:o.active?"Current floor":`Saved floor ${o.ordinal??e}`,Ze=class{#e;#t=new De;#a;#r=new Ye;#n=new Map;#o=null;#c;#d=null;#u=null;#s=null;#f=!1;#g=!1;#_=!1;#h="";#k=0;#y="";#l=!1;#w=!0;constructor(e,t){this.#e=e,this.#a=t}sync(e,t){if(this.#l)return;let r=this.#w;if(this.#w=e.host.connected,this.#o=e,this.#c=t,this.#e.patch({host:e.host,activity:e.activity,batteryPercent:e.batteryPercent,robotLabel:e.robotLabel,robots:e.robots,locale:e.language}),e.userKey!==this.#y){this.#y=e.userKey;let n=this.#r.load(e.userKey);this.#e.patch({view:n.view,appearance:n.appearance,labelsVisible:n.labels,quality:n.quality,cameras:n.cameras})}if(!e.host.administrator){this.#x(),this.#m("access-required");return}if(!e.host.connected){this.#x();let n=this.#e.value,a=n.resources.scene.value;this.#e.patch({coherence:a?"degraded":"unavailable",resources:{...n.resources,pose:v("idle",null)},map:{...n.map,available:a!==null,exactPose:!1},notice:a?{tone:"warning",text:ao}:n.notice});return}if(e.host.robotCount===0){this.#x(),this.#m("map-unavailable");return}if(this.#$(),!r){this.#e.value.notice?.text===ao&&this.#e.patch({notice:null}),this.refreshCatalog(!0);return}(this.#e.value.resources.catalog.status==="idle"||e.entryKey&&e.entryKey!==this.#e.value.selection.entryId)&&this.refreshCatalog(!0)}schedulePreferences(e){this.#r.schedule(e)}#$(){this.#d===null&&(this.#d=window.setInterval(()=>{document.visibilityState==="visible"&&this.refreshCatalog()},5e3)),this.#u===null&&(this.#u=window.setInterval(()=>{document.visibilityState==="visible"&&this.refreshPose()},cn))}#x(){this.#d!==null&&window.clearInterval(this.#d),this.#u!==null&&window.clearInterval(this.#u),this.#d=null,this.#u=null}#i(e){this.#n.get(e)?.abort();let t=new AbortController;return this.#n.set(e,t),t}#p(e,t){this.#n.get(e)===t&&this.#n.delete(e)}#b(e=[]){for(let[t,r]of this.#n)e.includes(t)||(r.abort(),this.#n.delete(t))}#m(e){this.#b(),this.#t.invalidate(),this.#h="";let t=this.#e.value;this.#e.patch({generation:this.#t.generation,coherence:t.host.administrator?"unavailable":"blocked",fullMap:!1,precisionOpen:!1,resources:{catalog:v("error",null,e),entry:null,scene:v("idle",null),pose:v("idle",null),history:v("idle",null),plans:v("idle",null),areas:v("idle",null)},map:{available:!1,complete:!1,floorCoherent:!1,sessionVerified:!1,exactPose:!1},selection:{...t.selection,entryId:null,floorId:"current",historyId:null}})}async refreshCatalog(e=!1){if(this.#l||this.#f||!this.#o?.host.administrator)return;this.#f=!0;let t=this.#i("catalog"),r=this.#e.value.resources.catalog.value;this.#e.patch({resources:{...this.#e.value.resources,catalog:v("loading",r)}});try{let n=await this.#a.catalog(t.signal);if(t.signal.aborted||this.#l)return;let a=this.#c?.config?.entry_id,i=typeof a=="string"?a:null,s=n.find(d=>d.entryId===this.#o?.entryKey)||n.find(d=>d.entryId===i)||n[0]||null,l=this.#e.value.resources.entry;if(s&&l&&F(s)===F(l)&&Ge(s)===Ge(l)&&je(s)===je(l)&&s.mapRevision<l.mapRevision&&(s={...s,mapRevision:l.mapRevision}),this.#e.patch({managedLock:s?oo(s):!1,resources:{...this.#e.value.resources,catalog:v(n.length?"ready":"empty",n),entry:s}}),!s){this.#m("no-loaded-robot");return}if(this.#e.value.selection.floorId!=="current"&&!e)return;let c=ro(s);if(!e&&c===this.#h){let d=this.#e.value,u=s.mapFloorCoherent&&s.mapSessionVerified,h=s.health==="problem"||s.health==="limited";this.#e.patch({coherence:u?h?"degraded":"current":"verifying",map:{...d.map,available:u&&d.resources.scene.value!==null,complete:s.mapComplete&&!s.mapTruncated,floorCoherent:s.mapFloorCoherent,sessionVerified:s.mapSessionVerified,exactPose:u?d.map.exactPose:!1},floor:{...d.floor,classifiedCount:Math.max(1,s.historyFloorCount)}});return}this.#h=c,this.#E(s)}catch(n){if(H(n))return;this.#e.patch({coherence:this.#e.value.resources.scene.value?"degraded":"unavailable",resources:{...this.#e.value.resources,catalog:v("error",r,ae(n,"catalog-unavailable"))}})}finally{this.#p("catalog",t),this.#f=!1}}#E(e){let t=this.#e.value,r=t.resources.entry,n=!!(r&&F(r)===F(e)),a=e.mapFloorCoherent&&e.mapSessionVerified;this.#b(n?["catalog","plans","areas","plan-mutation","area-mutation"]:["catalog"]);let i=n?t.resources.scene.value:null,s=t.resources.pose.value,l=n&&a&&e.mapSessionKey!==null&&s?.position&&s.mapSessionKey===e.mapSessionKey?s:null,c=this.#t.begin(e.entryId,Ge(e),je(e),e.mapRevision),d=e.health==="problem"||e.health==="limited",u=this.#e.value;this.#e.patch({managedLock:oo(e),generation:c.generation,coherence:a?d?"degraded":"current":"verifying",dataMode:"live",resources:{...u.resources,entry:e,scene:v(a?"loading":"idle",i),pose:v(a?"loading":"idle",l),history:v("loading",u.resources.history.value),plans:n?u.resources.plans:v("idle",null),areas:n?u.resources.areas:v("idle",null)},map:{available:a&&i!==null,complete:e.mapComplete&&!e.mapTruncated,floorCoherent:e.mapFloorCoherent,sessionVerified:e.mapSessionVerified,exactPose:a&&l!==null},floor:{classifiedCount:Math.max(1,e.historyFloorCount),displayName:e.selectedFloorOrdinal?`Floor ${e.selectedFloorOrdinal}`:"Current floor",readOnly:!1},selection:{...u.selection,entryId:e.entryId,floorId:"current",historyId:null,roomIds:n?u.selection.roomIds:[],planId:n?u.selection.planId:null,areaId:n?u.selection.areaId:null}}),this.#A(e,c),a&&(this.#C(e,c),this.#S(e,c))}async#C(e,t){let r=this.#i("scene");try{let n=await this.#a.scene(e.sceneUrl,e.mapRevision,e.mapFloorCoherent,"live",r.signal);if(!this.#t.accepts(t)||n.revision!==t.revision||!n.floorCoherent||!n.scene)return;let a=this.#e.value;if(this.#e.patch({resources:{...a.resources,scene:v("ready",n.scene)},map:{...a.map,available:!0},notice:a.notice?.text===no?null:a.notice}),e.deltaUrl){let i=++this.#k;this.#M(e,t,n.scene,i)}}catch(n){if(H(n)||!this.#t.accepts(t))return;if(n instanceof O&&n.code==="request-timeout"){let l=this.#e.value;this.#e.patch({resources:{...l.resources,scene:v("loading",l.resources.scene.value,"scene-building")}}),window.setTimeout(()=>{this.#l||!this.#t.accepts(t)||this.#e.value.selection.floorId!=="current"||this.#C(e,t)},250);return}let a=this.#e.value,i=a.resources.pose.value,s=a.resources.scene.value!==null&&e.mapSessionKey!==null&&i?.position!==null&&i?.mapSessionKey===e.mapSessionKey;this.#e.patch({coherence:"degraded",resources:{...a.resources,scene:v("error",a.resources.scene.value,ae(n,"scene-unavailable"))},map:{...a.map,available:a.resources.scene.value!==null,exactPose:s}})}finally{this.#p("scene",r)}}async#M(e,t,r,n){if(!e.deltaUrl||typeof DecompressionStream!="function")return;let a=e.deltaUrl,i=e,s=t,l=r;try{for(;!this.#l&&n===this.#k&&this.#t.accepts(s)&&this.#e.value.selection.floorId==="current";){let c=this.#i("delta");try{let d=await this.#a.sceneDelta(a,l,i.mapFloorCoherent,c.signal);if(c.signal.aborted||this.#l||n!==this.#k||!this.#t.accepts(s))return;if(!d.floorCoherent){this.#e.patch({coherence:"verifying",map:{...this.#e.value.map,available:!1,floorCoherent:!1,exactPose:!1},resources:{...this.#e.value.resources,pose:v("idle",null)}}),this.#h="",this.refreshCatalog(!0);return}if(d.notModified||!d.scene){await new Promise(p=>window.setTimeout(p,100));continue}let u=this.#t.advance(s,d.revision);if(!u)return;s=u,l=d.scene,i={...i,mapRevision:d.revision},this.#h=ro(i);let h=this.#e.value;this.#e.patch({resources:{...h.resources,entry:i,scene:v("ready",l)},map:{...h.map,available:!0,floorCoherent:!0}}),this.#S(i,s)}finally{this.#p("delta",c)}}}catch(c){if(H(c)||this.#l||n!==this.#k||!this.#t.accepts(s))return;this.#e.patch({coherence:"degraded",notice:{tone:"warning",text:no}}),this.#h="",this.refreshCatalog(!0)}}async#A(e,t){let r=this.#i("history");try{let n=await this.#a.history(e.historyUrl,r.signal);if(!this.#t.accepts(t)||n.entryId!==e.entryId)return;let a=n.floors.find(i=>i.active)||n.floors[0];if(!a)return;this.#e.patch({resources:{...this.#e.value.resources,history:v("ready",n)},floor:{...this.#e.value.floor,classifiedCount:n.floors.length,displayName:Wt(a,1)}})}catch(n){if(H(n)||!this.#t.accepts(t))return;this.#e.patch({resources:{...this.#e.value.resources,history:v("error",null,ae(n,"history-unavailable"))}})}finally{this.#p("history",r)}}async refreshPose(){let e=this.#e.value.resources.entry,t=this.#t.current();!e||!t||this.#e.value.selection.floorId!=="current"||!e.mapFloorCoherent||!e.mapSessionVerified||await this.#S(e,t)}async#S(e,t){if(this.#g){this.#_=!0;return}this.#g=!0;let r=this.#i("pose");try{let n=await this.#a.pose(e.poseUrl,r.signal),a=this.#t.current(),i=this.#e.value.resources.entry;if(!a||!ln(t,a)||!i||!n.floorCoherent)return;if(n.mapSessionKey===null||n.mapSessionKey!==i.mapSessionKey){this.#e.patch({map:{...this.#e.value.map,exactPose:!1}}),this.#h="",this.refreshCatalog(!0);return}let s=this.#e.value,l=s.resources.pose.value,c=!!(s.map.exactPose&&l?.position&&l.mapSessionKey===i.mapSessionKey);if(n.position===null&&c){this.#e.patch({resources:{...s.resources,pose:v("ready",l)}});return}this.#e.patch({resources:{...s.resources,pose:v("ready",n)},map:{...s.map,exactPose:n.position!==null}})}catch(n){if(H(n)||!this.#t.accepts(t))return;let a=this.#e.value,i=a.resources.pose.value,s=!!(a.map.exactPose&&i?.position&&i.mapSessionKey===a.resources.entry?.mapSessionKey);this.#e.patch({resources:{...a.resources,pose:v("error",s?i:null,ae(n,"pose-unavailable"))},map:{...a.map,exactPose:s}})}finally{if(this.#p("pose",r),this.#g=!1,this.#_&&!this.#l){this.#_=!1;let n=this.#e.value.resources.entry,a=this.#t.current();n&&a&&this.#S(n,a)}}}async selectFloor(e){let t=this.#e.value.resources.history.value,r=this.#e.value.resources.entry;if(!t||!r)return;let n=t.floors.find(s=>s.id===e);if(!n)return;if(n.active){this.#h="",this.#e.dispatch({type:"set-floor",floorId:"current"}),await this.refreshCatalog(!0);return}let a=n.snapshots.at(-1);this.#b(["catalog"]);let i=this.#t.begin(r.entryId,n.id,a?.id||n.id,a?.revision||0);this.#e.patch({generation:i.generation,coherence:"current",dataMode:"history",floor:{classifiedCount:t.floors.length,displayName:Wt(n,t.floors.indexOf(n)+1),readOnly:!0},selection:{...this.#e.value.selection,floorId:n.id,historyId:a?.id||null},resources:{...this.#e.value.resources,scene:v(a?"loading":"empty",null),pose:v("idle",null)},map:{available:!1,complete:!0,floorCoherent:!0,sessionVerified:!0,exactPose:!1}}),a&&await this.#I(a,i)}async selectHistory(e){let t=this.#e.value.resources.history.value,r=this.#e.value.resources.entry;if(!t||!r)return;if(!e){await this.selectFloor("current");return}let n=t.floors.find(s=>s.snapshots.some(l=>l.id===e)),a=n?.snapshots.find(s=>s.id===e);if(!n||!a)return;let i=this.#t.begin(r.entryId,n.id,a.id,a.revision);this.#b(["catalog"]),this.#e.patch({generation:i.generation,dataMode:"history",floor:{classifiedCount:t.floors.length,displayName:Wt(n,t.floors.indexOf(n)+1),readOnly:!0},selection:{...this.#e.value.selection,floorId:n.id,historyId:a.id},resources:{...this.#e.value.resources,scene:v("loading",null),pose:v("idle",null)},map:{...this.#e.value.map,available:!1,exactPose:!1}}),await this.#I(a,i)}async#I(e,t){let r=this.#i("history-scene");try{let n=await this.#a.scene(e.sceneUrl,e.revision,!0,"history",r.signal);if(!this.#t.accepts(t)||!n.scene)return;this.#e.patch({resources:{...this.#e.value.resources,scene:v("ready",n.scene)},map:{...this.#e.value.map,available:!0,exactPose:!1}})}catch(n){if(H(n)||!this.#t.accepts(t))return;this.#e.patch({resources:{...this.#e.value.resources,scene:v("error",null,ae(n,"history-scene-unavailable"))}})}finally{this.#p("history-scene",r)}}async openWorkflow(e){this.#e.dispatch({type:"open-workflow",workflow:e}),(e==="plan"||e==="rooms")&&await this.loadPlans(),(e==="draw"||e==="areaReview")&&await this.loadAreas()}async loadPlans(){let e=this.#e.value.resources.entry;if(!e||!this.#t.current()||!it(this.#e.value))return;let t=F(e),r=this.#i("plans");this.#e.patch({resources:{...this.#e.value.resources,plans:v("loading",null)}});try{let n=await this.#a.plans(e.plansUrl,r.signal),a=this.#e.value.resources.entry;if(!a||F(a)!==t)return;this.#e.patch({resources:{...this.#e.value.resources,plans:v("ready",n)},selection:{...this.#e.value.selection,planId:n.selectedPlan||n.plans[0]?.id||null}}),this.selectPlan(n.selectedPlan||n.plans[0]?.id||null)}catch(n){let a=this.#e.value.resources.entry;if(H(n)||!a||F(a)!==t)return;this.#e.patch({resources:{...this.#e.value.resources,plans:v("error",null,ae(n,"plans-unavailable"))}})}finally{this.#p("plans",r)}}selectPlan(e){let t=this.#e.value.resources.plans.value?.plans.find(r=>r.id===e);this.#e.patch({selection:{...this.#e.value.selection,planId:e},planDraft:t?this.#R(t):{...this.#e.value.planDraft,id:null,name:"",rooms:[],dirty:!1}})}#R(e){return{id:e.id,name:e.name,enabled:e.enabled,runBehavior:e.runBehavior,rooms:(e.roomOrder.length?e.roomOrder.flatMap(t=>{let r=e.rooms.find(n=>n.roomId===t);return r?[r]:[]}):e.rooms).map(t=>({...t})),returnToBase:e.returnToBase,finishCurrentRoom:e.finishCurrentRoom,finishCurrentRoomThreshold:e.finishCurrentRoomThreshold,dirty:!1}}async loadAreas(){let e=this.#e.value.resources.entry;if(!e||!this.#t.current()||!it(this.#e.value))return;let t=F(e),r=this.#i("areas");this.#e.patch({resources:{...this.#e.value.resources,areas:v("loading",null)}});try{let n=await this.#a.areas(e.areasUrl,r.signal),a=this.#e.value.resources.entry;if(!a||F(a)!==t||n.sceneUrl!==a.sceneUrl)return;this.#e.patch({resources:{...this.#e.value.resources,areas:v("ready",n)}}),this.selectArea(n.areas[0]?.id||null)}catch(n){let a=this.#e.value.resources.entry;if(H(n)||!a||F(a)!==t)return;this.#e.patch({resources:{...this.#e.value.resources,areas:v("error",null,ae(n,"areas-unavailable"))}})}finally{this.#p("areas",r)}}selectArea(e){let t=this.#e.value.resources.areas.value?.areas.find(n=>n.id===e),r=this.#e.value;this.#e.patch({selection:{...r.selection,areaId:e},areaDraft:t?this.#L(t):{id:null,name:"",cleaningMode:"vacuum",coverageSetting:"standard",status:"new",canRebind:!1,dirty:!1},draw:{...r.draw,circles:t?.circles||[],undo:[],redo:[],dirty:!1,strokeCount:0}})}#L(e){return{id:e.id,name:e.name,cleaningMode:e.cleaningMode,coverageSetting:e.coverageSetting,status:e.status,canRebind:e.canRebind,dirty:!1}}async saveArea(){let e=this.#e.value,t=e.resources.entry,r=e.areaDraft;if(!t||!q(e)||!r.name.trim()||!e.draw.circles.length)return;let n=this.#i("area-mutation");this.#e.patch({command:"pending",notice:{tone:"info",text:"Saving area\u2026"}});try{let a=await this.#a.saveArea(t.areasUrl,{areaId:r.id,name:r.name.trim(),circles:e.draw.circles,cleaningMode:r.cleaningMode,coverageSetting:r.coverageSetting},n.signal);this.#e.patch({command:"idle",notice:{tone:"success",text:"Area saved"}}),await this.loadAreas(),this.selectArea(a)}catch(a){if(H(a))return;this.#e.patch({command:"failed",notice:{tone:"error",text:"Area could not be saved"}})}finally{this.#p("area-mutation",n)}}async deleteArea(){let e=this.#e.value.resources.entry,t=this.#e.value.selection.areaId;if(!e||!t||!q(this.#e.value))return;let r=this.#i("area-mutation");try{await this.#a.deleteArea(e.areasUrl,t,r.signal),this.#e.patch({notice:{tone:"success",text:"Area deleted"}}),await this.loadAreas()}catch(n){H(n)||this.#e.patch({notice:{tone:"error",text:"Area could not be deleted"}})}finally{this.#p("area-mutation",r)}}async savePlan(){let e=this.#e.value,t=e.planDraft,r=e.resources.plans.value;if(!r||!t.name.trim()||!t.rooms.length||!q(e))return;let n=t.rooms;await this.#P("save_plan",{...t.id?{plan_id:t.id}:{},name:t.name.trim(),enabled:t.enabled,run_behavior:t.runBehavior,rooms:n.map(a=>({room:r.rooms.find(i=>i.roomId===a.roomId)?.name,cleaning_mode:a.cleaningMode,coverage_setting:a.coverageSetting})).filter(a=>a.room),return_to_base:t.returnToBase,finish_current_room:t.finishCurrentRoom,finish_current_room_threshold:t.finishCurrentRoomThreshold,select:!t.id||r.selectedPlan===t.id},"Plan saved","Plan could not be saved"),await this.loadPlans()}async deletePlan(){let e=this.#e.value.selection.planId;e&&(await this.#P("delete_plan",{plan:e},"Plan deleted","Plan could not be deleted"),await this.loadPlans())}async executeAction(e){switch(e){case"stop":this.#e.value.resources.entry?.activePlan||this.#e.value.resources.entry?.runnerLocked?await this.#v("matic_robot","stop_intelligent_cleaning",{}):await this.#v("vacuum","return_to_base",{});return;case"resume":await this.#v("vacuum","start",{});return;case"run-plan":{let t=this.#e.value.selection.planId||this.#e.value.resources.plans.value?.selectedPlan;t&&await this.#v("matic_robot","run_selected_plan",{plan:t});return}case"clean-rooms":{let t=this.#e.value.resources.plans.value,n=this.#e.value.selection.roomSettings.map(a=>({room:t?.rooms.find(i=>i.roomId===a.roomId)?.name,cleaning_mode:a.cleaningMode,coverage_setting:a.coverageSetting})).filter(a=>a.room);n.length&&await this.#v("matic_robot","clean_room_sequence",{rooms:n,return_to_base:!0});return}case"run-area":{let t=this.#e.value.selection.areaId;t&&await this.#v("matic_robot","clean_area",{area:t});return}case"review-area":this.#e.dispatch({type:"open-workflow",workflow:"areaReview"});return;case"save-area":await this.saveArea();return;case"save-plan":await this.savePlan();return;case"delete-plan":await this.deletePlan();return;case"delete-area":await this.deleteArea();return}}async#P(e,t,r,n){let a=this.#o?.vacuumEntityId;if(!(!a||!q(this.#e.value)||this.#e.value.command==="pending")){this.#e.patch({command:"pending",notice:{tone:"info",text:"Saving\u2026"}});try{await this.#a.service("matic_robot",e,t,a),this.#e.patch({command:"idle",notice:{tone:"success",text:r}})}catch{this.#e.patch({command:"failed",notice:{tone:"error",text:n}})}}}async#v(e,t,r){let n=this.#e.value,a=this.#o?.vacuumEntityId,s=(t==="stop_intelligent_cleaning"||e==="vacuum"&&t==="return_to_base")&&n.command==="idle"&&(n.activity==="cleaning"||n.activity==="paused"||n.activity==="returning"||n.activity==="recharging");if(!(!a||!s&&!se(n))){this.#e.patch({command:"pending",notice:null});try{await this.#a.service(e,t,r,a),this.#e.patch({command:"settling"}),this.#s!==null&&window.clearTimeout(this.#s),this.#s=window.setTimeout(()=>{this.#s=null,this.#e.value.command==="settling"&&this.#e.patch({command:"idle"})},15e3)}catch{this.#e.patch({command:"failed",notice:{tone:"error",text:"The robot did not accept that action"}})}}}updateDraftCircles(e,t=!0,r){this.#e.dispatch({type:"set-draft-circles",circles:e,record:t,...r?{previous:r}:{}}),this.#e.dispatch({type:"patch-area-draft",patch:{dirty:!0}})}dispose(){this.#l||(this.#l=!0,this.#x(),this.#b(),this.#s!==null&&window.clearTimeout(this.#s),this.#s=null,this.#r.dispose(),this.#a.dispose(),this.#t.invalidate())}};var io=o=>(o.workflow==="none"?0:1)+(o.fullMap?1:0)+(o.precisionOpen?1:0)+(o.dialog?1:0),dn=o=>{if(!o||typeof o!="object")return null;let e=o.maticMapLayer;if(!e||typeof e!="object")return null;let t=e.owner,r=e.depth;return typeof t=="string"&&Number.isInteger(r)&&Number(r)>=0?{owner:t,depth:Number(r)}:null},Qe=class{#e;#t=`matic-map-${crypto.randomUUID?.()||Math.random().toString(36).slice(2)}`;#a=0;#r=null;#n=!1;constructor(e){this.#e=e}start(){this.#r||(this.#a=io(this.#e.value),this.#r=this.#e.subscribe(e=>this.#o(e)),window.addEventListener("popstate",this.#c))}#o(e){let t=io(e);if(this.#n){this.#n=!1,this.#a=t;return}if(t>this.#a)for(let r=this.#a+1;r<=t;r+=1){let n=history.state&&typeof history.state=="object"?history.state:{};history.pushState({...n,maticMapLayer:{owner:this.#t,depth:r}},"",window.location.href)}this.#a=t}#c=()=>{this.#a<1||(this.#n=!0,this.#e.dispatch({type:"dismiss-top-layer"}))};dismissTop(){if(this.#a<1)return!1;let e=dn(history.state);return e?.owner===this.#t&&e.depth===this.#a?history.back():this.#e.dispatch({type:"dismiss-top-layer"}),!0}dispose(){this.#r?.(),this.#r=null,window.removeEventListener("popstate",this.#c),this.#a=0}};var so=U(re),Ut=class extends x{constructor(){super(...arguments);this.narrow=!1;this._workspace=M();this._classic=!1;this.entryOverride=null;this.#e=new Ne;this.#t=new le(this._workspace);this.#a=null;this.#r=null;this.#n=null;this.#o=null;this.#c=null;this.#d=""}static{this.styles=L`
...
`}static{this.properties={hass:{attribute:!1},narrow:{type:Boolean},route:{attribute:!1},panel:{attribute:!1},_workspace:{state:!0},_classic:{state:!0},entryOverride:{state:!0}}}#e;#t;#a;#r;#n;#o;#c;#d;connectedCallback(){super.connectedCallback(),this._classic=to()==="v3",this.#r=this.#t.subscribe(t=>{this._workspace=t,this.#f(t)}),this._classic||this.#u()}disconnectedCallback(){this.#r?.(),this.#r=null,this.#s(),super.disconnectedCallback()}#u(){this.#o||(this.#n=new Ke(()=>this.hass),this.#o=new Ze(this.#t,this.#n),this.#c=new Qe(this.#t),this.#c.start(),this.#a&&this.#o.sync(this.#a,this.panel))}#s(){this.#c?.dispose(),this.#c=null,this.#o?.dispose(),this.#o=null,this.#n=null}#f(t){if(!this.#o)return;let r={version:4,view:t.view,appearance:t.appearance,labels:t.labelsVisible,quality:t.quality,cameras:t.cameras},n=JSON.stringify(r);n!==this.#d&&(this.#d=n,this.#o.schedulePreferences(r))}willUpdate(t){if(t.has("hass")||t.has("panel")||t.has("entryOverride")){let r=this.#e.project(this.hass,this.panel,this.entryOverride);if(r!==this.#a){this.#a=r;let n=r.host.connected?r.host.robotCount===0?"unavailable":r.host.administrator?"verifying":"blocked":"degraded";this.#t.replace({...this.#t.value,coherence:n,activity:r.activity,batteryPercent:r.batteryPercent,host:r.host,fullMap:r.host.administrator&&r.host.robotCount>0&&this.#t.value.fullMap,robotLabel:r.robotLabel,robots:r.robots,locale:r.language})}this._classic||this.#o?.sync(r,this.panel)}t.has("narrow")&&this.#t.value.narrowHint!==this.narrow&&this.#t.dispatch({type:"set-narrow-hint",value:this.narrow})}#g(t){if(!ze(t.detail))return;t.stopPropagation();let r=t.detail;if(r.type==="dismiss-top-layer"||r.type==="exit-full-map"){this.#c?.dismissTop()||this.#t.dispatch(r);return}if(r.type==="open-workflow"&&r.workflow!=="none"){this.#o?.openWorkflow(r.workflow);return}if(r.type==="set-floor"){this.#o?.selectFloor(r.floorId);return}if(r.type==="select-entry"){if(!this._workspace.robots.some(n=>n.entryId===r.entryId))return;this.entryOverride=r.entryId;return}if(r.type==="set-history"){this.#o?.selectHistory(r.historyId);return}if(r.type==="select-plan"){this.#o?.selectPlan(r.planId);return}if(r.type==="select-area"){this.#o?.selectArea(r.areaId);return}this.#t.dispatch(r)}#_(t){if(t.stopPropagation(),typeof t.detail?.id=="string"){if(t.detail.id==="use-classic"){Nt("v3")&&(this.#s(),this._classic=!0);return}this.#o?.executeAction(t.detail.id),this.dispatchEvent(new CustomEvent("matic-map-v4-action-requested",{detail:{id:t.detail.id},bubbles:!0,composed:!0}))}}#h(){Nt("v4")&&(this._classic=!1,this.#u(),this.requestUpdate())}updated(){if(!this._classic)return;let t=this.renderRoot.querySelector("matic-map-panel-v0-3-1");t&&(t.hass=this.hass,t.narrow=this.narrow,t.route=this.route,t.panel=this.panel)}getWorkspaceSnapshot(){return this.#t.value}render(){return this._classic?f`
      ...
      ></${so}>
    `}};customElements.get($t)||customElements.define($t,Ut);export{De as CoherenceMachine,Te as DRAW_BRUSH_MAX_METERS,be as DRAW_BRUSH_MIN_METERS,dt as GALLERY_SCENARIOS,Ne as HassAdapter,at as MAP_PIXELS_PER_METER_AT_100,Le as MAP_ZOOM_MAX,j as MAP_ZOOM_MIN,$t as MATIC_MAP_PANEL_TAG,Ut as MaticMapPanelV4,Tt as MaticMapStudioGalleryV4,le as WorkspaceStore,pn as brushCursorPixels,q as canEditCoordinates,it as canReadFloorResources,Xt as canShowExactPose,ce as canShowLiveMap,se as canStartMotion,mn as commandState,ct as createGalleryState,M as initialWorkspaceState,ze as isWorkspaceIntent,Yt as mapScale,ho as normalizeBrush,qt as normalizeZoom,po as reduceWorkspace,Kt as selectPausedSecondaryAction,Vt as selectPrimaryAction};
