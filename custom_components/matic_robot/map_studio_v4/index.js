var k1=100,v5=1e3,m1=.2,P1=2.5,g2=64,v1=L=>!L||typeof L!="object"?!1:typeof L.type=="string";var t1=(L,C)=>{let H=L.workflow==="plan"&&L.planDraft.dirty,V=(L.workflow==="draw"||L.workflow==="areaReview")&&(L.draw.dirty||L.areaDraft.dirty);if(!H&&!V)return!1;switch(C.type){case"open-workflow":return H?C.workflow!=="plan":C.workflow!=="draw"&&C.workflow!=="areaReview";case"select-plan":return H;case"select-area":return V;case"set-floor":return C.floorId!==L.selection.floorId;case"select-entry":return C.entryId!==L.selection.entryId;case"set-history":return!0;case"dismiss-top-layer":return!L.dialog&&!L.precisionOpen&&!L.fullMap;default:return!1}};var c1=()=>({status:"idle",value:null,problem:null}),u5=new Set(["rooms","plan","draw","areaReview"]),L7=L=>L.dataMode==="history"||L.floor.readOnly,K=(L,C,H)=>Math.max(C,Math.min(H,L)),e7=L=>({yaw:K(Number.isFinite(L.yaw)?L.yaw:0,-Math.PI,Math.PI),pitch:K(Number.isFinite(L.pitch)?L.pitch:Math.PI/2-.018,.18,Math.PI/2-.018),zoom:K(Number.isFinite(L.zoom)?L.zoom:1,.01,100),targetX:K(Number.isFinite(L.targetX)?L.targetX:0,-1e4,1e4),targetZ:K(Number.isFinite(L.targetZ)?L.targetZ:0,-1e4,1e4)}),c5=L=>Math.round(K(Number.isFinite(L)?L:100,100,1e3)),r7=L=>Math.round(K(Number.isFinite(L)?L:.2,.2,2.5)*100)/100,y=()=>({owner:null,draftFloorOrdinal:null,generation:0,coherence:"verifying",dataMode:"live",activity:"unknown",workflow:"none",command:"idle",fullMap:!1,precisionOpen:!1,dialog:null,narrowHint:!1,view:"top",appearance:"photo",labelsVisible:!0,quality:"auto",cameras:{},managedLock:!1,batteryPercent:null,floor:{classifiedCount:1,displayName:"Current floor",readOnly:!1},map:{available:!1,complete:!1,floorCoherent:!1,sessionVerified:!1,exactPose:!1},host:{connected:!0,administrator:!0,robotConnected:!1,robotCount:0},draw:{zoomPercent:100,zoomOriginX:50,zoomOriginY:50,brushMeters:.6,tool:"paint",dirty:!1,strokeCount:0,circles:[],undo:[],redo:[]},resources:{catalog:c1(),entry:null,scene:c1(),pose:c1(),history:c1(),plans:c1(),areas:c1()},selection:{entryId:null,floorId:"current",historyId:null,roomIds:[],roomSettings:[],cleaningMode:"vacuum",coverageSetting:"standard",planId:null,areaId:null},planDraft:{id:null,name:"",enabled:!0,runBehavior:"intelligent",rooms:[],returnToBase:!0,finishCurrentRoom:!1,finishCurrentRoomThreshold:50,dirty:!1},areaDraft:{id:null,name:"",cleaningMode:"vacuum",coverageSetting:"standard",status:"new",canRebind:!1,dirty:!1},notice:null,robotLabel:"Matic robot",robots:[],locale:"en"}),W=(L,C)=>({...L,draw:{...L.draw,...C}}),t7=(L,C)=>{switch(C.type){case"set-host":return{...L,host:C.host,fullMap:C.host.administrator&&C.host.robotCount>0?L.fullMap:!1};case"set-operational-state":return{...L,coherence:C.coherence,activity:C.activity,command:C.command??L.command};case"set-narrow-hint":return{...L,narrowHint:C.value};case"set-view":return{...L,view:C.view};case"set-appearance":return{...L,appearance:C.appearance};case"set-quality":return{...L,quality:C.quality};case"set-camera":return{...L,cameras:{...L.cameras,[C.view]:e7(C.camera)}};case"toggle-labels":return{...L,labelsVisible:!L.labelsVisible};case"open-workflow":return L7(L)&&u5.has(C.workflow)?L:{...L,workflow:C.workflow,precisionOpen:!1};case"enter-full-map":return L.host.administrator&&L.host.robotCount>0&&L.map.available?{...L,fullMap:!0}:L;case"exit-full-map":return{...L,fullMap:!1,precisionOpen:!1};case"set-precision-open":return{...L,precisionOpen:C.value};case"set-zoom":return W(L,{zoomPercent:c5(C.value),...C.originX===void 0?{}:{zoomOriginX:K(C.originX,0,100)},...C.originY===void 0?{}:{zoomOriginY:K(C.originY,0,100)}});case"step-zoom":return W(L,{zoomPercent:c5(L.draw.zoomPercent*C.factor)});case"fit-map":return W(L,{zoomPercent:100,zoomOriginX:50,zoomOriginY:50});case"set-brush":return W(L,{brushMeters:r7(C.value)});case"set-draw-tool":return W(L,{tool:C.tool});case"mark-draft":{let H=Math.max(0,L.draw.strokeCount+C.strokeDelta);return W(L,{dirty:H>0,strokeCount:H})}case"undo-draft":{let H=L.draw.undo.at(-1);return H?W(L,{circles:H,undo:L.draw.undo.slice(0,-1),redo:[...L.draw.redo,L.draw.circles],dirty:!0,strokeCount:Math.max(0,L.draw.strokeCount-1)}):L}case"clear-draft":return L.draw.circles.length?W(L,{circles:[],undo:[...L.draw.undo.slice(-99),L.draw.circles],redo:[],dirty:!0,strokeCount:L.draw.strokeCount+1}):L;case"redo-draft":{let H=L.draw.redo.at(-1);return H?W(L,{circles:H,undo:[...L.draw.undo,L.draw.circles],redo:L.draw.redo.slice(0,-1),dirty:!0,strokeCount:L.draw.strokeCount+1}):L}case"set-draft-circles":{let H=C.circles.slice(0,512).map(e=>({...e})),V=C.record!==!1;return W(L,{circles:H,undo:V?[...L.draw.undo.slice(-99),C.previous??L.draw.circles]:L.draw.undo,redo:V?[]:L.draw.redo,dirty:!0,strokeCount:V?L.draw.strokeCount+1:L.draw.strokeCount})}case"discard-draft":return L.workflow==="plan"?{...L,planDraft:y().planDraft,selection:{...L.selection,planId:null},dialog:null,workflow:"none",precisionOpen:!1}:{...W(L,{dirty:!1,strokeCount:0,circles:[],undo:[],redo:[]}),areaDraft:y().areaDraft,selection:{...L.selection,areaId:null},dialog:null,workflow:"none",precisionOpen:!1};case"toggle-room":{let H=L.selection.roomIds.includes(C.roomId);return{...L,selection:{...L.selection,roomIds:H?L.selection.roomIds.filter(V=>V!==C.roomId):[...L.selection.roomIds,C.roomId],roomSettings:H?L.selection.roomSettings.filter(V=>V.roomId!==C.roomId):[...L.selection.roomSettings,{roomId:C.roomId,cleaningMode:"vacuum",coverageSetting:"standard"}]}}}case"patch-room-settings":return{...L,selection:{...L.selection,roomSettings:L.selection.roomSettings.map(H=>H.roomId===C.roomId?{...H,...C.cleaningMode?{cleaningMode:C.cleaningMode}:{},...C.coverageSetting?{coverageSetting:C.coverageSetting}:{}}:H)}};case"set-floor":return{...L,dataMode:C.floorId==="current"?"live":"history",selection:{...L.selection,floorId:C.floorId,historyId:null}};case"select-entry":return L;case"set-history":return{...L,dataMode:C.historyId?"history":"live",selection:{...L.selection,historyId:C.historyId}};case"select-plan":return{...L,selection:{...L.selection,planId:C.planId}};case"select-area":return{...L,selection:{...L.selection,areaId:C.areaId},workflow:C.workflow==="areaReview"?"areaReview":L.workflow};case"patch-plan-draft":return{...L,planDraft:{...L.planDraft,...C.patch,dirty:C.patch.dirty??!0}};case"patch-area-draft":return{...L,areaDraft:{...L.areaDraft,...C.patch,dirty:C.patch.dirty??!0}};case"set-notice":return{...L,notice:C.notice};case"open-dialog":return{...L,dialog:C.dialog};case"dismiss-top-layer":return t1(L,C)?{...L,dialog:"discardDraft"}:L.dialog?{...L,dialog:null}:L.precisionOpen?{...L,precisionOpen:!1}:L.fullMap?{...L,fullMap:!1}:L.workflow!=="none"?{...L,workflow:"none",precisionOpen:!1}:L;case"return-live":return{...L,dataMode:"live",workflow:"none",floor:{...L.floor,readOnly:!1}}}},x1=class{#C=new Set;#H;constructor(C=y()){this.#H=C}get value(){return this.#H}dispatch(C){let H=t7(this.#H,C);if(H===this.#H)return H;this.#H=H;for(let V of this.#C)V(H);return H}replace(C){if(C!==this.#H){this.#H=C;for(let H of this.#C)H(C)}}patch(C){let H={...this.#H,...C};return this.replace(H),H}subscribe(C){return this.#C.add(C),C(this.#H),()=>this.#C.delete(C)}},G1=class{#C=null;#H=0;get generation(){return this.#H}begin(C,H,V,e){return this.#H+=1,this.#C={entryKey:C,generation:this.#H,floorKey:H,missionKey:V,revision:e},this.#C}current(){return this.#C}accepts(C){let H=this.#C;return!!(H&&C.entryKey===H.entryKey&&C.generation===H.generation&&C.floorKey===H.floorKey&&C.missionKey===H.missionKey&&C.revision===H.revision)}advance(C,H){return!this.accepts(C)||!Number.isSafeInteger(H)||H<=C.revision?null:(this.#C={...C,revision:H},this.#C)}invalidate(){return this.#H+=1,this.#C=null,this.#H}},Z1=L=>L.dataMode==="live"&&L.map.available&&(L.coherence==="current"||L.coherence==="degraded")&&L.host.administrator,x5=L=>Z1(L)&&(L.coherence==="current"||L.coherence==="degraded")&&L.map.floorCoherent&&L.map.sessionVerified&&L.map.exactPose&&L.host.connected&&L.host.robotConnected,U=L=>Z1(L)&&L.coherence==="current"&&L.map.complete&&L.map.floorCoherent&&L.map.sessionVerified&&L.host.connected&&L.host.robotConnected&&!L.floor.readOnly,y2=L=>Z1(L)&&L.coherence==="current"&&L.map.floorCoherent&&L.map.sessionVerified&&L.host.connected&&L.host.robotConnected&&!L.floor.readOnly,u1=L=>U(L)&&!L.managedLock&&L.command==="idle"&&(L.activity==="idle"||L.activity==="docked"),b2=L=>U(L)&&L.command==="idle"&&L.activity==="paused"&&L.resources.entry?.stopSettlePending!==!0,N=(L,C,H,V,e)=>({id:L,label:C,labelKey:V,kind:"neutral",enabled:!1,reason:H,reasonKey:e}),O2=L=>L.command==="starting"||L.activity==="cleaning"||L.activity==="paused"||L.activity==="returning"||L.activity==="recharging"||L.resources.entry?.runnerLocked===!0||L.resources.entry?.activePlan===!0||L.resources.entry?.nativeSessionActive===!0,w2=L=>L.host.connected&&L.host.administrator&&L.host.robotConnected&&(L.command==="idle"||L.command==="failed"||L.command==="starting")&&O2(L),Z5=L=>{let C=w2(L);return{id:"stop",label:"Stop",labelKey:"v4_action_stop",kind:"danger",enabled:C,...C?{}:{reason:"The robot is already stopping.",reasonKey:"v4_reason_stop"}}},k2=L=>{if(L.dataMode==="history")return{id:"return-live",label:"Return to the live map",labelKey:"v4_action_return_live",kind:"primary",enabled:!0};if(L.floor.readOnly&&u5.has(L.workflow))return N("read-only","Live map required","Return to the live map to edit cleaning tasks.","v4_action_live_map_required","v4_reason_live_map_required");if(L.activity!=="paused"&&O2(L))return Z5(L);let C=L.workflow==="plan"&&L.planDraft.dirty||(L.workflow==="draw"||L.workflow==="areaReview")&&(L.draw.dirty||L.areaDraft.dirty);if(L.command==="failed"&&!C)return{id:"recheck-status",label:"Check robot status",labelKey:"v4_recheck_robot",kind:"primary",enabled:L.host.connected&&L.host.administrator&&L.host.robotConnected,reason:"Refresh the robot state before trying the action again.",reasonKey:"v4_recheck_robot_reason"};if(L.activity==="stopping"||L.command==="settling")return N("stopping","Stopping","Waiting for the robot to settle.","v4_action_stopping","v4_reason_stopping");if(L.command==="starting")return N("starting","Starting","Waiting for the robot to begin.","v4_action_starting","v4_reason_starting");if(L.activity==="paused")return{id:"resume",label:"Resume cleaning",labelKey:"v4_action_resume",kind:"primary",enabled:b2(L)};if(!L.host.connected)return N("reconnecting","Reconnecting","Home Assistant is offline.","v4_action_reconnecting","v4_reason_reconnecting");if(!L.host.administrator)return N("administrator","Administrator access required","Ask a Home Assistant administrator to open this map.","v4_action_administrator","v4_reason_administrator");if(L.host.robotCount===0)return N("setup","Set up a Matic robot","Add the Matic integration to get started.","v4_set_up_robot","v4_setup_reason");if(L.activity==="problem")return N("problem","Check the robot","Resolve the robot's problem before starting another task.","v4_check_robot","v4_problem_reason");if(!L.host.robotConnected)return N("robot-offline","Robot offline","Reconnect the robot to start cleaning.","v4_action_robot_offline","v4_reason_robot_offline");if(L.coherence==="unavailable"||L.coherence==="blocked")return N("map-unavailable","Map unavailable","Open Map diagnostics to check why the map is unavailable.","v4_map_unavailable","v4_map_unavailable_reason");if(L.coherence!=="current")return N("locating","Finding the map","Waiting for the robot to confirm which floor it is on.","v4_action_locating","v4_reason_locating");if((L.workflow==="plan"||L.workflow==="rooms")&&L.resources.plans.status!=="ready"){let H=L.resources.plans.status==="error"||L.resources.plans.status==="empty";return N("plans-unavailable",H?"Rooms and plans unavailable":"Loading rooms and plans\u2026","Load the room and plan list before choosing a cleaning action.",H?"v4_plans_unavailable_action":"v4_loading_rooms_plans","v4_plans_required_reason")}if(L.workflow==="draw"){let H={reason:"Draw the area first.",reasonKey:"v4_reason_save_area_draw"};return L.fullMap||L.narrowHint?{id:"review-area",label:"Name and save",labelKey:"v4_action_review_area",kind:"primary",enabled:L.draw.dirty,...L.draw.dirty?{}:H}:{id:"save-area",label:"Save area",labelKey:"v4_action_save_area",kind:"primary",enabled:L.draw.dirty&&U(L),...L.draw.dirty?{}:H}}if(L.workflow==="rooms"){let H=L.selection.roomIds.length,V=u1(L)&&H>0;return{id:"clean-rooms",label:H?`Clean ${H} room${H===1?"":"s"}`:"Clean selected rooms",...H?{}:{labelKey:"v4_action_clean_rooms"},kind:"primary",enabled:V,...V?{}:H?{reason:"Waiting for the current map to be verified.",reasonKey:"v4_reason_clean_rooms_verification"}:{reason:"Select at least one room to clean.",reasonKey:"v4_reason_clean_rooms_empty"}}}if(L.workflow==="plan"){if(L.planDraft.dirty||!L.planDraft.id){let H=U(L)&&L.planDraft.name.trim().length>0&&L.planDraft.rooms.length>0;return{id:"save-plan",label:"Save plan",labelKey:"v4_action_save_plan",kind:"primary",enabled:H,...H?{}:{reason:"Add a plan name and at least one room.",reasonKey:"v4_reason_save_plan"}}}return{id:"run-plan",label:"Run this plan",labelKey:"v4_action_run_plan",kind:"primary",enabled:u1(L)&&L.planDraft.enabled,...u1(L)?L.planDraft.enabled?{}:{reason:"This plan is paused. Enable it to run.",reasonKey:"v4_reason_run_plan_paused"}:{reason:"Waiting for the current map to be verified.",reasonKey:"v4_reason_run_plan"}}}if(L.workflow==="areaReview"){if(L.areaDraft.dirty||L.draw.dirty||!L.areaDraft.id||L.areaDraft.canRebind){let V=U(L)&&L.areaDraft.name.trim().length>0&&L.draw.circles.length>0;return{id:"save-area",label:L.areaDraft.canRebind?"Confirm on this map":"Save area",labelKey:L.areaDraft.canRebind?"v4_action_save_area_confirm":"v4_action_save_area",kind:"primary",enabled:V,...V?{}:{reason:"Add an area name and at least one mark.",reasonKey:"v4_reason_save_area_details"}}}let H=L.areaDraft.status==="current";return{id:"run-area",label:"Clean this area",labelKey:"v4_action_run_area",kind:"primary",enabled:H&&u1(L),...H?{}:{reason:"Confirm this outline on the current map first.",reasonKey:"v4_reason_run_area"}}}return{id:"choose-cleaning",label:"Choose what to clean",labelKey:"v4_action_choose_cleaning",kind:"neutral",enabled:!1,reason:"Choose rooms, a plan, or a custom area.",reasonKey:"v4_reason_choose_cleaning"}},h5=L=>O2(L)&&k2(L).id!=="stop"?Z5(L):null,p4=L=>L.draw.brushMeters*64*(L.draw.zoomPercent/100),M7=[2,1,.5,.25,.1,.05],S5=L=>{let C=64*(L.draw.zoomPercent/100),H=M7.reduce((V,e)=>{let r=Math.abs(e*C-64),t=Math.abs(V*C-64);return r<t?e:V});return{meters:H,pixels:H*C,label:H<1?`${Math.round(H*100)} cm`:`${H} m`}},m4=(L,C)=>({...L,command:C});var f5="a".repeat(64),h1=[{roomId:"room-a",name:"Kitchen",boundary:[[.5,.5],[4,.5],[4,3],[.5,3]]},{roomId:"room-b",name:"Living room",boundary:[[4.2,.5],[8.5,.5],[8.5,3.4],[4.2,3.4]]},{roomId:"room-c",name:"Office",boundary:[[.5,3.2],[3.8,3.2],[3.8,6.5],[.5,6.5]]},{roomId:"room-d",name:"Bedroom",boundary:[[4,3.6],[8.5,3.6],[8.5,6.5],[4,6.5]]}],g5=()=>{let L=[180,140],C={meters_per_cell:.05,origin_cells:[0,0],span_cells:L,sample_step:1,rooms:h1.map(i=>{let a=i.boundary.map(([A,l])=>[A/.05,l/.05]),n=[a.reduce((A,[l])=>A+l,0)/a.length,a.reduce((A,[,l])=>A+l,0)/a.length];return{name:i.name,boundary:a,boundary_closed:!0,center:n}})},H=new TextEncoder().encode(JSON.stringify(C)),V=[];for(let i=10;i<130;i+=2)for(let a=10;a<170;a+=2){let n=a<80?i<65?0:2:i<72?1:3,A=[[185,219,224],[201,211,233],[210,226,194],[232,207,207]][n]||[190,205,215];V.push([a,i,0,...A])}let e=500;for(let i=0;i<e;i+=1){let a=i%4,n=i*7%120,A=a<2?a===0?10:168:10+n,l=a>=2?a===2?10:128:10+n;V.push([A,l,10+i%18,104,122,137])}let r=V.length-e,t=new ArrayBuffer(24+H.byteLength+V.length*8),o=new DataView(t);new Uint8Array(t,0,8).set(new TextEncoder().encode("MATIC3D\0")),o.setUint16(8,1,!0),o.setUint16(10,8,!0),o.setUint32(12,H.byteLength,!0),o.setUint32(16,r,!0),o.setUint32(20,e,!0),new Uint8Array(t,24,H.byteLength).set(H);let M=new DataView(t,24+H.byteLength);return V.forEach(([i=0,a=0,n=0,A=0,l=0,d=0],p)=>{let Z=p*8;M.setUint16(Z,i,!0),M.setUint16(Z+2,a,!0),M.setUint8(Z+4,n),M.setUint8(Z+5,A),M.setUint8(Z+6,l),M.setUint8(Z+7,d)}),{buffer:t,pointOffset:24+H.byteLength,floorCount:r,surfaceCount:e,total:V.length,revision:7,etag:'"synthetic-scene"',source:"live",metadata:{metersPerCell:.05,origin:[0,0],span:L,sampleStep:1,rooms:C.rooms.map((i,a)=>({id:h1[a]?.roomId||`room-${a}`,name:i.name,boundary:i.boundary,center:i.center}))}}},Q1=()=>({entryId:"synthetic-entry",sceneUrl:"/api/matic_robot/slam_scene/synthetic",deltaUrl:"/api/matic_robot/slam_delta/synthetic",poseUrl:"/api/matic_robot/slam_pose/synthetic",historyUrl:"/api/matic_robot/slam_history/synthetic",areasUrl:"/api/matic_robot/areas/synthetic",plansUrl:"/api/matic_robot/plans/synthetic",mapRevision:7,mapFloorCoherent:!0,mapSessionVerified:!0,mapSessionKey:f5,mapBlockReason:null,runnerLocked:!1,stopSettlePending:!1,activePlan:!1,nativeReconciliationPending:!1,nativeSessionActive:!1,mapComplete:!0,mapTruncated:!1,selectedFloorOrdinal:1,mapFloorOrdinal:1,historyCount:2,historyFloorCount:2,health:"ready",streamFailures:0,bootstrapState:"complete",bootstrapPhotoSeen:!0,bootstrapStructureSeen:!0,bootstrapFailures:0}),P2=()=>({rooms:h1.map(({roomId:L,name:C})=>({roomId:L,name:C})),selectedPlan:"daily",plans:[{id:"daily",name:"Daily clean",enabled:!0,runBehavior:"intelligent",rooms:h1.slice(0,3).map(({roomId:L})=>({roomId:L,cleaningMode:"vacuum",coverageSetting:"standard"})),roomOrder:h1.slice(0,3).map(({roomId:L})=>L),returnToBase:!0,finishCurrentRoom:!1,finishCurrentRoomThreshold:50}]}),_2=()=>({sceneUrl:Q1().sceneUrl,rooms:h1.map(L=>({...L,boundary:L.boundary.map(C=>[...C])})),areas:[{id:"entryway",name:"Entryway",circles:[{x:1.5,y:1.4,radius:.3},{x:1.9,y:1.6,radius:.3}],cleaningMode:"vacuum",coverageSetting:"standard",status:"current",canRebind:!1}]}),y5=()=>({entryId:"synthetic-entry",liveAvailable:!0,floors:[{id:"current",active:!0,readOnly:!1,liveAvailable:!0,label:"House",ordinal:null,snapshots:[{id:"current-old",createdAt:"2026-08-29T14:00:00Z",revision:6,pointCount:5300,sceneUrl:"/synthetic-history-current-old"},{id:"current-new",createdAt:"2026-08-29T16:12:00Z",revision:7,pointCount:5300,sceneUrl:"/synthetic-history-current-new"}]},{id:"saved-1",active:!1,readOnly:!0,liveAvailable:!1,label:"Shed",ordinal:2,snapshots:[{id:"saved-one",createdAt:"2026-08-28T11:30:00Z",revision:3,pointCount:3100,sceneUrl:"/synthetic-history-saved"}]},{id:"saved-2",active:!1,readOnly:!0,liveAvailable:!1,label:"Annex",ordinal:3,snapshots:[]}]}),b5=()=>({position:[4.475,3.475],source:"latest_pose",revision:7,poseRevision:4,floorCoherent:!0,mapSessionKey:f5,freshness:"live"});var o7=()=>({...y(),coherence:"current",activity:"docked",batteryPercent:92,robots:[{entryId:"synthetic-entry",label:"Matic robot"}],host:{connected:!0,administrator:!0,robotConnected:!0,robotCount:1},floor:{classifiedCount:2,displayName:"House",readOnly:!1},map:{available:!0,complete:!0,floorCoherent:!0,sessionVerified:!0,exactPose:!0},resources:{catalog:{status:"ready",value:[Q1()],problem:null},entry:Q1(),scene:{status:"ready",value:g5(),problem:null},pose:{status:"ready",value:b5(),problem:null},history:{status:"ready",value:y5(),problem:null},plans:{status:"ready",value:P2(),problem:null},areas:{status:"ready",value:_2(),problem:null}},selection:{...y().selection,entryId:"synthetic-entry",planId:"daily"},planDraft:{...y().planDraft,id:"daily",name:"Daily clean",rooms:P2().plans[0]?.rooms||[]}}),T2=L=>{let C=o7();switch(L){case"ready":return C;case"cleaning":return{...C,activity:"cleaning"};case"paused":return{...C,activity:"paused"};case"returning":return{...C,activity:"returning"};case"recharging":return{...C,activity:"recharging",batteryPercent:18};case"rooms":return{...C,workflow:"rooms"};case"draw":return{...C,workflow:"draw",areaDraft:{...C.areaDraft,id:"entryway",name:"Entryway",status:"current"},selection:{...C.selection,areaId:"entryway"},draw:{...C.draw,dirty:!0,strokeCount:3,circles:_2().areas[0]?.circles||[]}};case"history":return{...C,dataMode:"history",workflow:"history",floor:{...C.floor,readOnly:!0},map:{...C.map,exactPose:!1},selection:{...C.selection,floorId:"saved-1",historyId:"saved-one"}};case"transition":return{...C,coherence:"verifying",activity:"unknown",map:{available:!1,complete:!1,floorCoherent:!1,sessionVerified:!1,exactPose:!1}};case"problem":return{...C,activity:"problem",coherence:"blocked"};case"ha-offline":return{...C,coherence:"degraded",host:{...C.host,connected:!1},map:{...C.map,exactPose:!1}};case"robot-offline":return{...C,coherence:"degraded",host:{...C.host,robotConnected:!1},map:{...C.map,exactPose:!1}};case"access":return{...C,coherence:"blocked",host:{...C.host,administrator:!1},map:{...C.map,available:!1,exactPose:!1}};case"empty":return{...C,coherence:"unavailable",host:{...C.host,robotConnected:!1,robotCount:0},map:{...C.map,available:!1,exactPose:!1}};case"unsupported":return{...C,coherence:"blocked",map:{...C.map,available:!1,exactPose:!1}};case"multi-robot":return{...C,host:{...C.host,robotCount:2},robots:[{entryId:"synthetic-entry",label:"Matic robot"},{entryId:"synthetic-entry-two",label:"Second robot"}]}}},B2=["ready","cleaning","paused","returning","recharging","rooms","draw","history","transition","problem","ha-offline","robot-offline","access","empty","unsupported","multi-robot"];var i7=(L,C)=>{if(C?.recharge_and_resume===!0&&C?.charging===!0)return"recharging";switch(L){case"cleaning":return"cleaning";case"paused":return"paused";case"returning":return"returning";case"docked":return"docked";case"idle":return"idle";case"error":return"problem";default:return"unknown"}},a7=L=>typeof L!="number"||!Number.isFinite(L)?null:Math.round(Math.max(0,Math.min(100,L))),n7=L=>{let C=L.attributes?.matic_entry_id;return typeof C=="string"&&C.length>0?C:null},A7=L=>String(L||"local-user").replaceAll(/[^a-zA-Z0-9_-]/g,"").slice(0,128)||"local-user",O5=L=>{if(typeof L!="string")return"Matic robot";let C=L.trim();return C&&Array.from(C).length<=128&&!/[\u0000-\u001f\u007f]/u.test(C)?C:"Matic robot"},K1=class{#C="";#H=null;project(C,H,V=null){let e=C?.states??{},r=H?.config?.entry_id,t=typeof r=="string"?r:null,o=null,M=null,i=null,a=new Map;for(let[f,g]of Object.entries(e)){let P=n7(g);if(!P||!f.startsWith("vacuum."))continue;a.set(P,{entryId:P,label:O5(g.attributes?.friendly_name)});let z1=V||t;(!o||z1&&P===z1)&&(o=g,M=f,i=P)}let n={connected:C?.connected!==!1,administrator:C?.user?.is_admin===!0,robotConnected:o!==null&&o.state!=="unavailable"&&o.state!=="unknown",robotCount:a.size},A=o?i7(o.state,o.attributes):"unknown",l=a7(o?.attributes?.battery_level),d=C?.selectedLanguage||C?.language||"en",p=A7(C?.user?.id),Z=O5(o?.attributes?.friendly_name),u=[...a.values()].sort((f,g)=>f.label.localeCompare(g.label,d,{sensitivity:"base"})),S=[n.connected,n.administrator,n.robotConnected,n.robotCount,A,l??"none",d,p,M??"none",i??"none",Z,u.map(f=>`${f.entryId}:${f.label}`).join(",")].join("|");return S===this.#C&&this.#H?this.#H:(this.#C=S,this.#H={host:n,activity:A,batteryPercent:l,language:d,userKey:p,vacuumEntityId:M,entryKey:i,robotLabel:Z,robots:u},this.#H)}};var q1=globalThis,X1=q1.ShadowRoot&&(q1.ShadyCSS===void 0||q1.ShadyCSS.nativeShadow)&&"adoptedStyleSheets"in Document.prototype&&"replace"in CSSStyleSheet.prototype,R2=Symbol(),w5=new WeakMap,_1=class{constructor(C,H,V){if(this._$cssResult$=!0,V!==R2)throw Error("CSSResult is not constructable. Use `unsafeCSS` or `css` instead.");this.cssText=C,this.t=H}get styleSheet(){let C=this.o,H=this.t;if(X1&&C===void 0){let V=H!==void 0&&H.length===1;V&&(C=w5.get(H)),C===void 0&&((this.o=C=new CSSStyleSheet).replaceSync(this.cssText),V&&w5.set(H,C))}return C}toString(){return this.cssText}},k5=L=>new _1(typeof L=="string"?L:L+"",void 0,R2),O=(L,...C)=>{let H=L.length===1?L[0]:C.reduce((V,e,r)=>V+(t=>{if(t._$cssResult$===!0)return t.cssText;if(typeof t=="number")return t;throw Error("Value passed to 'css' function must be a 'css' function result: "+t+". Use 'unsafeCSS' to pass non-literal values, but take care to ensure page security.")})(e)+L[r+1],L[0]);return new _1(H,L,R2)},P5=(L,C)=>{if(X1)L.adoptedStyleSheets=C.map(H=>H instanceof CSSStyleSheet?H:H.styleSheet);else for(let H of C){let V=document.createElement("style"),e=q1.litNonce;e!==void 0&&V.setAttribute("nonce",e),V.textContent=H.cssText,L.appendChild(V)}},F2=X1?L=>L:L=>L instanceof CSSStyleSheet?(C=>{let H="";for(let V of C.cssRules)H+=V.cssText;return k5(H)})(L):L;var{is:l7,defineProperty:s7,getOwnPropertyDescriptor:d7,getOwnPropertyNames:p7,getOwnPropertySymbols:m7,getPrototypeOf:v7}=Object,Y1=globalThis,_5=Y1.trustedTypes,c7=_5?_5.emptyScript:"",u7=Y1.reactiveElementPolyfillSupport,T1=(L,C)=>L,E2={toAttribute(L,C){switch(C){case Boolean:L=L?c7:null;break;case Object:case Array:L=L==null?L:JSON.stringify(L)}return L},fromAttribute(L,C){let H=L;switch(C){case Boolean:H=L!==null;break;case Number:H=L===null?null:Number(L);break;case Object:case Array:try{H=JSON.parse(L)}catch{H=null}}return H}},B5=(L,C)=>!l7(L,C),T5={attribute:!0,type:String,converter:E2,reflect:!1,useDefault:!1,hasChanged:B5};Symbol.metadata??=Symbol("metadata"),Y1.litPropertyMetadata??=new WeakMap;var q=class extends HTMLElement{static addInitializer(C){this._$Ei(),(this.l??=[]).push(C)}static get observedAttributes(){return this.finalize(),this._$Eh&&[...this._$Eh.keys()]}static createProperty(C,H=T5){if(H.state&&(H.attribute=!1),this._$Ei(),this.prototype.hasOwnProperty(C)&&((H=Object.create(H)).wrapped=!0),this.elementProperties.set(C,H),!H.noAccessor){let V=Symbol(),e=this.getPropertyDescriptor(C,V,H);e!==void 0&&s7(this.prototype,C,e)}}static getPropertyDescriptor(C,H,V){let{get:e,set:r}=d7(this.prototype,C)??{get(){return this[H]},set(t){this[H]=t}};return{get:e,set(t){let o=e?.call(this);r?.call(this,t),this.requestUpdate(C,o,V)},configurable:!0,enumerable:!0}}static getPropertyOptions(C){return this.elementProperties.get(C)??T5}static _$Ei(){if(this.hasOwnProperty(T1("elementProperties")))return;let C=v7(this);C.finalize(),C.l!==void 0&&(this.l=[...C.l]),this.elementProperties=new Map(C.elementProperties)}static finalize(){if(this.hasOwnProperty(T1("finalized")))return;if(this.finalized=!0,this._$Ei(),this.hasOwnProperty(T1("properties"))){let H=this.properties,V=[...p7(H),...m7(H)];for(let e of V)this.createProperty(e,H[e])}let C=this[Symbol.metadata];if(C!==null){let H=litPropertyMetadata.get(C);if(H!==void 0)for(let[V,e]of H)this.elementProperties.set(V,e)}this._$Eh=new Map;for(let[H,V]of this.elementProperties){let e=this._$Eu(H,V);e!==void 0&&this._$Eh.set(e,H)}this.elementStyles=this.finalizeStyles(this.styles)}static finalizeStyles(C){let H=[];if(Array.isArray(C)){let V=new Set(C.flat(1/0).reverse());for(let e of V)H.unshift(F2(e))}else C!==void 0&&H.push(F2(C));return H}static _$Eu(C,H){let V=H.attribute;return V===!1?void 0:typeof V=="string"?V:typeof C=="string"?C.toLowerCase():void 0}constructor(){super(),this._$Ep=void 0,this.isUpdatePending=!1,this.hasUpdated=!1,this._$Em=null,this._$Ev()}_$Ev(){this._$ES=new Promise(C=>this.enableUpdating=C),this._$AL=new Map,this._$E_(),this.requestUpdate(),this.constructor.l?.forEach(C=>C(this))}addController(C){(this._$EO??=new Set).add(C),this.renderRoot!==void 0&&this.isConnected&&C.hostConnected?.()}removeController(C){this._$EO?.delete(C)}_$E_(){let C=new Map,H=this.constructor.elementProperties;for(let V of H.keys())this.hasOwnProperty(V)&&(C.set(V,this[V]),delete this[V]);C.size>0&&(this._$Ep=C)}createRenderRoot(){let C=this.shadowRoot??this.attachShadow(this.constructor.shadowRootOptions);return P5(C,this.constructor.elementStyles),C}connectedCallback(){this.renderRoot??=this.createRenderRoot(),this.enableUpdating(!0),this._$EO?.forEach(C=>C.hostConnected?.())}enableUpdating(C){}disconnectedCallback(){this._$EO?.forEach(C=>C.hostDisconnected?.())}attributeChangedCallback(C,H,V){this._$AK(C,V)}_$ET(C,H){let V=this.constructor.elementProperties.get(C),e=this.constructor._$Eu(C,V);if(e!==void 0&&V.reflect===!0){let r=(V.converter?.toAttribute!==void 0?V.converter:E2).toAttribute(H,V.type);this._$Em=C,r==null?this.removeAttribute(e):this.setAttribute(e,r),this._$Em=null}}_$AK(C,H){let V=this.constructor,e=V._$Eh.get(C);if(e!==void 0&&this._$Em!==e){let r=V.getPropertyOptions(e),t=typeof r.converter=="function"?{fromAttribute:r.converter}:r.converter?.fromAttribute!==void 0?r.converter:E2;this._$Em=e;let o=t.fromAttribute(H,r.type);this[e]=o??this._$Ej?.get(e)??o,this._$Em=null}}requestUpdate(C,H,V,e=!1,r){if(C!==void 0){let t=this.constructor;if(e===!1&&(r=this[C]),V??=t.getPropertyOptions(C),!((V.hasChanged??B5)(r,H)||V.useDefault&&V.reflect&&r===this._$Ej?.get(C)&&!this.hasAttribute(t._$Eu(C,V))))return;this.C(C,H,V)}this.isUpdatePending===!1&&(this._$ES=this._$EP())}C(C,H,{useDefault:V,reflect:e,wrapped:r},t){V&&!(this._$Ej??=new Map).has(C)&&(this._$Ej.set(C,t??H??this[C]),r!==!0||t!==void 0)||(this._$AL.has(C)||(this.hasUpdated||V||(H=void 0),this._$AL.set(C,H)),e===!0&&this._$Em!==C&&(this._$Eq??=new Set).add(C))}async _$EP(){this.isUpdatePending=!0;try{await this._$ES}catch(H){Promise.reject(H)}let C=this.scheduleUpdate();return C!=null&&await C,!this.isUpdatePending}scheduleUpdate(){return this.performUpdate()}performUpdate(){if(!this.isUpdatePending)return;if(!this.hasUpdated){if(this.renderRoot??=this.createRenderRoot(),this._$Ep){for(let[e,r]of this._$Ep)this[e]=r;this._$Ep=void 0}let V=this.constructor.elementProperties;if(V.size>0)for(let[e,r]of V){let{wrapped:t}=r,o=this[e];t!==!0||this._$AL.has(e)||o===void 0||this.C(e,void 0,r,o)}}let C=!1,H=this._$AL;try{C=this.shouldUpdate(H),C?(this.willUpdate(H),this._$EO?.forEach(V=>V.hostUpdate?.()),this.update(H)):this._$EM()}catch(V){throw C=!1,this._$EM(),V}C&&this._$AE(H)}willUpdate(C){}_$AE(C){this._$EO?.forEach(H=>H.hostUpdated?.()),this.hasUpdated||(this.hasUpdated=!0,this.firstUpdated(C)),this.updated(C)}_$EM(){this._$AL=new Map,this.isUpdatePending=!1}get updateComplete(){return this.getUpdateComplete()}getUpdateComplete(){return this._$ES}shouldUpdate(C){return!0}update(C){this._$Eq&&=this._$Eq.forEach(H=>this._$ET(H,this[H])),this._$EM()}updated(C){}firstUpdated(C){}};q.elementStyles=[],q.shadowRootOptions={mode:"open"},q[T1("elementProperties")]=new Map,q[T1("finalized")]=new Map,u7?.({ReactiveElement:q}),(Y1.reactiveElementVersions??=[]).push("2.1.2");var $2=globalThis,R5=L=>L,j1=$2.trustedTypes,F5=j1?j1.createPolicy("lit-html",{createHTML:L=>L}):void 0,I2="$lit$",X=`lit$${Math.random().toFixed(9).slice(2)}$`,W2="?"+X,x7=`<${W2}>`,i1=document,R1=()=>i1.createComment(""),F1=L=>L===null||typeof L!="object"&&typeof L!="function",N2=Array.isArray,N5=L=>N2(L)||typeof L?.[Symbol.iterator]=="function",D2=`[ \t\n\f\r]`,B1=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,E5=/-->/g,D5=/>/g,M1=RegExp(`>|${D2}(?:([^\\s"'>=/]+)(${D2}*=${D2}*(?:[^ \t\n\f\r"'\`<>=]|("|')|))|$)`,"g"),$5=/'/g,I5=/"/g,z5=/^(?:script|style|textarea|title)$/i,z2=L=>(C,...H)=>({_$litType$:L,strings:C,values:H}),m=z2(1),U5=z2(2),G5=z2(3),Y=Symbol.for("lit-noChange"),s=Symbol.for("lit-nothing"),W5=new WeakMap,o1=i1.createTreeWalker(i1,129);function Q5(L,C){if(!N2(L)||!L.hasOwnProperty("raw"))throw Error("invalid template strings array");return F5!==void 0?F5.createHTML(C):C}var K5=(L,C)=>{let H=L.length-1,V=[],e,r=C===2?"<svg>":C===3?"<math>":"",t=B1;for(let o=0;o<H;o++){let M=L[o],i,a,n=-1,A=0;for(;A<M.length&&(t.lastIndex=A,a=t.exec(M),a!==null);)A=t.lastIndex,t===B1?a[1]==="!--"?t=E5:a[1]!==void 0?t=D5:a[2]!==void 0?(z5.test(a[2])&&(e=RegExp("</"+a[2],"g")),t=M1):a[3]!==void 0&&(t=M1):t===M1?a[0]===">"?(t=e??B1,n=-1):a[1]===void 0?n=-2:(n=t.lastIndex-a[2].length,i=a[1],t=a[3]===void 0?M1:a[3]==='"'?I5:$5):t===I5||t===$5?t=M1:t===E5||t===D5?t=B1:(t=M1,e=void 0);let l=t===M1&&L[o+1].startsWith("/>")?" ":"";r+=t===B1?M+x7:n>=0?(V.push(i),M.slice(0,n)+I2+M.slice(n)+X+l):M+X+(n===-2?o:l)}return[Q5(L,r+(L[H]||"<?>")+(C===2?"</svg>":C===3?"</math>":"")),V]},E1=class L{constructor({strings:C,_$litType$:H},V){let e;this.parts=[];let r=0,t=0,o=C.length-1,M=this.parts,[i,a]=K5(C,H);if(this.el=L.createElement(i,V),o1.currentNode=this.el.content,H===2||H===3){let n=this.el.content.firstChild;n.replaceWith(...n.childNodes)}for(;(e=o1.nextNode())!==null&&M.length<o;){if(e.nodeType===1){if(e.hasAttributes())for(let n of e.getAttributeNames())if(n.endsWith(I2)){let A=a[t++],l=e.getAttribute(n).split(X),d=/([.?@])?(.*)/.exec(A);M.push({type:1,index:r,name:d[2],strings:l,ctor:d[1]==="."?C2:d[1]==="?"?H2:d[1]==="@"?V2:n1}),e.removeAttribute(n)}else n.startsWith(X)&&(M.push({type:6,index:r}),e.removeAttribute(n));if(z5.test(e.tagName)){let n=e.textContent.split(X),A=n.length-1;if(A>0){e.textContent=j1?j1.emptyScript:"";for(let l=0;l<A;l++)e.append(n[l],R1()),o1.nextNode(),M.push({type:2,index:++r});e.append(n[A],R1())}}}else if(e.nodeType===8)if(e.data===W2)M.push({type:2,index:r});else{let n=-1;for(;(n=e.data.indexOf(X,n+1))!==-1;)M.push({type:7,index:r}),n+=X.length-1}r++}}static createElement(C,H){let V=i1.createElement("template");return V.innerHTML=C,V}};function a1(L,C,H=L,V){if(C===Y)return C;let e=V!==void 0?H._$Co?.[V]:H._$Cl,r=F1(C)?void 0:C._$litDirective$;return e?.constructor!==r&&(e?._$AO?.(!1),r===void 0?e=void 0:(e=new r(L),e._$AT(L,H,V)),V!==void 0?(H._$Co??=[])[V]=e:H._$Cl=e),e!==void 0&&(C=a1(L,e._$AS(L,C.values),e,V)),C}var J1=class{constructor(C,H){this._$AV=[],this._$AN=void 0,this._$AD=C,this._$AM=H}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}u(C){let{el:{content:H},parts:V}=this._$AD,e=(C?.creationScope??i1).importNode(H,!0);o1.currentNode=e;let r=o1.nextNode(),t=0,o=0,M=V[0];for(;M!==void 0;){if(t===M.index){let i;M.type===2?i=new S1(r,r.nextSibling,this,C):M.type===1?i=new M.ctor(r,M.name,M.strings,this,C):M.type===6&&(i=new L2(r,this,C)),this._$AV.push(i),M=V[++o]}t!==M?.index&&(r=o1.nextNode(),t++)}return o1.currentNode=i1,e}p(C){let H=0;for(let V of this._$AV)V!==void 0&&(V.strings!==void 0?(V._$AI(C,V,H),H+=V.strings.length-2):V._$AI(C[H])),H++}},S1=class L{get _$AU(){return this._$AM?._$AU??this._$Cv}constructor(C,H,V,e){this.type=2,this._$AH=s,this._$AN=void 0,this._$AA=C,this._$AB=H,this._$AM=V,this.options=e,this._$Cv=e?.isConnected??!0}get parentNode(){let C=this._$AA.parentNode,H=this._$AM;return H!==void 0&&C?.nodeType===11&&(C=H.parentNode),C}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(C,H=this){C=a1(this,C,H),F1(C)?C===s||C==null||C===""?(this._$AH!==s&&this._$AR(),this._$AH=s):C!==this._$AH&&C!==Y&&this._(C):C._$litType$!==void 0?this.$(C):C.nodeType!==void 0?this.T(C):N5(C)?this.k(C):this._(C)}O(C){return this._$AA.parentNode.insertBefore(C,this._$AB)}T(C){this._$AH!==C&&(this._$AR(),this._$AH=this.O(C))}_(C){this._$AH!==s&&F1(this._$AH)?this._$AA.nextSibling.data=C:this.T(i1.createTextNode(C)),this._$AH=C}$(C){let{values:H,_$litType$:V}=C,e=typeof V=="number"?this._$AC(C):(V.el===void 0&&(V.el=E1.createElement(Q5(V.h,V.h[0]),this.options)),V);if(this._$AH?._$AD===e)this._$AH.p(H);else{let r=new J1(e,this),t=r.u(this.options);r.p(H),this.T(t),this._$AH=r}}_$AC(C){let H=W5.get(C.strings);return H===void 0&&W5.set(C.strings,H=new E1(C)),H}k(C){N2(this._$AH)||(this._$AH=[],this._$AR());let H=this._$AH,V,e=0;for(let r of C)e===H.length?H.push(V=new L(this.O(R1()),this.O(R1()),this,this.options)):V=H[e],V._$AI(r),e++;e<H.length&&(this._$AR(V&&V._$AB.nextSibling,e),H.length=e)}_$AR(C=this._$AA.nextSibling,H){for(this._$AP?.(!1,!0,H);C!==this._$AB;){let V=R5(C).nextSibling;R5(C).remove(),C=V}}setConnected(C){this._$AM===void 0&&(this._$Cv=C,this._$AP?.(C))}},n1=class{get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}constructor(C,H,V,e,r){this.type=1,this._$AH=s,this._$AN=void 0,this.element=C,this.name=H,this._$AM=e,this.options=r,V.length>2||V[0]!==""||V[1]!==""?(this._$AH=Array(V.length-1).fill(new String),this.strings=V):this._$AH=s}_$AI(C,H=this,V,e){let r=this.strings,t=!1;if(r===void 0)C=a1(this,C,H,0),t=!F1(C)||C!==this._$AH&&C!==Y,t&&(this._$AH=C);else{let o=C,M,i;for(C=r[0],M=0;M<r.length-1;M++)i=a1(this,o[V+M],H,M),i===Y&&(i=this._$AH[M]),t||=!F1(i)||i!==this._$AH[M],i===s?C=s:C!==s&&(C+=(i??"")+r[M+1]),this._$AH[M]=i}t&&!e&&this.j(C)}j(C){C===s?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,C??"")}},C2=class extends n1{constructor(){super(...arguments),this.type=3}j(C){this.element[this.name]=C===s?void 0:C}},H2=class extends n1{constructor(){super(...arguments),this.type=4}j(C){this.element.toggleAttribute(this.name,!!C&&C!==s)}},V2=class extends n1{constructor(C,H,V,e,r){super(C,H,V,e,r),this.type=5}_$AI(C,H=this){if((C=a1(this,C,H,0)??s)===Y)return;let V=this._$AH,e=C===s&&V!==s||C.capture!==V.capture||C.once!==V.once||C.passive!==V.passive,r=C!==s&&(V===s||e);e&&this.element.removeEventListener(this.name,this,V),r&&this.element.addEventListener(this.name,this,C),this._$AH=C}handleEvent(C){typeof this._$AH=="function"?this._$AH.call(this.options?.host??this.element,C):this._$AH.handleEvent(C)}},L2=class{constructor(C,H,V){this.element=C,this.type=6,this._$AN=void 0,this._$AM=H,this.options=V}get _$AU(){return this._$AM._$AU}_$AI(C){a1(this,C)}},q5={M:I2,P:X,A:W2,C:1,L:K5,R:J1,D:N5,V:a1,I:S1,H:n1,N:H2,U:V2,B:C2,F:L2},Z7=$2.litHtmlPolyfillSupport;Z7?.(E1,S1),($2.litHtmlVersions??=[]).push("3.3.3");var X5=(L,C,H)=>{let V=H?.renderBefore??C,e=V._$litPart$;if(e===void 0){let r=H?.renderBefore??null;V._$litPart$=e=new S1(C.insertBefore(R1(),r),r,void 0,H??{})}return e._$AI(L),e};var U2=globalThis,w=class extends q{constructor(){super(...arguments),this.renderOptions={host:this},this._$Do=void 0}createRenderRoot(){let C=super.createRenderRoot();return this.renderOptions.renderBefore??=C.firstChild,C}update(C){let H=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(C),this._$Do=X5(H,this.renderRoot,this.renderOptions)}connectedCallback(){super.connectedCallback(),this._$Do?.setConnected(!0)}disconnectedCallback(){super.disconnectedCallback(),this._$Do?.setConnected(!1)}render(){return Y}};w._$litElement$=!0,w.finalized=!0,U2.litElementHydrateSupport?.({LitElement:w});var h7=U2.litElementPolyfillSupport;h7?.({LitElement:w});(U2.litElementVersions??=[]).push("4.2.2");var D=O`
:host {
...
`;var j5=Symbol.for(""),S7=L=>{if(L?.r===j5)return L?._$litStatic$},C1=L=>({_$litStatic$:L,r:j5});var Y5=new Map,G2=L=>(C,...H)=>{let V=H.length,e,r,t=[],o=[],M,i=0,a=!1;for(;i<V;){for(M=C[i];i<V&&(r=H[i],(e=S7(r))!==void 0);)M+=e+C[++i],a=!0;i!==V&&o.push(r),t.push(M),i++}if(i===V&&t.push(C[V]),a){let n=t.join("$$lit$$");(C=Y5.get(n))===void 0&&(t.raw=t,Y5.set(n,C=t)),H=o}return L(C,...H)},x=G2(m),N4=G2(U5),z4=G2(G5);var J5=import.meta.url.match(/\/matic_robot\/[^/]+-([a-f0-9]{12})\/map-studio-v4(?:\/|$)/u)?.[1]??"dev",D1=J5==="dev"?"":`-${J5}`,A1=`matic-map-canvas-v4${D1}`,$1=`matic-precision-controls-v4${D1}`,l1=`matic-map-workflow-v4${D1}`,s1=`matic-map-shell-v4${D1}`,Q2=`matic-map-panel-v0-4-0${D1}`;var H1=O`
.ms-btn, .ms-row {
  ...
  `]}#C;#H;#V;#M;#t;#L;#a;#i;#A;#e(H,V,e){return T(this.localize,H,V,e)}connectedCallback(){super.connectedCallback(),this.#n()}firstUpdated(){let H=this.renderRoot.querySelector(".map-root"),V=this.renderRoot.querySelector(".scene-canvas"),e=this.renderRoot.querySelector(".overlay-canvas");!H||!V||!e||(this.#H=new o2(V,e,{onCamera:(r,t,o)=>{this.#o({type:"set-camera",view:this.state.workflow==="draw"?"top":this.state.view,camera:{yaw:r.yaw,pitch:r.pitch,zoom:t/100,targetX:r.targetX,targetZ:r.targetZ}}),this.state.workflow==="draw"&&t!==this.state.draw.zoomPercent&&this.#o({type:"set-zoom",value:t,...o?{originX:o.xPercent,originY:o.yPercent}:{}})},onRoom:r=>this.#o({type:"toggle-room",roomId:r}),onProblem:()=>this.#d("renderer-problem")}),this.#V=new M2(H,this.#H,{state:()=>this.state,onCircles:(r,t,o)=>this.#o({type:"set-draft-circles",circles:r,record:t,...o?{previous:o}:{}}),onRoom:r=>this.#o({type:"toggle-room",roomId:r})}),this.#H.setState(this.state),this.#f())}disconnectedCallback(){this.#c(),this.#V?.dispose(),this.#V=null,this.#H?.dispose(),this.#H=null,super.disconnectedCallback()}updated(H){this.#t&&(this.#t=!1,this.renderRoot.querySelector(".navigation-help button")?.focus()),H.has("state")&&this.#H?.setState(this.state)}#x(){let H=this.renderRoot?.querySelector(".map-root");!H||!this.#H||this.#H.setPalette(L0(H))}#f(){this.#Z(),this.#i=window.requestAnimationFrame(()=>{this.#i=null,this.#A=window.setTimeout(()=>{this.#A=null,this.#x()},0)})}#Z(){this.#i!==null&&window.cancelAnimationFrame(this.#i),this.#A!==null&&window.clearTimeout(this.#A),this.#i=null,this.#A=null}#l;#n(){if(!(typeof document>"u"||this.#L)&&(this.#L=new MutationObserver(this.#l),this.#L.observe(document.documentElement,{attributes:!0,attributeFilter:["style","class"]}),typeof window.matchMedia=="function")){this.#a=[window.matchMedia("(prefers-color-scheme: dark)"),window.matchMedia("(forced-colors: active)")];for(let H of this.#a)H.addEventListener("change",this.#l)}}#c(){this.#Z(),this.#L?.disconnect(),this.#L=null;for(let H of this.#a)H.removeEventListener("change",this.#l);this.#a=[]}#o(H){this.dispatchEvent(new CustomEvent(V1,{detail:H,bubbles:!0,composed:!0}))}#d(H){this.dispatchEvent(new CustomEvent(i2,{detail:{id:H},bubbles:!0,composed:!0}))}#u(H){this.#C=H.currentTarget,this.#M=!this.#M,this.#t=this.#M,this.requestUpdate()}#g(){if(!this.#M)return;this.#M=!1,this.requestUpdate();let H=this.#C;H?.isConnected&&H.focus()}#r(){for(let H of this.state.selection.roomIds)this.#o({type:"toggle-room",roomId:H})}#m(H,V){this.#H?.orbitBy(H,V)}#h(H){if(!(H.ctrlKey||H.metaKey||H.altKey)&&H.key==="Escape"){if(H.preventDefault(),this.#M){this.#g();return}this.#o({type:"dismiss-top-layer"});return}}rendererDiagnostics(){return this.#H?.diagnostics()??null}canvasIdentity(){return{scene:this.renderRoot.querySelector(".scene-canvas"),overlay:this.renderRoot.querySelector(".overlay-canvas")}}#s(){return this.state.host.connected?this.state.host.administrator?this.state.host.robotCount===0?{title:this.#e("v4_no_robot","No Matic robot set up"),detail:this.#e("v4_no_robot_detail","Set up a robot before opening its map.")}:this.state.dataMode==="history"?!this.state.map.available&&this.state.resources.scene.status==="loading"?{title:this.#e("v4_loading_saved_map","Loading saved map"),detail:this.#e("v4_loading_saved_map_detail","This read-only snapshot is still preparing.")}:this.state.map.available?null:{title:this.#e("v4_saved_map_unavailable","Saved map unavailable"),detail:this.#e("v4_saved_map_unavailable_detail","Choose another snapshot or return to the live map.")}:this.state.host.robotConnected?this.state.coherence==="verifying"||this.state.coherence==="booting"?{title:this.#e("v4_locating_map","Locating the current map"),detail:this.#e("v4_locating_map_detail","Map controls will return after the floor is verified.")}:!this.state.map.available&&this.state.resources.scene.status==="loading"?{title:this.#e("v4_loading_verified_map","Loading the verified map"),detail:this.#e("v4_loading_verified_map_detail","The current floor is verified. The private scene is still preparing.")}:this.state.map.available?this.state.activity==="problem"?{title:this.#e("v4_robot_attention","Robot needs attention"),detail:this.#e("v4_robot_attention_detail","Check the robot before starting another task.")}:null:{title:this.#e("v4_map_unavailable","Map unavailable"),detail:this.#e("v4_map_unavailable_detail","The private scene is not ready. No map data is shown until it is verified.")}:{title:this.#e("v4_robot_offline","Robot offline"),detail:this.#e("v4_robot_offline_detail","The last verified map stays read only and has no live position.")}:{title:this.#e("v4_admin_required","Administrator access required"),detail:this.#e("v4_private_map_hidden","Private map data is hidden.")}:{title:this.#e("v4_reconnecting","Reconnecting"),detail:this.#e("v4_reconnecting_detail","The verified map is read only until Home Assistant reconnects.")}}#v(H,V){let e=this.state,r=this.narrow,t=e.workflow==="draw",o=this.#e("v4_how_to_move","How to move the map"),M=H&&!t,i=M&&!r&&e.view==="top",a=M&&e.view==="three",n=!V,A=!r&&!t;return!M&&!n?s:m`
    ...
    `}#p(H){let V=this.state;if(!H)return s;if(V.workflow==="draw"&&!this.narrow)return m`
        <div class="map-dock ms-surface ms-surface--floating" data-map-control>
          ${r2(V,{intent:r=>this.#o(r),openBrush:()=>this.#o({type:"set-precision-open",value:!V.precisionOpen}),t:(r,t)=>this.#e(r,t)},"row")}
        </div>
      ...
      `:s}render(){let H=this.state,V=S5(H),e=this.#s(),r=H.map.available&&(Z1(H)||H.dataMode==="history"),t=H.workflow==="draw"&&r,o=H.coherence==="verifying"||H.coherence==="booting";return m`
      <section
        class="map-root"
        tabindex="0"
    ...
    `}};customElements.get(A1)||customElements.define(A1,H5);var V5=class extends w{constructor(){super(...arguments);this.state=y();this.compact=!1;this.inline=!1}static{this.properties={state:{attribute:!1},localize:{attribute:!1},compact:{type:Boolean,reflect:!0},inline:{type:Boolean,reflect:!0}}}static{this.styles=[D,$,H1,O`
...
`]}#C(H,V){return T(this.localize,H,V)}#H(H){this.dispatchEvent(new CustomEvent(V1,{detail:H,bubbles:!0,composed:!0}))}#V(H){let V=H.currentTarget.valueAsNumber;Number.isFinite(V)&&this.#H({type:"set-brush",value:V})}render(){let{draw:H}=this.state;return m`
    ...
    `}};customElements.get($1)||customElements.define($1,V5);var A0={ATTRIBUTE:1,CHILD:2,PROPERTY:3,BOOLEAN_ATTRIBUTE:4,EVENT:5,ELEMENT:6},l0=L=>(...C)=>({_$litDirective$:L,values:C}),a2=class{constructor(C){}get _$AU(){return this._$AM._$AU}_$AT(C,H,V){this._$Ct=C,this._$AM=H,this._$Ci=V}_$AS(C,H){return this.update(C,H)}update(C,H){return this.render(...H)}};var{I:E7}=q5,s0=L=>L;var d0=()=>document.createComment(""),b1=(L,C,H)=>{let V=L._$AA.parentNode,e=C===void 0?L._$AB:C._$AA;if(H===void 0){let r=V.insertBefore(d0(),e),t=V.insertBefore(d0(),e);H=new E7(r,t,L,L.options)}else{let r=H._$AB.nextSibling,t=H._$AM,o=t!==L;if(o){let M;H._$AQ?.(L),H._$AM=L,H._$AP!==void 0&&(M=L._$AU)!==t._$AU&&H._$AP(M)}if(r!==e||o){let M=H._$AA;for(;M!==r;){let i=s0(M).nextSibling;s0(V).insertBefore(M,e),M=i}}}return H},L1=(L,C,H=L)=>(L._$AI(C,H),L),D7={},p0=(L,C=D7)=>L._$AH=C,m0=L=>L._$AH,n2=L=>{L._$AR(),L._$AA.remove()};var v0=(L,C,H)=>{let V=new Map;for(let e=C;e<=H;e++)V.set(L[e],e);return V},c0=l0(class extends a2{constructor(L){if(super(L),L.type!==A0.CHILD)throw Error("repeat() can only be used in text expressions")}dt(L,C,H){let V;H===void 0?H=C:C!==void 0&&(V=C);let e=[],r=[],t=0;for(let o of L)e[t]=V?V(o,t):t,r[t]=H(o,t),t++;return{values:r,keys:e}}render(L,C,H){return this.dt(L,C,H).values}update(L,[C,H,V]){let e=m0(L),{values:r,keys:t}=this.dt(C,H,V);if(!Array.isArray(e))return this.ut=t,r;let o=this.ut??=[],M=[],i,a,n=0,A=e.length-1,l=0,d=r.length-1;for(;n<=A&&l<=d;)if(e[n]===null)n++;else if(e[A]===null)A--;else if(o[n]===t[l])M[l]=L1(e[n],r[l]),n++,l++;else if(o[A]===t[d])M[d]=L1(e[A],r[d]),A--,d--;else if(o[n]===t[d])M[d]=L1(e[n],r[d]),b1(L,M[d+1],e[n]),n++,d--;else if(o[A]===t[l])M[l]=L1(e[A],r[l]),b1(L,e[n],e[A]),A--,l++;else if(i===void 0&&(i=v0(t,l,d),a=v0(o,n,A)),i.has(o[n]))if(i.has(o[A])){let p=a.get(t[l]),Z=p!==void 0?e[p]:null;if(Z===null){let u=b1(L,e[n]);L1(u,r[l]),M[l]=u}else M[l]=L1(Z,r[l]),b1(L,e[n],Z),e[p]=null;l++}else n2(e[A]),A--;else n2(e[n]),n++;for(;l<=d;){let p=b1(L,M[d+1]);L1(p,r[l]),M[l++]=p}for(;n<=A;){let p=e[n++];p!==null&&n2(p)}return this.ut=t,p0(L,M),Y}});var L5=["vacuum","mop","vacuum_and_mop"],e5=["quick","standard","heavy_duty"],I=L=>L.currentTarget.value,u0=L=>L.currentTarget.checked,r5=class extends w{constructor(){super(...arguments);this.state=y();this._copyStatus="idle"}static{this.properties={state:{attribute:!1},localize:{attribute:!1},_copyStatus:{state:!0}}}static{this.styles=[D,$,H1,O`
...
`]}#C;disconnectedCallback(){this.#C!==void 0&&clearTimeout(this.#C),this.#C=void 0,super.disconnectedCallback()}#H(H,V,e){return T(this.localize,H,V,e)}#V(H){return H==="vacuum"?this.#H("vacuum","Vacuum"):H==="mop"?this.#H("mop","Mop"):this.#H("vacuum_and_mop","Vacuum + mop")}#M(H){return H==="quick"?this.#H("quick","Quick"):H==="standard"?this.#H("standard","Optimal"):this.#H("heavy_duty","Heavy Duty")}#t(H){this.dispatchEvent(new CustomEvent(V1,{detail:H,bubbles:!0,composed:!0}))}#L(){return this.state.notice?m`
...
`),e=typeof navigator>"u"?void 0:navigator.clipboard;if(e&&typeof e.writeText=="function")try{await e.writeText(V),this.#g("copied");return}catch{}this.#g(this.#r(V,H instanceof HTMLElement?H:null)?"copied":"failed")}#h(){let H=this.#u(),V=this._copyStatus==="copied"?this.#H("v4_copied","Copied"):this._copyStatus==="failed"?this.#H("v4_copy_failed","The summary could not be copied. Select the text to copy it by hand."):"";return m`
    ...
    `}#G(H,V,e,r,t=!1){return x`
      ...
      >
        ...
        <span class="ms-row__trail">${h(e2)}</span>
      </button>
    ...
    `}#L1(H,V){let e=(f,g,P)=>this.#C(f,g,P),r=this.#G(e("v4_map_history","Map history"),Y2,()=>this.#o("history"),e("v4_map_history_detail","Saved maps are floor-scoped and read only.")),t=this.#G(e("v4_map_diagnostics","Map diagnostics"),J3,()=>this.#o("support"),e("v4_map_support_detail","Private geometry is never included.")),{host:o}=H;if(!o.connected)return this.#I(e("v4_reconnecting_title","Reconnecting to Home Assistant"),e("v4_reconnecting_body","The last verified map stays read-only until the connection returns."));if(!o.administrator)return this.#I(e("v4_admin_title","Administrator access required"),e("v4_admin_body","Ask a Home Assistant administrator to open this map."));if(o.robotCount===0)return this.#I(e("v4_no_robot_title","No Matic robot set up"),e("v4_no_robot_body","Add the Matic integration to see a map here."),x`<a class="ms-btn ms-btn--secondary" href="/config/integrations/integration/matic_robot">${e("v4_open_integration","Open the Matic integration")}</a>`);if(!o.robotConnected)return x`
      ...
      ${H.activity==="problem"?this.#I(e("v4_attention_title","The robot needs attention"),e("v4_attention_body","Check the robot, then start a new task.")):x`
          <div class="quick-actions" aria-label=${e("v4_cleaning_choices","Cleaning choices")}>
            ...
            >
              <span class="ms-row__lead">${h(f1)}</span>
      ...
      <div class="panel-heading">
        ${H.workflow!=="none"?x`
          <button
            ...
            @click=${()=>this.#o("none")}
          >${h(X2)}<span class="ms-btn__label">${this.#C("v4_all_tasks","All tasks")}</span></button>
        `:s}
            ...
            <div class="canvas">
              ...
              ${!V&&Z?x`
                <div class="precision-popover">
                  <${A2} compact .state=${H} .localize=${this.localize}></${A2}>
                </div>
              `:s}
            </div>
              ...
              ${V?x`
                ...
                ${p?x`
                  <div class="sheet-tools">
                    ${r2(H,{intent:u=>this.#n(u),openBrush:()=>this.#E(),t:(u,S)=>this.#C(u,S)},"grid")}
                    ${Z?x`
                      <div class="precision-popover">
                        <${A2} compact inline .state=${H} .localize=${this.localize}></${A2}>
                      </div>
                    `:s}
                  </div>
                `:s}
    ...
    `}};customElements.get(s1)||customElements.define(s1,M5);var g0=C1(s1),o5=class extends w{constructor(){super(...arguments);this.scenario="ready";this.narrow=!1;this.controls=!0;this._workspace=T2("ready");this.#C=new x1(this._workspace);this.#H=null}static{this.properties={scenario:{type:String,reflect:!0},narrow:{type:Boolean,reflect:!0},controls:{type:Boolean,reflect:!0},_workspace:{state:!0}}}static{this.styles=[D,$,O`
    :host {
      display: block;
      color: #1f2933;
      background: #e8edef;
  ...
  `]}#C;#H;connectedCallback(){super.connectedCallback(),this.#H=this.#C.subscribe(H=>{this._workspace=H})}disconnectedCallback(){this.#H?.(),this.#H=null,super.disconnectedCallback()}willUpdate(H){H.has("scenario")?this.#C.replace({...T2(this.scenario),narrowHint:this.narrow}):H.has("narrow")&&this.#C.dispatch({type:"set-narrow-hint",value:this.narrow})}setScenario(H){B2.includes(H)&&(this.scenario=H)}getWorkspaceSnapshot(){return structuredClone(this.#C.value)}replaceWorkspaceState(H){this.#C.replace(structuredClone(H))}#V(H){v1(H.detail)&&(H.stopPropagation(),this.#C.dispatch(H.detail))}render(){return x`
      ${this.controls?x`
...
`]}static{this.properties={hass:{attribute:!1},narrow:{type:Boolean},route:{attribute:!1},panel:{attribute:!1},_workspace:{state:!0},_classic:{state:!0},entryOverride:{state:!0}}}#C;#H;#V;#M;#t;#L;#a;#i;connectedCallback(){super.connectedCallback(),this._classic=Q0()==="v3",this.#M=this.#H.subscribe(H=>{this._workspace=H,this.#x(H)}),this._classic||this.#A()}disconnectedCallback(){this.#M?.(),this.#M=null,this.#e(),super.disconnectedCallback()}#A(){if(!this.#L&&(this.#V=this.#C.project(this.hass,this.panel,this.entryOverride),this.#t=new s2(()=>this.hass),this.#L=new v2(this.#H,this.#t),this.#a=new c2(this.#H),this.#a.start(),this.#V)){this.#L.sync(this.#V,this.panel);let{host:H}=this.#V;H.connected&&H.administrator&&H.robotCount>0&&this.#L.refreshCatalog(this.#H.value.selection.floorId==="current")}}#e(){this.#a?.dispose(),this.#a=null,this.#L?.dispose(),this.#L=null,this.#t=null}#x(H){if(!this.#L)return;let V={version:4,view:H.view,appearance:H.appearance,labels:H.labelsVisible,quality:H.quality,cameras:H.cameras},e=JSON.stringify(V);e!==this.#i&&(this.#i=e,this.#L.schedulePreferences(V))}willUpdate(H){if(H.has("hass")||H.has("panel")||H.has("entryOverride")){let V=this.#C.project(this.hass,this.panel,this.entryOverride);if(V!==this.#V){this.#V=V;let e=V.host.connected?V.host.robotCount===0?"unavailable":V.host.administrator?"verifying":"blocked":"degraded";this.#H.replace({...this.#H.value,coherence:e,activity:V.activity,batteryPercent:V.batteryPercent,host:V.host,fullMap:V.host.administrator&&V.host.robotCount>0&&this.#H.value.fullMap,robotLabel:V.robotLabel,robots:V.robots,locale:V.language})}this._classic||this.#L?.sync(V,this.panel)}H.has("narrow")&&this.#H.value.narrowHint!==this.narrow&&this.#H.dispatch({type:"set-narrow-hint",value:this.narrow})}#f(H){if(!v1(H.detail))return;H.stopPropagation();let V=H.detail;if(V.type==="dismiss-top-layer"||V.type==="exit-full-map"){this.#a?.dismissTop()||this.#H.dispatch(V);return}if(V.type==="open-workflow"&&V.workflow!=="none"){this.#L?.openWorkflow(V.workflow);return}if(V.type==="set-floor"){this.#L?.selectFloor(V.floorId);return}if(V.type==="select-entry"){if(!this._workspace.robots.some(e=>e.entryId===V.entryId))return;this.entryOverride=V.entryId;return}if(V.type==="set-history"){this.#L?.selectHistory(V.historyId);return}if(V.type==="select-plan"){this.#L?.selectPlan(V.planId);return}if(V.type==="select-area"){this.#L?.selectArea(V.areaId),V.workflow==="areaReview"&&this.#L?.openWorkflow("areaReview");return}this.#H.dispatch(V)}#Z(H){if(H.stopPropagation(),typeof H.detail?.id=="string"){if(H.detail.id==="use-classic"){A5("v3")&&(this.#e(),this._classic=!0);return}this.#L?.executeAction(H.detail.id),this.dispatchEvent(new CustomEvent("matic-map-v4-action-requested",{detail:{id:H.detail.id},bubbles:!0,composed:!0}))}}#l(){A5("v4")&&(this._classic=!1,this.#A(),this.requestUpdate())}updated(){if(!this._classic)return;let H=this.renderRoot.querySelector("matic-map-panel-v0-3-1");H&&(H.hass=this.hass,H.narrow=this.narrow,H.route=this.route,H.panel=this.panel)}getWorkspaceSnapshot(){return this.#H.value}render(){return this._classic?x`
      ...
      ></${C7}>
    `}};customElements.get(Q2)||customElements.define(Q2,s5);export{G1 as CoherenceMachine,P1 as DRAW_BRUSH_MAX_METERS,m1 as DRAW_BRUSH_MIN_METERS,B2 as GALLERY_SCENARIOS,K1 as HassAdapter,g2 as MAP_PIXELS_PER_METER_AT_100,v5 as MAP_ZOOM_MAX,k1 as MAP_ZOOM_MIN,Q2 as MATIC_MAP_PANEL_TAG,s5 as MaticMapPanelV4,o5 as MaticMapStudioGalleryV4,x1 as WorkspaceStore,p4 as brushCursorPixels,U as canEditCoordinates,y2 as canReadFloorResources,b2 as canResumeMotion,x5 as canShowExactPose,Z1 as canShowLiveMap,u1 as canStartMotion,w2 as canStopMotion,m4 as commandState,T2 as createGalleryState,y as initialWorkspaceState,v1 as isWorkspaceIntent,S5 as mapScale,r7 as normalizeBrush,c5 as normalizeZoom,t7 as reduceWorkspace,k2 as selectPrimaryAction,h5 as selectStopSecondaryAction};
