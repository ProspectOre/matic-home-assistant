      ...
      <div class="map-rail" data-map-control>
        ...
        ${this.#t&&H&&A?d`
          ...
          >
            <header>
              <h3>${o}</h3>
              <button class="ms-btn ms-btn--sm" type="button" @click=${()=>this.#f()}>${this.#e("v4_close","Close")}</button>
            </header>
            <dl>
...
`]}#C;disconnectedCallback(){this.#C!==void 0&&clearTimeout(this.#C),this.#C=void 0,super.disconnectedCallback()}#H(H,V,e){return T(this.localize,H,V,e)}#L(H){return H==="vacuum"?this.#H("vacuum","Vacuum"):H==="mop"?this.#H("mop","Mop"):this.#H("vacuum_and_mop","Vacuum + mop")}#t(H){return H==="quick"?this.#H("quick","Quick"):H==="standard"?this.#H("standard","Optimal"):this.#H("heavy_duty","Heavy Duty")}#M(H){this.dispatchEvent(new CustomEvent(H1,{detail:H,bubbles:!0,composed:!0}))}#V(){return this.state.notice?d`
          ...
          ${o.map(({room:M,label:i,selected:a})=>{let n=a?e.rooms.findIndex(A=>A.roomId===M.roomId):-1;return d`
              <div class="room plan-room ms-row ms-row--stack" data-selected=${String(a)}>
                ...
                ${a?d`
                  <div class="split room-settings">
                    <label class="field ms-field">${this.#H("v4_cleaning_system","Cleaning system")}
                      <select aria-label=${this.#H("v4_room_cleaning_system_named","Cleaning system for {room}",{room:i})} .value=${M.cleaningMode} @change=${A=>this.#g(n,{cleaningMode:I(A)})}>${Y2.map(A=>d`<option value=${A} ?selected=${A===M.cleaningMode}>${this.#L(A)}</option>`)}</select>
                    </label>
                    <label class="field ms-field">${this.#H("cleaning_mode","Cleaning mode")}
                      <select aria-label=${this.#H("v4_room_cleaning_mode_named","Cleaning mode for {room}",{room:i})} .value=${M.coverageSetting} @change=${A=>this.#g(n,{coverageSetting:I(A)})}>${j2.map(A=>d`<option value=${A} ?selected=${A===M.coverageSetting}>${this.#t(A)}</option>`)}</select>
                    </label>
                  </div>
                `:s}
              </div>
    ...
    `}#c(){let H=this.state.areaDraft,V=H.canRebind||H.status==="review",e=!V&&(H.status==="stale"||H.status==="unknown");return d`
      <div class="stack">
        ...
        <div class="split">
          <label class="field ms-field">${this.#H("v4_cleaning_system","Cleaning system")}
            <select .value=${H.cleaningMode} @change=${r=>this.#M({type:"patch-area-draft",patch:{cleaningMode:I(r)}})}>${Y2.map(r=>d`<option value=${r} ?selected=${r===H.cleaningMode}>${this.#L(r)}</option>`)}</select>
          </label>
          <label class="field ms-field">${this.#H("cleaning_mode","Cleaning mode")}
...
`),e=typeof navigator>"u"?void 0:navigator.clipboard;if(e&&typeof e.writeText=="function")try{await e.writeText(V),this.#f("copied");return}catch{}this.#f(this.#r(V,H instanceof HTMLElement?H:null)?"copied":"failed")}#h(){let H=this.#u(),V=this._copyStatus==="copied"?this.#H("v4_copied","Copied"):this._copyStatus==="failed"?this.#H("v4_copy_failed","The summary could not be copied. Select the text to copy it by hand."):"";return d`
    ...
    `}#U(H){let V=H.resources.plans.value?.rooms??H.resources.areas.value?.rooms??[];return H.selection.roomIds.map(e=>V.find(r=>r.roomId===e)?.name??e)}#$(H,V,e){let r=V?.enabled&&H.workflow==="rooms"&&V.id==="clean-rooms"?[this.#U(H).join(", "),H.planDraft.returnToBase?this.#C("v4_returns_to_dock","returns to the dock"):""].filter(Boolean).join(" \xB7 "):"";return c`
    ...
    `}#L1(H,V){let e=(S,g,P)=>this.#C(S,g,P),r=this.#G(e("v4_map_history","Map history"),U2,()=>this.#o("history"),e("v4_map_history_detail","Saved maps are floor-scoped and read only.")),t=this.#G(e("v4_map_diagnostics","Map diagnostics"),G3,()=>this.#o("support"),e("v4_map_support_detail","Private geometry is never included.")),{host:o}=H;if(!o.connected)return this.#I(e("v4_reconnecting_title","Reconnecting to Home Assistant"),e("v4_reconnecting_body","The last verified map stays read-only until the connection returns."));if(!o.administrator)return this.#I(e("v4_admin_title","Administrator access required"),e("v4_admin_body","Ask a Home Assistant administrator to open this map."));if(o.robotCount===0)return this.#I(e("v4_no_robot_title","No Matic robot set up"),e("v4_no_robot_body","Add the Matic integration to see a map here."),c`<a class="ms-btn ms-btn--secondary" href="/config/integrations/integration/matic_robot">${e("v4_open_integration","Open the Matic integration")}</a>`);if(!o.robotConnected)return c`
      ...
      ${H.activity==="problem"?this.#I(e("v4_attention_title","The robot needs attention"),e("v4_attention_body","Check the robot, then start a new task.")):c`
      ...
      <h3 class="shelf-heading">${e("v4_more","Map tools")}</h3>
      <div class="shelf">
        ${this.#G(e("v4_custom_areas","Clean a custom area"),z3,()=>this.#o("draw"),f,M)}
        ${r}
        ${V?this.#Q(H):s}
      </div>
      ${V?c`
              ...
              ${V?c`
                ...
                ${u?c`
                  <div class="sheet-tools">
                    ${j1(H,{intent:x=>this.#n(x),openBrush:()=>this.#E(),t:(x,f)=>this.#C(x,f)},"grid")}
                    ${h?c`
                      <div class="precision-popover">
