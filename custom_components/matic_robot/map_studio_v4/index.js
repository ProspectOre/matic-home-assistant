...
`;var $5=Symbol.for(""),H7=e=>{if(e?.r===$5)return e?._$litStatic$},j=e=>({_$litStatic$:e,r:$5});var D5=new Map,B2=e=>(C,...H)=>{let V=H.length,L,r,t=[],M=[],o,i=0,a=!1;for(;i<V;){for(o=C[i];i<V&&(r=H[i],(L=H7(r))!==void 0);)o+=L+C[++i],a=!0;i!==V&&M.push(r),t.push(o),i++}if(i===V&&t.push(C[V]),a){let n=t.join("$$lit$$");(C=D5.get(n))===void 0&&(t.raw=t,D5.set(n,C=t)),H=M}return e(C,...H)},v=B2(s),p4=B2(B5),m4=B2(R5);var I5=import.meta.url.match(/\/matic_robot\/[^/]+-([a-f0-9]{12})\/map-studio-v4(?:\/|$)/u)?.[1]??"dev",T1=I5==="dev"?"":`-${I5}`,t1=`matic-map-canvas-v4${T1}`,B1=`matic-precision-controls-v4${T1}`,c1=`matic-map-workflow-v4${T1}`,M1=`matic-map-shell-v4${T1}`,R2=`matic-map-panel-v0-4-0${T1}`;var J=b`
.ms-btn, .ms-row {
...
><path d=${e}></path></svg>`;var V7=["paint","erase","pan"],Y1=(e,C,H)=>{let{draw:V}=e,L=`${V.brushMeters.toFixed(2)} m`;return s`
  ...
  `};var L7=e=>e.matches(":disabled, [aria-disabled='true']"),j1=class{#C;#H;#V=null;#e=null;constructor(C,H){this.#C=C,this.#H=H,C.addController(this)}hostConnected(){this.#C.addEventListener("focusin",this.#n)}hostDisconnected(){this.#C.removeEventListener("focusin",this.#n),this.#V?.removeEventListener("keydown",this.#a),this.#V=null,this.#e=null}hostUpdated(){let C=this.#H.container();C!==this.#V&&(this.#V?.removeEventListener("keydown",this.#a),C?.addEventListener("keydown",this.#a),this.#V=C),this.#t()}#r(){let C=this.#V;return C?[...C.querySelectorAll(this.#H.items)].filter(H=>!L7(H)):[]}#t(){let C=this.#r(),H=(this.#e&&C.includes(this.#e)?this.#e:null)??C.find(L=>L.matches("[aria-pressed='true'], [aria-checked='true']"))??C[0]??null;this.#e=H;let V=this.#V?.querySelectorAll(this.#H.items)??[];for(let L of V)L.tabIndex=L===H?0:-1}#n=C=>{let H=C.composedPath()[0];!(H instanceof HTMLElement)||!this.#V?.contains(H)||H.matches(this.#H.items)&&(this.#e=H,this.#t())};#a=C=>{if(C.defaultPrevented||C.ctrlKey||C.metaKey||C.altKey)return;let H=this.#H.orientation??"horizontal",V=H!=="vertical",L=H!=="horizontal",r=this.#r();if(!r.length)return;let t=C.composedPath()[0],M=Math.max(0,r.findIndex(a=>a===this.#e||t instanceof Node&&a.contains(t))),o;switch(C.key){case"ArrowLeft":if(!V)return;o=M-1;break;case"ArrowRight":if(!V)return;o=M+1;break;case"ArrowUp":if(!L)return;o=M-1;break;case"ArrowDown":if(!L)return;o=M+1;break;case"Home":o=0;break;case"End":o=r.length-1;break;default:return}C.preventDefault();let i=r[(o+r.length)%r.length];i&&(this.#e=i,this.#t(),i.focus())}};var I3={accent:["--ms-accent","Highlight",[6,120,206]],onAccent:["--ms-on-accent","HighlightText",[255,255,255]],text:["--ms-text","CanvasText",[38,50,56]],quiet:["--ms-text-quiet","GrayText",[75,92,105]],plate:["--ms-surface-card","Canvas",[250,252,253]],roomFill:["--ms-surface-sunken","Canvas",[231,238,242]]},e7=e=>Math.max(0,Math.min(255,Math.round(e))),W3=e=>{let C=e.trim(),H=C.match(/^#([\da-f]{3}|[\da-f]{4}|[\da-f]{6}|[\da-f]{8})$/i)?.[1];if(H){let a=H.length<=4?[H[0],H[1],H[2]].map(m=>Number.parseInt(`${m}${m}`,16)):[H.slice(0,2),H.slice(2,4),H.slice(4,6)].map(m=>Number.parseInt(m,16)),[n,A,d]=a;return n===void 0||A===void 0||d===void 0?null:[n,A,d]}let V=C.startsWith("color(srgb"),L=C.slice(C.indexOf("(")+1).match(/-?\d*\.?\d+/g);if(!L||L.length<3)return null;let r=V?255:1,t=L.slice(0,3).map(a=>e7(Number(a)*r)),[M,o,i]=t;return M===void 0||o===void 0||i===void 0||[M,o,i].some(a=>Number.isNaN(a))?null:[M,o,i]},B=(e,C)=>`rgba(${e[0]},${e[1]},${e[2]},${C})`,N3=e=>{let C=window.matchMedia?.("(forced-colors: active)").matches??!1;if(!C){let L=getComputedStyle(e),r=t=>{let[M,,o]=I3[t];return W3(L.getPropertyValue(M))??o};return{accent:r("accent"),onAccent:r("onAccent"),text:r("text"),quiet:r("quiet"),plate:r("plate"),roomFill:r("roomFill"),forced:C}}let H=document.createElement("span");H.setAttribute("aria-hidden","true"),H.style.cssText="position:absolute;inline-size:0;block-size:0;overflow:hidden;visibility:hidden;pointer-events:none",e.append(H);let V=L=>{let[,r,t]=I3[L];return H.style.color=r,W3(getComputedStyle(H).color)??t};try{return{accent:V("accent"),onAccent:V("onAccent"),text:V("text"),quiet:V("quiet"),plate:V("plate"),roomFill:V("roomFill"),forced:C}}finally{H.remove()}};var z3=(e,C)=>Math.hypot(e.x-C.x,e.y-C.y),U3=(e,C)=>({x:(e.x+C.x)/2,y:(e.y+C.y)/2}),G3=(e,C)=>Math.atan2(C.y-e.y,C.x-e.x),r7=e=>{let C=e;for(;C>Math.PI;)C-=Math.PI*2;for(;C<-Math.PI;)C+=Math.PI*2;return C},o1=(e,C,H)=>Math.max(C,Math.min(H,e)),N2=e=>e.map(C=>({...C})),t7="button, input, select, textarea, a, [role='button'], [role='menuitem'], [data-map-control]",x1=e=>e.composedPath().some(C=>C instanceof Element&&C.matches(t7)),J1=class{#C;#H;#V;#e=new Map;#r=!1;#t="idle";#n=[];#a=[];#A=null;#L=0;#c=null;#h=0;#x=null;#i=null;#f=null;#p=0;#o=null;#u=!1;#Z=null;#v=!1;constructor(C,H,V){this.#C=C,this.#H=H,this.#V=V,C.addEventListener("pointerdown",this.#M),C.addEventListener("pointermove",this.#l),C.addEventListener("pointerup",this.#d),C.addEventListener("pointercancel",this.#d),C.addEventListener("wheel",this.#w,{passive:!1}),C.addEventListener("gesturestart",this.#S,{passive:!1}),C.addEventListener("gesturechange",this.#b,{passive:!1}),C.addEventListener("gestureend",this.#T,{passive:!1}),C.addEventListener("dblclick",this.#k),C.addEventListener("contextmenu",this.#y),C.addEventListener("keydown",this.#g),C.addEventListener("keyup",this.#P),C.addEventListener("blur",this.#O)}#M=C=>{if(this.#v||!C.isPrimary&&C.pointerType==="mouse"||x1(C))return;this.#C.focus({preventScroll:!0}),this.#_();let H=performance.now(),V={id:C.pointerId,type:C.pointerType,startX:C.clientX,startY:C.clientY,x:C.clientX,y:C.clientY,lastX:C.clientX,lastY:C.clientY,lastTime:H,velocityX:0,velocityY:0};if(this.#e.set(C.pointerId,V),this.#C.setPointerCapture?.(C.pointerId),this.#e.size>=2){this.#R(),(this.#t==="paint"||this.#t==="erase")&&(this.#a=N2(this.#n),this.#V.onCircles(this.#a,!1)),this.#t="pinch",this.#C.classList.add("navigating"),this.#u=!0;let[M,o]=[...this.#e.values()];M&&o&&(this.#L=Math.max(1,z3(M,o)),this.#c=U3(M,o),this.#h=G3(M,o),this.#x=this.#H.camera),C.preventDefault();return}let L=this.#V.state(),r=L.workflow==="draw"&&L.map.available&&!L.floor.readOnly;this.#u||this.#r||C.button===1||C.button===2||L.draw.tool==="pan"?(this.#t="pan",this.#i=this.#H.camera):r&&(L.draw.tool==="paint"||L.draw.tool==="erase")?(this.#n=N2(L.draw.circles),this.#a=N2(L.draw.circles),C.pointerType==="touch"?(this.#t="idle",this.#Z=window.setTimeout(()=>{if(this.#Z=null,this.#e.size!==1||this.#u)return;this.#t=L.draw.tool;let M=this.#e.get(C.pointerId);M&&this.#s(M.x,M.y)},110)):(this.#t=L.draw.tool,this.#s(C.clientX,C.clientY))):(this.#t=L.view==="three"&&!C.shiftKey?"orbit":"pan",this.#i=this.#H.camera),(this.#t==="pan"||this.#t==="orbit")&&this.#C.classList.add("navigating"),C.preventDefault()};#l=C=>{let H=this.#e.get(C.pointerId);if(!H){let a=this.#H.screenToMap(C.clientX,C.clientY);this.#H.setCursor(a);return}let L=(C.getCoalescedEvents?.()||[]).at(-1)||C,r=performance.now(),t=Math.max(1,r-H.lastTime),M=(L.clientX-H.lastX)/t,o=(L.clientY-H.lastY)/t;if(H.velocityX=H.velocityX*.62+M*.38,H.velocityY=H.velocityY*.62+o*.38,H.lastX=L.clientX,H.lastY=L.clientY,H.lastTime=r,H.x=L.clientX,H.y=L.clientY,this.#t==="pinch"&&this.#e.size>=2){let[a,n]=[...this.#e.values()];if(!a||!n)return;let A=Math.max(1,z3(a,n)),d=U3(a,n),m=G3(a,n),x=this.#x;if(x&&this.#c){let h={...x,distance:x.distance*this.#L/A,yaw:x.yaw+r7(m-this.#h),pitch:x.orthographic?x.pitch:x.pitch-(d.y-this.#c.y)*.0035};this.#H.setCamera(this.#H.cameraAfterPan(h,d.x-this.#c.x,d.y-this.#c.y))}C.preventDefault();return}this.#t==="paint"||this.#t==="erase"?this.#s(C.clientX,C.clientY):this.#t==="pan"?this.#i&&this.#H.setCamera(this.#H.cameraAfterPan(this.#i,L.clientX-H.startX,L.clientY-H.startY)):this.#t==="orbit"&&this.#i&&this.#H.setCamera({...this.#i,yaw:this.#i.yaw+(L.clientX-H.startX)*.0045,pitch:this.#i.pitch-(L.clientY-H.startY)*.004});let i=this.#H.screenToMap(L.clientX,L.clientY);this.#H.setCursor(i),C.preventDefault()};#d=C=>{let H=this.#e.get(C.pointerId);if(!H)return;let V=this.#t;if(this.#e.delete(C.pointerId),this.#C.releasePointerCapture?.(C.pointerId),this.#R(),(this.#t==="paint"||this.#t==="erase")&&JSON.stringify(this.#a)!==JSON.stringify(this.#n))this.#V.onCircles(this.#a,!0,this.#n);else if(this.#t!=="pinch"&&!this.#u&&Math.hypot(H.x-H.startX,H.y-H.startY)<7&&this.#V.state().workflow==="rooms"){let L=this.#H.roomAt(H.x,H.y);L&&this.#V.onRoom(L)}if(this.#e.size===0)this.#t="idle",this.#C.classList.remove("navigating"),this.#u=!1,this.#c=null,this.#x=null,this.#i=null,this.#A=null,(V==="pan"||V==="orbit")&&H.type!=="mouse"&&this.#B(H.velocityX,H.velocityY,V);else if(this.#t==="pinch"){this.#t="pan",this.#u=!0;let L=this.#e.values().next().value;L&&(L.startX=L.x,L.startY=L.y,L.velocityX=0,L.velocityY=0),this.#i=this.#H.camera,this.#x=null}C.preventDefault()};#s(C,H){let V=this.#H.screenToMap(C,H);if(!V)return;let r=this.#V.state().draw.brushMeters/2;if(this.#t==="erase")this.#a=this.#a.filter(t=>Math.hypot(t.x-V.x,t.y-V.y)>t.radius+r);else{if(!this.#H.containsMapPoint(V))return;let t=Math.max(.04,r*.55),M=this.#A||V,o=Math.hypot(V.x-M.x,V.y-M.y),i=Math.max(1,Math.ceil(o/t));for(let a=0;a<=i&&this.#a.length<512;a+=1){let n=a/i,A={x:M.x+(V.x-M.x)*n,y:M.y+(V.y-M.y)*n};this.#a.some(d=>Math.hypot(d.x-A.x,d.y-A.y)<Math.max(.025,r*.28))||this.#a.push({x:Math.round(A.x*1e4)/1e4,y:Math.round(A.y*1e4)/1e4,radius:Math.round(r*100)/100})}}this.#A=V,this.#V.onCircles(this.#a,!1)}#w=C=>{if(x1(C))return;C.preventDefault(),this.#C.focus({preventScroll:!0}),this.#_();let H=C.deltaMode===WheelEvent.DOM_DELTA_LINE?16:C.deltaMode===WheelEvent.DOM_DELTA_PAGE?Math.max(1,this.#C.clientHeight):1,V=C.deltaX*H,L=C.deltaY*H;if(C.ctrlKey||C.metaKey){this.#H.zoomAt(Math.exp(o1(-L*.008,-.28,.28)),C.clientX,C.clientY);return}if(C.altKey&&this.#V.state().view==="three"){this.#H.orbitBy(0,o1(L,-80,80)*.75);return}if(C.deltaMode!==WheelEvent.DOM_DELTA_PIXEL||Math.abs(V)<.5&&Math.abs(L)>=50){this.#H.zoomAt(Math.exp(o1(-L*.0025,-.28,.28)),C.clientX,C.clientY);return}this.#H.panBy(-o1(V,-80,80),-o1(L,-80,80))};#S=C=>{this.#v||x1(C)||(this.#C.focus({preventScroll:!0}),this.#_(),this.#C.classList.add("navigating"),this.#f=this.#H.camera,this.#p=Number.isFinite(C.rotation)?C.rotation:0,C.preventDefault())};#b=C=>{if(this.#v||x1(C))return;let H=this.#f;if(!H||this.#e.size>=2)return;let V=Number.isFinite(C.scale)&&C.scale>0?Math.max(.1,C.scale):1,L=Number.isFinite(C.rotation)?C.rotation:0;this.#H.setCamera({...H,distance:H.distance/V,yaw:H.yaw+(L-this.#p)*Math.PI/180}),C.preventDefault()};#T=C=>{this.#f=null,this.#p=0,this.#C.classList.remove("navigating"),C.preventDefault()};#g=C=>{if(C.defaultPrevented||C.ctrlKey||C.metaKey||C.altKey)return;if(C.code==="Space"){this.#r=!0,C.preventDefault();return}this.#_();let H=this.#V.state(),V=C.key.toLocaleLowerCase();if(C.key==="+"||C.key==="=")this.#H.zoomAt(1.25);else if(C.key==="-")this.#H.zoomAt(.8);else if(C.key==="0")this.#H.fit();else if(V==="3")this.#m({type:"set-view",view:"three"});else if(V==="t")this.#m({type:"set-view",view:"top"});else if(C.key==="[")this.#H.orbitBy(-40,0);else if(C.key==="]")this.#H.orbitBy(40,0);else if(C.key==="PageUp")this.#H.orbitBy(0,-30);else if(C.key==="PageDown")this.#H.orbitBy(0,30);else if(V==="d"&&H.workflow==="draw")this.#m({type:"set-draw-tool",tool:"paint"});else if(V==="e"&&H.workflow==="draw")this.#m({type:"set-draw-tool",tool:"erase"});else if(["arrowleft","arrowright","arrowup","arrowdown"].includes(V))if(H.view==="three"&&!C.shiftKey){let L=V==="arrowleft"?-24:V==="arrowright"?24:0,r=V==="arrowup"?-20:V==="arrowdown"?20:0;this.#H.orbitBy(L,r)}else{let L=V==="arrowleft"?30:V==="arrowright"?-30:0,r=V==="arrowup"?30:V==="arrowdown"?-30:0;this.#H.panBy(L,r)}else if(H.workflow!=="draw"&&["w","a","s","d"].includes(V))this.#H.panBy(V==="a"?34:V==="d"?-34:0,V==="w"?34:V==="s"?-34:0);else if(H.workflow!=="draw"&&(V==="q"||V==="e"))this.#H.orbitBy(V==="q"?-30:30,0);else return;C.preventDefault()};#P=C=>{C.code==="Space"&&(this.#r=!1)};#O=()=>{this.#r=!1,this.#R(),this.#H.setCursor(null),this.#C.classList.remove("navigating")};#k=C=>{x1(C)||(this.#_(),this.#H.zoomAt(C.shiftKey?1/1.6:1.6,C.clientX,C.clientY),C.preventDefault())};#y=C=>{x1(C)||C.preventDefault()};#m(C){this.#C.dispatchEvent(new CustomEvent("matic-workspace-intent",{detail:C,bubbles:!0,composed:!0}))}#B(C,H,V){if(window.matchMedia("(prefers-reduced-motion: reduce)").matches)return;let L=o1(C,-.55,.55),r=o1(H,-.55,.55);if(Math.hypot(L,r)<.02)return;let t=performance.now(),M=o=>{let i=Math.min(32,o-t);t=o,V==="orbit"?this.#H.orbitBy(L*i,r*i):this.#H.panBy(L*i,r*i);let a=.9**(i/16);L*=a,r*=a,Math.hypot(L,r)>=.01?this.#o=window.requestAnimationFrame(M):this.#o=null};this.#o=window.requestAnimationFrame(M)}#_(){this.#o!==null&&window.cancelAnimationFrame(this.#o),this.#o=null}#R(){this.#Z!==null&&window.clearTimeout(this.#Z),this.#Z=null}dispose(){this.#v||(this.#v=!0,this.#R(),this.#_(),this.#C.removeEventListener("pointerdown",this.#M),this.#C.removeEventListener("pointermove",this.#l),this.#C.removeEventListener("pointerup",this.#d),this.#C.removeEventListener("pointercancel",this.#d),this.#C.removeEventListener("wheel",this.#w),this.#C.removeEventListener("gesturestart",this.#S),this.#C.removeEventListener("gesturechange",this.#b),this.#C.removeEventListener("gestureend",this.#T),this.#C.removeEventListener("dblclick",this.#k),this.#C.removeEventListener("contextmenu",this.#y),this.#C.removeEventListener("keydown",this.#g),this.#C.removeEventListener("keyup",this.#P),this.#C.removeEventListener("blur",this.#O),this.#e.clear())}};var _=(e,C,H)=>Math.max(C,Math.min(H,e)),R1=e=>{let C=e;for(;C>Math.PI;)C-=Math.PI*2;for(;C<-Math.PI;)C+=Math.PI*2;return C},M7=e=>{switch(e){case"efficient":return .35;case"balanced":return .65;case"maximum":case"auto":return 1}},o7={accent:[6,120,206],onAccent:[255,255,255],text:[38,50,56],quiet:[75,92,105],plate:[250,252,253],roomFill:[231,238,242],forced:!1},K3=Math.PI/3.15,i7=1.08,a7=(e,C)=>{let H=K3/2,V=Math.atan(Math.tan(H)*Math.max(.2,C));return e/Math.sin(Math.min(H,V))*i7},n7=(e,C)=>{let H=new Float32Array(16);for(let V=0;V<4;V+=1)for(let L=0;L<4;L+=1){let r=0;for(let t=0;t<4;t+=1)r+=(e[t*4+L]??0)*(C[V*4+t]??0);H[V*4+L]=r}return H},A7=(e,C,H,V)=>{let L=1/Math.tan(e/2),r=new Float32Array(16);return r[0]=L/C,r[5]=L,r[10]=(V+H)/(H-V),r[11]=-1,r[14]=2*V*H/(H-V),r},l7=(e,C,H,V,L,r)=>{let t=new Float32Array(16);return t[0]=2/(C-e),t[5]=2/(V-H),t[10]=-2/(r-L),t[12]=-(C+e)/(C-e),t[13]=-(V+H)/(V-H),t[14]=-(r+L)/(r-L),t[15]=1,t},d7=(e,C)=>{let H=Math.hypot((e[0]??0)-(C[0]??0),(e[1]??0)-(C[1]??0),(e[2]??0)-(C[2]??0))||1,V=[((e[0]??0)-(C[0]??0))/H,((e[1]??0)-(C[1]??0))/H,((e[2]??0)-(C[2]??0))/H],L=Math.hypot(V[2]??0,V[0]??0)||1,r=[(V[2]??0)/L,0,-(V[0]??0)/L],t=[(V[1]??0)*(r[2]??0),(V[2]??0)*(r[0]??0)-(V[0]??0)*(r[2]??0),-(V[1]??0)*(r[0]??0)];return new Float32Array([r[0]??0,t[0]??0,V[0]??0,0,r[1]??0,t[1]??0,V[1]??0,0,r[2]??0,t[2]??0,V[2]??0,0,-((r[0]??0)*(e[0]??0)+(r[1]??0)*(e[1]??0)+(r[2]??0)*(e[2]??0)),-((t[0]??0)*(e[0]??0)+(t[1]??0)*(e[1]??0)+(t[2]??0)*(e[2]??0)),-((V[0]??0)*(e[0]??0)+(V[1]??0)*(e[1]??0)+(V[2]??0)*(e[2]??0)),1])},Q3=(e,C,H)=>{let V=!1,L=H.at(-1);if(!L)return!1;for(let r of H){let[t,M]=r,[o,i]=L;M>C!=i>C&&e<(o-t)*(C-M)/(i-M)+t&&(V=!V),L=r}return V},C2=class{#C;#H;#V;#e=null;#r=null;#t=null;#n=null;#a=null;#A=null;#L=null;#c=null;#h=null;#x=null;#i=null;#f=null;#p=null;#o=null;#u=null;#Z=null;#v;#M={yaw:-Math.PI/4,pitch:.82,distance:12,targetX:0,targetZ:0,orthographic:!1};#l=12;#d=8;#s=4;#w=new Float32Array(16);#S=null;#b="unavailable";#T=0;#g=0;#P=0;#O=0;#k=1;#y={width:1,height:1,left:0,top:0};#m=!0;#B=!1;#_=o7;constructor(C,H,V={}){this.#C=C,this.#H=H,this.#V=V,this.#r=H.getContext("2d",{alpha:!0}),this.#C.addEventListener("webglcontextlost",this.#L1),this.#C.addEventListener("webglcontextrestored",this.#e1),this.#q(),this.#v=new ResizeObserver(()=>{let L=this.#l,r=this.#d;this.#W(),this.#m&&(L!==this.#l||r!==this.#d)?this.fit(!1):this.requestRender()}),this.#v.observe(C)}get camera(){return{...this.#M}}#R(){return{minimum:Math.max(.2,this.#s*.04),maximum:this.#s*8}}#I(){let C=this.#o?.metadata.span,H=this.#o?.metadata.metersPerCell;return!C||H===void 0?{x:this.#s,z:this.#s}:{x:Math.max(.5,C[0]*H*.55),z:Math.max(.5,C[1]*H*.55)}}setCamera(C,H=!0){let V=this.#R(),L=this.#I();this.#M={yaw:R1(C.yaw),pitch:C.orthographic?Math.PI/2-.018:_(C.pitch,.18,1.38),distance:_(C.distance,V.minimum,V.maximum),targetX:_(C.targetX,-L.x,L.x),targetZ:_(C.targetZ,-L.z,L.z),orthographic:C.orthographic},this.#m=!1,this.requestRender(),H&&this.#G()}cameraAfterPan(C,H,V){let L=this.#D(),r=C.distance*1.75/Math.max(200,L.height),t=Math.cos(C.yaw),M=-Math.sin(C.yaw),o=-Math.sin(C.yaw),i=-Math.cos(C.yaw),a=this.#I();return{...C,targetX:_(C.targetX-H*r*t+V*r*o,-a.x,a.x),targetZ:_(C.targetZ-H*r*M+V*r*i,-a.z,a.z)}}setState(C){if(this.#B)return;let H=this.#p;this.#p=C;let V=C.resources.scene.value;V!==this.#o&&(this.#o=V,this.#E(V)),(!H||H.quality!==C.quality)&&(this.#k=M7(C.quality),this.#O=0);let L=H?.workflow!=="draw"&&C.workflow==="draw",r=H?.workflow==="draw"&&C.workflow!=="draw";if(!H||H.view!==C.view||L||r){let t=C.workflow==="draw"?"top":C.view;this.#M=this.#j(t,C),this.#m=this.#Q(t,C)}C.workflow==="draw"&&H?.draw.zoomPercent!==C.draw.zoomPercent&&(this.#M={...this.#M,orthographic:!0,pitch:Math.PI/2-.018,distance:this.#d*100/C.draw.zoomPercent},this.#m=C.draw.zoomPercent===100&&Math.abs(this.#M.targetX)<.001&&Math.abs(this.#M.targetZ)<.001&&Math.abs(R1(this.#M.yaw))<.001),this.requestRender()}#j(C,H){let V=C==="top",L=V?this.#d:this.#l,r=H.cameras[C];return r?{yaw:r.yaw,pitch:V?Math.PI/2-.018:r.pitch,distance:_(L/_(r.zoom,.01,100),Math.max(.2,this.#s*.04),this.#s*8),targetX:_(r.targetX,-this.#s,this.#s),targetZ:_(r.targetZ,-this.#s,this.#s),orthographic:V}:V?{yaw:0,pitch:Math.PI/2-.018,distance:L,targetX:0,targetZ:0,orthographic:!0}:{yaw:-Math.PI/4,pitch:.82,distance:L,targetX:0,targetZ:0,orthographic:!1}}#Q(C,H){let V=H.cameras[C];if(!V)return!0;let L=C==="top";return Math.abs(V.zoom-1)<.001&&Math.abs(V.targetX)<.001&&Math.abs(V.targetZ)<.001&&Math.abs(R1(V.yaw-(L?0:-Math.PI/4)))<.001&&(L||Math.abs(V.pitch-.82)<.001)}#K(C,H){let V=this.#e;if(!V)throw new Error("webgl-unavailable");let L=V.createShader(C);if(!L)throw new Error("shader-unavailable");if(V.shaderSource(L,H),V.compileShader(L),!V.getShaderParameter(L,V.COMPILE_STATUS))throw V.deleteShader(L),new Error("shader-failed");return L}#q(){try{this.#e=this.#C.getContext("webgl2",{alpha:!0,antialias:!0,depth:!0,powerPreference:"high-performance"});let C=this.#e;if(!C)throw new Error("webgl2-unavailable");let H=this.#K(C.VERTEX_SHADER,`#version 300 es
      ...
      `),L=C.createProgram();if(!L)throw new Error("program-unavailable");if(C.attachShader(L,H),C.attachShader(L,V),C.linkProgram(L),C.deleteShader(H),C.deleteShader(V),!C.getProgramParameter(L,C.LINK_STATUS))throw new Error("program-failed");this.#a=L,this.#c=C.getUniformLocation(L,"uViewProjection"),this.#h=C.getUniformLocation(L,"uCenter"),this.#x=C.getUniformLocation(L,"uMetersPerCell"),this.#i=C.getUniformLocation(L,"uPointPixels"),this.#f=C.getUniformLocation(L,"uMaxPointPixels"),this.#A=C.createBuffer(),this.#L=C.createVertexArray(),C.bindVertexArray(this.#L),C.bindBuffer(C.ARRAY_BUFFER,this.#A),C.enableVertexAttribArray(0),C.vertexAttribIPointer(0,2,C.UNSIGNED_SHORT,8,0),C.enableVertexAttribArray(1),C.vertexAttribIPointer(1,1,C.UNSIGNED_BYTE,8,4),C.enableVertexAttribArray(2),C.vertexAttribPointer(2,3,C.UNSIGNED_BYTE,!0,8,5),C.bindVertexArray(null),C.enable(C.DEPTH_TEST),C.depthFunc(C.LEQUAL),C.enable(C.BLEND),C.blendFunc(C.SRC_ALPHA,C.ONE_MINUS_SRC_ALPHA),this.#b="webgl2",this.#T+=1,this.#o&&this.#N(this.#o)}catch{this.#Y(),this.#F()}}#E(C){if(this.#z(),!C){this.#g=0,this.requestRender();return}let[H,V]=C.metadata.span,L=C.metadata.metersPerCell,r=H*L,t=V*L;this.#s=Math.max(1,Math.hypot(r,t)/2),this.#W(),this.fit(!1),this.#b==="webgl2"?this.#N(C):this.#$(C)}#W(){let C=this.#o;if(!C)return;let[H,V]=C.metadata.span,L=C.metadata.metersPerCell,r=H*L,t=V*L,M=this.#D(),o=Math.max(.2,M.width/Math.max(1,M.height));this.#l=a7(this.#s,o),this.#d=Math.max(t/2,r/(2*o))*1.12}#N(C){let H=this.#e;if(!H||!this.#A)return;let V=new Uint8Array(C.buffer,C.pointOffset,C.total*8);H.bindBuffer(H.ARRAY_BUFFER,this.#A),H.bufferData(H.ARRAY_BUFFER,V,H.STATIC_DRAW),this.#g=C.total}#F(){this.#b="canvas2d",this.#n=document.createElement("canvas"),this.#n.width=1024,this.#n.height=1024,this.#t=this.#n.getContext("2d",{alpha:!0}),this.#t?this.#o&&this.#$(this.#o):(this.#b="unavailable",this.#V.onProblem?.("renderer-unavailable"))}#$(C){let H=this.#t;if(!H||!this.#n)return;H.clearRect(0,0,this.#n.width,this.#n.height);let V=new DataView(C.buffer,C.pointOffset,C.total*8),L=Math.min(C.total,5e4),r=Math.max(1,Math.ceil(C.total/L)),t=0,M=0,o=()=>{if(this.#B||C!==this.#o||!this.#n)return;let i=Math.min(C.total,t+r*4e3);for(;t<i;t+=r){let a=t*8,n=V.getUint16(a,!0)/Math.max(1,C.metadata.span[0])*this.#n.width,A=V.getUint16(a+2,!0)/Math.max(1,C.metadata.span[1])*this.#n.height,d=V.getUint8(a+5),m=V.getUint8(a+6),x=V.getUint8(a+7);H.fillStyle=`rgb(${d} ${m} ${x})`,H.fillRect(n,A,1.5,1.5),M+=1}this.#g=M,this.requestRender(),t<C.total?this.#Z=window.setTimeout(o,0):this.#Z=null};o()}#z(){this.#Z!==null&&window.clearTimeout(this.#Z),this.#Z=null}#D(){let C=this.#C.getBoundingClientRect();return this.#y={width:C.width,height:C.height,left:C.left,top:C.top},this.#y}#J(){let C=this.#D(),H=Math.min(window.devicePixelRatio||1,3),V=Math.max(1,Math.round(C.width*H)),L=Math.max(1,Math.round(C.height*H));for(let r of[this.#C,this.#H])(r.width!==V||r.height!==L)&&(r.width=V,r.height=L)}#X(){let C=this.#y,H=Math.max(.2,C.width/Math.max(1,C.height)),V=Math.cos(this.#M.pitch)*this.#M.distance,L=[this.#M.targetX+Math.sin(this.#M.yaw)*V,Math.sin(this.#M.pitch)*this.#M.distance,this.#M.targetZ+Math.cos(this.#M.yaw)*V],r=[this.#M.targetX,0,this.#M.targetZ],t=d7(L,r),M=this.#M.orthographic?l7(-this.#M.distance*H,this.#M.distance*H,-this.#M.distance,this.#M.distance,-this.#s*4,this.#s*4):A7(K3,H,.02,Math.max(60,this.#s*12));return n7(M,t)}requestRender(){this.#u!==null||this.#B||(this.#u=window.requestAnimationFrame(()=>{this.#u=null,this.#C1()}))}#C1(){let C=performance.now();this.#J(),this.#w=this.#X(),this.#b==="webgl2"?this.#H1():this.#r1(),this.#M1(),this.#P=performance.now()-C,this.#P>18?(this.#O+=1,this.#O>=3&&this.#p?.quality==="auto"&&(this.#k=Math.max(.25,this.#k*.75))):this.#O=Math.max(0,this.#O-1)}#H1(){let C=this.#e,H=this.#o;if(!C||(C.viewport(0,0,this.#C.width,this.#C.height),C.clearColor(0,0,0,0),C.clear(C.COLOR_BUFFER_BIT|C.DEPTH_BUFFER_BIT),!H||!this.#a||!this.#L))return;if(this.#p?.view==="top"&&this.#p.appearance==="rooms"){this.#g=0;return}C.useProgram(this.#a),C.bindVertexArray(this.#L),C.uniformMatrix4fv(this.#c,!1,this.#w),C.uniform2f(this.#h,(H.metadata.span[0]-1)/2,(H.metadata.span[1]-1)/2),C.uniform1f(this.#x,H.metadata.metersPerCell);let V=Math.min(window.devicePixelRatio||1,3),L=Math.max(1,Math.floor(H.total*this.#k)),r=Math.min(H.floorCount,L),t=Math.min(H.surfaceCount,Math.max(0,L-r));C.uniform1f(this.#i,this.#C.height*.038),C.uniform1f(this.#f,4.5*V),C.drawArrays(C.POINTS,0,r),C.uniform1f(this.#i,this.#C.height*.05),C.uniform1f(this.#f,7*V),C.drawArrays(C.POINTS,H.floorCount,t),C.bindVertexArray(null),this.#g=r+t}#r1(){}#t1(C,H,V=0){let L=this.#o;return L?[-(C-(L.metadata.span[0]-1)/2)*L.metadata.metersPerCell,V*L.metadata.metersPerCell,(H-(L.metadata.span[1]-1)/2)*L.metadata.metersPerCell]:null}#V1(C,H,V=0,L=!0){let r=this.#t1(C,H,V);if(!r)return null;let[t,M,o]=r,i=this.#w,a=(i[0]??0)*t+(i[4]??0)*M+(i[8]??0)*o+(i[12]??0),n=(i[1]??0)*t+(i[5]??0)*M+(i[9]??0)*o+(i[13]??0),A=(i[3]??0)*t+(i[7]??0)*M+(i[11]??0)*o+(i[15]??0);if(A<=.001)return null;let d=a/A,m=n/A;if(!Number.isFinite(d)||!Number.isFinite(m)||L&&(Math.abs(d)>1.15||Math.abs(m)>1.15))return null;let x=this.#y;return{x:(d*.5+.5)*x.width,y:(-m*.5+.5)*x.height}}#U(C,H,V=0){let L=this.#o;if(!L)return null;let r=C/L.metadata.metersPerCell-L.metadata.origin[0],t=H/L.metadata.metersPerCell-L.metadata.origin[1];return this.#V1(r,t,V)}#M1(){let C=this.#r,H=this.#o,V=this.#p;if(!C)return;let L=Math.min(window.devicePixelRatio||1,3),r=this.#y;if(C.setTransform(L,0,0,L,0,0),C.clearRect(0,0,r.width,r.height),!H||!V)return;let t=this.#_;if(this.#b==="canvas2d"&&this.#n&&!(V.view==="top"&&V.appearance==="rooms")){let a=this.#d/this.#M.distance,n=r.width*a,A=r.height*a,d=(r.width-n)/2-this.#M.targetX*32*a,m=(r.height-A)/2-this.#M.targetZ*32*a;C.drawImage(this.#n,d,m,n,A)}let M=this.#o1(V);if(V.labelsVisible||V.view==="top"&&V.appearance==="rooms"){C.lineWidth=1.5,C.font="600 12px system-ui, sans-serif",C.textAlign="center",C.textBaseline="middle";let a=[];for(let n of H.metadata.rooms){let A=M.has(n.name.toLocaleLowerCase());C.strokeStyle=A?B(t.accent,1):B(t.quiet,.7),C.fillStyle=A?B(t.accent,.26):V.view==="top"&&V.appearance==="rooms"?B(t.roomFill,.94):B(t.plate,.04),C.beginPath();let d=Math.max(1,Math.ceil(n.boundary.length/512)),m=!1;for(let f=0;f<n.boundary.length;f+=d){let S=n.boundary[f];if(!S)continue;let y=this.#V1(S[0],S[1],.2,!1);y&&(m?C.lineTo(y.x,y.y):C.moveTo(y.x,y.y),m=!0)}if(m&&(C.closePath(),C.fill(),C.stroke()),!V.labelsVisible)continue;let x=this.#V1(n.center[0],n.center[1],1);if(!x)continue;let h=C.measureText(n.name).width,u=new DOMRect(x.x-h/2-6,x.y-10,h+12,20);a.some(f=>u.left<f.right+8&&u.right+8>f.left&&u.top<f.bottom+4&&u.bottom+4>f.top)||(a.push(u),C.fillStyle=B(t.plate,.88),C.fillRect(u.x,u.y,u.width,u.height),C.fillStyle=B(t.text,1),C.fillText(n.name,x.x,x.y))}}let o=V.draw.circles;if((V.workflow==="draw"||V.workflow==="areaReview")&&o.length){C.fillStyle=B(t.accent,.22),C.strokeStyle=B(t.accent,.92),C.lineWidth=1.5;for(let a of o)this.#i1(C,a)}if(this.#S&&V.workflow==="draw"&&V.draw.tool!=="pan"){let a=this.#U(this.#S.x,this.#S.y),n=this.#U(this.#S.x+V.draw.brushMeters/2,this.#S.y);a&&n&&(C.beginPath(),C.arc(a.x,a.y,Math.max(2,Math.hypot(n.x-a.x,n.y-a.y)),0,Math.PI*2),C.strokeStyle=B(t.accent,1),C.lineWidth=2,C.stroke())}let i=V.resources.pose.value;if(V.map.exactPose&&i?.position&&V.dataMode==="live"){let a=this.#U(i.position[0],i.position[1],3);a&&(C.beginPath(),C.arc(a.x,a.y,7,0,Math.PI*2),C.fillStyle=B(t.accent,1),C.fill(),C.strokeStyle=B(t.onAccent,1),C.lineWidth=3,C.stroke())}}#o1(C){let H=C.resources.plans.value?.rooms||C.resources.areas.value?.rooms||[];return new Set(H.filter(V=>C.selection.roomIds.includes(V.roomId)).map(V=>V.name.toLocaleLowerCase()))}#i1(C,H){let V=this.#U(H.x,H.y),L=this.#U(H.x+H.radius,H.y);!V||!L||(C.beginPath(),C.arc(V.x,V.y,Math.max(1,Math.hypot(L.x-V.x,L.y-V.y)),0,Math.PI*2),C.fill(),C.stroke())}setPalette(C){this.#_=C,this.requestRender()}setCursor(C){this.#S=C,this.requestRender()}screenToMap(C,H){let V=this.#o;if(!V||!this.#M.orthographic)return null;let L=this.#D();if(!L.width||!L.height)return null;let r=this.#M.distance*2/L.height,t=this.#M.targetX+(C-L.left-L.width/2)*r,M=this.#M.targetZ+(H-L.top-L.height/2)*r,o=-t/V.metadata.metersPerCell+(V.metadata.span[0]-1)/2,i=M/V.metadata.metersPerCell+(V.metadata.span[1]-1)/2;return{x:(o+V.metadata.origin[0])*V.metadata.metersPerCell,y:(i+V.metadata.origin[1])*V.metadata.metersPerCell}}roomAt(C,H){let V=this.screenToMap(C,H),L=this.#o,r=this.#p;if(!V||!L||!r)return null;let t=V.x/L.metadata.metersPerCell-L.metadata.origin[0],M=V.y/L.metadata.metersPerCell-L.metadata.origin[1],o=L.metadata.rooms.find(i=>Q3(t,M,i.boundary));return o?this.#a1(o,r):null}containsMapPoint(C){let H=this.#o;if(!H)return!1;let V=C.x/H.metadata.metersPerCell-H.metadata.origin[0],L=C.y/H.metadata.metersPerCell-H.metadata.origin[1];return H.metadata.rooms.some(r=>Q3(V,L,r.boundary))}#a1(C,H){return(H.resources.plans.value?.rooms||H.resources.areas.value?.rooms||[]).find(L=>L.name.localeCompare(C.name,void 0,{sensitivity:"base"})===0)?.roomId||C.id}selectRoomAt(C,H){let V=this.roomAt(C,H);V&&this.#V.onRoom?.(V)}fit(C=!0){let H=this.#p?.view==="top"||this.#p?.workflow==="draw";this.#M=H?{yaw:0,pitch:Math.PI/2-.018,distance:this.#d,targetX:0,targetZ:0,orthographic:!0}:{yaw:-Math.PI/4,pitch:.82,distance:this.#l,targetX:0,targetZ:0,orthographic:!1},this.#m=!0,this.requestRender(),C&&this.#G()}zoomAt(C,H,V){let L=H===void 0||V===void 0?null:this.screenToMap(H,V),r=this.#R();if(this.#M={...this.#M,distance:_(this.#M.distance/C,r.minimum,r.maximum)},this.#m=!1,L&&H!==void 0&&V!==void 0){let t=this.screenToMap(H,V);t&&(this.#M={...this.#M,targetX:this.#M.targetX-(L.x-t.x),targetZ:this.#M.targetZ+(L.y-t.y)})}this.requestRender(),this.#G(H,V)}panBy(C,H){this.setCamera(this.cameraAfterPan(this.#M,C,H))}orbitBy(C,H){if(this.#M.orthographic){this.panBy(C,H);return}this.#M={...this.#M,yaw:R1(this.#M.yaw+C*.006),pitch:_(this.#M.pitch-H*.004,.18,1.38)},this.#m=!1,this.requestRender(),this.#G()}rotateBy(C){this.#M={...this.#M,yaw:R1(this.#M.yaw+C)},this.#m=!1,this.requestRender(),this.#G()}#G(C,H){let V=this.#M.orthographic?this.#d:this.#l,L=C===void 0||H===void 0?this.#y:this.#D(),r=C===void 0||H===void 0||!L.width||!L.height?void 0:{xPercent:_((C-L.left)/L.width*100,0,100),yPercent:_((H-L.top)/L.height*100,0,100)};this.#V.onCamera?.(this.camera,Math.round(V/this.#M.distance*100),r)}diagnostics(){return{mode:this.#b,contextGeneration:this.#T,sceneRevision:this.#o?.revision??null,sourcePoints:this.#o?.total??0,renderedPoints:this.#g,lastFrameMs:Math.round(this.#P*100)/100,slowFrames:this.#O,cameraDistance:this.#M.distance,fitDistance:this.#M.orthographic?this.#d:this.#l,fitActive:this.#m}}#L1=C=>{C.preventDefault(),this.#Y(),this.#F(),this.requestRender()};#e1=()=>{this.#Y(),this.#q(),this.requestRender()};#Y(){let C=this.#e;C&&(this.#A&&C.deleteBuffer(this.#A),this.#L&&C.deleteVertexArray(this.#L),this.#a&&C.deleteProgram(this.#a)),this.#A=null,this.#L=null,this.#a=null,this.#e=null}dispose(){this.#B||(this.#B=!0,this.#v.disconnect(),this.#C.removeEventListener("webglcontextlost",this.#L1),this.#C.removeEventListener("webglcontextrestored",this.#e1),this.#u!==null&&window.cancelAnimationFrame(this.#u),this.#u=null,this.#z(),this.#Y(),this.#n=null,this.#t=null,this.#r=null,this.#o=null,this.#p=null)}};var q3="component.matic_robot.common.",T=(e,C,H,V)=>{let L=V?{...V}:void 0,r=e?.(`${q3}${C}`,L);return r&&r!==`${q3}${C}`?r:V?Object.entries(V).reduce((t,[M,o])=>t.replaceAll(`{${M}}`,String(o)),H):H};var i1="matic-workspace-intent",H2="matic-workspace-action",X3="navigation-help",Y3=(e,C)=>{let H=(L,r,t)=>T(C,L,r,t);if(e.dataMode==="history")return e.map.available?H("v4_saved_map_description","Saved read-only map for {floor}. Live robot position is hidden.",{floor:e.floor.displayName}):e.resources.scene.status==="loading"?H("v4_saved_map_loading_description","The saved map is loading."):H("v4_saved_map_unavailable_description","This saved map is unavailable.");if(!s1(e))return H("v4_private_map_unavailable","The current private map is not available.");let V=i5(e)?H("v4_robot_position_verified","The robot position is verified."):H("v4_robot_position_hidden","The robot position is not shown.");return H("v4_live_map_description","Live map for {floor}. {pose}",{floor:e.floor.displayName,pose:V})},z2=class extends O{constructor(){super();this.state=k();this.narrow=!1;this.#C=null;this.#H=null;this.#V=null;this.#e=!1;this.#r=!1;this.#t=null;this.#n=[];this.#a=null;this.#A=null;this.#i=()=>{this.#h()};new j1(this,{container:()=>this.renderRoot?.querySelector(".camera-steps")??null,items:"button"})}static{this.properties={state:{attribute:!1},localize:{attribute:!1},narrow:{type:Boolean,reflect:!0}}}static{this.styles=[E,D,J,b`
    :host {
      display: block;
      min-width: 0;
      min-height: 0;
...
.map-root { border: 1px solid CanvasText; }
  ...
  `]}#C;#H;#V;#e;#r;#t;#n;#a;#A;#L(H,V,L){return T(this.localize,H,V,L)}connectedCallback(){super.connectedCallback(),this.#f()}firstUpdated(){let H=this.renderRoot.querySelector(".map-root"),V=this.renderRoot.querySelector(".scene-canvas"),L=this.renderRoot.querySelector(".overlay-canvas");!H||!V||!L||(this.#H=new C2(V,L,{onCamera:(r,t,M)=>{this.#o({type:"set-camera",view:this.state.workflow==="draw"?"top":this.state.view,camera:{yaw:r.yaw,pitch:r.pitch,zoom:t/100,targetX:r.targetX,targetZ:r.targetZ}}),this.state.workflow==="draw"&&t!==this.state.draw.zoomPercent&&this.#o({type:"set-zoom",value:t,...M?{originX:M.xPercent,originY:M.yPercent}:{}})},onRoom:r=>this.#o({type:"toggle-room",roomId:r}),onProblem:()=>this.#u("renderer-problem")}),this.#V=new J1(H,this.#H,{state:()=>this.state,onCircles:(r,t,M)=>this.#o({type:"set-draft-circles",circles:r,record:t,...M?{previous:M}:{}}),onRoom:r=>this.#o({type:"toggle-room",roomId:r})}),this.#H.setState(this.state),this.#h())}disconnectedCallback(){this.#p(),this.#V?.dispose(),this.#V=null,this.#H?.dispose(),this.#H=null,super.disconnectedCallback()}updated(H){this.#r&&(this.#r=!1,this.renderRoot.querySelector(".navigation-help button")?.focus()),H.has("state")&&this.#H?.setState(this.state)}#c(){let H=this.renderRoot?.querySelector(".map-root");!H||!this.#H||this.#H.setPalette(N3(H))}#h(){this.#x(),this.#a=window.requestAnimationFrame(()=>{this.#a=null,this.#A=window.setTimeout(()=>{this.#A=null,this.#c()},0)})}#x(){this.#a!==null&&window.cancelAnimationFrame(this.#a),this.#A!==null&&window.clearTimeout(this.#A),this.#a=null,this.#A=null}#i;#f(){if(!(typeof document>"u"||this.#t)&&(this.#t=new MutationObserver(this.#i),this.#t.observe(document.documentElement,{attributes:!0,attributeFilter:["style","class"]}),typeof window.matchMedia=="function")){this.#n=[window.matchMedia("(prefers-color-scheme: dark)"),window.matchMedia("(forced-colors: active)")];for(let H of this.#n)H.addEventListener("change",this.#i)}}#p(){this.#x(),this.#t?.disconnect(),this.#t=null;for(let H of this.#n)H.removeEventListener("change",this.#i);this.#n=[]}#o(H){this.dispatchEvent(new CustomEvent(i1,{detail:H,bubbles:!0,composed:!0}))}#u(H){this.dispatchEvent(new CustomEvent(H2,{detail:{id:H},bubbles:!0,composed:!0}))}#Z(H){this.#C=H.currentTarget,this.#e=!this.#e,this.#r=this.#e,this.requestUpdate()}#v(){if(!this.#e)return;this.#e=!1,this.requestUpdate();let H=this.#C;H?.isConnected&&H.focus()}#M(){for(let H of this.state.selection.roomIds)this.#o({type:"toggle-room",roomId:H})}#l(H,V){this.#H?.orbitBy(H,V)}#d(H){if(!(H.ctrlKey||H.metaKey||H.altKey)&&H.key==="Escape"){if(H.preventDefault(),this.#e){this.#v();return}this.#o({type:"dismiss-top-layer"});return}}rendererDiagnostics(){return this.#H?.diagnostics()??null}canvasIdentity(){return{scene:this.renderRoot.querySelector(".scene-canvas"),overlay:this.renderRoot.querySelector(".overlay-canvas")}}#s(){return this.state.host.connected?this.state.host.administrator?this.state.host.robotCount===0?{title:this.#L("v4_no_robot","No Matic robot set up"),detail:this.#L("v4_no_robot_detail","Set up a robot before opening its map.")}:this.state.dataMode==="history"?!this.state.map.available&&this.state.resources.scene.status==="loading"?{title:this.#L("v4_loading_saved_map","Loading saved map"),detail:this.#L("v4_loading_saved_map_detail","This read-only snapshot is still preparing.")}:this.state.map.available?null:{title:this.#L("v4_saved_map_unavailable","Saved map unavailable"),detail:this.#L("v4_saved_map_unavailable_detail","Choose another snapshot or return to the live map.")}:this.state.host.robotConnected?this.state.coherence==="verifying"||this.state.coherence==="booting"?{title:this.#L("v4_locating_map","Locating the current map"),detail:this.#L("v4_locating_map_detail","Map controls will return after the floor is verified.")}:!this.state.map.available&&this.state.resources.scene.status==="loading"?{title:this.#L("v4_loading_verified_map","Loading the verified map"),detail:this.#L("v4_loading_verified_map_detail","The current floor is verified. The private scene is still preparing.")}:this.state.map.available?this.state.activity==="problem"?{title:this.#L("v4_robot_attention","Robot needs attention"),detail:this.#L("v4_robot_attention_detail","Check the robot before starting another task.")}:null:{title:this.#L("v4_map_unavailable","Map unavailable"),detail:this.#L("v4_map_unavailable_detail","The private scene is not ready. No map data is shown until it is verified.")}:{title:this.#L("v4_robot_offline","Robot offline"),detail:this.#L("v4_robot_offline_detail","The last verified map stays read only and has no live position.")}:{title:this.#L("v4_admin_required","Administrator access required"),detail:this.#L("v4_private_map_hidden","Private map data is hidden.")}:{title:this.#L("v4_reconnecting","Reconnecting"),detail:this.#L("v4_reconnecting_detail","The verified map is read only until Home Assistant reconnects.")}}#w(H,V){let L=this.state,r=this.narrow,t=L.workflow==="draw",M=this.#L("v4_how_to_move","How to move the map"),o=H&&!t,i=o&&!r&&L.view==="top",a=o&&L.view==="three",n=!V,A=!r&&!t;return!o&&!n?l:s`
      <div class="map-rail" data-map-control>
        ...
        ${a?s`
          <div class="camera-steps ms-surface ms-surface--floating ms-segment" role="toolbar" aria-orientation="horizontal" aria-label=${this.#L("map_camera_controls","Map camera controls")}>
            <button class="ms-btn ms-btn--icon" type="button" aria-label=${this.#L("map_rotate_left","Rotate left")} aria-keyshortcuts="[" @click=${()=>this.#l(-52,0)}>${Z(f3)}</button>
            <button class="ms-btn ms-btn--icon" type="button" aria-label=${this.#L("map_tilt_down","Lower viewing angle")} aria-keyshortcuts="PageDown" @click=${()=>this.#l(0,30)}>${Z(x3)}</button>
            <button class="ms-btn ms-btn--icon" type="button" aria-label=${this.#L("map_tilt_up","Raise viewing angle")} aria-keyshortcuts="PageUp" @click=${()=>this.#l(0,-30)}>${Z(u3)}</button>
            <button class="ms-btn ms-btn--icon" type="button" aria-label=${this.#L("map_rotate_right","Rotate right")} aria-keyshortcuts="]" @click=${()=>this.#l(52,0)}>${Z(g3)}</button>
          </div>
        `:l}
        ...
        ${n?s`
          <div class="map-tools ms-surface ms-surface--floating ms-segment" role="group" aria-label=${this.#L("v4_map_tools","Map tools")}>
            ${V?l:s`
              ...
              >${Z(Z3)}<span class="ms-btn__label">${this.#L("v4_fit_map","Fit map")}</span></button>
            `}
            ${!V&&A?s`
              <button
                class="labels ms-btn"
              ...
              >${Z(h3)}<span class="ms-btn__label">${this.#L("v4_room_names","Room names")}</span></button>
              <button
    ...
    `}#S(H){let V=this.state;if(!H)return l;if(V.workflow==="draw"&&!this.narrow)return s`
      ...
      `:l}render(){let H=this.state,V=l5(H),L=this.#s(),r=H.map.available&&(s1(H)||H.dataMode==="history"),t=H.workflow==="draw"&&r,M=H.coherence==="verifying"||H.coherence==="booting";return s`
      <section
        class="map-root"
        tabindex="0"
...
`]}#C(H,V){return T(this.localize,H,V)}#H(H){this.dispatchEvent(new CustomEvent(i1,{detail:H,bubbles:!0,composed:!0}))}#V(H){let V=H.currentTarget.valueAsNumber;Number.isFinite(V)&&this.#H({type:"set-brush",value:V})}render(){let{draw:H}=this.state;return s`
    ...
    `}};customElements.get(B1)||customElements.define(B1,U2);var G2=["vacuum","mop","vacuum_and_mop"],Q2=["quick","standard","heavy_duty"],$=e=>e.currentTarget.value,j3=e=>e.currentTarget.checked,K2=class extends O{constructor(){super(...arguments);this.state=k();this._copyStatus="idle"}static{this.properties={state:{attribute:!1},localize:{attribute:!1},_copyStatus:{state:!0}}}static{this.styles=[E,D,J,b`
...
`]}#C;disconnectedCallback(){this.#C!==void 0&&clearTimeout(this.#C),this.#C=void 0,super.disconnectedCallback()}#H(H,V,L){return T(this.localize,H,V,L)}#V(H){return H==="vacuum"?this.#H("vacuum","Vacuum"):H==="mop"?this.#H("mop","Mop"):this.#H("vacuum_and_mop","Vacuum + mop")}#e(H){return H==="quick"?this.#H("quick","Quick"):H==="standard"?this.#H("standard","Optimal"):this.#H("heavy_duty","Heavy Duty")}#r(H){this.dispatchEvent(new CustomEvent(i1,{detail:H,bubbles:!0,composed:!0}))}#t(){return this.state.notice?s`
    ...
    `:l}#n(){switch(this.state.workflow){case"rooms":case"plan":return{loading:this.#H("v4_loading_rooms_plans","Loading rooms and plans\u2026"),unavailable:this.#H("v4_rooms_plans_unavailable","Rooms and plans are unavailable right now."),empty:this.#H("v4_no_rooms_plans","No rooms or plans are available yet.")};case"draw":case"areaReview":return{loading:this.#H("v4_loading_areas","Loading saved areas\u2026"),unavailable:this.#H("v4_areas_unavailable","Saved areas are unavailable right now."),empty:this.#H("v4_no_saved_areas","No saved areas yet. Draw one on the map.")};case"history":return{loading:this.#H("v4_loading_history","Loading map history\u2026"),unavailable:this.#H("v4_history_unavailable","Map history is unavailable right now."),empty:this.#H("v4_no_map_history","No saved map snapshots yet.")};default:return{loading:this.#H("map_loading","Loading\u2026"),unavailable:this.#H("v4_workspace_unavailable","This workspace is unavailable right now."),empty:this.#H("v4_nothing_saved","Nothing saved yet.")}}}#a(H,V,L){let r=this.#n();if(H==="loading"||H==="idle")return s`<div class="loading" role="status">${r.loading}</div>`;if(H==="error"){let t=this.state.workflow;return s`
      ...
      `}return H==="empty"?s`<div class="empty">${r.empty}</div>`:L}#A(){let H=this.state.resources.plans;return this.#a(H.status,H.problem,s`
      <div class="stack">
      ...
      <div class="split room-settings">
        <label class="field ms-field">${this.#H("v4_cleaning_system","Cleaning system")}
          <select
            ...
            @change=${L=>this.#r({type:"patch-room-settings",roomId:H,cleaningMode:$(L)})}
    ...
    `}#c(H){let V=this.state.planDraft.rooms,r=V.find(t=>t.roomId===H)?V.filter(t=>t.roomId!==H):[...V,{roomId:H,cleaningMode:"vacuum",coverageSetting:"standard"}];this.#r({type:"patch-plan-draft",patch:{rooms:r}})}#h(H,V){let L=this.state.planDraft.rooms.map((r,t)=>t===H?{...r,...V}:r);this.#r({type:"patch-plan-draft",patch:{rooms:L}})}#x(H,V){let L=H+V,r=[...this.state.planDraft.rooms];if(L<0||L>=r.length)return;let[t]=r.splice(H,1);t&&(r.splice(L,0,t),this.#r({type:"patch-plan-draft",patch:{rooms:r}}))}#i(){let H=this.state.resources.plans,V=H.value,L=this.state.planDraft,r=L.rooms.map(o=>({room:o,label:V?.rooms.find(i=>i.roomId===o.roomId)?.name||"Room",selected:!0})),t=(V?.rooms||[]).filter(o=>!L.rooms.some(i=>i.roomId===o.roomId)).map(o=>({room:{roomId:o.roomId,cleaningMode:"vacuum",coverageSetting:"standard"},label:o.name,selected:!1})),M=[...r,...t];return this.#a(H.status,H.problem,s`
      <div class="stack">
        <div class="split">
          ...
          <button class="ms-btn ms-btn--secondary" type="button" @click=${()=>this.#r({type:"select-plan",planId:null})}>${Z(_3)}<span class="ms-btn__label">${this.#H("plan_new","New plan")}</span></button>
        </div>
        <label class="field ms-field">${this.#H("plan_name","Plan name")}
          <input
            ...
            autocomplete="off"
            .value=${L.name}
            @input=${o=>this.#r({type:"patch-plan-draft",patch:{name:$(o)}})}
          >
        </label>
        <div class="split">
          <label class="field ms-field">${this.#H("plan_run_behavior","Run order")}
            <select
              .value=${L.runBehavior}
              @change=${o=>this.#r({type:"patch-plan-draft",patch:{runBehavior:$(o)==="ordered"?"ordered":"intelligent"}})}
            >
          ...
          ${M.map(({room:o,label:i,selected:a})=>{let n=a?L.rooms.findIndex(A=>A.roomId===o.roomId):-1;return s`
              <div class="room plan-room ms-row ms-row--stack" data-selected=${String(a)}>
                <label class="room-choice">
                  ...
                  ${a?s`
                    <span>
                      <button class="icon-button ms-btn ms-btn--icon" type="button" aria-label=${this.#H("move_room_up","Move {room} earlier",{room:i})} ?disabled=${n===0} @click=${A=>{A.preventDefault(),this.#x(n,-1)}}>${Z(T3)}</button>
                      <button class="icon-button ms-btn ms-btn--icon" type="button" aria-label=${this.#H("move_room_down","Move {room} later",{room:i})} ?disabled=${n===L.rooms.length-1} @click=${A=>{A.preventDefault(),this.#x(n,1)}}>${Z(B3)}</button>
                    </span>
                  `:l}
                </label>
                ${a?s`
                  <div class="split room-settings">
                    <label class="field ms-field">${this.#H("v4_cleaning_system","Cleaning system")}
                      <select .value=${o.cleaningMode} @change=${A=>this.#h(n,{cleaningMode:$(A)})}>${G2.map(A=>s`<option value=${A} ?selected=${A===o.cleaningMode}>${this.#V(A)}</option>`)}</select>
                    </label>
                    <label class="field ms-field">${this.#H("cleaning_mode","Cleaning mode")}
                      <select .value=${o.coverageSetting} @change=${A=>this.#h(n,{coverageSetting:$(A)})}>${Q2.map(A=>s`<option value=${A} ?selected=${A===o.coverageSetting}>${this.#e(A)}</option>`)}</select>
                    </label>
                  </div>
                `:l}
              </div>
        ...
        <div class="plan-options" role="group" aria-labelledby="completion-heading">
          <label class="checkbox"><input type="checkbox" .checked=${L.returnToBase} @change=${o=>this.#r({type:"patch-plan-draft",patch:{returnToBase:j3(o)}})}>${this.#H("plan_return_to_base","Return to the dock when finished")}</label>
          <label class="checkbox"><input type="checkbox" .checked=${L.finishCurrentRoom} @change=${o=>this.#r({type:"patch-plan-draft",patch:{finishCurrentRoom:j3(o)}})}>${this.#H("plan_finish_room","Finish the active room after Stop")}</label>
          ${L.finishCurrentRoom?s`<label class="field ms-field">${this.#H("plan_threshold","Finish threshold")} \u00b7 ${L.finishCurrentRoomThreshold}%<input type="range" min="0" max="100" step="5" .value=${String(L.finishCurrentRoomThreshold)} @input=${o=>this.#r({type:"patch-plan-draft",patch:{finishCurrentRoomThreshold:Number($(o))}})}></label>`:l}
        </div>
        <div class="toolbar">
          ${L.id?s`
            <button
    ...
    `}#p(){let H=this.state.areaDraft,V=H.canRebind||H.status==="review",L=H.status==="stale"||H.status==="unknown";return s`
      <div class="stack">
        ...
        <label class="field ms-field">${this.#H("area_name","Area name")}
          <input maxlength="128" autocomplete="off" .value=${H.name} @input=${r=>this.#r({type:"patch-area-draft",patch:{name:$(r)}})}>
        </label>
        <div class="split">
          <label class="field ms-field">${this.#H("v4_cleaning_system","Cleaning system")}
            <select .value=${H.cleaningMode} @change=${r=>this.#r({type:"patch-area-draft",patch:{cleaningMode:$(r)}})}>${G2.map(r=>s`<option value=${r} ?selected=${r===H.cleaningMode}>${this.#V(r)}</option>`)}</select>
          </label>
          <label class="field ms-field">${this.#H("cleaning_mode","Cleaning mode")}
            <select .value=${H.coverageSetting} @change=${r=>this.#r({type:"patch-area-draft",patch:{coverageSetting:$(r)}})}>${Q2.map(r=>s`<option value=${r} ?selected=${r===H.coverageSetting}>${this.#e(r)}</option>`)}</select>
          </label>
        </div>
        ...
        <div class="timeline">
          <label class="field ms-field">${this.#H("map_timeline_label","Map timeline")}
            <input
              ...
              .value=${String(t)}
              ?disabled=${!r.length}
              @input=${M=>{let o=Number($(M));this.#r({type:"set-history",historyId:o===r.length?null:r[o]?.id||null})}}
            >
          </label>
          <div class="list">
            ...
            ${r.map((M,o)=>s`
              <button class="snapshot ms-row ms-row" type="button" aria-current=${String(M.id===this.state.selection.historyId)} @click=${()=>this.#r({type:"set-history",historyId:M.id})}>
                <span>${this.#u(M.createdAt)}</span><small>${o+1} of ${r.length}</small>
              </button>
            `)}
          </div>
        </div>
    ...
    `)}#u(H){try{return new Intl.DateTimeFormat(this.state.locale,{dateStyle:"medium",timeStyle:"short"}).format(new Date(H))}catch{return this.#H("v4_saved_map","Saved map")}}#Z(){let H=this.state.resources.entry,V=this.#H("v4_yes","Yes"),L=this.#H("v4_no","No"),r=this.#H("v4_seen","Seen"),t=this.#H("v4_not_seen","Not seen"),M=this.#H("v4_unknown","Unknown");return[[this.#H("v4_connection","Connection"),this.state.host.connected?this.#H("v4_connected","Connected"):this.#H("v4_offline","Offline")],[this.#H("v4_map_state","Map state"),String(this.state.coherence)],[this.#H("v4_floor_verified","Floor verified"),this.state.map.floorCoherent?V:L],[this.#H("v4_session_verified","Session verified"),this.state.map.sessionVerified?V:L],[this.#H("v4_map_complete","Map complete"),this.state.map.complete?V:L],[this.#H("v4_map_health","Map health"),H?.health||M],[this.#H("v4_blocked_by","Blocked by"),H?.mapBlockReason?.replaceAll("_"," ")||this.#H("v4_nothing","Nothing")],[this.#H("v4_startup_map","Startup map check"),H?.bootstrapState?.replaceAll("_"," ")||M],[this.#H("v4_startup_photo","Startup photo layer"),H?.bootstrapPhotoSeen?r:t],[this.#H("v4_startup_structure","Startup structure layer"),H?.bootstrapStructureSeen?r:t],[this.#H("v4_startup_failures","Startup failures"),String(H?.bootstrapFailures||0)],[this.#H("v4_stream_failures","Stream failures"),String(H?.streamFailures||0)],[this.#H("v4_saved_floor_count","Saved floor count"),String(this.state.floor.classifiedCount)]]}#v(H){this.#C!==void 0&&clearTimeout(this.#C),this.#C=void 0,this._copyStatus=H,H==="copied"&&(this.#C=setTimeout(()=>{this.#C=void 0,this._copyStatus="idle"},2e3))}#M(H,V){if(typeof document>"u"||typeof document.execCommand!="function")return!1;let L=V??(document.activeElement instanceof HTMLElement?document.activeElement:null),r=document.createElement("textarea");r.value=H,r.readOnly=!0,r.setAttribute("aria-hidden","true"),r.style.cssText="position:fixed;inset-block-start:-1000px;inline-size:1px;block-size:1px;opacity:0",document.body.append(r),r.select(),r.setSelectionRange(0,H.length);try{return document.execCommand("copy")}catch{return!1}finally{r.remove(),L?.focus({preventScroll:!0})}}async#l(H){let V=this.#Z().map(([r,t])=>`${r}: ${t}`).join(`
`),L=typeof navigator>"u"?void 0:navigator.clipboard;if(L&&typeof L.writeText=="function")try{await L.writeText(V),this.#v("copied");return}catch{}this.#v(this.#M(V,H instanceof HTMLElement?H:null)?"copied":"failed")}#d(){let H=this.#Z(),V=this._copyStatus==="copied"?this.#H("v4_copied","Copied"):this._copyStatus==="failed"?this.#H("v4_copy_failed","The summary could not be copied. Select the text to copy it by hand."):"";return s`
      <div class="stack">
  ...
  `]}#C(H,V,L){return T(this.localize,H,V,L)}#H;#V;#e;#r;#t;#n;#a;#A;#L;#c;connectedCallback(){super.connectedCallback(),this.#H=new ResizeObserver(([H])=>{if(!H)return;let V=H.contentRect.width<768||H.contentRect.height<480;V!==this._measuredNarrow&&(this._measuredNarrow=V)}),this.#H.observe(this),window.addEventListener("pointerdown",this.#c,!0),document.addEventListener("fullscreenchange",this.#L),this.#V=new ResizeObserver(([H])=>{if(!H)return;let V=Math.ceil(H.target.getBoundingClientRect().height);V!==this._sheetOffset&&(this._sheetOffset=V)})}disconnectedCallback(){this.#H?.disconnect(),this.#H=null,this.#V?.disconnect(),this.#V=null,this.#e=null,window.removeEventListener("pointerdown",this.#c,!0),document.removeEventListener("fullscreenchange",this.#L),super.disconnectedCallback()}updated(H){let V=H,L=this.renderRoot.querySelector(".mobile-sheet");if(L!==this.#e&&(this.#V?.disconnect(),this.#e=L,L?this.#V?.observe(L):this._sheetOffset!==0&&(this._sheetOffset=0)),V.has("_overflowOpen")&&this._overflowOpen&&this.updateComplete.then(()=>{this.renderRoot.querySelector("#map-options select, #map-options button")?.focus()}),V.has("_helpOpen")){if(this._helpOpen)this.updateComplete.then(()=>{this.renderRoot.querySelector(".help-dialog [data-dialog-initial-focus]")?.focus()});else if(V.get("_helpOpen")){let r=this.#t;this.#t=null,this.updateComplete.then(()=>{requestAnimationFrame(()=>r?.focus({preventScroll:!0}))})}}if(H.has("state")){let r=H.get("state");if(r?.precisionOpen&&!this.state.precisionOpen&&this.#x()?.focus(),r?.fullMap&&!this.state.fullMap&&this.updateComplete.then(()=>{requestAnimationFrame(()=>this.renderRoot.querySelector(".workspace-toggle")?.focus({preventScroll:!0}))}),!r?.dialog&&this.state.dialog){let t=Z7(this.shadowRoot||document);t?.hasAttribute("data-dialog-launcher")&&(this.#r=t),this.updateComplete.then(()=>{(this.renderRoot.querySelector(".dialog [data-dialog-initial-focus]")??this.renderRoot.querySelector(".dialog button"))?.focus()})}else if(r?.dialog&&!this.state.dialog){let t=this.#r?.isConnected&&this.#r.hasAttribute("data-dialog-launcher")?this.#r:this.#I(r.dialog);this.#r=null,this.updateComplete.then(()=>{requestAnimationFrame(()=>t?.focus({preventScroll:!0}))})}r?r.workflow!==this.state.workflow&&(this._sheetDetent=V0[this.state.workflow],this.updateComplete.then(()=>this.#h())):this._sheetDetent=V0[this.state.workflow]}}#h(){let H=this.renderRoot.querySelector(".panel-heading h2");if(q2(H)){H.focus({preventScroll:!0});return}let V=this.renderRoot.querySelector(".action-bar .ms-btn--primary");q2(V)&&V.focus({preventScroll:!0})}#x(){let H=this.renderRoot.querySelector(".draw-brush");return q2(H)?H:this.renderRoot.querySelector(t1)?.shadowRoot?.querySelector(".draw-brush")??null}#i(H){this.dispatchEvent(new CustomEvent(i1,{detail:H,bubbles:!0,composed:!0}))}#f(H){if(H.enabled){if(H.id==="return-live"){this.#i({type:"set-history",historyId:null});return}if(H.id==="clear-draft"){this.#i({type:"clear-draft"});return}this.#v(H.id)}}#p(H){if(this.state.workflow==="draw"&&this.state.draw.dirty&&H!=="draw"&&H!=="areaReview"){this.#n=H,this.#i({type:"open-dialog",dialog:"discardDraft"});return}this.#i({type:"open-workflow",workflow:H})}#o(){let H=this.#n;this.#n=null,this.#i({type:"discard-draft"}),H&&queueMicrotask(()=>this.#i({type:"open-workflow",workflow:H}))}#u(){this.#n=null,this.#Z()}#Z(){let H=this.state.dialog,V=H&&this.#r?.isConnected&&this.#r.hasAttribute("data-dialog-launcher")?this.#r:H?this.#I(H):null;this.#i({type:"dismiss-top-layer"}),V&&requestAnimationFrame(()=>V.focus({preventScroll:!0}))}#v(H){this.dispatchEvent(new CustomEvent(H2,{detail:{id:H},bubbles:!0,composed:!0}))}#M(H){this.#i({type:"dismiss-top-layer"}),this.#v(H)}#l(H){if(H.action==="discard"){this.#o();return}if(H.action==="delete-plan"||H.action==="delete-area"){this.#M(H.action);return}this.#i({type:"dismiss-top-layer"}),H.action==="stop"&&this.#v("stop")}#d(H){H!==this._sheetDetent&&(this._sheetDetent=H,this._announcement=this.#C("v4_workspace_height","Map workspace, {height} height",{height:H}))}#s(H,V=!1){let r=C1.indexOf(this._sheetDetent)+H;V&&r>=C1.length&&(r=0),r=Math.max(0,Math.min(C1.length-1,r)),this.#d(C1[r]??this._sheetDetent)}#w(H){let V=this.renderRoot.querySelector(".workspace")?.clientHeight??H.parentElement?.clientHeight??H.offsetHeight,L=parseFloat(getComputedStyle(this).fontSize)||16,r=[".sheet-grip",".sheet-tools",".action-bar"].map(o=>H.querySelector(o)?.offsetHeight??0).reduce((o,i)=>o+i,0)+L*.75,t=Math.min(V*.92,V-L*4),M=Math.min(V*.48,L*26,t);return{peek:Math.min(r,M),half:M,full:t}}#S(){return this.renderRoot.querySelector(".mobile-sheet")}#b(H){if(H.pointerType==="mouse"&&H.button!==0||H.target?.closest("button, select, input, a"))return;let V=this.#S();!V||this.#a||(this.#a={pointerId:H.pointerId,startY:H.clientY,startHeight:V.offsetHeight,heights:this.#w(V),samples:[{y:H.clientY,t:H.timeStamp}],moved:!1},H.currentTarget.setPointerCapture(H.pointerId),V.classList.add("dragging"))}#T(H){let V=this.#a;if(!V||H.pointerId!==V.pointerId)return;let L=this.#S();if(!L)return;let r=H.clientY-V.startY;for(!V.moved&&Math.abs(r)>v7&&(V.moved=!0),V.samples.push({y:H.clientY,t:H.timeStamp});V.samples.length>2&&H.timeStamp-(V.samples[1]?.t??0)>m7;)V.samples.shift();if(!V.moved)return;let t=V.startHeight-V.heights.full,M=V.startHeight-V.heights.peek,o=Math.max(t,Math.min(M,r));L.style.transform=`translateY(${o}px)`}#g(H){let V=this.#a;if(!V||H.pointerId!==V.pointerId)return;this.#a=null;let L=this.#S();if(L&&(L.style.transform="",L.classList.remove("dragging")),H.type==="pointercancel")return;if(!V.moved){this.#s(1,!0);return}let r=H.clientY-V.startY,t=C1.indexOf(this._sheetDetent),M=V.samples[0],o=V.samples[V.samples.length-1],i=M&&o&&o!==M?(o.y-M.y)/Math.max(1,o.t-M.t):0;if(Math.abs(i)>p7){let d=Math.max(0,Math.min(C1.length-1,t+(i<0?1:-1)));this.#d(C1[d]??this._sheetDetent);return}let a=V.startHeight-r,n=this._sheetDetent,A=Number.POSITIVE_INFINITY;for(let d of C1){let m=Math.abs(V.heights[d]-a);m<A&&(A=m,n=d)}this.#d(n)}#P(H){if(H.pointerType==="mouse")return;let V=H.currentTarget;this.#A={pointerId:H.pointerId,startY:H.clientY,atTop:V.scrollTop===0,consumed:!1}}#O(H){let V=this.#A;if(!V||V.consumed||!V.atTop||H.pointerId!==V.pointerId)return;if(H.currentTarget.scrollTop>0){this.#A=null;return}H.clientY-V.startY<c7||(V.consumed=!0,this.#s(-1))}#k(){this.#A=null}#y(H){this._overflowOpen=!1,H&&this.updateComplete.then(()=>{this.renderRoot.querySelector(".overflow")?.focus()})}#m(H){if(this.#y(H==="fullscreen"),H==="support"){this.#p("support");return}if(H==="fullscreen"){let V=this.renderRoot.querySelector(".app");document.fullscreenElement?document.exitFullscreen():V?.requestFullscreen();return}this.dispatchEvent(new CustomEvent(H2,{detail:{id:"use-classic"},bubbles:!0,composed:!0}))}#B(){this.#i({type:"set-precision-open",value:!this.state.precisionOpen})}#_(H){this.#t=H.currentTarget,this._helpOpen=!0}#R(H){let V=H;if(V.detail?.type!=="open-dialog")return;let L=V.composedPath().find(r=>r instanceof HTMLElement&&r.hasAttribute("data-dialog-launcher"));L instanceof HTMLElement&&(this.#r=L)}#I(H){return this.renderRoot.querySelector(c1)?.shadowRoot?.querySelector(`[data-dialog-launcher="${H}"]`)??null}#j(H){if(!(H.defaultPrevented||H.ctrlKey||H.metaKey||H.altKey)&&H.key==="Escape"){if(H.preventDefault(),this._overflowOpen){this.#y(!0);return}if(this._helpOpen){this._helpOpen=!1;return}this.#i({type:"dismiss-top-layer"})}}#Q(H){if(H.key!=="Tab")return;let L=[...H.currentTarget.querySelectorAll(u7)],r=L[0],t=L.at(-1);if(!r||!t)return;let M=this.shadowRoot?.activeElement;H.shiftKey&&M===r?(H.preventDefault(),t.focus()):!H.shiftKey&&M===t&&(H.preventDefault(),r.focus())}#K(){let H=this.renderRoot.querySelector(t1);(H?.shadowRoot?.querySelector(".map-root")??H)?.focus()}#q(){this._sheetDetent==="peek"&&this.#S()&&this.#d("half"),this.updateComplete.then(()=>this.#h())}#E(H,V,L){if(H.id==="choose-cleaning")return l;let r=H.labelKey?this.#C(H.labelKey,H.label):H.label,t=!H.enabled&&H.reason?H.reasonKey?this.#C(H.reasonKey,H.reason):H.reason:null,M=H.id==="stop";return v`
      <button
    ...
    `}#W(H){let V=H.resources.plans.value?.rooms??H.resources.areas.value?.rooms??[];return H.selection.roomIds.map(L=>V.find(r=>r.roomId===L)?.name??L)}#N(H,V,L){let r=V?.enabled&&H.workflow==="rooms"&&V.id==="clean-rooms"?[this.#W(H).join(", "),H.planDraft.returnToBase?this.#C("v4_returns_to_dock","returns to the dock"):""].filter(Boolean).join(" \xB7 "):"";return v`
    ...
    `}#z(H){let V=H.resources.history.value?.floors||[],L=V.length?V.map((r,t)=>({id:r.active?"current":r.id,label:`${r.label||(r.active?this.#C("v4_current_floor","Current floor"):this.#C("v4_saved_floor","Saved floor {number}",{number:r.ordinal??t+1}))}${!r.active&&r.snapshots.length===0?` \xB7 ${this.#C("v4_floor_not_captured","Visit floor to capture")}`:""}`,disabled:!r.active&&r.snapshots.length===0})):[{id:H.selection.floorId,label:H.floor.displayName,disabled:!1}];return v`
      ...
      `)}</select>
    `}#D(H,V){let L=(x,h,u)=>this.#C(x,h,u),r=this.#$(L("v4_map_history","Map history"),$2,()=>this.#p("history"),L("v4_map_history_detail","Saved maps are floor-scoped and read only.")),t=this.#$(L("v4_map_diagnostics","Map diagnostics"),D3,()=>this.#p("support"),L("v4_map_support_detail","Private geometry is never included.")),{host:M}=H;if(!M.connected)return this.#F(L("v4_reconnecting_title","Reconnecting to Home Assistant"),L("v4_reconnecting_body","The last verified map stays read-only until the connection returns."));if(!M.administrator)return this.#F(L("v4_admin_title","Administrator access required"),L("v4_admin_body","Ask a Home Assistant administrator to open this map."));if(M.robotCount===0)return this.#F(L("v4_no_robot_title","No Matic robot set up"),L("v4_no_robot_body","Add the Matic integration to see a map here."),v`<a class="ms-btn ms-btn--secondary" href="/config/integrations/integration/matic_robot">${L("v4_open_integration","Open the Matic integration")}</a>`);if(!M.robotConnected)return v`
        ${this.#F(L("v4_robot_offline_title","Robot offline"),L("v4_robot_offline_body","Showing the last verified map. Cleaning is unavailable until the robot reconnects."))}
      ...
      ${H.activity==="problem"?this.#F(L("v4_attention_title","The robot needs attention"),L("v4_attention_body","Check the robot, then start a new task.")):v`
          <div class="quick-actions" aria-label=${L("v4_cleaning_choices","Cleaning choices")}>
            ...
            <button
              ...
              @click=${()=>{o||this.#p("plan")}}
            >
              <span class="ms-row__lead">${Z(E3)}</span>
              <span class="ms-row__body">
      ...
      <h3 class="shelf-heading">${L("v4_more","Map tools")}</h3>
      <div class="shelf">
        ${this.#$(L("v4_custom_areas","Clean a custom area"),F3,()=>this.#p("draw"),L("v4_areas_quick_detail","Draw a precise area on the map"))}
        ${r}
        ${V?this.#z(H):l}
      </div>
      ${V?v`
      ...
      `:l}
    `}#J(H,V){return H.workflow==="none"?this.#D(H,V):v`<${C0}
      .state=${H}
      .localize=${this.localize}
      @matic-workspace-intent=${this.#R}
    ></${C0}>`}#X(H,V){let L=H0(H,this.localize);return v`
      <div class="panel-heading">
        ${H.workflow!=="none"?v`
          <button
            ...
            @click=${()=>this.#p(H.workflow==="areaReview"?"draw":"none")}
      ...
      ${this.#J(H,V)}
    `}#C1(H,V){let r=H0(H,this.localize).title;return H.workflow==="rooms"&&H.selection.roomIds.length&&(r=`${this.#C("v4_rooms_selected","{count} rooms selected",{count:H.selection.roomIds.length})} \xB7 ${this.#W(H).join(", ")}`),this._sheetDetent!=="peek"?V.detail?`${V.title} \xB7 ${V.detail}`:V.title:V.notable?`${V.title} \xB7 ${r}`:r}#H1(){let H=(V,L)=>this.#C(V,L);return v`
    ...
    `}render(){let H=this.state,V=H.narrowHint||this._measuredNarrow,L=s7(H,this.localize),r=n5({...H,narrowHint:V}),t=A5(H),M=!V&&r.id==="stop"?r:!V&&t?.id==="stop"?t:null,o=M&&M===r?null:r,i=H.workflow==="draw"&&H.dataMode==="live"?{id:"clear-draft",label:"Clear drawing",labelKey:"v4_clear_drawing",kind:"neutral",enabled:H.draw.circles.length>0}:null,a=M&&M===t?null:t??i,n=H.fullMap&&(H.coherence==="verifying"||H.coherence==="booting"),A=H.fullMap||H.host.administrator&&H.host.robotCount>0&&H.map.available,d=x7(H.dialog,this.localize),m=V&&!H.fullMap?`--map-sheet-offset:${this._sheetOffset}px`:"--map-sheet-offset:0px",x=V&&H.workflow==="draw",h=H.precisionOpen&&H.workflow==="draw";return v`
      <div class=${`root ${V?"narrow":"wide"}`} @keydown=${this.#j}>
        <button class="skip-link ms-btn ms-btn--primary" type="button" @click=${this.#K}>${this.#C("v4_skip_to_map","Skip to the map")}</button>
        <button class="skip-link ms-btn ms-btn--primary" type="button" @click=${this.#q}>${this.#C("v4_skip_to_workspace","Skip to the map workspace")}</button>
          ...
          <header class="app-bar">
            ...
            ${H.robots.length>1?v`
              <select
                ...
                @change=${u=>this.#i({type:"select-entry",entryId:u.currentTarget.value})}
              >${H.robots.map(u=>v`
            ...
            ${A?v`
              <button
                ...
                @click=${()=>this.#i({type:H.fullMap?"exit-full-map":"enter-full-map"})}
              >${Z(m3)}</button>
            `:l}
                ...
                <div id="map-options" class="overflow-menu ms-surface ms-surface--overlay">
                  <label class="overflow-field ms-field">${this.#C("map_quality_label","Scene detail")}
                    <select
                      ...
                      .value=${H.quality}
                      @change=${u=>this.#i({type:"set-quality",quality:u.currentTarget.value})}
                    >
                  ...
                  <button class="ms-row ms-row--menu" type="button" @click=${()=>this.#m("support")}>${this.#C("v4_map_diagnostics","Map diagnostics")}</button>
                  <button class="ms-row ms-row--menu" type="button" @click=${()=>this.#m("classic")}>${this.#C("v4_switch_classic","Switch to Map Studio 0.3")}</button>
                  <button class="ms-row ms-row--menu" type="button" @click=${()=>this.#m("fullscreen")}>${this._browserFullscreen?this.#C("v4_leave_full_screen","Leave full screen"):this.#C("v4_full_screen","Full screen")}</button>
                </div>
              `:l}
            </div>
          </header>
            ...
            >
              ${V?v`
                ...
                >
                  ...
                  <span class="sheet-status">${this.#C1(H,L)}</span>
                  <button
                ...
                ${x?v`
                  <div class="sheet-tools">
                    ${Y1(H,{intent:u=>this.#i(u),openBrush:()=>this.#B(),t:(u,f)=>this.#C(u,f)},"grid")}
                    ${h?v`
                      <div class="precision-popover">
            ...
            >
              ...
              <div class="dialog-actions">
                <button
                  ...
                  type="button"
                  data-dialog-initial-focus
                  @click=${H.dialog==="discardDraft"?this.#u:this.#Z}
    ...
    `}};customElements.get(M1)||customElements.define(M1,X2);var L0=j(M1),Y2=class extends O{constructor(){super(...arguments);this.scenario="ready";this.narrow=!1;this.controls=!0;this._workspace=u2("ready");this.#C=new d1(this._workspace);this.#H=null}static{this.properties={scenario:{type:String,reflect:!0},narrow:{type:Boolean,reflect:!0},controls:{type:Boolean,reflect:!0},_workspace:{state:!0}}}static{this.styles=[E,D,b`
    :host {
      display: block;
      color: #1f2933;
      background: #e8edef;
  ...
  `]}#C;#H;connectedCallback(){super.connectedCallback(),this.#H=this.#C.subscribe(H=>{this._workspace=H})}disconnectedCallback(){this.#H?.(),this.#H=null,super.disconnectedCallback()}willUpdate(H){H.has("scenario")?this.#C.replace({...u2(this.scenario),narrowHint:this.narrow}):H.has("narrow")&&this.#C.dispatch({type:"set-narrow-hint",value:this.narrow})}setScenario(H){x2.includes(H)&&(this.scenario=H)}getWorkspaceSnapshot(){return structuredClone(this.#C.value)}replaceWorkspaceState(H){this.#C.replace(structuredClone(H))}#V(H){I1(H.detail)&&(H.stopPropagation(),this.#C.dispatch(H.detail))}render(){return v`
    ...
    `}};customElements.get("matic-map-studio-gallery-v0-4-0")||customElements.define("matic-map-studio-gallery-v0-4-0",Y2);var e0="/api/matic_robot/slam_entries";var p=class extends Error{constructor(C){super(C),this.name="ContractError",this.code=C}},R=(e,C)=>{if(!e||typeof e!="object"||Array.isArray(e))throw new p(C);return e},w=(e,C,H)=>{if(typeof e!="string")throw new p(H);let V=e.trim();if(!V||Array.from(V).length>C||/[\u0000-\u001f\u007f]/u.test(V))throw new p(H);return V},h7=e=>{if(e==null||e==="")return null;try{return w(e,128,"invalid-floor-label")}catch{return null}},Z1=(e,C,H,V)=>{if(typeof e!="number"||!Number.isFinite(e)||e<C||e>H)throw new p(V);return e},N=(e,C,H,V)=>{let L=Z1(e,C,H,V);if(!Number.isInteger(L))throw new p(V);return L},j2=(e,C)=>e==null?null:N(e,1,C,"invalid-floor-ordinal"),g=(e,C)=>{if(typeof e!="boolean")throw new p(C);return e},S7=(e,C)=>e===null?null:g(e,C),r0=e=>{if(e==null)return null;let C=w(e,64,"invalid-map-session-key");if(!/^[0-9a-f]{64}$/u.test(C))throw new p("invalid-map-session-key");return C},f7=e=>{if(e==null)return null;if(e==="bootstrap_empty"||e==="map_session_unverified"||e==="floor_plan_unavailable"||e==="floor_plan_mismatch")return e;throw new p("invalid-map-block-reason")},g7=e=>{if(e===void 0)return"not_started";if(e==="not_started"||e==="running"||e==="complete"||e==="partial"||e==="failed")return e;throw new p("invalid-bootstrap-state")},q=(e,C)=>{let H=w(e,512,C);if(!H.startsWith("/")||H.startsWith("//")||H.includes("\\"))throw new p(C);return H},y7=e=>{let C=typeof e.map_health=="string"?e.map_health.toLowerCase():"",H=typeof e.stream_state=="string"?e.stream_state.toLowerCase():"",V=typeof e.invalid_tiles=="number"?e.invalid_tiles:0;return C.includes("error")||C.includes("fail")||C.includes("degrad")||V>0?"problem":e.map_truncated===!0||C.includes("truncat")||C.includes("limit")?"limited":e.map_complete===!0?"ready":H.includes("connect")||H.includes("collect")||H.includes("run")?"building":"unknown"},t0=e=>{let C=R(e,"invalid-catalog");if(!Array.isArray(C.entries)||C.entries.length>64)throw new p("invalid-catalog-entries");return C.entries.map(H=>{let V=R(H,"invalid-catalog-entry"),L=N(V.map_revision,0,Number.MAX_SAFE_INTEGER,"invalid-map-revision");return{entryId:w(V.entry_id,128,"invalid-entry-id"),sceneUrl:q(V.scene_url,"invalid-scene-url"),deltaUrl:V.delta_url===void 0||V.delta_url===null?null:q(V.delta_url,"invalid-delta-url"),poseUrl:q(V.pose_url,"invalid-pose-url"),historyUrl:q(V.history_url,"invalid-history-url"),areasUrl:q(V.areas_url,"invalid-areas-url"),plansUrl:q(V.plans_url,"invalid-plans-url"),mapRevision:L,mapFloorCoherent:g(V.map_floor_coherent,"invalid-floor-coherence"),mapSessionVerified:g(V.map_session_verified,"invalid-session-state"),mapSessionKey:r0(V.map_session_key),mapBlockReason:f7(V.map_block_reason),runnerLocked:g(V.runner_locked,"invalid-runner-lock"),stopSettlePending:g(V.stop_settle_pending,"invalid-stop-settle"),activePlan:g(V.active_plan,"invalid-active-plan"),nativeReconciliationPending:g(V.native_reconciliation_pending,"invalid-native-reconciliation"),nativeSessionActive:S7(V.native_session_active,"invalid-native-session"),mapComplete:g(V.map_complete,"invalid-map-complete"),mapTruncated:g(V.map_truncated,"invalid-map-truncated"),selectedFloorOrdinal:j2(V.selected_floor_ordinal,128),mapFloorOrdinal:j2(V.map_floor_ordinal,128),historyCount:N(V.history_count,0,12,"invalid-history-count"),historyFloorCount:N(V.history_floor_count,0,128,"invalid-floor-count"),health:y7(V),streamFailures:N(V.stream_failures,0,Number.MAX_SAFE_INTEGER,"invalid-stream-failures"),bootstrapState:g7(V.bootstrap_state),bootstrapPhotoSeen:V.bootstrap_photo_seen===void 0?!1:g(V.bootstrap_photo_seen,"invalid-bootstrap-photo"),bootstrapStructureSeen:V.bootstrap_structure_seen===void 0?!1:g(V.bootstrap_structure_seen,"invalid-bootstrap-structure"),bootstrapFailures:V.bootstrap_failures===void 0?0:N(V.bootstrap_failures,0,2,"invalid-bootstrap-failures")}})},M0=(e,C)=>{if(!Array.isArray(e)||e.length!==2)throw new p(C);return[Z1(e[0],-1e6,1e6,C),Z1(e[1],-1e6,1e6,C)]},b7=(e,C)=>{if(!Array.isArray(e)||e.length<3||e.length>8192)throw new p(C);return e.map(H=>M0(H,C))},o0=(e,C)=>{if(!Array.isArray(e)||e.length>256)throw new p("invalid-rooms");return e.map(H=>{let V=R(H,"invalid-room");return{roomId:w(V.room_id,128,"invalid-room-id"),name:w(V.name,128,"invalid-room-name"),boundary:C?b7(V.boundary,"invalid-room-boundary"):[]}})},O7=e=>{let C=R(e,"invalid-history-snapshot"),H=w(C.created_at,64,"invalid-history-time");if(!Number.isFinite(Date.parse(H)))throw new p("invalid-history-time");return{id:w(C.id,128,"invalid-history-id"),createdAt:H,revision:N(C.revision,0,Number.MAX_SAFE_INTEGER,"invalid-history-revision"),pointCount:N(C.point_count,1,15e5,"invalid-history-points"),sceneUrl:q(C.scene_url,"invalid-history-scene-url")}},i0=e=>{let C=R(e,"invalid-history");if(!Array.isArray(C.floors)||C.floors.length<1||C.floors.length>128)throw new p("invalid-history-floors");return{entryId:w(C.entry_id,128,"invalid-history-entry"),liveAvailable:g(C.live_available,"invalid-history-live"),floors:C.floors.map(H=>{let V=R(H,"invalid-history-floor");if(!Array.isArray(V.snapshots)||V.snapshots.length>12)throw new p("invalid-history-snapshots");return{id:w(V.id,128,"invalid-history-floor-id"),active:g(V.active,"invalid-history-floor-active"),readOnly:g(V.read_only,"invalid-history-floor-read-only"),liveAvailable:V.live_available===void 0?!1:g(V.live_available,"invalid-history-floor-live"),label:h7(V.label),ordinal:V.ordinal===void 0?null:j2(V.ordinal,128),snapshots:V.snapshots.map(O7)}})}},a0=e=>{if(e==="vacuum"||e==="mop"||e==="vacuum_and_mop")return e;throw new p("invalid-cleaning-mode")},n0=e=>{if(e==="quick"||e==="standard"||e==="heavy_duty")return e;throw new p("invalid-coverage-setting")},w7=e=>{let C=R(e,"invalid-area-circle");return{x:Z1(C.x,-1e6,1e6,"invalid-area-circle"),y:Z1(C.y,-1e6,1e6,"invalid-area-circle"),radius:Z1(C.radius,.05,2.5,"invalid-area-circle")}},k7=e=>e==="current"||e==="review"||e==="stale"?e:"unknown",A0=e=>{let C=R(e,"invalid-areas");if(!Array.isArray(C.areas)||C.areas.length>256)throw new p("invalid-area-list");return{sceneUrl:q(C.scene_url,"invalid-area-scene-url"),rooms:o0(C.rooms,!0),areas:C.areas.map(H=>{let V=R(H,"invalid-area");if(!Array.isArray(V.circles)||V.circles.length>512)throw new p("invalid-area-circles");return{id:w(V.id,128,"invalid-area-id"),name:w(V.name,128,"invalid-area-name"),circles:V.circles.map(w7),cleaningMode:a0(V.cleaning_mode),coverageSetting:n0(V.coverage_setting),status:k7(V.status),canRebind:g(V.can_rebind,"invalid-area-rebind")}})}},l0=e=>{let C=R(e,"invalid-plans");if(!Array.isArray(C.plans)||C.plans.length>256)throw new p("invalid-plan-list");return{rooms:o0(C.rooms,!1).map(({roomId:V,name:L})=>({roomId:V,name:L})),selectedPlan:C.selected_plan===null||C.selected_plan===void 0?null:w(C.selected_plan,128,"invalid-selected-plan"),plans:C.plans.map(V=>{let L=R(V,"invalid-plan");if(!Array.isArray(L.rooms)||L.rooms.length>256||!Array.isArray(L.room_order))throw new p("invalid-plan-rooms");let r=L.run_behavior;if(r!=="intelligent"&&r!=="ordered")throw new p("invalid-run-behavior");return{id:w(L.id,128,"invalid-plan-id"),name:w(L.name,128,"invalid-plan-name"),enabled:g(L.enabled,"invalid-plan-enabled"),runBehavior:r,rooms:L.rooms.map(t=>{let M=R(t,"invalid-plan-room");return{roomId:w(M.room_id,128,"invalid-plan-room-id"),cleaningMode:a0(M.cleaning_mode),coverageSetting:n0(M.coverage_setting)}}),roomOrder:L.room_order.slice(0,256).map(t=>w(t,128,"invalid-room-order")),returnToBase:g(L.return_to_base,"invalid-return-to-base"),finishCurrentRoom:g(L.finish_current_room,"invalid-finish-room"),finishCurrentRoomThreshold:N(L.finish_current_room_threshold,0,100,"invalid-finish-threshold")}})}},d0=e=>{let C=R(e,"invalid-pose"),H=C.position,V=H===null?null:M0(H,"invalid-pose-position"),L=C.pose_freshness;if(L!=="live"&&L!=="coordinator_fallback")throw new p("invalid-pose-freshness");return{position:V,source:w(C.source,64,"invalid-pose-source"),revision:N(C.revision,0,Number.MAX_SAFE_INTEGER,"invalid-pose-revision"),poseRevision:N(C.pose_revision,0,Number.MAX_SAFE_INTEGER,"invalid-pose-sequence"),floorCoherent:g(C.map_floor_coherent,"invalid-pose-floor"),mapSessionKey:r0(C.map_session_key),freshness:L}},s0=e=>{try{return q(e,"invalid-private-path"),!0}catch{return!1}};var p0=e=>{let r=()=>{throw new Error("invalid-scene")};(!(e instanceof ArrayBuffer)||e.byteLength<24||e.byteLength>16777216)&&r();let t=new DataView(e),M=new Uint8Array(e,0,8),o=String.fromCharCode(...M),i=t.getUint16(8,!0),a=t.getUint16(10,!0),n=t.getUint32(12,!0),A=t.getUint32(16,!0),d=t.getUint32(20,!0),m=A+d,x=24+n;(o!=="MATIC3D\0"||i!==1||a!==8||n>1024*1024||m<1||m>15e5||x+m*a!==e.byteLength)&&r();let h;try{h=JSON.parse(new TextDecoder("utf-8",{fatal:!0}).decode(new Uint8Array(e,24,n)))}catch{r()}(!h||typeof h!="object"||Array.isArray(h))&&r();let u=h,f=u.meters_per_cell,S=u.origin_cells,y=u.span_cells;(typeof f!="number"||!Number.isFinite(f)||f<.001||f>.1||!Array.isArray(S)||S.length!==2||!S.every(F=>typeof F=="number"&&Number.isFinite(F))||!Array.isArray(y)||y.length!==2||!y.every(F=>typeof F=="number"&&Number.isFinite(F)&&F>=1&&F<=65536))&&r();let D1=(Array.isArray(u.rooms)?u.rooms.slice(0,128):[]).flatMap((F,P0)=>{if(!F||typeof F!="object"||Array.isArray(F))return[];let H1=F,$1=typeof H1.name=="string"?H1.name.trim():"";if(!$1||Array.from($1).length>128||/[\u0000-\u001f\u007f]/u.test($1))return[];if(!Array.isArray(H1.boundary)||H1.boundary.length<3||H1.boundary.length>8192)return[];let t5=H1.boundary.flatMap(l2=>{if(!Array.isArray(l2)||l2.length!==2)return[];let[d2,s2]=l2;return typeof d2=="number"&&Number.isFinite(d2)&&typeof s2=="number"&&Number.isFinite(s2)?[[d2,s2]]:[]}),a2=H1.center;if(t5.length<3||!Array.isArray(a2)||a2.length!==2)return[];let[n2,A2]=a2;return typeof n2!="number"||!Number.isFinite(n2)||typeof A2!="number"||!Number.isFinite(A2)?[]:[{id:`scene-room-${P0+1}`,name:$1,boundary:t5,center:[n2,A2]}]}),k0=typeof u.sample_step=="number"&&Number.isInteger(u.sample_step)?Math.max(1,Math.min(15e5,u.sample_step)):1,e5=S,r5=y;return{buffer:e,pointOffset:x,floorCount:A,surfaceCount:d,total:m,metadata:{metersPerCell:f,origin:[e5[0],e5[1]],span:[r5[0],r5[1]],sampleStep:k0,rooms:D1}}},B7=e=>{if(e.byteLength>16777216||e.byteLength<24||!1||!1)throw new p("invalid-scene");try{return p0(e)}catch{throw new p("invalid-scene")}},R7=()=>`
  const parseTransfer = ${p0.toString()};
...
`,L2=class{#C=null;#H=null;#V=0;#e=new Map;constructor(){if(!(typeof Worker!="function"||typeof URL?.createObjectURL!="function"))try{this.#H=URL.createObjectURL(new Blob([R7()],{type:"text/javascript"})),this.#C=new Worker(this.#H),this.#C.onmessage=C=>{let H=this.#e.get(C.data.id);H&&(this.#e.delete(C.data.id),C.data.ok&&C.data.parsed?H.resolve(C.data.parsed):H.reject(new p(C.data.problem||"invalid-scene")))},this.#C.onerror=()=>this.#r("scene-worker-failed")}catch{this.#C=null,this.#H&&URL.revokeObjectURL(this.#H),this.#H=null}}async parse(C,H){if(H?.aborted)throw new DOMException("Aborted","AbortError");if(!this.#C){if(await new Promise(L=>window.setTimeout(L,0)),H?.aborted)throw new DOMException("Aborted","AbortError");return B7(C)}let V=++this.#V;return new Promise((L,r)=>{let t=()=>{this.#e.delete(V),r(new DOMException("Aborted","AbortError"))};H?.addEventListener("abort",t,{once:!0}),this.#e.set(V,{resolve:M=>{H?.removeEventListener("abort",t),L(M)},reject:M=>{H?.removeEventListener("abort",t),r(M)}}),this.#C?.postMessage({id:V,buffer:C},[C])})}#r(C){for(let H of this.#e.values())H.reject(new p(C));this.#e.clear(),this.#C?.terminate(),this.#C=null}dispose(){this.#r("scene-parser-disposed"),this.#H&&URL.revokeObjectURL(this.#H),this.#H=null}};var X={catalog:1e4,scene:6e4,delta:35e3,pose:1e4,history:15e3,workflow:15e3,mutation:2e4},I=class extends Error{constructor(C,H=null){super(C),this.name="BackendError",this.code=C,this.status=H}},F1=36,h1=16*1024*1024,m0=(e,C)=>{let H=Number(e);if(!Number.isSafeInteger(H)||H<0)throw new p(C);return H},v0=(e,C)=>{let H=e.headers.get("X-Matic-Revision");if(H===null)return C;let V=Number(H);if(!Number.isSafeInteger(V)||V<0)throw new p("invalid-scene-revision");return V},c0=(e,C)=>{let H=e.headers.get("X-Matic-Floor-Coherent");if(H===null)return C;if(H==="1")return!0;if(H==="0")return!1;throw new p("invalid-scene-floor-header")},e2=class{#C;#H=new L2;constructor(C){this.#C=C}async#V(C,H,V,L){if(!s0(C))throw new I("invalid-private-path");if(L?.aborted)throw new DOMException("Aborted","AbortError");let r=new AbortController,t=()=>r.abort();L?.addEventListener("abort",t,{once:!0});let M=!1,o=window.setTimeout(()=>{M=!0,r.abort()},V);try{let i=this.#C(),a=new Headers(H.headers),n={...H,cache:"no-store",credentials:"same-origin",headers:Object.fromEntries(a.entries()),signal:r.signal};if(typeof i?.fetchWithAuth=="function")return await i.fetchWithAuth(C,n);let A=i?.auth?.accessToken||i?.auth?.data?.access_token;A&&a.set("Authorization",`Bearer ${A}`);let d=typeof i?.hassUrl=="function"?i.hassUrl(C):C;return await fetch(d,{...n,headers:a})}catch(i){throw M&&!L?.aborted?new I("request-timeout"):r.signal.aborted?new DOMException("Aborted","AbortError"):i}finally{window.clearTimeout(o),L?.removeEventListener("abort",t)}}async#e(C,H,V,L={}){let r=await this.#V(C,{...L,headers:{Accept:"application/json",...L.headers||{}}},H,V);if(!r.ok)throw new I("request-failed",r.status);try{return await r.json()}catch{throw new p("invalid-json-response")}}async catalog(C){return t0(await this.#e(e0,X.catalog,C))}async scene(C,H,V,L,r,t){let M=new Headers({Accept:"application/vnd.matic.slam-scene"});L==="live"&&M.set("X-Matic-Prefer-Cached","1"),t&&M.set("If-None-Match",t);let o=await this.#V(C,{headers:M},X.scene,r),i=v0(o,H),a=c0(o,V);if(o.status===304)return{scene:null,floorCoherent:a,revision:i,notModified:!0};if(!o.ok)throw new I("scene-request-failed",o.status);if(o.headers.get("Content-Type")?.split(";",1)[0]!=="application/vnd.matic.slam-scene")throw new p("invalid-scene-content-type");return{scene:{...await this.#H.parse(await o.arrayBuffer(),r),revision:i,etag:o.headers.get("ETag"),source:L},floorCoherent:a,revision:i,notModified:!1}}async#r(C,H,V){if(!Number.isSafeInteger(H)||H<1||H>h1||typeof DecompressionStream!="function")throw new p("invalid-scene-delta");let r=new Blob([C]).stream().pipeThrough(new DecompressionStream("deflate")).getReader(),t=new Uint8Array(H),M=0,o=()=>{r.cancel()};V?.addEventListener("abort",o,{once:!0});try{for(;;){if(V?.aborted)throw new DOMException("Aborted","AbortError");let{done:i,value:a}=await r.read();if(i)break;if(!(a instanceof Uint8Array)||M+a.byteLength>H)throw new p("invalid-scene-delta");t.set(a,M),M+=a.byteLength}}finally{V?.removeEventListener("abort",o),r.releaseLock()}if(M!==H)throw new p("invalid-scene-delta");return t}async#t(C,H,V){if(C.byteLength<F1||C.byteLength>F1+h1||H.buffer.byteLength>h1)throw new p("invalid-scene-delta");let L=new DataView(C),r=new TextDecoder().decode(new Uint8Array(C,0,8)),t=L.getUint16(8,!0),M=L.getUint16(10,!0),o=m0(L.getBigUint64(12,!0),"invalid-scene-delta"),i=m0(L.getBigUint64(20,!0),"invalid-scene-delta"),a=L.getUint32(28,!0),n=L.getUint32(32,!0);if(r!=="MATICDLT"||t!==1||M!==1||o!==H.revision||i<=H.revision||a<24||a>h1||n>h1||n+F1!==C.byteLength)throw new p("invalid-scene-delta");let A=new Uint8Array(C,F1,n),d=new Uint8Array(H.buffer),x=(await this.#r(A,Math.max(d.byteLength,a),V)).slice(),h=1024*1024;for(let S=0;S<d.byteLength;S+=h){if(V?.aborted)throw new DOMException("Aborted","AbortError");let y=Math.min(d.byteLength,S+h);for(let P=S;P<y;P+=1)x[P]=(x[P]??0)^(d[P]??0);y<d.byteLength&&await new Promise(P=>window.setTimeout(P,0))}let u=x.slice(0,a).buffer;return{parsed:{...await this.#H.parse(u,V),revision:i,etag:null,source:"live"},revision:i}}async sceneDelta(C,H,V,L){let r=C.includes("?")?"&":"?",t=await this.#V(`${C}${r}since=${encodeURIComponent(H.revision)}`,{headers:{Accept:"application/vnd.matic.slam-delta, application/vnd.matic.slam-scene"}},X.delta,L),M=v0(t,H.revision),o=c0(t,V);if(t.status===204){if(M!==H.revision)throw new p("invalid-scene-delta-revision");return{scene:null,floorCoherent:o,revision:M,notModified:!0}}if(!t.ok)throw new I("delta-request-failed",t.status);if(M<=H.revision)throw new p("invalid-scene-delta-revision");let i=Number(t.headers.get("Content-Length"));if(Number.isFinite(i)&&i>F1+h1)throw new p("invalid-scene-delta-size");let a=t.headers.get("Content-Type")?.split(";",1)[0],n=await t.arrayBuffer();if(a==="application/vnd.matic.slam-delta"){let d=Number(t.headers.get("X-Matic-Base-Revision"));if(!Number.isSafeInteger(d)||d!==H.revision)throw new p("invalid-scene-delta-base");let m=await this.#t(n,H,L);if(m.revision!==M)throw new p("invalid-scene-delta-revision");return{scene:{...m.parsed,etag:t.headers.get("ETag")},floorCoherent:o,revision:M,notModified:!1}}if(a!=="application/vnd.matic.slam-scene")throw new p("invalid-scene-delta-content-type");return{scene:{...await this.#H.parse(n,L),revision:M,etag:t.headers.get("ETag"),source:"live"},floorCoherent:o,revision:M,notModified:!1}}async pose(C,H){return d0(await this.#e(C,X.pose,H))}async history(C,H){return i0(await this.#e(C,X.history,H))}async plans(C,H){return l0(await this.#e(C,X.workflow,H))}async areas(C,H){return A0(await this.#e(C,X.workflow,H))}async saveArea(C,H,V){let L=await this.#e(C,X.mutation,V,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({...H.areaId?{area_id:H.areaId}:{},name:H.name,circles:H.circles,cleaning_mode:H.cleaningMode,coverage_setting:H.coverageSetting})});if(!L||typeof L!="object"||typeof L.id!="string")throw new p("invalid-area-save-response");return L.id}async deleteArea(C,H,V){let L=await this.#V(`${C}?area_id=${encodeURIComponent(H)}`,{method:"DELETE",headers:{Accept:"application/json"}},X.mutation,V);if(!L.ok)throw new I("area-delete-failed",L.status)}async service(C,H,V,L){let r=this.#C();if(typeof r?.callService!="function")throw new I("service-unavailable");await r.callService(C,H,V,{entity_id:L})}dispose(){this.#H.dispose()}};var x0=()=>({version:4,view:"top",appearance:"photo",labels:!0,quality:"auto",cameras:{}}),E1=(e,C,H)=>Math.max(C,Math.min(H,e)),Z0=e=>e.replaceAll(/[^a-zA-Z0-9_-]/g,"").slice(0,128)||"local-user",C5=(e,C=4)=>`matic-map-studio:v${C}:${Z0(e)}`,F7=e=>{if(!e||typeof e!="object")return null;let C=e;return["yaw","pitch","zoom","targetX","targetZ"].every(V=>typeof C[V]=="number"&&Number.isFinite(C[V]))?{yaw:E1(C.yaw,-Math.PI,Math.PI),pitch:E1(C.pitch,.18,Math.PI/2-.018),zoom:E1(C.zoom,.01,100),targetX:E1(C.targetX,-1e4,1e4),targetZ:E1(C.targetZ,-1e4,1e4)}:null},u0=e=>{let C=x0();if(!e||typeof e!="object")return C;let H=e,V=H.view==="three"||H.view==="top"||H.view==="rooms"?H.view:C.view,L=V==="rooms"?"top":V,r=H.quality==="auto"||H.quality==="efficient"||H.quality==="balanced"||H.quality==="maximum"?H.quality:C.quality,t=H.cameras&&typeof H.cameras=="object"?H.cameras:{},M={};for(let o of["three","top"]){let i=F7(t[o]);i&&(M[o]=i)}return{version:4,view:L,appearance:H.appearance==="rooms"||H.appearance==="photo"?H.appearance:C.appearance,labels:typeof H.labels=="boolean"?H.labels:C.labels,quality:r,cameras:M}},r2=class{#C="local-user";#H=null;load(C){this.#C=Z0(C);try{let H=window.localStorage.getItem(C5(this.#C));if(H)return u0(JSON.parse(H));for(let V of[3,2]){let L=window.localStorage.getItem(C5(this.#C,V));if(L)return u0(JSON.parse(L))}}catch{}return x0()}schedule(C){this.#H!==null&&window.clearTimeout(this.#H),this.#H=window.setTimeout(()=>{this.#H=null;try{window.localStorage.setItem(C5(this.#C),JSON.stringify(C))}catch{}},250)}dispose(){this.#H!==null&&window.clearTimeout(this.#H),this.#H=null}},h0="matic-map-studio:preferred-frontend",S0=()=>{try{return window.localStorage.getItem(h0)==="v3"?"v3":"v4"}catch{return"v4"}},H5=e=>{try{return window.localStorage.setItem(h0,e),!0}catch{return!1}};var c=(e,C,H=null)=>({status:e,value:C,problem:H}),z=e=>e instanceof DOMException&&e.name==="AbortError",a1=(e,C)=>e instanceof I||e&&typeof e=="object"&&"code"in e&&typeof e.code=="string"?e.code:C,t2=e=>[e.selectedFloorOrdinal??"none",e.mapFloorOrdinal??"none",e.mapFloorCoherent?"coherent":"transition"].join(":"),M2=e=>[e.mapFloorOrdinal??"none",e.mapSessionVerified?"verified":"unverified",e.mapSessionKey??"no-session"].join(":"),U=e=>[e.entryId,e.selectedFloorOrdinal??"none",e.mapFloorOrdinal??"none"].join("|"),f0=e=>[e.entryId,t2(e),M2(e),e.mapRevision].join("|"),g0=e=>e.runnerLocked||e.stopSettlePending||e.activePlan||e.nativeReconciliationPending||e.nativeSessionActive===!0,E7=(e,C)=>e.entryKey===C.entryKey&&e.generation===C.generation&&e.floorKey===C.floorKey&&e.missionKey===C.missionKey,y0="Live map updates paused while the current map is rechecked.",b0="Reconnecting. The last verified map remains read only.",D7=1e3,V5=(e,C)=>e.label?e.label:e.active?"Current floor":`Saved floor ${e.ordinal??C}`,o2=class{#C;#H=new W1;#V;#e=new r2;#r=new Map;#t=null;#n;#a=null;#A=null;#L=null;#c=!1;#h=!1;#x=!1;#i="";#f=0;#p="";#o=!1;#u=!0;constructor(C,H){this.#C=C,this.#V=H}sync(C,H){if(this.#o)return;let V=this.#u;if(this.#u=C.host.connected,this.#t=C,this.#n=H,this.#C.patch({host:C.host,activity:C.activity,batteryPercent:C.batteryPercent,robotLabel:C.robotLabel,robots:C.robots,locale:C.language}),C.userKey!==this.#p){this.#p=C.userKey;let L=this.#e.load(C.userKey);this.#C.patch({view:L.view,appearance:L.appearance,labelsVisible:L.labels,quality:L.quality,cameras:L.cameras})}if(!C.host.administrator){this.#v(),this.#s("access-required");return}if(!C.host.connected){this.#v();let L=this.#C.value,r=L.resources.scene.value;this.#C.patch({coherence:r?"degraded":"unavailable",resources:{...L.resources,pose:c("idle",null)},map:{...L.map,available:r!==null,exactPose:!1},notice:r?{tone:"warning",text:b0}:L.notice});return}if(C.host.robotCount===0){this.#v(),this.#s("map-unavailable");return}if(this.#Z(),!V){this.#C.value.notice?.text===b0&&this.#C.patch({notice:null}),this.refreshCatalog(!0);return}(this.#C.value.resources.catalog.status==="idle"||C.entryKey&&C.entryKey!==this.#C.value.selection.entryId)&&this.refreshCatalog(!0)}schedulePreferences(C){this.#e.schedule(C)}#Z(){this.#a===null&&(this.#a=window.setInterval(()=>{document.visibilityState==="visible"&&this.refreshCatalog()},5e3)),this.#A===null&&(this.#A=window.setInterval(()=>{document.visibilityState==="visible"&&this.refreshPose()},D7))}#v(){this.#a!==null&&window.clearInterval(this.#a),this.#A!==null&&window.clearInterval(this.#A),this.#a=null,this.#A=null}#M(C){this.#r.get(C)?.abort();let H=new AbortController;return this.#r.set(C,H),H}#l(C,H){this.#r.get(C)===H&&this.#r.delete(C)}#d(C=[]){for(let[H,V]of this.#r)C.includes(H)||(V.abort(),this.#r.delete(H))}#s(C){this.#d(),this.#H.invalidate(),this.#i="";let H=this.#C.value;this.#C.patch({generation:this.#H.generation,coherence:H.host.administrator?"unavailable":"blocked",fullMap:!1,precisionOpen:!1,resources:{catalog:c("error",null,C),entry:null,scene:c("idle",null),pose:c("idle",null),history:c("idle",null),plans:c("idle",null),areas:c("idle",null)},map:{available:!1,complete:!1,floorCoherent:!1,sessionVerified:!1,exactPose:!1},selection:{...H.selection,entryId:null,floorId:"current",historyId:null}})}async refreshCatalog(C=!1){if(this.#o||this.#c||!this.#t?.host.administrator)return;this.#c=!0;let H=this.#M("catalog"),V=this.#C.value.resources.catalog.value;this.#C.patch({resources:{...this.#C.value.resources,catalog:c("loading",V)}});try{let L=await this.#V.catalog(H.signal);if(H.signal.aborted||this.#o)return;let r=this.#n?.config?.entry_id,t=typeof r=="string"?r:null,M=L.find(a=>a.entryId===this.#t?.entryKey)||L.find(a=>a.entryId===t)||L[0]||null,o=this.#C.value.resources.entry;if(M&&o&&U(M)===U(o)&&t2(M)===t2(o)&&M2(M)===M2(o)&&M.mapRevision<o.mapRevision&&(M={...M,mapRevision:o.mapRevision}),this.#C.patch({managedLock:M?g0(M):!1,resources:{...this.#C.value.resources,catalog:c(L.length?"ready":"empty",L),entry:M}}),!M){this.#s("no-loaded-robot");return}if(this.#C.value.selection.floorId!=="current"&&!C)return;let i=f0(M);if(!C&&i===this.#i){let a=this.#C.value,n=M.mapFloorCoherent&&M.mapSessionVerified,A=M.health==="problem"||M.health==="limited";this.#C.patch({coherence:n?A?"degraded":"current":"verifying",map:{...a.map,available:n&&a.resources.scene.value!==null,complete:M.mapComplete&&!M.mapTruncated,floorCoherent:M.mapFloorCoherent,sessionVerified:M.mapSessionVerified,exactPose:n?a.map.exactPose:!1},floor:{...a.floor,classifiedCount:Math.max(1,M.historyFloorCount)}});return}this.#i=i,this.#w(M)}catch(L){if(z(L))return;this.#C.patch({coherence:this.#C.value.resources.scene.value?"degraded":"unavailable",resources:{...this.#C.value.resources,catalog:c("error",V,a1(L,"catalog-unavailable"))}})}finally{this.#l("catalog",H),this.#c=!1}}#w(C){let H=this.#C.value,V=H.resources.entry,L=!!(V&&U(V)===U(C)),r=C.mapFloorCoherent&&C.mapSessionVerified;this.#d(L?["catalog","plans","areas","plan-mutation","area-mutation"]:["catalog"]);let t=L?H.resources.scene.value:null,M=H.resources.pose.value,o=L&&r&&C.mapSessionKey!==null&&M?.position&&M.mapSessionKey===C.mapSessionKey?M:null,i=this.#H.begin(C.entryId,t2(C),M2(C),C.mapRevision),a=C.health==="problem"||C.health==="limited",n=this.#C.value;this.#C.patch({managedLock:g0(C),generation:i.generation,coherence:r?a?"degraded":"current":"verifying",dataMode:"live",resources:{...n.resources,entry:C,scene:c(r?"loading":"idle",t),pose:c(r?"loading":"idle",o),history:c("loading",n.resources.history.value),plans:L?n.resources.plans:c("idle",null),areas:L?n.resources.areas:c("idle",null)},map:{available:r&&t!==null,complete:C.mapComplete&&!C.mapTruncated,floorCoherent:C.mapFloorCoherent,sessionVerified:C.mapSessionVerified,exactPose:r&&o!==null},floor:{classifiedCount:Math.max(1,C.historyFloorCount),displayName:C.selectedFloorOrdinal?`Floor ${C.selectedFloorOrdinal}`:"Current floor",readOnly:!1},selection:{...n.selection,entryId:C.entryId,floorId:"current",historyId:null,roomIds:L?n.selection.roomIds:[],planId:L?n.selection.planId:null,areaId:L?n.selection.areaId:null}}),this.#T(C,i),r&&(this.#S(C,i),this.#g(C,i))}async#S(C,H){let V=this.#M("scene");try{let L=await this.#V.scene(C.sceneUrl,C.mapRevision,C.mapFloorCoherent,"live",V.signal);if(!this.#H.accepts(H)||L.revision!==H.revision||!L.floorCoherent||!L.scene)return;let r=this.#C.value;if(this.#C.patch({resources:{...r.resources,scene:c("ready",L.scene)},map:{...r.map,available:!0},notice:r.notice?.text===y0?null:r.notice}),C.deltaUrl){let t=++this.#f;this.#b(C,H,L.scene,t)}}catch(L){if(z(L)||!this.#H.accepts(H))return;if(L instanceof I&&L.code==="request-timeout"){let o=this.#C.value;this.#C.patch({resources:{...o.resources,scene:c("loading",o.resources.scene.value,"scene-building")}}),window.setTimeout(()=>{this.#o||!this.#H.accepts(H)||this.#C.value.selection.floorId!=="current"||this.#S(C,H)},250);return}let r=this.#C.value,t=r.resources.pose.value,M=r.resources.scene.value!==null&&C.mapSessionKey!==null&&t?.position!==null&&t?.mapSessionKey===C.mapSessionKey;this.#C.patch({coherence:"degraded",resources:{...r.resources,scene:c("error",r.resources.scene.value,a1(L,"scene-unavailable"))},map:{...r.map,available:r.resources.scene.value!==null,exactPose:M}})}finally{this.#l("scene",V)}}async#b(C,H,V,L){if(!C.deltaUrl||typeof DecompressionStream!="function")return;let r=C.deltaUrl,t=C,M=H,o=V;try{for(;!this.#o&&L===this.#f&&this.#H.accepts(M)&&this.#C.value.selection.floorId==="current";){let i=this.#M("delta");try{let a=await this.#V.sceneDelta(r,o,t.mapFloorCoherent,i.signal);if(i.signal.aborted||this.#o||L!==this.#f||!this.#H.accepts(M))return;if(!a.floorCoherent){this.#C.patch({coherence:"verifying",map:{...this.#C.value.map,available:!1,floorCoherent:!1,exactPose:!1},resources:{...this.#C.value.resources,pose:c("idle",null)}}),this.#i="",this.refreshCatalog(!0);return}if(a.notModified||!a.scene){await new Promise(d=>window.setTimeout(d,100));continue}let n=this.#H.advance(M,a.revision);if(!n)return;M=n,o=a.scene,t={...t,mapRevision:a.revision},this.#i=f0(t);let A=this.#C.value;this.#C.patch({resources:{...A.resources,entry:t,scene:c("ready",o)},map:{...A.map,available:!0,floorCoherent:!0}}),this.#g(t,M)}finally{this.#l("delta",i)}}}catch(i){if(z(i)||this.#o||L!==this.#f||!this.#H.accepts(M))return;this.#C.patch({coherence:"degraded",notice:{tone:"warning",text:y0}}),this.#i="",this.refreshCatalog(!0)}}async#T(C,H){let V=this.#M("history");try{let L=await this.#V.history(C.historyUrl,V.signal);if(!this.#H.accepts(H)||L.entryId!==C.entryId)return;let r=L.floors.find(t=>t.active)||L.floors[0];if(!r)return;this.#C.patch({resources:{...this.#C.value.resources,history:c("ready",L)},floor:{...this.#C.value.floor,classifiedCount:L.floors.length,displayName:V5(r,1)}})}catch(L){if(z(L)||!this.#H.accepts(H))return;this.#C.patch({resources:{...this.#C.value.resources,history:c("error",null,a1(L,"history-unavailable"))}})}finally{this.#l("history",V)}}async refreshPose(){let C=this.#C.value.resources.entry,H=this.#H.current();!C||!H||this.#C.value.selection.floorId!=="current"||!C.mapFloorCoherent||!C.mapSessionVerified||await this.#g(C,H)}async#g(C,H){if(this.#h){this.#x=!0;return}this.#h=!0;let V=this.#M("pose");try{let L=await this.#V.pose(C.poseUrl,V.signal),r=this.#H.current(),t=this.#C.value.resources.entry;if(!r||!E7(H,r)||!t||!L.floorCoherent)return;if(L.mapSessionKey===null||L.mapSessionKey!==t.mapSessionKey){this.#C.patch({map:{...this.#C.value.map,exactPose:!1}}),this.#i="",this.refreshCatalog(!0);return}let M=this.#C.value,o=M.resources.pose.value,i=!!(M.map.exactPose&&o?.position&&o.mapSessionKey===t.mapSessionKey);if(L.position===null&&i){this.#C.patch({resources:{...M.resources,pose:c("ready",o)}});return}this.#C.patch({resources:{...M.resources,pose:c("ready",L)},map:{...M.map,exactPose:L.position!==null}})}catch(L){if(z(L)||!this.#H.accepts(H))return;let r=this.#C.value,t=r.resources.pose.value,M=!!(r.map.exactPose&&t?.position&&t.mapSessionKey===r.resources.entry?.mapSessionKey);this.#C.patch({resources:{...r.resources,pose:c("error",M?t:null,a1(L,"pose-unavailable"))},map:{...r.map,exactPose:M}})}finally{if(this.#l("pose",V),this.#h=!1,this.#x&&!this.#o){this.#x=!1;let L=this.#C.value.resources.entry,r=this.#H.current();L&&r&&this.#g(L,r)}}}async selectFloor(C){let H=this.#C.value.resources.history.value,V=this.#C.value.resources.entry;if(!H||!V)return;let L=H.floors.find(M=>M.id===C);if(!L)return;if(L.active){this.#i="",this.#C.dispatch({type:"set-floor",floorId:"current"}),await this.refreshCatalog(!0);return}let r=L.snapshots.at(-1);this.#d(["catalog"]);let t=this.#H.begin(V.entryId,L.id,r?.id||L.id,r?.revision||0);this.#C.patch({generation:t.generation,coherence:"current",dataMode:"history",floor:{classifiedCount:H.floors.length,displayName:V5(L,H.floors.indexOf(L)+1),readOnly:!0},selection:{...this.#C.value.selection,floorId:L.id,historyId:r?.id||null},resources:{...this.#C.value.resources,scene:c(r?"loading":"empty",null),pose:c("idle",null)},map:{available:!1,complete:!0,floorCoherent:!0,sessionVerified:!0,exactPose:!1}}),r&&await this.#P(r,t)}async selectHistory(C){let H=this.#C.value.resources.history.value,V=this.#C.value.resources.entry;if(!H||!V)return;if(!C){await this.selectFloor("current");return}let L=H.floors.find(M=>M.snapshots.some(o=>o.id===C)),r=L?.snapshots.find(M=>M.id===C);if(!L||!r)return;let t=this.#H.begin(V.entryId,L.id,r.id,r.revision);this.#d(["catalog"]),this.#C.patch({generation:t.generation,dataMode:"history",floor:{classifiedCount:H.floors.length,displayName:V5(L,H.floors.indexOf(L)+1),readOnly:!0},selection:{...this.#C.value.selection,floorId:L.id,historyId:r.id},resources:{...this.#C.value.resources,scene:c("loading",null),pose:c("idle",null)},map:{...this.#C.value.map,available:!1,exactPose:!1}}),await this.#P(r,t)}async#P(C,H){let V=this.#M("history-scene");try{let L=await this.#V.scene(C.sceneUrl,C.revision,!0,"history",V.signal);if(!this.#H.accepts(H)||!L.scene)return;this.#C.patch({resources:{...this.#C.value.resources,scene:c("ready",L.scene)},map:{...this.#C.value.map,available:!0,exactPose:!1}})}catch(L){if(z(L)||!this.#H.accepts(H))return;this.#C.patch({resources:{...this.#C.value.resources,scene:c("error",null,a1(L,"history-scene-unavailable"))}})}finally{this.#l("history-scene",V)}}async openWorkflow(C){let H=this.#C.value.workflow;C==="draw"&&H!=="draw"&&H!=="areaReview"&&this.selectArea(null),this.#C.dispatch({type:"open-workflow",workflow:C}),(C==="plan"||C==="rooms")&&await this.loadPlans(),(C==="draw"||C==="areaReview")&&await this.loadAreas()}async loadPlans(){let C=this.#C.value.resources.entry;if(!C||!this.#H.current()||!m2(this.#C.value))return;let H=U(C),V=this.#M("plans");this.#C.patch({resources:{...this.#C.value.resources,plans:c("loading",null)}});try{let L=await this.#V.plans(C.plansUrl,V.signal),r=this.#C.value.resources.entry;if(!r||U(r)!==H)return;let t=L.selectedPlan||L.plans[0]?.id||null,M=L.plans.find(o=>o.id===t);this.#C.patch({resources:{...this.#C.value.resources,plans:c("ready",L)},selection:{...this.#C.value.selection,planId:t},planDraft:M?this.#O(M):{...this.#C.value.planDraft,id:null,name:"",rooms:[],dirty:!1}})}catch(L){let r=this.#C.value.resources.entry;if(z(L)||!r||U(r)!==H)return;this.#C.patch({resources:{...this.#C.value.resources,plans:c("error",null,a1(L,"plans-unavailable"))}})}finally{this.#l("plans",V)}}selectPlan(C){let H=this.#C.value.resources.plans.value?.plans.find(V=>V.id===C);this.#C.patch({selection:{...this.#C.value.selection,planId:C},planDraft:H?this.#O(H):{...this.#C.value.planDraft,id:null,name:"",rooms:[],dirty:!1}})}#O(C){return{id:C.id,name:C.name,enabled:C.enabled,runBehavior:C.runBehavior,rooms:(C.roomOrder.length?C.roomOrder.flatMap(H=>{let V=C.rooms.find(L=>L.roomId===H);return V?[V]:[]}):C.rooms).map(H=>({...H})),returnToBase:C.returnToBase,finishCurrentRoom:C.finishCurrentRoom,finishCurrentRoomThreshold:C.finishCurrentRoomThreshold,dirty:!1}}async loadAreas(){let C=this.#C.value.resources.entry;if(!C||!this.#H.current()||!m2(this.#C.value))return;let H=U(C),V=this.#M("areas");this.#C.patch({resources:{...this.#C.value.resources,areas:c("loading",null)}});try{let L=await this.#V.areas(C.areasUrl,V.signal),r=this.#C.value.resources.entry;if(!r||U(r)!==H||L.sceneUrl!==r.sceneUrl)return;this.#C.patch({resources:{...this.#C.value.resources,areas:c("ready",L)}});let t=this.#C.value.selection.areaId;this.selectArea(L.areas.some(M=>M.id===t)?t:null)}catch(L){let r=this.#C.value.resources.entry;if(z(L)||!r||U(r)!==H)return;this.#C.patch({resources:{...this.#C.value.resources,areas:c("error",null,a1(L,"areas-unavailable"))}})}finally{this.#l("areas",V)}}selectArea(C){let H=this.#C.value.resources.areas.value?.areas.find(L=>L.id===C),V=this.#C.value;this.#C.patch({selection:{...V.selection,areaId:C},areaDraft:H?this.#k(H):{id:null,name:"",cleaningMode:"vacuum",coverageSetting:"standard",status:"new",canRebind:!1,dirty:!1},draw:{...V.draw,circles:H?.circles||[],undo:[],redo:[],dirty:!1,strokeCount:0}})}#k(C){return{id:C.id,name:C.name,cleaningMode:C.cleaningMode,coverageSetting:C.coverageSetting,status:C.status,canRebind:C.canRebind,dirty:!1}}async saveArea(){let C=this.#C.value,H=C.resources.entry,V=C.areaDraft;if(!H||!Q(C)||!V.name.trim()||!C.draw.circles.length)return;let L=this.#M("area-mutation");this.#C.patch({command:"pending",notice:{tone:"info",text:"Saving area\u2026"}});try{let r=await this.#V.saveArea(H.areasUrl,{areaId:V.id,name:V.name.trim(),circles:C.draw.circles,cleaningMode:V.cleaningMode,coverageSetting:V.coverageSetting},L.signal);this.#C.patch({command:"idle",notice:{tone:"success",text:"Area saved"}}),await this.loadAreas(),this.selectArea(r)}catch(r){if(z(r))return;this.#C.patch({command:"failed",notice:{tone:"error",text:"Area could not be saved"}})}finally{this.#l("area-mutation",L)}}async deleteArea(){let C=this.#C.value.resources.entry,H=this.#C.value.selection.areaId;if(!C||!H||!Q(this.#C.value))return;let V=this.#M("area-mutation");try{await this.#V.deleteArea(C.areasUrl,H,V.signal),this.#C.patch({notice:{tone:"success",text:"Area deleted"}}),await this.loadAreas()}catch(L){z(L)||this.#C.patch({notice:{tone:"error",text:"Area could not be deleted"}})}finally{this.#l("area-mutation",V)}}async savePlan(){let C=this.#C.value,H=C.planDraft,V=C.resources.plans.value;if(!V||!H.name.trim()||!H.rooms.length||!Q(C))return;let L=H.rooms;await this.#y("save_plan",{...H.id?{plan_id:H.id}:{},name:H.name.trim(),enabled:H.enabled,run_behavior:H.runBehavior,rooms:L.map(r=>({room:V.rooms.find(t=>t.roomId===r.roomId)?.name,cleaning_mode:r.cleaningMode,coverage_setting:r.coverageSetting})).filter(r=>r.room),return_to_base:H.returnToBase,finish_current_room:H.finishCurrentRoom,finish_current_room_threshold:H.finishCurrentRoomThreshold,select:!H.id||V.selectedPlan===H.id},"Plan saved","Plan could not be saved"),await this.loadPlans()}async deletePlan(){let C=this.#C.value.selection.planId;C&&(await this.#y("delete_plan",{plan:C},"Plan deleted","Plan could not be deleted"),await this.loadPlans())}async executeAction(C){switch(C){case"stop":this.#C.value.resources.entry?.activePlan||this.#C.value.resources.entry?.runnerLocked?await this.#m("matic_robot","stop_intelligent_cleaning",{}):await this.#m("vacuum","return_to_base",{});return;case"resume":await this.#m("vacuum","start",{});return;case"run-plan":{let H=this.#C.value.selection.planId||this.#C.value.resources.plans.value?.selectedPlan;H&&await this.#m("matic_robot","run_selected_plan",{plan:H});return}case"clean-rooms":{let H=this.#C.value.resources.plans.value,L=this.#C.value.selection.roomSettings.map(r=>({room:H?.rooms.find(t=>t.roomId===r.roomId)?.name,cleaning_mode:r.cleaningMode,coverage_setting:r.coverageSetting})).filter(r=>r.room);L.length&&await this.#m("matic_robot","clean_room_sequence",{rooms:L,return_to_base:!0});return}case"run-area":{let H=this.#C.value.selection.areaId;H&&await this.#m("matic_robot","clean_area",{area:H});return}case"review-area":this.#C.dispatch({type:"open-workflow",workflow:"areaReview"});return;case"save-area":await this.saveArea();return;case"save-plan":await this.savePlan();return;case"delete-plan":await this.deletePlan();return;case"delete-area":await this.deleteArea();return}}async#y(C,H,V,L){let r=this.#t?.vacuumEntityId;if(!(!r||!Q(this.#C.value)||this.#C.value.command==="pending")){this.#C.patch({command:"pending",notice:{tone:"info",text:"Saving\u2026"}});try{await this.#V.service("matic_robot",C,H,r),this.#C.patch({command:"idle",notice:{tone:"success",text:V}})}catch{this.#C.patch({command:"failed",notice:{tone:"error",text:L}})}}}async#m(C,H,V){let L=this.#C.value,r=this.#t?.vacuumEntityId,M=(H==="stop_intelligent_cleaning"||C==="vacuum"&&H==="return_to_base")&&L.command==="idle"&&(L.activity==="cleaning"||L.activity==="paused"||L.activity==="returning"||L.activity==="recharging");if(!(!r||!M&&!l1(L))){this.#C.patch({command:"pending",notice:null});try{await this.#V.service(C,H,V,r),this.#C.patch({command:"settling"}),this.#L!==null&&window.clearTimeout(this.#L),this.#L=window.setTimeout(()=>{this.#L=null,this.#C.value.command==="settling"&&this.#C.patch({command:"idle"})},15e3)}catch{this.#C.patch({command:"failed",notice:{tone:"error",text:"The robot did not accept that action"}})}}}updateDraftCircles(C,H=!0,V){this.#C.dispatch({type:"set-draft-circles",circles:C,record:H,...V?{previous:V}:{}}),this.#C.dispatch({type:"patch-area-draft",patch:{dirty:!0}})}dispose(){this.#o||(this.#o=!0,this.#v(),this.#d(),this.#L!==null&&window.clearTimeout(this.#L),this.#L=null,this.#e.dispose(),this.#V.dispose(),this.#H.invalidate())}};var O0=e=>(e.workflow==="none"?0:1)+(e.fullMap?1:0)+(e.precisionOpen?1:0)+(e.dialog?1:0),$7=e=>{if(!e||typeof e!="object")return null;let C=e.maticMapLayer;if(!C||typeof C!="object")return null;let H=C.owner,V=C.depth;return typeof H=="string"&&Number.isInteger(V)&&Number(V)>=0?{owner:H,depth:Number(V)}:null},i2=class{#C;#H=`matic-map-${crypto.randomUUID?.()||Math.random().toString(36).slice(2)}`;#V=0;#e=null;#r=!1;constructor(C){this.#C=C}start(){this.#e||(this.#V=O0(this.#C.value),this.#e=this.#C.subscribe(C=>this.#t(C)),window.addEventListener("popstate",this.#n))}#t(C){let H=O0(C);if(this.#r){this.#r=!1,this.#V=H;return}if(H>this.#V)for(let V=this.#V+1;V<=H;V+=1){let L=history.state&&typeof history.state=="object"?history.state:{};history.pushState({...L,maticMapLayer:{owner:this.#H,depth:V}},"",window.location.href)}this.#V=H}#n=()=>{this.#V<1||(this.#r=!0,this.#C.dispatch({type:"dismiss-top-layer"}))};dismissTop(){if(this.#V<1)return!1;let C=$7(history.state);return C?.owner===this.#H&&C.depth===this.#V?history.back():this.#C.dispatch({type:"dismiss-top-layer"}),!0}dispose(){this.#e?.(),this.#e=null,window.removeEventListener("popstate",this.#n),this.#V=0}};var w0=j(M1),L5=class extends O{constructor(){super(...arguments);this.narrow=!1;this._workspace=k();this._classic=!1;this.entryOverride=null;this.#C=new z1;this.#H=new d1(this._workspace);this.#V=null;this.#e=null;this.#r=null;this.#t=null;this.#n=null;this.#a=""}static{this.styles=[E,D,b`
...
`]}static{this.properties={hass:{attribute:!1},narrow:{type:Boolean},route:{attribute:!1},panel:{attribute:!1},_workspace:{state:!0},_classic:{state:!0},entryOverride:{state:!0}}}#C;#H;#V;#e;#r;#t;#n;#a;connectedCallback(){super.connectedCallback(),this._classic=S0()==="v3",this.#e=this.#H.subscribe(H=>{this._workspace=H,this.#c(H)}),this._classic||this.#A()}disconnectedCallback(){this.#e?.(),this.#e=null,this.#L(),super.disconnectedCallback()}#A(){this.#t||(this.#r=new e2(()=>this.hass),this.#t=new o2(this.#H,this.#r),this.#n=new i2(this.#H),this.#n.start(),this.#V&&this.#t.sync(this.#V,this.panel))}#L(){this.#n?.dispose(),this.#n=null,this.#t?.dispose(),this.#t=null,this.#r=null}#c(H){if(!this.#t)return;let V={version:4,view:H.view,appearance:H.appearance,labels:H.labelsVisible,quality:H.quality,cameras:H.cameras},L=JSON.stringify(V);L!==this.#a&&(this.#a=L,this.#t.schedulePreferences(V))}willUpdate(H){if(H.has("hass")||H.has("panel")||H.has("entryOverride")){let V=this.#C.project(this.hass,this.panel,this.entryOverride);if(V!==this.#V){this.#V=V;let L=V.host.connected?V.host.robotCount===0?"unavailable":V.host.administrator?"verifying":"blocked":"degraded";this.#H.replace({...this.#H.value,coherence:L,activity:V.activity,batteryPercent:V.batteryPercent,host:V.host,fullMap:V.host.administrator&&V.host.robotCount>0&&this.#H.value.fullMap,robotLabel:V.robotLabel,robots:V.robots,locale:V.language})}this._classic||this.#t?.sync(V,this.panel)}H.has("narrow")&&this.#H.value.narrowHint!==this.narrow&&this.#H.dispatch({type:"set-narrow-hint",value:this.narrow})}#h(H){if(!I1(H.detail))return;H.stopPropagation();let V=H.detail;if(V.type==="dismiss-top-layer"||V.type==="exit-full-map"){this.#n?.dismissTop()||this.#H.dispatch(V);return}if(V.type==="open-workflow"&&V.workflow!=="none"){this.#t?.openWorkflow(V.workflow);return}if(V.type==="set-floor"){this.#t?.selectFloor(V.floorId);return}if(V.type==="select-entry"){if(!this._workspace.robots.some(L=>L.entryId===V.entryId))return;this.entryOverride=V.entryId;return}if(V.type==="set-history"){this.#t?.selectHistory(V.historyId);return}if(V.type==="select-plan"){this.#t?.selectPlan(V.planId);return}if(V.type==="select-area"){this.#t?.selectArea(V.areaId);return}this.#H.dispatch(V)}#x(H){if(H.stopPropagation(),typeof H.detail?.id=="string"){if(H.detail.id==="use-classic"){H5("v3")&&(this.#L(),this._classic=!0);return}this.#t?.executeAction(H.detail.id),this.dispatchEvent(new CustomEvent("matic-map-v4-action-requested",{detail:{id:H.detail.id},bubbles:!0,composed:!0}))}}#i(){H5("v4")&&(this._classic=!1,this.#A(),this.requestUpdate())}updated(){if(!this._classic)return;let H=this.renderRoot.querySelector("matic-map-panel-v0-3-1");H&&(H.hass=this.hass,H.narrow=this.narrow,H.route=this.route,H.panel=this.panel)}getWorkspaceSnapshot(){return this.#H.value}render(){return this._classic?v`
        <div class="classic">
      ...
      ></${w0}>
    `}};customElements.get(R2)||customElements.define(R2,L5);export{W1 as CoherenceMachine,f1 as DRAW_BRUSH_MAX_METERS,n1 as DRAW_BRUSH_MIN_METERS,x2 as GALLERY_SCENARIOS,z1 as HassAdapter,p2 as MAP_PIXELS_PER_METER_AT_100,M5 as MAP_ZOOM_MAX,S1 as MAP_ZOOM_MIN,R2 as MATIC_MAP_PANEL_TAG,L5 as MaticMapPanelV4,Y2 as MaticMapStudioGalleryV4,d1 as WorkspaceStore,N7 as brushCursorPixels,Q as canEditCoordinates,m2 as canReadFloorResources,i5 as canShowExactPose,s1 as canShowLiveMap,l1 as canStartMotion,z7 as commandState,u2 as createGalleryState,k as initialWorkspaceState,I1 as isWorkspaceIntent,l5 as mapScale,T0 as normalizeBrush,o5 as normalizeZoom,B0 as reduceWorkspace,A5 as selectPausedSecondaryAction,n5 as selectPrimaryAction};
