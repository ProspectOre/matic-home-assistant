...
`;var U5=Symbol.for(""),A7=L=>{if(L?.r===U5)return L?._$litStatic$},J=L=>({_$litStatic$:L,r:U5});var z5=new Map,$2=L=>(C,...H)=>{let V=H.length,e,r,t=[],o=[],M,i=0,a=!1;for(;i<V;){for(M=C[i];i<V&&(r=H[i],(e=A7(r))!==void 0);)M+=e+C[++i],a=!0;i!==V&&o.push(r),t.push(M),i++}if(i===V&&t.push(C[V]),a){let n=t.join("$$lit$$");(C=z5.get(n))===void 0&&(t.raw=t,z5.set(n,C=t)),H=o}return L(C,...H)},c=$2(d),O4=$2($5),w4=$2(I5);var G5=import.meta.url.match(/\/matic_robot\/[^/]+-([a-f0-9]{12})\/map-studio-v4(?:\/|$)/u)?.[1]??"dev",R1=G5==="dev"?"":`-${G5}`,i1=`matic-map-canvas-v4${R1}`,F1=`matic-precision-controls-v4${R1}`,a1=`matic-map-workflow-v4${R1}`,n1=`matic-map-shell-v4${R1}`,I2=`matic-map-panel-v0-4-0${R1}`;var C1=b`
.ms-btn, .ms-row {
...
><path d=${L}></path></svg>`;var l7=["paint","erase","pan"],j1=(L,C,H)=>{let{draw:V}=L,e=`${V.brushMeters.toFixed(2)} m`;return d`
    ...
    >
      ${l7.map(r=>d`
        ...
        >${Z(r==="paint"?F3:r==="erase"?D3:$3)}<span class="ms-btn__label">${r==="paint"?C.t("area_paint","Paint"):r==="erase"?C.t("area_erase","Erase"):C.t("move_map","Move map")}</span></button>
      `)}
      <button
        class="ms-btn"
        type="button"
      ...
      >${Z(B3)}<span class="ms-btn__label">${C.t("undo","Undo")}</span></button>
      <button
        class="ms-btn"
        type="button"
        ?disabled=${V.redo.length===0}
        @click=${()=>C.intent({type:"redo-draft"})}
      >${Z(R3)}<span class="ms-btn__label">${C.t("redo","Redo")}</span></button>
      <button
...
.map-root { border: 1px solid CanvasText; }
  ...
  `]}#C;#H;#V;#t;#M;#L;#a;#i;#A;#e(H,V,e){return T(this.localize,H,V,e)}connectedCallback(){super.connectedCallback(),this.#n()}firstUpdated(){let H=this.renderRoot.querySelector(".map-root"),V=this.renderRoot.querySelector(".scene-canvas"),e=this.renderRoot.querySelector(".overlay-canvas");!H||!V||!e||(this.#H=new H2(V,e,{onCamera:(r,t,o)=>{this.#o({type:"set-camera",view:this.state.workflow==="draw"?"top":this.state.view,camera:{yaw:r.yaw,pitch:r.pitch,zoom:t/100,targetX:r.targetX,targetZ:r.targetZ}}),this.state.workflow==="draw"&&t!==this.state.draw.zoomPercent&&this.#o({type:"set-zoom",value:t,...o?{originX:o.xPercent,originY:o.yPercent}:{}})},onRoom:r=>this.#o({type:"toggle-room",roomId:r}),onProblem:()=>this.#d("renderer-problem")}),this.#V=new C2(H,this.#H,{state:()=>this.state,onCircles:(r,t,o)=>this.#o({type:"set-draft-circles",circles:r,record:t,...o?{previous:o}:{}}),onRoom:r=>this.#o({type:"toggle-room",roomId:r})}),this.#H.setState(this.state),this.#f())}disconnectedCallback(){this.#c(),this.#V?.dispose(),this.#V=null,this.#H?.dispose(),this.#H=null,super.disconnectedCallback()}updated(H){this.#M&&(this.#M=!1,this.renderRoot.querySelector(".navigation-help button")?.focus()),H.has("state")&&this.#H?.setState(this.state)}#x(){let H=this.renderRoot?.querySelector(".map-root");!H||!this.#H||this.#H.setPalette(Y3(H))}#f(){this.#Z(),this.#i=window.requestAnimationFrame(()=>{this.#i=null,this.#A=window.setTimeout(()=>{this.#A=null,this.#x()},0)})}#Z(){this.#i!==null&&window.cancelAnimationFrame(this.#i),this.#A!==null&&window.clearTimeout(this.#A),this.#i=null,this.#A=null}#s;#n(){if(!(typeof document>"u"||this.#L)&&(this.#L=new MutationObserver(this.#s),this.#L.observe(document.documentElement,{attributes:!0,attributeFilter:["style","class"]}),typeof window.matchMedia=="function")){this.#a=[window.matchMedia("(prefers-color-scheme: dark)"),window.matchMedia("(forced-colors: active)")];for(let H of this.#a)H.addEventListener("change",this.#s)}}#c(){this.#Z(),this.#L?.disconnect(),this.#L=null;for(let H of this.#a)H.removeEventListener("change",this.#s);this.#a=[]}#o(H){this.dispatchEvent(new CustomEvent(H1,{detail:H,bubbles:!0,composed:!0}))}#d(H){this.dispatchEvent(new CustomEvent(V2,{detail:{id:H},bubbles:!0,composed:!0}))}#u(H){this.#C=H.currentTarget,this.#t=!this.#t,this.#M=this.#t,this.requestUpdate()}#S(){if(!this.#t)return;this.#t=!1,this.requestUpdate();let H=this.#C;H?.isConnected&&H.focus()}#r(){for(let H of this.state.selection.roomIds)this.#o({type:"toggle-room",roomId:H})}#m(H,V){this.#H?.orbitBy(H,V)}#h(H){if(!(H.ctrlKey||H.metaKey||H.altKey)&&H.key==="Escape"){if(H.preventDefault(),this.#t){this.#S();return}this.#o({type:"dismiss-top-layer"});return}}rendererDiagnostics(){return this.#H?.diagnostics()??null}canvasIdentity(){return{scene:this.renderRoot.querySelector(".scene-canvas"),overlay:this.renderRoot.querySelector(".overlay-canvas")}}#l(){return this.state.host.connected?this.state.host.administrator?this.state.host.robotCount===0?{title:this.#e("v4_no_robot","No Matic robot set up"),detail:this.#e("v4_no_robot_detail","Set up a robot before opening its map.")}:this.state.dataMode==="history"?!this.state.map.available&&this.state.resources.scene.status==="loading"?{title:this.#e("v4_loading_saved_map","Loading saved map"),detail:this.#e("v4_loading_saved_map_detail","This read-only snapshot is still preparing.")}:this.state.map.available?null:{title:this.#e("v4_saved_map_unavailable","Saved map unavailable"),detail:this.#e("v4_saved_map_unavailable_detail","Choose another snapshot or return to the live map.")}:this.state.host.robotConnected?this.state.coherence==="verifying"||this.state.coherence==="booting"?{title:this.#e("v4_locating_map","Locating the current map"),detail:this.#e("v4_locating_map_detail","Map controls will return after the floor is verified.")}:!this.state.map.available&&this.state.resources.scene.status==="loading"?{title:this.#e("v4_loading_verified_map","Loading the verified map"),detail:this.#e("v4_loading_verified_map_detail","The current floor is verified. The private scene is still preparing.")}:this.state.map.available?this.state.activity==="problem"?{title:this.#e("v4_robot_attention","Robot needs attention"),detail:this.#e("v4_robot_attention_detail","Check the robot before starting another task.")}:null:{title:this.#e("v4_map_unavailable","Map unavailable"),detail:this.#e("v4_map_unavailable_detail","The private scene is not ready. No map data is shown until it is verified.")}:{title:this.#e("v4_robot_offline","Robot offline"),detail:this.#e("v4_robot_offline_detail","The last verified map stays read only and has no live position.")}:{title:this.#e("v4_admin_required","Administrator access required"),detail:this.#e("v4_private_map_hidden","Private map data is hidden.")}:{title:this.#e("v4_reconnecting","Reconnecting"),detail:this.#e("v4_reconnecting_detail","The verified map is read only until Home Assistant reconnects.")}}#v(H,V){let e=this.state,r=this.narrow,t=e.workflow==="draw",o=this.#e("v4_how_to_move","How to move the map"),M=H&&!t,i=M&&!r&&e.view==="top",a=M&&e.view==="three",n=!V,A=!r&&!t;return!M&&!n?l:d`
      <div class="map-rail" data-map-control>
        ...
        ${a?d`
          <div class="camera-steps ms-surface ms-surface--floating ms-segment" role="toolbar" aria-orientation="horizontal" aria-label=${this.#e("map_camera_controls","Map camera controls")}>
            <button class="ms-btn ms-btn--icon" type="button" aria-label=${this.#e("map_rotate_left","Rotate left")} aria-keyshortcuts="[" @click=${()=>this.#m(-52,0)}>${Z(_3)}</button>
            <button class="ms-btn ms-btn--icon" type="button" aria-label=${this.#e("map_tilt_down","Lower viewing angle")} aria-keyshortcuts="PageDown" @click=${()=>this.#m(0,30)}>${Z(O3)}</button>
            <button class="ms-btn ms-btn--icon" type="button" aria-label=${this.#e("map_tilt_up","Raise viewing angle")} aria-keyshortcuts="PageUp" @click=${()=>this.#m(0,-30)}>${Z(b3)}</button>
            <button class="ms-btn ms-btn--icon" type="button" aria-label=${this.#e("map_rotate_right","Rotate right")} aria-keyshortcuts="]" @click=${()=>this.#m(52,0)}>${Z(T3)}</button>
          </div>
        `:l}
        ...
        ${n?d`
          <div class="map-tools ms-surface ms-surface--floating ms-segment" role="group" aria-label=${this.#e("v4_map_tools","Map tools")}>
            ${V?l:d`
              ...
              >${Z(w3)}<span class="ms-btn__label">${this.#e("v4_fit_map","Fit map")}</span></button>
            `}
            ${!V&&A?d`
              <button
                class="labels ms-btn"
              ...
              >${Z(k3)}<span class="ms-btn__label">${this.#e("v4_room_names","Room names")}</span></button>
              <button
    ...
    `}#p(H){let V=this.state;if(!H)return l;if(V.workflow==="draw"&&!this.narrow)return d`
      ...
      `:l}render(){let H=this.state,V=v5(H),e=this.#l(),r=H.map.available&&(c1(H)||H.dataMode==="history"),t=H.workflow==="draw"&&r,o=H.coherence==="verifying"||H.coherence==="booting";return d`
      <section
        class="map-root"
        tabindex="0"
    ...
    `}};customElements.get(i1)||customElements.define(i1,q2);var X2=class extends O{constructor(){super(...arguments);this.state=k();this.compact=!1;this.inline=!1}static{this.properties={state:{attribute:!1},localize:{attribute:!1},compact:{type:Boolean,reflect:!0},inline:{type:Boolean,reflect:!0}}}static{this.styles=[D,$,C1,b`
...
`]}#C(H,V){return T(this.localize,H,V)}#H(H){this.dispatchEvent(new CustomEvent(H1,{detail:H,bubbles:!0,composed:!0}))}#V(H){let V=H.currentTarget.valueAsNumber;Number.isFinite(V)&&this.#H({type:"set-brush",value:V})}render(){let{draw:H}=this.state;return d`
    ...
    `}};customElements.get(F1)||customElements.define(F1,X2);var Y2=["vacuum","mop","vacuum_and_mop"],j2=["quick","standard","heavy_duty"],I=L=>L.currentTarget.value,t0=L=>L.currentTarget.checked,J2=class extends O{constructor(){super(...arguments);this.state=k();this._copyStatus="idle"}static{this.properties={state:{attribute:!1},localize:{attribute:!1},_copyStatus:{state:!0}}}static{this.styles=[D,$,C1,b`
...
`]}#C;disconnectedCallback(){this.#C!==void 0&&clearTimeout(this.#C),this.#C=void 0,super.disconnectedCallback()}#H(H,V,e){return T(this.localize,H,V,e)}#V(H){return H==="vacuum"?this.#H("vacuum","Vacuum"):H==="mop"?this.#H("mop","Mop"):this.#H("vacuum_and_mop","Vacuum + mop")}#t(H){return H==="quick"?this.#H("quick","Quick"):H==="standard"?this.#H("standard","Optimal"):this.#H("heavy_duty","Heavy Duty")}#M(H){this.dispatchEvent(new CustomEvent(H1,{detail:H,bubbles:!0,composed:!0}))}#L(){return this.state.notice?d`
    ...
    `)}#e(H,V){let e=this.state.resources.plans.value?.rooms.find(r=>r.roomId===H)?.name||this.#H("v4_room","Room");return d`
      <div class="split room-settings">
        ...
        <label class="field ms-field">${this.#H("cleaning_mode","Cleaning mode")}
          ...
          >${j2.map(r=>d`<option value=${r} ?selected=${r===V.coverageSetting}>${this.#t(r)}</option>`)}</select>
        </label>
      </div>
    `}#x(H){let V=this.state.planDraft.rooms,r=V.find(t=>t.roomId===H)?V.filter(t=>t.roomId!==H):[...V,{roomId:H,cleaningMode:"vacuum",coverageSetting:"standard"}];this.#M({type:"patch-plan-draft",patch:{rooms:r}})}#f(H,V){let e=this.state.planDraft.rooms.map((r,t)=>t===H?{...r,...V}:r);this.#M({type:"patch-plan-draft",patch:{rooms:e}})}#Z(H,V){let e=H+V,r=[...this.state.planDraft.rooms];if(e<0||e>=r.length)return;let[t]=r.splice(H,1);t&&(r.splice(e,0,t),this.#M({type:"patch-plan-draft",patch:{rooms:r}}))}#s(){let H=this.state.resources.plans,V=H.value,e=this.state.planDraft,r=e.rooms.map(M=>({room:M,label:V?.rooms.find(i=>i.roomId===M.roomId)?.name||"Room",selected:!0})),t=(V?.rooms||[]).filter(M=>!e.rooms.some(i=>i.roomId===M.roomId)).map(M=>({room:{roomId:M.roomId,cleaningMode:"vacuum",coverageSetting:"standard"},label:M.name,selected:!1})),o=[...r,...t];return this.#i(H.status,H.problem,d`
      <div class="stack">
        <div class="split">
          ...
          <button class="ms-btn ms-btn--secondary" type="button" @click=${()=>this.#M({type:"select-plan",planId:null})}>${Z(I3)}<span class="ms-btn__label">${this.#H("plan_new","New plan")}</span></button>
        </div>
          ...
          ${o.map(({room:M,label:i,selected:a})=>{let n=a?e.rooms.findIndex(A=>A.roomId===M.roomId):-1;return d`
              <div class="room plan-room ms-row ms-row--stack" data-selected=${String(a)}>
                <div class="room-choice">
                  ...
                  ${a?d`
                    <span>
                      <button class="icon-button ms-btn ms-btn--icon" type="button" aria-label=${this.#H("move_room_up","Move {room} earlier",{room:i})} ?disabled=${n===0} @click=${A=>{A.preventDefault(),this.#Z(n,-1)}}>${Z(W3)}</button>
                      <button class="icon-button ms-btn ms-btn--icon" type="button" aria-label=${this.#H("move_room_down","Move {room} later",{room:i})} ?disabled=${n===e.rooms.length-1} @click=${A=>{A.preventDefault(),this.#Z(n,1)}}>${Z(N3)}</button>
                    </span>
                  `:l}
                </div>
                ${a?d`
                  <div class="split room-settings">
                    ...
                    <label class="field ms-field">${this.#H("cleaning_mode","Cleaning mode")}
                      <select aria-label=${this.#H("v4_room_cleaning_mode_named","Cleaning mode for {room}",{room:i})} .value=${M.coverageSetting} @change=${A=>this.#f(n,{coverageSetting:I(A)})}>${j2.map(A=>d`<option value=${A} ?selected=${A===M.coverageSetting}>${this.#t(A)}</option>`)}</select>
                    </label>
                  </div>
                `:l}
              </div>
        ...
        <div class="plan-options" role="group" aria-labelledby="completion-heading">
          <label class="plan-option">
            <input type="checkbox" .checked=${e.returnToBase} @change=${M=>this.#M({type:"patch-plan-draft",patch:{returnToBase:t0(M)}})}>
          ...
          <label class="plan-option">
            <input type="checkbox" .checked=${e.finishCurrentRoom} @change=${M=>this.#M({type:"patch-plan-draft",patch:{finishCurrentRoom:t0(M)}})}>
            <span class="plan-option-copy">
    ...
    `}#c(){let H=this.state.areaDraft,V=H.canRebind||H.status==="review",e=H.status==="stale"||H.status==="unknown";return d`
      <div class="stack">
        ...
        <div class="split">
          <label class="field ms-field">${this.#H("v4_cleaning_system","Cleaning system")}
            <select .value=${H.cleaningMode} @change=${r=>this.#M({type:"patch-area-draft",patch:{cleaningMode:I(r)}})}>${Y2.map(r=>d`<option value=${r} ?selected=${r===H.cleaningMode}>${this.#V(r)}</option>`)}</select>
          </label>
          <label class="field ms-field">${this.#H("cleaning_mode","Cleaning mode")}
            <select .value=${H.coverageSetting} @change=${r=>this.#M({type:"patch-area-draft",patch:{coverageSetting:I(r)}})}>${j2.map(r=>d`<option value=${r} ?selected=${r===H.coverageSetting}>${this.#t(r)}</option>`)}</select>
          </label>
        </div>
...
`),e=typeof navigator>"u"?void 0:navigator.clipboard;if(e&&typeof e.writeText=="function")try{await e.writeText(V),this.#S("copied");return}catch{}this.#S(this.#r(V,H instanceof HTMLElement?H:null)?"copied":"failed")}#h(){let H=this.#u(),V=this._copyStatus==="copied"?this.#H("v4_copied","Copied"):this._copyStatus==="failed"?this.#H("v4_copy_failed","The summary could not be copied. Select the text to copy it by hand."):"";return d`
    ...
    `}#L1(H,V){let e=(S,g,P)=>this.#C(S,g,P),r=this.#U(e("v4_map_history","Map history"),U2,()=>this.#o("history"),e("v4_map_history_detail","Saved maps are floor-scoped and read only.")),t=this.#U(e("v4_map_diagnostics","Map diagnostics"),Q3,()=>this.#o("support"),e("v4_map_support_detail","Private geometry is never included.")),{host:o}=H;if(!o.connected)return this.#$(e("v4_reconnecting_title","Reconnecting to Home Assistant"),e("v4_reconnecting_body","The last verified map stays read-only until the connection returns."));if(!o.administrator)return this.#$(e("v4_admin_title","Administrator access required"),e("v4_admin_body","Ask a Home Assistant administrator to open this map."));if(o.robotCount===0)return this.#$(e("v4_no_robot_title","No Matic robot set up"),e("v4_no_robot_body","Add the Matic integration to see a map here."),c`<a class="ms-btn ms-btn--secondary" href="/config/integrations/integration/matic_robot">${e("v4_open_integration","Open the Matic integration")}</a>`);if(!o.robotConnected)return c`
      ...
      ${H.activity==="problem"?this.#$(e("v4_attention_title","The robot needs attention"),e("v4_attention_body","Check the robot, then start a new task.")):c`
          <div class="quick-actions" aria-label=${e("v4_cleaning_choices","Cleaning choices")}>
            ...
            <button
              ...
              @click=${()=>{M||this.#o("plan")}}
            >
              <span class="ms-row__lead">${Z(G3)}</span>
              <span class="ms-row__body">
      ...
      <h3 class="shelf-heading">${e("v4_more","Map tools")}</h3>
      <div class="shelf">
        ${this.#U(e("v4_custom_areas","Clean a custom area"),U3,()=>this.#o("draw"),f,M)}
        ${r}
        ${V?this.#G(H):l}
      </div>
      ${V?c`
      ...
      `:l}
    `}#e1(H,V){return H.workflow==="none"?this.#L1(H,V):c`<${o0}
      .state=${H}
      .localize=${this.localize}
      @matic-workspace-intent=${this.#q}
    ></${o0}>`}#j(H,V){let e=i0(H,this.localize);return c`
    ...
    `}render(){let H=this.state,V=H.narrowHint||this._measuredNarrow,e=g7(H,this.localize),r=Z2({...H,narrowHint:V}),t=m5(H),o=!V&&r.id==="stop"?r:!V&&t?.id==="stop"?t:null,M=o&&o===r?null:r,i=H.workflow==="draw"&&H.dataMode==="live"?{id:"clear-draft",label:"Clear drawing",labelKey:"v4_clear_drawing",kind:"neutral",enabled:H.draw.circles.length>0}:null,a=o&&o===t?null:t??i,n=H.fullMap&&(H.coherence==="verifying"||H.coherence==="booting"),A=H.fullMap||H.host.administrator&&H.host.robotCount>0&&H.map.available,s=P7(H.dialog,this.localize,H.workflow==="plan"),p=V&&!H.fullMap?`--map-sheet-offset:${this._sheetOffset}px`:"--map-sheet-offset:0px",u=V&&H.workflow==="draw",h=H.precisionOpen&&H.workflow==="draw";return c`
    ...
    `}};customElements.get(n1)||customElements.define(n1,H5);var A0=J(n1),V5=class extends O{constructor(){super(...arguments);this.scenario="ready";this.narrow=!1;this.controls=!0;this._workspace=f2("ready");this.#C=new v1(this._workspace);this.#H=null}static{this.properties={scenario:{type:String,reflect:!0},narrow:{type:Boolean,reflect:!0},controls:{type:Boolean,reflect:!0},_workspace:{state:!0}}}static{this.styles=[D,$,b`
    :host {
      display: block;
      color: #1f2933;
      background: #e8edef;
  ...
  `]}#C;#H;connectedCallback(){super.connectedCallback(),this.#H=this.#C.subscribe(H=>{this._workspace=H})}disconnectedCallback(){this.#H?.(),this.#H=null,super.disconnectedCallback()}willUpdate(H){H.has("scenario")?this.#C.replace({...f2(this.scenario),narrowHint:this.narrow}):H.has("narrow")&&this.#C.dispatch({type:"set-narrow-hint",value:this.narrow})}setScenario(H){g2.includes(H)&&(this.scenario=H)}getWorkspaceSnapshot(){return structuredClone(this.#C.value)}replaceWorkspaceState(H){this.#C.replace(structuredClone(H))}#V(H){d1(H.detail)&&(H.stopPropagation(),this.#C.dispatch(H.detail))}render(){return c`
      ${this.controls?c`
    ...
    `}};customElements.get("matic-map-studio-gallery-v0-4-0")||customElements.define("matic-map-studio-gallery-v0-4-0",V5);var l0="/api/matic_robot/slam_entries";var m=class extends Error{constructor(C){super(C),this.name="ContractError",this.code=C}},R=(L,C)=>{if(!L||typeof L!="object"||Array.isArray(L))throw new m(C);return L},w=(L,C,H)=>{if(typeof L!="string")throw new m(H);let V=L.trim();if(!V||Array.from(V).length>C||/[\u0000-\u001f\u007f]/u.test(V))throw new m(H);return V},T7=L=>{if(L==null||L==="")return null;try{return w(L,128,"invalid-floor-label")}catch{return null}},f1=(L,C,H,V)=>{if(typeof L!="number"||!Number.isFinite(L)||L<C||L>H)throw new m(V);return L},z=(L,C,H,V)=>{let e=f1(L,C,H,V);if(!Number.isInteger(e))throw new m(V);return e},L5=(L,C)=>L==null?null:z(L,1,C,"invalid-floor-ordinal"),y=(L,C)=>{if(typeof L!="boolean")throw new m(C);return L},B7=(L,C)=>L===null?null:y(L,C),s0=L=>{if(L==null)return null;let C=w(L,64,"invalid-map-session-key");if(!/^[0-9a-f]{64}$/u.test(C))throw new m("invalid-map-session-key");return C},R7=L=>{if(L==null)return null;if(L==="bootstrap_empty"||L==="map_session_unverified"||L==="floor_plan_unavailable"||L==="floor_plan_mismatch")return L;throw new m("invalid-map-block-reason")},F7=L=>{if(L===void 0)return"not_started";if(L==="not_started"||L==="running"||L==="complete"||L==="partial"||L==="failed")return L;throw new m("invalid-bootstrap-state")},X=(L,C)=>{let H=w(L,512,C);if(!H.startsWith("/")||H.startsWith("//")||H.includes("\\"))throw new m(C);return H},E7=L=>{let C=typeof L.map_health=="string"?L.map_health.toLowerCase():"",H=typeof L.stream_state=="string"?L.stream_state.toLowerCase():"",V=typeof L.invalid_tiles=="number"?L.invalid_tiles:0;return C.includes("error")||C.includes("fail")||C.includes("degrad")||V>0?"problem":L.map_truncated===!0||C.includes("truncat")||C.includes("limit")?"limited":L.map_complete===!0?"ready":H.includes("connect")||H.includes("collect")||H.includes("run")?"building":"unknown"},d0=L=>{let C=R(L,"invalid-catalog");if(!Array.isArray(C.entries)||C.entries.length>64)throw new m("invalid-catalog-entries");return C.entries.map(H=>{let V=R(H,"invalid-catalog-entry"),e=z(V.map_revision,0,Number.MAX_SAFE_INTEGER,"invalid-map-revision");return{entryId:w(V.entry_id,128,"invalid-entry-id"),sceneUrl:X(V.scene_url,"invalid-scene-url"),deltaUrl:V.delta_url===void 0||V.delta_url===null?null:X(V.delta_url,"invalid-delta-url"),poseUrl:X(V.pose_url,"invalid-pose-url"),historyUrl:X(V.history_url,"invalid-history-url"),areasUrl:X(V.areas_url,"invalid-areas-url"),plansUrl:X(V.plans_url,"invalid-plans-url"),mapRevision:e,mapFloorCoherent:y(V.map_floor_coherent,"invalid-floor-coherence"),mapSessionVerified:y(V.map_session_verified,"invalid-session-state"),mapSessionKey:s0(V.map_session_key),mapBlockReason:R7(V.map_block_reason),runnerLocked:y(V.runner_locked,"invalid-runner-lock"),stopSettlePending:y(V.stop_settle_pending,"invalid-stop-settle"),activePlan:y(V.active_plan,"invalid-active-plan"),nativeReconciliationPending:y(V.native_reconciliation_pending,"invalid-native-reconciliation"),nativeSessionActive:B7(V.native_session_active,"invalid-native-session"),mapComplete:y(V.map_complete,"invalid-map-complete"),mapTruncated:y(V.map_truncated,"invalid-map-truncated"),selectedFloorOrdinal:L5(V.selected_floor_ordinal,128),mapFloorOrdinal:L5(V.map_floor_ordinal,128),historyCount:z(V.history_count,0,12,"invalid-history-count"),historyFloorCount:z(V.history_floor_count,0,128,"invalid-floor-count"),health:E7(V),streamFailures:z(V.stream_failures,0,Number.MAX_SAFE_INTEGER,"invalid-stream-failures"),bootstrapState:F7(V.bootstrap_state),bootstrapPhotoSeen:V.bootstrap_photo_seen===void 0?!1:y(V.bootstrap_photo_seen,"invalid-bootstrap-photo"),bootstrapStructureSeen:V.bootstrap_structure_seen===void 0?!1:y(V.bootstrap_structure_seen,"invalid-bootstrap-structure"),bootstrapFailures:V.bootstrap_failures===void 0?0:z(V.bootstrap_failures,0,2,"invalid-bootstrap-failures")}})},p0=(L,C)=>{if(!Array.isArray(L)||L.length!==2)throw new m(C);return[f1(L[0],-1e6,1e6,C),f1(L[1],-1e6,1e6,C)]},D7=(L,C)=>{if(!Array.isArray(L)||L.length<3||L.length>8192)throw new m(C);return L.map(H=>p0(H,C))},m0=(L,C)=>{if(!Array.isArray(L)||L.length>256)throw new m("invalid-rooms");return L.map(H=>{let V=R(H,"invalid-room");return{roomId:w(V.room_id,128,"invalid-room-id"),name:w(V.name,128,"invalid-room-name"),boundary:C?D7(V.boundary,"invalid-room-boundary"):[]}})},$7=L=>{let C=R(L,"invalid-history-snapshot"),H=w(C.created_at,64,"invalid-history-time");if(!Number.isFinite(Date.parse(H)))throw new m("invalid-history-time");return{id:w(C.id,128,"invalid-history-id"),createdAt:H,revision:z(C.revision,0,Number.MAX_SAFE_INTEGER,"invalid-history-revision"),pointCount:z(C.point_count,1,15e5,"invalid-history-points"),sceneUrl:X(C.scene_url,"invalid-history-scene-url")}},v0=L=>{let C=R(L,"invalid-history");if(!Array.isArray(C.floors)||C.floors.length<1||C.floors.length>128)throw new m("invalid-history-floors");return{entryId:w(C.entry_id,128,"invalid-history-entry"),liveAvailable:y(C.live_available,"invalid-history-live"),floors:C.floors.map(H=>{let V=R(H,"invalid-history-floor");if(!Array.isArray(V.snapshots)||V.snapshots.length>12)throw new m("invalid-history-snapshots");return{id:w(V.id,128,"invalid-history-floor-id"),active:y(V.active,"invalid-history-floor-active"),readOnly:y(V.read_only,"invalid-history-floor-read-only"),liveAvailable:V.live_available===void 0?!1:y(V.live_available,"invalid-history-floor-live"),label:T7(V.label),ordinal:V.ordinal===void 0?null:L5(V.ordinal,128),snapshots:V.snapshots.map($7)}})}},c0=L=>{if(L==="vacuum"||L==="mop"||L==="vacuum_and_mop")return L;throw new m("invalid-cleaning-mode")},u0=L=>{if(L==="quick"||L==="standard"||L==="heavy_duty")return L;throw new m("invalid-coverage-setting")},I7=L=>{let C=R(L,"invalid-area-circle");return{x:f1(C.x,-1e6,1e6,"invalid-area-circle"),y:f1(C.y,-1e6,1e6,"invalid-area-circle"),radius:f1(C.radius,.05,2.5,"invalid-area-circle")}},W7=L=>L==="current"||L==="review"||L==="stale"?L:"unknown",x0=L=>{let C=R(L,"invalid-areas");if(!Array.isArray(C.areas)||C.areas.length>256)throw new m("invalid-area-list");return{sceneUrl:X(C.scene_url,"invalid-area-scene-url"),rooms:m0(C.rooms,!0),areas:C.areas.map(H=>{let V=R(H,"invalid-area");if(!Array.isArray(V.circles)||V.circles.length>512)throw new m("invalid-area-circles");return{id:w(V.id,128,"invalid-area-id"),name:w(V.name,128,"invalid-area-name"),circles:V.circles.map(I7),cleaningMode:c0(V.cleaning_mode),coverageSetting:u0(V.coverage_setting),status:W7(V.status),canRebind:y(V.can_rebind,"invalid-area-rebind")}})}},Z0=L=>{let C=R(L,"invalid-plans");if(!Array.isArray(C.plans)||C.plans.length>256)throw new m("invalid-plan-list");return{rooms:m0(C.rooms,!1).map(({roomId:V,name:e})=>({roomId:V,name:e})),selectedPlan:C.selected_plan===null||C.selected_plan===void 0?null:w(C.selected_plan,128,"invalid-selected-plan"),plans:C.plans.map(V=>{let e=R(V,"invalid-plan");if(!Array.isArray(e.rooms)||e.rooms.length>256||!Array.isArray(e.room_order))throw new m("invalid-plan-rooms");let r=e.run_behavior;if(r!=="intelligent"&&r!=="ordered")throw new m("invalid-run-behavior");return{id:w(e.id,128,"invalid-plan-id"),name:w(e.name,128,"invalid-plan-name"),enabled:y(e.enabled,"invalid-plan-enabled"),runBehavior:r,rooms:e.rooms.map(t=>{let o=R(t,"invalid-plan-room");return{roomId:w(o.room_id,128,"invalid-plan-room-id"),cleaningMode:c0(o.cleaning_mode),coverageSetting:u0(o.coverage_setting)}}),roomOrder:e.room_order.slice(0,256).map(t=>w(t,128,"invalid-room-order")),returnToBase:y(e.return_to_base,"invalid-return-to-base"),finishCurrentRoom:y(e.finish_current_room,"invalid-finish-room"),finishCurrentRoomThreshold:z(e.finish_current_room_threshold,0,100,"invalid-finish-threshold")}})}},h0=L=>{let C=R(L,"invalid-pose"),H=C.position,V=H===null?null:p0(H,"invalid-pose-position"),e=C.pose_freshness;if(e!=="live"&&e!=="coordinator_fallback")throw new m("invalid-pose-freshness");return{position:V,source:w(C.source,64,"invalid-pose-source"),revision:z(C.revision,0,Number.MAX_SAFE_INTEGER,"invalid-pose-revision"),poseRevision:z(C.pose_revision,0,Number.MAX_SAFE_INTEGER,"invalid-pose-sequence"),floorCoherent:y(C.map_floor_coherent,"invalid-pose-floor"),mapSessionKey:s0(C.map_session_key),freshness:e}},S0=L=>{try{return X(L,"invalid-private-path"),!0}catch{return!1}};var f0=L=>{let r=()=>{throw new Error("invalid-scene")};(!(L instanceof ArrayBuffer)||L.byteLength<24||L.byteLength>16777216)&&r();let t=new DataView(L),o=new Uint8Array(L,0,8),M=String.fromCharCode(...o),i=t.getUint16(8,!0),a=t.getUint16(10,!0),n=t.getUint32(12,!0),A=t.getUint32(16,!0),s=t.getUint32(20,!0),p=A+s,u=24+n;(M!=="MATIC3D\0"||i!==1||a!==8||n>1024*1024||p<1||p>15e5||u+p*a!==L.byteLength)&&r();let h;try{h=JSON.parse(new TextDecoder("utf-8",{fatal:!0}).decode(new Uint8Array(L,24,n)))}catch{r()}(!h||typeof h!="object"||Array.isArray(h))&&r();let x=h,f=x.meters_per_cell,S=x.origin_cells,g=x.span_cells;(typeof f!="number"||!Number.isFinite(f)||f<.001||f>.1||!Array.isArray(S)||S.length!==2||!S.every(E=>typeof E=="number"&&Number.isFinite(E))||!Array.isArray(g)||g.length!==2||!g.every(E=>typeof E=="number"&&Number.isFinite(E)&&E>=1&&E<=65536))&&r();let W1=(Array.isArray(x.rooms)?x.rooms.slice(0,128):[]).flatMap((E,W0)=>{if(!E||typeof E!="object"||Array.isArray(E))return[];let L1=E,N1=typeof L1.name=="string"?L1.name.trim():"";if(!N1||Array.from(N1).length>128||/[\u0000-\u001f\u007f]/u.test(N1))return[];if(!Array.isArray(L1.boundary)||L1.boundary.length<3||L1.boundary.length>8192)return[];let n5=L1.boundary.flatMap(s2=>{if(!Array.isArray(s2)||s2.length!==2)return[];let[d2,p2]=s2;return typeof d2=="number"&&Number.isFinite(d2)&&typeof p2=="number"&&Number.isFinite(p2)?[[d2,p2]]:[]}),n2=L1.center;if(n5.length<3||!Array.isArray(n2)||n2.length!==2)return[];let[A2,l2]=n2;return typeof A2!="number"||!Number.isFinite(A2)||typeof l2!="number"||!Number.isFinite(l2)?[]:[{id:`scene-room-${W0+1}`,name:N1,boundary:n5,center:[A2,l2]}]}),I0=typeof x.sample_step=="number"&&Number.isInteger(x.sample_step)?Math.max(1,Math.min(15e5,x.sample_step)):1,i5=S,a5=g;return{buffer:L,pointOffset:u,floorCount:A,surfaceCount:s,total:p,metadata:{metersPerCell:f,origin:[i5[0],i5[1]],span:[a5[0],a5[1]],sampleStep:I0,rooms:W1}}},G7=L=>{if(L.byteLength>16777216||L.byteLength<24||!1||!1)throw new m("invalid-scene");try{return f0(L)}catch{throw new m("invalid-scene")}},Q7=()=>`
  const parseTransfer = ${f0.toString()};
...
`,e2=class{#C=null;#H=null;#V=0;#t=new Map;constructor(){if(!(typeof Worker!="function"||typeof URL?.createObjectURL!="function"))try{this.#H=URL.createObjectURL(new Blob([Q7()],{type:"text/javascript"})),this.#C=new Worker(this.#H),this.#C.onmessage=C=>{let H=this.#t.get(C.data.id);H&&(this.#t.delete(C.data.id),C.data.ok&&C.data.parsed?H.resolve(C.data.parsed):H.reject(new m(C.data.problem||"invalid-scene")))},this.#C.onerror=()=>this.#M("scene-worker-failed")}catch{this.#C=null,this.#H&&URL.revokeObjectURL(this.#H),this.#H=null}}async parse(C,H){if(H?.aborted)throw new DOMException("Aborted","AbortError");if(!this.#C){if(await new Promise(e=>window.setTimeout(e,0)),H?.aborted)throw new DOMException("Aborted","AbortError");return G7(C)}let V=++this.#V;return new Promise((e,r)=>{let t=()=>{this.#t.delete(V),r(new DOMException("Aborted","AbortError"))};H?.addEventListener("abort",t,{once:!0}),this.#t.set(V,{resolve:o=>{H?.removeEventListener("abort",t),e(o)},reject:o=>{H?.removeEventListener("abort",t),r(o)}}),this.#C?.postMessage({id:V,buffer:C},[C])})}#M(C){for(let H of this.#t.values())H.reject(new m(C));this.#t.clear(),this.#C?.terminate(),this.#C=null}dispose(){this.#M("scene-parser-disposed"),this.#H&&URL.revokeObjectURL(this.#H),this.#H=null}};var Y={catalog:1e4,scene:6e4,delta:35e3,pose:1e4,history:15e3,workflow:15e3,mutation:2e4},F=class extends Error{constructor(C,H=null){super(C),this.name="BackendError",this.code=C,this.status=H}},$1=36,g1=16*1024*1024,g0=(L,C)=>{let H=Number(L);if(!Number.isSafeInteger(H)||H<0)throw new m(C);return H},y0=(L,C)=>{let H=L.headers.get("X-Matic-Revision");if(H===null)return C;let V=Number(H);if(!Number.isSafeInteger(V)||V<0)throw new m("invalid-scene-revision");return V},b0=(L,C)=>{let H=L.headers.get("X-Matic-Floor-Coherent");if(H===null)return C;if(H==="1")return!0;if(H==="0")return!1;throw new m("invalid-scene-floor-header")},r2=class{#C;#H=new e2;constructor(C){this.#C=C}async#V(C,H,V,e){if(!S0(C))throw new F("invalid-private-path");if(e?.aborted)throw new DOMException("Aborted","AbortError");let r=new AbortController,t=()=>r.abort();e?.addEventListener("abort",t,{once:!0});let o=!1,M=window.setTimeout(()=>{o=!0,r.abort()},V);try{let i=this.#C(),a=new Headers(H.headers),n={...H,cache:"no-store",credentials:"same-origin",headers:Object.fromEntries(a.entries()),signal:r.signal};if(typeof i?.fetchWithAuth=="function")return await i.fetchWithAuth(C,n);let A=i?.auth?.accessToken||i?.auth?.data?.access_token;A&&a.set("Authorization",`Bearer ${A}`);let s=typeof i?.hassUrl=="function"?i.hassUrl(C):C;return await fetch(s,{...n,headers:a})}catch(i){throw o&&!e?.aborted?new F("request-timeout"):r.signal.aborted?new DOMException("Aborted","AbortError"):i}finally{window.clearTimeout(M),e?.removeEventListener("abort",t)}}async#t(C,H,V,e={}){let r=await this.#V(C,{...e,headers:{Accept:"application/json",...e.headers||{}}},H,V);if(!r.ok){let t=r.headers.get("X-Matic-Plans-Conflict");throw new F(t==="map-rechecking"?"map-rechecking":"request-failed",r.status)}try{return await r.json()}catch{throw new m("invalid-json-response")}}async catalog(C){return d0(await this.#t(l0,Y.catalog,C))}async scene(C,H,V,e,r,t){let o=new Headers({Accept:"application/vnd.matic.slam-scene"});e==="live"&&o.set("X-Matic-Prefer-Cached","1"),t&&o.set("If-None-Match",t);let M=await this.#V(C,{headers:o},Y.scene,r),i=y0(M,H),a=b0(M,V);if(M.status===304)return{scene:null,floorCoherent:a,revision:i,notModified:!0};if(!M.ok)throw new F("scene-request-failed",M.status);if(M.headers.get("Content-Type")?.split(";",1)[0]!=="application/vnd.matic.slam-scene")throw new m("invalid-scene-content-type");return{scene:{...await this.#H.parse(await M.arrayBuffer(),r),revision:i,etag:M.headers.get("ETag"),source:e},floorCoherent:a,revision:i,notModified:!1}}async#M(C,H,V){if(!Number.isSafeInteger(H)||H<1||H>g1||typeof DecompressionStream!="function")throw new m("invalid-scene-delta");let r=new Blob([C]).stream().pipeThrough(new DecompressionStream("deflate")).getReader(),t=new Uint8Array(H),o=0,M=()=>{r.cancel()};V?.addEventListener("abort",M,{once:!0});try{for(;;){if(V?.aborted)throw new DOMException("Aborted","AbortError");let{done:i,value:a}=await r.read();if(i)break;if(!(a instanceof Uint8Array)||o+a.byteLength>H)throw new m("invalid-scene-delta");t.set(a,o),o+=a.byteLength}}finally{V?.removeEventListener("abort",M),r.releaseLock()}if(o!==H)throw new m("invalid-scene-delta");return t}async#L(C,H,V){if(C.byteLength<$1||C.byteLength>$1+g1||H.buffer.byteLength>g1)throw new m("invalid-scene-delta");let e=new DataView(C),r=new TextDecoder().decode(new Uint8Array(C,0,8)),t=e.getUint16(8,!0),o=e.getUint16(10,!0),M=g0(e.getBigUint64(12,!0),"invalid-scene-delta"),i=g0(e.getBigUint64(20,!0),"invalid-scene-delta"),a=e.getUint32(28,!0),n=e.getUint32(32,!0);if(r!=="MATICDLT"||t!==1||o!==1||M!==H.revision||i<=H.revision||a<24||a>g1||n>g1||n+$1!==C.byteLength)throw new m("invalid-scene-delta");let A=new Uint8Array(C,$1,n),s=new Uint8Array(H.buffer),u=(await this.#M(A,Math.max(s.byteLength,a),V)).slice(),h=1024*1024;for(let S=0;S<s.byteLength;S+=h){if(V?.aborted)throw new DOMException("Aborted","AbortError");let g=Math.min(s.byteLength,S+h);for(let P=S;P<g;P+=1)u[P]=(u[P]??0)^(s[P]??0);g<s.byteLength&&await new Promise(P=>window.setTimeout(P,0))}let x=u.slice(0,a).buffer;return{parsed:{...await this.#H.parse(x,V),revision:i,etag:null,source:"live"},revision:i}}async sceneDelta(C,H,V,e){let r=C.includes("?")?"&":"?",t=await this.#V(`${C}${r}since=${encodeURIComponent(H.revision)}`,{headers:{Accept:"application/vnd.matic.slam-delta, application/vnd.matic.slam-scene"}},Y.delta,e),o=y0(t,H.revision),M=b0(t,V);if(t.status===204){if(o!==H.revision)throw new m("invalid-scene-delta-revision");return{scene:null,floorCoherent:M,revision:o,notModified:!0}}if(!t.ok)throw new F("delta-request-failed",t.status);if(o<=H.revision)throw new m("invalid-scene-delta-revision");let i=Number(t.headers.get("Content-Length"));if(Number.isFinite(i)&&i>$1+g1)throw new m("invalid-scene-delta-size");let a=t.headers.get("Content-Type")?.split(";",1)[0],n=await t.arrayBuffer();if(a==="application/vnd.matic.slam-delta"){let s=Number(t.headers.get("X-Matic-Base-Revision"));if(!Number.isSafeInteger(s)||s!==H.revision)throw new m("invalid-scene-delta-base");let p=await this.#L(n,H,e);if(p.revision!==o)throw new m("invalid-scene-delta-revision");return{scene:{...p.parsed,etag:t.headers.get("ETag")},floorCoherent:M,revision:o,notModified:!1}}if(a!=="application/vnd.matic.slam-scene")throw new m("invalid-scene-delta-content-type");return{scene:{...await this.#H.parse(n,e),revision:o,etag:t.headers.get("ETag"),source:"live"},floorCoherent:M,revision:o,notModified:!1}}async pose(C,H){return h0(await this.#t(C,Y.pose,H))}async history(C,H){return v0(await this.#t(C,Y.history,H))}async plans(C,H){return Z0(await this.#t(C,Y.workflow,H))}async areas(C,H){return x0(await this.#t(C,Y.workflow,H))}async saveArea(C,H,V){let e=await this.#t(C,Y.mutation,V,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({...H.areaId?{area_id:H.areaId}:{},name:H.name,circles:H.circles,cleaning_mode:H.cleaningMode,coverage_setting:H.coverageSetting})});if(!e||typeof e!="object"||typeof e.id!="string")throw new m("invalid-area-save-response");return e.id}async deleteArea(C,H,V){let e=await this.#V(`${C}?area_id=${encodeURIComponent(H)}`,{method:"DELETE",headers:{Accept:"application/json"}},Y.mutation,V);if(!e.ok)throw new F("area-delete-failed",e.status)}async service(C,H,V,e){let r=this.#C();if(typeof r?.callService!="function")throw new F("service-unavailable");await r.callService(C,H,V,{entity_id:e})}dispose(){this.#H.dispose()}};var w0=()=>({version:4,view:"top",appearance:"photo",labels:!0,quality:"auto",cameras:{}}),I1=(L,C,H)=>Math.max(C,Math.min(H,L)),k0=L=>L.replaceAll(/[^a-zA-Z0-9_-]/g,"").slice(0,128)||"local-user",r5=(L,C=4)=>`matic-map-studio:v${C}:${k0(L)}`,K7=L=>{if(!L||typeof L!="object")return null;let C=L;return["yaw","pitch","zoom","targetX","targetZ"].every(V=>typeof C[V]=="number"&&Number.isFinite(C[V]))?{yaw:I1(C.yaw,-Math.PI,Math.PI),pitch:I1(C.pitch,.18,Math.PI/2-.018),zoom:I1(C.zoom,.01,100),targetX:I1(C.targetX,-1e4,1e4),targetZ:I1(C.targetZ,-1e4,1e4)}:null},O0=L=>{let C=w0();if(!L||typeof L!="object")return C;let H=L,V=H.view==="three"||H.view==="top"||H.view==="rooms"?H.view:C.view,e=V==="rooms"?"top":V,r=H.quality==="auto"||H.quality==="efficient"||H.quality==="balanced"||H.quality==="maximum"?H.quality:C.quality,t=H.cameras&&typeof H.cameras=="object"?H.cameras:{},o={};for(let M of["three","top"]){let i=K7(t[M]);i&&(o[M]=i)}return{version:4,view:e,appearance:H.appearance==="rooms"||H.appearance==="photo"?H.appearance:C.appearance,labels:typeof H.labels=="boolean"?H.labels:C.labels,quality:r,cameras:o}},t2=class{#C="local-user";#H=null;load(C){this.#C=k0(C);try{let H=window.localStorage.getItem(r5(this.#C));if(H)return O0(JSON.parse(H));for(let V of[3,2]){let e=window.localStorage.getItem(r5(this.#C,V));if(e)return O0(JSON.parse(e))}}catch{}return w0()}schedule(C){this.#H!==null&&window.clearTimeout(this.#H),this.#H=window.setTimeout(()=>{this.#H=null;try{window.localStorage.setItem(r5(this.#C),JSON.stringify(C))}catch{}},250)}dispose(){this.#H!==null&&window.clearTimeout(this.#H),this.#H=null}},P0="matic-map-studio:preferred-frontend",_0=()=>{try{return window.localStorage.getItem(P0)==="v3"?"v3":"v4"}catch{return"v4"}},t5=L=>{try{return window.localStorage.setItem(P0,L),!0}catch{return!1}};var v=(L,C,H=null)=>({status:L,value:C,problem:H}),G=L=>L instanceof DOMException&&L.name==="AbortError",l1=(L,C)=>L instanceof F||L&&typeof L=="object"&&"code"in L&&typeof L.code=="string"?L.code:C,M2=L=>[L.selectedFloorOrdinal??"none",L.mapFloorOrdinal??"none",L.mapFloorCoherent?"coherent":"transition"].join(":"),o2=L=>[L.mapFloorOrdinal??"none",L.mapSessionVerified?"verified":"unverified",L.mapSessionKey??"no-session"].join(":"),Q=L=>[L.entryId,L.selectedFloorOrdinal??"none",L.mapFloorOrdinal??"none"].join("|"),T0=L=>[L.entryId,M2(L),o2(L),L.mapRevision].join("|"),B0=L=>L.runnerLocked||L.stopSettlePending||L.activePlan||L.nativeReconciliationPending||L.nativeSessionActive===!0,q7=(L,C)=>L.entryKey===C.entryKey&&L.generation===C.generation&&L.floorKey===C.floorKey&&L.missionKey===C.missionKey,R0="Live map updates paused while the current map is rechecked.",F0="Reconnecting. The last verified map remains read only.",X7=1e3,Y7=["rooms","plan","draw","areaReview"],M5=(L,C)=>L.label?L.label:L.active?"Current floor":`Saved floor ${L.ordinal??C}`,i2=class{#C;#H=new z1;#V;#t=new t2;#M=new Map;#L=null;#a;#i=null;#A=null;#e=null;#x=0;#f=!1;#Z=!1;#s=!1;#n=Promise.resolve();#c=!1;#o=!1;#d="";#u=0;#S="";#r=!1;#m=!0;constructor(C,H){this.#C=C,this.#V=H}sync(C,H){if(this.#r)return;this.#L&&this.#L.entryKey!==C.entryKey&&(this.#x+=1,this.#e!==null&&window.clearTimeout(this.#e),this.#e=null,(this.#C.value.command==="starting"||this.#C.value.command==="settling")&&this.#C.patch({command:"idle"}));let V=this.#m;if(this.#m=C.host.connected,this.#L=C,this.#a=H,this.#C.patch({host:C.host,activity:C.activity,batteryPercent:C.batteryPercent,robotLabel:C.robotLabel,robots:C.robots,locale:C.language}),C.userKey!==this.#S){this.#S=C.userKey;let e=this.#t.load(C.userKey);this.#C.patch({view:e.view,appearance:e.appearance,labelsVisible:e.labels,quality:e.quality,cameras:e.cameras})}if(!C.host.administrator){this.#l(),this.#O("access-required");return}if(!C.host.connected){this.#l(),this.#s=!1,this.#o=!1;let e=this.#M.has("area-mutation")&&this.#C.value.command==="pending";this.#y();let r=this.#C.value,t=r.resources.scene.value;this.#C.patch({command:e?"idle":r.command,coherence:t?"degraded":"unavailable",resources:{...r.resources,catalog:r.resources.catalog.status==="loading"?v("idle",r.resources.catalog.value):r.resources.catalog,plans:r.resources.plans.status==="loading"?v("idle",r.resources.plans.value):r.resources.plans,areas:r.resources.areas.status==="loading"?v("idle",r.resources.areas.value):r.resources.areas,pose:v("idle",null)},map:{...r.map,available:t!==null,exactPose:!1},notice:t?{tone:"warning",text:F0}:r.notice});return}if(C.host.robotCount===0){this.#l(),this.#O("map-unavailable");return}if(this.#h(),!V){this.#C.value.notice?.text===F0&&this.#C.patch({notice:null}),this.refreshCatalog(!0);return}(this.#C.value.resources.catalog.status==="idle"||C.entryKey&&C.entryKey!==this.#C.value.selection.entryId)&&this.refreshCatalog(!0)}schedulePreferences(C){this.#t.schedule(C)}#h(){this.#i===null&&(this.#i=window.setInterval(()=>{document.visibilityState==="visible"&&this.refreshCatalog()},5e3)),this.#A===null&&(this.#A=window.setInterval(()=>{document.visibilityState==="visible"&&this.refreshPose()},X7))}#l(){this.#i!==null&&window.clearInterval(this.#i),this.#A!==null&&window.clearInterval(this.#A),this.#i=null,this.#A=null}#v(C){this.#M.get(C)?.abort();let H=new AbortController;return this.#M.set(C,H),H}#p(C,H){this.#M.get(C)===H&&this.#M.delete(C)}#y(C=[]){for(let[H,V]of this.#M)C.includes(H)||(V.abort(),this.#M.delete(H))}#O(C){this.#y(),this.#H.invalidate(),this.#d="";let H=this.#C.value;this.#C.patch({generation:this.#H.generation,coherence:H.host.administrator?"unavailable":"blocked",fullMap:!1,precisionOpen:!1,resources:{catalog:v("error",null,C),entry:null,scene:v("idle",null),pose:v("idle",null),history:v("idle",null),plans:v("idle",null),areas:v("idle",null)},map:{available:!1,complete:!1,floorCoherent:!1,sessionVerified:!1,exactPose:!1},selection:{...H.selection,entryId:null,floorId:"current",historyId:null}})}async refreshCatalog(C=!1){if(this.#r||!this.#L?.host.administrator||!this.#L.host.connected||this.#L.host.robotCount===0)return;if(this.#f)return C&&!this.#Z&&(this.#s=!0,this.#M.get("catalog")?.abort()),this.#n;this.#f=!0,this.#Z=C;let H;this.#n=new Promise(r=>{H=r});let V=this.#v("catalog"),e=this.#C.value.resources.catalog.value;this.#C.patch({resources:{...this.#C.value.resources,catalog:v("loading",e)}});try{let r=await this.#V.catalog(V.signal);if(V.signal.aborted||this.#r)return;let t=this.#a?.config?.entry_id,o=typeof t=="string"?t:null,M=r.find(n=>n.entryId===this.#L?.entryKey)||r.find(n=>n.entryId===o)||r[0]||null,i=this.#C.value.resources.entry;if(M&&i&&Q(M)===Q(i)&&M2(M)===M2(i)&&o2(M)===o2(i)&&M.mapRevision<i.mapRevision&&(M={...M,mapRevision:i.mapRevision}),this.#C.patch({managedLock:M?B0(M):!1,resources:{...this.#C.value.resources,catalog:v(r.length?"ready":"empty",r),entry:M}}),!M){this.#O("no-loaded-robot");return}if(this.#C.value.selection.floorId!=="current"&&!C)return;let a=T0(M);if(!C&&a===this.#d){let n=this.#C.value,A=M.mapFloorCoherent&&M.mapSessionVerified,s=M.health==="problem"||M.health==="limited";this.#C.patch({coherence:A?s?"degraded":"current":"verifying",map:{...n.map,available:A&&n.resources.scene.value!==null,complete:M.mapComplete&&!M.mapTruncated,floorCoherent:M.mapFloorCoherent,sessionVerified:M.mapSessionVerified,exactPose:A?n.map.exactPose:!1},floor:{...n.floor,classifiedCount:Math.max(1,M.historyFloorCount)}}),A&&this.#C.value.resources.plans.problem==="map-rechecking"&&this.loadPlans();return}this.#d=a,this.#k(M)}catch(r){if(G(r))return;this.#C.patch({coherence:this.#C.value.resources.scene.value?"degraded":"unavailable",resources:{...this.#C.value.resources,catalog:v("error",e,l1(r,"catalog-unavailable"))}})}finally{this.#p("catalog",V),this.#f=!1;let r=this.#s;this.#Z=!1;try{r&&!this.#r&&(this.#s=!1,await this.refreshCatalog(!0))}finally{H()}}}#k(C){let H=this.#C.value,V=H.resources.entry,e=!!(V&&Q(V)===Q(C)),r=C.mapFloorCoherent&&C.mapSessionVerified;this.#y(e?["catalog","plans","areas","plan-mutation","area-mutation"]:["catalog"]);let t=e?H.resources.scene.value:null,o=H.resources.pose.value,M=e&&r&&C.mapSessionKey!==null&&o?.position&&o.mapSessionKey===C.mapSessionKey?o:null,i=this.#H.begin(C.entryId,M2(C),o2(C),C.mapRevision),a=C.health==="problem"||C.health==="limited",n=this.#C.value;this.#C.patch({managedLock:B0(C),generation:i.generation,coherence:r?a?"degraded":"current":"verifying",dataMode:"live",resources:{...n.resources,entry:C,scene:v(r?"loading":"idle",t),pose:v(r?"loading":"idle",M),history:v("loading",n.resources.history.value),plans:e?n.resources.plans:v("idle",null),areas:e?n.resources.areas:v("idle",null)},map:{available:r&&t!==null,complete:C.mapComplete&&!C.mapTruncated,floorCoherent:C.mapFloorCoherent,sessionVerified:C.mapSessionVerified,exactPose:r&&M!==null},floor:{classifiedCount:Math.max(1,C.historyFloorCount),displayName:C.selectedFloorOrdinal?`Floor ${C.selectedFloorOrdinal}`:"Current floor",readOnly:!1},selection:{...n.selection,entryId:C.entryId,floorId:"current",historyId:null,roomIds:e?n.selection.roomIds:[],planId:e?n.selection.planId:null,areaId:e?n.selection.areaId:null}}),this.#T(C,i),r&&this.#C.value.resources.plans.status==="idle"&&this.loadPlans(),r&&(this.#F(C,i),this.#b(C,i))}async#F(C,H){let V=this.#v("scene");try{let e=await this.#V.scene(C.sceneUrl,C.mapRevision,C.mapFloorCoherent,"live",V.signal);if(!this.#H.accepts(H)||e.revision!==H.revision||!e.floorCoherent||!e.scene)return;let r=this.#C.value;this.#C.patch({resources:{...r.resources,scene:v("ready",e.scene)},map:{...r.map,available:!0},notice:r.notice?.text===R0?null:r.notice});let t=this.#C.value.resources.plans;if((t.status==="idle"||t.problem==="map-rechecking")&&this.loadPlans(),C.deltaUrl){let o=++this.#u;this.#w(C,H,e.scene,o)}}catch(e){if(G(e)||!this.#H.accepts(H))return;if(e instanceof F&&e.code==="request-timeout"){let M=this.#C.value;this.#C.patch({resources:{...M.resources,scene:v("loading",M.resources.scene.value,"scene-building")}}),window.setTimeout(()=>{this.#r||!this.#H.accepts(H)||this.#C.value.selection.floorId!=="current"||this.#F(C,H)},250);return}let r=this.#C.value,t=r.resources.pose.value,o=r.resources.scene.value!==null&&C.mapSessionKey!==null&&t?.position!==null&&t?.mapSessionKey===C.mapSessionKey;this.#C.patch({coherence:"degraded",resources:{...r.resources,scene:v("error",r.resources.scene.value,l1(e,"scene-unavailable"))},map:{...r.map,available:r.resources.scene.value!==null,exactPose:o}})}finally{this.#p("scene",V)}}async#w(C,H,V,e){if(!C.deltaUrl||typeof DecompressionStream!="function")return;let r=C.deltaUrl,t=C,o=H,M=V;try{for(;!this.#r&&e===this.#u&&this.#H.accepts(o)&&this.#C.value.selection.floorId==="current";){let i=this.#v("delta");try{let a=await this.#V.sceneDelta(r,M,t.mapFloorCoherent,i.signal);if(i.signal.aborted||this.#r||e!==this.#u||!this.#H.accepts(o))return;if(!a.floorCoherent){this.#C.patch({coherence:"verifying",map:{...this.#C.value.map,available:!1,floorCoherent:!1,exactPose:!1},resources:{...this.#C.value.resources,pose:v("idle",null)}}),this.#d="",this.refreshCatalog(!0);return}if(a.notModified||!a.scene){await new Promise(s=>window.setTimeout(s,100));continue}let n=this.#H.advance(o,a.revision);if(!n)return;o=n,M=a.scene,t={...t,mapRevision:a.revision},this.#d=T0(t);let A=this.#C.value;this.#C.patch({resources:{...A.resources,entry:t,scene:v("ready",M)},map:{...A.map,available:!0,floorCoherent:!0}}),this.#b(t,o)}finally{this.#p("delta",i)}}}catch(i){if(G(i)||this.#r||e!==this.#u||!this.#H.accepts(o))return;this.#C.patch({coherence:"degraded",notice:{tone:"warning",text:R0}}),this.#d="",this.refreshCatalog(!0)}}async#T(C,H){let V=this.#v("history");try{let e=await this.#V.history(C.historyUrl,V.signal);if(!this.#H.accepts(H)||e.entryId!==C.entryId)return;let r=this.#C.value,t=e.floors.find(i=>i.id===r.selection.floorId),o=!r.selection.historyId||t?.snapshots.some(i=>i.id===r.selection.historyId),M=r.dataMode==="live"?e.floors.find(i=>i.active):t;if(this.#C.patch({resources:{...this.#C.value.resources,history:v("ready",e)},floor:{...this.#C.value.floor,classifiedCount:e.floors.length,...M?{displayName:M5(M,1)}:{}}}),r.dataMode==="history"&&(!t||!o)){let i=t||e.floors.find(n=>n.active)||e.floors[0],a=this.selectFloor(i?.id||"current");!this.#r&&r.workflow==="history"&&this.#C.dispatch({type:"open-workflow",workflow:"history"}),await a}}catch(e){if(G(e)||!this.#H.accepts(H))return;this.#C.patch({resources:{...this.#C.value.resources,history:v("error",null,l1(e,"history-unavailable"))}})}finally{this.#p("history",V)}}async refreshPose(){let C=this.#C.value.resources.entry,H=this.#H.current();!C||!H||this.#C.value.selection.floorId!=="current"||!C.mapFloorCoherent||!C.mapSessionVerified||await this.#b(C,H)}async#b(C,H){if(this.#r||!this.#m||!this.#L?.host.connected)return;if(this.#c){this.#o=!0;return}this.#c=!0;let V=this.#v("pose");try{let e=await this.#V.pose(C.poseUrl,V.signal),r=this.#H.current(),t=this.#C.value.resources.entry;if(!r||!q7(H,r)||!t||!e.floorCoherent)return;if(e.mapSessionKey===null||e.mapSessionKey!==t.mapSessionKey){this.#C.patch({map:{...this.#C.value.map,exactPose:!1}}),this.#d="",this.refreshCatalog(!0);return}let o=this.#C.value,M=o.resources.pose.value,i=!!(o.map.exactPose&&M?.position&&M.mapSessionKey===t.mapSessionKey);if(e.position===null&&i){this.#C.patch({resources:{...o.resources,pose:v("ready",M)}});return}this.#C.patch({resources:{...o.resources,pose:v("ready",e)},map:{...o.map,exactPose:e.position!==null}})}catch(e){if(G(e)||!this.#H.accepts(H))return;let r=this.#C.value,t=r.resources.pose.value,o=!!(r.map.exactPose&&t?.position&&t.mapSessionKey===r.resources.entry?.mapSessionKey);this.#C.patch({resources:{...r.resources,pose:v("error",o?t:null,l1(e,"pose-unavailable"))},map:{...r.map,exactPose:o}})}finally{if(this.#p("pose",V),this.#c=!1,this.#o&&!this.#r&&this.#m&&this.#L?.host.connected&&this.#L.host.administrator&&this.#L.host.robotCount>0){this.#o=!1;let e=this.#C.value.resources.entry,r=this.#H.current();e&&r&&this.#b(e,r)}else this.#o=!1}}async selectFloor(C){let H=this.#C.value.resources.history.value,V=this.#C.value.resources.entry;if(!H||!V)return;let e=H.floors.find(M=>M.id===C);if(!e&&C!=="current")return;let r=this.#C.value;if(r.workflow==="draw"&&(r.draw.dirty||r.areaDraft.dirty)||r.workflow==="areaReview"&&(r.draw.dirty||r.areaDraft.dirty))return;if(!e||e.active){this.#d="";let M=this.#C.value;this.#C.patch({resources:{...M.resources,plans:v("idle",null),areas:v("idle",null),scene:v("idle",null),pose:v("idle",null)},map:{...M.map,available:!1,exactPose:!1},coherence:"verifying",floor:{...M.floor,readOnly:!1,displayName:"Current floor"},workflow:"none",precisionOpen:!1}),this.#C.dispatch({type:"set-floor",floorId:"current"}),await this.refreshCatalog(!0);return}let t=e.snapshots.at(-1);this.#y(["catalog"]);let o=this.#H.begin(V.entryId,e.id,t?.id||e.id,t?.revision||0);this.#C.patch({generation:o.generation,coherence:"current",dataMode:"history",floor:{classifiedCount:H.floors.length,displayName:M5(e,H.floors.indexOf(e)+1),readOnly:!0},selection:{...this.#C.value.selection,floorId:e.id,historyId:t?.id||null},resources:{...this.#C.value.resources,scene:v(t?"loading":"empty",null),pose:v("idle",null),plans:v("idle",null),areas:v("idle",null)},workflow:"none",precisionOpen:!1,map:{available:!1,complete:!0,floorCoherent:!0,sessionVerified:!0,exactPose:!1}}),t&&await this.#g(t,o)}async selectHistory(C){let H=this.#C.value.resources.history.value,V=this.#C.value.resources.entry;if(!H||!V)return;if(!C){await this.selectFloor("current");return}let e=H.floors.find(o=>o.snapshots.some(M=>M.id===C)),r=e?.snapshots.find(o=>o.id===C);if(!e||!r)return;let t=this.#H.begin(V.entryId,e.id,r.id,r.revision);this.#y(["catalog"]),this.#C.patch({generation:t.generation,dataMode:"history",floor:{classifiedCount:H.floors.length,displayName:M5(e,H.floors.indexOf(e)+1),readOnly:!0},selection:{...this.#C.value.selection,floorId:e.id,historyId:r.id},resources:{...this.#C.value.resources,scene:v("loading",null),pose:v("idle",null)},map:{...this.#C.value.map,available:!1,exactPose:!1}}),await this.#g(r,t)}async#g(C,H){let V=this.#v("history-scene");try{let e=await this.#V.scene(C.sceneUrl,C.revision,!0,"history",V.signal);if(!this.#H.accepts(H)||!e.scene)return;this.#C.patch({resources:{...this.#C.value.resources,scene:v("ready",e.scene)},map:{...this.#C.value.map,available:!0,exactPose:!1}})}catch(e){if(G(e)||!this.#H.accepts(H))return;this.#C.patch({resources:{...this.#C.value.resources,scene:v("error",null,l1(e,"history-scene-unavailable"))}})}finally{this.#p("history-scene",V)}}async openWorkflow(C){let H=this.#C.value;if((H.dataMode==="history"||H.floor.readOnly)&&Y7.includes(C))return;let V=this.#C.value.workflow;if(C==="draw"&&V!=="draw"&&V!=="areaReview"&&this.selectArea(null),this.#C.dispatch({type:"open-workflow",workflow:C}),C==="history"){let e=this.#C.value.resources.entry,r=this.#H.current();e&&r&&(this.#C.patch({resources:{...this.#C.value.resources,history:v("loading",this.#C.value.resources.history.value)}}),await this.#T(e,r))}(C==="plan"||C==="rooms")&&await this.loadPlans(),(C==="draw"||C==="areaReview")&&await this.loadAreas()}async loadPlans(){let C=this.#C.value.resources.entry;if(!C||!this.#H.current()||!v2(this.#C.value)||this.#C.value.resources.plans.status==="loading")return;let H=Q(C),V=this.#v("plans");this.#C.patch({resources:{...this.#C.value.resources,plans:v("loading",null)}});try{let e=await this.#V.plans(C.plansUrl,V.signal),r=this.#C.value.resources.entry;if(!r||Q(r)!==H)return;if(this.#C.value.planDraft.dirty){this.#C.patch({resources:{...this.#C.value.resources,plans:v("ready",e)}});return}let t=e.selectedPlan||e.plans[0]?.id||null,o=e.plans.find(M=>M.id===t);this.#C.patch({resources:{...this.#C.value.resources,plans:v("ready",e)},selection:{...this.#C.value.selection,planId:t},planDraft:o?this.#B(o):{...this.#C.value.planDraft,id:null,name:"",rooms:[],dirty:!1}})}catch(e){let r=this.#C.value.resources.entry;if(G(e)||!r||Q(r)!==H)return;let t=e instanceof F&&e.code==="map-rechecking"?"map-rechecking":l1(e,"plans-unavailable");this.#C.patch({resources:{...this.#C.value.resources,plans:v("error",null,t)}})}finally{this.#p("plans",V)}}selectPlan(C){let H=this.#C.value.resources.plans.value?.plans.find(V=>V.id===C);this.#C.patch({selection:{...this.#C.value.selection,planId:C},planDraft:H?this.#B(H):{...this.#C.value.planDraft,id:null,name:"",rooms:[],dirty:!1}})}#B(C){return{id:C.id,name:C.name,enabled:C.enabled,runBehavior:C.runBehavior,rooms:(C.roomOrder.length?C.roomOrder.flatMap(H=>{let V=C.rooms.find(e=>e.roomId===H);return V?[V]:[]}):C.rooms).map(H=>({...H})),returnToBase:C.returnToBase,finishCurrentRoom:C.finishCurrentRoom,finishCurrentRoomThreshold:C.finishCurrentRoomThreshold,dirty:!1}}async loadAreas(){let C=this.#C.value.resources.entry;if(!C||!this.#H.current()||!v2(this.#C.value))return;let H=Q(C),V=this.#v("areas");this.#C.patch({resources:{...this.#C.value.resources,areas:v("loading",null)}});try{let e=await this.#V.areas(C.areasUrl,V.signal),r=this.#C.value.resources.entry;if(!r||Q(r)!==H||e.sceneUrl!==r.sceneUrl)return;this.#C.patch({resources:{...this.#C.value.resources,areas:v("ready",e)}});let t=this.#C.value.selection.areaId,o=this.#C.value;(t!==null||!o.draw.dirty&&!o.areaDraft.dirty)&&this.selectArea(e.areas.some(M=>M.id===t)?t:null)}catch(e){let r=this.#C.value.resources.entry;if(G(e)||!r||Q(r)!==H)return;this.#C.patch({resources:{...this.#C.value.resources,areas:v("error",null,l1(e,"areas-unavailable"))}})}finally{this.#p("areas",V)}}selectArea(C){let H=this.#C.value.resources.areas.value?.areas.find(e=>e.id===C),V=this.#C.value;this.#C.patch({selection:{...V.selection,areaId:C},areaDraft:H?this.#P(H):{id:null,name:"",cleaningMode:"vacuum",coverageSetting:"standard",status:"new",canRebind:!1,dirty:!1},draw:{...V.draw,circles:H?.circles||[],undo:[],redo:[],dirty:!1,strokeCount:0}})}#P(C){return{id:C.id,name:C.name,cleaningMode:C.cleaningMode,coverageSetting:C.coverageSetting,status:C.status,canRebind:C.canRebind,dirty:!1}}async saveArea(){let C=this.#C.value,H=C.resources.entry,V=C.areaDraft;if(!H||!U(C)||!V.name.trim()||!C.draw.circles.length)return;let e=this.#v("area-mutation");this.#C.patch({command:"pending",notice:{tone:"info",text:"Saving area\u2026"}});try{let r=await this.#V.saveArea(H.areasUrl,{areaId:V.id,name:V.name.trim(),circles:C.draw.circles,cleaningMode:V.cleaningMode,coverageSetting:V.coverageSetting},e.signal);this.#C.patch({command:"idle",notice:{tone:"success",text:"Area saved"}}),await this.loadAreas(),this.selectArea(r)}catch(r){if(G(r))return;this.#C.patch({command:"failed",notice:{tone:"error",text:"Area could not be saved"}})}finally{this.#p("area-mutation",e)}}async deleteArea(){let C=this.#C.value.resources.entry,H=this.#C.value.selection.areaId;if(!C||!H||!U(this.#C.value))return;let V=this.#v("area-mutation");try{await this.#V.deleteArea(C.areasUrl,H,V.signal),this.#C.patch({notice:{tone:"success",text:"Area deleted"}}),await this.loadAreas()}catch(e){G(e)||this.#C.patch({notice:{tone:"error",text:"Area could not be deleted"}})}finally{this.#p("area-mutation",V)}}async savePlan(){let C=this.#C.value,H=C.planDraft,V=C.resources.plans.value;if(!V||!H.name.trim()||!H.rooms.length||!U(C))return;let e=H.rooms;await this.#_("save_plan",{...H.id?{plan_id:H.id}:{},name:H.name.trim(),enabled:H.enabled,run_behavior:H.runBehavior,rooms:e.map(t=>({room:V.rooms.find(o=>o.roomId===t.roomId)?.name,cleaning_mode:t.cleaningMode,coverage_setting:t.coverageSetting})).filter(t=>t.room),return_to_base:H.returnToBase,finish_current_room:H.finishCurrentRoom,finish_current_room_threshold:H.finishCurrentRoomThreshold,select:!H.id||V.selectedPlan===H.id},"Plan saved","Plan could not be saved")&&(this.#C.patch({planDraft:{...this.#C.value.planDraft,dirty:!1}}),await this.loadPlans())}async deletePlan(){let C=this.#C.value.selection.planId,H=this.#C.value.selection.entryId;if(!C)return;await this.#_("delete_plan",{plan:C},"Plan deleted","Plan could not be deleted")&&(this.#C.value.selection.entryId===H&&this.#C.value.planDraft.id===C&&this.selectPlan(null),await this.loadPlans())}async executeAction(C){switch(C){case"recheck-status":{let H=this.#C.value.selection.entryId;await this.refreshCatalog(!0);let V=this.#C.value;!this.#r&&V.selection.entryId===H&&V.resources.catalog.status==="ready"&&V.host.connected&&V.host.robotConnected&&V.coherence==="current"&&V.command==="failed"&&this.#C.patch({command:"idle",notice:{tone:"info",text:"Status refreshed. Review the robot state before trying again."}});return}case"stop":await this.#R("matic_robot","stop_intelligent_cleaning",{include_unmanaged:!0});return;case"resume":await this.#R("vacuum","send_command",{command:"resume"});return;case"run-plan":{let H=this.#C.value.selection.planId||this.#C.value.resources.plans.value?.selectedPlan;H&&await this.#R("matic_robot","run_selected_plan",{plan:H});return}case"clean-rooms":{let H=this.#C.value.resources.plans.value,e=this.#C.value.selection.roomSettings.map(r=>({room:H?.rooms.find(t=>t.roomId===r.roomId)?.name,cleaning_mode:r.cleaningMode,coverage_setting:r.coverageSetting})).filter(r=>r.room);e.length&&await this.#R("matic_robot","clean_room_sequence",{rooms:e,return_to_base:!0});return}case"run-area":{let H=this.#C.value.selection.areaId;H&&await this.#R("matic_robot","clean_area",{area:H});return}case"review-area":this.#C.dispatch({type:"open-workflow",workflow:"areaReview"});return;case"save-area":await this.saveArea();return;case"save-plan":await this.savePlan();return;case"delete-plan":await this.deletePlan();return;case"delete-area":await this.deleteArea();return}}async#_(C,H,V,e){let r=this.#L?.vacuumEntityId;if(!r||!U(this.#C.value)||this.#C.value.command==="pending")return!1;this.#C.patch({command:"pending",notice:{tone:"info",text:"Saving\u2026"}});try{return await this.#V.service("matic_robot",C,H,r),this.#C.patch({command:"idle",notice:{tone:"success",text:V}}),!0}catch{return this.#C.patch({command:"failed",notice:{tone:"error",text:e}}),!1}}async#R(C,H,V){let e=this.#C.value,r=this.#L?.vacuumEntityId,t=H==="stop_intelligent_cleaning"||C==="vacuum"&&H==="return_to_base",o=C==="vacuum"&&H==="send_command"&&V.command==="resume";if(!r||e.selection.entryId!==this.#L?.entryKey||(t?!x2(e):o?!c2(e):!m1(e)))return;let M=++this.#x,i=this.#L?.entryKey,a=()=>!this.#r&&M===this.#x&&i===this.#L?.entryKey,n=t?"settling":"starting";this.#e!==null&&window.clearTimeout(this.#e),this.#e=null,this.#C.patch({command:n,notice:null});try{if(await this.#V.service(C,H,V,r),!a())return;if(C==="matic_robot"&&(H==="clean_room_sequence"||H==="run_selected_plan")){this.#C.patch({command:"idle"}),this.refreshCatalog(!0);return}this.#C.patch({command:n}),this.#e!==null&&window.clearTimeout(this.#e),this.#e=window.setTimeout(()=>{this.#e=null,a()&&this.#C.value.command===n&&this.#C.patch({command:"idle"})},15e3)}catch{if(!a())return;this.#C.patch({command:"failed",notice:{tone:"error",text:"The action could not be confirmed. Check the robot status before trying again."}})}}updateDraftCircles(C,H=!0,V){this.#C.dispatch({type:"set-draft-circles",circles:C,record:H,...V?{previous:V}:{}}),this.#C.dispatch({type:"patch-area-draft",patch:{dirty:!0}})}dispose(){this.#r||(this.#r=!0,this.#l(),this.#y(),this.#e!==null&&window.clearTimeout(this.#e),this.#e=null,this.#t.dispose(),this.#V.dispose(),this.#H.invalidate())}};var E0=L=>(L.workflow==="none"?0:1)+(L.fullMap?1:0)+(L.precisionOpen?1:0)+(L.dialog?1:0),D0=L=>{if(!L||typeof L!="object")return null;let C=L.maticMapLayer;if(!C||typeof C!="object")return null;let H=C.owner,V=C.depth;return typeof H=="string"&&Number.isInteger(V)&&Number(V)>=0?{owner:H,depth:Number(V)}:null},a2=class{#C;#H=`matic-map-${crypto.randomUUID?.()||Math.random().toString(36).slice(2)}`;#V=0;#t=null;#M=!1;#L=!1;constructor(C){this.#C=C}start(){this.#t||(this.#V=E0(this.#C.value),this.#t=this.#C.subscribe(C=>this.#a(C)),window.addEventListener("popstate",this.#i))}#a(C){let H=E0(C);if(this.#M){this.#M=!1,this.#V=H;return}if(H<this.#V){let V=D0(history.state);if(V?.owner===this.#H&&V.depth===this.#V){let e=H-this.#V;this.#V=H,this.#L=!0,history.go(e);return}}if(H>this.#V)for(let V=this.#V+1;V<=H;V+=1){let e=history.state&&typeof history.state=="object"?history.state:{};history.pushState({...e,maticMapLayer:{owner:this.#H,depth:V}},"",window.location.href)}this.#V=H}#i=()=>{if(this.#L){this.#L=!1;return}if(!(this.#V<1)){if(e1(this.#C.value,{type:"dismiss-top-layer"})){let C=history.state&&typeof history.state=="object"?history.state:{};history.pushState({...C,maticMapLayer:{owner:this.#H,depth:this.#V}},"",window.location.href),this.#C.dispatch({type:"open-dialog",dialog:"discardDraft"});return}this.#M=!0,this.#C.dispatch({type:"dismiss-top-layer"})}};dismissTop(){if(this.#V<1)return!1;let C=D0(history.state);return C?.owner===this.#H&&C.depth===this.#V?history.back():this.#C.dispatch({type:"dismiss-top-layer"}),!0}dispose(){this.#t?.(),this.#t=null,window.removeEventListener("popstate",this.#i),this.#V=0,this.#L=!1}};var $0=J(n1),o5=class extends O{constructor(){super(...arguments);this.narrow=!1;this._workspace=k();this._classic=!1;this.entryOverride=null;this.#C=new G1;this.#H=new v1(this._workspace);this.#V=null;this.#t=null;this.#M=null;this.#L=null;this.#a=null;this.#i=""}static{this.styles=[D,$,b`
...
`]}static{this.properties={hass:{attribute:!1},narrow:{type:Boolean},route:{attribute:!1},panel:{attribute:!1},_workspace:{state:!0},_classic:{state:!0},entryOverride:{state:!0}}}#C;#H;#V;#t;#M;#L;#a;#i;connectedCallback(){super.connectedCallback(),this._classic=_0()==="v3",this.#t=this.#H.subscribe(H=>{this._workspace=H,this.#x(H)}),this._classic||this.#A()}disconnectedCallback(){this.#t?.(),this.#t=null,this.#e(),super.disconnectedCallback()}#A(){if(!this.#L&&(this.#V=this.#C.project(this.hass,this.panel,this.entryOverride),this.#M=new r2(()=>this.hass),this.#L=new i2(this.#H,this.#M),this.#a=new a2(this.#H),this.#a.start(),this.#V)){this.#L.sync(this.#V,this.panel);let{host:H}=this.#V;H.connected&&H.administrator&&H.robotCount>0&&this.#L.refreshCatalog(this.#H.value.selection.floorId==="current")}}#e(){this.#a?.dispose(),this.#a=null,this.#L?.dispose(),this.#L=null,this.#M=null}#x(H){if(!this.#L)return;let V={version:4,view:H.view,appearance:H.appearance,labels:H.labelsVisible,quality:H.quality,cameras:H.cameras},e=JSON.stringify(V);e!==this.#i&&(this.#i=e,this.#L.schedulePreferences(V))}willUpdate(H){if(H.has("hass")||H.has("panel")||H.has("entryOverride")){let V=this.#C.project(this.hass,this.panel,this.entryOverride);if(V!==this.#V){this.#V=V;let e=V.host.connected?V.host.robotCount===0?"unavailable":V.host.administrator?"verifying":"blocked":"degraded";this.#H.replace({...this.#H.value,coherence:e,activity:V.activity,batteryPercent:V.batteryPercent,host:V.host,fullMap:V.host.administrator&&V.host.robotCount>0&&this.#H.value.fullMap,robotLabel:V.robotLabel,robots:V.robots,locale:V.language})}this._classic||this.#L?.sync(V,this.panel)}H.has("narrow")&&this.#H.value.narrowHint!==this.narrow&&this.#H.dispatch({type:"set-narrow-hint",value:this.narrow})}#f(H){if(!d1(H.detail))return;H.stopPropagation();let V=H.detail;if(V.type==="dismiss-top-layer"||V.type==="exit-full-map"){this.#a?.dismissTop()||this.#H.dispatch(V);return}if(V.type==="open-workflow"&&V.workflow!=="none"){this.#L?.openWorkflow(V.workflow);return}if(V.type==="set-floor"){this.#L?.selectFloor(V.floorId);return}if(V.type==="select-entry"){if(!this._workspace.robots.some(e=>e.entryId===V.entryId))return;this.entryOverride=V.entryId;return}if(V.type==="set-history"){this.#L?.selectHistory(V.historyId);return}if(V.type==="select-plan"){this.#L?.selectPlan(V.planId);return}if(V.type==="select-area"){this.#L?.selectArea(V.areaId),V.workflow==="areaReview"&&this.#L?.openWorkflow("areaReview");return}this.#H.dispatch(V)}#Z(H){if(H.stopPropagation(),typeof H.detail?.id=="string"){if(H.detail.id==="use-classic"){t5("v3")&&(this.#e(),this._classic=!0);return}this.#L?.executeAction(H.detail.id),this.dispatchEvent(new CustomEvent("matic-map-v4-action-requested",{detail:{id:H.detail.id},bubbles:!0,composed:!0}))}}#s(){t5("v4")&&(this._classic=!1,this.#A(),this.requestUpdate())}updated(){if(!this._classic)return;let H=this.renderRoot.querySelector("matic-map-panel-v0-3-1");H&&(H.hass=this.hass,H.narrow=this.narrow,H.route=this.route,H.panel=this.panel)}getWorkspaceSnapshot(){return this.#H.value}render(){return this._classic?c`
      ...
      ></${$0}>
    `}};customElements.get(I2)||customElements.define(I2,o5);export{z1 as CoherenceMachine,b1 as DRAW_BRUSH_MAX_METERS,s1 as DRAW_BRUSH_MIN_METERS,g2 as GALLERY_SCENARIOS,G1 as HassAdapter,m2 as MAP_PIXELS_PER_METER_AT_100,A5 as MAP_ZOOM_MAX,y1 as MAP_ZOOM_MIN,I2 as MATIC_MAP_PANEL_TAG,o5 as MaticMapPanelV4,V5 as MaticMapStudioGalleryV4,v1 as WorkspaceStore,V4 as brushCursorPixels,U as canEditCoordinates,v2 as canReadFloorResources,c2 as canResumeMotion,d5 as canShowExactPose,c1 as canShowLiveMap,m1 as canStartMotion,x2 as canStopMotion,L4 as commandState,f2 as createGalleryState,k as initialWorkspaceState,d1 as isWorkspaceIntent,v5 as mapScale,U0 as normalizeBrush,l5 as normalizeZoom,G0 as reduceWorkspace,Z2 as selectPrimaryAction,m5 as selectStopSecondaryAction};
