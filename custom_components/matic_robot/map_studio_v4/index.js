...
><path d=${e}></path></svg>`;var e7=["paint","erase","pan"],Y1=(e,C,H)=>{let{draw:V}=e,L=`${V.brushMeters.toFixed(2)} m`;return s`
  ...
  `};var r7=e=>e.matches(":disabled, [aria-disabled='true']"),j1=class{#C;#H;#V=null;#e=null;constructor(C,H){this.#C=C,this.#H=H,C.addController(this)}hostConnected(){this.#C.addEventListener("focusin",this.#n)}hostDisconnected(){this.#C.removeEventListener("focusin",this.#n),this.#V?.removeEventListener("keydown",this.#a),this.#V=null,this.#e=null}hostUpdated(){let C=this.#H.container();C!==this.#V&&(this.#V?.removeEventListener("keydown",this.#a),C?.addEventListener("keydown",this.#a),this.#V=C),this.#t()}#r(){let C=this.#V;return C?[...C.querySelectorAll(this.#H.items)].filter(H=>!r7(H)):[]}#t(){let C=this.#r(),H=(this.#e&&C.includes(this.#e)?this.#e:null)??C.find(L=>L.matches("[aria-pressed='true'], [aria-checked='true']"))??C[0]??null;this.#e=H;let V=this.#V?.querySelectorAll(this.#H.items)??[];for(let L of V)L.tabIndex=L===H?0:-1}#n=C=>{let H=C.composedPath()[0];!(H instanceof HTMLElement)||!this.#V?.contains(H)||H.matches(this.#H.items)&&(this.#e=H,this.#t())};#a=C=>{if(C.defaultPrevented||C.ctrlKey||C.metaKey||C.altKey)return;let H=this.#H.orientation??"horizontal",V=H!=="vertical",L=H!=="horizontal",r=this.#r();if(!r.length)return;let t=C.composedPath()[0],M=Math.max(0,r.findIndex(a=>a===this.#e||t instanceof Node&&a.contains(t))),o;switch(C.key){case"ArrowLeft":if(!V)return;o=M-1;break;case"ArrowRight":if(!V)return;o=M+1;break;case"ArrowUp":if(!L)return;o=M-1;break;case"ArrowDown":if(!L)return;o=M+1;break;case"Home":o=0;break;case"End":o=r.length-1;break;default:return}C.preventDefault();let i=r[(o+r.length)%r.length];i&&(this.#e=i,this.#t(),i.focus())}};var N3={accent:["--ms-accent","Highlight",[6,120,206]],onAccent:["--ms-on-accent","HighlightText",[255,255,255]],text:["--ms-text","CanvasText",[38,50,56]],quiet:["--ms-text-quiet","GrayText",[75,92,105]],plate:["--ms-surface-card","Canvas",[250,252,253]],roomFill:["--ms-surface-sunken","Canvas",[231,238,242]]},t7=e=>Math.max(0,Math.min(255,Math.round(e))),z3=e=>{let C=e.trim(),H=C.match(/^#([\da-f]{3}|[\da-f]{4}|[\da-f]{6}|[\da-f]{8})$/i)?.[1];if(H){let a=H.length<=4?[H[0],H[1],H[2]].map(m=>Number.parseInt(`${m}${m}`,16)):[H.slice(0,2),H.slice(2,4),H.slice(4,6)].map(m=>Number.parseInt(m,16)),[n,A,d]=a;return n===void 0||A===void 0||d===void 0?null:[n,A,d]}let V=C.startsWith("color(srgb"),L=C.slice(C.indexOf("(")+1).match(/-?\d*\.?\d+/g);if(!L||L.length<3)return null;let r=V?255:1,t=L.slice(0,3).map(a=>t7(Number(a)*r)),[M,o,i]=t;return M===void 0||o===void 0||i===void 0||[M,o,i].some(a=>Number.isNaN(a))?null:[M,o,i]},B=(e,C)=>`rgba(${e[0]},${e[1]},${e[2]},${C})`,U3=e=>{let C=window.matchMedia?.("(forced-colors: active)").matches??!1;if(!C){let L=document.createElement("span");L.setAttribute("aria-hidden","true"),L.style.cssText="position:absolute;inline-size:0;block-size:0;overflow:hidden;visibility:hidden;pointer-events:none",e.append(L);let r=t=>{let[M,,o]=N3[t];return L.style.color=`var(${M}, transparent)`,z3(getComputedStyle(L).color)??o};try{return{accent:r("accent"),onAccent:r("onAccent"),text:r("text"),quiet:r("quiet"),plate:r("plate"),roomFill:r("roomFill"),forced:C}}finally{L.remove()}}let H=document.createElement("span");H.setAttribute("aria-hidden","true"),H.style.cssText="position:absolute;inline-size:0;block-size:0;overflow:hidden;visibility:hidden;pointer-events:none",e.append(H);let V=L=>{let[,r,t]=N3[L];return H.style.color=r,z3(getComputedStyle(H).color)??t};try{return{accent:V("accent"),onAccent:V("onAccent"),text:V("text"),quiet:V("quiet"),plate:V("plate"),roomFill:V("roomFill"),forced:C}}finally{H.remove()}};var G3=(e,C)=>Math.hypot(e.x-C.x,e.y-C.y),Q3=(e,C)=>({x:(e.x+C.x)/2,y:(e.y+C.y)/2}),K3=(e,C)=>Math.atan2(C.y-e.y,C.x-e.x),M7=e=>{let C=e;for(;C>Math.PI;)C-=Math.PI*2;for(;C<-Math.PI;)C+=Math.PI*2;return C},o1=(e,C,H)=>Math.max(C,Math.min(H,e)),N2=e=>e.map(C=>({...C})),o7="button, input, select, textarea, a, [role='button'], [role='menuitem'], [data-map-control]",x1=e=>e.composedPath().some(C=>C instanceof Element&&C.matches(o7)),J1=class{#C;#H;#V;#e=new Map;#r=!1;#t="idle";#n=[];#a=[];#A=null;#L=0;#c=null;#h=0;#x=null;#i=null;#f=null;#p=0;#o=null;#u=!1;#Z=null;#m=!1;constructor(C,H,V){this.#C=C,this.#H=H,this.#V=V,C.addEventListener("pointerdown",this.#M),C.addEventListener("pointermove",this.#l),C.addEventListener("pointerup",this.#d),C.addEventListener("pointercancel",this.#d),C.addEventListener("wheel",this.#w,{passive:!1}),C.addEventListener("gesturestart",this.#S,{passive:!1}),C.addEventListener("gesturechange",this.#y,{passive:!1}),C.addEventListener("gestureend",this.#B,{passive:!1}),C.addEventListener("dblclick",this.#k),C.addEventListener("contextmenu",this.#O),C.addEventListener("keydown",this.#g),C.addEventListener("keyup",this.#P),C.addEventListener("blur",this.#b)}#M=C=>{if(this.#m||!C.isPrimary&&C.pointerType==="mouse"||x1(C))return;this.#C.focus({preventScroll:!0}),this.#T();let H=performance.now(),V={id:C.pointerId,type:C.pointerType,startX:C.clientX,startY:C.clientY,x:C.clientX,y:C.clientY,lastX:C.clientX,lastY:C.clientY,lastTime:H,velocityX:0,velocityY:0};if(this.#e.set(C.pointerId,V),this.#C.setPointerCapture?.(C.pointerId),this.#e.size>=2){this.#R(),(this.#t==="paint"||this.#t==="erase")&&(this.#a=N2(this.#n),this.#V.onCircles(this.#a,!1)),this.#t="pinch",this.#C.classList.add("navigating"),this.#u=!0;let[M,o]=[...this.#e.values()];M&&o&&(this.#L=Math.max(1,G3(M,o)),this.#c=Q3(M,o),this.#h=K3(M,o),this.#x=this.#H.camera),C.preventDefault();return}let L=this.#V.state(),r=L.workflow==="draw"&&L.map.available&&!L.floor.readOnly;this.#u||this.#r||C.button===1||C.button===2||L.draw.tool==="pan"?(this.#t="pan",this.#i=this.#H.camera):r&&(L.draw.tool==="paint"||L.draw.tool==="erase")?(this.#n=N2(L.draw.circles),this.#a=N2(L.draw.circles),C.pointerType==="touch"?(this.#t="idle",this.#Z=window.setTimeout(()=>{if(this.#Z=null,this.#e.size!==1||this.#u)return;this.#t=L.draw.tool;let M=this.#e.get(C.pointerId);M&&this.#s(M.x,M.y)},110)):(this.#t=L.draw.tool,this.#s(C.clientX,C.clientY))):(this.#t=L.view==="three"&&!C.shiftKey?"orbit":"pan",this.#i=this.#H.camera),(this.#t==="pan"||this.#t==="orbit")&&this.#C.classList.add("navigating"),C.preventDefault()};#l=C=>{let H=this.#e.get(C.pointerId);if(!H){let a=this.#H.screenToMap(C.clientX,C.clientY);this.#H.setCursor(a);return}let L=(C.getCoalescedEvents?.()||[]).at(-1)||C,r=performance.now(),t=Math.max(1,r-H.lastTime),M=(L.clientX-H.lastX)/t,o=(L.clientY-H.lastY)/t;if(H.velocityX=H.velocityX*.62+M*.38,H.velocityY=H.velocityY*.62+o*.38,H.lastX=L.clientX,H.lastY=L.clientY,H.lastTime=r,H.x=L.clientX,H.y=L.clientY,this.#t==="pinch"&&this.#e.size>=2){let[a,n]=[...this.#e.values()];if(!a||!n)return;let A=Math.max(1,G3(a,n)),d=Q3(a,n),m=K3(a,n),x=this.#x;if(x&&this.#c){let h={...x,distance:x.distance*this.#L/A,yaw:x.yaw+M7(m-this.#h),pitch:x.orthographic?x.pitch:x.pitch-(d.y-this.#c.y)*.0035};this.#H.setCamera(this.#H.cameraAfterPan(h,d.x-this.#c.x,d.y-this.#c.y))}C.preventDefault();return}this.#t==="paint"||this.#t==="erase"?this.#s(C.clientX,C.clientY):this.#t==="pan"?this.#i&&this.#H.setCamera(this.#H.cameraAfterPan(this.#i,L.clientX-H.startX,L.clientY-H.startY)):this.#t==="orbit"&&this.#i&&this.#H.setCamera({...this.#i,yaw:this.#i.yaw+(L.clientX-H.startX)*.0045,pitch:this.#i.pitch-(L.clientY-H.startY)*.004});let i=this.#H.screenToMap(L.clientX,L.clientY);this.#H.setCursor(i),C.preventDefault()};#d=C=>{let H=this.#e.get(C.pointerId);if(!H)return;let V=this.#t;if(this.#e.delete(C.pointerId),this.#C.releasePointerCapture?.(C.pointerId),this.#R(),(this.#t==="paint"||this.#t==="erase")&&JSON.stringify(this.#a)!==JSON.stringify(this.#n))this.#V.onCircles(this.#a,!0,this.#n);else if(this.#t!=="pinch"&&!this.#u&&Math.hypot(H.x-H.startX,H.y-H.startY)<7&&this.#V.state().workflow==="rooms"){let L=this.#H.roomAt(H.x,H.y);L&&this.#V.onRoom(L)}if(this.#e.size===0)this.#t="idle",this.#C.classList.remove("navigating"),this.#u=!1,this.#c=null,this.#x=null,this.#i=null,this.#A=null,(V==="pan"||V==="orbit")&&H.type!=="mouse"&&this.#_(H.velocityX,H.velocityY,V);else if(this.#t==="pinch"){this.#t="pan",this.#u=!0;let L=this.#e.values().next().value;L&&(L.startX=L.x,L.startY=L.y,L.velocityX=0,L.velocityY=0),this.#i=this.#H.camera,this.#x=null}C.preventDefault()};#s(C,H){let V=this.#H.screenToMap(C,H);if(!V)return;let r=this.#V.state().draw.brushMeters/2;if(this.#t==="erase")this.#a=this.#a.filter(t=>Math.hypot(t.x-V.x,t.y-V.y)>t.radius+r);else{if(!this.#H.containsMapPoint(V))return;let t=Math.max(.04,r*.55),M=this.#A||V,o=Math.hypot(V.x-M.x,V.y-M.y),i=Math.max(1,Math.ceil(o/t));for(let a=0;a<=i&&this.#a.length<512;a+=1){let n=a/i,A={x:M.x+(V.x-M.x)*n,y:M.y+(V.y-M.y)*n};this.#a.some(d=>Math.hypot(d.x-A.x,d.y-A.y)<Math.max(.025,r*.28))||this.#a.push({x:Math.round(A.x*1e4)/1e4,y:Math.round(A.y*1e4)/1e4,radius:Math.round(r*100)/100})}}this.#A=V,this.#V.onCircles(this.#a,!1)}#w=C=>{if(x1(C))return;C.preventDefault(),this.#C.focus({preventScroll:!0}),this.#T();let H=C.deltaMode===WheelEvent.DOM_DELTA_LINE?16:C.deltaMode===WheelEvent.DOM_DELTA_PAGE?Math.max(1,this.#C.clientHeight):1,V=C.deltaX*H,L=C.deltaY*H;if(C.ctrlKey||C.metaKey){this.#H.zoomAt(Math.exp(o1(-L*.008,-.28,.28)),C.clientX,C.clientY);return}if(C.altKey&&this.#V.state().view==="three"){this.#H.orbitBy(0,o1(L,-80,80)*.75);return}if(C.deltaMode!==WheelEvent.DOM_DELTA_PIXEL||Math.abs(V)<.5&&Math.abs(L)>=50){this.#H.zoomAt(Math.exp(o1(-L*.0025,-.28,.28)),C.clientX,C.clientY);return}this.#H.panBy(-o1(V,-80,80),-o1(L,-80,80))};#S=C=>{this.#m||x1(C)||(this.#C.focus({preventScroll:!0}),this.#T(),this.#C.classList.add("navigating"),this.#f=this.#H.camera,this.#p=Number.isFinite(C.rotation)?C.rotation:0,C.preventDefault())};#y=C=>{if(this.#m||x1(C))return;let H=this.#f;if(!H||this.#e.size>=2)return;let V=Number.isFinite(C.scale)&&C.scale>0?Math.max(.1,C.scale):1,L=Number.isFinite(C.rotation)?C.rotation:0;this.#H.setCamera({...H,distance:H.distance/V,yaw:H.yaw+(L-this.#p)*Math.PI/180}),C.preventDefault()};#B=C=>{this.#f=null,this.#p=0,this.#C.classList.remove("navigating"),C.preventDefault()};#g=C=>{if(C.defaultPrevented||C.ctrlKey||C.metaKey||C.altKey)return;if(C.code==="Space"){this.#r=!0,C.preventDefault();return}this.#T();let H=this.#V.state(),V=C.key.toLocaleLowerCase();if(C.key==="+"||C.key==="=")this.#H.zoomAt(1.25);else if(C.key==="-")this.#H.zoomAt(.8);else if(C.key==="0")this.#H.fit();else if(V==="3")this.#v({type:"set-view",view:"three"});else if(V==="t")this.#v({type:"set-view",view:"top"});else if(C.key==="[")this.#H.orbitBy(-40,0);else if(C.key==="]")this.#H.orbitBy(40,0);else if(C.key==="PageUp")this.#H.orbitBy(0,-30);else if(C.key==="PageDown")this.#H.orbitBy(0,30);else if(V==="d"&&H.workflow==="draw")this.#v({type:"set-draw-tool",tool:"paint"});else if(V==="e"&&H.workflow==="draw")this.#v({type:"set-draw-tool",tool:"erase"});else if(["arrowleft","arrowright","arrowup","arrowdown"].includes(V))if(H.view==="three"&&!C.shiftKey){let L=V==="arrowleft"?-24:V==="arrowright"?24:0,r=V==="arrowup"?-20:V==="arrowdown"?20:0;this.#H.orbitBy(L,r)}else{let L=V==="arrowleft"?30:V==="arrowright"?-30:0,r=V==="arrowup"?30:V==="arrowdown"?-30:0;this.#H.panBy(L,r)}else if(H.workflow!=="draw"&&["w","a","s","d"].includes(V))this.#H.panBy(V==="a"?34:V==="d"?-34:0,V==="w"?34:V==="s"?-34:0);else if(H.workflow!=="draw"&&(V==="q"||V==="e"))this.#H.orbitBy(V==="q"?-30:30,0);else return;C.preventDefault()};#P=C=>{C.code==="Space"&&(this.#r=!1)};#b=()=>{this.#r=!1,this.#R(),this.#H.setCursor(null),this.#C.classList.remove("navigating")};#k=C=>{x1(C)||(this.#T(),this.#H.zoomAt(C.shiftKey?1/1.6:1.6,C.clientX,C.clientY),C.preventDefault())};#O=C=>{x1(C)||C.preventDefault()};#v(C){this.#C.dispatchEvent(new CustomEvent("matic-workspace-intent",{detail:C,bubbles:!0,composed:!0}))}#_(C,H,V){if(window.matchMedia("(prefers-reduced-motion: reduce)").matches)return;let L=o1(C,-.55,.55),r=o1(H,-.55,.55);if(Math.hypot(L,r)<.02)return;let t=performance.now(),M=o=>{let i=Math.min(32,o-t);t=o,V==="orbit"?this.#H.orbitBy(L*i,r*i):this.#H.panBy(L*i,r*i);let a=.9**(i/16);L*=a,r*=a,Math.hypot(L,r)>=.01?this.#o=window.requestAnimationFrame(M):this.#o=null};this.#o=window.requestAnimationFrame(M)}#T(){this.#o!==null&&window.cancelAnimationFrame(this.#o),this.#o=null}#R(){this.#Z!==null&&window.clearTimeout(this.#Z),this.#Z=null}dispose(){this.#m||(this.#m=!0,this.#R(),this.#T(),this.#C.removeEventListener("pointerdown",this.#M),this.#C.removeEventListener("pointermove",this.#l),this.#C.removeEventListener("pointerup",this.#d),this.#C.removeEventListener("pointercancel",this.#d),this.#C.removeEventListener("wheel",this.#w),this.#C.removeEventListener("gesturestart",this.#S),this.#C.removeEventListener("gesturechange",this.#y),this.#C.removeEventListener("gestureend",this.#B),this.#C.removeEventListener("dblclick",this.#k),this.#C.removeEventListener("contextmenu",this.#O),this.#C.removeEventListener("keydown",this.#g),this.#C.removeEventListener("keyup",this.#P),this.#C.removeEventListener("blur",this.#b),this.#e.clear())}};var _=(e,C,H)=>Math.max(C,Math.min(H,e)),R1=e=>{let C=e;for(;C>Math.PI;)C-=Math.PI*2;for(;C<-Math.PI;)C+=Math.PI*2;return C},i7=e=>{switch(e){case"efficient":return .35;case"balanced":return .65;case"maximum":case"auto":return 1}},a7={accent:[6,120,206],onAccent:[255,255,255],text:[38,50,56],quiet:[75,92,105],plate:[250,252,253],roomFill:[231,238,242],forced:!1},X3=Math.PI/3.15,n7=1.08,A7=(e,C)=>{let H=X3/2,V=Math.atan(Math.tan(H)*Math.max(.2,C));return e/Math.sin(Math.min(H,V))*n7},l7=(e,C)=>{let H=new Float32Array(16);for(let V=0;V<4;V+=1)for(let L=0;L<4;L+=1){let r=0;for(let t=0;t<4;t+=1)r+=(e[t*4+L]??0)*(C[V*4+t]??0);H[V*4+L]=r}return H},d7=(e,C,H,V)=>{let L=1/Math.tan(e/2),r=new Float32Array(16);return r[0]=L/C,r[5]=L,r[10]=(V+H)/(H-V),r[11]=-1,r[14]=2*V*H/(H-V),r},s7=(e,C,H,V,L,r)=>{let t=new Float32Array(16);return t[0]=2/(C-e),t[5]=2/(V-H),t[10]=-2/(r-L),t[12]=-(C+e)/(C-e),t[13]=-(V+H)/(V-H),t[14]=-(r+L)/(r-L),t[15]=1,t},p7=(e,C)=>{let H=Math.hypot((e[0]??0)-(C[0]??0),(e[1]??0)-(C[1]??0),(e[2]??0)-(C[2]??0))||1,V=[((e[0]??0)-(C[0]??0))/H,((e[1]??0)-(C[1]??0))/H,((e[2]??0)-(C[2]??0))/H],L=Math.hypot(V[2]??0,V[0]??0)||1,r=[(V[2]??0)/L,0,-(V[0]??0)/L],t=[(V[1]??0)*(r[2]??0),(V[2]??0)*(r[0]??0)-(V[0]??0)*(r[2]??0),-(V[1]??0)*(r[0]??0)];return new Float32Array([r[0]??0,t[0]??0,V[0]??0,0,r[1]??0,t[1]??0,V[1]??0,0,r[2]??0,t[2]??0,V[2]??0,0,-((r[0]??0)*(e[0]??0)+(r[1]??0)*(e[1]??0)+(r[2]??0)*(e[2]??0)),-((t[0]??0)*(e[0]??0)+(t[1]??0)*(e[1]??0)+(t[2]??0)*(e[2]??0)),-((V[0]??0)*(e[0]??0)+(V[1]??0)*(e[1]??0)+(V[2]??0)*(e[2]??0)),1])},q3=(e,C,H)=>{let V=!1,L=H.at(-1);if(!L)return!1;for(let r of H){let[t,M]=r,[o,i]=L;M>C!=i>C&&e<(o-t)*(C-M)/(i-M)+t&&(V=!V),L=r}return V},C2=class{#C;#H;#V;#e=null;#r=null;#t=null;#n=null;#a=null;#A=null;#L=null;#c=null;#h=null;#x=null;#i=null;#f=null;#p=null;#o=null;#u=null;#Z=null;#m;#M={yaw:-Math.PI/4,pitch:.82,distance:12,targetX:0,targetZ:0,orthographic:!1};#l=12;#d=8;#s=4;#w=new Float32Array(16);#S=null;#y="unavailable";#B=0;#g=0;#P=0;#b=0;#k=1;#O={width:1,height:1,left:0,top:0};#v=!0;#_=!1;#T=a7;constructor(C,H,V={}){this.#C=C,this.#H=H,this.#V=V,this.#r=H.getContext("2d",{alpha:!0}),this.#C.addEventListener("webglcontextlost",this.#e1),this.#C.addEventListener("webglcontextrestored",this.#r1),this.#K(),this.#m=new ResizeObserver(()=>{let L=this.#l,r=this.#d;this.#F(),this.#v&&(L!==this.#l||r!==this.#d)?this.fit(!1):this.requestRender()}),this.#m.observe(C)}get camera(){return{...this.#M}}#R(){return{minimum:Math.max(.2,this.#s*.04),maximum:this.#s*8}}#G(){let C=this.#o?.metadata.span,H=this.#o?.metadata.metersPerCell;return!C||H===void 0?{x:this.#s,z:this.#s}:{x:Math.max(.5,C[0]*H*.55),z:Math.max(.5,C[1]*H*.55)}}setCamera(C,H=!0){let V=this.#R(),L=this.#G();this.#M={yaw:R1(C.yaw),pitch:C.orthographic?Math.PI/2-.018:_(C.pitch,.18,1.38),distance:_(C.distance,V.minimum,V.maximum),targetX:_(C.targetX,-L.x,L.x),targetZ:_(C.targetZ,-L.z,L.z),orthographic:C.orthographic},this.#v=!1,this.requestRender(),H&&this.#U()}cameraAfterPan(C,H,V){let L=this.#D(),r=C.distance*1.75/Math.max(200,L.height),t=Math.cos(C.yaw),M=-Math.sin(C.yaw),o=-Math.sin(C.yaw),i=-Math.cos(C.yaw),a=this.#G();return{...C,targetX:_(C.targetX-H*r*t+V*r*o,-a.x,a.x),targetZ:_(C.targetZ-H*r*M+V*r*i,-a.z,a.z)}}setState(C){if(this.#_)return;let H=this.#p;this.#p=C;let V=C.resources.scene.value;V!==this.#o&&(this.#o=V,this.#j(V)),(!H||H.quality!==C.quality)&&(this.#k=i7(C.quality),this.#b=0);let L=H?.workflow!=="draw"&&C.workflow==="draw",r=H?.workflow==="draw"&&C.workflow!=="draw";if(!H||H.view!==C.view||L||r){let t=C.workflow==="draw"?"top":C.view;this.#M=this.#Q(t,C),this.#v=this.#Y(t,C)}C.workflow==="draw"&&H?.draw.zoomPercent!==C.draw.zoomPercent&&(this.#M={...this.#M,orthographic:!0,pitch:Math.PI/2-.018,distance:this.#d*100/C.draw.zoomPercent},this.#v=C.draw.zoomPercent===100&&Math.abs(this.#M.targetX)<.001&&Math.abs(this.#M.targetZ)<.001&&Math.abs(R1(this.#M.yaw))<.001),this.requestRender()}#Q(C,H){let V=C==="top",L=V?this.#d:this.#l,r=H.cameras[C];return r?{yaw:r.yaw,pitch:V?Math.PI/2-.018:r.pitch,distance:_(L/_(r.zoom,.01,100),Math.max(.2,this.#s*.04),this.#s*8),targetX:_(r.targetX,-this.#s,this.#s),targetZ:_(r.targetZ,-this.#s,this.#s),orthographic:V}:V?{yaw:0,pitch:Math.PI/2-.018,distance:L,targetX:0,targetZ:0,orthographic:!0}:{yaw:-Math.PI/4,pitch:.82,distance:L,targetX:0,targetZ:0,orthographic:!1}}#Y(C,H){let V=H.cameras[C];if(!V)return!0;let L=C==="top";return Math.abs(V.zoom-1)<.001&&Math.abs(V.targetX)<.001&&Math.abs(V.targetZ)<.001&&Math.abs(R1(V.yaw-(L?0:-Math.PI/4)))<.001&&(L||Math.abs(V.pitch-.82)<.001)}#I(C,H){let V=this.#e;if(!V)throw new Error("webgl-unavailable");let L=V.createShader(C);if(!L)throw new Error("shader-unavailable");if(V.shaderSource(L,H),V.compileShader(L),!V.getShaderParameter(L,V.COMPILE_STATUS))throw V.deleteShader(L),new Error("shader-failed");return L}#K(){try{this.#e=this.#C.getContext("webgl2",{alpha:!0,antialias:!0,depth:!0,powerPreference:"high-performance"});let C=this.#e;if(!C)throw new Error("webgl2-unavailable");let H=this.#I(C.VERTEX_SHADER,`#version 300 es
      ...
      `),V=this.#I(C.FRAGMENT_SHADER,`#version 300 es
        precision highp float;
        in vec3 vColor;
        out vec4 outColor;
        void main() {
      ...
      `),L=C.createProgram();if(!L)throw new Error("program-unavailable");if(C.attachShader(L,H),C.attachShader(L,V),C.linkProgram(L),C.deleteShader(H),C.deleteShader(V),!C.getProgramParameter(L,C.LINK_STATUS))throw new Error("program-failed");this.#a=L,this.#c=C.getUniformLocation(L,"uViewProjection"),this.#h=C.getUniformLocation(L,"uCenter"),this.#x=C.getUniformLocation(L,"uMetersPerCell"),this.#i=C.getUniformLocation(L,"uPointPixels"),this.#f=C.getUniformLocation(L,"uMaxPointPixels"),this.#A=C.createBuffer(),this.#L=C.createVertexArray(),C.bindVertexArray(this.#L),C.bindBuffer(C.ARRAY_BUFFER,this.#A),C.enableVertexAttribArray(0),C.vertexAttribIPointer(0,2,C.UNSIGNED_SHORT,8,0),C.enableVertexAttribArray(1),C.vertexAttribIPointer(1,1,C.UNSIGNED_BYTE,8,4),C.enableVertexAttribArray(2),C.vertexAttribPointer(2,3,C.UNSIGNED_BYTE,!0,8,5),C.bindVertexArray(null),C.enable(C.DEPTH_TEST),C.depthFunc(C.LEQUAL),C.enable(C.BLEND),C.blendFunc(C.SRC_ALPHA,C.ONE_MINUS_SRC_ALPHA),this.#y="webgl2",this.#B+=1,this.#o&&this.#W(this.#o)}catch{this.#X(),this.#N()}}#j(C){if(this.#$(),!C){this.#g=0,this.requestRender();return}let[H,V]=C.metadata.span,L=C.metadata.metersPerCell,r=H*L,t=V*L;this.#s=Math.max(1,Math.hypot(r,t)/2),this.#F(),this.fit(!1),this.#y==="webgl2"?this.#W(C):this.#E(C)}#F(){let C=this.#o;if(!C)return;let[H,V]=C.metadata.span,L=C.metadata.metersPerCell,r=H*L,t=V*L,M=this.#D(),o=Math.max(.2,M.width/Math.max(1,M.height));this.#l=A7(this.#s,o),this.#d=Math.max(t/2,r/(2*o))*1.12}#W(C){let H=this.#e;if(!H||!this.#A)return;let V=new Uint8Array(C.buffer,C.pointOffset,C.total*8);H.bindBuffer(H.ARRAY_BUFFER,this.#A),H.bufferData(H.ARRAY_BUFFER,V,H.STATIC_DRAW),this.#g=C.total}#N(){this.#y="canvas2d",this.#n=document.createElement("canvas"),this.#n.width=1024,this.#n.height=1024,this.#t=this.#n.getContext("2d",{alpha:!0}),this.#t?this.#o&&this.#E(this.#o):(this.#y="unavailable",this.#V.onProblem?.("renderer-unavailable"))}#E(C){let H=this.#t;if(!H||!this.#n)return;H.clearRect(0,0,this.#n.width,this.#n.height);let V=new DataView(C.buffer,C.pointOffset,C.total*8),L=Math.min(C.total,5e4),r=Math.max(1,Math.ceil(C.total/L)),t=0,M=0,o=()=>{if(this.#_||C!==this.#o||!this.#n)return;let i=Math.min(C.total,t+r*4e3);for(;t<i;t+=r){let a=t*8,n=V.getUint16(a,!0)/Math.max(1,C.metadata.span[0])*this.#n.width,A=V.getUint16(a+2,!0)/Math.max(1,C.metadata.span[1])*this.#n.height,d=V.getUint8(a+5),m=V.getUint8(a+6),x=V.getUint8(a+7);H.fillStyle=`rgb(${d} ${m} ${x})`,H.fillRect(n,A,1.5,1.5),M+=1}this.#g=M,this.requestRender(),t<C.total?this.#Z=window.setTimeout(o,0):this.#Z=null};o()}#$(){this.#Z!==null&&window.clearTimeout(this.#Z),this.#Z=null}#D(){let C=this.#C.getBoundingClientRect();return this.#O={width:C.width,height:C.height,left:C.left,top:C.top},this.#O}#J(){let C=this.#D(),H=Math.min(window.devicePixelRatio||1,3),V=Math.max(1,Math.round(C.width*H)),L=Math.max(1,Math.round(C.height*H));for(let r of[this.#C,this.#H])(r.width!==V||r.height!==L)&&(r.width=V,r.height=L)}#C1(){let C=this.#O,H=Math.max(.2,C.width/Math.max(1,C.height)),V=Math.cos(this.#M.pitch)*this.#M.distance,L=[this.#M.targetX+Math.sin(this.#M.yaw)*V,Math.sin(this.#M.pitch)*this.#M.distance,this.#M.targetZ+Math.cos(this.#M.yaw)*V],r=[this.#M.targetX,0,this.#M.targetZ],t=p7(L,r),M=this.#M.orthographic?s7(-this.#M.distance*H,this.#M.distance*H,-this.#M.distance,this.#M.distance,-this.#s*4,this.#s*4):d7(X3,H,.02,Math.max(60,this.#s*12));return l7(M,t)}requestRender(){this.#u!==null||this.#_||(this.#u=window.requestAnimationFrame(()=>{this.#u=null,this.#q()}))}#q(){let C=performance.now();this.#J(),this.#w=this.#C1(),this.#y==="webgl2"?this.#H1():this.#V1(),this.#M1(),this.#P=performance.now()-C,this.#P>18?(this.#b+=1,this.#b>=3&&this.#p?.quality==="auto"&&(this.#k=Math.max(.25,this.#k*.75))):this.#b=Math.max(0,this.#b-1)}#H1(){let C=this.#e,H=this.#o;if(!C||(C.viewport(0,0,this.#C.width,this.#C.height),C.clearColor(0,0,0,0),C.clear(C.COLOR_BUFFER_BIT|C.DEPTH_BUFFER_BIT),!H||!this.#a||!this.#L))return;if(this.#p?.view==="top"&&this.#p.appearance==="rooms"){this.#g=0;return}C.useProgram(this.#a),C.bindVertexArray(this.#L),C.uniformMatrix4fv(this.#c,!1,this.#w),C.uniform2f(this.#h,(H.metadata.span[0]-1)/2,(H.metadata.span[1]-1)/2),C.uniform1f(this.#x,H.metadata.metersPerCell);let V=Math.min(window.devicePixelRatio||1,3),L=Math.max(1,Math.floor(H.total*this.#k)),r=Math.min(H.floorCount,L),t=Math.min(H.surfaceCount,Math.max(0,L-r));C.uniform1f(this.#i,this.#C.height*.038),C.uniform1f(this.#f,4.5*V),C.drawArrays(C.POINTS,0,r),C.uniform1f(this.#i,this.#C.height*.05),C.uniform1f(this.#f,7*V),C.drawArrays(C.POINTS,H.floorCount,t),C.bindVertexArray(null),this.#g=r+t}#V1(){}#t1(C,H,V=0){let L=this.#o;return L?[-(C-(L.metadata.span[0]-1)/2)*L.metadata.metersPerCell,V*L.metadata.metersPerCell,(H-(L.metadata.span[1]-1)/2)*L.metadata.metersPerCell]:null}#L1(C,H,V=0,L=!0){let r=this.#t1(C,H,V);if(!r)return null;let[t,M,o]=r,i=this.#w,a=(i[0]??0)*t+(i[4]??0)*M+(i[8]??0)*o+(i[12]??0),n=(i[1]??0)*t+(i[5]??0)*M+(i[9]??0)*o+(i[13]??0),A=(i[3]??0)*t+(i[7]??0)*M+(i[11]??0)*o+(i[15]??0);if(A<=.001)return null;let d=a/A,m=n/A;if(!Number.isFinite(d)||!Number.isFinite(m)||L&&(Math.abs(d)>1.15||Math.abs(m)>1.15))return null;let x=this.#O;return{x:(d*.5+.5)*x.width,y:(-m*.5+.5)*x.height}}#z(C,H,V=0){let L=this.#o;if(!L)return null;let r=C/L.metadata.metersPerCell-L.metadata.origin[0],t=H/L.metadata.metersPerCell-L.metadata.origin[1];return this.#L1(r,t,V)}#M1(){let C=this.#r,H=this.#o,V=this.#p;if(!C)return;let L=Math.min(window.devicePixelRatio||1,3),r=this.#O;if(C.setTransform(L,0,0,L,0,0),C.clearRect(0,0,r.width,r.height),!H||!V)return;let t=this.#T;if(this.#y==="canvas2d"&&this.#n&&!(V.view==="top"&&V.appearance==="rooms")){let a=this.#d/this.#M.distance,n=r.width*a,A=r.height*a,d=(r.width-n)/2-this.#M.targetX*32*a,m=(r.height-A)/2-this.#M.targetZ*32*a;C.drawImage(this.#n,d,m,n,A)}let M=this.#o1(V);if(V.labelsVisible||V.view==="top"&&V.appearance==="rooms"){C.lineWidth=1.5,C.font="600 12px system-ui, sans-serif",C.textAlign="center",C.textBaseline="middle";let a=[];for(let n of H.metadata.rooms){let A=M.has(n.name.toLocaleLowerCase());C.strokeStyle=A?B(t.accent,1):B(t.quiet,.7),C.fillStyle=A?B(t.accent,.26):V.view==="top"&&V.appearance==="rooms"?B(t.roomFill,.94):B(t.plate,.04),C.beginPath();let d=Math.max(1,Math.ceil(n.boundary.length/512)),m=!1;for(let f=0;f<n.boundary.length;f+=d){let S=n.boundary[f];if(!S)continue;let y=this.#L1(S[0],S[1],.2,!1);y&&(m?C.lineTo(y.x,y.y):C.moveTo(y.x,y.y),m=!0)}if(m&&(C.closePath(),C.fill(),C.stroke()),!V.labelsVisible)continue;let x=this.#L1(n.center[0],n.center[1],1);if(!x)continue;let h=C.measureText(n.name).width,u=new DOMRect(x.x-h/2-6,x.y-10,h+12,20);a.some(f=>u.left<f.right+8&&u.right+8>f.left&&u.top<f.bottom+4&&u.bottom+4>f.top)||(a.push(u),C.fillStyle=B(t.plate,.88),C.fillRect(u.x,u.y,u.width,u.height),C.fillStyle=B(t.text,1),C.fillText(n.name,x.x,x.y))}}let o=V.draw.circles;if((V.workflow==="draw"||V.workflow==="areaReview")&&o.length){C.fillStyle=B(t.accent,.22),C.strokeStyle=B(t.accent,.92),C.lineWidth=1.5;for(let a of o)this.#i1(C,a)}if(this.#S&&V.workflow==="draw"&&V.draw.tool!=="pan"){let a=this.#z(this.#S.x,this.#S.y),n=this.#z(this.#S.x+V.draw.brushMeters/2,this.#S.y);a&&n&&(C.beginPath(),C.arc(a.x,a.y,Math.max(2,Math.hypot(n.x-a.x,n.y-a.y)),0,Math.PI*2),C.strokeStyle=B(t.accent,1),C.lineWidth=2,C.stroke())}let i=V.resources.pose.value;if(V.map.exactPose&&i?.position&&V.dataMode==="live"){let a=this.#z(i.position[0],i.position[1],3);a&&(C.beginPath(),C.arc(a.x,a.y,7,0,Math.PI*2),C.fillStyle=B(t.accent,1),C.fill(),C.strokeStyle=B(t.onAccent,1),C.lineWidth=3,C.stroke())}}#o1(C){let H=C.resources.plans.value?.rooms||C.resources.areas.value?.rooms||[];return new Set(H.filter(V=>C.selection.roomIds.includes(V.roomId)).map(V=>V.name.toLocaleLowerCase()))}#i1(C,H){let V=this.#z(H.x,H.y),L=this.#z(H.x+H.radius,H.y);!V||!L||(C.beginPath(),C.arc(V.x,V.y,Math.max(1,Math.hypot(L.x-V.x,L.y-V.y)),0,Math.PI*2),C.fill(),C.stroke())}setPalette(C){this.#T=C,this.requestRender()}setCursor(C){this.#S=C,this.requestRender()}screenToMap(C,H){let V=this.#o;if(!V||!this.#M.orthographic)return null;let L=this.#D();if(!L.width||!L.height)return null;let r=this.#M.distance*2/L.height,t=this.#M.targetX+(C-L.left-L.width/2)*r,M=this.#M.targetZ+(H-L.top-L.height/2)*r,o=-t/V.metadata.metersPerCell+(V.metadata.span[0]-1)/2,i=M/V.metadata.metersPerCell+(V.metadata.span[1]-1)/2;return{x:(o+V.metadata.origin[0])*V.metadata.metersPerCell,y:(i+V.metadata.origin[1])*V.metadata.metersPerCell}}roomAt(C,H){let V=this.screenToMap(C,H),L=this.#o,r=this.#p;if(!V||!L||!r)return null;let t=V.x/L.metadata.metersPerCell-L.metadata.origin[0],M=V.y/L.metadata.metersPerCell-L.metadata.origin[1],o=L.metadata.rooms.find(i=>q3(t,M,i.boundary));return o?this.#a1(o,r):null}containsMapPoint(C){let H=this.#o;if(!H)return!1;let V=C.x/H.metadata.metersPerCell-H.metadata.origin[0],L=C.y/H.metadata.metersPerCell-H.metadata.origin[1];return H.metadata.rooms.some(r=>q3(V,L,r.boundary))}#a1(C,H){return(H.resources.plans.value?.rooms||H.resources.areas.value?.rooms||[]).find(L=>L.name.localeCompare(C.name,void 0,{sensitivity:"base"})===0)?.roomId||C.id}selectRoomAt(C,H){let V=this.roomAt(C,H);V&&this.#V.onRoom?.(V)}fit(C=!0){let H=this.#p?.view==="top"||this.#p?.workflow==="draw";this.#M=H?{yaw:0,pitch:Math.PI/2-.018,distance:this.#d,targetX:0,targetZ:0,orthographic:!0}:{yaw:-Math.PI/4,pitch:.82,distance:this.#l,targetX:0,targetZ:0,orthographic:!1},this.#v=!0,this.requestRender(),C&&this.#U()}zoomAt(C,H,V){let L=H===void 0||V===void 0?null:this.screenToMap(H,V),r=this.#R();if(this.#M={...this.#M,distance:_(this.#M.distance/C,r.minimum,r.maximum)},this.#v=!1,L&&H!==void 0&&V!==void 0){let t=this.screenToMap(H,V);t&&(this.#M={...this.#M,targetX:this.#M.targetX-(L.x-t.x),targetZ:this.#M.targetZ+(L.y-t.y)})}this.requestRender(),this.#U(H,V)}panBy(C,H){this.setCamera(this.cameraAfterPan(this.#M,C,H))}orbitBy(C,H){if(this.#M.orthographic){this.panBy(C,H);return}this.#M={...this.#M,yaw:R1(this.#M.yaw+C*.006),pitch:_(this.#M.pitch-H*.004,.18,1.38)},this.#v=!1,this.requestRender(),this.#U()}rotateBy(C){this.#M={...this.#M,yaw:R1(this.#M.yaw+C)},this.#v=!1,this.requestRender(),this.#U()}#U(C,H){let V=this.#M.orthographic?this.#d:this.#l,L=C===void 0||H===void 0?this.#O:this.#D(),r=C===void 0||H===void 0||!L.width||!L.height?void 0:{xPercent:_((C-L.left)/L.width*100,0,100),yPercent:_((H-L.top)/L.height*100,0,100)};this.#V.onCamera?.(this.camera,Math.round(V/this.#M.distance*100),r)}diagnostics(){return{mode:this.#y,contextGeneration:this.#B,sceneRevision:this.#o?.revision??null,sourcePoints:this.#o?.total??0,renderedPoints:this.#g,lastFrameMs:Math.round(this.#P*100)/100,slowFrames:this.#b,cameraDistance:this.#M.distance,fitDistance:this.#M.orthographic?this.#d:this.#l,fitActive:this.#v}}#e1=C=>{C.preventDefault(),this.#X(),this.#N(),this.requestRender()};#r1=()=>{this.#X(),this.#K(),this.requestRender()};#X(){let C=this.#e;C&&(this.#A&&C.deleteBuffer(this.#A),this.#L&&C.deleteVertexArray(this.#L),this.#a&&C.deleteProgram(this.#a)),this.#A=null,this.#L=null,this.#a=null,this.#e=null}dispose(){this.#_||(this.#_=!0,this.#m.disconnect(),this.#C.removeEventListener("webglcontextlost",this.#e1),this.#C.removeEventListener("webglcontextrestored",this.#r1),this.#u!==null&&window.cancelAnimationFrame(this.#u),this.#u=null,this.#$(),this.#X(),this.#n=null,this.#t=null,this.#r=null,this.#o=null,this.#p=null)}};var Y3="component.matic_robot.common.",T=(e,C,H,V)=>{let L=V?{...V}:void 0,r=e?.(`${Y3}${C}`,L);return r&&r!==`${Y3}${C}`?r:V?Object.entries(V).reduce((t,[M,o])=>t.replaceAll(`{${M}}`,String(o)),H):H};var i1="matic-workspace-intent",H2="matic-workspace-action",j3="navigation-help",J3=(e,C)=>{let H=(L,r,t)=>T(C,L,r,t);if(e.dataMode==="history")return e.map.available?H("v4_saved_map_description","Saved read-only map for {floor}. Live robot position is hidden.",{floor:e.floor.displayName}):e.resources.scene.status==="loading"?H("v4_saved_map_loading_description","The saved map is loading."):H("v4_saved_map_unavailable_description","This saved map is unavailable.");if(!s1(e))return H("v4_private_map_unavailable","The current private map is not available.");let V=i5(e)?H("v4_robot_position_verified","The robot position is verified."):H("v4_robot_position_hidden","The robot position is not shown.");return H("v4_live_map_description","Live map for {floor}. {pose}",{floor:e.floor.displayName,pose:V})},z2=class extends O{constructor(){super();this.state=k();this.narrow=!1;this.#C=null;this.#H=null;this.#V=null;this.#e=!1;this.#r=!1;this.#t=null;this.#n=[];this.#a=null;this.#A=null;this.#i=()=>{this.#h()};new j1(this,{container:()=>this.renderRoot?.querySelector(".camera-steps")??null,items:"button"})}static{this.properties={state:{attribute:!1},localize:{attribute:!1},narrow:{type:Boolean,reflect:!0}}}static{this.styles=[E,D,J,b`
    :host {
      display: block;
      min-width: 0;
      min-height: 0;
      ...
      <div class="map-rail" data-map-control>
        ...
        ${a?s`
          <div class="camera-steps ms-surface ms-surface--floating ms-segment" role="toolbar" aria-orientation="horizontal" aria-label=${this.#L("map_camera_controls","Map camera controls")}>
            <button class="ms-btn ms-btn--icon" type="button" aria-label=${this.#L("map_rotate_left","Rotate left")} aria-keyshortcuts="[" @click=${()=>this.#l(-52,0)}>${Z(y3)}</button>
            <button class="ms-btn ms-btn--icon" type="button" aria-label=${this.#L("map_tilt_down","Lower viewing angle")} aria-keyshortcuts="PageDown" @click=${()=>this.#l(0,30)}>${Z(h3)}</button>
            <button class="ms-btn ms-btn--icon" type="button" aria-label=${this.#L("map_tilt_up","Raise viewing angle")} aria-keyshortcuts="PageUp" @click=${()=>this.#l(0,-30)}>${Z(Z3)}</button>
            <button class="ms-btn ms-btn--icon" type="button" aria-label=${this.#L("map_rotate_right","Rotate right")} aria-keyshortcuts="]" @click=${()=>this.#l(52,0)}>${Z(b3)}</button>
          </div>
        `:l}
        ...
        ${this.#e&&H&&A?s`
          ...
          >
            <header>
              <h3>${M}</h3>
              <button class="ms-btn ms-btn--sm" type="button" @click=${()=>this.#m()}>${this.#L("v4_close","Close")}</button>
            </header>
            <dl>
    ...
    `}#c(H){let V=this.state.planDraft.rooms,r=V.find(t=>t.roomId===H)?V.filter(t=>t.roomId!==H):[...V,{roomId:H,cleaningMode:"vacuum",coverageSetting:"standard"}];this.#r({type:"patch-plan-draft",patch:{rooms:r}})}#h(H,V){let L=this.state.planDraft.rooms.map((r,t)=>t===H?{...r,...V}:r);this.#r({type:"patch-plan-draft",patch:{rooms:L}})}#x(H,V){let L=H+V,r=[...this.state.planDraft.rooms];if(L<0||L>=r.length)return;let[t]=r.splice(H,1);t&&(r.splice(L,0,t),this.#r({type:"patch-plan-draft",patch:{rooms:r}}))}#i(){let H=this.state.resources.plans,V=H.value,L=this.state.planDraft,r=L.rooms.map(o=>({room:o,label:V?.rooms.find(i=>i.roomId===o.roomId)?.name||"Room",selected:!0})),t=(V?.rooms||[]).filter(o=>!L.rooms.some(i=>i.roomId===o.roomId)).map(o=>({room:{roomId:o.roomId,cleaningMode:"vacuum",coverageSetting:"standard"},label:o.name,selected:!1})),M=[...r,...t];return this.#a(H.status,H.problem,s`
      <div class="stack">
        ...
        <div class="plan-options" role="group" aria-labelledby="completion-heading">
          <label class="checkbox"><input type="checkbox" .checked=${L.returnToBase} @change=${o=>this.#r({type:"patch-plan-draft",patch:{returnToBase:C0(o)}})}>${this.#H("plan_return_to_base","Return to the dock when finished")}</label>
          <label class="checkbox"><input type="checkbox" .checked=${L.finishCurrentRoom} @change=${o=>this.#r({type:"patch-plan-draft",patch:{finishCurrentRoom:C0(o)}})}>${this.#H("plan_finish_room","Finish the active room after Stop")}</label>
...
`),L=typeof navigator>"u"?void 0:navigator.clipboard;if(L&&typeof L.writeText=="function")try{await L.writeText(V),this.#m("copied");return}catch{}this.#m(this.#M(V,H instanceof HTMLElement?H:null)?"copied":"failed")}#d(){let H=this.#Z(),V=this._copyStatus==="copied"?this.#H("v4_copied","Copied"):this._copyStatus==="failed"?this.#H("v4_copy_failed","The summary could not be copied. Select the text to copy it by hand."):"";return s`
  ...
  `]}#C(H,V,L){return T(this.localize,H,V,L)}#H;#V;#e;#r;#t;#n;#a;#A;#L;#c;connectedCallback(){super.connectedCallback(),this.#H=new ResizeObserver(([H])=>{if(!H)return;let V=H.contentRect.width<768||H.contentRect.height<480;V!==this._measuredNarrow&&(this._measuredNarrow=V)}),this.#H.observe(this),window.addEventListener("pointerdown",this.#c,!0),document.addEventListener("fullscreenchange",this.#L),this.#V=new ResizeObserver(([H])=>{if(!H)return;let V=Math.ceil(H.target.getBoundingClientRect().height);V!==this._sheetOffset&&(this._sheetOffset=V)})}disconnectedCallback(){this.#H?.disconnect(),this.#H=null,this.#V?.disconnect(),this.#V=null,this.#e=null,window.removeEventListener("pointerdown",this.#c,!0),document.removeEventListener("fullscreenchange",this.#L),super.disconnectedCallback()}updated(H){let V=H,L=this.renderRoot.querySelector(".mobile-sheet");if(L!==this.#e&&(this.#V?.disconnect(),this.#e=L,L?this.#V?.observe(L):this._sheetOffset!==0&&(this._sheetOffset=0)),V.has("_overflowOpen")&&this._overflowOpen&&this.updateComplete.then(()=>{this.renderRoot.querySelector("#map-options select, #map-options button")?.focus()}),V.has("_helpOpen")){if(this._helpOpen)this.updateComplete.then(()=>{this.renderRoot.querySelector(".help-dialog [data-dialog-initial-focus]")?.focus()});else if(V.get("_helpOpen")){let r=this.#t;this.#t=null,this.updateComplete.then(()=>{requestAnimationFrame(()=>r?.focus({preventScroll:!0}))})}}if(H.has("state")){let r=H.get("state");if(r?.precisionOpen&&!this.state.precisionOpen&&this.#x()?.focus(),r?.fullMap&&!this.state.fullMap&&this.updateComplete.then(()=>{requestAnimationFrame(()=>this.renderRoot.querySelector(".workspace-toggle")?.focus({preventScroll:!0}))}),!r?.dialog&&this.state.dialog){let t=S7(this.shadowRoot||document);t?.hasAttribute("data-dialog-launcher")&&(this.#r=t),this.updateComplete.then(()=>{(this.renderRoot.querySelector(".dialog [data-dialog-initial-focus]")??this.renderRoot.querySelector(".dialog button"))?.focus()})}else if(r?.dialog&&!this.state.dialog){let t=this.#r?.isConnected&&this.#r.hasAttribute("data-dialog-launcher")?this.#r:this.#Q(r.dialog);this.#r=null,this.updateComplete.then(()=>{requestAnimationFrame(()=>t?.focus({preventScroll:!0}))})}r?r.workflow!==this.state.workflow&&(this._sheetDetent=e0[this.state.workflow],this.updateComplete.then(()=>this.#h())):this._sheetDetent=e0[this.state.workflow]}}#h(){let H=this.renderRoot.querySelector(".panel-heading h2");if(q2(H)){H.focus({preventScroll:!0});return}let V=this.renderRoot.querySelector(".action-bar .ms-btn--primary");q2(V)&&V.focus({preventScroll:!0})}#x(){let H=this.renderRoot.querySelector(".draw-brush");return q2(H)?H:this.renderRoot.querySelector(t1)?.shadowRoot?.querySelector(".draw-brush")??null}#i(H){this.dispatchEvent(new CustomEvent(i1,{detail:H,bubbles:!0,composed:!0}))}#f(H){if(H.enabled){if(H.id==="return-live"){this.#i({type:"set-history",historyId:null});return}if(H.id==="clear-draft"){this.#i({type:"clear-draft"});return}this.#m(H.id)}}#p(H){if(this.state.workflow==="draw"&&this.state.draw.dirty&&H!=="draw"&&H!=="areaReview"){this.#n=H,this.#i({type:"open-dialog",dialog:"discardDraft"});return}this.#i({type:"open-workflow",workflow:H})}#o(){let H=this.#n;this.#n=null,this.#i({type:"discard-draft"}),H&&queueMicrotask(()=>this.#i({type:"open-workflow",workflow:H}))}#u(){this.#n=null,this.#Z()}#Z(){let H=this.state.dialog,V=H&&this.#r?.isConnected&&this.#r.hasAttribute("data-dialog-launcher")?this.#r:H?this.#Q(H):null;this.#i({type:"dismiss-top-layer"}),V&&requestAnimationFrame(()=>V.focus({preventScroll:!0}))}#m(H){this.dispatchEvent(new CustomEvent(H2,{detail:{id:H},bubbles:!0,composed:!0}))}#M(H){this.#i({type:"dismiss-top-layer"}),this.#m(H)}#l(H){if(H.action==="discard"){this.#o();return}if(H.action==="delete-plan"||H.action==="delete-area"){this.#M(H.action);return}this.#i({type:"dismiss-top-layer"}),H.action==="stop"&&this.#m("stop")}#d(H){H!==this._sheetDetent&&(this._sheetDetent=H,this._announcement=this.#C("v4_workspace_height","Map workspace, {height} height",{height:H}))}#s(H,V=!1){let r=C1.indexOf(this._sheetDetent)+H;V&&r>=C1.length&&(r=0),r=Math.max(0,Math.min(C1.length-1,r)),this.#d(C1[r]??this._sheetDetent)}#w(H){let V=this.renderRoot.querySelector(".workspace")?.clientHeight??H.parentElement?.clientHeight??H.offsetHeight,L=parseFloat(getComputedStyle(this).fontSize)||16,r=[".sheet-grip",".sheet-tools",".action-bar"].map(o=>H.querySelector(o)?.offsetHeight??0).reduce((o,i)=>o+i,0)+L*.75,t=Math.min(V*.92,V-L*4),M=Math.min(V*.48,L*26,t);return{peek:Math.min(r,M),half:M,full:t}}#S(){return this.renderRoot.querySelector(".mobile-sheet")}#y(H){if(H.pointerType==="mouse"&&H.button!==0||H.target?.closest("button, select, input, a"))return;let V=this.#S();!V||this.#a||(this.#a={pointerId:H.pointerId,startY:H.clientY,startHeight:V.offsetHeight,heights:this.#w(V),samples:[{y:H.clientY,t:H.timeStamp}],moved:!1},H.currentTarget.setPointerCapture(H.pointerId),V.classList.add("dragging"))}#B(H){let V=this.#a;if(!V||H.pointerId!==V.pointerId)return;let L=this.#S();if(!L)return;let r=H.clientY-V.startY;for(!V.moved&&Math.abs(r)>u7&&(V.moved=!0),V.samples.push({y:H.clientY,t:H.timeStamp});V.samples.length>2&&H.timeStamp-(V.samples[1]?.t??0)>c7;)V.samples.shift();if(!V.moved)return;let t=V.startHeight-V.heights.full,M=V.startHeight-V.heights.peek,o=Math.max(t,Math.min(M,r));L.style.transform=`translateY(${o}px)`}#g(H){let V=this.#a;if(!V||H.pointerId!==V.pointerId)return;this.#a=null;let L=this.#S();if(L&&(L.style.transform="",L.classList.remove("dragging")),H.type==="pointercancel")return;if(!V.moved){this.#s(1,!0);return}let r=H.clientY-V.startY,t=C1.indexOf(this._sheetDetent),M=V.samples[0],o=V.samples[V.samples.length-1],i=M&&o&&o!==M?(o.y-M.y)/Math.max(1,o.t-M.t):0;if(Math.abs(i)>v7){let d=Math.max(0,Math.min(C1.length-1,t+(i<0?1:-1)));this.#d(C1[d]??this._sheetDetent);return}let a=V.startHeight-r,n=this._sheetDetent,A=Number.POSITIVE_INFINITY;for(let d of C1){let m=Math.abs(V.heights[d]-a);m<A&&(A=m,n=d)}this.#d(n)}#P(H){if(H.pointerType==="mouse")return;let V=H.currentTarget;this.#A={pointerId:H.pointerId,startY:H.clientY,atTop:V.scrollTop===0,consumed:!1}}#b(H){let V=this.#A;if(!V||V.consumed||!V.atTop||H.pointerId!==V.pointerId)return;if(H.currentTarget.scrollTop>0){this.#A=null;return}H.clientY-V.startY<x7||(V.consumed=!0,this.#s(-1))}#k(){this.#A=null}#O(){this.dispatchEvent(new CustomEvent("hass-toggle-menu",{bubbles:!0,composed:!0}))}#v(H){this._overflowOpen=!1,H&&this.updateComplete.then(()=>{this.renderRoot.querySelector(".overflow")?.focus()})}#_(H){if(this.#v(H==="fullscreen"),H==="support"){this.#p("support");return}if(H==="fullscreen"){let V=this.renderRoot.querySelector(".app");document.fullscreenElement?document.exitFullscreen():V?.requestFullscreen();return}this.dispatchEvent(new CustomEvent(H2,{detail:{id:"use-classic"},bubbles:!0,composed:!0}))}#T(){this.#i({type:"set-precision-open",value:!this.state.precisionOpen})}#R(H){this.#t=H.currentTarget,this._helpOpen=!0}#G(H){let V=H;if(V.detail?.type!=="open-dialog")return;let L=V.composedPath().find(r=>r instanceof HTMLElement&&r.hasAttribute("data-dialog-launcher"));L instanceof HTMLElement&&(this.#r=L)}#Q(H){return this.renderRoot.querySelector(c1)?.shadowRoot?.querySelector(`[data-dialog-launcher="${H}"]`)??null}#Y(H){if(!(H.defaultPrevented||H.ctrlKey||H.metaKey||H.altKey)&&H.key==="Escape"){if(H.preventDefault(),this._overflowOpen){this.#v(!0);return}if(this._helpOpen){this._helpOpen=!1;return}this.#i({type:"dismiss-top-layer"})}}#I(H){if(H.key!=="Tab")return;let L=[...H.currentTarget.querySelectorAll(Z7)],r=L[0],t=L.at(-1);if(!r||!t)return;let M=this.shadowRoot?.activeElement;H.shiftKey&&M===r?(H.preventDefault(),t.focus()):!H.shiftKey&&M===t&&(H.preventDefault(),r.focus())}#K(){let H=this.renderRoot.querySelector(t1);(H?.shadowRoot?.querySelector(".map-root")??H)?.focus()}#j(){this._sheetDetent==="peek"&&this.#S()&&this.#d("half"),this.updateComplete.then(()=>this.#h())}#F(H,V,L){if(H.id==="choose-cleaning")return l;let r=H.labelKey?this.#C(H.labelKey,H.label):H.label,t=!H.enabled&&H.reason?H.reasonKey?this.#C(H.reasonKey,H.reason):H.reason:null,M=H.id==="stop";return v`
      <button
    ...
    `}#D(H){let V=H.resources.history.value?.floors||[],L=V.length?V.map((r,t)=>({id:r.active?"current":r.id,label:`${r.label||(r.active?this.#C("v4_current_floor","Current floor"):this.#C("v4_saved_floor","Saved floor {number}",{number:r.ordinal??t+1}))}${!r.active&&r.snapshots.length===0?` \xB7 ${this.#C("v4_floor_not_captured","Visit floor to capture")}`:""}`,disabled:!r.active&&r.snapshots.length===0})):[{id:H.selection.floorId,label:H.floor.displayName,disabled:!1}];return v`
      ...
      `)}</select>
    `}#J(H,V){let L=(x,h,u)=>this.#C(x,h,u),r=this.#$(L("v4_map_history","Map history"),$2,()=>this.#p("history"),L("v4_map_history_detail","Saved maps are floor-scoped and read only.")),t=this.#$(L("v4_map_diagnostics","Map diagnostics"),I3,()=>this.#p("support"),L("v4_map_support_detail","Private geometry is never included.")),{host:M}=H;if(!M.connected)return this.#E(L("v4_reconnecting_title","Reconnecting to Home Assistant"),L("v4_reconnecting_body","The last verified map stays read-only until the connection returns."));if(!M.administrator)return this.#E(L("v4_admin_title","Administrator access required"),L("v4_admin_body","Ask a Home Assistant administrator to open this map."));if(M.robotCount===0)return this.#E(L("v4_no_robot_title","No Matic robot set up"),L("v4_no_robot_body","Add the Matic integration to see a map here."),v`<a class="ms-btn ms-btn--secondary" href="/config/integrations/integration/matic_robot">${L("v4_open_integration","Open the Matic integration")}</a>`);if(!M.robotConnected)return v`
        ${this.#E(L("v4_robot_offline_title","Robot offline"),L("v4_robot_offline_body","Showing the last verified map. Cleaning is unavailable until the robot reconnects."))}
      ...
      ${H.activity==="problem"?this.#E(L("v4_attention_title","The robot needs attention"),L("v4_attention_body","Check the robot, then start a new task.")):v`
      ...
      <h3 class="shelf-heading">${L("v4_more","Map tools")}</h3>
      <div class="shelf">
        ${this.#$(L("v4_custom_areas","Clean a custom area"),D3,()=>this.#p("draw"),L("v4_areas_quick_detail","Draw a precise area on the map"))}
        ${r}
        ${V?this.#D(H):l}
      </div>
      ${V?v`
      ...
      `:l}
    `}#C1(H,V){return H.workflow==="none"?this.#J(H,V):v`<${V0}
      .state=${H}
      .localize=${this.localize}
      @matic-workspace-intent=${this.#G}
    ></${V0}>`}#q(H,V){let L=L0(H,this.localize);return v`
      ...
      ${this.#C1(H,V)}
    `}#H1(H,V){let r=L0(H,this.localize).title;return H.workflow==="rooms"&&H.selection.roomIds.length&&(r=`${this.#C("v4_rooms_selected","{count} rooms selected",{count:H.selection.roomIds.length})} \xB7 ${this.#W(H).join(", ")}`),this._sheetDetent!=="peek"?V.detail?`${V.title} \xB7 ${V.detail}`:V.title:V.notable?`${V.title} \xB7 ${r}`:r}#V1(){let H=(V,L)=>this.#C(V,L);return v`
    ...
    `}render(){let H=this.state,V=H.narrowHint||this._measuredNarrow,L=m7(H,this.localize),r=n5({...H,narrowHint:V}),t=A5(H),M=!V&&r.id==="stop"?r:!V&&t?.id==="stop"?t:null,o=M&&M===r?null:r,i=H.workflow==="draw"&&H.dataMode==="live"?{id:"clear-draft",label:"Clear drawing",labelKey:"v4_clear_drawing",kind:"neutral",enabled:H.draw.circles.length>0}:null,a=M&&M===t?null:t??i,n=H.fullMap&&(H.coherence==="verifying"||H.coherence==="booting"),A=H.fullMap||H.host.administrator&&H.host.robotCount>0&&H.map.available,d=h7(H.dialog,this.localize),m=V&&!H.fullMap?`--map-sheet-offset:${this._sheetOffset}px`:"--map-sheet-offset:0px",x=V&&H.workflow==="draw",h=H.precisionOpen&&H.workflow==="draw";return v`
            ...
            <div class="overflow-wrap">
              ...
              ${this._overflowOpen?v`
                <div id="map-options" class="overflow-menu ms-surface ms-surface--overlay">
                  ...
                  <button class="ms-row ms-row--menu" type="button" @click=${()=>this.#_("support")}>${this.#C("v4_map_diagnostics","Map diagnostics")}</button>
                  <button class="ms-row ms-row--menu" type="button" @click=${()=>this.#_("classic")}>${this.#C("v4_switch_classic","Switch to Map Studio 0.3")}</button>
                  <button class="ms-row ms-row--menu" type="button" @click=${()=>this.#_("fullscreen")}>${this._browserFullscreen?this.#C("v4_leave_full_screen","Leave full screen"):this.#C("v4_full_screen","Full screen")}</button>
                </div>
              `:l}
            </div>
          </header>
            ...
            >
              ${V?v`
                ...
                >
                  ...
                  <span class="sheet-status">${this.#H1(H,L)}</span>
                  <button
                ...
                ${x?v`
                  <div class="sheet-tools">
                    ${Y1(H,{intent:u=>this.#i(u),openBrush:()=>this.#T(),t:(u,f)=>this.#C(u,f)},"grid")}
                    ${h?v`
                      <div class="precision-popover">
