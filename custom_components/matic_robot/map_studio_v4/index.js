              ...
              ${V?v`
                ...
                ${x?v`
                  <div class="sheet-tools">
                    ${Y1(H,{intent:u=>this.#n(u),openBrush:()=>this.#G(),t:(u,f)=>this.#C(u,f)},"grid")}
                    ${h?v`
                      <div class="precision-popover">
