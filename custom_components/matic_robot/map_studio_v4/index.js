...
`;var f5=Symbol.for(""),l0=L=>{if(L?.r===f5)return L?._$litStatic$},N=L=>({_$litStatic$:L,r:f5});var h5=new Map,b2=L=>(C,...H)=>{let V=H.length,e,r,M=[],t=[],i,o=0,a=!1;for(;o<V;){for(i=C[o];o<V&&(r=H[o],(e=l0(r))!==void 0);)i+=e+C[++o],a=!0;o!==V&&t.push(r),M.push(i),o++}if(o===V&&M.push(C[V]),a){let A=M.join("$$lit$$");(C=h5.get(A))===void 0&&(M.raw=M,h5.set(A,C=M)),H=t}return L(C,...H)},d=b2(y),x7=b2(x5),u7=b2(u5);var g5=import.meta.url.match(/\/matic_robot\/[^/]+-([a-f0-9]{12})\/map-studio-v4(?:\/|$)/u)?.[1]??"dev",w1=g5==="dev"?"":`-${g5}`,k1=`matic-map-canvas-v4${w1}`,e1=`matic-precision-controls-v4${w1}`,p1=`matic-map-workflow-v4${w1}`,r1=`matic-map-shell-v4${w1}`,O2=`matic-map-panel-v0-4-0${w1}`;var m1=h`
.ms-btn, .ms-row {
...
`;var y5="M9.5,13.09L10.91,14.5L6.41,19H10V21H3V14H5V17.59L9.5,13.09M10.91,9.5L9.5,10.91L5,6.41V10H3V3H10V5H6.41L10.91,9.5M14.5,13.09L19,17.59V14H21V21H14V19H17.59L13.09,14.5L14.5,13.09M13.09,9.5L17.59,5H14V3H21V10H19V6.41L14.5,10.91L13.09,9.5Z";var b5="M20.71,4.63L19.37,3.29C19,2.9 18.35,2.9 17.96,3.29L9,12.25L11.75,15L20.71,6.04C21.1,5.65 21.1,5 20.71,4.63M7,14A3,3 0 0,0 4,17C4,18.31 2.84,19 2,19C2.92,20.22 4.5,21 6,21A4,4 0 0,0 10,17A3,3 0 0,0 7,14Z";var O5="M21,7L9,19L3.5,13.5L4.91,12.09L9,16.17L19.59,5.59L21,7Z";var w5="M7.41,8.58L12,13.17L16.59,8.58L18,10L12,16L6,10L7.41,8.58Z";var k5="M7.41,15.41L12,10.83L16.59,15.41L18,14L12,8L6,14L7.41,15.41Z";var P5="M19,21H8V7H19M19,5H8A2,2 0 0,0 6,7V21A2,2 0 0,0 8,23H19A2,2 0 0,0 21,21V7A2,2 0 0,0 19,5M16,1H4A2,2 0 0,0 2,3V17H4V3H16V1Z";var B5="M13,6V11H18V7.75L22.25,12L18,16.25V13H13V18H16.25L12,22.25L7.75,18H11V13H6V16.25L1.75,12L6,7.75V11H11V6H7.75L12,1.75L16.25,6H13Z";var T5="M16.24,3.56L21.19,8.5C21.97,9.29 21.97,10.55 21.19,11.34L12,20.53C10.44,22.09 7.91,22.09 6.34,20.53L2.81,17C2.03,16.21 2.03,14.95 2.81,14.16L13.41,3.56C14.2,2.78 15.46,2.78 16.24,3.56M4.22,15.58L7.76,19.11C8.54,19.9 9.8,19.9 10.59,19.11L14.12,15.58L9.17,10.63L4.22,15.58Z";var R5="M18.5,4L19.66,8.35L18.7,8.61C18.25,7.74 17.79,6.87 17.26,6.43C16.73,6 16.11,6 15.5,6H13V16.5C13,17 13,17.5 13.33,17.75C13.67,18 14.33,18 15,18V19H9V18C9.67,18 10.33,18 10.67,17.75C11,17.5 11,17 11,16.5V6H8.5C7.89,6 7.27,6 6.74,6.43C6.21,6.87 5.75,7.74 5.3,8.61L4.34,8.35L5.5,4H18.5Z";var _5="M5,5H10V7H7V10H5V5M14,5H19V10H17V7H14V5M17,14H19V19H14V17H17V14M10,17V19H5V14H7V17H10Z",F5="M14,14H19V16H16V19H14V14M5,14H10V19H8V16H5V14M8,5H10V10H5V8H8V5M19,8V10H14V5H16V8H19Z";var E5="M11,18H13V16H11V18M12,2A10,10 0 0,0 2,12A10,10 0 0,0 12,22A10,10 0 0,0 22,12A10,10 0 0,0 12,2M12,20C7.59,20 4,16.41 4,12C4,7.59 7.59,4 12,4C16.41,4 20,7.59 20,12C20,16.41 16.41,20 12,20M12,6A4,4 0 0,0 8,10H10A2,2 0 0,1 12,8A2,2 0 0,1 14,10C14,12 11,11.75 11,15H13C13,12.75 16,12.5 16,10A4,4 0 0,0 12,6Z";var D5="M18.4,10.6C16.55,9 14.15,8 11.5,8C6.85,8 2.92,11.03 1.54,15.22L3.9,16C4.95,12.81 7.95,10.5 11.5,10.5C13.45,10.5 15.23,11.22 16.62,12.38L13,16H22V7L18.4,10.6Z";var $5="M13,4.07V1L8.45,5.55L13,10V6.09C15.84,6.57 18,9.03 18,12C18,14.97 15.84,17.43 13,17.91V19.93C16.95,19.44 20,16.08 20,12C20,7.92 16.95,4.56 13,4.07M7.1,18.32C8.26,19.22 9.61,19.76 11,19.93V17.9C10.13,17.75 9.29,17.41 8.54,16.87L7.1,18.32M6.09,13H4.07C4.24,14.39 4.79,15.73 5.69,16.89L7.1,15.47C6.58,14.72 6.23,13.88 6.09,13M7.11,8.53L5.7,7.11C4.8,8.27 4.24,9.61 4.07,11H6.09C6.23,10.13 6.58,9.28 7.11,8.53Z";var I5="M16.89,15.5L18.31,16.89C19.21,15.73 19.76,14.39 19.93,13H17.91C17.77,13.87 17.43,14.72 16.89,15.5M13,17.9V19.92C14.39,19.75 15.74,19.21 16.9,18.31L15.46,16.87C14.71,17.41 13.87,17.76 13,17.9M19.93,11C19.76,9.61 19.21,8.27 18.31,7.11L16.89,8.53C17.43,9.28 17.77,10.13 17.91,11M15.55,5.55L11,1V4.07C7.06,4.56 4,7.92 4,12C4,16.08 7.05,19.44 11,19.93V17.91C8.16,17.43 6,14.97 6,12C6,9.03 8.16,6.57 11,6.09V10L15.55,5.55Z";var W5="M12.5,8C9.85,8 7.45,9 5.6,10.6L2,7V16H11L7.38,12.38C8.77,11.22 10.54,10.5 12.5,10.5C16.04,10.5 19.05,12.81 20.1,16L22.47,15.22C21.08,11.03 17.15,8 12.5,8Z";var N5=k5,z5=w5,U5=y5,G5=R5,Q5=E5,q5=_5,K5=F5,X5=$5,j5=I5,Y5=W5,J5=D5,C3=b5;var H3=T5,V3=B5,L3=O5;var e3=P5;var w=L=>y`<svg
  class="ms-icon"
  viewBox="0 0 24 24"
  fill="currentColor"
  aria-hidden="true"
  focusable="false"
><path d=${L}></path></svg>`;var r3=(L,C)=>Math.hypot(L.x-C.x,L.y-C.y),M3=(L,C)=>({x:(L.x+C.x)/2,y:(L.y+C.y)/2}),t3=(L,C)=>Math.atan2(C.y-L.y,C.x-L.x),s0=L=>{let C=L;for(;C>Math.PI;)C-=Math.PI*2;for(;C<-Math.PI;)C+=Math.PI*2;return C},M1=(L,C,H)=>Math.max(C,Math.min(H,L)),w2=L=>L.map(C=>({...C})),v1=L=>L instanceof Element&&!!L.closest("button, input, select, textarea, a, [role='button'], [role='menuitem']"),Q1=class{#C;#H;#e;#M=new Map;#V=!1;#L="idle";#t=[];#a=[];#A=null;#o=0;#s=null;#m=0;#S=null;#n=null;#h=null;#p=0;#i=null;#c=!1;#u=null;#Z=!1;constructor(C,H,V){this.#C=C,this.#H=H,this.#e=V,C.addEventListener("pointerdown",this.#r),C.addEventListener("pointermove",this.#d),C.addEventListener("pointerup",this.#v),C.addEventListener("pointercancel",this.#v),C.addEventListener("wheel",this.#w,{passive:!1}),C.addEventListener("gesturestart",this.#g,{passive:!1}),C.addEventListener("gesturechange",this.#y,{passive:!1}),C.addEventListener("gestureend",this.#b,{passive:!1}),C.addEventListener("dblclick",this.#B),C.addEventListener("contextmenu",this.#O),C.addEventListener("keydown",this.#f),C.addEventListener("keyup",this.#P),C.addEventListener("blur",this.#k)}#r=C=>{if(this.#Z||!C.isPrimary&&C.pointerType==="mouse"||v1(C.target))return;this.#C.focus({preventScroll:!0}),this.#T();let H=performance.now(),V={id:C.pointerId,type:C.pointerType,startX:C.clientX,startY:C.clientY,x:C.clientX,y:C.clientY,lastX:C.clientX,lastY:C.clientY,lastTime:H,velocityX:0,velocityY:0};if(this.#M.set(C.pointerId,V),this.#C.setPointerCapture?.(C.pointerId),this.#M.size>=2){this.#_(),(this.#L==="paint"||this.#L==="erase")&&(this.#a=w2(this.#t),this.#e.onCircles(this.#a,!1)),this.#L="pinch",this.#C.classList.add("navigating"),this.#c=!0;let[t,i]=[...this.#M.values()];t&&i&&(this.#o=Math.max(1,r3(t,i)),this.#s=M3(t,i),this.#m=t3(t,i),this.#S=this.#H.camera),C.preventDefault();return}let e=this.#e.state(),r=e.workflow==="draw"&&e.map.available&&!e.floor.readOnly;this.#c||this.#V||C.button===1||C.button===2||e.draw.tool==="pan"?(this.#L="pan",this.#n=this.#H.camera):r&&(e.draw.tool==="paint"||e.draw.tool==="erase")?(this.#t=w2(e.draw.circles),this.#a=w2(e.draw.circles),C.pointerType==="touch"?(this.#L="idle",this.#u=window.setTimeout(()=>{if(this.#u=null,this.#M.size!==1||this.#c)return;this.#L=e.draw.tool;let t=this.#M.get(C.pointerId);t&&this.#l(t.x,t.y)},110)):(this.#L=e.draw.tool,this.#l(C.clientX,C.clientY))):(this.#L=e.view==="three"&&!C.shiftKey?"orbit":"pan",this.#n=this.#H.camera),(this.#L==="pan"||this.#L==="orbit")&&this.#C.classList.add("navigating"),C.preventDefault()};#d=C=>{let H=this.#M.get(C.pointerId);if(!H){let a=this.#H.screenToMap(C.clientX,C.clientY);this.#H.setCursor(a);return}let e=(C.getCoalescedEvents?.()||[]).at(-1)||C,r=performance.now(),M=Math.max(1,r-H.lastTime),t=(e.clientX-H.lastX)/M,i=(e.clientY-H.lastY)/M;if(H.velocityX=H.velocityX*.62+t*.38,H.velocityY=H.velocityY*.62+i*.38,H.lastX=e.clientX,H.lastY=e.clientY,H.lastTime=r,H.x=e.clientX,H.y=e.clientY,this.#L==="pinch"&&this.#M.size>=2){let[a,A]=[...this.#M.values()];if(!a||!A)return;let n=Math.max(1,r3(a,A)),l=M3(a,A),v=t3(a,A),u=this.#S;if(u&&this.#s){let x={...u,distance:u.distance*this.#o/n,yaw:u.yaw+s0(v-this.#m),pitch:u.orthographic?u.pitch:u.pitch-(l.y-this.#s.y)*.0035};this.#H.setCamera(this.#H.cameraAfterPan(x,l.x-this.#s.x,l.y-this.#s.y))}C.preventDefault();return}this.#L==="paint"||this.#L==="erase"?this.#l(C.clientX,C.clientY):this.#L==="pan"?this.#n&&this.#H.setCamera(this.#H.cameraAfterPan(this.#n,e.clientX-H.startX,e.clientY-H.startY)):this.#L==="orbit"&&this.#n&&this.#H.setCamera({...this.#n,yaw:this.#n.yaw+(e.clientX-H.startX)*.0045,pitch:this.#n.pitch-(e.clientY-H.startY)*.004});let o=this.#H.screenToMap(e.clientX,e.clientY);this.#H.setCursor(o),C.preventDefault()};#v=C=>{let H=this.#M.get(C.pointerId);if(!H)return;let V=this.#L;if(this.#M.delete(C.pointerId),this.#C.releasePointerCapture?.(C.pointerId),this.#_(),(this.#L==="paint"||this.#L==="erase")&&JSON.stringify(this.#a)!==JSON.stringify(this.#t))this.#e.onCircles(this.#a,!0,this.#t);else if(this.#L!=="pinch"&&!this.#c&&Math.hypot(H.x-H.startX,H.y-H.startY)<7&&this.#e.state().workflow==="rooms"){let e=this.#H.roomAt(H.x,H.y);e&&this.#e.onRoom(e)}if(this.#M.size===0)this.#L="idle",this.#C.classList.remove("navigating"),this.#c=!1,this.#s=null,this.#S=null,this.#n=null,this.#A=null,(V==="pan"||V==="orbit")&&H.type!=="mouse"&&this.#R(H.velocityX,H.velocityY,V);else if(this.#L==="pinch"){this.#L="pan",this.#c=!0;let e=this.#M.values().next().value;e&&(e.startX=e.x,e.startY=e.y,e.velocityX=0,e.velocityY=0),this.#n=this.#H.camera,this.#S=null}C.preventDefault()};#l(C,H){let V=this.#H.screenToMap(C,H);if(!V)return;let r=this.#e.state().draw.brushMeters/2;if(this.#L==="erase")this.#a=this.#a.filter(M=>Math.hypot(M.x-V.x,M.y-V.y)>M.radius+r);else{if(!this.#H.containsMapPoint(V))return;let M=Math.max(.04,r*.55),t=this.#A||V,i=Math.hypot(V.x-t.x,V.y-t.y),o=Math.max(1,Math.ceil(i/M));for(let a=0;a<=o&&this.#a.length<512;a+=1){let A=a/o,n={x:t.x+(V.x-t.x)*A,y:t.y+(V.y-t.y)*A};this.#a.some(l=>Math.hypot(l.x-n.x,l.y-n.y)<Math.max(.025,r*.28))||this.#a.push({x:Math.round(n.x*1e4)/1e4,y:Math.round(n.y*1e4)/1e4,radius:Math.round(r*100)/100})}}this.#A=V,this.#e.onCircles(this.#a,!1)}#w=C=>{if(v1(C.target))return;C.preventDefault(),this.#C.focus({preventScroll:!0}),this.#T();let H=C.deltaMode===WheelEvent.DOM_DELTA_LINE?16:C.deltaMode===WheelEvent.DOM_DELTA_PAGE?Math.max(1,this.#C.clientHeight):1,V=C.deltaX*H,e=C.deltaY*H;if(C.ctrlKey||C.metaKey){this.#H.zoomAt(Math.exp(M1(-e*.008,-.28,.28)),C.clientX,C.clientY);return}if(C.altKey&&this.#e.state().view==="three"){this.#H.orbitBy(0,M1(e,-80,80)*.75);return}if(C.deltaMode!==WheelEvent.DOM_DELTA_PIXEL||Math.abs(V)<.5&&Math.abs(e)>=50){this.#H.zoomAt(Math.exp(M1(-e*.0025,-.28,.28)),C.clientX,C.clientY);return}this.#H.panBy(-M1(V,-80,80),-M1(e,-80,80))};#g=C=>{this.#Z||v1(C.target)||(this.#C.focus({preventScroll:!0}),this.#T(),this.#C.classList.add("navigating"),this.#h=this.#H.camera,this.#p=Number.isFinite(C.rotation)?C.rotation:0,C.preventDefault())};#y=C=>{if(this.#Z||v1(C.target))return;let H=this.#h;if(!H||this.#M.size>=2)return;let V=Number.isFinite(C.scale)&&C.scale>0?Math.max(.1,C.scale):1,e=Number.isFinite(C.rotation)?C.rotation:0;this.#H.setCamera({...H,distance:H.distance/V,yaw:H.yaw+(e-this.#p)*Math.PI/180}),C.preventDefault()};#b=C=>{this.#h=null,this.#p=0,this.#C.classList.remove("navigating"),C.preventDefault()};#f=C=>{if(C.defaultPrevented||C.ctrlKey||C.metaKey||C.altKey)return;if(C.code==="Space"){this.#V=!0,C.preventDefault();return}this.#T();let H=this.#e.state(),V=C.key.toLocaleLowerCase();if(C.key==="+"||C.key==="=")this.#H.zoomAt(1.25);else if(C.key==="-")this.#H.zoomAt(.8);else if(C.key==="0")this.#H.fit();else if(V==="3")this.#x({type:"set-view",view:"three"});else if(V==="t")this.#x({type:"set-view",view:"top"});else if(C.key==="[")this.#H.orbitBy(-40,0);else if(C.key==="]")this.#H.orbitBy(40,0);else if(C.key==="PageUp")this.#H.orbitBy(0,-30);else if(C.key==="PageDown")this.#H.orbitBy(0,30);else if(V==="d"&&H.workflow==="draw")this.#x({type:"set-draw-tool",tool:"paint"});else if(V==="e"&&H.workflow==="draw")this.#x({type:"set-draw-tool",tool:"erase"});else if(["arrowleft","arrowright","arrowup","arrowdown"].includes(V))if(H.view==="three"&&!C.shiftKey){let e=V==="arrowleft"?-24:V==="arrowright"?24:0,r=V==="arrowup"?-20:V==="arrowdown"?20:0;this.#H.orbitBy(e,r)}else{let e=V==="arrowleft"?30:V==="arrowright"?-30:0,r=V==="arrowup"?30:V==="arrowdown"?-30:0;this.#H.panBy(e,r)}else if(H.workflow!=="draw"&&["w","a","s","d"].includes(V))this.#H.panBy(V==="a"?34:V==="d"?-34:0,V==="w"?34:V==="s"?-34:0);else if(H.workflow!=="draw"&&(V==="q"||V==="e"))this.#H.orbitBy(V==="q"?-30:30,0);else return;C.preventDefault()};#P=C=>{C.code==="Space"&&(this.#V=!1)};#k=()=>{this.#V=!1,this.#_(),this.#H.setCursor(null),this.#C.classList.remove("navigating")};#B=C=>{v1(C.target)||(this.#T(),this.#H.zoomAt(C.shiftKey?1/1.6:1.6,C.clientX,C.clientY),C.preventDefault())};#O=C=>{v1(C.target)||C.preventDefault()};#x(C){this.#C.dispatchEvent(new CustomEvent("matic-workspace-intent",{detail:C,bubbles:!0,composed:!0}))}#R(C,H,V){if(window.matchMedia("(prefers-reduced-motion: reduce)").matches)return;let e=M1(C,-.55,.55),r=M1(H,-.55,.55);if(Math.hypot(e,r)<.02)return;let M=performance.now(),t=i=>{let o=Math.min(32,i-M);M=i,V==="orbit"?this.#H.orbitBy(e*o,r*o):this.#H.panBy(e*o,r*o);let a=.9**(o/16);e*=a,r*=a,Math.hypot(e,r)>=.01?this.#i=window.requestAnimationFrame(t):this.#i=null};this.#i=window.requestAnimationFrame(t)}#T(){this.#i!==null&&window.cancelAnimationFrame(this.#i),this.#i=null}#_(){this.#u!==null&&window.clearTimeout(this.#u),this.#u=null}dispose(){this.#Z||(this.#Z=!0,this.#_(),this.#T(),this.#C.removeEventListener("pointerdown",this.#r),this.#C.removeEventListener("pointermove",this.#d),this.#C.removeEventListener("pointerup",this.#v),this.#C.removeEventListener("pointercancel",this.#v),this.#C.removeEventListener("wheel",this.#w),this.#C.removeEventListener("gesturestart",this.#g),this.#C.removeEventListener("gesturechange",this.#y),this.#C.removeEventListener("gestureend",this.#b),this.#C.removeEventListener("dblclick",this.#B),this.#C.removeEventListener("contextmenu",this.#O),this.#C.removeEventListener("keydown",this.#f),this.#C.removeEventListener("keyup",this.#P),this.#C.removeEventListener("blur",this.#k),this.#M.clear())}};var P=(L,C,H)=>Math.max(C,Math.min(H,L)),P1=L=>{let C=L;for(;C>Math.PI;)C-=Math.PI*2;for(;C<-Math.PI;)C+=Math.PI*2;return C},p0=L=>{switch(L){case"efficient":return .35;case"balanced":return .65;case"maximum":case"auto":return 1}},o3=Math.PI/3.15,m0=1.08,v0=(L,C)=>{let H=o3/2,V=Math.atan(Math.tan(H)*Math.max(.2,C));return L/Math.sin(Math.min(H,V))*m0},c0=(L,C)=>{let H=new Float32Array(16);for(let V=0;V<4;V+=1)for(let e=0;e<4;e+=1){let r=0;for(let M=0;M<4;M+=1)r+=(L[M*4+e]??0)*(C[V*4+M]??0);H[V*4+e]=r}return H},x0=(L,C,H,V)=>{let e=1/Math.tan(L/2),r=new Float32Array(16);return r[0]=e/C,r[5]=e,r[10]=(V+H)/(H-V),r[11]=-1,r[14]=2*V*H/(H-V),r},u0=(L,C,H,V,e,r)=>{let M=new Float32Array(16);return M[0]=2/(C-L),M[5]=2/(V-H),M[10]=-2/(r-e),M[12]=-(C+L)/(C-L),M[13]=-(V+H)/(V-H),M[14]=-(r+e)/(r-e),M[15]=1,M},Z0=(L,C)=>{let H=Math.hypot((L[0]??0)-(C[0]??0),(L[1]??0)-(C[1]??0),(L[2]??0)-(C[2]??0))||1,V=[((L[0]??0)-(C[0]??0))/H,((L[1]??0)-(C[1]??0))/H,((L[2]??0)-(C[2]??0))/H],e=Math.hypot(V[2]??0,V[0]??0)||1,r=[(V[2]??0)/e,0,-(V[0]??0)/e],M=[(V[1]??0)*(r[2]??0),(V[2]??0)*(r[0]??0)-(V[0]??0)*(r[2]??0),-(V[1]??0)*(r[0]??0)];return new Float32Array([r[0]??0,M[0]??0,V[0]??0,0,r[1]??0,M[1]??0,V[1]??0,0,r[2]??0,M[2]??0,V[2]??0,0,-((r[0]??0)*(L[0]??0)+(r[1]??0)*(L[1]??0)+(r[2]??0)*(L[2]??0)),-((M[0]??0)*(L[0]??0)+(M[1]??0)*(L[1]??0)+(M[2]??0)*(L[2]??0)),-((V[0]??0)*(L[0]??0)+(V[1]??0)*(L[1]??0)+(V[2]??0)*(L[2]??0)),1])},i3=(L,C,H)=>{let V=!1,e=H.at(-1);if(!e)return!1;for(let r of H){let[M,t]=r,[i,o]=e;t>C!=o>C&&L<(i-M)*(C-t)/(o-t)+M&&(V=!V),e=r}return V},q1=class{#C;#H;#e;#M=null;#V=null;#L=null;#t=null;#a=null;#A=null;#o=null;#s=null;#m=null;#S=null;#n=null;#h=null;#p=null;#i=null;#c=null;#u=null;#Z;#r={yaw:-Math.PI/4,pitch:.82,distance:12,targetX:0,targetZ:0,orthographic:!1};#d=12;#v=8;#l=4;#w=new Float32Array(16);#g=null;#y="unavailable";#b=0;#f=0;#P=0;#k=0;#B=1;#O={width:1,height:1,left:0,top:0};#x=!0;#R=!1;constructor(C,H,V={}){this.#C=C,this.#H=H,this.#e=V,this.#V=H.getContext("2d",{alpha:!0}),this.#C.addEventListener("webglcontextlost",this.#K),this.#C.addEventListener("webglcontextrestored",this.#X),this.#N(),this.#Z=new ResizeObserver(()=>{let e=this.#d,r=this.#v;this.#z(),this.#x&&(e!==this.#d||r!==this.#v)?this.fit(!1):this.requestRender()}),this.#Z.observe(C)}get camera(){return{...this.#r}}#T(){return{minimum:Math.max(.2,this.#l*.04),maximum:this.#l*8}}#_(){let C=this.#i?.metadata.span,H=this.#i?.metadata.metersPerCell;return!C||H===void 0?{x:this.#l,z:this.#l}:{x:Math.max(.5,C[0]*H*.55),z:Math.max(.5,C[1]*H*.55)}}setCamera(C,H=!0){let V=this.#T(),e=this.#_();this.#r={yaw:P1(C.yaw),pitch:C.orthographic?Math.PI/2-.018:P(C.pitch,.18,1.38),distance:P(C.distance,V.minimum,V.maximum),targetX:P(C.targetX,-e.x,e.x),targetZ:P(C.targetZ,-e.z,e.z),orthographic:C.orthographic},this.#x=!1,this.requestRender(),H&&this.#D()}cameraAfterPan(C,H,V){let e=this.#F(),r=C.distance*1.75/Math.max(200,e.height),M=Math.cos(C.yaw),t=-Math.sin(C.yaw),i=-Math.sin(C.yaw),o=-Math.cos(C.yaw),a=this.#_();return{...C,targetX:P(C.targetX-H*r*M+V*r*i,-a.x,a.x),targetZ:P(C.targetZ-H*r*t+V*r*o,-a.z,a.z)}}setState(C){if(this.#R)return;let H=this.#p;this.#p=C;let V=C.resources.scene.value;V!==this.#i&&(this.#i=V,this.#J(V)),(!H||H.quality!==C.quality)&&(this.#B=p0(C.quality),this.#k=0);let e=H?.workflow!=="draw"&&C.workflow==="draw",r=H?.workflow==="draw"&&C.workflow!=="draw";if(!H||H.view!==C.view||e||r){let M=C.workflow==="draw"?"top":C.view;this.#r=this.#j(M,C),this.#x=this.#Y(M,C)}C.workflow==="draw"&&H?.draw.zoomPercent!==C.draw.zoomPercent&&(this.#r={...this.#r,orthographic:!0,pitch:Math.PI/2-.018,distance:this.#v*100/C.draw.zoomPercent},this.#x=C.draw.zoomPercent===100&&Math.abs(this.#r.targetX)<.001&&Math.abs(this.#r.targetZ)<.001&&Math.abs(P1(this.#r.yaw))<.001),this.requestRender()}#j(C,H){let V=C==="top",e=V?this.#v:this.#d,r=H.cameras[C];return r?{yaw:r.yaw,pitch:V?Math.PI/2-.018:r.pitch,distance:P(e/P(r.zoom,.01,100),Math.max(.2,this.#l*.04),this.#l*8),targetX:P(r.targetX,-this.#l,this.#l),targetZ:P(r.targetZ,-this.#l,this.#l),orthographic:V}:V?{yaw:0,pitch:Math.PI/2-.018,distance:e,targetX:0,targetZ:0,orthographic:!0}:{yaw:-Math.PI/4,pitch:.82,distance:e,targetX:0,targetZ:0,orthographic:!1}}#Y(C,H){let V=H.cameras[C];if(!V)return!0;let e=C==="top";return Math.abs(V.zoom-1)<.001&&Math.abs(V.targetX)<.001&&Math.abs(V.targetZ)<.001&&Math.abs(P1(V.yaw-(e?0:-Math.PI/4)))<.001&&(e||Math.abs(V.pitch-.82)<.001)}#W(C,H){let V=this.#M;if(!V)throw new Error("webgl-unavailable");let e=V.createShader(C);if(!e)throw new Error("shader-unavailable");if(V.shaderSource(e,H),V.compileShader(e),!V.getShaderParameter(e,V.COMPILE_STATUS))throw V.deleteShader(e),new Error("shader-failed");return e}#N(){try{this.#M=this.#C.getContext("webgl2",{alpha:!0,antialias:!0,depth:!0,powerPreference:"high-performance"});let C=this.#M;if(!C)throw new Error("webgl2-unavailable");let H=this.#W(C.VERTEX_SHADER,`#version 300 es
      ...
      `),e=C.createProgram();if(!e)throw new Error("program-unavailable");if(C.attachShader(e,H),C.attachShader(e,V),C.linkProgram(e),C.deleteShader(H),C.deleteShader(V),!C.getProgramParameter(e,C.LINK_STATUS))throw new Error("program-failed");this.#a=e,this.#s=C.getUniformLocation(e,"uViewProjection"),this.#m=C.getUniformLocation(e,"uCenter"),this.#S=C.getUniformLocation(e,"uMetersPerCell"),this.#n=C.getUniformLocation(e,"uPointPixels"),this.#h=C.getUniformLocation(e,"uMaxPointPixels"),this.#A=C.createBuffer(),this.#o=C.createVertexArray(),C.bindVertexArray(this.#o),C.bindBuffer(C.ARRAY_BUFFER,this.#A),C.enableVertexAttribArray(0),C.vertexAttribIPointer(0,2,C.UNSIGNED_SHORT,8,0),C.enableVertexAttribArray(1),C.vertexAttribIPointer(1,1,C.UNSIGNED_BYTE,8,4),C.enableVertexAttribArray(2),C.vertexAttribPointer(2,3,C.UNSIGNED_BYTE,!0,8,5),C.bindVertexArray(null),C.enable(C.DEPTH_TEST),C.depthFunc(C.LEQUAL),C.enable(C.BLEND),C.blendFunc(C.SRC_ALPHA,C.ONE_MINUS_SRC_ALPHA),this.#y="webgl2",this.#b+=1,this.#i&&this.#U(this.#i)}catch{this.#$(),this.#G()}}#J(C){if(this.#q(),!C){this.#f=0,this.requestRender();return}let[H,V]=C.metadata.span,e=C.metadata.metersPerCell,r=H*e,M=V*e;this.#l=Math.max(1,Math.hypot(r,M)/2),this.#z(),this.fit(!1),this.#y==="webgl2"?this.#U(C):this.#Q(C)}#z(){let C=this.#i;if(!C)return;let[H,V]=C.metadata.span,e=C.metadata.metersPerCell,r=H*e,M=V*e,t=this.#F(),i=Math.max(.2,t.width/Math.max(1,t.height));this.#d=v0(this.#l,i),this.#v=Math.max(M/2,r/(2*i))*1.12}#U(C){let H=this.#M;if(!H||!this.#A)return;let V=new Uint8Array(C.buffer,C.pointOffset,C.total*8);H.bindBuffer(H.ARRAY_BUFFER,this.#A),H.bufferData(H.ARRAY_BUFFER,V,H.STATIC_DRAW),this.#f=C.total}#G(){this.#y="canvas2d",this.#t=document.createElement("canvas"),this.#t.width=1024,this.#t.height=1024,this.#L=this.#t.getContext("2d",{alpha:!0}),this.#L?this.#i&&this.#Q(this.#i):(this.#y="unavailable",this.#e.onProblem?.("renderer-unavailable"))}#Q(C){let H=this.#L;if(!H||!this.#t)return;H.clearRect(0,0,this.#t.width,this.#t.height);let V=new DataView(C.buffer,C.pointOffset,C.total*8),e=Math.min(C.total,5e4),r=Math.max(1,Math.ceil(C.total/e)),M=0,t=0,i=()=>{if(this.#R||C!==this.#i||!this.#t)return;let o=Math.min(C.total,M+r*4e3);for(;M<o;M+=r){let a=M*8,A=V.getUint16(a,!0)/Math.max(1,C.metadata.span[0])*this.#t.width,n=V.getUint16(a+2,!0)/Math.max(1,C.metadata.span[1])*this.#t.height,l=V.getUint8(a+5),v=V.getUint8(a+6),u=V.getUint8(a+7);H.fillStyle=`rgb(${l} ${v} ${u})`,H.fillRect(A,n,1.5,1.5),t+=1}this.#f=t,this.requestRender(),M<C.total?this.#u=window.setTimeout(i,0):this.#u=null};i()}#q(){this.#u!==null&&window.clearTimeout(this.#u),this.#u=null}#F(){let C=this.#C.getBoundingClientRect();return this.#O={width:C.width,height:C.height,left:C.left,top:C.top},this.#O}#C1(){let C=this.#F(),H=Math.min(window.devicePixelRatio||1,3),V=Math.max(1,Math.round(C.width*H)),e=Math.max(1,Math.round(C.height*H));for(let r of[this.#C,this.#H])(r.width!==V||r.height!==e)&&(r.width=V,r.height=e)}#H1(){let C=this.#O,H=Math.max(.2,C.width/Math.max(1,C.height)),V=Math.cos(this.#r.pitch)*this.#r.distance,e=[this.#r.targetX+Math.sin(this.#r.yaw)*V,Math.sin(this.#r.pitch)*this.#r.distance,this.#r.targetZ+Math.cos(this.#r.yaw)*V],r=[this.#r.targetX,0,this.#r.targetZ],M=Z0(e,r),t=this.#r.orthographic?u0(-this.#r.distance*H,this.#r.distance*H,-this.#r.distance,this.#r.distance,-this.#l*4,this.#l*4):x0(o3,H,.02,Math.max(60,this.#l*12));return c0(t,M)}requestRender(){this.#c!==null||this.#R||(this.#c=window.requestAnimationFrame(()=>{this.#c=null,this.#V1()}))}#V1(){let C=performance.now();this.#C1(),this.#w=this.#H1(),this.#y==="webgl2"?this.#L1():this.#e1(),this.#M1(),this.#P=performance.now()-C,this.#P>18?(this.#k+=1,this.#k>=3&&this.#p?.quality==="auto"&&(this.#B=Math.max(.25,this.#B*.75))):this.#k=Math.max(0,this.#k-1)}#L1(){let C=this.#M,H=this.#i;if(!C||(C.viewport(0,0,this.#C.width,this.#C.height),C.clearColor(0,0,0,0),C.clear(C.COLOR_BUFFER_BIT|C.DEPTH_BUFFER_BIT),!H||!this.#a||!this.#o))return;if(this.#p?.view==="top"&&this.#p.appearance==="rooms"){this.#f=0;return}C.useProgram(this.#a),C.bindVertexArray(this.#o),C.uniformMatrix4fv(this.#s,!1,this.#w),C.uniform2f(this.#m,(H.metadata.span[0]-1)/2,(H.metadata.span[1]-1)/2),C.uniform1f(this.#S,H.metadata.metersPerCell);let V=Math.min(window.devicePixelRatio||1,3),e=Math.max(1,Math.floor(H.total*this.#B)),r=Math.min(H.floorCount,e),M=Math.min(H.surfaceCount,Math.max(0,e-r));C.uniform1f(this.#n,this.#C.height*.038),C.uniform1f(this.#h,4.5*V),C.drawArrays(C.POINTS,0,r),C.uniform1f(this.#n,this.#C.height*.05),C.uniform1f(this.#h,7*V),C.drawArrays(C.POINTS,H.floorCount,M),C.bindVertexArray(null),this.#f=r+M}#e1(){}#r1(C,H,V=0){let e=this.#i;return e?[-(C-(e.metadata.span[0]-1)/2)*e.metadata.metersPerCell,V*e.metadata.metersPerCell,(H-(e.metadata.span[1]-1)/2)*e.metadata.metersPerCell]:null}#I(C,H,V=0,e=!0){let r=this.#r1(C,H,V);if(!r)return null;let[M,t,i]=r,o=this.#w,a=(o[0]??0)*M+(o[4]??0)*t+(o[8]??0)*i+(o[12]??0),A=(o[1]??0)*M+(o[5]??0)*t+(o[9]??0)*i+(o[13]??0),n=(o[3]??0)*M+(o[7]??0)*t+(o[11]??0)*i+(o[15]??0);if(n<=.001)return null;let l=a/n,v=A/n;if(!Number.isFinite(l)||!Number.isFinite(v)||e&&(Math.abs(l)>1.15||Math.abs(v)>1.15))return null;let u=this.#O;return{x:(l*.5+.5)*u.width,y:(-v*.5+.5)*u.height}}#E(C,H,V=0){let e=this.#i;if(!e)return null;let r=C/e.metadata.metersPerCell-e.metadata.origin[0],M=H/e.metadata.metersPerCell-e.metadata.origin[1];return this.#I(r,M,V)}#M1(){let C=this.#V,H=this.#i,V=this.#p;if(!C)return;let e=Math.min(window.devicePixelRatio||1,3),r=this.#O;if(C.setTransform(e,0,0,e,0,0),C.clearRect(0,0,r.width,r.height),!H||!V)return;if(this.#y==="canvas2d"&&this.#t&&!(V.view==="top"&&V.appearance==="rooms")){let o=this.#v/this.#r.distance,a=r.width*o,A=r.height*o,n=(r.width-a)/2-this.#r.targetX*32*o,l=(r.height-A)/2-this.#r.targetZ*32*o;C.drawImage(this.#t,n,l,a,A)}let M=this.#t1(V);if(V.labelsVisible||V.view==="top"&&V.appearance==="rooms"){C.lineWidth=1.5,C.font="600 12px system-ui, sans-serif",C.textAlign="center",C.textBaseline="middle";let o=[];for(let a of H.metadata.rooms){let A=M.has(a.name.toLocaleLowerCase());C.strokeStyle=A?"#0678ce":"rgba(75, 92, 105, .7)",C.fillStyle=A?"rgba(6, 120, 206, .26)":V.view==="top"&&V.appearance==="rooms"?"rgba(231, 238, 242, .94)":"rgba(255, 255, 255, .04)",C.beginPath();let n=Math.max(1,Math.ceil(a.boundary.length/512)),l=!1;for(let m=0;m<a.boundary.length;m+=n){let b=a.boundary[m];if(!b)continue;let Z=this.#I(b[0],b[1],.2,!1);Z&&(l?C.lineTo(Z.x,Z.y):C.moveTo(Z.x,Z.y),l=!0)}if(l&&(C.closePath(),C.fill(),C.stroke()),!V.labelsVisible)continue;let v=this.#I(a.center[0],a.center[1],1);if(!v)continue;let u=C.measureText(a.name).width,x=new DOMRect(v.x-u/2-6,v.y-10,u+12,20);o.some(m=>x.left<m.right+8&&x.right+8>m.left&&x.top<m.bottom+4&&x.bottom+4>m.top)||(o.push(x),C.fillStyle="rgba(250, 252, 253, .88)",C.fillRect(x.x,x.y,x.width,x.height),C.fillStyle="#263238",C.fillText(a.name,v.x,v.y))}}let t=V.draw.circles;if((V.workflow==="draw"||V.workflow==="areaReview")&&t.length){C.fillStyle="rgba(6, 120, 206, .22)",C.strokeStyle="rgba(6, 120, 206, .92)",C.lineWidth=1.5;for(let o of t)this.#i1(C,o)}if(this.#g&&V.workflow==="draw"&&V.draw.tool!=="pan"){let o=this.#E(this.#g.x,this.#g.y),a=this.#E(this.#g.x+V.draw.brushMeters/2,this.#g.y);o&&a&&(C.beginPath(),C.arc(o.x,o.y,Math.max(2,Math.hypot(a.x-o.x,a.y-o.y)),0,Math.PI*2),C.strokeStyle="#0678ce",C.lineWidth=2,C.stroke())}let i=V.resources.pose.value;if(V.map.exactPose&&i?.position&&V.dataMode==="live"){let o=this.#E(i.position[0],i.position[1],3);o&&(C.beginPath(),C.arc(o.x,o.y,7,0,Math.PI*2),C.fillStyle="#0678ce",C.fill(),C.strokeStyle="#fff",C.lineWidth=3,C.stroke())}}#t1(C){let H=C.resources.plans.value?.rooms||C.resources.areas.value?.rooms||[];return new Set(H.filter(V=>C.selection.roomIds.includes(V.roomId)).map(V=>V.name.toLocaleLowerCase()))}#i1(C,H){let V=this.#E(H.x,H.y),e=this.#E(H.x+H.radius,H.y);!V||!e||(C.beginPath(),C.arc(V.x,V.y,Math.max(1,Math.hypot(e.x-V.x,e.y-V.y)),0,Math.PI*2),C.fill(),C.stroke())}setCursor(C){this.#g=C,this.requestRender()}screenToMap(C,H){let V=this.#i;if(!V||!this.#r.orthographic)return null;let e=this.#F();if(!e.width||!e.height)return null;let r=this.#r.distance*2/e.height,M=this.#r.targetX+(C-e.left-e.width/2)*r,t=this.#r.targetZ+(H-e.top-e.height/2)*r,i=-M/V.metadata.metersPerCell+(V.metadata.span[0]-1)/2,o=t/V.metadata.metersPerCell+(V.metadata.span[1]-1)/2;return{x:(i+V.metadata.origin[0])*V.metadata.metersPerCell,y:(o+V.metadata.origin[1])*V.metadata.metersPerCell}}roomAt(C,H){let V=this.screenToMap(C,H),e=this.#i,r=this.#p;if(!V||!e||!r)return null;let M=V.x/e.metadata.metersPerCell-e.metadata.origin[0],t=V.y/e.metadata.metersPerCell-e.metadata.origin[1],i=e.metadata.rooms.find(o=>i3(M,t,o.boundary));return i?this.#o1(i,r):null}containsMapPoint(C){let H=this.#i;if(!H)return!1;let V=C.x/H.metadata.metersPerCell-H.metadata.origin[0],e=C.y/H.metadata.metersPerCell-H.metadata.origin[1];return H.metadata.rooms.some(r=>i3(V,e,r.boundary))}#o1(C,H){return(H.resources.plans.value?.rooms||H.resources.areas.value?.rooms||[]).find(e=>e.name.localeCompare(C.name,void 0,{sensitivity:"base"})===0)?.roomId||C.id}selectRoomAt(C,H){let V=this.roomAt(C,H);V&&this.#e.onRoom?.(V)}fit(C=!0){let H=this.#p?.view==="top"||this.#p?.workflow==="draw";this.#r=H?{yaw:0,pitch:Math.PI/2-.018,distance:this.#v,targetX:0,targetZ:0,orthographic:!0}:{yaw:-Math.PI/4,pitch:.82,distance:this.#d,targetX:0,targetZ:0,orthographic:!1},this.#x=!0,this.requestRender(),C&&this.#D()}zoomAt(C,H,V){let e=H===void 0||V===void 0?null:this.screenToMap(H,V),r=this.#T();if(this.#r={...this.#r,distance:P(this.#r.distance/C,r.minimum,r.maximum)},this.#x=!1,e&&H!==void 0&&V!==void 0){let M=this.screenToMap(H,V);M&&(this.#r={...this.#r,targetX:this.#r.targetX-(e.x-M.x),targetZ:this.#r.targetZ+(e.y-M.y)})}this.requestRender(),this.#D(H,V)}panBy(C,H){this.setCamera(this.cameraAfterPan(this.#r,C,H))}orbitBy(C,H){if(this.#r.orthographic){this.panBy(C,H);return}this.#r={...this.#r,yaw:P1(this.#r.yaw+C*.006),pitch:P(this.#r.pitch-H*.004,.18,1.38)},this.#x=!1,this.requestRender(),this.#D()}rotateBy(C){this.#r={...this.#r,yaw:P1(this.#r.yaw+C)},this.#x=!1,this.requestRender(),this.#D()}#D(C,H){let V=this.#r.orthographic?this.#v:this.#d,e=C===void 0||H===void 0?this.#O:this.#F(),r=C===void 0||H===void 0||!e.width||!e.height?void 0:{xPercent:P((C-e.left)/e.width*100,0,100),yPercent:P((H-e.top)/e.height*100,0,100)};this.#e.onCamera?.(this.camera,Math.round(V/this.#r.distance*100),r)}diagnostics(){return{mode:this.#y,contextGeneration:this.#b,sceneRevision:this.#i?.revision??null,sourcePoints:this.#i?.total??0,renderedPoints:this.#f,lastFrameMs:Math.round(this.#P*100)/100,slowFrames:this.#k,cameraDistance:this.#r.distance,fitDistance:this.#r.orthographic?this.#v:this.#d,fitActive:this.#x}}#K=C=>{C.preventDefault(),this.#$(),this.#G(),this.requestRender()};#X=()=>{this.#$(),this.#N(),this.requestRender()};#$(){let C=this.#M;C&&(this.#A&&C.deleteBuffer(this.#A),this.#o&&C.deleteVertexArray(this.#o),this.#a&&C.deleteProgram(this.#a)),this.#A=null,this.#o=null,this.#a=null,this.#M=null}dispose(){this.#R||(this.#R=!0,this.#Z.disconnect(),this.#C.removeEventListener("webglcontextlost",this.#K),this.#C.removeEventListener("webglcontextrestored",this.#X),this.#c!==null&&window.cancelAnimationFrame(this.#c),this.#c=null,this.#q(),this.#$(),this.#t=null,this.#L=null,this.#V=null,this.#i=null,this.#p=null)}};var a3="component.matic_robot.common.",B=(L,C,H,V)=>{let e=V?{...V}:void 0,r=L?.(`${a3}${C}`,e);return r&&r!==`${a3}${C}`?r:V?Object.entries(V).reduce((M,[t,i])=>M.replaceAll(`{${t}}`,String(i)),H):H};var t1="matic-workspace-intent",K1="matic-workspace-action",A3=(L,C)=>{let H=(e,r,M)=>B(C,e,r,M);if(!n1(L))return H("v4_private_map_unavailable","The current private map is not available.");if(L.dataMode==="history")return H("v4_saved_map_description","Saved read-only map for {floor}. Live robot position is hidden.",{floor:L.floor.displayName});let V=K2(L)?H("v4_robot_position_verified","The robot position is verified."):H("v4_robot_position_hidden","The robot position is not shown.");return H("v4_live_map_description","Live map for {floor}. {pose}",{floor:L.floor.displayName,pose:V})},k2=class extends f{constructor(){super(...arguments);this.state=O();this.#C=null;this.#H=null;this.#e=null;this.#M=!1}static{this.properties={state:{attribute:!1},localize:{attribute:!1}}}static{this.styles=[F,E,m1,h`
    :host {
      display: block;
      min-width: 0;
      min-height: 0;
  ...
  `]}#C;#H;#e;#M;#V(H,V,e){return B(this.localize,H,V,e)}firstUpdated(){let H=this.renderRoot.querySelector(".map-root"),V=this.renderRoot.querySelector(".scene-canvas"),e=this.renderRoot.querySelector(".overlay-canvas");!H||!V||!e||(this.#H=new q1(V,e,{onCamera:(r,M,t)=>{this.#L({type:"set-camera",view:this.state.workflow==="draw"?"top":this.state.view,camera:{yaw:r.yaw,pitch:r.pitch,zoom:M/100,targetX:r.targetX,targetZ:r.targetZ}}),this.state.workflow==="draw"&&M!==this.state.draw.zoomPercent&&this.#L({type:"set-zoom",value:M,...t?{originX:t.xPercent,originY:t.yPercent}:{}})},onRoom:r=>this.#L({type:"toggle-room",roomId:r}),onProblem:()=>this.#t("renderer-problem")}),this.#e=new Q1(H,this.#H,{state:()=>this.state,onCircles:(r,M,t)=>this.#L({type:"set-draft-circles",circles:r,record:M,...t?{previous:t}:{}}),onRoom:r=>this.#L({type:"toggle-room",roomId:r})}),this.#H.setState(this.state))}disconnectedCallback(){this.#e?.dispose(),this.#e=null,this.#H?.dispose(),this.#H=null,super.disconnectedCallback()}updated(H){if(!H.has("state"))return;H.get("state")?.fullMap&&!this.state.fullMap&&this.#C&&this.#C.focus(),this.#H?.setState(this.state)}#L(H){this.dispatchEvent(new CustomEvent(t1,{detail:H,bubbles:!0,composed:!0}))}#t(H){this.dispatchEvent(new CustomEvent(K1,{detail:{id:H},bubbles:!0,composed:!0}))}#a(H){this.#C=H.currentTarget,this.#L({type:this.state.fullMap?"exit-full-map":"enter-full-map"})}#A(H,V){this.#H?.orbitBy(H,V)}#o(H){if(!(H.ctrlKey||H.metaKey||H.altKey)&&H.key==="Escape"){if(H.preventDefault(),this.#M){this.#M=!1,this.requestUpdate();return}this.#L({type:"dismiss-top-layer"});return}}rendererDiagnostics(){return this.#H?.diagnostics()??null}canvasIdentity(){return{scene:this.renderRoot.querySelector(".scene-canvas"),overlay:this.renderRoot.querySelector(".overlay-canvas")}}#s(){return this.state.host.connected?this.state.host.administrator?this.state.host.robotCount===0?{title:this.#V("v4_no_robot","No Matic robot set up"),detail:this.#V("v4_no_robot_detail","Set up a robot before opening its map.")}:this.state.host.robotConnected?this.state.coherence==="verifying"||this.state.coherence==="booting"?{title:this.#V("v4_locating_map","Locating the current map"),detail:this.#V("v4_locating_map_detail","Map controls will return after the floor is verified.")}:!this.state.map.available&&this.state.resources.scene.status==="loading"?{title:this.#V("v4_loading_verified_map","Loading the verified map"),detail:this.#V("v4_loading_verified_map_detail","The current floor is verified. The private scene is still preparing.")}:this.state.map.available?this.state.activity==="problem"?{title:this.#V("v4_robot_attention","Robot needs attention"),detail:this.#V("v4_robot_attention_detail","Check the robot before starting another task.")}:null:{title:this.#V("v4_map_unavailable","Map unavailable"),detail:this.#V("v4_map_unavailable_detail","The private scene is not ready. No map data is shown until it is verified.")}:{title:this.#V("v4_robot_offline","Robot offline"),detail:this.#V("v4_robot_offline_detail","The last verified map stays read only and has no live position.")}:{title:this.#V("v4_admin_required","Administrator access required"),detail:this.#V("v4_private_map_hidden","Private map data is hidden.")}:{title:this.#V("v4_reconnecting","Reconnecting"),detail:this.#V("v4_reconnecting_detail","The verified map is read only until Home Assistant reconnects.")}}render(){let H=this.state,V=Y2(H),e=this.#s(),r=H.map.available&&(n1(H)||H.dataMode==="history"),M=H.workflow==="draw"&&r,t=H.coherence==="verifying"||H.coherence==="booting";return y`
      ...
      >
        ${!t||H.fullMap?y`<nav class="map-tools ms-surface ms-surface--floating ms-segment" aria-label="Map tools">
          ${t?s:y`
            <button class="ms-btn" type="button" @click=${()=>{this.#H?.fit(),this.#L({type:"fit-map"})}}>${w(U5)}<span class="ms-btn__label">${this.#V("map_home_view","Fit")}</span></button>
            <button
              class="labels ms-btn"
              type="button"
              aria-pressed=${String(H.labelsVisible)}
              @click=${()=>this.#L({type:"toggle-labels"})}
            >${w(G5)}<span class="ms-btn__label">${this.#V("map_labels","Labels")}</span></button>
            <button
          ...
          <button
            ...
            @click=${this.#a}
          >${w(H.fullMap?K5:q5)}<span class="ms-btn__label">${H.fullMap?this.#V("v4_close","Close"):this.#V("v4_full_map","Full map")}</span></button>
        </nav>`:s}
        ...
        ${H.view==="three"&&r?y`
          <div class="camera-steps ms-surface ms-surface--floating ms-segment" role="toolbar" aria-label=${this.#V("map_camera_controls","Map camera controls")}>
            <button class="ms-btn ms-btn--icon" type="button" aria-label=${this.#V("map_rotate_left","Rotate left")} aria-keyshortcuts="[" @click=${()=>this.#A(-52,0)}>${w(X5)}</button>
            <button class="ms-btn ms-btn--icon" type="button" aria-label=${this.#V("map_tilt_down","Lower viewing angle")} aria-keyshortcuts="PageDown" @click=${()=>this.#A(0,30)}>${w(z5)}</button>
            <button class="ms-btn ms-btn--icon" type="button" aria-label=${this.#V("map_tilt_up","Raise viewing angle")} aria-keyshortcuts="PageUp" @click=${()=>this.#A(0,-30)}>${w(N5)}</button>
            <button class="ms-btn ms-btn--icon" type="button" aria-label=${this.#V("map_rotate_right","Rotate right")} aria-keyshortcuts="]" @click=${()=>this.#A(52,0)}>${w(j5)}</button>
          </div>
        `:s}
        ...
        ${M?y`
          ...
          <div class="draw-tools ms-surface ms-surface--floating ms-segment" role="toolbar" aria-label="Draw area tools">
            ${["paint","erase","pan"].map(i=>y`
              ...
              >${w(i==="paint"?C3:i==="erase"?H3:V3)}<span class="ms-btn__label">${i==="paint"?this.#V("area_paint","Paint"):i==="erase"?this.#V("area_erase","Erase"):this.#V("move_map","Move map")}</span></button>
            `)}
            <button
              class="ms-btn"
              type="button"
            ...
            >${w(Y5)}<span class="ms-btn__label">${this.#V("undo","Undo")}</span></button>
            <button
              class="ms-btn"
              type="button"
              ?disabled=${H.draw.redo.length===0}
              @click=${()=>this.#L({type:"redo-draft"})}
            >${w(J5)}<span class="ms-btn__label">${this.#V("redo","Redo")}</span></button>
            <button class="ms-btn" type="button" @click=${()=>this.#t("review-area")}>${w(L3)}<span class="ms-btn__label">${this.#V("done_editing","Done editing")}</span></button>
          </div>
        `:s}
...
`]}#C(H,V){return B(this.localize,H,V)}#H(H){this.dispatchEvent(new CustomEvent(t1,{detail:H,bubbles:!0,composed:!0}))}#e(H,V){let e=H.currentTarget.valueAsNumber;Number.isFinite(e)&&this.#H(V==="zoom"?{type:"set-zoom",value:e}:{type:"set-brush",value:e})}render(){let{draw:H}=this.state;return y`
    ...
    `}};customElements.get(e1)||customElements.define(e1,P2);var B2=["vacuum","mop","vacuum_and_mop"],T2=["quick","standard","heavy_duty"],D=L=>L.currentTarget.value,R2=L=>L.currentTarget.checked,n3=N(e1),_2=class extends f{constructor(){super(...arguments);this.state=O();this._copyStatus="idle"}static{this.properties={state:{attribute:!1},localize:{attribute:!1},_copyStatus:{state:!0}}}static{this.styles=[F,E,m1,h`
...
`]}#C;disconnectedCallback(){this.#C!==void 0&&clearTimeout(this.#C),this.#C=void 0,super.disconnectedCallback()}#H(H,V,e){return B(this.localize,H,V,e)}#e(H){return H==="vacuum"?this.#H("vacuum","Vacuum"):H==="mop"?this.#H("mop","Mop"):this.#H("vacuum_and_mop","Vacuum + mop")}#M(H){return H==="quick"?this.#H("quick","Quick"):H==="standard"?this.#H("standard","Optimal"):this.#H("heavy_duty","Heavy Duty")}#V(H){this.dispatchEvent(new CustomEvent(t1,{detail:H,bubbles:!0,composed:!0}))}#L(){return this.state.notice?d`
      <div class="notice" data-tone=${this.state.notice.tone} role=${this.state.notice.tone==="error"?"alert":"status"}>
        ${this.state.notice.text}
      </div>
    `:s}#t(H,V,e){if(H==="loading"||H==="idle")return d`<div class="loading" role="status">${this.#H("map_loading","Loading\u2026")}</div>`;if(H==="error"){let r=this.state.workflow;return d`
        <div class="stack">
    ...
    `)}#A(H,V){return d`
      <div class="split room-settings">
        <label class="field ms-field">${this.#H("v4_cleaning_system","Cleaning system")}
          ...
          >${B2.map(e=>d`<option value=${e} ?selected=${e===V.cleaningMode}>${this.#e(e)}</option>`)}</select>
        </label>
        <label class="field ms-field">${this.#H("cleaning_mode","Cleaning mode")}
          ...
          >${T2.map(e=>d`<option value=${e} ?selected=${e===V.coverageSetting}>${this.#M(e)}</option>`)}</select>
        </label>
      </div>
    `}#o(H){let V=this.state.planDraft.rooms,r=V.find(M=>M.roomId===H)?V.filter(M=>M.roomId!==H):[...V,{roomId:H,cleaningMode:"vacuum",coverageSetting:"standard"}];this.#V({type:"patch-plan-draft",patch:{rooms:r}})}#s(H,V){let e=this.state.planDraft.rooms.map((r,M)=>M===H?{...r,...V}:r);this.#V({type:"patch-plan-draft",patch:{rooms:e}})}#m(H,V){let e=H+V,r=[...this.state.planDraft.rooms];if(e<0||e>=r.length)return;let[M]=r.splice(H,1);M&&(r.splice(e,0,M),this.#V({type:"patch-plan-draft",patch:{rooms:r}}))}#S(){let H=this.state.resources.plans,V=H.value,e=this.state.planDraft,r=e.rooms.map(i=>({room:i,label:V?.rooms.find(o=>o.roomId===i.roomId)?.name||"Room",selected:!0})),M=(V?.rooms||[]).filter(i=>!e.rooms.some(o=>o.roomId===i.roomId)).map(i=>({room:{roomId:i.roomId,cleaningMode:"vacuum",coverageSetting:"standard"},label:i.name,selected:!1})),t=[...r,...M];return this.#t(H.status,H.problem,d`
      <div class="stack">
        ...
        <div class="split">
          ...
          <label class="checkbox"><input type="checkbox" .checked=${e.enabled} @change=${i=>this.#V({type:"patch-plan-draft",patch:{enabled:R2(i)}})}>${this.#H("plan_enabled","Enabled")}</label>
        </div>
        ...
        <div class="list" role="group" aria-labelledby="plan-rooms-heading">
          ${t.map(({room:i,label:o,selected:a})=>{let A=a?e.rooms.findIndex(n=>n.roomId===i.roomId):-1;return d`
              <div class="room plan-room ms-row ms-row--stack" data-selected=${String(a)}>
                <label class="room-choice">
                  ...
                  ${a?d`
                    <span>
                      <button class="icon-button ms-btn ms-btn--icon ms-btn--sm" type="button" aria-label=${this.#H("move_room_up","Move {room} earlier",{room:o})} ?disabled=${A===0} @click=${n=>{n.preventDefault(),this.#m(A,-1)}}>\u2191</button>
                      <button class="icon-button ms-btn ms-btn--icon ms-btn--sm" type="button" aria-label=${this.#H("move_room_down","Move {room} later",{room:o})} ?disabled=${A===e.rooms.length-1} @click=${n=>{n.preventDefault(),this.#m(A,1)}}>\u2193</button>
                    </span>
                  `:s}
                </label>
                ${a?d`
                  <div class="split room-settings">
                    <label class="field ms-field">${this.#H("v4_cleaning_system","Cleaning system")}
                      <select .value=${i.cleaningMode} @change=${n=>this.#s(A,{cleaningMode:D(n)})}>${B2.map(n=>d`<option value=${n} ?selected=${n===i.cleaningMode}>${this.#e(n)}</option>`)}</select>
                    </label>
                    <label class="field ms-field">${this.#H("cleaning_mode","Cleaning mode")}
                      <select .value=${i.coverageSetting} @change=${n=>this.#s(A,{coverageSetting:D(n)})}>${T2.map(n=>d`<option value=${n} ?selected=${n===i.coverageSetting}>${this.#M(n)}</option>`)}</select>
                    </label>
                  </div>
                `:s}
              </div>
        ...
        <div class="plan-options" role="group" aria-labelledby="completion-heading">
          <label class="checkbox"><input type="checkbox" .checked=${e.returnToBase} @change=${i=>this.#V({type:"patch-plan-draft",patch:{returnToBase:R2(i)}})}>${this.#H("plan_return_to_base","Return to the dock when finished")}</label>
          <label class="checkbox"><input type="checkbox" .checked=${e.finishCurrentRoom} @change=${i=>this.#V({type:"patch-plan-draft",patch:{finishCurrentRoom:R2(i)}})}>${this.#H("plan_finish_room","Finish the active room after Stop")}</label>
          ${e.finishCurrentRoom?d`<label class="field ms-field">${this.#H("plan_threshold","Finish threshold")} \u00b7 ${e.finishCurrentRoomThreshold}%<input type="range" min="0" max="100" step="5" .value=${String(e.finishCurrentRoomThreshold)} @input=${i=>this.#V({type:"patch-plan-draft",patch:{finishCurrentRoomThreshold:Number(D(i))}})}></label>`:s}
        </div>
        <div class="toolbar">
          ${e.id?d`
            <button
    ...
    `)}#n(){let H=this.state.resources.areas;return d`
      <div class="stack">
        <${n3} .state=${this.state} .localize=${this.localize}></${n3}>
    ...
    `}#h(){let H=this.state.areaDraft,V=H.canRebind||H.status==="review",e=H.status==="stale"||H.status==="unknown";return d`
      <div class="stack">
        ...
        <div class="split">
          <label class="field ms-field">${this.#H("v4_cleaning_system","Cleaning system")}
            <select .value=${H.cleaningMode} @change=${r=>this.#V({type:"patch-area-draft",patch:{cleaningMode:D(r)}})}>${B2.map(r=>d`<option value=${r} ?selected=${r===H.cleaningMode}>${this.#e(r)}</option>`)}</select>
          </label>
          <label class="field ms-field">${this.#H("cleaning_mode","Cleaning mode")}
            <select .value=${H.coverageSetting} @change=${r=>this.#V({type:"patch-area-draft",patch:{coverageSetting:D(r)}})}>${T2.map(r=>d`<option value=${r} ?selected=${r===H.coverageSetting}>${this.#M(r)}</option>`)}</select>
          </label>
        </div>
...
`),V=typeof navigator>"u"?void 0:navigator.clipboard;if(!V||typeof V.writeText!="function"){this.#u("failed");return}let e;try{e=V.writeText(H)}catch{this.#u("failed");return}e.then(()=>this.#u("copied"),()=>this.#u("failed"))}#r(){let H=this.#c(),V=this._copyStatus==="copied"?this.#H("v4_copied","Copied"):this._copyStatus==="failed"?this.#H("v4_copy_failed","The summary could not be copied. Select the text to copy it by hand."):"";return d`
  ...
  `]}#C(H,V,e){return B(this.localize,H,V,e)}#H;#e;#M;#V;#L;#t;#a;#A;connectedCallback(){super.connectedCallback(),this.#H=new ResizeObserver(([H])=>{if(!H)return;let V=H.contentRect.width<768||H.contentRect.height<480;V!==this._measuredNarrow&&(this._measuredNarrow=V)}),this.#H.observe(this),window.addEventListener("pointerdown",this.#A,!0),document.addEventListener("fullscreenchange",this.#a),this.#e=new ResizeObserver(([H])=>{if(!H)return;let V=Math.ceil(H.target.getBoundingClientRect().height);V!==this._sheetOffset&&(this._sheetOffset=V)})}disconnectedCallback(){this.#H?.disconnect(),this.#H=null,this.#e?.disconnect(),this.#e=null,this.#M=null,window.removeEventListener("pointerdown",this.#A,!0),document.removeEventListener("fullscreenchange",this.#a),super.disconnectedCallback()}updated(H){let V=this.renderRoot.querySelector(".mobile-sheet");if(V!==this.#M&&(this.#e?.disconnect(),this.#M=V,V&&this.#e?.observe(V)),H.has("state")){let e=H.get("state");if(e?.precisionOpen&&!this.state.precisionOpen&&this.#V?.focus(),!e?.dialog&&this.state.dialog){let r=g0(this.shadowRoot||document);r?.hasAttribute("data-dialog-launcher")&&(this.#L=r),this.updateComplete.then(()=>{this.renderRoot.querySelector(".dialog button")?.focus()})}else if(e?.dialog&&!this.state.dialog){let r=this.#L?.isConnected&&this.#L.hasAttribute("data-dialog-launcher")?this.#L:this.#w(e.dialog);this.#L=null,this.updateComplete.then(()=>{requestAnimationFrame(()=>r?.focus({preventScroll:!0}))})}(!e||e.workflow!==this.state.workflow)&&(this._sheetDetent="half")}}#o(H){this.dispatchEvent(new CustomEvent(t1,{detail:H,bubbles:!0,composed:!0}))}#s(H){if(H.enabled){if(H.id==="return-live"){this.#o({type:"set-history",historyId:null});return}this.#p(H.id)}}#m(H){if(this.state.workflow==="draw"&&this.state.draw.dirty&&H!=="draw"&&H!=="areaReview"){this.#t=H,this.#o({type:"open-dialog",dialog:"discardDraft"});return}this.#o({type:"open-workflow",workflow:H})}#S(){let H=this.#t;this.#t=null,this.#o({type:"discard-draft"}),H&&queueMicrotask(()=>this.#o({type:"open-workflow",workflow:H}))}#n(){this.#t=null,this.#h()}#h(){let H=this.state.dialog,V=H&&this.#L?.isConnected&&this.#L.hasAttribute("data-dialog-launcher")?this.#L:H?this.#w(H):null;this.#o({type:"dismiss-top-layer"}),V&&requestAnimationFrame(()=>V.focus({preventScroll:!0}))}#p(H){this.dispatchEvent(new CustomEvent(K1,{detail:{id:H},bubbles:!0,composed:!0}))}#i(H){this.#o({type:"dismiss-top-layer"}),this.#p(H)}#c(H){if(H.action==="discard"){this.#S();return}if(H.action==="delete-plan"||H.action==="delete-area"){this.#i(H.action);return}this.#o({type:"dismiss-top-layer"}),H.action==="stop"&&this.#p("stop")}#u(){this._sheetDetent=this._sheetDetent==="peek"?"half":this._sheetDetent==="half"?"full":"peek"}#Z(){if(this.state.precisionOpen||this.state.fullMap){this.#o({type:"dismiss-top-layer"});return}if(this.state.workflow!=="none"){this.#m("none");return}this.#r()}#r(){this.dispatchEvent(new CustomEvent("hass-toggle-menu",{bubbles:!0,composed:!0}))}#d(H){if(this._overflowOpen=!1,H==="support"){this.#m("support");return}if(H==="fullscreen"){let V=this.renderRoot.querySelector(".app");document.fullscreenElement?document.exitFullscreen():V?.requestFullscreen();return}this.dispatchEvent(new CustomEvent(K1,{detail:{id:"use-classic"},bubbles:!0,composed:!0}))}#v(H){this.#V=H.currentTarget,this.#o({type:"set-precision-open",value:!this.state.precisionOpen})}#l(H){let V=H;if(V.detail?.type!=="open-dialog")return;let e=V.composedPath().find(r=>r instanceof HTMLElement&&r.hasAttribute("data-dialog-launcher"));e instanceof HTMLElement&&(this.#L=e)}#w(H){return this.renderRoot.querySelector(p1)?.shadowRoot?.querySelector(`[data-dialog-launcher="${H}"]`)??null}#g(H){if(!(H.defaultPrevented||H.ctrlKey||H.metaKey||H.altKey)&&H.key==="Escape"){if(H.preventDefault(),this._overflowOpen){this._overflowOpen=!1;return}this.#o({type:"dismiss-top-layer"})}}#y(H){if(H.key!=="Tab")return;let V=[...this.renderRoot.querySelectorAll(".dialog button:not(:disabled)")],e=V[0],r=V.at(-1);!e||!r||(H.shiftKey&&this.shadowRoot?.activeElement===e?(H.preventDefault(),r.focus()):!H.shiftKey&&this.shadowRoot?.activeElement===r&&(H.preventDefault(),e.focus()))}#b(H,V="primary-action"){if(H.id==="choose-cleaning")return s;let r={stop:["v4_stop","Stop"],resume:["v4_resume","Resume"],"review-area":["v4_review_details","Review details"],"save-area":["area_save","Save area"],"run-area":["area_run","Clean area"],"save-plan":["plan_save","Save plan"],"run-plan":["plan_run","Run plan"]}[H.id],M=H.id==="clean-rooms"?H.label:r?this.#C(r[0],r[1]):H.label;return d`
      <button
    ...
    ></${s3}>`}render(){let H=this.state,V=H.narrowHint||this._measuredNarrow,e=S0(H,this.localize),r=h0(H,this.localize),M=X2({...H,narrowHint:V}),t=j2(H),i=!V&&M.id==="stop"?M:!V&&t?.id==="stop"?t:null,o=i===M?null:M,a=i===t?null:t,A=H.workflow==="draw"&&(V||H.fullMap),n=H.fullMap&&(H.coherence==="verifying"||H.coherence==="booting"),l=H.fullMap||H.precisionOpen,v=f0(H.dialog,this.localize),u=H.resources.history.value?.floors||[],x=u.length?u.map((m,b)=>({id:m.active?"current":m.id,label:`${m.label||(m.active?this.#C("v4_current_floor","Current floor"):this.#C("v4_saved_floor","Saved floor {number}",{number:m.ordinal??b+1}))}${!m.active&&m.snapshots.length===0?` \xB7 ${this.#C("v4_floor_not_captured","Visit floor to capture")}`:""}`,disabled:!m.active&&m.snapshots.length===0})):[{id:H.selection.floorId,label:H.floor.displayName,disabled:!1}];return d`
        ...
        <div class="app">
          <header class="app-bar">
            <button
              class="nav"
              type="button"
              aria-label=${l?this.#C("v4_back","Back"):this.#C("v4_open_navigation","Open navigation")}
              @click=${this.#Z}
            >${l?"\u2190":"\u2630"}</button>
          ...
          <main class=${`workspace ${H.fullMap?"full-map":""}`}>
            ...
            ${A?d`
              <div class="precision-popover">
                ...
                ${H.precisionOpen?d`
                  <${l3} compact .state=${H} .localize=${this.localize}></${l3}>
                `:s}
              </div>
            `:s}
            ...
            >
              ${V?d`
                ...
                <div class="sheet-body">
                  ...
                  -->
                  ${H.workflow==="draw"?s:this.#f(H)}
                </div>
                <div class="primary-stack">
                  ${o?this.#b(o):s}
                  ${a?this.#b(a,"secondary-action"):s}
                </div>
              `:d`
            ...
            ${H.fullMap?d`
              ...
              >
                ...
                ${n?s:this.#b(M)}
                ${!n&&t?this.#b(t,"secondary-action"):s}
              </section>
            `:s}
          </main>
        </div>
          ...
          <div class="dialog-backdrop">
            ...
            >
              ...
              <div class="dialog-actions">
                <button
                  type="button"
                  @click=${H.dialog==="discardDraft"?this.#n:this.#h}
    ...
    `}};customElements.get(r1)||customElements.define(r1,F2);var p3=N(r1),E2=class extends f{constructor(){super(...arguments);this.scenario="ready";this.narrow=!1;this.controls=!0;this._workspace=d2("ready");this.#C=new A1(this._workspace);this.#H=null}static{this.properties={scenario:{type:String,reflect:!0},narrow:{type:Boolean,reflect:!0},controls:{type:Boolean,reflect:!0},_workspace:{state:!0}}}static{this.styles=[F,E,h`
    :host {
      display: block;
      color: #1f2933;
      background: #e8edef;
  ...
  `]}#C;#H;connectedCallback(){super.connectedCallback(),this.#H=this.#C.subscribe(H=>{this._workspace=H})}disconnectedCallback(){this.#H?.(),this.#H=null,super.disconnectedCallback()}willUpdate(H){H.has("scenario")?this.#C.replace({...d2(this.scenario),narrowHint:this.narrow}):H.has("narrow")&&this.#C.dispatch({type:"set-narrow-hint",value:this.narrow})}setScenario(H){l2.includes(H)&&(this.scenario=H)}getWorkspaceSnapshot(){return structuredClone(this.#C.value)}replaceWorkspaceState(H){this.#C.replace(structuredClone(H))}#e(H){D1(H.detail)&&(H.stopPropagation(),this.#C.dispatch(H.detail))}render(){return d`
      ${this.controls?d`
    ...
    `}};customElements.get("matic-map-studio-gallery-v0-4-0")||customElements.define("matic-map-studio-gallery-v0-4-0",E2);var m3="/api/matic_robot/slam_entries";var p=class extends Error{constructor(C){super(C),this.name="ContractError",this.code=C}},R=(L,C)=>{if(!L||typeof L!="object"||Array.isArray(L))throw new p(C);return L},g=(L,C,H)=>{if(typeof L!="string")throw new p(H);let V=L.trim();if(!V||Array.from(V).length>C||/[\u0000-\u001f\u007f]/u.test(V))throw new p(H);return V},y0=L=>{if(L==null||L==="")return null;try{return g(L,128,"invalid-floor-label")}catch{return null}},c1=(L,C,H,V)=>{if(typeof L!="number"||!Number.isFinite(L)||L<C||L>H)throw new p(V);return L},W=(L,C,H,V)=>{let e=c1(L,C,H,V);if(!Number.isInteger(e))throw new p(V);return e},D2=(L,C)=>L==null?null:W(L,1,C,"invalid-floor-ordinal"),S=(L,C)=>{if(typeof L!="boolean")throw new p(C);return L},b0=(L,C)=>L===null?null:S(L,C),v3=L=>{if(L==null)return null;let C=g(L,64,"invalid-map-session-key");if(!/^[0-9a-f]{64}$/u.test(C))throw new p("invalid-map-session-key");return C},O0=L=>{if(L==null)return null;if(L==="bootstrap_empty"||L==="map_session_unverified"||L==="floor_plan_unavailable"||L==="floor_plan_mismatch")return L;throw new p("invalid-map-block-reason")},w0=L=>{if(L===void 0)return"not_started";if(L==="not_started"||L==="running"||L==="complete"||L==="partial"||L==="failed")return L;throw new p("invalid-bootstrap-state")},K=(L,C)=>{let H=g(L,512,C);if(!H.startsWith("/")||H.startsWith("//")||H.includes("\\"))throw new p(C);return H},k0=L=>{let C=typeof L.map_health=="string"?L.map_health.toLowerCase():"",H=typeof L.stream_state=="string"?L.stream_state.toLowerCase():"",V=typeof L.invalid_tiles=="number"?L.invalid_tiles:0;return C.includes("error")||C.includes("fail")||C.includes("degrad")||V>0?"problem":L.map_truncated===!0||C.includes("truncat")||C.includes("limit")?"limited":L.map_complete===!0?"ready":H.includes("connect")||H.includes("collect")||H.includes("run")?"building":"unknown"},c3=L=>{let C=R(L,"invalid-catalog");if(!Array.isArray(C.entries)||C.entries.length>64)throw new p("invalid-catalog-entries");return C.entries.map(H=>{let V=R(H,"invalid-catalog-entry"),e=W(V.map_revision,0,Number.MAX_SAFE_INTEGER,"invalid-map-revision");return{entryId:g(V.entry_id,128,"invalid-entry-id"),sceneUrl:K(V.scene_url,"invalid-scene-url"),deltaUrl:V.delta_url===void 0||V.delta_url===null?null:K(V.delta_url,"invalid-delta-url"),poseUrl:K(V.pose_url,"invalid-pose-url"),historyUrl:K(V.history_url,"invalid-history-url"),areasUrl:K(V.areas_url,"invalid-areas-url"),plansUrl:K(V.plans_url,"invalid-plans-url"),mapRevision:e,mapFloorCoherent:S(V.map_floor_coherent,"invalid-floor-coherence"),mapSessionVerified:S(V.map_session_verified,"invalid-session-state"),mapSessionKey:v3(V.map_session_key),mapBlockReason:O0(V.map_block_reason),runnerLocked:S(V.runner_locked,"invalid-runner-lock"),stopSettlePending:S(V.stop_settle_pending,"invalid-stop-settle"),activePlan:S(V.active_plan,"invalid-active-plan"),nativeReconciliationPending:S(V.native_reconciliation_pending,"invalid-native-reconciliation"),nativeSessionActive:b0(V.native_session_active,"invalid-native-session"),mapComplete:S(V.map_complete,"invalid-map-complete"),mapTruncated:S(V.map_truncated,"invalid-map-truncated"),selectedFloorOrdinal:D2(V.selected_floor_ordinal,128),mapFloorOrdinal:D2(V.map_floor_ordinal,128),historyCount:W(V.history_count,0,12,"invalid-history-count"),historyFloorCount:W(V.history_floor_count,0,128,"invalid-floor-count"),health:k0(V),streamFailures:W(V.stream_failures,0,Number.MAX_SAFE_INTEGER,"invalid-stream-failures"),bootstrapState:w0(V.bootstrap_state),bootstrapPhotoSeen:V.bootstrap_photo_seen===void 0?!1:S(V.bootstrap_photo_seen,"invalid-bootstrap-photo"),bootstrapStructureSeen:V.bootstrap_structure_seen===void 0?!1:S(V.bootstrap_structure_seen,"invalid-bootstrap-structure"),bootstrapFailures:V.bootstrap_failures===void 0?0:W(V.bootstrap_failures,0,2,"invalid-bootstrap-failures")}})},x3=(L,C)=>{if(!Array.isArray(L)||L.length!==2)throw new p(C);return[c1(L[0],-1e6,1e6,C),c1(L[1],-1e6,1e6,C)]},P0=(L,C)=>{if(!Array.isArray(L)||L.length<3||L.length>8192)throw new p(C);return L.map(H=>x3(H,C))},u3=(L,C)=>{if(!Array.isArray(L)||L.length>256)throw new p("invalid-rooms");return L.map(H=>{let V=R(H,"invalid-room");return{roomId:g(V.room_id,128,"invalid-room-id"),name:g(V.name,128,"invalid-room-name"),boundary:C?P0(V.boundary,"invalid-room-boundary"):[]}})},B0=L=>{let C=R(L,"invalid-history-snapshot"),H=g(C.created_at,64,"invalid-history-time");if(!Number.isFinite(Date.parse(H)))throw new p("invalid-history-time");return{id:g(C.id,128,"invalid-history-id"),createdAt:H,revision:W(C.revision,0,Number.MAX_SAFE_INTEGER,"invalid-history-revision"),pointCount:W(C.point_count,1,15e5,"invalid-history-points"),sceneUrl:K(C.scene_url,"invalid-history-scene-url")}},Z3=L=>{let C=R(L,"invalid-history");if(!Array.isArray(C.floors)||C.floors.length<1||C.floors.length>128)throw new p("invalid-history-floors");return{entryId:g(C.entry_id,128,"invalid-history-entry"),liveAvailable:S(C.live_available,"invalid-history-live"),floors:C.floors.map(H=>{let V=R(H,"invalid-history-floor");if(!Array.isArray(V.snapshots)||V.snapshots.length>12)throw new p("invalid-history-snapshots");return{id:g(V.id,128,"invalid-history-floor-id"),active:S(V.active,"invalid-history-floor-active"),readOnly:S(V.read_only,"invalid-history-floor-read-only"),liveAvailable:V.live_available===void 0?!1:S(V.live_available,"invalid-history-floor-live"),label:y0(V.label),ordinal:V.ordinal===void 0?null:D2(V.ordinal,128),snapshots:V.snapshots.map(B0)}})}},S3=L=>{if(L==="vacuum"||L==="mop"||L==="vacuum_and_mop")return L;throw new p("invalid-cleaning-mode")},h3=L=>{if(L==="quick"||L==="standard"||L==="heavy_duty")return L;throw new p("invalid-coverage-setting")},T0=L=>{let C=R(L,"invalid-area-circle");return{x:c1(C.x,-1e6,1e6,"invalid-area-circle"),y:c1(C.y,-1e6,1e6,"invalid-area-circle"),radius:c1(C.radius,.05,2.5,"invalid-area-circle")}},R0=L=>L==="current"||L==="review"||L==="stale"?L:"unknown",f3=L=>{let C=R(L,"invalid-areas");if(!Array.isArray(C.areas)||C.areas.length>256)throw new p("invalid-area-list");return{sceneUrl:K(C.scene_url,"invalid-area-scene-url"),rooms:u3(C.rooms,!0),areas:C.areas.map(H=>{let V=R(H,"invalid-area");if(!Array.isArray(V.circles)||V.circles.length>512)throw new p("invalid-area-circles");return{id:g(V.id,128,"invalid-area-id"),name:g(V.name,128,"invalid-area-name"),circles:V.circles.map(T0),cleaningMode:S3(V.cleaning_mode),coverageSetting:h3(V.coverage_setting),status:R0(V.status),canRebind:S(V.can_rebind,"invalid-area-rebind")}})}},g3=L=>{let C=R(L,"invalid-plans");if(!Array.isArray(C.plans)||C.plans.length>256)throw new p("invalid-plan-list");return{rooms:u3(C.rooms,!1).map(({roomId:V,name:e})=>({roomId:V,name:e})),selectedPlan:C.selected_plan===null||C.selected_plan===void 0?null:g(C.selected_plan,128,"invalid-selected-plan"),plans:C.plans.map(V=>{let e=R(V,"invalid-plan");if(!Array.isArray(e.rooms)||e.rooms.length>256||!Array.isArray(e.room_order))throw new p("invalid-plan-rooms");let r=e.run_behavior;if(r!=="intelligent"&&r!=="ordered")throw new p("invalid-run-behavior");return{id:g(e.id,128,"invalid-plan-id"),name:g(e.name,128,"invalid-plan-name"),enabled:S(e.enabled,"invalid-plan-enabled"),runBehavior:r,rooms:e.rooms.map(M=>{let t=R(M,"invalid-plan-room");return{roomId:g(t.room_id,128,"invalid-plan-room-id"),cleaningMode:S3(t.cleaning_mode),coverageSetting:h3(t.coverage_setting)}}),roomOrder:e.room_order.slice(0,256).map(M=>g(M,128,"invalid-room-order")),returnToBase:S(e.return_to_base,"invalid-return-to-base"),finishCurrentRoom:S(e.finish_current_room,"invalid-finish-room"),finishCurrentRoomThreshold:W(e.finish_current_room_threshold,0,100,"invalid-finish-threshold")}})}},y3=L=>{let C=R(L,"invalid-pose"),H=C.position,V=H===null?null:x3(H,"invalid-pose-position"),e=C.pose_freshness;if(e!=="live"&&e!=="coordinator_fallback")throw new p("invalid-pose-freshness");return{position:V,source:g(C.source,64,"invalid-pose-source"),revision:W(C.revision,0,Number.MAX_SAFE_INTEGER,"invalid-pose-revision"),poseRevision:W(C.pose_revision,0,Number.MAX_SAFE_INTEGER,"invalid-pose-sequence"),floorCoherent:S(C.map_floor_coherent,"invalid-pose-floor"),mapSessionKey:v3(C.map_session_key),freshness:e}},b3=L=>{try{return K(L,"invalid-private-path"),!0}catch{return!1}};var O3=L=>{let r=()=>{throw new Error("invalid-scene")};(!(L instanceof ArrayBuffer)||L.byteLength<24||L.byteLength>16777216)&&r();let M=new DataView(L),t=new Uint8Array(L,0,8),i=String.fromCharCode(...t),o=M.getUint16(8,!0),a=M.getUint16(10,!0),A=M.getUint32(12,!0),n=M.getUint32(16,!0),l=M.getUint32(20,!0),v=n+l,u=24+A;(i!=="MATIC3D\0"||o!==1||a!==8||A>1024*1024||v<1||v>15e5||u+v*a!==L.byteLength)&&r();let x;try{x=JSON.parse(new TextDecoder("utf-8",{fatal:!0}).decode(new Uint8Array(L,24,A)))}catch{r()}(!x||typeof x!="object"||Array.isArray(x))&&r();let m=x,b=m.meters_per_cell,Z=m.origin_cells,T=m.span_cells;(typeof b!="number"||!Number.isFinite(b)||b<.001||b>.1||!Array.isArray(Z)||Z.length!==2||!Z.every(_=>typeof _=="number"&&Number.isFinite(_))||!Array.isArray(T)||T.length!==2||!T.every(_=>typeof _=="number"&&Number.isFinite(_)&&_>=1&&_<=65536))&&r();let R1=(Array.isArray(m.rooms)?m.rooms.slice(0,128):[]).flatMap((_,U3)=>{if(!_||typeof _!="object"||Array.isArray(_))return[];let Y=_,_1=typeof Y.name=="string"?Y.name.trim():"";if(!_1||Array.from(_1).length>128||/[\u0000-\u001f\u007f]/u.test(_1))return[];if(!Array.isArray(Y.boundary)||Y.boundary.length<3||Y.boundary.length>8192)return[];let Q2=Y.boundary.flatMap(M2=>{if(!Array.isArray(M2)||M2.length!==2)return[];let[t2,i2]=M2;return typeof t2=="number"&&Number.isFinite(t2)&&typeof i2=="number"&&Number.isFinite(i2)?[[t2,i2]]:[]}),L2=Y.center;if(Q2.length<3||!Array.isArray(L2)||L2.length!==2)return[];let[e2,r2]=L2;return typeof e2!="number"||!Number.isFinite(e2)||typeof r2!="number"||!Number.isFinite(r2)?[]:[{id:`scene-room-${U3+1}`,name:_1,boundary:Q2,center:[e2,r2]}]}),z3=typeof m.sample_step=="number"&&Number.isInteger(m.sample_step)?Math.max(1,Math.min(15e5,m.sample_step)):1,U2=Z,G2=T;return{buffer:L,pointOffset:u,floorCount:n,surfaceCount:l,total:v,metadata:{metersPerCell:b,origin:[U2[0],U2[1]],span:[G2[0],G2[1]],sampleStep:z3,rooms:R1}}},D0=L=>{if(L.byteLength>16777216||L.byteLength<24||!1||!1)throw new p("invalid-scene");try{return O3(L)}catch{throw new p("invalid-scene")}},$0=()=>`
  const parseTransfer = ${O3.toString()};
...
`,X1=class{#C=null;#H=null;#e=0;#M=new Map;constructor(){if(!(typeof Worker!="function"||typeof URL?.createObjectURL!="function"))try{this.#H=URL.createObjectURL(new Blob([$0()],{type:"text/javascript"})),this.#C=new Worker(this.#H),this.#C.onmessage=C=>{let H=this.#M.get(C.data.id);H&&(this.#M.delete(C.data.id),C.data.ok&&C.data.parsed?H.resolve(C.data.parsed):H.reject(new p(C.data.problem||"invalid-scene")))},this.#C.onerror=()=>this.#V("scene-worker-failed")}catch{this.#C=null,this.#H&&URL.revokeObjectURL(this.#H),this.#H=null}}async parse(C,H){if(H?.aborted)throw new DOMException("Aborted","AbortError");if(!this.#C){if(await new Promise(e=>window.setTimeout(e,0)),H?.aborted)throw new DOMException("Aborted","AbortError");return D0(C)}let V=++this.#e;return new Promise((e,r)=>{let M=()=>{this.#M.delete(V),r(new DOMException("Aborted","AbortError"))};H?.addEventListener("abort",M,{once:!0}),this.#M.set(V,{resolve:t=>{H?.removeEventListener("abort",M),e(t)},reject:t=>{H?.removeEventListener("abort",M),r(t)}}),this.#C?.postMessage({id:V,buffer:C},[C])})}#V(C){for(let H of this.#M.values())H.reject(new p(C));this.#M.clear(),this.#C?.terminate(),this.#C=null}dispose(){this.#V("scene-parser-disposed"),this.#H&&URL.revokeObjectURL(this.#H),this.#H=null}};var X={catalog:1e4,scene:6e4,delta:35e3,pose:1e4,history:15e3,workflow:15e3,mutation:2e4},$=class extends Error{constructor(C,H=null){super(C),this.name="BackendError",this.code=C,this.status=H}},B1=36,x1=16*1024*1024,w3=(L,C)=>{let H=Number(L);if(!Number.isSafeInteger(H)||H<0)throw new p(C);return H},k3=(L,C)=>{let H=L.headers.get("X-Matic-Revision");if(H===null)return C;let V=Number(H);if(!Number.isSafeInteger(V)||V<0)throw new p("invalid-scene-revision");return V},P3=(L,C)=>{let H=L.headers.get("X-Matic-Floor-Coherent");if(H===null)return C;if(H==="1")return!0;if(H==="0")return!1;throw new p("invalid-scene-floor-header")},j1=class{#C;#H=new X1;constructor(C){this.#C=C}async#e(C,H,V,e){if(!b3(C))throw new $("invalid-private-path");if(e?.aborted)throw new DOMException("Aborted","AbortError");let r=new AbortController,M=()=>r.abort();e?.addEventListener("abort",M,{once:!0});let t=!1,i=window.setTimeout(()=>{t=!0,r.abort()},V);try{let o=this.#C(),a=new Headers(H.headers),A={...H,cache:"no-store",credentials:"same-origin",headers:Object.fromEntries(a.entries()),signal:r.signal};if(typeof o?.fetchWithAuth=="function")return await o.fetchWithAuth(C,A);let n=o?.auth?.accessToken||o?.auth?.data?.access_token;n&&a.set("Authorization",`Bearer ${n}`);let l=typeof o?.hassUrl=="function"?o.hassUrl(C):C;return await fetch(l,{...A,headers:a})}catch(o){throw t&&!e?.aborted?new $("request-timeout"):r.signal.aborted?new DOMException("Aborted","AbortError"):o}finally{window.clearTimeout(i),e?.removeEventListener("abort",M)}}async#M(C,H,V,e={}){let r=await this.#e(C,{...e,headers:{Accept:"application/json",...e.headers||{}}},H,V);if(!r.ok)throw new $("request-failed",r.status);try{return await r.json()}catch{throw new p("invalid-json-response")}}async catalog(C){return c3(await this.#M(m3,X.catalog,C))}async scene(C,H,V,e,r,M){let t=new Headers({Accept:"application/vnd.matic.slam-scene"});e==="live"&&t.set("X-Matic-Prefer-Cached","1"),M&&t.set("If-None-Match",M);let i=await this.#e(C,{headers:t},X.scene,r),o=k3(i,H),a=P3(i,V);if(i.status===304)return{scene:null,floorCoherent:a,revision:o,notModified:!0};if(!i.ok)throw new $("scene-request-failed",i.status);if(i.headers.get("Content-Type")?.split(";",1)[0]!=="application/vnd.matic.slam-scene")throw new p("invalid-scene-content-type");return{scene:{...await this.#H.parse(await i.arrayBuffer(),r),revision:o,etag:i.headers.get("ETag"),source:e},floorCoherent:a,revision:o,notModified:!1}}async#V(C,H,V){if(!Number.isSafeInteger(H)||H<1||H>x1||typeof DecompressionStream!="function")throw new p("invalid-scene-delta");let r=new Blob([C]).stream().pipeThrough(new DecompressionStream("deflate")).getReader(),M=new Uint8Array(H),t=0,i=()=>{r.cancel()};V?.addEventListener("abort",i,{once:!0});try{for(;;){if(V?.aborted)throw new DOMException("Aborted","AbortError");let{done:o,value:a}=await r.read();if(o)break;if(!(a instanceof Uint8Array)||t+a.byteLength>H)throw new p("invalid-scene-delta");M.set(a,t),t+=a.byteLength}}finally{V?.removeEventListener("abort",i),r.releaseLock()}if(t!==H)throw new p("invalid-scene-delta");return M}async#L(C,H,V){if(C.byteLength<B1||C.byteLength>B1+x1||H.buffer.byteLength>x1)throw new p("invalid-scene-delta");let e=new DataView(C),r=new TextDecoder().decode(new Uint8Array(C,0,8)),M=e.getUint16(8,!0),t=e.getUint16(10,!0),i=w3(e.getBigUint64(12,!0),"invalid-scene-delta"),o=w3(e.getBigUint64(20,!0),"invalid-scene-delta"),a=e.getUint32(28,!0),A=e.getUint32(32,!0);if(r!=="MATICDLT"||M!==1||t!==1||i!==H.revision||o<=H.revision||a<24||a>x1||A>x1||A+B1!==C.byteLength)throw new p("invalid-scene-delta");let n=new Uint8Array(C,B1,A),l=new Uint8Array(H.buffer),u=(await this.#V(n,Math.max(l.byteLength,a),V)).slice(),x=1024*1024;for(let Z=0;Z<l.byteLength;Z+=x){if(V?.aborted)throw new DOMException("Aborted","AbortError");let T=Math.min(l.byteLength,Z+x);for(let k=Z;k<T;k+=1)u[k]=(u[k]??0)^(l[k]??0);T<l.byteLength&&await new Promise(k=>window.setTimeout(k,0))}let m=u.slice(0,a).buffer;return{parsed:{...await this.#H.parse(m,V),revision:o,etag:null,source:"live"},revision:o}}async sceneDelta(C,H,V,e){let r=C.includes("?")?"&":"?",M=await this.#e(`${C}${r}since=${encodeURIComponent(H.revision)}`,{headers:{Accept:"application/vnd.matic.slam-delta, application/vnd.matic.slam-scene"}},X.delta,e),t=k3(M,H.revision),i=P3(M,V);if(M.status===204){if(t!==H.revision)throw new p("invalid-scene-delta-revision");return{scene:null,floorCoherent:i,revision:t,notModified:!0}}if(!M.ok)throw new $("delta-request-failed",M.status);if(t<=H.revision)throw new p("invalid-scene-delta-revision");let o=Number(M.headers.get("Content-Length"));if(Number.isFinite(o)&&o>B1+x1)throw new p("invalid-scene-delta-size");let a=M.headers.get("Content-Type")?.split(";",1)[0],A=await M.arrayBuffer();if(a==="application/vnd.matic.slam-delta"){let l=Number(M.headers.get("X-Matic-Base-Revision"));if(!Number.isSafeInteger(l)||l!==H.revision)throw new p("invalid-scene-delta-base");let v=await this.#L(A,H,e);if(v.revision!==t)throw new p("invalid-scene-delta-revision");return{scene:{...v.parsed,etag:M.headers.get("ETag")},floorCoherent:i,revision:t,notModified:!1}}if(a!=="application/vnd.matic.slam-scene")throw new p("invalid-scene-delta-content-type");return{scene:{...await this.#H.parse(A,e),revision:t,etag:M.headers.get("ETag"),source:"live"},floorCoherent:i,revision:t,notModified:!1}}async pose(C,H){return y3(await this.#M(C,X.pose,H))}async history(C,H){return Z3(await this.#M(C,X.history,H))}async plans(C,H){return g3(await this.#M(C,X.workflow,H))}async areas(C,H){return f3(await this.#M(C,X.workflow,H))}async saveArea(C,H,V){let e=await this.#M(C,X.mutation,V,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({...H.areaId?{area_id:H.areaId}:{},name:H.name,circles:H.circles,cleaning_mode:H.cleaningMode,coverage_setting:H.coverageSetting})});if(!e||typeof e!="object"||typeof e.id!="string")throw new p("invalid-area-save-response");return e.id}async deleteArea(C,H,V){let e=await this.#e(`${C}?area_id=${encodeURIComponent(H)}`,{method:"DELETE",headers:{Accept:"application/json"}},X.mutation,V);if(!e.ok)throw new $("area-delete-failed",e.status)}async service(C,H,V,e){let r=this.#C();if(typeof r?.callService!="function")throw new $("service-unavailable");await r.callService(C,H,V,{entity_id:e})}dispose(){this.#H.dispose()}};var T3=()=>({version:4,view:"top",appearance:"photo",labels:!0,quality:"auto",cameras:{}}),T1=(L,C,H)=>Math.max(C,Math.min(H,L)),R3=L=>L.replaceAll(/[^a-zA-Z0-9_-]/g,"").slice(0,128)||"local-user",I2=(L,C=4)=>`matic-map-studio:v${C}:${R3(L)}`,I0=L=>{if(!L||typeof L!="object")return null;let C=L;return["yaw","pitch","zoom","targetX","targetZ"].every(V=>typeof C[V]=="number"&&Number.isFinite(C[V]))?{yaw:T1(C.yaw,-Math.PI,Math.PI),pitch:T1(C.pitch,.18,Math.PI/2-.018),zoom:T1(C.zoom,.01,100),targetX:T1(C.targetX,-1e4,1e4),targetZ:T1(C.targetZ,-1e4,1e4)}:null},B3=L=>{let C=T3();if(!L||typeof L!="object")return C;let H=L,V=H.view==="three"||H.view==="top"||H.view==="rooms"?H.view:C.view,e=V==="rooms"?"top":V,r=H.quality==="auto"||H.quality==="efficient"||H.quality==="balanced"||H.quality==="maximum"?H.quality:C.quality,M=H.cameras&&typeof H.cameras=="object"?H.cameras:{},t={};for(let i of["three","top"]){let o=I0(M[i]);o&&(t[i]=o)}return{version:4,view:e,appearance:H.appearance==="rooms"||H.appearance==="photo"?H.appearance:C.appearance,labels:typeof H.labels=="boolean"?H.labels:C.labels,quality:r,cameras:t}},Y1=class{#C="local-user";#H=null;load(C){this.#C=R3(C);try{let H=window.localStorage.getItem(I2(this.#C));if(H)return B3(JSON.parse(H));for(let V of[3,2]){let e=window.localStorage.getItem(I2(this.#C,V));if(e)return B3(JSON.parse(e))}}catch{}return T3()}schedule(C){this.#H!==null&&window.clearTimeout(this.#H),this.#H=window.setTimeout(()=>{this.#H=null;try{window.localStorage.setItem(I2(this.#C),JSON.stringify(C))}catch{}},250)}dispose(){this.#H!==null&&window.clearTimeout(this.#H),this.#H=null}},_3="matic-map-studio:preferred-frontend",F3=()=>{try{return window.localStorage.getItem(_3)==="v3"?"v3":"v4"}catch{return"v4"}},W2=L=>{try{return window.localStorage.setItem(_3,L),!0}catch{return!1}};var c=(L,C,H=null)=>({status:L,value:C,problem:H}),z=L=>L instanceof DOMException&&L.name==="AbortError",i1=(L,C)=>L instanceof $||L&&typeof L=="object"&&"code"in L&&typeof L.code=="string"?L.code:C,J1=L=>[L.selectedFloorOrdinal??"none",L.mapFloorOrdinal??"none",L.mapFloorCoherent?"coherent":"transition"].join(":"),C2=L=>[L.mapFloorOrdinal??"none",L.mapSessionVerified?"verified":"unverified",L.mapSessionKey??"no-session"].join(":"),U=L=>[L.entryId,L.selectedFloorOrdinal??"none",L.mapFloorOrdinal??"none"].join("|"),E3=L=>[L.entryId,J1(L),C2(L),L.mapRevision].join("|"),D3=L=>L.runnerLocked||L.stopSettlePending||L.activePlan||L.nativeReconciliationPending||L.nativeSessionActive===!0,W0=(L,C)=>L.entryKey===C.entryKey&&L.generation===C.generation&&L.floorKey===C.floorKey&&L.missionKey===C.missionKey,$3="Live map updates paused while the current map is rechecked.",I3="Reconnecting. The last verified map remains read only.",N0=1e3,N2=(L,C)=>L.label?L.label:L.active?"Current floor":`Saved floor ${L.ordinal??C}`,H2=class{#C;#H=new $1;#e;#M=new Y1;#V=new Map;#L=null;#t;#a=null;#A=null;#o=null;#s=!1;#m=!1;#S=!1;#n="";#h=0;#p="";#i=!1;#c=!0;constructor(C,H){this.#C=C,this.#e=H}sync(C,H){if(this.#i)return;let V=this.#c;if(this.#c=C.host.connected,this.#L=C,this.#t=H,this.#C.patch({host:C.host,activity:C.activity,batteryPercent:C.batteryPercent,robotLabel:C.robotLabel,robots:C.robots,locale:C.language}),C.userKey!==this.#p){this.#p=C.userKey;let e=this.#M.load(C.userKey);this.#C.patch({view:e.view,appearance:e.appearance,labelsVisible:e.labels,quality:e.quality,cameras:e.cameras})}if(!C.host.administrator){this.#Z(),this.#l("access-required");return}if(!C.host.connected){this.#Z();let e=this.#C.value,r=e.resources.scene.value;this.#C.patch({coherence:r?"degraded":"unavailable",resources:{...e.resources,pose:c("idle",null)},map:{...e.map,available:r!==null,exactPose:!1},notice:r?{tone:"warning",text:I3}:e.notice});return}if(C.host.robotCount===0){this.#Z(),this.#l("map-unavailable");return}if(this.#u(),!V){this.#C.value.notice?.text===I3&&this.#C.patch({notice:null}),this.refreshCatalog(!0);return}(this.#C.value.resources.catalog.status==="idle"||C.entryKey&&C.entryKey!==this.#C.value.selection.entryId)&&this.refreshCatalog(!0)}schedulePreferences(C){this.#M.schedule(C)}#u(){this.#a===null&&(this.#a=window.setInterval(()=>{document.visibilityState==="visible"&&this.refreshCatalog()},5e3)),this.#A===null&&(this.#A=window.setInterval(()=>{document.visibilityState==="visible"&&this.refreshPose()},N0))}#Z(){this.#a!==null&&window.clearInterval(this.#a),this.#A!==null&&window.clearInterval(this.#A),this.#a=null,this.#A=null}#r(C){this.#V.get(C)?.abort();let H=new AbortController;return this.#V.set(C,H),H}#d(C,H){this.#V.get(C)===H&&this.#V.delete(C)}#v(C=[]){for(let[H,V]of this.#V)C.includes(H)||(V.abort(),this.#V.delete(H))}#l(C){this.#v(),this.#H.invalidate(),this.#n="";let H=this.#C.value;this.#C.patch({generation:this.#H.generation,coherence:H.host.administrator?"unavailable":"blocked",fullMap:!1,precisionOpen:!1,resources:{catalog:c("error",null,C),entry:null,scene:c("idle",null),pose:c("idle",null),history:c("idle",null),plans:c("idle",null),areas:c("idle",null)},map:{available:!1,complete:!1,floorCoherent:!1,sessionVerified:!1,exactPose:!1},selection:{...H.selection,entryId:null,floorId:"current",historyId:null}})}async refreshCatalog(C=!1){if(this.#i||this.#s||!this.#L?.host.administrator)return;this.#s=!0;let H=this.#r("catalog"),V=this.#C.value.resources.catalog.value;this.#C.patch({resources:{...this.#C.value.resources,catalog:c("loading",V)}});try{let e=await this.#e.catalog(H.signal);if(H.signal.aborted||this.#i)return;let r=this.#t?.config?.entry_id,M=typeof r=="string"?r:null,t=e.find(a=>a.entryId===this.#L?.entryKey)||e.find(a=>a.entryId===M)||e[0]||null,i=this.#C.value.resources.entry;if(t&&i&&U(t)===U(i)&&J1(t)===J1(i)&&C2(t)===C2(i)&&t.mapRevision<i.mapRevision&&(t={...t,mapRevision:i.mapRevision}),this.#C.patch({managedLock:t?D3(t):!1,resources:{...this.#C.value.resources,catalog:c(e.length?"ready":"empty",e),entry:t}}),!t){this.#l("no-loaded-robot");return}if(this.#C.value.selection.floorId!=="current"&&!C)return;let o=E3(t);if(!C&&o===this.#n){let a=this.#C.value,A=t.mapFloorCoherent&&t.mapSessionVerified,n=t.health==="problem"||t.health==="limited";this.#C.patch({coherence:A?n?"degraded":"current":"verifying",map:{...a.map,available:A&&a.resources.scene.value!==null,complete:t.mapComplete&&!t.mapTruncated,floorCoherent:t.mapFloorCoherent,sessionVerified:t.mapSessionVerified,exactPose:A?a.map.exactPose:!1},floor:{...a.floor,classifiedCount:Math.max(1,t.historyFloorCount)}});return}this.#n=o,this.#w(t)}catch(e){if(z(e))return;this.#C.patch({coherence:this.#C.value.resources.scene.value?"degraded":"unavailable",resources:{...this.#C.value.resources,catalog:c("error",V,i1(e,"catalog-unavailable"))}})}finally{this.#d("catalog",H),this.#s=!1}}#w(C){let H=this.#C.value,V=H.resources.entry,e=!!(V&&U(V)===U(C)),r=C.mapFloorCoherent&&C.mapSessionVerified;this.#v(e?["catalog","plans","areas","plan-mutation","area-mutation"]:["catalog"]);let M=e?H.resources.scene.value:null,t=H.resources.pose.value,i=e&&r&&C.mapSessionKey!==null&&t?.position&&t.mapSessionKey===C.mapSessionKey?t:null,o=this.#H.begin(C.entryId,J1(C),C2(C),C.mapRevision),a=C.health==="problem"||C.health==="limited",A=this.#C.value;this.#C.patch({managedLock:D3(C),generation:o.generation,coherence:r?a?"degraded":"current":"verifying",dataMode:"live",resources:{...A.resources,entry:C,scene:c(r?"loading":"idle",M),pose:c(r?"loading":"idle",i),history:c("loading",A.resources.history.value),plans:e?A.resources.plans:c("idle",null),areas:e?A.resources.areas:c("idle",null)},map:{available:r&&M!==null,complete:C.mapComplete&&!C.mapTruncated,floorCoherent:C.mapFloorCoherent,sessionVerified:C.mapSessionVerified,exactPose:r&&i!==null},floor:{classifiedCount:Math.max(1,C.historyFloorCount),displayName:C.selectedFloorOrdinal?`Floor ${C.selectedFloorOrdinal}`:"Current floor",readOnly:!1},selection:{...A.selection,entryId:C.entryId,floorId:"current",historyId:null,roomIds:e?A.selection.roomIds:[],planId:e?A.selection.planId:null,areaId:e?A.selection.areaId:null}}),this.#b(C,o),r&&(this.#g(C,o),this.#f(C,o))}async#g(C,H){let V=this.#r("scene");try{let e=await this.#e.scene(C.sceneUrl,C.mapRevision,C.mapFloorCoherent,"live",V.signal);if(!this.#H.accepts(H)||e.revision!==H.revision||!e.floorCoherent||!e.scene)return;let r=this.#C.value;if(this.#C.patch({resources:{...r.resources,scene:c("ready",e.scene)},map:{...r.map,available:!0},notice:r.notice?.text===$3?null:r.notice}),C.deltaUrl){let M=++this.#h;this.#y(C,H,e.scene,M)}}catch(e){if(z(e)||!this.#H.accepts(H))return;if(e instanceof $&&e.code==="request-timeout"){let i=this.#C.value;this.#C.patch({resources:{...i.resources,scene:c("loading",i.resources.scene.value,"scene-building")}}),window.setTimeout(()=>{this.#i||!this.#H.accepts(H)||this.#C.value.selection.floorId!=="current"||this.#g(C,H)},250);return}let r=this.#C.value,M=r.resources.pose.value,t=r.resources.scene.value!==null&&C.mapSessionKey!==null&&M?.position!==null&&M?.mapSessionKey===C.mapSessionKey;this.#C.patch({coherence:"degraded",resources:{...r.resources,scene:c("error",r.resources.scene.value,i1(e,"scene-unavailable"))},map:{...r.map,available:r.resources.scene.value!==null,exactPose:t}})}finally{this.#d("scene",V)}}async#y(C,H,V,e){if(!C.deltaUrl||typeof DecompressionStream!="function")return;let r=C.deltaUrl,M=C,t=H,i=V;try{for(;!this.#i&&e===this.#h&&this.#H.accepts(t)&&this.#C.value.selection.floorId==="current";){let o=this.#r("delta");try{let a=await this.#e.sceneDelta(r,i,M.mapFloorCoherent,o.signal);if(o.signal.aborted||this.#i||e!==this.#h||!this.#H.accepts(t))return;if(!a.floorCoherent){this.#C.patch({coherence:"verifying",map:{...this.#C.value.map,available:!1,floorCoherent:!1,exactPose:!1},resources:{...this.#C.value.resources,pose:c("idle",null)}}),this.#n="",this.refreshCatalog(!0);return}if(a.notModified||!a.scene){await new Promise(l=>window.setTimeout(l,100));continue}let A=this.#H.advance(t,a.revision);if(!A)return;t=A,i=a.scene,M={...M,mapRevision:a.revision},this.#n=E3(M);let n=this.#C.value;this.#C.patch({resources:{...n.resources,entry:M,scene:c("ready",i)},map:{...n.map,available:!0,floorCoherent:!0}}),this.#f(M,t)}finally{this.#d("delta",o)}}}catch(o){if(z(o)||this.#i||e!==this.#h||!this.#H.accepts(t))return;this.#C.patch({coherence:"degraded",notice:{tone:"warning",text:$3}}),this.#n="",this.refreshCatalog(!0)}}async#b(C,H){let V=this.#r("history");try{let e=await this.#e.history(C.historyUrl,V.signal);if(!this.#H.accepts(H)||e.entryId!==C.entryId)return;let r=e.floors.find(M=>M.active)||e.floors[0];if(!r)return;this.#C.patch({resources:{...this.#C.value.resources,history:c("ready",e)},floor:{...this.#C.value.floor,classifiedCount:e.floors.length,displayName:N2(r,1)}})}catch(e){if(z(e)||!this.#H.accepts(H))return;this.#C.patch({resources:{...this.#C.value.resources,history:c("error",null,i1(e,"history-unavailable"))}})}finally{this.#d("history",V)}}async refreshPose(){let C=this.#C.value.resources.entry,H=this.#H.current();!C||!H||this.#C.value.selection.floorId!=="current"||!C.mapFloorCoherent||!C.mapSessionVerified||await this.#f(C,H)}async#f(C,H){if(this.#m){this.#S=!0;return}this.#m=!0;let V=this.#r("pose");try{let e=await this.#e.pose(C.poseUrl,V.signal),r=this.#H.current(),M=this.#C.value.resources.entry;if(!r||!W0(H,r)||!M||!e.floorCoherent)return;if(e.mapSessionKey===null||e.mapSessionKey!==M.mapSessionKey){this.#C.patch({map:{...this.#C.value.map,exactPose:!1}}),this.#n="",this.refreshCatalog(!0);return}let t=this.#C.value,i=t.resources.pose.value,o=!!(t.map.exactPose&&i?.position&&i.mapSessionKey===M.mapSessionKey);if(e.position===null&&o){this.#C.patch({resources:{...t.resources,pose:c("ready",i)}});return}this.#C.patch({resources:{...t.resources,pose:c("ready",e)},map:{...t.map,exactPose:e.position!==null}})}catch(e){if(z(e)||!this.#H.accepts(H))return;let r=this.#C.value,M=r.resources.pose.value,t=!!(r.map.exactPose&&M?.position&&M.mapSessionKey===r.resources.entry?.mapSessionKey);this.#C.patch({resources:{...r.resources,pose:c("error",t?M:null,i1(e,"pose-unavailable"))},map:{...r.map,exactPose:t}})}finally{if(this.#d("pose",V),this.#m=!1,this.#S&&!this.#i){this.#S=!1;let e=this.#C.value.resources.entry,r=this.#H.current();e&&r&&this.#f(e,r)}}}async selectFloor(C){let H=this.#C.value.resources.history.value,V=this.#C.value.resources.entry;if(!H||!V)return;let e=H.floors.find(t=>t.id===C);if(!e)return;if(e.active){this.#n="",this.#C.dispatch({type:"set-floor",floorId:"current"}),await this.refreshCatalog(!0);return}let r=e.snapshots.at(-1);this.#v(["catalog"]);let M=this.#H.begin(V.entryId,e.id,r?.id||e.id,r?.revision||0);this.#C.patch({generation:M.generation,coherence:"current",dataMode:"history",floor:{classifiedCount:H.floors.length,displayName:N2(e,H.floors.indexOf(e)+1),readOnly:!0},selection:{...this.#C.value.selection,floorId:e.id,historyId:r?.id||null},resources:{...this.#C.value.resources,scene:c(r?"loading":"empty",null),pose:c("idle",null)},map:{available:!1,complete:!0,floorCoherent:!0,sessionVerified:!0,exactPose:!1}}),r&&await this.#P(r,M)}async selectHistory(C){let H=this.#C.value.resources.history.value,V=this.#C.value.resources.entry;if(!H||!V)return;if(!C){await this.selectFloor("current");return}let e=H.floors.find(t=>t.snapshots.some(i=>i.id===C)),r=e?.snapshots.find(t=>t.id===C);if(!e||!r)return;let M=this.#H.begin(V.entryId,e.id,r.id,r.revision);this.#v(["catalog"]),this.#C.patch({generation:M.generation,dataMode:"history",floor:{classifiedCount:H.floors.length,displayName:N2(e,H.floors.indexOf(e)+1),readOnly:!0},selection:{...this.#C.value.selection,floorId:e.id,historyId:r.id},resources:{...this.#C.value.resources,scene:c("loading",null),pose:c("idle",null)},map:{...this.#C.value.map,available:!1,exactPose:!1}}),await this.#P(r,M)}async#P(C,H){let V=this.#r("history-scene");try{let e=await this.#e.scene(C.sceneUrl,C.revision,!0,"history",V.signal);if(!this.#H.accepts(H)||!e.scene)return;this.#C.patch({resources:{...this.#C.value.resources,scene:c("ready",e.scene)},map:{...this.#C.value.map,available:!0,exactPose:!1}})}catch(e){if(z(e)||!this.#H.accepts(H))return;this.#C.patch({resources:{...this.#C.value.resources,scene:c("error",null,i1(e,"history-scene-unavailable"))}})}finally{this.#d("history-scene",V)}}async openWorkflow(C){this.#C.dispatch({type:"open-workflow",workflow:C}),(C==="plan"||C==="rooms")&&await this.loadPlans(),(C==="draw"||C==="areaReview")&&await this.loadAreas()}async loadPlans(){let C=this.#C.value.resources.entry;if(!C||!this.#H.current()||!a2(this.#C.value))return;let H=U(C),V=this.#r("plans");this.#C.patch({resources:{...this.#C.value.resources,plans:c("loading",null)}});try{let e=await this.#e.plans(C.plansUrl,V.signal),r=this.#C.value.resources.entry;if(!r||U(r)!==H)return;this.#C.patch({resources:{...this.#C.value.resources,plans:c("ready",e)},selection:{...this.#C.value.selection,planId:e.selectedPlan||e.plans[0]?.id||null}}),this.selectPlan(e.selectedPlan||e.plans[0]?.id||null)}catch(e){let r=this.#C.value.resources.entry;if(z(e)||!r||U(r)!==H)return;this.#C.patch({resources:{...this.#C.value.resources,plans:c("error",null,i1(e,"plans-unavailable"))}})}finally{this.#d("plans",V)}}selectPlan(C){let H=this.#C.value.resources.plans.value?.plans.find(V=>V.id===C);this.#C.patch({selection:{...this.#C.value.selection,planId:C},planDraft:H?this.#k(H):{...this.#C.value.planDraft,id:null,name:"",rooms:[],dirty:!1}})}#k(C){return{id:C.id,name:C.name,enabled:C.enabled,runBehavior:C.runBehavior,rooms:(C.roomOrder.length?C.roomOrder.flatMap(H=>{let V=C.rooms.find(e=>e.roomId===H);return V?[V]:[]}):C.rooms).map(H=>({...H})),returnToBase:C.returnToBase,finishCurrentRoom:C.finishCurrentRoom,finishCurrentRoomThreshold:C.finishCurrentRoomThreshold,dirty:!1}}async loadAreas(){let C=this.#C.value.resources.entry;if(!C||!this.#H.current()||!a2(this.#C.value))return;let H=U(C),V=this.#r("areas");this.#C.patch({resources:{...this.#C.value.resources,areas:c("loading",null)}});try{let e=await this.#e.areas(C.areasUrl,V.signal),r=this.#C.value.resources.entry;if(!r||U(r)!==H||e.sceneUrl!==r.sceneUrl)return;this.#C.patch({resources:{...this.#C.value.resources,areas:c("ready",e)}}),this.selectArea(e.areas[0]?.id||null)}catch(e){let r=this.#C.value.resources.entry;if(z(e)||!r||U(r)!==H)return;this.#C.patch({resources:{...this.#C.value.resources,areas:c("error",null,i1(e,"areas-unavailable"))}})}finally{this.#d("areas",V)}}selectArea(C){let H=this.#C.value.resources.areas.value?.areas.find(e=>e.id===C),V=this.#C.value;this.#C.patch({selection:{...V.selection,areaId:C},areaDraft:H?this.#B(H):{id:null,name:"",cleaningMode:"vacuum",coverageSetting:"standard",status:"new",canRebind:!1,dirty:!1},draw:{...V.draw,circles:H?.circles||[],undo:[],redo:[],dirty:!1,strokeCount:0}})}#B(C){return{id:C.id,name:C.name,cleaningMode:C.cleaningMode,coverageSetting:C.coverageSetting,status:C.status,canRebind:C.canRebind,dirty:!1}}async saveArea(){let C=this.#C.value,H=C.resources.entry,V=C.areaDraft;if(!H||!Q(C)||!V.name.trim()||!C.draw.circles.length)return;let e=this.#r("area-mutation");this.#C.patch({command:"pending",notice:{tone:"info",text:"Saving area\u2026"}});try{let r=await this.#e.saveArea(H.areasUrl,{areaId:V.id,name:V.name.trim(),circles:C.draw.circles,cleaningMode:V.cleaningMode,coverageSetting:V.coverageSetting},e.signal);this.#C.patch({command:"idle",notice:{tone:"success",text:"Area saved"}}),await this.loadAreas(),this.selectArea(r)}catch(r){if(z(r))return;this.#C.patch({command:"failed",notice:{tone:"error",text:"Area could not be saved"}})}finally{this.#d("area-mutation",e)}}async deleteArea(){let C=this.#C.value.resources.entry,H=this.#C.value.selection.areaId;if(!C||!H||!Q(this.#C.value))return;let V=this.#r("area-mutation");try{await this.#e.deleteArea(C.areasUrl,H,V.signal),this.#C.patch({notice:{tone:"success",text:"Area deleted"}}),await this.loadAreas()}catch(e){z(e)||this.#C.patch({notice:{tone:"error",text:"Area could not be deleted"}})}finally{this.#d("area-mutation",V)}}async savePlan(){let C=this.#C.value,H=C.planDraft,V=C.resources.plans.value;if(!V||!H.name.trim()||!H.rooms.length||!Q(C))return;let e=H.rooms;await this.#O("save_plan",{...H.id?{plan_id:H.id}:{},name:H.name.trim(),enabled:H.enabled,run_behavior:H.runBehavior,rooms:e.map(r=>({room:V.rooms.find(M=>M.roomId===r.roomId)?.name,cleaning_mode:r.cleaningMode,coverage_setting:r.coverageSetting})).filter(r=>r.room),return_to_base:H.returnToBase,finish_current_room:H.finishCurrentRoom,finish_current_room_threshold:H.finishCurrentRoomThreshold,select:!H.id||V.selectedPlan===H.id},"Plan saved","Plan could not be saved"),await this.loadPlans()}async deletePlan(){let C=this.#C.value.selection.planId;C&&(await this.#O("delete_plan",{plan:C},"Plan deleted","Plan could not be deleted"),await this.loadPlans())}async executeAction(C){switch(C){case"stop":this.#C.value.resources.entry?.activePlan||this.#C.value.resources.entry?.runnerLocked?await this.#x("matic_robot","stop_intelligent_cleaning",{}):await this.#x("vacuum","return_to_base",{});return;case"resume":await this.#x("vacuum","start",{});return;case"run-plan":{let H=this.#C.value.selection.planId||this.#C.value.resources.plans.value?.selectedPlan;H&&await this.#x("matic_robot","run_selected_plan",{plan:H});return}case"clean-rooms":{let H=this.#C.value.resources.plans.value,e=this.#C.value.selection.roomSettings.map(r=>({room:H?.rooms.find(M=>M.roomId===r.roomId)?.name,cleaning_mode:r.cleaningMode,coverage_setting:r.coverageSetting})).filter(r=>r.room);e.length&&await this.#x("matic_robot","clean_room_sequence",{rooms:e,return_to_base:!0});return}case"run-area":{let H=this.#C.value.selection.areaId;H&&await this.#x("matic_robot","clean_area",{area:H});return}case"review-area":this.#C.dispatch({type:"open-workflow",workflow:"areaReview"});return;case"save-area":await this.saveArea();return;case"save-plan":await this.savePlan();return;case"delete-plan":await this.deletePlan();return;case"delete-area":await this.deleteArea();return}}async#O(C,H,V,e){let r=this.#L?.vacuumEntityId;if(!(!r||!Q(this.#C.value)||this.#C.value.command==="pending")){this.#C.patch({command:"pending",notice:{tone:"info",text:"Saving\u2026"}});try{await this.#e.service("matic_robot",C,H,r),this.#C.patch({command:"idle",notice:{tone:"success",text:V}})}catch{this.#C.patch({command:"failed",notice:{tone:"error",text:e}})}}}async#x(C,H,V){let e=this.#C.value,r=this.#L?.vacuumEntityId,t=(H==="stop_intelligent_cleaning"||C==="vacuum"&&H==="return_to_base")&&e.command==="idle"&&(e.activity==="cleaning"||e.activity==="paused"||e.activity==="returning"||e.activity==="recharging");if(!(!r||!t&&!a1(e))){this.#C.patch({command:"pending",notice:null});try{await this.#e.service(C,H,V,r),this.#C.patch({command:"settling"}),this.#o!==null&&window.clearTimeout(this.#o),this.#o=window.setTimeout(()=>{this.#o=null,this.#C.value.command==="settling"&&this.#C.patch({command:"idle"})},15e3)}catch{this.#C.patch({command:"failed",notice:{tone:"error",text:"The robot did not accept that action"}})}}}updateDraftCircles(C,H=!0,V){this.#C.dispatch({type:"set-draft-circles",circles:C,record:H,...V?{previous:V}:{}}),this.#C.dispatch({type:"patch-area-draft",patch:{dirty:!0}})}dispose(){this.#i||(this.#i=!0,this.#Z(),this.#v(),this.#o!==null&&window.clearTimeout(this.#o),this.#o=null,this.#M.dispose(),this.#e.dispose(),this.#H.invalidate())}};var W3=L=>(L.workflow==="none"?0:1)+(L.fullMap?1:0)+(L.precisionOpen?1:0)+(L.dialog?1:0),z0=L=>{if(!L||typeof L!="object")return null;let C=L.maticMapLayer;if(!C||typeof C!="object")return null;let H=C.owner,V=C.depth;return typeof H=="string"&&Number.isInteger(V)&&Number(V)>=0?{owner:H,depth:Number(V)}:null},V2=class{#C;#H=`matic-map-${crypto.randomUUID?.()||Math.random().toString(36).slice(2)}`;#e=0;#M=null;#V=!1;constructor(C){this.#C=C}start(){this.#M||(this.#e=W3(this.#C.value),this.#M=this.#C.subscribe(C=>this.#L(C)),window.addEventListener("popstate",this.#t))}#L(C){let H=W3(C);if(this.#V){this.#V=!1,this.#e=H;return}if(H>this.#e)for(let V=this.#e+1;V<=H;V+=1){let e=history.state&&typeof history.state=="object"?history.state:{};history.pushState({...e,maticMapLayer:{owner:this.#H,depth:V}},"",window.location.href)}this.#e=H}#t=()=>{this.#e<1||(this.#V=!0,this.#C.dispatch({type:"dismiss-top-layer"}))};dismissTop(){if(this.#e<1)return!1;let C=z0(history.state);return C?.owner===this.#H&&C.depth===this.#e?history.back():this.#C.dispatch({type:"dismiss-top-layer"}),!0}dispose(){this.#M?.(),this.#M=null,window.removeEventListener("popstate",this.#t),this.#e=0}};var N3=N(r1),z2=class extends f{constructor(){super(...arguments);this.narrow=!1;this._workspace=O();this._classic=!1;this.entryOverride=null;this.#C=new W1;this.#H=new A1(this._workspace);this.#e=null;this.#M=null;this.#V=null;this.#L=null;this.#t=null;this.#a=""}static{this.styles=[F,E,h`
...
`]}static{this.properties={hass:{attribute:!1},narrow:{type:Boolean},route:{attribute:!1},panel:{attribute:!1},_workspace:{state:!0},_classic:{state:!0},entryOverride:{state:!0}}}#C;#H;#e;#M;#V;#L;#t;#a;connectedCallback(){super.connectedCallback(),this._classic=F3()==="v3",this.#M=this.#H.subscribe(H=>{this._workspace=H,this.#s(H)}),this._classic||this.#A()}disconnectedCallback(){this.#M?.(),this.#M=null,this.#o(),super.disconnectedCallback()}#A(){this.#L||(this.#V=new j1(()=>this.hass),this.#L=new H2(this.#H,this.#V),this.#t=new V2(this.#H),this.#t.start(),this.#e&&this.#L.sync(this.#e,this.panel))}#o(){this.#t?.dispose(),this.#t=null,this.#L?.dispose(),this.#L=null,this.#V=null}#s(H){if(!this.#L)return;let V={version:4,view:H.view,appearance:H.appearance,labels:H.labelsVisible,quality:H.quality,cameras:H.cameras},e=JSON.stringify(V);e!==this.#a&&(this.#a=e,this.#L.schedulePreferences(V))}willUpdate(H){if(H.has("hass")||H.has("panel")||H.has("entryOverride")){let V=this.#C.project(this.hass,this.panel,this.entryOverride);if(V!==this.#e){this.#e=V;let e=V.host.connected?V.host.robotCount===0?"unavailable":V.host.administrator?"verifying":"blocked":"degraded";this.#H.replace({...this.#H.value,coherence:e,activity:V.activity,batteryPercent:V.batteryPercent,host:V.host,fullMap:V.host.administrator&&V.host.robotCount>0&&this.#H.value.fullMap,robotLabel:V.robotLabel,robots:V.robots,locale:V.language})}this._classic||this.#L?.sync(V,this.panel)}H.has("narrow")&&this.#H.value.narrowHint!==this.narrow&&this.#H.dispatch({type:"set-narrow-hint",value:this.narrow})}#m(H){if(!D1(H.detail))return;H.stopPropagation();let V=H.detail;if(V.type==="dismiss-top-layer"||V.type==="exit-full-map"){this.#t?.dismissTop()||this.#H.dispatch(V);return}if(V.type==="open-workflow"&&V.workflow!=="none"){this.#L?.openWorkflow(V.workflow);return}if(V.type==="set-floor"){this.#L?.selectFloor(V.floorId);return}if(V.type==="select-entry"){if(!this._workspace.robots.some(e=>e.entryId===V.entryId))return;this.entryOverride=V.entryId;return}if(V.type==="set-history"){this.#L?.selectHistory(V.historyId);return}if(V.type==="select-plan"){this.#L?.selectPlan(V.planId);return}if(V.type==="select-area"){this.#L?.selectArea(V.areaId);return}this.#H.dispatch(V)}#S(H){if(H.stopPropagation(),typeof H.detail?.id=="string"){if(H.detail.id==="use-classic"){W2("v3")&&(this.#o(),this._classic=!0);return}this.#L?.executeAction(H.detail.id),this.dispatchEvent(new CustomEvent("matic-map-v4-action-requested",{detail:{id:H.detail.id},bubbles:!0,composed:!0}))}}#n(){W2("v4")&&(this._classic=!1,this.#A(),this.requestUpdate())}updated(){if(!this._classic)return;let H=this.renderRoot.querySelector("matic-map-panel-v0-3-1");H&&(H.hass=this.hass,H.narrow=this.narrow,H.route=this.route,H.panel=this.panel)}getWorkspaceSnapshot(){return this.#H.value}render(){return this._classic?d`
        <div class="classic">
      ...
      ></${N3}>
    `}};customElements.get(O2)||customElements.define(O2,z2);export{$1 as CoherenceMachine,E1 as DRAW_BRUSH_MAX_METERS,u1 as DRAW_BRUSH_MIN_METERS,l2 as GALLERY_SCENARIOS,W1 as HassAdapter,o2 as MAP_PIXELS_PER_METER_AT_100,F1 as MAP_ZOOM_MAX,J as MAP_ZOOM_MIN,O2 as MATIC_MAP_PANEL_TAG,z2 as MaticMapPanelV4,E2 as MaticMapStudioGalleryV4,A1 as WorkspaceStore,Q0 as brushCursorPixels,Q as canEditCoordinates,a2 as canReadFloorResources,K2 as canShowExactPose,n1 as canShowLiveMap,a1 as canStartMotion,q0 as commandState,d2 as createGalleryState,O as initialWorkspaceState,D1 as isWorkspaceIntent,Y2 as mapScale,Q3 as normalizeBrush,q2 as normalizeZoom,q3 as reduceWorkspace,j2 as selectPausedSecondaryAction,X2 as selectPrimaryAction};
