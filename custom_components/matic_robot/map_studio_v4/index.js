var C1=100,E1=1e3,u1=.2,D1=2.5,n2=64,$1=L=>!L||typeof L!="object"?!1:typeof L.type=="string";var i1=()=>({status:"idle",value:null,problem:null}),G=(L,C,H)=>Math.max(C,Math.min(H,L)),j3=L=>({yaw:G(Number.isFinite(L.yaw)?L.yaw:0,-Math.PI,Math.PI),pitch:G(Number.isFinite(L.pitch)?L.pitch:Math.PI/2-.018,.18,Math.PI/2-.018),zoom:G(Number.isFinite(L.zoom)?L.zoom:1,.01,100),targetX:G(Number.isFinite(L.targetX)?L.targetX:0,-1e4,1e4),targetZ:G(Number.isFinite(L.targetZ)?L.targetZ:0,-1e4,1e4)}),X2=L=>Math.round(G(Number.isFinite(L)?L:100,100,1e3)),Y3=L=>Math.round(G(Number.isFinite(L)?L:.2,.2,2.5)*100)/100,k=()=>({generation:0,coherence:"verifying",dataMode:"live",activity:"unknown",workflow:"none",command:"idle",fullMap:!1,precisionOpen:!1,dialog:null,narrowHint:!1,view:"top",appearance:"photo",labelsVisible:!0,quality:"auto",cameras:{},managedLock:!1,batteryPercent:null,floor:{classifiedCount:1,displayName:"Current floor",readOnly:!1},map:{available:!1,complete:!1,floorCoherent:!1,sessionVerified:!1,exactPose:!1},host:{connected:!0,administrator:!0,robotConnected:!1,robotCount:0},draw:{zoomPercent:100,zoomOriginX:50,zoomOriginY:50,brushMeters:.6,tool:"paint",dirty:!1,strokeCount:0,circles:[],undo:[],redo:[]},resources:{catalog:i1(),entry:null,scene:i1(),pose:i1(),history:i1(),plans:i1(),areas:i1()},selection:{entryId:null,floorId:"current",historyId:null,roomIds:[],roomSettings:[],cleaningMode:"vacuum",coverageSetting:"standard",planId:null,areaId:null},planDraft:{id:null,name:"",enabled:!0,runBehavior:"intelligent",rooms:[],returnToBase:!0,finishCurrentRoom:!1,finishCurrentRoomThreshold:50,dirty:!1},areaDraft:{id:null,name:"",cleaningMode:"vacuum",coverageSetting:"standard",status:"new",canRebind:!1,dirty:!1},notice:null,robotLabel:"Matic robot",robots:[],locale:"en"}),W=(L,C)=>({...L,draw:{...L.draw,...C}}),J3=(L,C)=>{switch(C.type){case"set-host":return{...L,host:C.host,fullMap:C.host.administrator&&C.host.robotCount>0?L.fullMap:!1};case"set-operational-state":return{...L,coherence:C.coherence,activity:C.activity,command:C.command??L.command};case"set-narrow-hint":return{...L,narrowHint:C.value};case"set-view":return{...L,view:C.view};case"set-appearance":return{...L,appearance:C.appearance};case"set-quality":return{...L,quality:C.quality};case"set-camera":return{...L,cameras:{...L.cameras,[C.view]:j3(C.camera)}};case"toggle-labels":return{...L,labelsVisible:!L.labelsVisible};case"open-workflow":return{...L,workflow:C.workflow,precisionOpen:!1};case"enter-full-map":return L.host.administrator&&L.host.robotCount>0&&L.map.available?{...L,fullMap:!0}:L;case"exit-full-map":return{...L,fullMap:!1,precisionOpen:!1};case"set-precision-open":return{...L,precisionOpen:C.value};case"set-zoom":return W(L,{zoomPercent:X2(C.value),...C.originX===void 0?{}:{zoomOriginX:G(C.originX,0,100)},...C.originY===void 0?{}:{zoomOriginY:G(C.originY,0,100)}});case"step-zoom":return W(L,{zoomPercent:X2(L.draw.zoomPercent*C.factor)});case"fit-map":return W(L,{zoomPercent:100,zoomOriginX:50,zoomOriginY:50});case"set-brush":return W(L,{brushMeters:Y3(C.value)});case"set-draw-tool":return W(L,{tool:C.tool});case"mark-draft":{let H=Math.max(0,L.draw.strokeCount+C.strokeDelta);return W(L,{dirty:H>0,strokeCount:H})}case"undo-draft":{let H=L.draw.undo.at(-1);return H?W(L,{circles:H,undo:L.draw.undo.slice(0,-1),redo:[...L.draw.redo,L.draw.circles],dirty:!0,strokeCount:Math.max(0,L.draw.strokeCount-1)}):L}case"clear-draft":return L.draw.circles.length?W(L,{circles:[],undo:[...L.draw.undo.slice(-99),L.draw.circles],redo:[],dirty:!0,strokeCount:L.draw.strokeCount+1}):L;case"redo-draft":{let H=L.draw.redo.at(-1);return H?W(L,{circles:H,undo:[...L.draw.undo,L.draw.circles],redo:L.draw.redo.slice(0,-1),dirty:!0,strokeCount:L.draw.strokeCount+1}):L}case"set-draft-circles":{let H=C.circles.slice(0,512).map(e=>({...e})),V=C.record!==!1;return W(L,{circles:H,undo:V?[...L.draw.undo.slice(-99),C.previous??L.draw.circles]:L.draw.undo,redo:V?[]:L.draw.redo,dirty:!0,strokeCount:V?L.draw.strokeCount+1:L.draw.strokeCount})}case"discard-draft":return{...W(L,{dirty:!1,strokeCount:0,circles:[],undo:[],redo:[]}),dialog:null,workflow:"none",precisionOpen:!1};case"toggle-room":{let H=L.selection.roomIds.includes(C.roomId);return{...L,selection:{...L.selection,roomIds:H?L.selection.roomIds.filter(V=>V!==C.roomId):[...L.selection.roomIds,C.roomId],roomSettings:H?L.selection.roomSettings.filter(V=>V.roomId!==C.roomId):[...L.selection.roomSettings,{roomId:C.roomId,cleaningMode:"vacuum",coverageSetting:"standard"}]}}}case"patch-room-settings":return{...L,selection:{...L.selection,roomSettings:L.selection.roomSettings.map(H=>H.roomId===C.roomId?{...H,...C.cleaningMode?{cleaningMode:C.cleaningMode}:{},...C.coverageSetting?{coverageSetting:C.coverageSetting}:{}}:H)}};case"set-floor":return{...L,dataMode:C.floorId==="current"?"live":"history",selection:{...L.selection,floorId:C.floorId,historyId:null}};case"select-entry":return L;case"set-history":return{...L,dataMode:C.historyId?"history":"live",selection:{...L.selection,historyId:C.historyId}};case"select-plan":return{...L,selection:{...L.selection,planId:C.planId}};case"select-area":return{...L,selection:{...L.selection,areaId:C.areaId}};case"patch-plan-draft":return{...L,planDraft:{...L.planDraft,...C.patch,dirty:C.patch.dirty??!0}};case"patch-area-draft":return{...L,areaDraft:{...L.areaDraft,...C.patch,dirty:C.patch.dirty??!0}};case"set-notice":return{...L,notice:C.notice};case"open-dialog":return{...L,dialog:C.dialog};case"dismiss-top-layer":return L.dialog?{...L,dialog:null}:L.precisionOpen?{...L,precisionOpen:!1}:L.fullMap?{...L,fullMap:!1}:L.workflow!=="none"?{...L,workflow:"none",precisionOpen:!1}:L;case"return-live":return{...L,dataMode:"live",workflow:"none",floor:{...L.floor,readOnly:!1}}}},n1=class{#C=new Set;#H;constructor(C=k()){this.#H=C}get value(){return this.#H}dispatch(C){let H=J3(this.#H,C);if(H===this.#H)return H;this.#H=H;for(let V of this.#C)V(H);return H}replace(C){if(C!==this.#H){this.#H=C;for(let H of this.#C)H(C)}}patch(C){let H={...this.#H,...C};return this.replace(H),H}subscribe(C){return this.#C.add(C),C(this.#H),()=>this.#C.delete(C)}},I1=class{#C=null;#H=0;get generation(){return this.#H}begin(C,H,V,e){return this.#H+=1,this.#C={entryKey:C,generation:this.#H,floorKey:H,missionKey:V,revision:e},this.#C}current(){return this.#C}accepts(C){let H=this.#C;return!!(H&&C.entryKey===H.entryKey&&C.generation===H.generation&&C.floorKey===H.floorKey&&C.missionKey===H.missionKey&&C.revision===H.revision)}advance(C,H){return!this.accepts(C)||!Number.isSafeInteger(H)||H<=C.revision?null:(this.#C={...C,revision:H},this.#C)}invalidate(){return this.#H+=1,this.#C=null,this.#H}},A1=L=>L.dataMode==="live"&&L.map.available&&(L.coherence==="current"||L.coherence==="degraded")&&L.host.administrator,j2=L=>A1(L)&&(L.coherence==="current"||L.coherence==="degraded")&&L.map.floorCoherent&&L.map.sessionVerified&&L.map.exactPose&&L.host.connected&&L.host.robotConnected,Q=L=>A1(L)&&L.coherence==="current"&&L.map.complete&&L.map.floorCoherent&&L.map.sessionVerified&&L.host.connected&&L.host.robotConnected&&!L.floor.readOnly,A2=L=>A1(L)&&L.coherence==="current"&&L.map.floorCoherent&&L.map.sessionVerified&&L.host.connected&&L.host.robotConnected&&!L.floor.readOnly,a1=L=>Q(L)&&!L.managedLock&&L.command==="idle"&&(L.activity==="idle"||L.activity==="docked"),Z1=(L,C,H,V,e)=>({id:L,label:C,labelKey:V,kind:"neutral",enabled:!1,reason:H,reasonKey:e}),Y2=L=>{let C=L.command==="idle";return{id:"stop",label:"Stop",labelKey:"v4_action_stop",kind:"danger",enabled:C,...C?{}:{reason:"The robot is already stopping.",reasonKey:"v4_reason_stop"}}},J2=L=>{if(L.dataMode==="history")return{id:"return-live",label:"Return to the live map",labelKey:"v4_action_return_live",kind:"primary",enabled:!0};if(L.activity==="cleaning"||L.activity==="returning"||L.activity==="recharging")return Y2(L);if(L.activity==="stopping"||L.command==="settling")return Z1("stopping","Stopping","Waiting for the robot to settle.","v4_action_stopping","v4_reason_stopping");if(L.activity==="paused")return{id:"resume",label:"Resume cleaning",labelKey:"v4_action_resume",kind:"primary",enabled:L.command==="idle"};if(!L.host.connected)return Z1("reconnecting","Reconnecting","Home Assistant is offline.","v4_action_reconnecting","v4_reason_reconnecting");if(!L.host.administrator)return Z1("administrator","Administrator access required","Ask a Home Assistant administrator to open this map.","v4_action_administrator","v4_reason_administrator");if(!L.host.robotConnected)return Z1("robot-offline","Robot offline","Reconnect the robot to start cleaning.","v4_action_robot_offline","v4_reason_robot_offline");if(L.coherence!=="current")return Z1("locating","Finding the map","Waiting for the robot to confirm which floor it is on.","v4_action_locating","v4_reason_locating");if(L.workflow==="draw"){let C={reason:"Draw the area first.",reasonKey:"v4_reason_save_area_draw"};return L.fullMap||L.narrowHint?{id:"review-area",label:"Name and save",labelKey:"v4_action_review_area",kind:"primary",enabled:L.draw.dirty,...L.draw.dirty?{}:C}:{id:"save-area",label:"Save area",labelKey:"v4_action_save_area",kind:"primary",enabled:L.draw.dirty&&Q(L),...L.draw.dirty?{}:C}}if(L.workflow==="rooms"){let C=L.selection.roomIds.length,H=a1(L)&&C>0;return{id:"clean-rooms",label:C?`Clean ${C} room${C===1?"":"s"}`:"Clean selected rooms",...C?{}:{labelKey:"v4_action_clean_rooms"},kind:"primary",enabled:H,...H?{}:C?{reason:"Waiting for the current map to be verified.",reasonKey:"v4_reason_clean_rooms_verification"}:{reason:"Select at least one room to clean.",reasonKey:"v4_reason_clean_rooms_empty"}}}if(L.workflow==="plan"){if(L.planDraft.dirty||!L.planDraft.id){let C=Q(L)&&L.planDraft.name.trim().length>0&&L.planDraft.rooms.length>0;return{id:"save-plan",label:"Save plan",labelKey:"v4_action_save_plan",kind:"primary",enabled:C,...C?{}:{reason:"Add a plan name and at least one room.",reasonKey:"v4_reason_save_plan"}}}return{id:"run-plan",label:"Run this plan",labelKey:"v4_action_run_plan",kind:"primary",enabled:a1(L)&&L.planDraft.enabled,...a1(L)?{}:{reason:"Waiting for the current map to be verified.",reasonKey:"v4_reason_run_plan"}}}if(L.workflow==="areaReview"){if(L.areaDraft.dirty||L.draw.dirty||!L.areaDraft.id||L.areaDraft.canRebind){let H=Q(L)&&L.areaDraft.name.trim().length>0&&L.draw.circles.length>0;return{id:"save-area",label:L.areaDraft.canRebind?"Confirm on this map":"Save area",labelKey:L.areaDraft.canRebind?"v4_action_save_area_confirm":"v4_action_save_area",kind:"primary",enabled:H,...H?{}:{reason:"Add an area name and at least one mark.",reasonKey:"v4_reason_save_area_details"}}}let C=L.areaDraft.status==="current";return{id:"run-area",label:"Clean this area",labelKey:"v4_action_run_area",kind:"primary",enabled:C&&a1(L),...C?{}:{reason:"Confirm this outline on the current map first.",reasonKey:"v4_reason_run_area"}}}return{id:"choose-cleaning",label:"Choose what to clean",labelKey:"v4_action_choose_cleaning",kind:"neutral",enabled:!1,reason:"Choose rooms, a plan, or a custom area.",reasonKey:"v4_reason_choose_cleaning"}},C5=L=>L.activity==="paused"?Y2(L):null,r7=L=>L.draw.brushMeters*64*(L.draw.zoomPercent/100),C0=[2,1,.5,.25,.1,.05],H5=L=>{let C=64*(L.draw.zoomPercent/100),H=C0.reduce((V,e)=>{let r=Math.abs(e*C-64),M=Math.abs(V*C-64);return r<M?e:V});return{meters:H,pixels:H*C,label:H<1?`${Math.round(H*100)} cm`:`${H} m`}},M7=(L,C)=>({...L,command:C});var V5="a".repeat(64),d1=[{roomId:"room-a",name:"Kitchen",boundary:[[.5,.5],[4,.5],[4,3],[.5,3]]},{roomId:"room-b",name:"Living room",boundary:[[4.2,.5],[8.5,.5],[8.5,3.4],[4.2,3.4]]},{roomId:"room-c",name:"Office",boundary:[[.5,3.2],[3.8,3.2],[3.8,6.5],[.5,6.5]]},{roomId:"room-d",name:"Bedroom",boundary:[[4,3.6],[8.5,3.6],[8.5,6.5],[4,6.5]]}],L5=()=>{let L=[180,140],C={meters_per_cell:.05,origin_cells:[0,0],span_cells:L,sample_step:1,rooms:d1.map(i=>{let a=i.boundary.map(([A,s])=>[A/.05,s/.05]),n=[a.reduce((A,[s])=>A+s,0)/a.length,a.reduce((A,[,s])=>A+s,0)/a.length];return{name:i.name,boundary:a,boundary_closed:!0,center:n}})},H=new TextEncoder().encode(JSON.stringify(C)),V=[];for(let i=10;i<130;i+=2)for(let a=10;a<170;a+=2){let n=a<80?i<65?0:2:i<72?1:3,A=[[185,219,224],[201,211,233],[210,226,194],[232,207,207]][n]||[190,205,215];V.push([a,i,0,...A])}let e=500;for(let i=0;i<e;i+=1){let a=i%4,n=i*7%120,A=a<2?a===0?10:168:10+n,s=a>=2?a===2?10:128:10+n;V.push([A,s,10+i%18,104,122,137])}let r=V.length-e,M=new ArrayBuffer(24+H.byteLength+V.length*8),t=new DataView(M);new Uint8Array(M,0,8).set(new TextEncoder().encode("MATIC3D\0")),t.setUint16(8,1,!0),t.setUint16(10,8,!0),t.setUint32(12,H.byteLength,!0),t.setUint32(16,r,!0),t.setUint32(20,e,!0),new Uint8Array(M,24,H.byteLength).set(H);let o=new DataView(M,24+H.byteLength);return V.forEach(([i=0,a=0,n=0,A=0,s=0,v=0],x)=>{let u=x*8;o.setUint16(u,i,!0),o.setUint16(u+2,a,!0),o.setUint8(u+4,n),o.setUint8(u+5,A),o.setUint8(u+6,s),o.setUint8(u+7,v)}),{buffer:M,pointOffset:24+H.byteLength,floorCount:r,surfaceCount:e,total:V.length,revision:7,etag:'"synthetic-scene"',source:"live",metadata:{metersPerCell:.05,origin:[0,0],span:L,sampleStep:1,rooms:C.rooms.map((i,a)=>({id:d1[a]?.roomId||`room-${a}`,name:i.name,boundary:i.boundary,center:i.center}))}}},W1=()=>({entryId:"synthetic-entry",sceneUrl:"/api/matic_robot/slam_scene/synthetic",deltaUrl:"/api/matic_robot/slam_delta/synthetic",poseUrl:"/api/matic_robot/slam_pose/synthetic",historyUrl:"/api/matic_robot/slam_history/synthetic",areasUrl:"/api/matic_robot/areas/synthetic",plansUrl:"/api/matic_robot/plans/synthetic",mapRevision:7,mapFloorCoherent:!0,mapSessionVerified:!0,mapSessionKey:V5,mapBlockReason:null,runnerLocked:!1,stopSettlePending:!1,activePlan:!1,nativeReconciliationPending:!1,nativeSessionActive:!1,mapComplete:!0,mapTruncated:!1,selectedFloorOrdinal:1,mapFloorOrdinal:1,historyCount:2,historyFloorCount:2,health:"ready",streamFailures:0,bootstrapState:"complete",bootstrapPhotoSeen:!0,bootstrapStructureSeen:!0,bootstrapFailures:0}),d2=()=>({rooms:d1.map(({roomId:L,name:C})=>({roomId:L,name:C})),selectedPlan:"daily",plans:[{id:"daily",name:"Daily clean",enabled:!0,runBehavior:"intelligent",rooms:d1.slice(0,3).map(({roomId:L})=>({roomId:L,cleaningMode:"vacuum",coverageSetting:"standard"})),roomOrder:d1.slice(0,3).map(({roomId:L})=>L),returnToBase:!0,finishCurrentRoom:!1,finishCurrentRoomThreshold:50}]}),l2=()=>({sceneUrl:W1().sceneUrl,rooms:d1.map(L=>({...L,boundary:L.boundary.map(C=>[...C])})),areas:[{id:"entryway",name:"Entryway",circles:[{x:1.5,y:1.4,radius:.3},{x:1.9,y:1.6,radius:.3}],cleaningMode:"vacuum",coverageSetting:"standard",status:"current",canRebind:!1}]}),e5=()=>({entryId:"synthetic-entry",liveAvailable:!0,floors:[{id:"current",active:!0,readOnly:!1,liveAvailable:!0,label:"House",ordinal:null,snapshots:[{id:"current-old",createdAt:"2026-08-29T14:00:00Z",revision:6,pointCount:5300,sceneUrl:"/synthetic-history-current-old"},{id:"current-new",createdAt:"2026-08-29T16:12:00Z",revision:7,pointCount:5300,sceneUrl:"/synthetic-history-current-new"}]},{id:"saved-1",active:!1,readOnly:!0,liveAvailable:!1,label:"Shed",ordinal:2,snapshots:[{id:"saved-one",createdAt:"2026-08-28T11:30:00Z",revision:3,pointCount:3100,sceneUrl:"/synthetic-history-saved"}]},{id:"saved-2",active:!1,readOnly:!0,liveAvailable:!1,label:"Annex",ordinal:3,snapshots:[]}]}),r5=()=>({position:[4.475,3.475],source:"latest_pose",revision:7,poseRevision:4,floorCoherent:!0,mapSessionKey:V5,freshness:"live"});var H0=()=>({...k(),coherence:"current",activity:"docked",batteryPercent:92,robots:[{entryId:"synthetic-entry",label:"Matic robot"}],host:{connected:!0,administrator:!0,robotConnected:!0,robotCount:1},floor:{classifiedCount:2,displayName:"House",readOnly:!1},map:{available:!0,complete:!0,floorCoherent:!0,sessionVerified:!0,exactPose:!0},resources:{catalog:{status:"ready",value:[W1()],problem:null},entry:W1(),scene:{status:"ready",value:L5(),problem:null},pose:{status:"ready",value:r5(),problem:null},history:{status:"ready",value:e5(),problem:null},plans:{status:"ready",value:d2(),problem:null},areas:{status:"ready",value:l2(),problem:null}},selection:{...k().selection,entryId:"synthetic-entry",planId:"daily"},planDraft:{...k().planDraft,id:"daily",name:"Daily clean",rooms:d2().plans[0]?.rooms||[]}}),s2=L=>{let C=H0();switch(L){case"ready":return C;case"cleaning":return{...C,activity:"cleaning"};case"paused":return{...C,activity:"paused"};case"returning":return{...C,activity:"returning"};case"recharging":return{...C,activity:"recharging",batteryPercent:18};case"rooms":return{...C,workflow:"rooms"};case"draw":return{...C,workflow:"draw",areaDraft:{...C.areaDraft,id:"entryway",name:"Entryway",status:"current"},selection:{...C.selection,areaId:"entryway"},draw:{...C.draw,dirty:!0,strokeCount:3,circles:l2().areas[0]?.circles||[]}};case"history":return{...C,dataMode:"history",workflow:"history",floor:{...C.floor,readOnly:!0},map:{...C.map,exactPose:!1},selection:{...C.selection,floorId:"saved-1",historyId:"saved-one"}};case"transition":return{...C,coherence:"verifying",activity:"unknown",map:{available:!1,complete:!1,floorCoherent:!1,sessionVerified:!1,exactPose:!1}};case"problem":return{...C,activity:"problem",coherence:"blocked"};case"ha-offline":return{...C,coherence:"degraded",host:{...C.host,connected:!1},map:{...C.map,exactPose:!1}};case"robot-offline":return{...C,coherence:"degraded",host:{...C.host,robotConnected:!1},map:{...C.map,exactPose:!1}};case"access":return{...C,coherence:"blocked",host:{...C.host,administrator:!1},map:{...C.map,available:!1,exactPose:!1}};case"empty":return{...C,coherence:"unavailable",host:{...C.host,robotConnected:!1,robotCount:0},map:{...C.map,available:!1,exactPose:!1}};case"unsupported":return{...C,coherence:"blocked",map:{...C.map,available:!1,exactPose:!1}};case"multi-robot":return{...C,host:{...C.host,robotCount:2},robots:[{entryId:"synthetic-entry",label:"Matic robot"},{entryId:"synthetic-entry-two",label:"Second robot"}]}}},p2=["ready","cleaning","paused","returning","recharging","rooms","draw","history","transition","problem","ha-offline","robot-offline","access","empty","unsupported","multi-robot"];var V0=(L,C)=>{if(C?.recharge_and_resume===!0&&C?.charging===!0)return"recharging";switch(L){case"cleaning":return"cleaning";case"paused":return"paused";case"returning":return"returning";case"docked":return"docked";case"idle":return"idle";case"error":return"problem";default:return"unknown"}},L0=L=>typeof L!="number"||!Number.isFinite(L)?null:Math.round(Math.max(0,Math.min(100,L))),e0=L=>{let C=L.attributes?.matic_entry_id;return typeof C=="string"&&C.length>0?C:null},r0=L=>String(L||"local-user").replaceAll(/[^a-zA-Z0-9_-]/g,"").slice(0,128)||"local-user",M5=L=>{if(typeof L!="string")return"Matic robot";let C=L.trim();return C&&Array.from(C).length<=128&&!/[\u0000-\u001f\u007f]/u.test(C)?C:"Matic robot"},N1=class{#C="";#H=null;project(C,H,V=null){let e=C?.states??{},r=H?.config?.entry_id,M=typeof r=="string"?r:null,t=null,o=null,i=null,a=new Map;for(let[S,g]of Object.entries(e)){let P=e0(g);if(!P||!S.startsWith("vacuum."))continue;a.set(P,{entryId:P,label:M5(g.attributes?.friendly_name)});let _1=V||M;(!t||_1&&P===_1)&&(t=g,o=S,i=P)}let n={connected:C?.connected!==!1,administrator:C?.user?.is_admin===!0,robotConnected:t!==null&&t.state!=="unavailable"&&t.state!=="unknown",robotCount:a.size},A=t?V0(t.state,t.attributes):"unknown",s=L0(t?.attributes?.battery_level),v=C?.selectedLanguage||C?.language||"en",x=r0(C?.user?.id),u=M5(t?.attributes?.friendly_name),m=[...a.values()].sort((S,g)=>S.label.localeCompare(g.label,v,{sensitivity:"base"})),h=[n.connected,n.administrator,n.robotConnected,n.robotCount,A,s??"none",v,x,o??"none",i??"none",u,m.map(S=>`${S.entryId}:${S.label}`).join(",")].join("|");return h===this.#C&&this.#H?this.#H:(this.#C=h,this.#H={host:n,activity:A,batteryPercent:s,language:v,userKey:x,vacuumEntityId:o,entryKey:i,robotLabel:u,robots:m},this.#H)}};var z1=globalThis,U1=z1.ShadowRoot&&(z1.ShadyCSS===void 0||z1.ShadyCSS.nativeShadow)&&"adoptedStyleSheets"in Document.prototype&&"replace"in CSSStyleSheet.prototype,m2=Symbol(),t5=new WeakMap,S1=class{constructor(C,H,V){if(this._$cssResult$=!0,V!==m2)throw Error("CSSResult is not constructable. Use `unsafeCSS` or `css` instead.");this.cssText=C,this.t=H}get styleSheet(){let C=this.o,H=this.t;if(U1&&C===void 0){let V=H!==void 0&&H.length===1;V&&(C=t5.get(H)),C===void 0&&((this.o=C=new CSSStyleSheet).replaceSync(this.cssText),V&&t5.set(H,C))}return C}toString(){return this.cssText}},o5=L=>new S1(typeof L=="string"?L:L+"",void 0,m2),y=(L,...C)=>{let H=L.length===1?L[0]:C.reduce((V,e,r)=>V+(M=>{if(M._$cssResult$===!0)return M.cssText;if(typeof M=="number")return M;throw Error("Value passed to 'css' function must be a 'css' function result: "+M+". Use 'unsafeCSS' to pass non-literal values, but take care to ensure page security.")})(e)+L[r+1],L[0]);return new S1(H,L,m2)},i5=(L,C)=>{if(U1)L.adoptedStyleSheets=C.map(H=>H instanceof CSSStyleSheet?H:H.styleSheet);else for(let H of C){let V=document.createElement("style"),e=z1.litNonce;e!==void 0&&V.setAttribute("nonce",e),V.textContent=H.cssText,L.appendChild(V)}},v2=U1?L=>L:L=>L instanceof CSSStyleSheet?(C=>{let H="";for(let V of C.cssRules)H+=V.cssText;return o5(H)})(L):L;var{is:M0,defineProperty:t0,getOwnPropertyDescriptor:o0,getOwnPropertyNames:i0,getOwnPropertySymbols:a0,getPrototypeOf:n0}=Object,G1=globalThis,a5=G1.trustedTypes,A0=a5?a5.emptyScript:"",d0=G1.reactiveElementPolyfillSupport,h1=(L,C)=>L,c2={toAttribute(L,C){switch(C){case Boolean:L=L?A0:null;break;case Object:case Array:L=L==null?L:JSON.stringify(L)}return L},fromAttribute(L,C){let H=L;switch(C){case Boolean:H=L!==null;break;case Number:H=L===null?null:Number(L);break;case Object:case Array:try{H=JSON.parse(L)}catch{H=null}}return H}},A5=(L,C)=>!M0(L,C),n5={attribute:!0,type:String,converter:c2,reflect:!1,useDefault:!1,hasChanged:A5};Symbol.metadata??=Symbol("metadata"),G1.litPropertyMetadata??=new WeakMap;var K=class extends HTMLElement{static addInitializer(C){this._$Ei(),(this.l??=[]).push(C)}static get observedAttributes(){return this.finalize(),this._$Eh&&[...this._$Eh.keys()]}static createProperty(C,H=n5){if(H.state&&(H.attribute=!1),this._$Ei(),this.prototype.hasOwnProperty(C)&&((H=Object.create(H)).wrapped=!0),this.elementProperties.set(C,H),!H.noAccessor){let V=Symbol(),e=this.getPropertyDescriptor(C,V,H);e!==void 0&&t0(this.prototype,C,e)}}static getPropertyDescriptor(C,H,V){let{get:e,set:r}=o0(this.prototype,C)??{get(){return this[H]},set(M){this[H]=M}};return{get:e,set(M){let t=e?.call(this);r?.call(this,M),this.requestUpdate(C,t,V)},configurable:!0,enumerable:!0}}static getPropertyOptions(C){return this.elementProperties.get(C)??n5}static _$Ei(){if(this.hasOwnProperty(h1("elementProperties")))return;let C=n0(this);C.finalize(),C.l!==void 0&&(this.l=[...C.l]),this.elementProperties=new Map(C.elementProperties)}static finalize(){if(this.hasOwnProperty(h1("finalized")))return;if(this.finalized=!0,this._$Ei(),this.hasOwnProperty(h1("properties"))){let H=this.properties,V=[...i0(H),...a0(H)];for(let e of V)this.createProperty(e,H[e])}let C=this[Symbol.metadata];if(C!==null){let H=litPropertyMetadata.get(C);if(H!==void 0)for(let[V,e]of H)this.elementProperties.set(V,e)}this._$Eh=new Map;for(let[H,V]of this.elementProperties){let e=this._$Eu(H,V);e!==void 0&&this._$Eh.set(e,H)}this.elementStyles=this.finalizeStyles(this.styles)}static finalizeStyles(C){let H=[];if(Array.isArray(C)){let V=new Set(C.flat(1/0).reverse());for(let e of V)H.unshift(v2(e))}else C!==void 0&&H.push(v2(C));return H}static _$Eu(C,H){let V=H.attribute;return V===!1?void 0:typeof V=="string"?V:typeof C=="string"?C.toLowerCase():void 0}constructor(){super(),this._$Ep=void 0,this.isUpdatePending=!1,this.hasUpdated=!1,this._$Em=null,this._$Ev()}_$Ev(){this._$ES=new Promise(C=>this.enableUpdating=C),this._$AL=new Map,this._$E_(),this.requestUpdate(),this.constructor.l?.forEach(C=>C(this))}addController(C){(this._$EO??=new Set).add(C),this.renderRoot!==void 0&&this.isConnected&&C.hostConnected?.()}removeController(C){this._$EO?.delete(C)}_$E_(){let C=new Map,H=this.constructor.elementProperties;for(let V of H.keys())this.hasOwnProperty(V)&&(C.set(V,this[V]),delete this[V]);C.size>0&&(this._$Ep=C)}createRenderRoot(){let C=this.shadowRoot??this.attachShadow(this.constructor.shadowRootOptions);return i5(C,this.constructor.elementStyles),C}connectedCallback(){this.renderRoot??=this.createRenderRoot(),this.enableUpdating(!0),this._$EO?.forEach(C=>C.hostConnected?.())}enableUpdating(C){}disconnectedCallback(){this._$EO?.forEach(C=>C.hostDisconnected?.())}attributeChangedCallback(C,H,V){this._$AK(C,V)}_$ET(C,H){let V=this.constructor.elementProperties.get(C),e=this.constructor._$Eu(C,V);if(e!==void 0&&V.reflect===!0){let r=(V.converter?.toAttribute!==void 0?V.converter:c2).toAttribute(H,V.type);this._$Em=C,r==null?this.removeAttribute(e):this.setAttribute(e,r),this._$Em=null}}_$AK(C,H){let V=this.constructor,e=V._$Eh.get(C);if(e!==void 0&&this._$Em!==e){let r=V.getPropertyOptions(e),M=typeof r.converter=="function"?{fromAttribute:r.converter}:r.converter?.fromAttribute!==void 0?r.converter:c2;this._$Em=e;let t=M.fromAttribute(H,r.type);this[e]=t??this._$Ej?.get(e)??t,this._$Em=null}}requestUpdate(C,H,V,e=!1,r){if(C!==void 0){let M=this.constructor;if(e===!1&&(r=this[C]),V??=M.getPropertyOptions(C),!((V.hasChanged??A5)(r,H)||V.useDefault&&V.reflect&&r===this._$Ej?.get(C)&&!this.hasAttribute(M._$Eu(C,V))))return;this.C(C,H,V)}this.isUpdatePending===!1&&(this._$ES=this._$EP())}C(C,H,{useDefault:V,reflect:e,wrapped:r},M){V&&!(this._$Ej??=new Map).has(C)&&(this._$Ej.set(C,M??H??this[C]),r!==!0||M!==void 0)||(this._$AL.has(C)||(this.hasUpdated||V||(H=void 0),this._$AL.set(C,H)),e===!0&&this._$Em!==C&&(this._$Eq??=new Set).add(C))}async _$EP(){this.isUpdatePending=!0;try{await this._$ES}catch(H){Promise.reject(H)}let C=this.scheduleUpdate();return C!=null&&await C,!this.isUpdatePending}scheduleUpdate(){return this.performUpdate()}performUpdate(){if(!this.isUpdatePending)return;if(!this.hasUpdated){if(this.renderRoot??=this.createRenderRoot(),this._$Ep){for(let[e,r]of this._$Ep)this[e]=r;this._$Ep=void 0}let V=this.constructor.elementProperties;if(V.size>0)for(let[e,r]of V){let{wrapped:M}=r,t=this[e];M!==!0||this._$AL.has(e)||t===void 0||this.C(e,void 0,r,t)}}let C=!1,H=this._$AL;try{C=this.shouldUpdate(H),C?(this.willUpdate(H),this._$EO?.forEach(V=>V.hostUpdate?.()),this.update(H)):this._$EM()}catch(V){throw C=!1,this._$EM(),V}C&&this._$AE(H)}willUpdate(C){}_$AE(C){this._$EO?.forEach(H=>H.hostUpdated?.()),this.hasUpdated||(this.hasUpdated=!0,this.firstUpdated(C)),this.updated(C)}_$EM(){this._$AL=new Map,this.isUpdatePending=!1}get updateComplete(){return this.getUpdateComplete()}getUpdateComplete(){return this._$ES}shouldUpdate(C){return!0}update(C){this._$Eq&&=this._$Eq.forEach(H=>this._$ET(H,this[H])),this._$EM()}updated(C){}firstUpdated(C){}};K.elementStyles=[],K.shadowRootOptions={mode:"open"},K[h1("elementProperties")]=new Map,K[h1("finalized")]=new Map,d0?.({ReactiveElement:K}),(G1.reactiveElementVersions??=[]).push("2.1.2");var g2=globalThis,d5=L=>L,Q1=g2.trustedTypes,l5=Q1?Q1.createPolicy("lit-html",{createHTML:L=>L}):void 0,x5="$lit$",j=`lit$${Math.random().toFixed(9).slice(2)}$`,u5="?"+j,l0=`<${u5}>`,L1=document,g1=()=>L1.createComment(""),y1=L=>L===null||typeof L!="object"&&typeof L!="function",y2=Array.isArray,s0=L=>y2(L)||typeof L?.[Symbol.iterator]=="function",x2=`[ \t\n\f\r]`,f1=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,s5=/-->/g,p5=/>/g,H1=RegExp(`>|${x2}(?:([^\\s"'>=/]+)(${x2}*=${x2}*(?:[^ \t\n\f\r"'\`<>=]|("|')|))|$)`,"g"),m5=/'/g,v5=/"/g,Z5=/^(?:script|style|textarea|title)$/i,b2=L=>(C,...H)=>({_$litType$:L,strings:C,values:H}),l=b2(1),S5=b2(2),h5=b2(3),e1=Symbol.for("lit-noChange"),d=Symbol.for("lit-nothing"),c5=new WeakMap,V1=L1.createTreeWalker(L1,129);function f5(L,C){if(!y2(L)||!L.hasOwnProperty("raw"))throw Error("invalid template strings array");return l5!==void 0?l5.createHTML(C):C}var p0=(L,C)=>{let H=L.length-1,V=[],e,r=C===2?"<svg>":C===3?"<math>":"",M=f1;for(let t=0;t<H;t++){let o=L[t],i,a,n=-1,A=0;for(;A<o.length&&(M.lastIndex=A,a=M.exec(o),a!==null);)A=M.lastIndex,M===f1?a[1]==="!--"?M=s5:a[1]!==void 0?M=p5:a[2]!==void 0?(Z5.test(a[2])&&(e=RegExp("</"+a[2],"g")),M=H1):a[3]!==void 0&&(M=H1):M===H1?a[0]===">"?(M=e??f1,n=-1):a[1]===void 0?n=-2:(n=M.lastIndex-a[2].length,i=a[1],M=a[3]===void 0?H1:a[3]==='"'?v5:m5):M===v5||M===m5?M=H1:M===s5||M===p5?M=f1:(M=H1,e=void 0);let s=M===H1&&L[t+1].startsWith("/>")?" ":"";r+=M===f1?o+l0:n>=0?(V.push(i),o.slice(0,n)+x5+o.slice(n)+j+s):o+j+(n===-2?t:s)}return[f5(L,r+(L[H]||"<?>")+(C===2?"</svg>":C===3?"</math>":"")),V]},b1=class L{constructor({strings:C,_$litType$:H},V){let e;this.parts=[];let r=0,M=0,t=C.length-1,o=this.parts,[i,a]=p0(C,H);if(this.el=L.createElement(i,V),V1.currentNode=this.el.content,H===2||H===3){let n=this.el.content.firstChild;n.replaceWith(...n.childNodes)}for(;(e=V1.nextNode())!==null&&o.length<t;){if(e.nodeType===1){if(e.hasAttributes())for(let n of e.getAttributeNames())if(n.endsWith(x5)){let A=a[M++],s=e.getAttribute(n).split(j),v=/([.?@])?(.*)/.exec(A);o.push({type:1,index:r,name:v[2],strings:s,ctor:v[1]==="."?Z2:v[1]==="?"?S2:v[1]==="@"?h2:s1}),e.removeAttribute(n)}else n.startsWith(j)&&(o.push({type:6,index:r}),e.removeAttribute(n));if(Z5.test(e.tagName)){let n=e.textContent.split(j),A=n.length-1;if(A>0){e.textContent=Q1?Q1.emptyScript:"";for(let s=0;s<A;s++)e.append(n[s],g1()),V1.nextNode(),o.push({type:2,index:++r});e.append(n[A],g1())}}}else if(e.nodeType===8)if(e.data===u5)o.push({type:2,index:r});else{let n=-1;for(;(n=e.data.indexOf(j,n+1))!==-1;)o.push({type:7,index:r}),n+=j.length-1}r++}}static createElement(C,H){let V=L1.createElement("template");return V.innerHTML=C,V}};function l1(L,C,H=L,V){if(C===e1)return C;let e=V!==void 0?H._$Co?.[V]:H._$Cl,r=y1(C)?void 0:C._$litDirective$;return e?.constructor!==r&&(e?._$AO?.(!1),r===void 0?e=void 0:(e=new r(L),e._$AT(L,H,V)),V!==void 0?(H._$Co??=[])[V]=e:H._$Cl=e),e!==void 0&&(C=l1(L,e._$AS(L,C.values),e,V)),C}var u2=class{constructor(C,H){this._$AV=[],this._$AN=void 0,this._$AD=C,this._$AM=H}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}u(C){let{el:{content:H},parts:V}=this._$AD,e=(C?.creationScope??L1).importNode(H,!0);V1.currentNode=e;let r=V1.nextNode(),M=0,t=0,o=V[0];for(;o!==void 0;){if(M===o.index){let i;o.type===2?i=new O1(r,r.nextSibling,this,C):o.type===1?i=new o.ctor(r,o.name,o.strings,this,C):o.type===6&&(i=new f2(r,this,C)),this._$AV.push(i),o=V[++t]}M!==o?.index&&(r=V1.nextNode(),M++)}return V1.currentNode=L1,e}p(C){let H=0;for(let V of this._$AV)V!==void 0&&(V.strings!==void 0?(V._$AI(C,V,H),H+=V.strings.length-2):V._$AI(C[H])),H++}},O1=class L{get _$AU(){return this._$AM?._$AU??this._$Cv}constructor(C,H,V,e){this.type=2,this._$AH=d,this._$AN=void 0,this._$AA=C,this._$AB=H,this._$AM=V,this.options=e,this._$Cv=e?.isConnected??!0}get parentNode(){let C=this._$AA.parentNode,H=this._$AM;return H!==void 0&&C?.nodeType===11&&(C=H.parentNode),C}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(C,H=this){C=l1(this,C,H),y1(C)?C===d||C==null||C===""?(this._$AH!==d&&this._$AR(),this._$AH=d):C!==this._$AH&&C!==e1&&this._(C):C._$litType$!==void 0?this.$(C):C.nodeType!==void 0?this.T(C):s0(C)?this.k(C):this._(C)}O(C){return this._$AA.parentNode.insertBefore(C,this._$AB)}T(C){this._$AH!==C&&(this._$AR(),this._$AH=this.O(C))}_(C){this._$AH!==d&&y1(this._$AH)?this._$AA.nextSibling.data=C:this.T(L1.createTextNode(C)),this._$AH=C}$(C){let{values:H,_$litType$:V}=C,e=typeof V=="number"?this._$AC(C):(V.el===void 0&&(V.el=b1.createElement(f5(V.h,V.h[0]),this.options)),V);if(this._$AH?._$AD===e)this._$AH.p(H);else{let r=new u2(e,this),M=r.u(this.options);r.p(H),this.T(M),this._$AH=r}}_$AC(C){let H=c5.get(C.strings);return H===void 0&&c5.set(C.strings,H=new b1(C)),H}k(C){y2(this._$AH)||(this._$AH=[],this._$AR());let H=this._$AH,V,e=0;for(let r of C)e===H.length?H.push(V=new L(this.O(g1()),this.O(g1()),this,this.options)):V=H[e],V._$AI(r),e++;e<H.length&&(this._$AR(V&&V._$AB.nextSibling,e),H.length=e)}_$AR(C=this._$AA.nextSibling,H){for(this._$AP?.(!1,!0,H);C!==this._$AB;){let V=d5(C).nextSibling;d5(C).remove(),C=V}}setConnected(C){this._$AM===void 0&&(this._$Cv=C,this._$AP?.(C))}},s1=class{get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}constructor(C,H,V,e,r){this.type=1,this._$AH=d,this._$AN=void 0,this.element=C,this.name=H,this._$AM=e,this.options=r,V.length>2||V[0]!==""||V[1]!==""?(this._$AH=Array(V.length-1).fill(new String),this.strings=V):this._$AH=d}_$AI(C,H=this,V,e){let r=this.strings,M=!1;if(r===void 0)C=l1(this,C,H,0),M=!y1(C)||C!==this._$AH&&C!==e1,M&&(this._$AH=C);else{let t=C,o,i;for(C=r[0],o=0;o<r.length-1;o++)i=l1(this,t[V+o],H,o),i===e1&&(i=this._$AH[o]),M||=!y1(i)||i!==this._$AH[o],i===d?C=d:C!==d&&(C+=(i??"")+r[o+1]),this._$AH[o]=i}M&&!e&&this.j(C)}j(C){C===d?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,C??"")}},Z2=class extends s1{constructor(){super(...arguments),this.type=3}j(C){this.element[this.name]=C===d?void 0:C}},S2=class extends s1{constructor(){super(...arguments),this.type=4}j(C){this.element.toggleAttribute(this.name,!!C&&C!==d)}},h2=class extends s1{constructor(C,H,V,e,r){super(C,H,V,e,r),this.type=5}_$AI(C,H=this){if((C=l1(this,C,H,0)??d)===e1)return;let V=this._$AH,e=C===d&&V!==d||C.capture!==V.capture||C.once!==V.once||C.passive!==V.passive,r=C!==d&&(V===d||e);e&&this.element.removeEventListener(this.name,this,V),r&&this.element.addEventListener(this.name,this,C),this._$AH=C}handleEvent(C){typeof this._$AH=="function"?this._$AH.call(this.options?.host??this.element,C):this._$AH.handleEvent(C)}},f2=class{constructor(C,H,V){this.element=C,this.type=6,this._$AN=void 0,this._$AM=H,this.options=V}get _$AU(){return this._$AM._$AU}_$AI(C){l1(this,C)}};var m0=g2.litHtmlPolyfillSupport;m0?.(b1,O1),(g2.litHtmlVersions??=[]).push("3.3.3");var g5=(L,C,H)=>{let V=H?.renderBefore??C,e=V._$litPart$;if(e===void 0){let r=H?.renderBefore??null;V._$litPart$=e=new O1(C.insertBefore(g1(),r),r,void 0,H??{})}return e._$AI(L),e};var O2=globalThis,b=class extends K{constructor(){super(...arguments),this.renderOptions={host:this},this._$Do=void 0}createRenderRoot(){let C=super.createRenderRoot();return this.renderOptions.renderBefore??=C.firstChild,C}update(C){let H=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(C),this._$Do=g5(H,this.renderRoot,this.renderOptions)}connectedCallback(){super.connectedCallback(),this._$Do?.setConnected(!0)}disconnectedCallback(){super.disconnectedCallback(),this._$Do?.setConnected(!1)}render(){return e1}};b._$litElement$=!0,b.finalized=!0,O2.litElementHydrateSupport?.({LitElement:b});var v0=O2.litElementPolyfillSupport;v0?.({LitElement:b});(O2.litElementVersions??=[]).push("4.2.2");var E=y`
:host {
...
`;var b5=Symbol.for(""),c0=L=>{if(L?.r===b5)return L?._$litStatic$},Y=L=>({_$litStatic$:L,r:b5});var y5=new Map,w2=L=>(C,...H)=>{let V=H.length,e,r,M=[],t=[],o,i=0,a=!1;for(;i<V;){for(o=C[i];i<V&&(r=H[i],(e=c0(r))!==void 0);)o+=e+C[++i],a=!0;i!==V&&t.push(r),M.push(o),i++}if(i===V&&M.push(C[V]),a){let n=M.join("$$lit$$");(C=y5.get(n))===void 0&&(M.raw=M,y5.set(n,C=M)),H=t}return L(C,...H)},Z=w2(l),P7=w2(S5),B7=w2(h5);var O5=import.meta.url.match(/\/matic_robot\/[^/]+-([a-f0-9]{12})\/map-studio-v4(?:\/|$)/u)?.[1]??"dev",w1=O5==="dev"?"":`-${O5}`,k1=`matic-map-canvas-v4${w1}`,P1=`matic-precision-controls-v4${w1}`,p1=`matic-map-workflow-v4${w1}`,r1=`matic-map-shell-v4${w1}`,k2=`matic-map-panel-v0-4-0${w1}`;var m1=y`
.ms-btn, .ms-row {
...
.map-root { border: 1px solid CanvasText; }
  ...
  `]}#C;#H;#V;#t;#e;#L;#o;#A;#r(H,V,e){return T(this.localize,H,V,e)}connectedCallback(){super.connectedCallback(),this.#m()}firstUpdated(){let H=this.renderRoot.querySelector(".map-root"),V=this.renderRoot.querySelector(".scene-canvas"),e=this.renderRoot.querySelector(".overlay-canvas");!H||!V||!e||(this.#V=new X1(V,e,{onCamera:(r,M,t)=>{this.#i({type:"set-camera",view:this.state.workflow==="draw"?"top":this.state.view,camera:{yaw:r.yaw,pitch:r.pitch,zoom:M/100,targetX:r.targetX,targetZ:r.targetZ}}),this.state.workflow==="draw"&&M!==this.state.draw.zoomPercent&&this.#i({type:"set-zoom",value:M,...t?{originX:t.xPercent,originY:t.yPercent}:{}})},onRoom:r=>this.#i({type:"toggle-room",roomId:r}),onProblem:()=>this.#h("renderer-problem")}),this.#t=new q1(H,this.#V,{state:()=>this.state,onCircles:(r,M,t)=>this.#i({type:"set-draft-circles",circles:r,record:M,...t?{previous:t}:{}}),onRoom:r=>this.#i({type:"toggle-room",roomId:r})}),this.#n(),this.#V.setState(this.state))}disconnectedCallback(){this.#S(),this.#t?.dispose(),this.#t=null,this.#V?.dispose(),this.#V=null,super.disconnectedCallback()}updated(H){if(this.#L&&(this.#L=!1,this.renderRoot.querySelector(".navigation-help button")?.focus()),!H.has("state"))return;H.get("state")?.fullMap&&!this.state.fullMap&&this.#C&&this.#C.focus(),this.#V?.setState(this.state)}#n(){let H=this.renderRoot?.querySelector(".map-root");!H||!this.#V||this.#V.setPalette(i3(H))}#s;#m(){if(!(typeof document>"u"||this.#o)&&(this.#o=new MutationObserver(this.#s),this.#o.observe(document.documentElement,{attributes:!0,attributeFilter:["style","class"]}),typeof window.matchMedia=="function")){this.#A=[window.matchMedia("(prefers-color-scheme: dark)"),window.matchMedia("(forced-colors: active)")];for(let H of this.#A)H.addEventListener("change",this.#s)}}#S(){this.#o?.disconnect(),this.#o=null;for(let H of this.#A)H.removeEventListener("change",this.#s);this.#A=[]}#i(H){this.dispatchEvent(new CustomEvent(t1,{detail:H,bubbles:!0,composed:!0}))}#h(H){this.dispatchEvent(new CustomEvent(j1,{detail:{id:H},bubbles:!0,composed:!0}))}#p(H){this.#C=H.currentTarget,this.#i({type:this.state.fullMap?"exit-full-map":"enter-full-map"})}#a(H){this.#H=H.currentTarget,this.#e=!this.#e,this.#L=this.#e,this.requestUpdate()}#v(){if(!this.#e)return;this.#e=!1,this.requestUpdate();let H=this.#H;H?.isConnected&&H.focus()}#u(){for(let H of this.state.selection.roomIds)this.#i({type:"toggle-room",roomId:H})}#x(H,V){this.#V?.orbitBy(H,V)}#M(H){if(!(H.ctrlKey||H.metaKey||H.altKey)&&H.key==="Escape"){if(H.preventDefault(),this.#e){this.#v();return}this.#i({type:"dismiss-top-layer"});return}}rendererDiagnostics(){return this.#V?.diagnostics()??null}canvasIdentity(){return{scene:this.renderRoot.querySelector(".scene-canvas"),overlay:this.renderRoot.querySelector(".overlay-canvas")}}#d(){return this.state.host.connected?this.state.host.administrator?this.state.host.robotCount===0?{title:this.#r("v4_no_robot","No Matic robot set up"),detail:this.#r("v4_no_robot_detail","Set up a robot before opening its map.")}:this.state.host.robotConnected?this.state.coherence==="verifying"||this.state.coherence==="booting"?{title:this.#r("v4_locating_map","Locating the current map"),detail:this.#r("v4_locating_map_detail","Map controls will return after the floor is verified.")}:!this.state.map.available&&this.state.resources.scene.status==="loading"?{title:this.#r("v4_loading_verified_map","Loading the verified map"),detail:this.#r("v4_loading_verified_map_detail","The current floor is verified. The private scene is still preparing.")}:this.state.map.available?this.state.activity==="problem"?{title:this.#r("v4_robot_attention","Robot needs attention"),detail:this.#r("v4_robot_attention_detail","Check the robot before starting another task.")}:null:{title:this.#r("v4_map_unavailable","Map unavailable"),detail:this.#r("v4_map_unavailable_detail","The private scene is not ready. No map data is shown until it is verified.")}:{title:this.#r("v4_robot_offline","Robot offline"),detail:this.#r("v4_robot_offline_detail","The last verified map stays read only and has no live position.")}:{title:this.#r("v4_admin_required","Administrator access required"),detail:this.#r("v4_private_map_hidden","Private map data is hidden.")}:{title:this.#r("v4_reconnecting","Reconnecting"),detail:this.#r("v4_reconnecting_detail","The verified map is read only until Home Assistant reconnects.")}}#c(H,V){let e=this.state,r=this.narrow,M=e.workflow==="draw",t=this.#r("v4_how_to_move","How to move the map"),o=H&&!M,i=o&&!r&&e.view==="top",a=o&&e.view==="three",n=!V||e.fullMap,A=!r&&!M;return!o&&!n?d:l`
    ...
    `}#l(H){let V=this.state;if(!H)return d;if(V.workflow==="draw"&&!this.narrow)return l`
      ...
      `;let e=V.selection.roomIds.length;return V.workflow==="rooms"&&e>0&&!this.narrow?l`
        <div class="map-dock ms-surface ms-surface--floating" data-map-control>
      ...
      `:d}render(){let H=this.state,V=H5(H),e=this.#d(),r=H.map.available&&(A1(H)||H.dataMode==="history"),M=H.workflow==="draw"&&r,t=H.coherence==="verifying"||H.coherence==="booting";return l`
      <section
        class="map-root"
        tabindex="0"
      ...
      >
        ...
        ${e&&!(H.fullMap&&(t||!H.host.administrator))?l`
    ...
    `}};customElements.get(k1)||customElements.define(k1,B2);var T2=class extends b{constructor(){super(...arguments);this.state=k();this.compact=!1}static{this.properties={state:{attribute:!1},localize:{attribute:!1},compact:{type:Boolean,reflect:!0}}}static{this.styles=[E,D,m1,y`
...
`]}#C(H,V){return T(this.localize,H,V)}#H(H){this.dispatchEvent(new CustomEvent(t1,{detail:H,bubbles:!0,composed:!0}))}#V(H,V){let e=H.currentTarget.valueAsNumber;Number.isFinite(e)&&this.#H(V==="zoom"?{type:"set-zoom",value:e}:{type:"set-brush",value:e})}render(){let{draw:H}=this.state;return l`
    ...
    `}};customElements.get(P1)||customElements.define(P1,T2);var R2=["vacuum","mop","vacuum_and_mop"],_2=["quick","standard","heavy_duty"],$=L=>L.currentTarget.value,F2=L=>L.currentTarget.checked,E2=class extends b{constructor(){super(...arguments);this.state=k();this._copyStatus="idle"}static{this.properties={state:{attribute:!1},localize:{attribute:!1},_copyStatus:{state:!0}}}static{this.styles=[E,D,m1,y`
...
`]}#C;disconnectedCallback(){this.#C!==void 0&&clearTimeout(this.#C),this.#C=void 0,super.disconnectedCallback()}#H(H,V,e){return T(this.localize,H,V,e)}#V(H){return H==="vacuum"?this.#H("vacuum","Vacuum"):H==="mop"?this.#H("mop","Mop"):this.#H("vacuum_and_mop","Vacuum + mop")}#t(H){return H==="quick"?this.#H("quick","Quick"):H==="standard"?this.#H("standard","Optimal"):this.#H("heavy_duty","Heavy Duty")}#e(H){this.dispatchEvent(new CustomEvent(t1,{detail:H,bubbles:!0,composed:!0}))}#L(){return this.state.notice?l`
...
`),V=typeof navigator>"u"?void 0:navigator.clipboard;if(!V||typeof V.writeText!="function"){this.#u("failed");return}let e;try{e=V.writeText(H)}catch{this.#u("failed");return}e.then(()=>this.#u("copied"),()=>this.#u("failed"))}#M(){let H=this.#v(),V=this._copyStatus==="copied"?this.#H("v4_copied","Copied"):this._copyStatus==="failed"?this.#H("v4_copy_failed","The summary could not be copied. Select the text to copy it by hand."):"";return l`
  ...
  `]}#C(H,V,e){return T(this.localize,H,V,e)}#H;#V;#t;#e;#L;#o;#A;#r;connectedCallback(){super.connectedCallback(),this.#H=new ResizeObserver(([H])=>{if(!H)return;let V=H.contentRect.width<768||H.contentRect.height<480;V!==this._measuredNarrow&&(this._measuredNarrow=V)}),this.#H.observe(this),window.addEventListener("pointerdown",this.#r,!0),document.addEventListener("fullscreenchange",this.#A),this.#V=new ResizeObserver(([H])=>{if(!H)return;let V=Math.ceil(H.target.getBoundingClientRect().height);V!==this._sheetOffset&&(this._sheetOffset=V)})}disconnectedCallback(){this.#H?.disconnect(),this.#H=null,this.#V?.disconnect(),this.#V=null,this.#t=null,window.removeEventListener("pointerdown",this.#r,!0),document.removeEventListener("fullscreenchange",this.#A),super.disconnectedCallback()}updated(H){let V=this.renderRoot.querySelector(".mobile-sheet");if(V!==this.#t&&(this.#V?.disconnect(),this.#t=V,V&&this.#V?.observe(V)),H.has("state")){let e=H.get("state");if(e?.precisionOpen&&!this.state.precisionOpen&&this.#e?.focus(),!e?.dialog&&this.state.dialog){let r=E0(this.shadowRoot||document);r?.hasAttribute("data-dialog-launcher")&&(this.#L=r),this.updateComplete.then(()=>{this.renderRoot.querySelector(".dialog button")?.focus()})}else if(e?.dialog&&!this.state.dialog){let r=this.#L?.isConnected&&this.#L.hasAttribute("data-dialog-launcher")?this.#L:this.#w(e.dialog);this.#L=null,this.updateComplete.then(()=>{requestAnimationFrame(()=>r?.focus({preventScroll:!0}))})}(!e||e.workflow!==this.state.workflow)&&(this._sheetDetent="half")}}#n(H){this.dispatchEvent(new CustomEvent(t1,{detail:H,bubbles:!0,composed:!0}))}#s(H){if(H.enabled){if(H.id==="return-live"){this.#n({type:"set-history",historyId:null});return}this.#p(H.id)}}#m(H){if(this.state.workflow==="draw"&&this.state.draw.dirty&&H!=="draw"&&H!=="areaReview"){this.#o=H,this.#n({type:"open-dialog",dialog:"discardDraft"});return}this.#n({type:"open-workflow",workflow:H})}#S(){let H=this.#o;this.#o=null,this.#n({type:"discard-draft"}),H&&queueMicrotask(()=>this.#n({type:"open-workflow",workflow:H}))}#i(){this.#o=null,this.#h()}#h(){let H=this.state.dialog,V=H&&this.#L?.isConnected&&this.#L.hasAttribute("data-dialog-launcher")?this.#L:H?this.#w(H):null;this.#n({type:"dismiss-top-layer"}),V&&requestAnimationFrame(()=>V.focus({preventScroll:!0}))}#p(H){this.dispatchEvent(new CustomEvent(j1,{detail:{id:H},bubbles:!0,composed:!0}))}#a(H){this.#n({type:"dismiss-top-layer"}),this.#p(H)}#v(H){if(H.action==="discard"){this.#S();return}if(H.action==="delete-plan"||H.action==="delete-area"){this.#a(H.action);return}this.#n({type:"dismiss-top-layer"}),H.action==="stop"&&this.#p("stop")}#u(){this._sheetDetent=this._sheetDetent==="peek"?"half":this._sheetDetent==="half"?"full":"peek"}#x(){if(this.state.precisionOpen||this.state.fullMap){this.#n({type:"dismiss-top-layer"});return}if(this.state.workflow!=="none"){this.#m("none");return}this.#M()}#M(){this.dispatchEvent(new CustomEvent("hass-toggle-menu",{bubbles:!0,composed:!0}))}#d(H){if(this._overflowOpen=!1,H==="support"){this.#m("support");return}if(H==="fullscreen"){let V=this.renderRoot.querySelector(".app");document.fullscreenElement?document.exitFullscreen():V?.requestFullscreen();return}this.dispatchEvent(new CustomEvent(j1,{detail:{id:"use-classic"},bubbles:!0,composed:!0}))}#c(H){this.#e=H.currentTarget,this.#n({type:"set-precision-open",value:!this.state.precisionOpen})}#l(H){let V=H;if(V.detail?.type!=="open-dialog")return;let e=V.composedPath().find(r=>r instanceof HTMLElement&&r.hasAttribute("data-dialog-launcher"));e instanceof HTMLElement&&(this.#L=e)}#w(H){return this.renderRoot.querySelector(p1)?.shadowRoot?.querySelector(`[data-dialog-launcher="${H}"]`)??null}#g(H){if(!(H.defaultPrevented||H.ctrlKey||H.metaKey||H.altKey)&&H.key==="Escape"){if(H.preventDefault(),this._overflowOpen){this._overflowOpen=!1;return}this.#n({type:"dismiss-top-layer"})}}#y(H){if(H.key!=="Tab")return;let V=[...this.renderRoot.querySelectorAll(".dialog button:not(:disabled)")],e=V[0],r=V.at(-1);!e||!r||(H.shiftKey&&this.shadowRoot?.activeElement===e?(H.preventDefault(),r.focus()):!H.shiftKey&&this.shadowRoot?.activeElement===r&&(H.preventDefault(),e.focus()))}#b(H,V="primary-action"){if(H.id==="choose-cleaning")return d;let r={stop:["v4_stop","Stop"],resume:["v4_resume","Resume"],"review-area":["v4_review_details","Review details"],"save-area":["area_save","Save area"],"run-area":["area_run","Clean area"],"save-plan":["plan_save","Save plan"],"run-plan":["plan_run","Run plan"]}[H.id],M=H.id==="clean-rooms"?H.label:r?this.#C(r[0],r[1]):H.label;return Z`
    ...
    ></${x3}>`}render(){let H=this.state,V=H.narrowHint||this._measuredNarrow,e=R0(H,this.localize),r=_0(H,this.localize),M=J2({...H,narrowHint:V}),t=C5(H),o=!V&&M.id==="stop"?M:!V&&t?.id==="stop"?t:null,i=o===M?null:M,a=o===t?null:t,n=H.workflow==="draw"&&(V||H.fullMap),A=H.fullMap&&(H.coherence==="verifying"||H.coherence==="booting"),s=H.fullMap||H.precisionOpen,v=F0(H.dialog,this.localize),x=H.resources.history.value?.floors||[],u=x.length?x.map((m,h)=>({id:m.active?"current":m.id,label:`${m.label||(m.active?this.#C("v4_current_floor","Current floor"):this.#C("v4_saved_floor","Saved floor {number}",{number:m.ordinal??h+1}))}${!m.active&&m.snapshots.length===0?` \xB7 ${this.#C("v4_floor_not_captured","Visit floor to capture")}`:""}`,disabled:!m.active&&m.snapshots.length===0})):[{id:H.selection.floorId,label:H.floor.displayName,disabled:!1}];return Z`
          ...
          <main class=${`workspace ${H.fullMap?"full-map":""}`}>
            ...
            ${n?Z`
              <div class="precision-popover">
                ...
                ${H.precisionOpen?Z`
                  <${c3} compact .state=${H} .localize=${this.localize}></${c3}>
                `:d}
              </div>
            `:d}
    ...
    `}};customElements.get(r1)||customElements.define(r1,D2);var u3=Y(r1),$2=class extends b{constructor(){super(...arguments);this.scenario="ready";this.narrow=!1;this.controls=!0;this._workspace=s2("ready");this.#C=new n1(this._workspace);this.#H=null}static{this.properties={scenario:{type:String,reflect:!0},narrow:{type:Boolean,reflect:!0},controls:{type:Boolean,reflect:!0},_workspace:{state:!0}}}static{this.styles=[E,D,y`
    :host {
      display: block;
      color: #1f2933;
      background: #e8edef;
  ...
  `]}#C;#H;connectedCallback(){super.connectedCallback(),this.#H=this.#C.subscribe(H=>{this._workspace=H})}disconnectedCallback(){this.#H?.(),this.#H=null,super.disconnectedCallback()}willUpdate(H){H.has("scenario")?this.#C.replace({...s2(this.scenario),narrowHint:this.narrow}):H.has("narrow")&&this.#C.dispatch({type:"set-narrow-hint",value:this.narrow})}setScenario(H){p2.includes(H)&&(this.scenario=H)}getWorkspaceSnapshot(){return structuredClone(this.#C.value)}replaceWorkspaceState(H){this.#C.replace(structuredClone(H))}#V(H){$1(H.detail)&&(H.stopPropagation(),this.#C.dispatch(H.detail))}render(){return Z`
      ${this.controls?Z`
    ...
    `}};customElements.get("matic-map-studio-gallery-v0-4-0")||customElements.define("matic-map-studio-gallery-v0-4-0",$2);var Z3="/api/matic_robot/slam_entries";var p=class extends Error{constructor(C){super(C),this.name="ContractError",this.code=C}},_=(L,C)=>{if(!L||typeof L!="object"||Array.isArray(L))throw new p(C);return L},O=(L,C,H)=>{if(typeof L!="string")throw new p(H);let V=L.trim();if(!V||Array.from(V).length>C||/[\u0000-\u001f\u007f]/u.test(V))throw new p(H);return V},D0=L=>{if(L==null||L==="")return null;try{return O(L,128,"invalid-floor-label")}catch{return null}},c1=(L,C,H,V)=>{if(typeof L!="number"||!Number.isFinite(L)||L<C||L>H)throw new p(V);return L},N=(L,C,H,V)=>{let e=c1(L,C,H,V);if(!Number.isInteger(e))throw new p(V);return e},I2=(L,C)=>L==null?null:N(L,1,C,"invalid-floor-ordinal"),f=(L,C)=>{if(typeof L!="boolean")throw new p(C);return L},$0=(L,C)=>L===null?null:f(L,C),S3=L=>{if(L==null)return null;let C=O(L,64,"invalid-map-session-key");if(!/^[0-9a-f]{64}$/u.test(C))throw new p("invalid-map-session-key");return C},I0=L=>{if(L==null)return null;if(L==="bootstrap_empty"||L==="map_session_unverified"||L==="floor_plan_unavailable"||L==="floor_plan_mismatch")return L;throw new p("invalid-map-block-reason")},W0=L=>{if(L===void 0)return"not_started";if(L==="not_started"||L==="running"||L==="complete"||L==="partial"||L==="failed")return L;throw new p("invalid-bootstrap-state")},q=(L,C)=>{let H=O(L,512,C);if(!H.startsWith("/")||H.startsWith("//")||H.includes("\\"))throw new p(C);return H},N0=L=>{let C=typeof L.map_health=="string"?L.map_health.toLowerCase():"",H=typeof L.stream_state=="string"?L.stream_state.toLowerCase():"",V=typeof L.invalid_tiles=="number"?L.invalid_tiles:0;return C.includes("error")||C.includes("fail")||C.includes("degrad")||V>0?"problem":L.map_truncated===!0||C.includes("truncat")||C.includes("limit")?"limited":L.map_complete===!0?"ready":H.includes("connect")||H.includes("collect")||H.includes("run")?"building":"unknown"},h3=L=>{let C=_(L,"invalid-catalog");if(!Array.isArray(C.entries)||C.entries.length>64)throw new p("invalid-catalog-entries");return C.entries.map(H=>{let V=_(H,"invalid-catalog-entry"),e=N(V.map_revision,0,Number.MAX_SAFE_INTEGER,"invalid-map-revision");return{entryId:O(V.entry_id,128,"invalid-entry-id"),sceneUrl:q(V.scene_url,"invalid-scene-url"),deltaUrl:V.delta_url===void 0||V.delta_url===null?null:q(V.delta_url,"invalid-delta-url"),poseUrl:q(V.pose_url,"invalid-pose-url"),historyUrl:q(V.history_url,"invalid-history-url"),areasUrl:q(V.areas_url,"invalid-areas-url"),plansUrl:q(V.plans_url,"invalid-plans-url"),mapRevision:e,mapFloorCoherent:f(V.map_floor_coherent,"invalid-floor-coherence"),mapSessionVerified:f(V.map_session_verified,"invalid-session-state"),mapSessionKey:S3(V.map_session_key),mapBlockReason:I0(V.map_block_reason),runnerLocked:f(V.runner_locked,"invalid-runner-lock"),stopSettlePending:f(V.stop_settle_pending,"invalid-stop-settle"),activePlan:f(V.active_plan,"invalid-active-plan"),nativeReconciliationPending:f(V.native_reconciliation_pending,"invalid-native-reconciliation"),nativeSessionActive:$0(V.native_session_active,"invalid-native-session"),mapComplete:f(V.map_complete,"invalid-map-complete"),mapTruncated:f(V.map_truncated,"invalid-map-truncated"),selectedFloorOrdinal:I2(V.selected_floor_ordinal,128),mapFloorOrdinal:I2(V.map_floor_ordinal,128),historyCount:N(V.history_count,0,12,"invalid-history-count"),historyFloorCount:N(V.history_floor_count,0,128,"invalid-floor-count"),health:N0(V),streamFailures:N(V.stream_failures,0,Number.MAX_SAFE_INTEGER,"invalid-stream-failures"),bootstrapState:W0(V.bootstrap_state),bootstrapPhotoSeen:V.bootstrap_photo_seen===void 0?!1:f(V.bootstrap_photo_seen,"invalid-bootstrap-photo"),bootstrapStructureSeen:V.bootstrap_structure_seen===void 0?!1:f(V.bootstrap_structure_seen,"invalid-bootstrap-structure"),bootstrapFailures:V.bootstrap_failures===void 0?0:N(V.bootstrap_failures,0,2,"invalid-bootstrap-failures")}})},f3=(L,C)=>{if(!Array.isArray(L)||L.length!==2)throw new p(C);return[c1(L[0],-1e6,1e6,C),c1(L[1],-1e6,1e6,C)]},z0=(L,C)=>{if(!Array.isArray(L)||L.length<3||L.length>8192)throw new p(C);return L.map(H=>f3(H,C))},g3=(L,C)=>{if(!Array.isArray(L)||L.length>256)throw new p("invalid-rooms");return L.map(H=>{let V=_(H,"invalid-room");return{roomId:O(V.room_id,128,"invalid-room-id"),name:O(V.name,128,"invalid-room-name"),boundary:C?z0(V.boundary,"invalid-room-boundary"):[]}})},U0=L=>{let C=_(L,"invalid-history-snapshot"),H=O(C.created_at,64,"invalid-history-time");if(!Number.isFinite(Date.parse(H)))throw new p("invalid-history-time");return{id:O(C.id,128,"invalid-history-id"),createdAt:H,revision:N(C.revision,0,Number.MAX_SAFE_INTEGER,"invalid-history-revision"),pointCount:N(C.point_count,1,15e5,"invalid-history-points"),sceneUrl:q(C.scene_url,"invalid-history-scene-url")}},y3=L=>{let C=_(L,"invalid-history");if(!Array.isArray(C.floors)||C.floors.length<1||C.floors.length>128)throw new p("invalid-history-floors");return{entryId:O(C.entry_id,128,"invalid-history-entry"),liveAvailable:f(C.live_available,"invalid-history-live"),floors:C.floors.map(H=>{let V=_(H,"invalid-history-floor");if(!Array.isArray(V.snapshots)||V.snapshots.length>12)throw new p("invalid-history-snapshots");return{id:O(V.id,128,"invalid-history-floor-id"),active:f(V.active,"invalid-history-floor-active"),readOnly:f(V.read_only,"invalid-history-floor-read-only"),liveAvailable:V.live_available===void 0?!1:f(V.live_available,"invalid-history-floor-live"),label:D0(V.label),ordinal:V.ordinal===void 0?null:I2(V.ordinal,128),snapshots:V.snapshots.map(U0)}})}},b3=L=>{if(L==="vacuum"||L==="mop"||L==="vacuum_and_mop")return L;throw new p("invalid-cleaning-mode")},O3=L=>{if(L==="quick"||L==="standard"||L==="heavy_duty")return L;throw new p("invalid-coverage-setting")},G0=L=>{let C=_(L,"invalid-area-circle");return{x:c1(C.x,-1e6,1e6,"invalid-area-circle"),y:c1(C.y,-1e6,1e6,"invalid-area-circle"),radius:c1(C.radius,.05,2.5,"invalid-area-circle")}},Q0=L=>L==="current"||L==="review"||L==="stale"?L:"unknown",w3=L=>{let C=_(L,"invalid-areas");if(!Array.isArray(C.areas)||C.areas.length>256)throw new p("invalid-area-list");return{sceneUrl:q(C.scene_url,"invalid-area-scene-url"),rooms:g3(C.rooms,!0),areas:C.areas.map(H=>{let V=_(H,"invalid-area");if(!Array.isArray(V.circles)||V.circles.length>512)throw new p("invalid-area-circles");return{id:O(V.id,128,"invalid-area-id"),name:O(V.name,128,"invalid-area-name"),circles:V.circles.map(G0),cleaningMode:b3(V.cleaning_mode),coverageSetting:O3(V.coverage_setting),status:Q0(V.status),canRebind:f(V.can_rebind,"invalid-area-rebind")}})}},k3=L=>{let C=_(L,"invalid-plans");if(!Array.isArray(C.plans)||C.plans.length>256)throw new p("invalid-plan-list");return{rooms:g3(C.rooms,!1).map(({roomId:V,name:e})=>({roomId:V,name:e})),selectedPlan:C.selected_plan===null||C.selected_plan===void 0?null:O(C.selected_plan,128,"invalid-selected-plan"),plans:C.plans.map(V=>{let e=_(V,"invalid-plan");if(!Array.isArray(e.rooms)||e.rooms.length>256||!Array.isArray(e.room_order))throw new p("invalid-plan-rooms");let r=e.run_behavior;if(r!=="intelligent"&&r!=="ordered")throw new p("invalid-run-behavior");return{id:O(e.id,128,"invalid-plan-id"),name:O(e.name,128,"invalid-plan-name"),enabled:f(e.enabled,"invalid-plan-enabled"),runBehavior:r,rooms:e.rooms.map(M=>{let t=_(M,"invalid-plan-room");return{roomId:O(t.room_id,128,"invalid-plan-room-id"),cleaningMode:b3(t.cleaning_mode),coverageSetting:O3(t.coverage_setting)}}),roomOrder:e.room_order.slice(0,256).map(M=>O(M,128,"invalid-room-order")),returnToBase:f(e.return_to_base,"invalid-return-to-base"),finishCurrentRoom:f(e.finish_current_room,"invalid-finish-room"),finishCurrentRoomThreshold:N(e.finish_current_room_threshold,0,100,"invalid-finish-threshold")}})}},P3=L=>{let C=_(L,"invalid-pose"),H=C.position,V=H===null?null:f3(H,"invalid-pose-position"),e=C.pose_freshness;if(e!=="live"&&e!=="coordinator_fallback")throw new p("invalid-pose-freshness");return{position:V,source:O(C.source,64,"invalid-pose-source"),revision:N(C.revision,0,Number.MAX_SAFE_INTEGER,"invalid-pose-revision"),poseRevision:N(C.pose_revision,0,Number.MAX_SAFE_INTEGER,"invalid-pose-sequence"),floorCoherent:f(C.map_floor_coherent,"invalid-pose-floor"),mapSessionKey:S3(C.map_session_key),freshness:e}},B3=L=>{try{return q(L,"invalid-private-path"),!0}catch{return!1}};var T3=L=>{let r=()=>{throw new Error("invalid-scene")};(!(L instanceof ArrayBuffer)||L.byteLength<24||L.byteLength>16777216)&&r();let M=new DataView(L),t=new Uint8Array(L,0,8),o=String.fromCharCode(...t),i=M.getUint16(8,!0),a=M.getUint16(10,!0),n=M.getUint32(12,!0),A=M.getUint32(16,!0),s=M.getUint32(20,!0),v=A+s,x=24+n;(o!=="MATIC3D\0"||i!==1||a!==8||n>1024*1024||v<1||v>15e5||x+v*a!==L.byteLength)&&r();let u;try{u=JSON.parse(new TextDecoder("utf-8",{fatal:!0}).decode(new Uint8Array(L,24,n)))}catch{r()}(!u||typeof u!="object"||Array.isArray(u))&&r();let m=u,h=m.meters_per_cell,S=m.origin_cells,g=m.span_cells;(typeof h!="number"||!Number.isFinite(h)||h<.001||h>.1||!Array.isArray(S)||S.length!==2||!S.every(F=>typeof F=="number"&&Number.isFinite(F))||!Array.isArray(g)||g.length!==2||!g.every(F=>typeof F=="number"&&Number.isFinite(F)&&F>=1&&F<=65536))&&r();let _1=(Array.isArray(m.rooms)?m.rooms.slice(0,128):[]).flatMap((F,X3)=>{if(!F||typeof F!="object"||Array.isArray(F))return[];let J=F,F1=typeof J.name=="string"?J.name.trim():"";if(!F1||Array.from(F1).length>128||/[\u0000-\u001f\u007f]/u.test(F1))return[];if(!Array.isArray(J.boundary)||J.boundary.length<3||J.boundary.length>8192)return[];let q2=J.boundary.flatMap(o2=>{if(!Array.isArray(o2)||o2.length!==2)return[];let[i2,a2]=o2;return typeof i2=="number"&&Number.isFinite(i2)&&typeof a2=="number"&&Number.isFinite(a2)?[[i2,a2]]:[]}),r2=J.center;if(q2.length<3||!Array.isArray(r2)||r2.length!==2)return[];let[M2,t2]=r2;return typeof M2!="number"||!Number.isFinite(M2)||typeof t2!="number"||!Number.isFinite(t2)?[]:[{id:`scene-room-${X3+1}`,name:F1,boundary:q2,center:[M2,t2]}]}),q3=typeof m.sample_step=="number"&&Number.isInteger(m.sample_step)?Math.max(1,Math.min(15e5,m.sample_step)):1,Q2=S,K2=g;return{buffer:L,pointOffset:x,floorCount:A,surfaceCount:s,total:v,metadata:{metersPerCell:h,origin:[Q2[0],Q2[1]],span:[K2[0],K2[1]],sampleStep:q3,rooms:_1}}},j0=L=>{if(L.byteLength>16777216||L.byteLength<24||!1||!1)throw new p("invalid-scene");try{return T3(L)}catch{throw new p("invalid-scene")}},Y0=()=>`
  const parseTransfer = ${T3.toString()};
...
`,Y1=class{#C=null;#H=null;#V=0;#t=new Map;constructor(){if(!(typeof Worker!="function"||typeof URL?.createObjectURL!="function"))try{this.#H=URL.createObjectURL(new Blob([Y0()],{type:"text/javascript"})),this.#C=new Worker(this.#H),this.#C.onmessage=C=>{let H=this.#t.get(C.data.id);H&&(this.#t.delete(C.data.id),C.data.ok&&C.data.parsed?H.resolve(C.data.parsed):H.reject(new p(C.data.problem||"invalid-scene")))},this.#C.onerror=()=>this.#e("scene-worker-failed")}catch{this.#C=null,this.#H&&URL.revokeObjectURL(this.#H),this.#H=null}}async parse(C,H){if(H?.aborted)throw new DOMException("Aborted","AbortError");if(!this.#C){if(await new Promise(e=>window.setTimeout(e,0)),H?.aborted)throw new DOMException("Aborted","AbortError");return j0(C)}let V=++this.#V;return new Promise((e,r)=>{let M=()=>{this.#t.delete(V),r(new DOMException("Aborted","AbortError"))};H?.addEventListener("abort",M,{once:!0}),this.#t.set(V,{resolve:t=>{H?.removeEventListener("abort",M),e(t)},reject:t=>{H?.removeEventListener("abort",M),r(t)}}),this.#C?.postMessage({id:V,buffer:C},[C])})}#e(C){for(let H of this.#t.values())H.reject(new p(C));this.#t.clear(),this.#C?.terminate(),this.#C=null}dispose(){this.#e("scene-parser-disposed"),this.#H&&URL.revokeObjectURL(this.#H),this.#H=null}};var X={catalog:1e4,scene:6e4,delta:35e3,pose:1e4,history:15e3,workflow:15e3,mutation:2e4},I=class extends Error{constructor(C,H=null){super(C),this.name="BackendError",this.code=C,this.status=H}},T1=36,x1=16*1024*1024,R3=(L,C)=>{let H=Number(L);if(!Number.isSafeInteger(H)||H<0)throw new p(C);return H},_3=(L,C)=>{let H=L.headers.get("X-Matic-Revision");if(H===null)return C;let V=Number(H);if(!Number.isSafeInteger(V)||V<0)throw new p("invalid-scene-revision");return V},F3=(L,C)=>{let H=L.headers.get("X-Matic-Floor-Coherent");if(H===null)return C;if(H==="1")return!0;if(H==="0")return!1;throw new p("invalid-scene-floor-header")},J1=class{#C;#H=new Y1;constructor(C){this.#C=C}async#V(C,H,V,e){if(!B3(C))throw new I("invalid-private-path");if(e?.aborted)throw new DOMException("Aborted","AbortError");let r=new AbortController,M=()=>r.abort();e?.addEventListener("abort",M,{once:!0});let t=!1,o=window.setTimeout(()=>{t=!0,r.abort()},V);try{let i=this.#C(),a=new Headers(H.headers),n={...H,cache:"no-store",credentials:"same-origin",headers:Object.fromEntries(a.entries()),signal:r.signal};if(typeof i?.fetchWithAuth=="function")return await i.fetchWithAuth(C,n);let A=i?.auth?.accessToken||i?.auth?.data?.access_token;A&&a.set("Authorization",`Bearer ${A}`);let s=typeof i?.hassUrl=="function"?i.hassUrl(C):C;return await fetch(s,{...n,headers:a})}catch(i){throw t&&!e?.aborted?new I("request-timeout"):r.signal.aborted?new DOMException("Aborted","AbortError"):i}finally{window.clearTimeout(o),e?.removeEventListener("abort",M)}}async#t(C,H,V,e={}){let r=await this.#V(C,{...e,headers:{Accept:"application/json",...e.headers||{}}},H,V);if(!r.ok)throw new I("request-failed",r.status);try{return await r.json()}catch{throw new p("invalid-json-response")}}async catalog(C){return h3(await this.#t(Z3,X.catalog,C))}async scene(C,H,V,e,r,M){let t=new Headers({Accept:"application/vnd.matic.slam-scene"});e==="live"&&t.set("X-Matic-Prefer-Cached","1"),M&&t.set("If-None-Match",M);let o=await this.#V(C,{headers:t},X.scene,r),i=_3(o,H),a=F3(o,V);if(o.status===304)return{scene:null,floorCoherent:a,revision:i,notModified:!0};if(!o.ok)throw new I("scene-request-failed",o.status);if(o.headers.get("Content-Type")?.split(";",1)[0]!=="application/vnd.matic.slam-scene")throw new p("invalid-scene-content-type");return{scene:{...await this.#H.parse(await o.arrayBuffer(),r),revision:i,etag:o.headers.get("ETag"),source:e},floorCoherent:a,revision:i,notModified:!1}}async#e(C,H,V){if(!Number.isSafeInteger(H)||H<1||H>x1||typeof DecompressionStream!="function")throw new p("invalid-scene-delta");let r=new Blob([C]).stream().pipeThrough(new DecompressionStream("deflate")).getReader(),M=new Uint8Array(H),t=0,o=()=>{r.cancel()};V?.addEventListener("abort",o,{once:!0});try{for(;;){if(V?.aborted)throw new DOMException("Aborted","AbortError");let{done:i,value:a}=await r.read();if(i)break;if(!(a instanceof Uint8Array)||t+a.byteLength>H)throw new p("invalid-scene-delta");M.set(a,t),t+=a.byteLength}}finally{V?.removeEventListener("abort",o),r.releaseLock()}if(t!==H)throw new p("invalid-scene-delta");return M}async#L(C,H,V){if(C.byteLength<T1||C.byteLength>T1+x1||H.buffer.byteLength>x1)throw new p("invalid-scene-delta");let e=new DataView(C),r=new TextDecoder().decode(new Uint8Array(C,0,8)),M=e.getUint16(8,!0),t=e.getUint16(10,!0),o=R3(e.getBigUint64(12,!0),"invalid-scene-delta"),i=R3(e.getBigUint64(20,!0),"invalid-scene-delta"),a=e.getUint32(28,!0),n=e.getUint32(32,!0);if(r!=="MATICDLT"||M!==1||t!==1||o!==H.revision||i<=H.revision||a<24||a>x1||n>x1||n+T1!==C.byteLength)throw new p("invalid-scene-delta");let A=new Uint8Array(C,T1,n),s=new Uint8Array(H.buffer),x=(await this.#e(A,Math.max(s.byteLength,a),V)).slice(),u=1024*1024;for(let S=0;S<s.byteLength;S+=u){if(V?.aborted)throw new DOMException("Aborted","AbortError");let g=Math.min(s.byteLength,S+u);for(let P=S;P<g;P+=1)x[P]=(x[P]??0)^(s[P]??0);g<s.byteLength&&await new Promise(P=>window.setTimeout(P,0))}let m=x.slice(0,a).buffer;return{parsed:{...await this.#H.parse(m,V),revision:i,etag:null,source:"live"},revision:i}}async sceneDelta(C,H,V,e){let r=C.includes("?")?"&":"?",M=await this.#V(`${C}${r}since=${encodeURIComponent(H.revision)}`,{headers:{Accept:"application/vnd.matic.slam-delta, application/vnd.matic.slam-scene"}},X.delta,e),t=_3(M,H.revision),o=F3(M,V);if(M.status===204){if(t!==H.revision)throw new p("invalid-scene-delta-revision");return{scene:null,floorCoherent:o,revision:t,notModified:!0}}if(!M.ok)throw new I("delta-request-failed",M.status);if(t<=H.revision)throw new p("invalid-scene-delta-revision");let i=Number(M.headers.get("Content-Length"));if(Number.isFinite(i)&&i>T1+x1)throw new p("invalid-scene-delta-size");let a=M.headers.get("Content-Type")?.split(";",1)[0],n=await M.arrayBuffer();if(a==="application/vnd.matic.slam-delta"){let s=Number(M.headers.get("X-Matic-Base-Revision"));if(!Number.isSafeInteger(s)||s!==H.revision)throw new p("invalid-scene-delta-base");let v=await this.#L(n,H,e);if(v.revision!==t)throw new p("invalid-scene-delta-revision");return{scene:{...v.parsed,etag:M.headers.get("ETag")},floorCoherent:o,revision:t,notModified:!1}}if(a!=="application/vnd.matic.slam-scene")throw new p("invalid-scene-delta-content-type");return{scene:{...await this.#H.parse(n,e),revision:t,etag:M.headers.get("ETag"),source:"live"},floorCoherent:o,revision:t,notModified:!1}}async pose(C,H){return P3(await this.#t(C,X.pose,H))}async history(C,H){return y3(await this.#t(C,X.history,H))}async plans(C,H){return k3(await this.#t(C,X.workflow,H))}async areas(C,H){return w3(await this.#t(C,X.workflow,H))}async saveArea(C,H,V){let e=await this.#t(C,X.mutation,V,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({...H.areaId?{area_id:H.areaId}:{},name:H.name,circles:H.circles,cleaning_mode:H.cleaningMode,coverage_setting:H.coverageSetting})});if(!e||typeof e!="object"||typeof e.id!="string")throw new p("invalid-area-save-response");return e.id}async deleteArea(C,H,V){let e=await this.#V(`${C}?area_id=${encodeURIComponent(H)}`,{method:"DELETE",headers:{Accept:"application/json"}},X.mutation,V);if(!e.ok)throw new I("area-delete-failed",e.status)}async service(C,H,V,e){let r=this.#C();if(typeof r?.callService!="function")throw new I("service-unavailable");await r.callService(C,H,V,{entity_id:e})}dispose(){this.#H.dispose()}};var D3=()=>({version:4,view:"top",appearance:"photo",labels:!0,quality:"auto",cameras:{}}),R1=(L,C,H)=>Math.max(C,Math.min(H,L)),$3=L=>L.replaceAll(/[^a-zA-Z0-9_-]/g,"").slice(0,128)||"local-user",N2=(L,C=4)=>`matic-map-studio:v${C}:${$3(L)}`,J0=L=>{if(!L||typeof L!="object")return null;let C=L;return["yaw","pitch","zoom","targetX","targetZ"].every(V=>typeof C[V]=="number"&&Number.isFinite(C[V]))?{yaw:R1(C.yaw,-Math.PI,Math.PI),pitch:R1(C.pitch,.18,Math.PI/2-.018),zoom:R1(C.zoom,.01,100),targetX:R1(C.targetX,-1e4,1e4),targetZ:R1(C.targetZ,-1e4,1e4)}:null},E3=L=>{let C=D3();if(!L||typeof L!="object")return C;let H=L,V=H.view==="three"||H.view==="top"||H.view==="rooms"?H.view:C.view,e=V==="rooms"?"top":V,r=H.quality==="auto"||H.quality==="efficient"||H.quality==="balanced"||H.quality==="maximum"?H.quality:C.quality,M=H.cameras&&typeof H.cameras=="object"?H.cameras:{},t={};for(let o of["three","top"]){let i=J0(M[o]);i&&(t[o]=i)}return{version:4,view:e,appearance:H.appearance==="rooms"||H.appearance==="photo"?H.appearance:C.appearance,labels:typeof H.labels=="boolean"?H.labels:C.labels,quality:r,cameras:t}},C2=class{#C="local-user";#H=null;load(C){this.#C=$3(C);try{let H=window.localStorage.getItem(N2(this.#C));if(H)return E3(JSON.parse(H));for(let V of[3,2]){let e=window.localStorage.getItem(N2(this.#C,V));if(e)return E3(JSON.parse(e))}}catch{}return D3()}schedule(C){this.#H!==null&&window.clearTimeout(this.#H),this.#H=window.setTimeout(()=>{this.#H=null;try{window.localStorage.setItem(N2(this.#C),JSON.stringify(C))}catch{}},250)}dispose(){this.#H!==null&&window.clearTimeout(this.#H),this.#H=null}},I3="matic-map-studio:preferred-frontend",W3=()=>{try{return window.localStorage.getItem(I3)==="v3"?"v3":"v4"}catch{return"v4"}},z2=L=>{try{return window.localStorage.setItem(I3,L),!0}catch{return!1}};var c=(L,C,H=null)=>({status:L,value:C,problem:H}),z=L=>L instanceof DOMException&&L.name==="AbortError",o1=(L,C)=>L instanceof I||L&&typeof L=="object"&&"code"in L&&typeof L.code=="string"?L.code:C,H2=L=>[L.selectedFloorOrdinal??"none",L.mapFloorOrdinal??"none",L.mapFloorCoherent?"coherent":"transition"].join(":"),V2=L=>[L.mapFloorOrdinal??"none",L.mapSessionVerified?"verified":"unverified",L.mapSessionKey??"no-session"].join(":"),U=L=>[L.entryId,L.selectedFloorOrdinal??"none",L.mapFloorOrdinal??"none"].join("|"),N3=L=>[L.entryId,H2(L),V2(L),L.mapRevision].join("|"),z3=L=>L.runnerLocked||L.stopSettlePending||L.activePlan||L.nativeReconciliationPending||L.nativeSessionActive===!0,C7=(L,C)=>L.entryKey===C.entryKey&&L.generation===C.generation&&L.floorKey===C.floorKey&&L.missionKey===C.missionKey,U3="Live map updates paused while the current map is rechecked.",G3="Reconnecting. The last verified map remains read only.",H7=1e3,U2=(L,C)=>L.label?L.label:L.active?"Current floor":`Saved floor ${L.ordinal??C}`,L2=class{#C;#H=new I1;#V;#t=new C2;#e=new Map;#L=null;#o;#A=null;#r=null;#n=null;#s=!1;#m=!1;#S=!1;#i="";#h=0;#p="";#a=!1;#v=!0;constructor(C,H){this.#C=C,this.#V=H}sync(C,H){if(this.#a)return;let V=this.#v;if(this.#v=C.host.connected,this.#L=C,this.#o=H,this.#C.patch({host:C.host,activity:C.activity,batteryPercent:C.batteryPercent,robotLabel:C.robotLabel,robots:C.robots,locale:C.language}),C.userKey!==this.#p){this.#p=C.userKey;let e=this.#t.load(C.userKey);this.#C.patch({view:e.view,appearance:e.appearance,labelsVisible:e.labels,quality:e.quality,cameras:e.cameras})}if(!C.host.administrator){this.#x(),this.#l("access-required");return}if(!C.host.connected){this.#x();let e=this.#C.value,r=e.resources.scene.value;this.#C.patch({coherence:r?"degraded":"unavailable",resources:{...e.resources,pose:c("idle",null)},map:{...e.map,available:r!==null,exactPose:!1},notice:r?{tone:"warning",text:G3}:e.notice});return}if(C.host.robotCount===0){this.#x(),this.#l("map-unavailable");return}if(this.#u(),!V){this.#C.value.notice?.text===G3&&this.#C.patch({notice:null}),this.refreshCatalog(!0);return}(this.#C.value.resources.catalog.status==="idle"||C.entryKey&&C.entryKey!==this.#C.value.selection.entryId)&&this.refreshCatalog(!0)}schedulePreferences(C){this.#t.schedule(C)}#u(){this.#A===null&&(this.#A=window.setInterval(()=>{document.visibilityState==="visible"&&this.refreshCatalog()},5e3)),this.#r===null&&(this.#r=window.setInterval(()=>{document.visibilityState==="visible"&&this.refreshPose()},H7))}#x(){this.#A!==null&&window.clearInterval(this.#A),this.#r!==null&&window.clearInterval(this.#r),this.#A=null,this.#r=null}#M(C){this.#e.get(C)?.abort();let H=new AbortController;return this.#e.set(C,H),H}#d(C,H){this.#e.get(C)===H&&this.#e.delete(C)}#c(C=[]){for(let[H,V]of this.#e)C.includes(H)||(V.abort(),this.#e.delete(H))}#l(C){this.#c(),this.#H.invalidate(),this.#i="";let H=this.#C.value;this.#C.patch({generation:this.#H.generation,coherence:H.host.administrator?"unavailable":"blocked",fullMap:!1,precisionOpen:!1,resources:{catalog:c("error",null,C),entry:null,scene:c("idle",null),pose:c("idle",null),history:c("idle",null),plans:c("idle",null),areas:c("idle",null)},map:{available:!1,complete:!1,floorCoherent:!1,sessionVerified:!1,exactPose:!1},selection:{...H.selection,entryId:null,floorId:"current",historyId:null}})}async refreshCatalog(C=!1){if(this.#a||this.#s||!this.#L?.host.administrator)return;this.#s=!0;let H=this.#M("catalog"),V=this.#C.value.resources.catalog.value;this.#C.patch({resources:{...this.#C.value.resources,catalog:c("loading",V)}});try{let e=await this.#V.catalog(H.signal);if(H.signal.aborted||this.#a)return;let r=this.#o?.config?.entry_id,M=typeof r=="string"?r:null,t=e.find(a=>a.entryId===this.#L?.entryKey)||e.find(a=>a.entryId===M)||e[0]||null,o=this.#C.value.resources.entry;if(t&&o&&U(t)===U(o)&&H2(t)===H2(o)&&V2(t)===V2(o)&&t.mapRevision<o.mapRevision&&(t={...t,mapRevision:o.mapRevision}),this.#C.patch({managedLock:t?z3(t):!1,resources:{...this.#C.value.resources,catalog:c(e.length?"ready":"empty",e),entry:t}}),!t){this.#l("no-loaded-robot");return}if(this.#C.value.selection.floorId!=="current"&&!C)return;let i=N3(t);if(!C&&i===this.#i){let a=this.#C.value,n=t.mapFloorCoherent&&t.mapSessionVerified,A=t.health==="problem"||t.health==="limited";this.#C.patch({coherence:n?A?"degraded":"current":"verifying",map:{...a.map,available:n&&a.resources.scene.value!==null,complete:t.mapComplete&&!t.mapTruncated,floorCoherent:t.mapFloorCoherent,sessionVerified:t.mapSessionVerified,exactPose:n?a.map.exactPose:!1},floor:{...a.floor,classifiedCount:Math.max(1,t.historyFloorCount)}});return}this.#i=i,this.#w(t)}catch(e){if(z(e))return;this.#C.patch({coherence:this.#C.value.resources.scene.value?"degraded":"unavailable",resources:{...this.#C.value.resources,catalog:c("error",V,o1(e,"catalog-unavailable"))}})}finally{this.#d("catalog",H),this.#s=!1}}#w(C){let H=this.#C.value,V=H.resources.entry,e=!!(V&&U(V)===U(C)),r=C.mapFloorCoherent&&C.mapSessionVerified;this.#c(e?["catalog","plans","areas","plan-mutation","area-mutation"]:["catalog"]);let M=e?H.resources.scene.value:null,t=H.resources.pose.value,o=e&&r&&C.mapSessionKey!==null&&t?.position&&t.mapSessionKey===C.mapSessionKey?t:null,i=this.#H.begin(C.entryId,H2(C),V2(C),C.mapRevision),a=C.health==="problem"||C.health==="limited",n=this.#C.value;this.#C.patch({managedLock:z3(C),generation:i.generation,coherence:r?a?"degraded":"current":"verifying",dataMode:"live",resources:{...n.resources,entry:C,scene:c(r?"loading":"idle",M),pose:c(r?"loading":"idle",o),history:c("loading",n.resources.history.value),plans:e?n.resources.plans:c("idle",null),areas:e?n.resources.areas:c("idle",null)},map:{available:r&&M!==null,complete:C.mapComplete&&!C.mapTruncated,floorCoherent:C.mapFloorCoherent,sessionVerified:C.mapSessionVerified,exactPose:r&&o!==null},floor:{classifiedCount:Math.max(1,C.historyFloorCount),displayName:C.selectedFloorOrdinal?`Floor ${C.selectedFloorOrdinal}`:"Current floor",readOnly:!1},selection:{...n.selection,entryId:C.entryId,floorId:"current",historyId:null,roomIds:e?n.selection.roomIds:[],planId:e?n.selection.planId:null,areaId:e?n.selection.areaId:null}}),this.#b(C,i),r&&(this.#g(C,i),this.#f(C,i))}async#g(C,H){let V=this.#M("scene");try{let e=await this.#V.scene(C.sceneUrl,C.mapRevision,C.mapFloorCoherent,"live",V.signal);if(!this.#H.accepts(H)||e.revision!==H.revision||!e.floorCoherent||!e.scene)return;let r=this.#C.value;if(this.#C.patch({resources:{...r.resources,scene:c("ready",e.scene)},map:{...r.map,available:!0},notice:r.notice?.text===U3?null:r.notice}),C.deltaUrl){let M=++this.#h;this.#y(C,H,e.scene,M)}}catch(e){if(z(e)||!this.#H.accepts(H))return;if(e instanceof I&&e.code==="request-timeout"){let o=this.#C.value;this.#C.patch({resources:{...o.resources,scene:c("loading",o.resources.scene.value,"scene-building")}}),window.setTimeout(()=>{this.#a||!this.#H.accepts(H)||this.#C.value.selection.floorId!=="current"||this.#g(C,H)},250);return}let r=this.#C.value,M=r.resources.pose.value,t=r.resources.scene.value!==null&&C.mapSessionKey!==null&&M?.position!==null&&M?.mapSessionKey===C.mapSessionKey;this.#C.patch({coherence:"degraded",resources:{...r.resources,scene:c("error",r.resources.scene.value,o1(e,"scene-unavailable"))},map:{...r.map,available:r.resources.scene.value!==null,exactPose:t}})}finally{this.#d("scene",V)}}async#y(C,H,V,e){if(!C.deltaUrl||typeof DecompressionStream!="function")return;let r=C.deltaUrl,M=C,t=H,o=V;try{for(;!this.#a&&e===this.#h&&this.#H.accepts(t)&&this.#C.value.selection.floorId==="current";){let i=this.#M("delta");try{let a=await this.#V.sceneDelta(r,o,M.mapFloorCoherent,i.signal);if(i.signal.aborted||this.#a||e!==this.#h||!this.#H.accepts(t))return;if(!a.floorCoherent){this.#C.patch({coherence:"verifying",map:{...this.#C.value.map,available:!1,floorCoherent:!1,exactPose:!1},resources:{...this.#C.value.resources,pose:c("idle",null)}}),this.#i="",this.refreshCatalog(!0);return}if(a.notModified||!a.scene){await new Promise(s=>window.setTimeout(s,100));continue}let n=this.#H.advance(t,a.revision);if(!n)return;t=n,o=a.scene,M={...M,mapRevision:a.revision},this.#i=N3(M);let A=this.#C.value;this.#C.patch({resources:{...A.resources,entry:M,scene:c("ready",o)},map:{...A.map,available:!0,floorCoherent:!0}}),this.#f(M,t)}finally{this.#d("delta",i)}}}catch(i){if(z(i)||this.#a||e!==this.#h||!this.#H.accepts(t))return;this.#C.patch({coherence:"degraded",notice:{tone:"warning",text:U3}}),this.#i="",this.refreshCatalog(!0)}}async#b(C,H){let V=this.#M("history");try{let e=await this.#V.history(C.historyUrl,V.signal);if(!this.#H.accepts(H)||e.entryId!==C.entryId)return;let r=e.floors.find(M=>M.active)||e.floors[0];if(!r)return;this.#C.patch({resources:{...this.#C.value.resources,history:c("ready",e)},floor:{...this.#C.value.floor,classifiedCount:e.floors.length,displayName:U2(r,1)}})}catch(e){if(z(e)||!this.#H.accepts(H))return;this.#C.patch({resources:{...this.#C.value.resources,history:c("error",null,o1(e,"history-unavailable"))}})}finally{this.#d("history",V)}}async refreshPose(){let C=this.#C.value.resources.entry,H=this.#H.current();!C||!H||this.#C.value.selection.floorId!=="current"||!C.mapFloorCoherent||!C.mapSessionVerified||await this.#f(C,H)}async#f(C,H){if(this.#m){this.#S=!0;return}this.#m=!0;let V=this.#M("pose");try{let e=await this.#V.pose(C.poseUrl,V.signal),r=this.#H.current(),M=this.#C.value.resources.entry;if(!r||!C7(H,r)||!M||!e.floorCoherent)return;if(e.mapSessionKey===null||e.mapSessionKey!==M.mapSessionKey){this.#C.patch({map:{...this.#C.value.map,exactPose:!1}}),this.#i="",this.refreshCatalog(!0);return}let t=this.#C.value,o=t.resources.pose.value,i=!!(t.map.exactPose&&o?.position&&o.mapSessionKey===M.mapSessionKey);if(e.position===null&&i){this.#C.patch({resources:{...t.resources,pose:c("ready",o)}});return}this.#C.patch({resources:{...t.resources,pose:c("ready",e)},map:{...t.map,exactPose:e.position!==null}})}catch(e){if(z(e)||!this.#H.accepts(H))return;let r=this.#C.value,M=r.resources.pose.value,t=!!(r.map.exactPose&&M?.position&&M.mapSessionKey===r.resources.entry?.mapSessionKey);this.#C.patch({resources:{...r.resources,pose:c("error",t?M:null,o1(e,"pose-unavailable"))},map:{...r.map,exactPose:t}})}finally{if(this.#d("pose",V),this.#m=!1,this.#S&&!this.#a){this.#S=!1;let e=this.#C.value.resources.entry,r=this.#H.current();e&&r&&this.#f(e,r)}}}async selectFloor(C){let H=this.#C.value.resources.history.value,V=this.#C.value.resources.entry;if(!H||!V)return;let e=H.floors.find(t=>t.id===C);if(!e)return;if(e.active){this.#i="",this.#C.dispatch({type:"set-floor",floorId:"current"}),await this.refreshCatalog(!0);return}let r=e.snapshots.at(-1);this.#c(["catalog"]);let M=this.#H.begin(V.entryId,e.id,r?.id||e.id,r?.revision||0);this.#C.patch({generation:M.generation,coherence:"current",dataMode:"history",floor:{classifiedCount:H.floors.length,displayName:U2(e,H.floors.indexOf(e)+1),readOnly:!0},selection:{...this.#C.value.selection,floorId:e.id,historyId:r?.id||null},resources:{...this.#C.value.resources,scene:c(r?"loading":"empty",null),pose:c("idle",null)},map:{available:!1,complete:!0,floorCoherent:!0,sessionVerified:!0,exactPose:!1}}),r&&await this.#P(r,M)}async selectHistory(C){let H=this.#C.value.resources.history.value,V=this.#C.value.resources.entry;if(!H||!V)return;if(!C){await this.selectFloor("current");return}let e=H.floors.find(t=>t.snapshots.some(o=>o.id===C)),r=e?.snapshots.find(t=>t.id===C);if(!e||!r)return;let M=this.#H.begin(V.entryId,e.id,r.id,r.revision);this.#c(["catalog"]),this.#C.patch({generation:M.generation,dataMode:"history",floor:{classifiedCount:H.floors.length,displayName:U2(e,H.floors.indexOf(e)+1),readOnly:!0},selection:{...this.#C.value.selection,floorId:e.id,historyId:r.id},resources:{...this.#C.value.resources,scene:c("loading",null),pose:c("idle",null)},map:{...this.#C.value.map,available:!1,exactPose:!1}}),await this.#P(r,M)}async#P(C,H){let V=this.#M("history-scene");try{let e=await this.#V.scene(C.sceneUrl,C.revision,!0,"history",V.signal);if(!this.#H.accepts(H)||!e.scene)return;this.#C.patch({resources:{...this.#C.value.resources,scene:c("ready",e.scene)},map:{...this.#C.value.map,available:!0,exactPose:!1}})}catch(e){if(z(e)||!this.#H.accepts(H))return;this.#C.patch({resources:{...this.#C.value.resources,scene:c("error",null,o1(e,"history-scene-unavailable"))}})}finally{this.#d("history-scene",V)}}async openWorkflow(C){this.#C.dispatch({type:"open-workflow",workflow:C}),(C==="plan"||C==="rooms")&&await this.loadPlans(),(C==="draw"||C==="areaReview")&&await this.loadAreas()}async loadPlans(){let C=this.#C.value.resources.entry;if(!C||!this.#H.current()||!A2(this.#C.value))return;let H=U(C),V=this.#M("plans");this.#C.patch({resources:{...this.#C.value.resources,plans:c("loading",null)}});try{let e=await this.#V.plans(C.plansUrl,V.signal),r=this.#C.value.resources.entry;if(!r||U(r)!==H)return;this.#C.patch({resources:{...this.#C.value.resources,plans:c("ready",e)},selection:{...this.#C.value.selection,planId:e.selectedPlan||e.plans[0]?.id||null}}),this.selectPlan(e.selectedPlan||e.plans[0]?.id||null)}catch(e){let r=this.#C.value.resources.entry;if(z(e)||!r||U(r)!==H)return;this.#C.patch({resources:{...this.#C.value.resources,plans:c("error",null,o1(e,"plans-unavailable"))}})}finally{this.#d("plans",V)}}selectPlan(C){let H=this.#C.value.resources.plans.value?.plans.find(V=>V.id===C);this.#C.patch({selection:{...this.#C.value.selection,planId:C},planDraft:H?this.#k(H):{...this.#C.value.planDraft,id:null,name:"",rooms:[],dirty:!1}})}#k(C){return{id:C.id,name:C.name,enabled:C.enabled,runBehavior:C.runBehavior,rooms:(C.roomOrder.length?C.roomOrder.flatMap(H=>{let V=C.rooms.find(e=>e.roomId===H);return V?[V]:[]}):C.rooms).map(H=>({...H})),returnToBase:C.returnToBase,finishCurrentRoom:C.finishCurrentRoom,finishCurrentRoomThreshold:C.finishCurrentRoomThreshold,dirty:!1}}async loadAreas(){let C=this.#C.value.resources.entry;if(!C||!this.#H.current()||!A2(this.#C.value))return;let H=U(C),V=this.#M("areas");this.#C.patch({resources:{...this.#C.value.resources,areas:c("loading",null)}});try{let e=await this.#V.areas(C.areasUrl,V.signal),r=this.#C.value.resources.entry;if(!r||U(r)!==H||e.sceneUrl!==r.sceneUrl)return;this.#C.patch({resources:{...this.#C.value.resources,areas:c("ready",e)}}),this.selectArea(e.areas[0]?.id||null)}catch(e){let r=this.#C.value.resources.entry;if(z(e)||!r||U(r)!==H)return;this.#C.patch({resources:{...this.#C.value.resources,areas:c("error",null,o1(e,"areas-unavailable"))}})}finally{this.#d("areas",V)}}selectArea(C){let H=this.#C.value.resources.areas.value?.areas.find(e=>e.id===C),V=this.#C.value;this.#C.patch({selection:{...V.selection,areaId:C},areaDraft:H?this.#B(H):{id:null,name:"",cleaningMode:"vacuum",coverageSetting:"standard",status:"new",canRebind:!1,dirty:!1},draw:{...V.draw,circles:H?.circles||[],undo:[],redo:[],dirty:!1,strokeCount:0}})}#B(C){return{id:C.id,name:C.name,cleaningMode:C.cleaningMode,coverageSetting:C.coverageSetting,status:C.status,canRebind:C.canRebind,dirty:!1}}async saveArea(){let C=this.#C.value,H=C.resources.entry,V=C.areaDraft;if(!H||!Q(C)||!V.name.trim()||!C.draw.circles.length)return;let e=this.#M("area-mutation");this.#C.patch({command:"pending",notice:{tone:"info",text:"Saving area\u2026"}});try{let r=await this.#V.saveArea(H.areasUrl,{areaId:V.id,name:V.name.trim(),circles:C.draw.circles,cleaningMode:V.cleaningMode,coverageSetting:V.coverageSetting},e.signal);this.#C.patch({command:"idle",notice:{tone:"success",text:"Area saved"}}),await this.loadAreas(),this.selectArea(r)}catch(r){if(z(r))return;this.#C.patch({command:"failed",notice:{tone:"error",text:"Area could not be saved"}})}finally{this.#d("area-mutation",e)}}async deleteArea(){let C=this.#C.value.resources.entry,H=this.#C.value.selection.areaId;if(!C||!H||!Q(this.#C.value))return;let V=this.#M("area-mutation");try{await this.#V.deleteArea(C.areasUrl,H,V.signal),this.#C.patch({notice:{tone:"success",text:"Area deleted"}}),await this.loadAreas()}catch(e){z(e)||this.#C.patch({notice:{tone:"error",text:"Area could not be deleted"}})}finally{this.#d("area-mutation",V)}}async savePlan(){let C=this.#C.value,H=C.planDraft,V=C.resources.plans.value;if(!V||!H.name.trim()||!H.rooms.length||!Q(C))return;let e=H.rooms;await this.#O("save_plan",{...H.id?{plan_id:H.id}:{},name:H.name.trim(),enabled:H.enabled,run_behavior:H.runBehavior,rooms:e.map(r=>({room:V.rooms.find(M=>M.roomId===r.roomId)?.name,cleaning_mode:r.cleaningMode,coverage_setting:r.coverageSetting})).filter(r=>r.room),return_to_base:H.returnToBase,finish_current_room:H.finishCurrentRoom,finish_current_room_threshold:H.finishCurrentRoomThreshold,select:!H.id||V.selectedPlan===H.id},"Plan saved","Plan could not be saved"),await this.loadPlans()}async deletePlan(){let C=this.#C.value.selection.planId;C&&(await this.#O("delete_plan",{plan:C},"Plan deleted","Plan could not be deleted"),await this.loadPlans())}async executeAction(C){switch(C){case"stop":this.#C.value.resources.entry?.activePlan||this.#C.value.resources.entry?.runnerLocked?await this.#Z("matic_robot","stop_intelligent_cleaning",{}):await this.#Z("vacuum","return_to_base",{});return;case"resume":await this.#Z("vacuum","start",{});return;case"run-plan":{let H=this.#C.value.selection.planId||this.#C.value.resources.plans.value?.selectedPlan;H&&await this.#Z("matic_robot","run_selected_plan",{plan:H});return}case"clean-rooms":{let H=this.#C.value.resources.plans.value,e=this.#C.value.selection.roomSettings.map(r=>({room:H?.rooms.find(M=>M.roomId===r.roomId)?.name,cleaning_mode:r.cleaningMode,coverage_setting:r.coverageSetting})).filter(r=>r.room);e.length&&await this.#Z("matic_robot","clean_room_sequence",{rooms:e,return_to_base:!0});return}case"run-area":{let H=this.#C.value.selection.areaId;H&&await this.#Z("matic_robot","clean_area",{area:H});return}case"review-area":this.#C.dispatch({type:"open-workflow",workflow:"areaReview"});return;case"save-area":await this.saveArea();return;case"save-plan":await this.savePlan();return;case"delete-plan":await this.deletePlan();return;case"delete-area":await this.deleteArea();return}}async#O(C,H,V,e){let r=this.#L?.vacuumEntityId;if(!(!r||!Q(this.#C.value)||this.#C.value.command==="pending")){this.#C.patch({command:"pending",notice:{tone:"info",text:"Saving\u2026"}});try{await this.#V.service("matic_robot",C,H,r),this.#C.patch({command:"idle",notice:{tone:"success",text:V}})}catch{this.#C.patch({command:"failed",notice:{tone:"error",text:e}})}}}async#Z(C,H,V){let e=this.#C.value,r=this.#L?.vacuumEntityId,t=(H==="stop_intelligent_cleaning"||C==="vacuum"&&H==="return_to_base")&&e.command==="idle"&&(e.activity==="cleaning"||e.activity==="paused"||e.activity==="returning"||e.activity==="recharging");if(!(!r||!t&&!a1(e))){this.#C.patch({command:"pending",notice:null});try{await this.#V.service(C,H,V,r),this.#C.patch({command:"settling"}),this.#n!==null&&window.clearTimeout(this.#n),this.#n=window.setTimeout(()=>{this.#n=null,this.#C.value.command==="settling"&&this.#C.patch({command:"idle"})},15e3)}catch{this.#C.patch({command:"failed",notice:{tone:"error",text:"The robot did not accept that action"}})}}}updateDraftCircles(C,H=!0,V){this.#C.dispatch({type:"set-draft-circles",circles:C,record:H,...V?{previous:V}:{}}),this.#C.dispatch({type:"patch-area-draft",patch:{dirty:!0}})}dispose(){this.#a||(this.#a=!0,this.#x(),this.#c(),this.#n!==null&&window.clearTimeout(this.#n),this.#n=null,this.#t.dispose(),this.#V.dispose(),this.#H.invalidate())}};var Q3=L=>(L.workflow==="none"?0:1)+(L.fullMap?1:0)+(L.precisionOpen?1:0)+(L.dialog?1:0),V7=L=>{if(!L||typeof L!="object")return null;let C=L.maticMapLayer;if(!C||typeof C!="object")return null;let H=C.owner,V=C.depth;return typeof H=="string"&&Number.isInteger(V)&&Number(V)>=0?{owner:H,depth:Number(V)}:null},e2=class{#C;#H=`matic-map-${crypto.randomUUID?.()||Math.random().toString(36).slice(2)}`;#V=0;#t=null;#e=!1;constructor(C){this.#C=C}start(){this.#t||(this.#V=Q3(this.#C.value),this.#t=this.#C.subscribe(C=>this.#L(C)),window.addEventListener("popstate",this.#o))}#L(C){let H=Q3(C);if(this.#e){this.#e=!1,this.#V=H;return}if(H>this.#V)for(let V=this.#V+1;V<=H;V+=1){let e=history.state&&typeof history.state=="object"?history.state:{};history.pushState({...e,maticMapLayer:{owner:this.#H,depth:V}},"",window.location.href)}this.#V=H}#o=()=>{this.#V<1||(this.#e=!0,this.#C.dispatch({type:"dismiss-top-layer"}))};dismissTop(){if(this.#V<1)return!1;let C=V7(history.state);return C?.owner===this.#H&&C.depth===this.#V?history.back():this.#C.dispatch({type:"dismiss-top-layer"}),!0}dispose(){this.#t?.(),this.#t=null,window.removeEventListener("popstate",this.#o),this.#V=0}};var K3=Y(r1),G2=class extends b{constructor(){super(...arguments);this.narrow=!1;this._workspace=k();this._classic=!1;this.entryOverride=null;this.#C=new N1;this.#H=new n1(this._workspace);this.#V=null;this.#t=null;this.#e=null;this.#L=null;this.#o=null;this.#A=""}static{this.styles=[E,D,y`
...
`]}static{this.properties={hass:{attribute:!1},narrow:{type:Boolean},route:{attribute:!1},panel:{attribute:!1},_workspace:{state:!0},_classic:{state:!0},entryOverride:{state:!0}}}#C;#H;#V;#t;#e;#L;#o;#A;connectedCallback(){super.connectedCallback(),this._classic=W3()==="v3",this.#t=this.#H.subscribe(H=>{this._workspace=H,this.#s(H)}),this._classic||this.#r()}disconnectedCallback(){this.#t?.(),this.#t=null,this.#n(),super.disconnectedCallback()}#r(){this.#L||(this.#e=new J1(()=>this.hass),this.#L=new L2(this.#H,this.#e),this.#o=new e2(this.#H),this.#o.start(),this.#V&&this.#L.sync(this.#V,this.panel))}#n(){this.#o?.dispose(),this.#o=null,this.#L?.dispose(),this.#L=null,this.#e=null}#s(H){if(!this.#L)return;let V={version:4,view:H.view,appearance:H.appearance,labels:H.labelsVisible,quality:H.quality,cameras:H.cameras},e=JSON.stringify(V);e!==this.#A&&(this.#A=e,this.#L.schedulePreferences(V))}willUpdate(H){if(H.has("hass")||H.has("panel")||H.has("entryOverride")){let V=this.#C.project(this.hass,this.panel,this.entryOverride);if(V!==this.#V){this.#V=V;let e=V.host.connected?V.host.robotCount===0?"unavailable":V.host.administrator?"verifying":"blocked":"degraded";this.#H.replace({...this.#H.value,coherence:e,activity:V.activity,batteryPercent:V.batteryPercent,host:V.host,fullMap:V.host.administrator&&V.host.robotCount>0&&this.#H.value.fullMap,robotLabel:V.robotLabel,robots:V.robots,locale:V.language})}this._classic||this.#L?.sync(V,this.panel)}H.has("narrow")&&this.#H.value.narrowHint!==this.narrow&&this.#H.dispatch({type:"set-narrow-hint",value:this.narrow})}#m(H){if(!$1(H.detail))return;H.stopPropagation();let V=H.detail;if(V.type==="dismiss-top-layer"||V.type==="exit-full-map"){this.#o?.dismissTop()||this.#H.dispatch(V);return}if(V.type==="open-workflow"&&V.workflow!=="none"){this.#L?.openWorkflow(V.workflow);return}if(V.type==="set-floor"){this.#L?.selectFloor(V.floorId);return}if(V.type==="select-entry"){if(!this._workspace.robots.some(e=>e.entryId===V.entryId))return;this.entryOverride=V.entryId;return}if(V.type==="set-history"){this.#L?.selectHistory(V.historyId);return}if(V.type==="select-plan"){this.#L?.selectPlan(V.planId);return}if(V.type==="select-area"){this.#L?.selectArea(V.areaId);return}this.#H.dispatch(V)}#S(H){if(H.stopPropagation(),typeof H.detail?.id=="string"){if(H.detail.id==="use-classic"){z2("v3")&&(this.#n(),this._classic=!0);return}this.#L?.executeAction(H.detail.id),this.dispatchEvent(new CustomEvent("matic-map-v4-action-requested",{detail:{id:H.detail.id},bubbles:!0,composed:!0}))}}#i(){z2("v4")&&(this._classic=!1,this.#r(),this.requestUpdate())}updated(){if(!this._classic)return;let H=this.renderRoot.querySelector("matic-map-panel-v0-3-1");H&&(H.hass=this.hass,H.narrow=this.narrow,H.route=this.route,H.panel=this.panel)}getWorkspaceSnapshot(){return this.#H.value}render(){return this._classic?Z`
      ...
      ></${K3}>
    `}};customElements.get(k2)||customElements.define(k2,G2);export{I1 as CoherenceMachine,D1 as DRAW_BRUSH_MAX_METERS,u1 as DRAW_BRUSH_MIN_METERS,p2 as GALLERY_SCENARIOS,N1 as HassAdapter,n2 as MAP_PIXELS_PER_METER_AT_100,E1 as MAP_ZOOM_MAX,C1 as MAP_ZOOM_MIN,k2 as MATIC_MAP_PANEL_TAG,G2 as MaticMapPanelV4,$2 as MaticMapStudioGalleryV4,n1 as WorkspaceStore,r7 as brushCursorPixels,Q as canEditCoordinates,A2 as canReadFloorResources,j2 as canShowExactPose,A1 as canShowLiveMap,a1 as canStartMotion,M7 as commandState,s2 as createGalleryState,k as initialWorkspaceState,$1 as isWorkspaceIntent,H5 as mapScale,Y3 as normalizeBrush,X2 as normalizeZoom,J3 as reduceWorkspace,C5 as selectPausedSecondaryAction,J2 as selectPrimaryAction};
