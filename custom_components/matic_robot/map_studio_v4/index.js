...
`;var $5=Symbol.for(""),L7=e=>{if(e?.r===$5)return e?._$litStatic$},j=e=>({_$litStatic$:e,r:$5});var D5=new Map,B2=e=>(C,...H)=>{let V=H.length,L,r,t=[],M=[],o,i=0,a=!1;for(;i<V;){for(o=C[i];i<V&&(r=H[i],(L=L7(r))!==void 0);)o+=L+C[++i],a=!0;i!==V&&M.push(r),t.push(o),i++}if(i===V&&t.push(C[V]),a){let n=t.join("$$lit$$");(C=D5.get(n))===void 0&&(t.raw=t,D5.set(n,C=t)),H=M}return e(C,...H)},c=B2(s),v4=B2(B5),c4=B2(R5);var I5=import.meta.url.match(/\/matic_robot\/[^/]+-([a-f0-9]{12})\/map-studio-v4(?:\/|$)/u)?.[1]??"dev",T1=I5==="dev"?"":`-${I5}`,t1=`matic-map-canvas-v4${T1}`,B1=`matic-precision-controls-v4${T1}`,c1=`matic-map-workflow-v4${T1}`,M1=`matic-map-shell-v4${T1}`,R2=`matic-map-panel-v0-4-0${T1}`;var J=b`
.ms-btn, .ms-row {
...
><path d=${e}></path></svg>`;var e7=["paint","erase","pan"],Y1=(e,C,H)=>{let{draw:V}=e,L=`${V.brushMeters.toFixed(2)} m`;return s`
  ...
  `};var r7=e=>e.matches(":disabled, [aria-disabled='true']"),j1=class{#C;#H;#V=null;#t=null;constructor(C,H){this.#C=C,this.#H=H,C.addController(this)}hostConnected(){this.#C.addEventListener("focusin",this.#a)}hostDisconnected(){this.#C.removeEventListener("focusin",this.#a),this.#V?.removeEventListener("keydown",this.#i),this.#V=null,this.#t=null}hostUpdated(){let C=this.#H.container();C!==this.#V&&(this.#V?.removeEventListener("keydown",this.#i),C?.addEventListener("keydown",this.#i),this.#V=C),this.#L()}#r(){let C=this.#V;return C?[...C.querySelectorAll(this.#H.items)].filter(H=>!r7(H)):[]}#L(){let C=this.#r(),H=(this.#t&&C.includes(this.#t)?this.#t:null)??C.find(L=>L.matches("[aria-pressed='true'], [aria-checked='true']"))??C[0]??null;this.#t=H;let V=this.#V?.querySelectorAll(this.#H.items)??[];for(let L of V)L.tabIndex=L===H?0:-1}#a=C=>{let H=C.composedPath()[0];!(H instanceof HTMLElement)||!this.#V?.contains(H)||H.matches(this.#H.items)&&(this.#t=H,this.#L())};#i=C=>{if(C.defaultPrevented||C.ctrlKey||C.metaKey||C.altKey)return;let H=this.#H.orientation??"horizontal",V=H!=="vertical",L=H!=="horizontal",r=this.#r();if(!r.length)return;let t=C.composedPath()[0],M=Math.max(0,r.findIndex(a=>a===this.#t||t instanceof Node&&a.contains(t))),o;switch(C.key){case"ArrowLeft":if(!V)return;o=M-1;break;case"ArrowRight":if(!V)return;o=M+1;break;case"ArrowUp":if(!L)return;o=M-1;break;case"ArrowDown":if(!L)return;o=M+1;break;case"Home":o=0;break;case"End":o=r.length-1;break;default:return}C.preventDefault();let i=r[(o+r.length)%r.length];i&&(this.#t=i,this.#L(),i.focus())}};var N3={accent:["--ms-accent","Highlight",[6,120,206]],onAccent:["--ms-on-accent","HighlightText",[255,255,255]],text:["--ms-text","CanvasText",[38,50,56]],quiet:["--ms-text-quiet","GrayText",[75,92,105]],plate:["--ms-surface-card","Canvas",[250,252,253]],roomFill:["--ms-surface-sunken","Canvas",[231,238,242]]},t7=e=>Math.max(0,Math.min(255,Math.round(e))),z3=e=>{let C=e.trim(),H=C.match(/^#([\da-f]{3}|[\da-f]{4}|[\da-f]{6}|[\da-f]{8})$/i)?.[1];if(H){let a=H.length<=4?[H[0],H[1],H[2]].map(p=>Number.parseInt(`${p}${p}`,16)):[H.slice(0,2),H.slice(2,4),H.slice(4,6)].map(p=>Number.parseInt(p,16)),[n,A,d]=a;return n===void 0||A===void 0||d===void 0?null:[n,A,d]}let V=C.startsWith("color(srgb"),L=C.slice(C.indexOf("(")+1).match(/-?\d*\.?\d+/g);if(!L||L.length<3)return null;let r=V?255:1,t=L.slice(0,3).map(a=>t7(Number(a)*r)),[M,o,i]=t;return M===void 0||o===void 0||i===void 0||[M,o,i].some(a=>Number.isNaN(a))?null:[M,o,i]},B=(e,C)=>`rgba(${e[0]},${e[1]},${e[2]},${C})`,U3=e=>{let C=window.matchMedia?.("(forced-colors: active)").matches??!1;if(!C){let L=document.createElement("span"),r=document.createElement("canvas");r.width=1,r.height=1;let t=r.getContext("2d",{colorSpace:"srgb",willReadFrequently:!0});L.setAttribute("aria-hidden","true"),L.style.cssText="position:absolute;inline-size:0;block-size:0;overflow:hidden;visibility:hidden;pointer-events:none",e.append(L);let M=o=>{let[i,,a]=N3[o];L.style.color=`var(${i}, transparent)`;let n=getComputedStyle(L).color;if(t){t.clearRect(0,0,1,1),t.fillStyle="transparent",t.fillStyle=n,t.fillRect(0,0,1,1);let[A,d,p,u]=t.getImageData(0,0,1,1).data;if(A!==void 0&&d!==void 0&&p!==void 0&&u!==void 0&&u!==0)return[A,d,p]}return z3(n)??a};try{return{accent:M("accent"),onAccent:M("onAccent"),text:M("text"),quiet:M("quiet"),plate:M("plate"),roomFill:M("roomFill"),forced:C}}finally{L.remove()}}let H=document.createElement("span");H.setAttribute("aria-hidden","true"),H.style.cssText="position:absolute;inline-size:0;block-size:0;overflow:hidden;visibility:hidden;pointer-events:none",e.append(H);let V=L=>{let[,r,t]=N3[L];return H.style.color=r,z3(getComputedStyle(H).color)??t};try{return{accent:V("accent"),onAccent:V("onAccent"),text:V("text"),quiet:V("quiet"),plate:V("plate"),roomFill:V("roomFill"),forced:C}}finally{H.remove()}};var G3=(e,C)=>Math.hypot(e.x-C.x,e.y-C.y),Q3=(e,C)=>({x:(e.x+C.x)/2,y:(e.y+C.y)/2}),K3=(e,C)=>Math.atan2(C.y-e.y,C.x-e.x),M7=e=>{let C=e;for(;C>Math.PI;)C-=Math.PI*2;for(;C<-Math.PI;)C+=Math.PI*2;return C},o1=(e,C,H)=>Math.max(C,Math.min(H,e)),N2=e=>e.map(C=>({...C})),o7="button, input, select, textarea, a, [role='button'], [role='menuitem'], [data-map-control]",x1=e=>e.composedPath().some(C=>C instanceof Element&&C.matches(o7)),J1=class{#C;#H;#V;#t=new Map;#r=!1;#L="idle";#a=[];#i=[];#l=null;#e=0;#x=null;#h=0;#c=null;#m=null;#n=null;#p=0;#o=null;#Z=!1;#d=null;#u=!1;constructor(C,H,V){this.#C=C,this.#H=H,this.#V=V,C.addEventListener("pointerdown",this.#M),C.addEventListener("pointermove",this.#v),C.addEventListener("pointerup",this.#s),C.addEventListener("pointercancel",this.#s),C.addEventListener("wheel",this.#S,{passive:!1}),C.addEventListener("gesturestart",this.#y,{passive:!1}),C.addEventListener("gesturechange",this.#b,{passive:!1}),C.addEventListener("gestureend",this.#F,{passive:!1}),C.addEventListener("dblclick",this.#P),C.addEventListener("contextmenu",this.#w),C.addEventListener("keydown",this.#k),C.addEventListener("keyup",this.#T),C.addEventListener("blur",this.#O)}#M=C=>{if(this.#u||!C.isPrimary&&C.pointerType==="mouse"||x1(C))return;this.#C.focus({preventScroll:!0}),this.#f();let H=performance.now(),V={id:C.pointerId,type:C.pointerType,startX:C.clientX,startY:C.clientY,x:C.clientX,y:C.clientY,lastX:C.clientX,lastY:C.clientY,lastTime:H,velocityX:0,velocityY:0};if(this.#t.set(C.pointerId,V),this.#C.setPointerCapture?.(C.pointerId),this.#t.size>=2){this.#B(),(this.#L==="paint"||this.#L==="erase")&&(this.#i=N2(this.#a),this.#V.onCircles(this.#i,!1)),this.#L="pinch",this.#C.classList.add("navigating"),this.#Z=!0;let[M,o]=[...this.#t.values()];M&&o&&(this.#e=Math.max(1,G3(M,o)),this.#x=Q3(M,o),this.#h=K3(M,o),this.#c=this.#H.camera),C.preventDefault();return}let L=this.#V.state(),r=L.workflow==="draw"&&L.map.available&&!L.floor.readOnly;this.#Z||this.#r||C.button===1||C.button===2||L.draw.tool==="pan"?(this.#L="pan",this.#m=this.#H.camera):r&&(L.draw.tool==="paint"||L.draw.tool==="erase")?(this.#a=N2(L.draw.circles),this.#i=N2(L.draw.circles),C.pointerType==="touch"?(this.#L="idle",this.#d=window.setTimeout(()=>{if(this.#d=null,this.#t.size!==1||this.#Z)return;this.#L=L.draw.tool;let M=this.#t.get(C.pointerId);M&&this.#A(M.x,M.y)},110)):(this.#L=L.draw.tool,this.#A(C.clientX,C.clientY))):(this.#L=L.view==="three"&&!C.shiftKey?"orbit":"pan",this.#m=this.#H.camera),(this.#L==="pan"||this.#L==="orbit")&&this.#C.classList.add("navigating"),C.preventDefault()};#v=C=>{let H=this.#t.get(C.pointerId);if(!H){let a=this.#H.screenToMap(C.clientX,C.clientY);this.#H.setCursor(a);return}let L=(C.getCoalescedEvents?.()||[]).at(-1)||C,r=performance.now(),t=Math.max(1,r-H.lastTime),M=(L.clientX-H.lastX)/t,o=(L.clientY-H.lastY)/t;if(H.velocityX=H.velocityX*.62+M*.38,H.velocityY=H.velocityY*.62+o*.38,H.lastX=L.clientX,H.lastY=L.clientY,H.lastTime=r,H.x=L.clientX,H.y=L.clientY,this.#L==="pinch"&&this.#t.size>=2){let[a,n]=[...this.#t.values()];if(!a||!n)return;let A=Math.max(1,G3(a,n)),d=Q3(a,n),p=K3(a,n),u=this.#c;if(u&&this.#x){let h={...u,distance:u.distance*this.#e/A,yaw:u.yaw+M7(p-this.#h),pitch:u.orthographic?u.pitch:u.pitch-(d.y-this.#x.y)*.0035};this.#H.setCamera(this.#H.cameraAfterPan(h,d.x-this.#x.x,d.y-this.#x.y))}C.preventDefault();return}this.#L==="paint"||this.#L==="erase"?this.#A(C.clientX,C.clientY):this.#L==="pan"?this.#m&&this.#H.setCamera(this.#H.cameraAfterPan(this.#m,L.clientX-H.startX,L.clientY-H.startY)):this.#L==="orbit"&&this.#m&&this.#H.setCamera({...this.#m,yaw:this.#m.yaw+(L.clientX-H.startX)*.0045,pitch:this.#m.pitch-(L.clientY-H.startY)*.004});let i=this.#H.screenToMap(L.clientX,L.clientY);this.#H.setCursor(i),C.preventDefault()};#s=C=>{let H=this.#t.get(C.pointerId);if(!H)return;let V=this.#L;if(this.#t.delete(C.pointerId),this.#C.releasePointerCapture?.(C.pointerId),this.#B(),(this.#L==="paint"||this.#L==="erase")&&JSON.stringify(this.#i)!==JSON.stringify(this.#a))this.#V.onCircles(this.#i,!0,this.#a);else if(this.#L!=="pinch"&&!this.#Z&&Math.hypot(H.x-H.startX,H.y-H.startY)<7&&this.#V.state().workflow==="rooms"){let L=this.#H.roomAt(H.x,H.y);L&&this.#V.onRoom(L)}if(this.#t.size===0)this.#L="idle",this.#C.classList.remove("navigating"),this.#Z=!1,this.#x=null,this.#c=null,this.#m=null,this.#l=null,(V==="pan"||V==="orbit")&&H.type!=="mouse"&&this.#_(H.velocityX,H.velocityY,V);else if(this.#L==="pinch"){this.#L="pan",this.#Z=!0;let L=this.#t.values().next().value;L&&(L.startX=L.x,L.startY=L.y,L.velocityX=0,L.velocityY=0),this.#m=this.#H.camera,this.#c=null}C.preventDefault()};#A(C,H){let V=this.#H.screenToMap(C,H);if(!V)return;let r=this.#V.state().draw.brushMeters/2;if(this.#L==="erase")this.#i=this.#i.filter(t=>Math.hypot(t.x-V.x,t.y-V.y)>t.radius+r);else{if(!this.#H.containsMapPoint(V))return;let t=Math.max(.04,r*.55),M=this.#l||V,o=Math.hypot(V.x-M.x,V.y-M.y),i=Math.max(1,Math.ceil(o/t));for(let a=0;a<=i&&this.#i.length<512;a+=1){let n=a/i,A={x:M.x+(V.x-M.x)*n,y:M.y+(V.y-M.y)*n};this.#i.some(d=>Math.hypot(d.x-A.x,d.y-A.y)<Math.max(.025,r*.28))||this.#i.push({x:Math.round(A.x*1e4)/1e4,y:Math.round(A.y*1e4)/1e4,radius:Math.round(r*100)/100})}}this.#l=V,this.#V.onCircles(this.#i,!1)}#S=C=>{if(x1(C))return;C.preventDefault(),this.#C.focus({preventScroll:!0}),this.#f();let H=C.deltaMode===WheelEvent.DOM_DELTA_LINE?16:C.deltaMode===WheelEvent.DOM_DELTA_PAGE?Math.max(1,this.#C.clientHeight):1,V=C.deltaX*H,L=C.deltaY*H;if(C.ctrlKey||C.metaKey){this.#H.zoomAt(Math.exp(o1(-L*.008,-.28,.28)),C.clientX,C.clientY);return}if(C.altKey&&this.#V.state().view==="three"){this.#H.orbitBy(0,o1(L,-80,80)*.75);return}if(C.deltaMode!==WheelEvent.DOM_DELTA_PIXEL||Math.abs(V)<.5&&Math.abs(L)>=50){this.#H.zoomAt(Math.exp(o1(-L*.0025,-.28,.28)),C.clientX,C.clientY);return}this.#H.panBy(-o1(V,-80,80),-o1(L,-80,80))};#y=C=>{this.#u||x1(C)||(this.#C.focus({preventScroll:!0}),this.#f(),this.#C.classList.add("navigating"),this.#n=this.#H.camera,this.#p=Number.isFinite(C.rotation)?C.rotation:0,C.preventDefault())};#b=C=>{if(this.#u||x1(C))return;let H=this.#n;if(!H||this.#t.size>=2)return;let V=Number.isFinite(C.scale)&&C.scale>0?Math.max(.1,C.scale):1,L=Number.isFinite(C.rotation)?C.rotation:0;this.#H.setCamera({...H,distance:H.distance/V,yaw:H.yaw+(L-this.#p)*Math.PI/180}),C.preventDefault()};#F=C=>{this.#n=null,this.#p=0,this.#C.classList.remove("navigating"),C.preventDefault()};#k=C=>{if(C.defaultPrevented||C.ctrlKey||C.metaKey||C.altKey)return;if(C.code==="Space"){this.#r=!0,C.preventDefault();return}this.#f();let H=this.#V.state(),V=C.key.toLocaleLowerCase();if(C.key==="+"||C.key==="=")this.#H.zoomAt(1.25);else if(C.key==="-")this.#H.zoomAt(.8);else if(C.key==="0")this.#H.fit();else if(V==="3")this.#g({type:"set-view",view:"three"});else if(V==="t")this.#g({type:"set-view",view:"top"});else if(C.key==="[")this.#H.orbitBy(-40,0);else if(C.key==="]")this.#H.orbitBy(40,0);else if(C.key==="PageUp")this.#H.orbitBy(0,-30);else if(C.key==="PageDown")this.#H.orbitBy(0,30);else if(V==="d"&&H.workflow==="draw")this.#g({type:"set-draw-tool",tool:"paint"});else if(V==="e"&&H.workflow==="draw")this.#g({type:"set-draw-tool",tool:"erase"});else if(["arrowleft","arrowright","arrowup","arrowdown"].includes(V))if(H.view==="three"&&!C.shiftKey){let L=V==="arrowleft"?-24:V==="arrowright"?24:0,r=V==="arrowup"?-20:V==="arrowdown"?20:0;this.#H.orbitBy(L,r)}else{let L=V==="arrowleft"?30:V==="arrowright"?-30:0,r=V==="arrowup"?30:V==="arrowdown"?-30:0;this.#H.panBy(L,r)}else if(H.workflow!=="draw"&&["w","a","s","d"].includes(V))this.#H.panBy(V==="a"?34:V==="d"?-34:0,V==="w"?34:V==="s"?-34:0);else if(H.workflow!=="draw"&&(V==="q"||V==="e"))this.#H.orbitBy(V==="q"?-30:30,0);else return;C.preventDefault()};#T=C=>{C.code==="Space"&&(this.#r=!1)};#O=()=>{this.#r=!1,this.#B(),this.#H.setCursor(null),this.#C.classList.remove("navigating")};#P=C=>{x1(C)||(this.#f(),this.#H.zoomAt(C.shiftKey?1/1.6:1.6,C.clientX,C.clientY),C.preventDefault())};#w=C=>{x1(C)||C.preventDefault()};#g(C){this.#C.dispatchEvent(new CustomEvent("matic-workspace-intent",{detail:C,bubbles:!0,composed:!0}))}#_(C,H,V){if(window.matchMedia("(prefers-reduced-motion: reduce)").matches)return;let L=o1(C,-.55,.55),r=o1(H,-.55,.55);if(Math.hypot(L,r)<.02)return;let t=performance.now(),M=o=>{let i=Math.min(32,o-t);t=o,V==="orbit"?this.#H.orbitBy(L*i,r*i):this.#H.panBy(L*i,r*i);let a=.9**(i/16);L*=a,r*=a,Math.hypot(L,r)>=.01?this.#o=window.requestAnimationFrame(M):this.#o=null};this.#o=window.requestAnimationFrame(M)}#f(){this.#o!==null&&window.cancelAnimationFrame(this.#o),this.#o=null}#B(){this.#d!==null&&window.clearTimeout(this.#d),this.#d=null}dispose(){this.#u||(this.#u=!0,this.#B(),this.#f(),this.#C.removeEventListener("pointerdown",this.#M),this.#C.removeEventListener("pointermove",this.#v),this.#C.removeEventListener("pointerup",this.#s),this.#C.removeEventListener("pointercancel",this.#s),this.#C.removeEventListener("wheel",this.#S),this.#C.removeEventListener("gesturestart",this.#y),this.#C.removeEventListener("gesturechange",this.#b),this.#C.removeEventListener("gestureend",this.#F),this.#C.removeEventListener("dblclick",this.#P),this.#C.removeEventListener("contextmenu",this.#w),this.#C.removeEventListener("keydown",this.#k),this.#C.removeEventListener("keyup",this.#T),this.#C.removeEventListener("blur",this.#O),this.#t.clear())}};var _=(e,C,H)=>Math.max(C,Math.min(H,e)),R1=e=>{let C=e;for(;C>Math.PI;)C-=Math.PI*2;for(;C<-Math.PI;)C+=Math.PI*2;return C},i7=e=>{switch(e){case"efficient":return .35;case"balanced":return .65;case"maximum":case"auto":return 1}},a7={accent:[6,120,206],onAccent:[255,255,255],text:[38,50,56],quiet:[75,92,105],plate:[250,252,253],roomFill:[231,238,242],forced:!1},X3=Math.PI/3.15,n7=1.08,A7=(e,C)=>{let H=X3/2,V=Math.atan(Math.tan(H)*Math.max(.2,C));return e/Math.sin(Math.min(H,V))*n7},l7=(e,C)=>{let H=new Float32Array(16);for(let V=0;V<4;V+=1)for(let L=0;L<4;L+=1){let r=0;for(let t=0;t<4;t+=1)r+=(e[t*4+L]??0)*(C[V*4+t]??0);H[V*4+L]=r}return H},d7=(e,C,H,V)=>{let L=1/Math.tan(e/2),r=new Float32Array(16);return r[0]=L/C,r[5]=L,r[10]=(V+H)/(H-V),r[11]=-1,r[14]=2*V*H/(H-V),r},s7=(e,C,H,V,L,r)=>{let t=new Float32Array(16);return t[0]=2/(C-e),t[5]=2/(V-H),t[10]=-2/(r-L),t[12]=-(C+e)/(C-e),t[13]=-(V+H)/(V-H),t[14]=-(r+L)/(r-L),t[15]=1,t},p7=(e,C)=>{let H=Math.hypot((e[0]??0)-(C[0]??0),(e[1]??0)-(C[1]??0),(e[2]??0)-(C[2]??0))||1,V=[((e[0]??0)-(C[0]??0))/H,((e[1]??0)-(C[1]??0))/H,((e[2]??0)-(C[2]??0))/H],L=Math.hypot(V[2]??0,V[0]??0)||1,r=[(V[2]??0)/L,0,-(V[0]??0)/L],t=[(V[1]??0)*(r[2]??0),(V[2]??0)*(r[0]??0)-(V[0]??0)*(r[2]??0),-(V[1]??0)*(r[0]??0)];return new Float32Array([r[0]??0,t[0]??0,V[0]??0,0,r[1]??0,t[1]??0,V[1]??0,0,r[2]??0,t[2]??0,V[2]??0,0,-((r[0]??0)*(e[0]??0)+(r[1]??0)*(e[1]??0)+(r[2]??0)*(e[2]??0)),-((t[0]??0)*(e[0]??0)+(t[1]??0)*(e[1]??0)+(t[2]??0)*(e[2]??0)),-((V[0]??0)*(e[0]??0)+(V[1]??0)*(e[1]??0)+(V[2]??0)*(e[2]??0)),1])},q3=(e,C,H)=>{let V=!1,L=H.at(-1);if(!L)return!1;for(let r of H){let[t,M]=r,[o,i]=L;M>C!=i>C&&e<(o-t)*(C-M)/(i-M)+t&&(V=!V),L=r}return V},C2=class{#C;#H;#V;#t=null;#r=null;#L=null;#a=null;#i=null;#l=null;#e=null;#x=null;#h=null;#c=null;#m=null;#n=null;#p=null;#o=null;#Z=null;#d=null;#u;#M={yaw:-Math.PI/4,pitch:.82,distance:12,targetX:0,targetZ:0,orthographic:!1};#v=12;#s=8;#A=4;#S=new Float32Array(16);#y=null;#b="unavailable";#F=0;#k=0;#T=0;#O=0;#P=1;#w={width:1,height:1,left:0,top:0};#g=!0;#_=!1;#f=a7;constructor(C,H,V={}){this.#C=C,this.#H=H,this.#V=V,this.#r=H.getContext("2d",{alpha:!0}),this.#C.addEventListener("webglcontextlost",this.#r1),this.#C.addEventListener("webglcontextrestored",this.#t1),this.#Q(),this.#u=new ResizeObserver(()=>{let L=this.#v,r=this.#s;this.#q(),this.#g&&(L!==this.#v||r!==this.#s)?this.fit(!1):this.requestRender()}),this.#u.observe(C)}get camera(){return{...this.#M}}#B(){return{minimum:Math.max(.2,this.#A*.04),maximum:this.#A*8}}#G(){let C=this.#o?.metadata.span,H=this.#o?.metadata.metersPerCell;return!C||H===void 0?{x:this.#A,z:this.#A}:{x:Math.max(.5,C[0]*H*.55),z:Math.max(.5,C[1]*H*.55)}}setCamera(C,H=!0){let V=this.#B(),L=this.#G();this.#M={yaw:R1(C.yaw),pitch:C.orthographic?Math.PI/2-.018:_(C.pitch,.18,1.38),distance:_(C.distance,V.minimum,V.maximum),targetX:_(C.targetX,-L.x,L.x),targetZ:_(C.targetZ,-L.z,L.z),orthographic:C.orthographic},this.#g=!1,this.requestRender(),H&&this.#U()}cameraAfterPan(C,H,V){let L=this.#R(),r=C.distance*1.75/Math.max(200,L.height),t=Math.cos(C.yaw),M=-Math.sin(C.yaw),o=-Math.sin(C.yaw),i=-Math.cos(C.yaw),a=this.#G();return{...C,targetX:_(C.targetX-H*r*t+V*r*o,-a.x,a.x),targetZ:_(C.targetZ-H*r*M+V*r*i,-a.z,a.z)}}setState(C){if(this.#_)return;let H=this.#p;this.#p=C;let V=C.resources.scene.value;V!==this.#o&&(this.#o=V,this.#K(V)),(!H||H.quality!==C.quality)&&(this.#P=i7(C.quality),this.#O=0);let L=H?.workflow!=="draw"&&C.workflow==="draw",r=H?.workflow==="draw"&&C.workflow!=="draw";if(!H||H.view!==C.view||L||r){let t=C.workflow==="draw"?"top":C.view;this.#M=this.#C1(t,C),this.#g=this.#H1(t,C)}C.workflow==="draw"&&H?.draw.zoomPercent!==C.draw.zoomPercent&&(this.#M={...this.#M,orthographic:!0,pitch:Math.PI/2-.018,distance:this.#s*100/C.draw.zoomPercent},this.#g=C.draw.zoomPercent===100&&Math.abs(this.#M.targetX)<.001&&Math.abs(this.#M.targetZ)<.001&&Math.abs(R1(this.#M.yaw))<.001),this.requestRender()}#C1(C,H){let V=C==="top",L=V?this.#s:this.#v,r=H.cameras[C];return r?{yaw:r.yaw,pitch:V?Math.PI/2-.018:r.pitch,distance:_(L/_(r.zoom,.01,100),Math.max(.2,this.#A*.04),this.#A*8),targetX:_(r.targetX,-this.#A,this.#A),targetZ:_(r.targetZ,-this.#A,this.#A),orthographic:V}:V?{yaw:0,pitch:Math.PI/2-.018,distance:L,targetX:0,targetZ:0,orthographic:!0}:{yaw:-Math.PI/4,pitch:.82,distance:L,targetX:0,targetZ:0,orthographic:!1}}#H1(C,H){let V=H.cameras[C];if(!V)return!0;let L=C==="top";return Math.abs(V.zoom-1)<.001&&Math.abs(V.targetX)<.001&&Math.abs(V.targetZ)<.001&&Math.abs(R1(V.yaw-(L?0:-Math.PI/4)))<.001&&(L||Math.abs(V.pitch-.82)<.001)}#D(C,H){let V=this.#t;if(!V)throw new Error("webgl-unavailable");let L=V.createShader(C);if(!L)throw new Error("shader-unavailable");if(V.shaderSource(L,H),V.compileShader(L),!V.getShaderParameter(L,V.COMPILE_STATUS))throw V.deleteShader(L),new Error("shader-failed");return L}#Q(){try{this.#t=this.#C.getContext("webgl2",{alpha:!0,antialias:!0,depth:!0,powerPreference:"high-performance"});let C=this.#t;if(!C)throw new Error("webgl2-unavailable");let H=this.#D(C.VERTEX_SHADER,`#version 300 es
      ...
      `),L=C.createProgram();if(!L)throw new Error("program-unavailable");if(C.attachShader(L,H),C.attachShader(L,V),C.linkProgram(L),C.deleteShader(H),C.deleteShader(V),!C.getProgramParameter(L,C.LINK_STATUS))throw new Error("program-failed");this.#i=L,this.#x=C.getUniformLocation(L,"uViewProjection"),this.#h=C.getUniformLocation(L,"uCenter"),this.#c=C.getUniformLocation(L,"uMetersPerCell"),this.#m=C.getUniformLocation(L,"uPointPixels"),this.#n=C.getUniformLocation(L,"uMaxPointPixels"),this.#l=C.createBuffer(),this.#e=C.createVertexArray(),C.bindVertexArray(this.#e),C.bindBuffer(C.ARRAY_BUFFER,this.#l),C.enableVertexAttribArray(0),C.vertexAttribIPointer(0,2,C.UNSIGNED_SHORT,8,0),C.enableVertexAttribArray(1),C.vertexAttribIPointer(1,1,C.UNSIGNED_BYTE,8,4),C.enableVertexAttribArray(2),C.vertexAttribPointer(2,3,C.UNSIGNED_BYTE,!0,8,5),C.bindVertexArray(null),C.enable(C.DEPTH_TEST),C.depthFunc(C.LEQUAL),C.enable(C.BLEND),C.blendFunc(C.SRC_ALPHA,C.ONE_MINUS_SRC_ALPHA),this.#b="webgl2",this.#F+=1,this.#o&&this.#X(this.#o)}catch{this.#J(),this.#E()}}#K(C){if(this.#I(),!C){this.#k=0,this.requestRender();return}let[H,V]=C.metadata.span,L=C.metadata.metersPerCell,r=H*L,t=V*L;this.#A=Math.max(1,Math.hypot(r,t)/2),this.#q(),this.fit(!1),this.#b==="webgl2"?this.#X(C):this.#$(C)}#q(){let C=this.#o;if(!C)return;let[H,V]=C.metadata.span,L=C.metadata.metersPerCell,r=H*L,t=V*L,M=this.#R(),o=Math.max(.2,M.width/Math.max(1,M.height));this.#v=A7(this.#A,o),this.#s=Math.max(t/2,r/(2*o))*1.12}#X(C){let H=this.#t;if(!H||!this.#l)return;let V=new Uint8Array(C.buffer,C.pointOffset,C.total*8);H.bindBuffer(H.ARRAY_BUFFER,this.#l),H.bufferData(H.ARRAY_BUFFER,V,H.STATIC_DRAW),this.#k=C.total}#E(){this.#b="canvas2d",this.#a=document.createElement("canvas"),this.#a.width=1024,this.#a.height=1024,this.#L=this.#a.getContext("2d",{alpha:!0}),this.#L?this.#o&&this.#$(this.#o):(this.#b="unavailable",this.#V.onProblem?.("renderer-unavailable"))}#$(C){let H=this.#L;if(!H||!this.#a)return;H.clearRect(0,0,this.#a.width,this.#a.height);let V=new DataView(C.buffer,C.pointOffset,C.total*8),L=Math.min(C.total,5e4),r=Math.max(1,Math.ceil(C.total/L)),t=0,M=0,o=()=>{if(this.#_||C!==this.#o||!this.#a)return;let i=Math.min(C.total,t+r*4e3);for(;t<i;t+=r){let a=t*8,n=V.getUint16(a,!0)/Math.max(1,C.metadata.span[0])*this.#a.width,A=V.getUint16(a+2,!0)/Math.max(1,C.metadata.span[1])*this.#a.height,d=V.getUint8(a+5),p=V.getUint8(a+6),u=V.getUint8(a+7);H.fillStyle=`rgb(${d} ${p} ${u})`,H.fillRect(n,A,1.5,1.5),M+=1}this.#k=M,this.requestRender(),t<C.total?this.#d=window.setTimeout(o,0):this.#d=null};o()}#I(){this.#d!==null&&window.clearTimeout(this.#d),this.#d=null}#R(){let C=this.#C.getBoundingClientRect();return this.#w={width:C.width,height:C.height,left:C.left,top:C.top},this.#w}#W(){let C=this.#R(),H=Math.min(window.devicePixelRatio||1,3),V=Math.max(1,Math.round(C.width*H)),L=Math.max(1,Math.round(C.height*H));for(let r of[this.#C,this.#H])(r.width!==V||r.height!==L)&&(r.width=V,r.height=L)}#Y(){let C=this.#w,H=Math.max(.2,C.width/Math.max(1,C.height)),V=Math.cos(this.#M.pitch)*this.#M.distance,L=[this.#M.targetX+Math.sin(this.#M.yaw)*V,Math.sin(this.#M.pitch)*this.#M.distance,this.#M.targetZ+Math.cos(this.#M.yaw)*V],r=[this.#M.targetX,0,this.#M.targetZ],t=p7(L,r),M=this.#M.orthographic?s7(-this.#M.distance*H,this.#M.distance*H,-this.#M.distance,this.#M.distance,-this.#A*4,this.#A*4):d7(X3,H,.02,Math.max(60,this.#A*12));return l7(M,t)}requestRender(){this.#Z!==null||this.#_||(this.#Z=window.requestAnimationFrame(()=>{this.#Z=null,this.#V1()}))}#V1(){let C=performance.now();this.#W(),this.#S=this.#Y(),this.#b==="webgl2"?this.#L1():this.#j(),this.#M1(),this.#T=performance.now()-C,this.#T>18?(this.#O+=1,this.#O>=3&&this.#p?.quality==="auto"&&(this.#P=Math.max(.25,this.#P*.75))):this.#O=Math.max(0,this.#O-1)}#L1(){let C=this.#t,H=this.#o;if(!C||(C.viewport(0,0,this.#C.width,this.#C.height),C.clearColor(0,0,0,0),C.clear(C.COLOR_BUFFER_BIT|C.DEPTH_BUFFER_BIT),!H||!this.#i||!this.#e))return;if(this.#p?.view==="top"&&this.#p.appearance==="rooms"){this.#k=0;return}C.useProgram(this.#i),C.bindVertexArray(this.#e),C.uniformMatrix4fv(this.#x,!1,this.#S),C.uniform2f(this.#h,(H.metadata.span[0]-1)/2,(H.metadata.span[1]-1)/2),C.uniform1f(this.#c,H.metadata.metersPerCell);let V=Math.min(window.devicePixelRatio||1,3),L=Math.max(1,Math.floor(H.total*this.#P)),r=Math.min(H.floorCount,L),t=Math.min(H.surfaceCount,Math.max(0,L-r));C.uniform1f(this.#m,this.#C.height*.038),C.uniform1f(this.#n,4.5*V),C.drawArrays(C.POINTS,0,r),C.uniform1f(this.#m,this.#C.height*.05),C.uniform1f(this.#n,7*V),C.drawArrays(C.POINTS,H.floorCount,t),C.bindVertexArray(null),this.#k=r+t}#j(){}#e1(C,H,V=0){let L=this.#o;return L?[-(C-(L.metadata.span[0]-1)/2)*L.metadata.metersPerCell,V*L.metadata.metersPerCell,(H-(L.metadata.span[1]-1)/2)*L.metadata.metersPerCell]:null}#N(C,H,V=0,L=!0){let r=this.#e1(C,H,V);if(!r)return null;let[t,M,o]=r,i=this.#S,a=(i[0]??0)*t+(i[4]??0)*M+(i[8]??0)*o+(i[12]??0),n=(i[1]??0)*t+(i[5]??0)*M+(i[9]??0)*o+(i[13]??0),A=(i[3]??0)*t+(i[7]??0)*M+(i[11]??0)*o+(i[15]??0);if(A<=.001)return null;let d=a/A,p=n/A;if(!Number.isFinite(d)||!Number.isFinite(p)||L&&(Math.abs(d)>1.15||Math.abs(p)>1.15))return null;let u=this.#w;return{x:(d*.5+.5)*u.width,y:(-p*.5+.5)*u.height}}#z(C,H,V=0){let L=this.#o;if(!L)return null;let r=C/L.metadata.metersPerCell-L.metadata.origin[0],t=H/L.metadata.metersPerCell-L.metadata.origin[1];return this.#N(r,t,V)}#M1(){let C=this.#r,H=this.#o,V=this.#p;if(!C)return;let L=Math.min(window.devicePixelRatio||1,3),r=this.#w;if(C.setTransform(L,0,0,L,0,0),C.clearRect(0,0,r.width,r.height),!H||!V)return;let t=this.#f;if(this.#b==="canvas2d"&&this.#a&&!(V.view==="top"&&V.appearance==="rooms")){let a=this.#s/this.#M.distance,n=r.width*a,A=r.height*a,d=(r.width-n)/2-this.#M.targetX*32*a,p=(r.height-A)/2-this.#M.targetZ*32*a;C.drawImage(this.#a,d,p,n,A)}let M=this.#o1(V);if(V.labelsVisible||V.view==="top"&&V.appearance==="rooms"){C.lineWidth=1.5,C.font="600 12px system-ui, sans-serif",C.textAlign="center",C.textBaseline="middle";let a=[];for(let n of H.metadata.rooms){let A=M.has(n.name.toLocaleLowerCase());C.strokeStyle=A?B(t.accent,1):B(t.quiet,.7),C.fillStyle=A?B(t.accent,.26):V.view==="top"&&V.appearance==="rooms"?B(t.roomFill,.94):B(t.plate,.04),C.beginPath();let d=Math.max(1,Math.ceil(n.boundary.length/512)),p=!1;for(let f=0;f<n.boundary.length;f+=d){let S=n.boundary[f];if(!S)continue;let g=this.#N(S[0],S[1],.2,!1);g&&(p?C.lineTo(g.x,g.y):C.moveTo(g.x,g.y),p=!0)}if(p&&(C.closePath(),C.fill(),C.stroke()),!V.labelsVisible)continue;let u=this.#N(n.center[0],n.center[1],1);if(!u)continue;let h=C.measureText(n.name).width,x=new DOMRect(u.x-h/2-6,u.y-10,h+12,20);a.some(f=>x.left<f.right+8&&x.right+8>f.left&&x.top<f.bottom+4&&x.bottom+4>f.top)||(a.push(x),C.fillStyle=B(t.plate,.88),C.fillRect(x.x,x.y,x.width,x.height),C.fillStyle=B(t.text,1),C.fillText(n.name,u.x,u.y))}}let o=V.draw.circles;if((V.workflow==="draw"||V.workflow==="areaReview")&&o.length){C.fillStyle=B(t.accent,.22),C.strokeStyle=B(t.accent,.92),C.lineWidth=1.5;for(let a of o)this.#i1(C,a)}if(this.#y&&V.workflow==="draw"&&V.draw.tool!=="pan"){let a=this.#z(this.#y.x,this.#y.y),n=this.#z(this.#y.x+V.draw.brushMeters/2,this.#y.y);a&&n&&(C.beginPath(),C.arc(a.x,a.y,Math.max(2,Math.hypot(n.x-a.x,n.y-a.y)),0,Math.PI*2),C.strokeStyle=B(t.accent,1),C.lineWidth=2,C.stroke())}let i=V.resources.pose.value;if(V.map.exactPose&&i?.position&&V.dataMode==="live"){let a=this.#z(i.position[0],i.position[1],3);a&&(C.beginPath(),C.arc(a.x,a.y,7,0,Math.PI*2),C.fillStyle=B(t.accent,1),C.fill(),C.strokeStyle=B(t.onAccent,1),C.lineWidth=3,C.stroke())}}#o1(C){let H=C.resources.plans.value?.rooms||C.resources.areas.value?.rooms||[];return new Set(H.filter(V=>C.selection.roomIds.includes(V.roomId)).map(V=>V.name.toLocaleLowerCase()))}#i1(C,H){let V=this.#z(H.x,H.y),L=this.#z(H.x+H.radius,H.y);!V||!L||(C.beginPath(),C.arc(V.x,V.y,Math.max(1,Math.hypot(L.x-V.x,L.y-V.y)),0,Math.PI*2),C.fill(),C.stroke())}setPalette(C){this.#f=C,this.requestRender()}setCursor(C){this.#y=C,this.requestRender()}screenToMap(C,H){let V=this.#o;if(!V||!this.#M.orthographic)return null;let L=this.#R();if(!L.width||!L.height)return null;let r=this.#M.distance*2/L.height,t=this.#M.targetX+(C-L.left-L.width/2)*r,M=this.#M.targetZ+(H-L.top-L.height/2)*r,o=-t/V.metadata.metersPerCell+(V.metadata.span[0]-1)/2,i=M/V.metadata.metersPerCell+(V.metadata.span[1]-1)/2;return{x:(o+V.metadata.origin[0])*V.metadata.metersPerCell,y:(i+V.metadata.origin[1])*V.metadata.metersPerCell}}roomAt(C,H){let V=this.screenToMap(C,H),L=this.#o,r=this.#p;if(!V||!L||!r)return null;let t=V.x/L.metadata.metersPerCell-L.metadata.origin[0],M=V.y/L.metadata.metersPerCell-L.metadata.origin[1],o=L.metadata.rooms.find(i=>q3(t,M,i.boundary));return o?this.#a1(o,r):null}containsMapPoint(C){let H=this.#o;if(!H)return!1;let V=C.x/H.metadata.metersPerCell-H.metadata.origin[0],L=C.y/H.metadata.metersPerCell-H.metadata.origin[1];return H.metadata.rooms.some(r=>q3(V,L,r.boundary))}#a1(C,H){return(H.resources.plans.value?.rooms||H.resources.areas.value?.rooms||[]).find(L=>L.name.localeCompare(C.name,void 0,{sensitivity:"base"})===0)?.roomId||C.id}selectRoomAt(C,H){let V=this.roomAt(C,H);V&&this.#V.onRoom?.(V)}fit(C=!0){let H=this.#p?.view==="top"||this.#p?.workflow==="draw";this.#M=H?{yaw:0,pitch:Math.PI/2-.018,distance:this.#s,targetX:0,targetZ:0,orthographic:!0}:{yaw:-Math.PI/4,pitch:.82,distance:this.#v,targetX:0,targetZ:0,orthographic:!1},this.#g=!0,this.requestRender(),C&&this.#U()}zoomAt(C,H,V){let L=H===void 0||V===void 0?null:this.screenToMap(H,V),r=this.#B();if(this.#M={...this.#M,distance:_(this.#M.distance/C,r.minimum,r.maximum)},this.#g=!1,L&&H!==void 0&&V!==void 0){let t=this.screenToMap(H,V);t&&(this.#M={...this.#M,targetX:this.#M.targetX-(L.x-t.x),targetZ:this.#M.targetZ+(L.y-t.y)})}this.requestRender(),this.#U(H,V)}panBy(C,H){this.setCamera(this.cameraAfterPan(this.#M,C,H))}orbitBy(C,H){if(this.#M.orthographic){this.panBy(C,H);return}this.#M={...this.#M,yaw:R1(this.#M.yaw+C*.006),pitch:_(this.#M.pitch-H*.004,.18,1.38)},this.#g=!1,this.requestRender(),this.#U()}rotateBy(C){this.#M={...this.#M,yaw:R1(this.#M.yaw+C)},this.#g=!1,this.requestRender(),this.#U()}#U(C,H){let V=this.#M.orthographic?this.#s:this.#v,L=C===void 0||H===void 0?this.#w:this.#R(),r=C===void 0||H===void 0||!L.width||!L.height?void 0:{xPercent:_((C-L.left)/L.width*100,0,100),yPercent:_((H-L.top)/L.height*100,0,100)};this.#V.onCamera?.(this.camera,Math.round(V/this.#M.distance*100),r)}diagnostics(){return{mode:this.#b,contextGeneration:this.#F,sceneRevision:this.#o?.revision??null,sourcePoints:this.#o?.total??0,renderedPoints:this.#k,lastFrameMs:Math.round(this.#T*100)/100,slowFrames:this.#O,cameraDistance:this.#M.distance,fitDistance:this.#M.orthographic?this.#s:this.#v,fitActive:this.#g}}#r1=C=>{C.preventDefault(),this.#J(),this.#E(),this.requestRender()};#t1=()=>{this.#J(),this.#Q(),this.requestRender()};#J(){let C=this.#t;C&&(this.#l&&C.deleteBuffer(this.#l),this.#e&&C.deleteVertexArray(this.#e),this.#i&&C.deleteProgram(this.#i)),this.#l=null,this.#e=null,this.#i=null,this.#t=null}dispose(){this.#_||(this.#_=!0,this.#u.disconnect(),this.#C.removeEventListener("webglcontextlost",this.#r1),this.#C.removeEventListener("webglcontextrestored",this.#t1),this.#Z!==null&&window.cancelAnimationFrame(this.#Z),this.#Z=null,this.#I(),this.#J(),this.#a=null,this.#L=null,this.#r=null,this.#o=null,this.#p=null)}};var Y3="component.matic_robot.common.",T=(e,C,H,V)=>{let L=V?{...V}:void 0,r=e?.(`${Y3}${C}`,L);return r&&r!==`${Y3}${C}`?r:V?Object.entries(V).reduce((t,[M,o])=>t.replaceAll(`{${M}}`,String(o)),H):H};var i1="matic-workspace-intent",H2="matic-workspace-action",j3="navigation-help",J3=(e,C)=>{let H=(L,r,t)=>T(C,L,r,t);if(e.dataMode==="history")return e.map.available?H("v4_saved_map_description","Saved read-only map for {floor}. Live robot position is hidden.",{floor:e.floor.displayName}):e.resources.scene.status==="loading"?H("v4_saved_map_loading_description","The saved map is loading."):H("v4_saved_map_unavailable_description","This saved map is unavailable.");if(!s1(e))return H("v4_private_map_unavailable","The current private map is not available.");let V=i5(e)?H("v4_robot_position_verified","The robot position is verified."):H("v4_robot_position_hidden","The robot position is not shown.");return H("v4_live_map_description","Live map for {floor}. {pose}",{floor:e.floor.displayName,pose:V})},z2=class extends O{constructor(){super();this.state=k();this.narrow=!1;this.#C=null;this.#H=null;this.#V=null;this.#t=!1;this.#r=!1;this.#L=null;this.#a=[];this.#i=null;this.#l=null;this.#m=()=>{this.#h()};new j1(this,{container:()=>this.renderRoot?.querySelector(".camera-steps")??null,items:"button"})}static{this.properties={state:{attribute:!1},localize:{attribute:!1},narrow:{type:Boolean,reflect:!0}}}static{this.styles=[D,$,J,b`
    :host {
      display: block;
      min-width: 0;
      min-height: 0;
...
.map-root { border: 1px solid CanvasText; }
  ...
  `]}#C;#H;#V;#t;#r;#L;#a;#i;#l;#e(H,V,L){return T(this.localize,H,V,L)}connectedCallback(){super.connectedCallback(),this.#n()}firstUpdated(){let H=this.renderRoot.querySelector(".map-root"),V=this.renderRoot.querySelector(".scene-canvas"),L=this.renderRoot.querySelector(".overlay-canvas");!H||!V||!L||(this.#H=new C2(V,L,{onCamera:(r,t,M)=>{this.#o({type:"set-camera",view:this.state.workflow==="draw"?"top":this.state.view,camera:{yaw:r.yaw,pitch:r.pitch,zoom:t/100,targetX:r.targetX,targetZ:r.targetZ}}),this.state.workflow==="draw"&&t!==this.state.draw.zoomPercent&&this.#o({type:"set-zoom",value:t,...M?{originX:M.xPercent,originY:M.yPercent}:{}})},onRoom:r=>this.#o({type:"toggle-room",roomId:r}),onProblem:()=>this.#Z("renderer-problem")}),this.#V=new J1(H,this.#H,{state:()=>this.state,onCircles:(r,t,M)=>this.#o({type:"set-draft-circles",circles:r,record:t,...M?{previous:M}:{}}),onRoom:r=>this.#o({type:"toggle-room",roomId:r})}),this.#H.setState(this.state),this.#h())}disconnectedCallback(){this.#p(),this.#V?.dispose(),this.#V=null,this.#H?.dispose(),this.#H=null,super.disconnectedCallback()}updated(H){this.#r&&(this.#r=!1,this.renderRoot.querySelector(".navigation-help button")?.focus()),H.has("state")&&this.#H?.setState(this.state)}#x(){let H=this.renderRoot?.querySelector(".map-root");!H||!this.#H||this.#H.setPalette(U3(H))}#h(){this.#c(),this.#i=window.requestAnimationFrame(()=>{this.#i=null,this.#l=window.setTimeout(()=>{this.#l=null,this.#x()},0)})}#c(){this.#i!==null&&window.cancelAnimationFrame(this.#i),this.#l!==null&&window.clearTimeout(this.#l),this.#i=null,this.#l=null}#m;#n(){if(!(typeof document>"u"||this.#L)&&(this.#L=new MutationObserver(this.#m),this.#L.observe(document.documentElement,{attributes:!0,attributeFilter:["style","class"]}),typeof window.matchMedia=="function")){this.#a=[window.matchMedia("(prefers-color-scheme: dark)"),window.matchMedia("(forced-colors: active)")];for(let H of this.#a)H.addEventListener("change",this.#m)}}#p(){this.#c(),this.#L?.disconnect(),this.#L=null;for(let H of this.#a)H.removeEventListener("change",this.#m);this.#a=[]}#o(H){this.dispatchEvent(new CustomEvent(i1,{detail:H,bubbles:!0,composed:!0}))}#Z(H){this.dispatchEvent(new CustomEvent(H2,{detail:{id:H},bubbles:!0,composed:!0}))}#d(H){this.#C=H.currentTarget,this.#t=!this.#t,this.#r=this.#t,this.requestUpdate()}#u(){if(!this.#t)return;this.#t=!1,this.requestUpdate();let H=this.#C;H?.isConnected&&H.focus()}#M(){for(let H of this.state.selection.roomIds)this.#o({type:"toggle-room",roomId:H})}#v(H,V){this.#H?.orbitBy(H,V)}#s(H){if(!(H.ctrlKey||H.metaKey||H.altKey)&&H.key==="Escape"){if(H.preventDefault(),this.#t){this.#u();return}this.#o({type:"dismiss-top-layer"});return}}rendererDiagnostics(){return this.#H?.diagnostics()??null}canvasIdentity(){return{scene:this.renderRoot.querySelector(".scene-canvas"),overlay:this.renderRoot.querySelector(".overlay-canvas")}}#A(){return this.state.host.connected?this.state.host.administrator?this.state.host.robotCount===0?{title:this.#e("v4_no_robot","No Matic robot set up"),detail:this.#e("v4_no_robot_detail","Set up a robot before opening its map.")}:this.state.dataMode==="history"?!this.state.map.available&&this.state.resources.scene.status==="loading"?{title:this.#e("v4_loading_saved_map","Loading saved map"),detail:this.#e("v4_loading_saved_map_detail","This read-only snapshot is still preparing.")}:this.state.map.available?null:{title:this.#e("v4_saved_map_unavailable","Saved map unavailable"),detail:this.#e("v4_saved_map_unavailable_detail","Choose another snapshot or return to the live map.")}:this.state.host.robotConnected?this.state.coherence==="verifying"||this.state.coherence==="booting"?{title:this.#e("v4_locating_map","Locating the current map"),detail:this.#e("v4_locating_map_detail","Map controls will return after the floor is verified.")}:!this.state.map.available&&this.state.resources.scene.status==="loading"?{title:this.#e("v4_loading_verified_map","Loading the verified map"),detail:this.#e("v4_loading_verified_map_detail","The current floor is verified. The private scene is still preparing.")}:this.state.map.available?this.state.activity==="problem"?{title:this.#e("v4_robot_attention","Robot needs attention"),detail:this.#e("v4_robot_attention_detail","Check the robot before starting another task.")}:null:{title:this.#e("v4_map_unavailable","Map unavailable"),detail:this.#e("v4_map_unavailable_detail","The private scene is not ready. No map data is shown until it is verified.")}:{title:this.#e("v4_robot_offline","Robot offline"),detail:this.#e("v4_robot_offline_detail","The last verified map stays read only and has no live position.")}:{title:this.#e("v4_admin_required","Administrator access required"),detail:this.#e("v4_private_map_hidden","Private map data is hidden.")}:{title:this.#e("v4_reconnecting","Reconnecting"),detail:this.#e("v4_reconnecting_detail","The verified map is read only until Home Assistant reconnects.")}}#S(H,V){let L=this.state,r=this.narrow,t=L.workflow==="draw",M=this.#e("v4_how_to_move","How to move the map"),o=H&&!t,i=o&&!r&&L.view==="top",a=o&&L.view==="three",n=!V,A=!r&&!t;return!o&&!n?l:s`
      <div class="map-rail" data-map-control>
        ...
        ${a?s`
          <div class="camera-steps ms-surface ms-surface--floating ms-segment" role="toolbar" aria-orientation="horizontal" aria-label=${this.#e("map_camera_controls","Map camera controls")}>
            <button class="ms-btn ms-btn--icon" type="button" aria-label=${this.#e("map_rotate_left","Rotate left")} aria-keyshortcuts="[" @click=${()=>this.#v(-52,0)}>${Z(y3)}</button>
            <button class="ms-btn ms-btn--icon" type="button" aria-label=${this.#e("map_tilt_down","Lower viewing angle")} aria-keyshortcuts="PageDown" @click=${()=>this.#v(0,30)}>${Z(h3)}</button>
            <button class="ms-btn ms-btn--icon" type="button" aria-label=${this.#e("map_tilt_up","Raise viewing angle")} aria-keyshortcuts="PageUp" @click=${()=>this.#v(0,-30)}>${Z(Z3)}</button>
            <button class="ms-btn ms-btn--icon" type="button" aria-label=${this.#e("map_rotate_right","Rotate right")} aria-keyshortcuts="]" @click=${()=>this.#v(52,0)}>${Z(b3)}</button>
          </div>
        `:l}
    ...
    `}#y(H){let V=this.state;if(!H)return l;if(V.workflow==="draw"&&!this.narrow)return s`
      ...
      `:l}render(){let H=this.state,V=l5(H),L=this.#A(),r=H.map.available&&(s1(H)||H.dataMode==="history"),t=H.workflow==="draw"&&r,M=H.coherence==="verifying"||H.coherence==="booting";return s`
      <section
        class="map-root"
        tabindex="0"
          ...
          ${M.map(({room:o,label:i,selected:a})=>{let n=a?L.rooms.findIndex(A=>A.roomId===o.roomId):-1;return s`
              <div class="room plan-room ms-row ms-row--stack" data-selected=${String(a)}>
                <label class="room-choice">
                  ...
                  ${a?s`
                    <span>
                      <button class="icon-button ms-btn ms-btn--icon" type="button" aria-label=${this.#H("move_room_up","Move {room} earlier",{room:i})} ?disabled=${n===0} @click=${A=>{A.preventDefault(),this.#c(n,-1)}}>${Z(R3)}</button>
                      <button class="icon-button ms-btn ms-btn--icon" type="button" aria-label=${this.#H("move_room_down","Move {room} later",{room:i})} ?disabled=${n===L.rooms.length-1} @click=${A=>{A.preventDefault(),this.#c(n,1)}}>${Z(F3)}</button>
                    </span>
                  `:l}
                </label>
                ${a?s`
...
`),L=typeof navigator>"u"?void 0:navigator.clipboard;if(L&&typeof L.writeText=="function")try{await L.writeText(V),this.#u("copied");return}catch{}this.#u(this.#M(V,H instanceof HTMLElement?H:null)?"copied":"failed")}#s(){let H=this.#d(),V=this._copyStatus==="copied"?this.#H("v4_copied","Copied"):this._copyStatus==="failed"?this.#H("v4_copy_failed","The summary could not be copied. Select the text to copy it by hand."):"";return s`
  ...
  `]}#C(H,V,L){return T(this.localize,H,V,L)}#H;#V;#t;#r;#L;#a;#i;#l;#e;#x;#h;connectedCallback(){super.connectedCallback(),this.#H=new ResizeObserver(([H])=>{if(!H)return;let V=H.contentRect.width<768||H.contentRect.height<480;V!==this._measuredNarrow&&(this._measuredNarrow=V)}),this.#H.observe(this),window.addEventListener("pointerdown",this.#h,!0),document.addEventListener("fullscreenchange",this.#x),this.#V=new ResizeObserver(([H])=>{if(!H)return;let V=Math.ceil(H.target.getBoundingClientRect().height);V!==this._sheetOffset&&(this._sheetOffset=V)})}disconnectedCallback(){this.#H?.disconnect(),this.#H=null,this.#V?.disconnect(),this.#V=null,this.#t=null,window.removeEventListener("pointerdown",this.#h,!0),document.removeEventListener("fullscreenchange",this.#x),super.disconnectedCallback()}updated(H){let V=H,L=this.renderRoot.querySelector(".mobile-sheet");if(L!==this.#t&&(this.#V?.disconnect(),this.#t=L,L?this.#V?.observe(L):this._sheetOffset!==0&&(this._sheetOffset=0)),V.has("_overflowOpen")&&this._overflowOpen&&this.updateComplete.then(()=>{this.renderRoot.querySelector("#map-options select, #map-options button")?.focus()}),V.has("_helpOpen")){if(this._helpOpen)this.updateComplete.then(()=>{this.renderRoot.querySelector(".help-dialog [data-dialog-initial-focus]")?.focus()});else if(V.get("_helpOpen")){let r=this.#a;this.#a=null,this.updateComplete.then(()=>{requestAnimationFrame(()=>r?.focus({preventScroll:!0}))})}}if(H.has("state")){let r=H.get("state");if(r?.precisionOpen&&!this.state.precisionOpen&&this.#m()?.focus(),r?.fullMap&&!this.state.fullMap){let t=this.#L;this.#L=null,this.updateComplete.then(()=>{requestAnimationFrame(()=>{(this.renderRoot.querySelector(".workspace-toggle")??this.renderRoot.querySelector(".nav--menu")??(t?.isConnected?t:null))?.focus({preventScroll:!0})})})}if(!r?.dialog&&this.state.dialog){let t=S7(this.shadowRoot||document);t?.hasAttribute("data-dialog-launcher")&&(this.#r=t),this.updateComplete.then(()=>{(this.renderRoot.querySelector(".dialog [data-dialog-initial-focus]")??this.renderRoot.querySelector(".dialog button"))?.focus()})}else if(r?.dialog&&!this.state.dialog){let t=this.#r?.isConnected&&this.#r.hasAttribute("data-dialog-launcher")?this.#r:this.#D(r.dialog);this.#r=null,this.updateComplete.then(()=>{requestAnimationFrame(()=>t?.focus({preventScroll:!0}))})}r?r.workflow!==this.state.workflow&&(this._sheetDetent=e0[this.state.workflow],this.updateComplete.then(()=>this.#c())):this._sheetDetent=e0[this.state.workflow]}}#c(){let H=this.renderRoot.querySelector(".panel-heading h2");if(q2(H)){H.focus({preventScroll:!0});return}let V=this.renderRoot.querySelector(".action-bar .ms-btn--primary");q2(V)&&V.focus({preventScroll:!0})}#m(){let H=this.renderRoot.querySelector(".draw-brush");return q2(H)?H:this.renderRoot.querySelector(t1)?.shadowRoot?.querySelector(".draw-brush")??null}#n(H){this.dispatchEvent(new CustomEvent(i1,{detail:H,bubbles:!0,composed:!0}))}#p(H){if(H.enabled){if(H.id==="return-live"){this.#n({type:"set-history",historyId:null});return}if(H.id==="clear-draft"){this.#n({type:"clear-draft"});return}this.#M(H.id)}}#o(H){if(this.state.workflow==="draw"&&this.state.draw.dirty&&H!=="draw"&&H!=="areaReview"){this.#i=H,this.#n({type:"open-dialog",dialog:"discardDraft"});return}this.#n({type:"open-workflow",workflow:H})}#Z(){let H=this.#i;this.#i=null,this.#n({type:"discard-draft"}),H&&queueMicrotask(()=>this.#n({type:"open-workflow",workflow:H}))}#d(){this.#i=null,this.#u()}#u(){let H=this.state.dialog,V=H&&this.#r?.isConnected&&this.#r.hasAttribute("data-dialog-launcher")?this.#r:H?this.#D(H):null;this.#n({type:"dismiss-top-layer"}),V&&requestAnimationFrame(()=>V.focus({preventScroll:!0}))}#M(H){this.dispatchEvent(new CustomEvent(H2,{detail:{id:H},bubbles:!0,composed:!0}))}#v(H){this.#n({type:"dismiss-top-layer"}),this.#M(H)}#s(H){if(H.action==="discard"){this.#Z();return}if(H.action==="delete-plan"||H.action==="delete-area"){this.#v(H.action);return}this.#n({type:"dismiss-top-layer"}),H.action==="stop"&&this.#M("stop")}#A(H){H!==this._sheetDetent&&(this._sheetDetent=H,this._announcement=this.#C("v4_workspace_height","Map workspace, {height} height",{height:H}))}#S(H,V=!1){let r=C1.indexOf(this._sheetDetent)+H;V&&r>=C1.length&&(r=0),r=Math.max(0,Math.min(C1.length-1,r)),this.#A(C1[r]??this._sheetDetent)}#y(H){let V=this.renderRoot.querySelector(".workspace")?.clientHeight??H.parentElement?.clientHeight??H.offsetHeight,L=parseFloat(getComputedStyle(this).fontSize)||16,r=[".sheet-grip",".sheet-tools",".action-bar"].map(o=>H.querySelector(o)?.offsetHeight??0).reduce((o,i)=>o+i,0)+L*.75,t=Math.min(V*.92,V-L*4),M=Math.min(V*.48,L*26,t);return{peek:Math.min(r,M),half:M,full:t}}#b(){return this.renderRoot.querySelector(".mobile-sheet")}#F(H){if(H.pointerType==="mouse"&&H.button!==0||H.target?.closest("button, select, input, a"))return;let V=this.#b();!V||this.#l||(this.#l={pointerId:H.pointerId,startY:H.clientY,startHeight:V.offsetHeight,heights:this.#y(V),samples:[{y:H.clientY,t:H.timeStamp}],moved:!1},H.currentTarget.setPointerCapture(H.pointerId),V.classList.add("dragging"))}#k(H){let V=this.#l;if(!V||H.pointerId!==V.pointerId)return;let L=this.#b();if(!L)return;let r=H.clientY-V.startY;for(!V.moved&&Math.abs(r)>u7&&(V.moved=!0),V.samples.push({y:H.clientY,t:H.timeStamp});V.samples.length>2&&H.timeStamp-(V.samples[1]?.t??0)>c7;)V.samples.shift();if(!V.moved)return;let t=V.startHeight-V.heights.full,M=V.startHeight-V.heights.peek,o=Math.max(t,Math.min(M,r));L.style.transform=`translateY(${o}px)`}#T(H){let V=this.#l;if(!V||H.pointerId!==V.pointerId)return;this.#l=null;let L=this.#b();if(L&&(L.style.transform="",L.classList.remove("dragging")),H.type==="pointercancel")return;if(!V.moved){this.#S(1,!0);return}let r=H.clientY-V.startY,t=C1.indexOf(this._sheetDetent),M=V.samples[0],o=V.samples[V.samples.length-1],i=M&&o&&o!==M?(o.y-M.y)/Math.max(1,o.t-M.t):0;if(Math.abs(i)>v7){let d=Math.max(0,Math.min(C1.length-1,t+(i<0?1:-1)));this.#A(C1[d]??this._sheetDetent);return}let a=V.startHeight-r,n=this._sheetDetent,A=Number.POSITIVE_INFINITY;for(let d of C1){let p=Math.abs(V.heights[d]-a);p<A&&(A=p,n=d)}this.#A(n)}#O(H){if(H.pointerType==="mouse")return;let V=H.currentTarget;this.#e={pointerId:H.pointerId,startY:H.clientY,atTop:V.scrollTop===0,consumed:!1}}#P(H){let V=this.#e;if(!V||V.consumed||!V.atTop||H.pointerId!==V.pointerId)return;if(H.currentTarget.scrollTop>0){this.#e=null;return}H.clientY-V.startY<x7||(V.consumed=!0,this.#S(-1))}#w(){this.#e=null}#g(){this.dispatchEvent(new CustomEvent("hass-toggle-menu",{bubbles:!0,composed:!0}))}#_(H){this.#L=H.currentTarget,this.#n({type:this.state.fullMap?"exit-full-map":"enter-full-map"})}#f(H){this._overflowOpen=!1,H&&this.updateComplete.then(()=>{this.renderRoot.querySelector(".overflow")?.focus()})}#B(H){if(this.#f(H==="fullscreen"),H==="support"){this.#o("support");return}if(H==="fullscreen"){let V=this.renderRoot.querySelector(".app");document.fullscreenElement?document.exitFullscreen():V?.requestFullscreen();return}this.dispatchEvent(new CustomEvent(H2,{detail:{id:"use-classic"},bubbles:!0,composed:!0}))}#G(){this.#n({type:"set-precision-open",value:!this.state.precisionOpen})}#C1(H){this.#a=H.currentTarget,this._helpOpen=!0}#H1(H){let V=H;if(V.detail?.type!=="open-dialog")return;let L=V.composedPath().find(r=>r instanceof HTMLElement&&r.hasAttribute("data-dialog-launcher"));L instanceof HTMLElement&&(this.#r=L)}#D(H){return this.renderRoot.querySelector(c1)?.shadowRoot?.querySelector(`[data-dialog-launcher="${H}"]`)??null}#Q(H){if(!(H.defaultPrevented||H.ctrlKey||H.metaKey||H.altKey)&&H.key==="Escape"){if(H.preventDefault(),this._overflowOpen){this.#f(!0);return}if(this._helpOpen){this._helpOpen=!1;return}this.#n({type:"dismiss-top-layer"})}}#K(H){if(H.key!=="Tab")return;let L=[...H.currentTarget.querySelectorAll(Z7)],r=L[0],t=L.at(-1);if(!r||!t)return;let M=this.shadowRoot?.activeElement;H.shiftKey&&M===r?(H.preventDefault(),t.focus()):!H.shiftKey&&M===t&&(H.preventDefault(),r.focus())}#q(){let H=this.renderRoot.querySelector(t1);(H?.shadowRoot?.querySelector(".map-root")??H)?.focus()}#X(){this._sheetDetent==="peek"&&this.#b()&&this.#A("half"),this.updateComplete.then(()=>this.#c())}#E(H,V,L){if(H.id==="choose-cleaning")return l;let r=H.labelKey?this.#C(H.labelKey,H.label):H.label,t=!H.enabled&&H.reason?H.reasonKey?this.#C(H.reasonKey,H.reason):H.reason:null,M=H.id==="stop";return c`
    ...
    `}#Y(H){let V=H.resources.history.value?.floors||[],L=V.length?V.map((r,t)=>({id:r.active?"current":r.id,label:`${r.label||(r.active?this.#C("v4_current_floor","Current floor"):this.#C("v4_saved_floor","Saved floor {number}",{number:r.ordinal??t+1}))}${!r.active&&r.snapshots.length===0?` \xB7 ${this.#C("v4_floor_not_captured","Visit floor to capture")}`:""}`,disabled:!r.active&&r.snapshots.length===0})):[{id:H.selection.floorId,label:H.floor.displayName,disabled:!1}];return c`
      ...
      `)}</select>
    `}#V1(H,V){let L=(f,S,g)=>this.#C(f,S,g),r=this.#W(L("v4_map_history","Map history"),$2,()=>this.#o("history"),L("v4_map_history_detail","Saved maps are floor-scoped and read only.")),t=this.#W(L("v4_map_diagnostics","Map diagnostics"),I3,()=>this.#o("support"),L("v4_map_support_detail","Private geometry is never included.")),{host:M}=H;if(!M.connected)return this.#R(L("v4_reconnecting_title","Reconnecting to Home Assistant"),L("v4_reconnecting_body","The last verified map stays read-only until the connection returns."));if(!M.administrator)return this.#R(L("v4_admin_title","Administrator access required"),L("v4_admin_body","Ask a Home Assistant administrator to open this map."));if(M.robotCount===0)return this.#R(L("v4_no_robot_title","No Matic robot set up"),L("v4_no_robot_body","Add the Matic integration to see a map here."),c`<a class="ms-btn ms-btn--secondary" href="/config/integrations/integration/matic_robot">${L("v4_open_integration","Open the Matic integration")}</a>`);if(!M.robotConnected)return c`
        ${this.#R(L("v4_robot_offline_title","Robot offline"),L("v4_robot_offline_body","Showing the last verified map. Cleaning is unavailable until the robot reconnects."))}
        <h3 class="shelf-heading">${L("v4_more","Map tools")}</h3>
        <div class="shelf">${r}${t}</div>
      `;let o=H.coherence==="verifying"||H.coherence==="booting",i=H.resources.plans,a=i.value,n=a!==null&&a.rooms.length===0,A=a?.plans.length??0,d=i.status==="loading",p=i.status==="error",u=o||n,h=o?L("v4_reason_locating","Waiting for the robot to confirm which floor it is on."):n?L("v4_no_rooms_reason","This floor has no named rooms yet."):null,x=o?L("v4_reason_locating","Waiting for the robot to confirm which floor it is on."):null;return c`
      ${H.activity==="problem"?this.#R(L("v4_attention_title","The robot needs attention"),L("v4_attention_body","Check the robot, then start a new task.")):c`
      ...
      `:l}
    `}#L1(H,V){return H.workflow==="none"?this.#V1(H,V):c`<${V0}
      .state=${H}
      .localize=${this.localize}
      @matic-workspace-intent=${this.#H1}
    ></${V0}>`}#j(H,V){let L=L0(H,this.localize);return c`
    ...
    `}render(){let H=this.state,V=H.narrowHint||this._measuredNarrow,L=m7(H,this.localize),r=n5({...H,narrowHint:V}),t=A5(H),M=!V&&r.id==="stop"?r:!V&&t?.id==="stop"?t:null,o=M&&M===r?null:r,i=H.workflow==="draw"&&H.dataMode==="live"?{id:"clear-draft",label:"Clear drawing",labelKey:"v4_clear_drawing",kind:"neutral",enabled:H.draw.circles.length>0}:null,a=M&&M===t?null:t??i,n=H.fullMap&&(H.coherence==="verifying"||H.coherence==="booting"),A=H.fullMap||H.host.administrator&&H.host.robotCount>0&&H.map.available,d=h7(H.dialog,this.localize),p=V&&!H.fullMap?`--map-sheet-offset:${this._sheetOffset}px`:"--map-sheet-offset:0px",u=V&&H.workflow==="draw",h=H.precisionOpen&&H.workflow==="draw";return c`
