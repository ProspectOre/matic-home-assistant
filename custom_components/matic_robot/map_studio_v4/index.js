              ...
              <div class="room plan-room ms-row ms-row--stack" data-selected=${String(a)}>
                ...
                ${a?d`
                  <div class="split room-settings">
                    ...
                    <label class="field ms-field">${this.#H("cleaning_mode","Cleaning mode")}
                      <select aria-label=${this.#H("v4_room_cleaning_mode_named","Cleaning mode for {room}",{room:i})} .value=${M.coverageSetting} @change=${A=>this.#g(n,{coverageSetting:I(A)})}>${j2.map(A=>d`<option value=${A} ?selected=${A===M.coverageSetting}>${this.#M(A)}</option>`)}</select>
                    </label>
                  </div>
                `:s}
              </div>
