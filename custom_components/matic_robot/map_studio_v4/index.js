...
`;var t3=Symbol.for(""),_7=L=>{if(L?.r===t3)return L?._$litStatic$},H1=L=>({_$litStatic$:L,r:t3});var r3=new Map,H5=L=>(C,...H)=>{let V=H.length,e,r,t=[],M=[],o,i=0,a=!1;for(;i<V;){for(o=C[i];i<V&&(r=H[i],(e=_7(r))!==void 0);)o+=e+C[++i],a=!0;i!==V&&M.push(r),t.push(o),i++}if(i===V&&t.push(C[V]),a){let n=t.join("$$lit$$");(C=r3.get(n))===void 0&&(t.raw=t,r3.set(n,C=t)),H=M}return L(C,...H)},u=H5(p),Y4=H5(J5),j4=H5(C3);var M3=import.meta.url.match(/\/matic_robot\/[^/]+-([a-f0-9]{12})\/map-studio-v4(?:\/|$)/u)?.[1]??"dev",I1=M3==="dev"?"":`-${M3}`,A1=`matic-map-canvas-v4${I1}`,W1=`matic-precision-controls-v4${I1}`,s1=`matic-map-workflow-v4${I1}`,d1=`matic-map-shell-v4${I1}`,V5=`matic-map-panel-v0-4-0${I1}`;var V1=w`
.ms-btn, .ms-row {
  ...
  `};var M0=(L,C)=>Math.hypot(L.x-C.x,L.y-C.y),o0=(L,C)=>({x:(L.x+C.x)/2,y:(L.y+C.y)/2}),i0=(L,C)=>Math.atan2(C.y-L.y,C.x-L.x),B7=L=>{let C=L;for(;C>Math.PI;)C-=Math.PI*2;for(;C<-Math.PI;)C+=Math.PI*2;return C},p1=(L,C,H)=>Math.max(C,Math.min(H,L)),z1=L=>L.map(C=>({...C})),R7="button, input, select, textarea, a, [contenteditable='true'], [role='button'], [role='menuitem'], [data-map-control]",L1=L=>L.composedPath().some(C=>C instanceof Element&&C.matches(R7)),A2=L=>L.composedPath().some(C=>C instanceof Element&&C.matches("select")),l2=class{#C;#H;#V;#r=new Map;#t=!1;#L="idle";#o=[];#i=null;#a=[];#A=null;#u=0;#M=null;#y=0;#h=null;#n=null;#v=null;#l=0;#p=null;#s=!1;#S=null;#e=!1;constructor(C,H,V){this.#C=C,this.#H=H,this.#V=V,C.addEventListener("pointerdown",this.#x),C.addEventListener("pointermove",this.#f),C.addEventListener("pointerup",this.#d),C.addEventListener("pointercancel",this.#d),C.addEventListener("wheel",this.#c,{passive:!1}),C.addEventListener("gesturestart",this.#Z,{passive:!1}),C.addEventListener("gesturechange",this.#w,{passive:!1}),C.addEventListener("gestureend",this.#O,{passive:!1}),C.addEventListener("dblclick",this.#g),C.addEventListener("contextmenu",this.#T),C.addEventListener("keydown",this.#k),C.addEventListener("keyup",this.#R),C.addEventListener("blur",this.#P)}#x=C=>{if(this.#e||!C.isPrimary&&C.pointerType==="mouse"||L1(C))return;this.#C.focus({preventScroll:!0}),this.#b(),C.pointerType==="touch"&&!C.isPrimary&&this.#r.size===0&&this.#V.state().draw.tool==="outline"&&(this.#s=!0);let H=performance.now(),V={id:C.pointerId,type:C.pointerType,startX:C.clientX,startY:C.clientY,x:C.clientX,y:C.clientY,lastX:C.clientX,lastY:C.clientY,lastTime:H,velocityX:0,velocityY:0};if(this.#r.set(C.pointerId,V),this.#C.setPointerCapture?.(C.pointerId),this.#r.size>=2){this.#_(),(this.#L==="paint"||this.#L==="erase")&&(this.#a=z1(this.#o),this.#V.onCircles(this.#a,!1,this.#o,this.#i)),this.#L="pinch",this.#C.classList.add("navigating"),this.#s=!0;let[M,o]=[...this.#r.values()];M&&o&&(this.#u=Math.max(1,M0(M,o)),this.#M=o0(M,o),this.#y=i0(M,o),this.#h=this.#H.camera),C.preventDefault();return}let e=this.#V.state(),r=e.workflow==="draw"&&e.map.available&&!e.floor.readOnly;this.#s||this.#t||C.button===1||C.button===2||e.draw.tool==="pan"?(this.#L="pan",this.#n=this.#H.camera):r&&e.draw.tool==="outline"&&_(e)?this.#L="outline":r&&(e.draw.tool==="paint"||e.draw.tool==="erase")?(this.#o=z1(e.draw.circles),this.#i=e.draw.outline??null,this.#a=z1(e.draw.circles),C.pointerType==="touch"?(this.#L="idle",this.#S=window.setTimeout(()=>{if(this.#S=null,this.#r.size!==1||this.#s)return;this.#L=e.draw.tool;let M=this.#r.get(C.pointerId);M&&this.#m(M.x,M.y)},110)):(this.#L=e.draw.tool,this.#m(C.clientX,C.clientY))):(this.#L=e.view==="three"&&!C.shiftKey?"orbit":"pan",this.#n=this.#H.camera),(this.#L==="pan"||this.#L==="orbit")&&this.#C.classList.add("navigating"),C.preventDefault()};#f=C=>{let H=this.#r.get(C.pointerId);if(!H){let a=this.#H.screenToMap(C.clientX,C.clientY);this.#H.setCursor(a);return}let e=(C.getCoalescedEvents?.()||[]).at(-1)||C,r=performance.now(),t=Math.max(1,r-H.lastTime),M=(e.clientX-H.lastX)/t,o=(e.clientY-H.lastY)/t;if(H.velocityX=H.velocityX*.62+M*.38,H.velocityY=H.velocityY*.62+o*.38,H.lastX=e.clientX,H.lastY=e.clientY,H.lastTime=r,H.x=e.clientX,H.y=e.clientY,this.#L==="pinch"&&this.#r.size>=2){let[a,n]=[...this.#r.values()];if(!a||!n)return;let A=Math.max(1,M0(a,n)),l=o0(a,n),d=i0(a,n),m=this.#h;if(m&&this.#M){let x={...m,distance:m.distance*this.#u/A,yaw:m.yaw+B7(d-this.#y),pitch:m.orthographic?m.pitch:m.pitch-(l.y-this.#M.y)*.0035};this.#H.setCamera(this.#H.cameraAfterPan(x,l.x-this.#M.x,l.y-this.#M.y))}C.preventDefault();return}this.#L==="paint"||this.#L==="erase"?this.#m(C.clientX,C.clientY):this.#L==="pan"?this.#n&&this.#H.setCamera(this.#H.cameraAfterPan(this.#n,e.clientX-H.startX,e.clientY-H.startY)):this.#L==="orbit"&&this.#n&&this.#H.setCamera({...this.#n,yaw:this.#n.yaw+(e.clientX-H.startX)*.0045,pitch:this.#n.pitch-(e.clientY-H.startY)*.004});let i=this.#H.screenToMap(e.clientX,e.clientY);this.#H.setCursor(i),C.preventDefault()};#d=C=>{let H=this.#r.get(C.pointerId);if(!H)return;let V=this.#L;if(this.#r.delete(C.pointerId),this.#C.releasePointerCapture?.(C.pointerId),this.#_(),this.#L==="outline"&&C.type!=="pointercancel"&&Math.hypot(H.x-H.startX,H.y-H.startY)<7){let e=this.#H.screenToMap(H.x,H.y);e&&this.#V.onOutlinePoint?.(e)}if((this.#L==="paint"||this.#L==="erase")&&JSON.stringify(this.#a)!==JSON.stringify(this.#o))this.#V.onCircles(this.#a,!0,this.#o,this.#i);else if(this.#L!=="pinch"&&!this.#s&&Math.hypot(H.x-H.startX,H.y-H.startY)<7&&this.#V.state().workflow==="rooms"){let e=this.#H.roomAt(H.x,H.y);e&&this.#V.onRoom(e)}if(this.#r.size===0)this.#L="idle",this.#C.classList.remove("navigating"),this.#s=!1,this.#M=null,this.#h=null,this.#n=null,this.#A=null,(V==="pan"||V==="orbit")&&H.type!=="mouse"&&this.#F(H.velocityX,H.velocityY,V);else if(this.#L==="pinch"){this.#L="pan",this.#s=!0;let e=this.#r.values().next().value;e&&(e.startX=e.x,e.startY=e.y,e.velocityX=0,e.velocityY=0),this.#n=this.#H.camera,this.#h=null}C.preventDefault()};#m(C,H,V=!0){let e=this.#H.screenToMap(C,H);if(!e)return;let r=this.#V.state(),t=r.draw.brushMeters/2;if(this.#L==="erase")this.#a=this.#a.filter(M=>Math.hypot(M.x-e.x,M.y-e.y)>M.radius+t);else{if(!this.#H.containsMapPoint(e))return;let M=Math.max(.04,t*.55),o=this.#A||e,i=Math.hypot(e.x-o.x,e.y-o.y),a=Math.max(1,Math.ceil(i/M));for(let n=0;n<=a&&this.#a.length<512;n+=1){let A=n/a,l={x:o.x+(e.x-o.x)*A,y:o.y+(e.y-o.y)*A};this.#a.some(d=>Math.hypot(d.x-l.x,d.y-l.y)<Math.max(.025,t*.28))||this.#a.push({x:Math.round(l.x*1e4)/1e4,y:Math.round(l.y*1e4)/1e4,radius:Math.round(t*100)/100})}}this.#A=e,V&&JSON.stringify(this.#a)!==JSON.stringify(r.draw.circles)&&this.#V.onCircles(this.#a,!1)}#c=C=>{if(L1(C))return;C.preventDefault(),this.#C.focus({preventScroll:!0}),this.#b();let H=C.deltaMode===WheelEvent.DOM_DELTA_LINE?16:C.deltaMode===WheelEvent.DOM_DELTA_PAGE?Math.max(1,this.#C.clientHeight):1,V=C.deltaX*H,e=C.deltaY*H;if(C.ctrlKey||C.metaKey){this.#H.zoomAt(Math.exp(p1(-e*.008,-.28,.28)),C.clientX,C.clientY);return}if(C.altKey&&this.#V.state().view==="three"){this.#H.orbitBy(0,p1(e,-80,80)*.75);return}if(C.deltaMode!==WheelEvent.DOM_DELTA_PIXEL||Math.abs(V)<.5&&Math.abs(e)>=50){this.#H.zoomAt(Math.exp(p1(-e*.0025,-.28,.28)),C.clientX,C.clientY);return}this.#H.panBy(-p1(V,-80,80),-p1(e,-80,80))};#Z=C=>{this.#e||L1(C)||(this.#C.focus({preventScroll:!0}),this.#b(),this.#C.classList.add("navigating"),this.#v=this.#H.camera,this.#l=Number.isFinite(C.rotation)?C.rotation:0,C.preventDefault())};#w=C=>{if(this.#e||L1(C))return;let H=this.#v;if(!H||this.#r.size>=2)return;let V=Number.isFinite(C.scale)&&C.scale>0?Math.max(.1,C.scale):1,e=Number.isFinite(C.rotation)?C.rotation:0;this.#H.setCamera({...H,distance:H.distance/V,yaw:H.yaw+(e-this.#l)*Math.PI/180}),C.preventDefault()};#O=C=>{let H=this.#v!==null;this.#v=null,this.#l=0,this.#C.classList.remove("navigating"),H&&!L1(C)&&C.preventDefault()};#E(C){let H=this.#V.state();if(C.repeat||this.#e||this.#r.size||C.composedPath()[0]!==this.#C||!this.#C.matches(":focus")||H.workflow!=="draw"||!_(H)||H.command!=="idle"&&H.command!=="failed"||H.draw.tool!=="paint"&&H.draw.tool!=="erase"&&H.draw.tool!=="outline")return;let e=this.#C.querySelector(".scene-canvas")?.getBoundingClientRect();if(!(!e?.width||!e.height)){if(C.preventDefault(),this.#b(),H.draw.tool==="outline"){let r=this.#H.screenToMap(e.left+e.width/2,e.top+e.height/2);r&&this.#V.onOutlinePoint?.(r);return}this.#o=z1(H.draw.circles),this.#i=H.draw.outline??null,this.#a=z1(H.draw.circles),this.#A=null,this.#L=H.draw.tool,this.#m(e.left+e.width/2,e.top+e.height/2,!1),this.#L="idle",this.#A=null,JSON.stringify(this.#a)!==JSON.stringify(this.#o)&&this.#V.onCircles(this.#a,!0,this.#o,this.#i)}}#k=C=>{if(L1(C)||C.defaultPrevented||C.ctrlKey||C.metaKey||C.altKey)return;if(C.key==="Enter"){this.#E(C);return}if(C.code==="Space"){this.#t=!0,C.preventDefault();return}this.#b();let H=this.#V.state(),V=C.key.toLocaleLowerCase();if(C.key==="+"||C.key==="=")this.#H.zoomAt(1.25);else if(C.key==="-")this.#H.zoomAt(.8);else if(C.key==="0")this.#H.fit();else if(V==="3")this.#B({type:"set-view",view:"three"});else if(V==="t")this.#B({type:"set-view",view:"top"});else if(C.key==="[")this.#H.orbitBy(-40,0);else if(C.key==="]")this.#H.orbitBy(40,0);else if(C.key==="PageUp")this.#H.orbitBy(0,-30);else if(C.key==="PageDown")this.#H.orbitBy(0,30);else if(V==="d"&&H.workflow==="draw")this.#B({type:"set-draw-tool",tool:"paint"});else if(V==="e"&&H.workflow==="draw")this.#B({type:"set-draw-tool",tool:"erase"});else if(["arrowleft","arrowright","arrowup","arrowdown"].includes(V))if(H.view==="three"&&!C.shiftKey){let e=V==="arrowleft"?-24:V==="arrowright"?24:0,r=V==="arrowup"?-20:V==="arrowdown"?20:0;this.#H.orbitBy(e,r)}else{let e=V==="arrowleft"?30:V==="arrowright"?-30:0,r=V==="arrowup"?30:V==="arrowdown"?-30:0;this.#H.panBy(e,r)}else if(H.workflow!=="draw"&&["w","a","s","d"].includes(V))this.#H.panBy(V==="a"?34:V==="d"?-34:0,V==="w"?34:V==="s"?-34:0);else if(H.workflow!=="draw"&&(V==="q"||V==="e"))this.#H.orbitBy(V==="q"?-30:30,0);else return;C.preventDefault()};#R=C=>{C.code==="Space"&&(this.#t=!1)};#P=()=>{this.#t=!1,this.#_(),this.#H.setCursor(null),this.#C.classList.remove("navigating")};#g=C=>{L1(C)||(this.#b(),this.#H.zoomAt(C.shiftKey?1/1.6:1.6,C.clientX,C.clientY),C.preventDefault())};#T=C=>{L1(C)||C.preventDefault()};#B(C){this.#C.dispatchEvent(new CustomEvent("matic-workspace-intent",{detail:C,bubbles:!0,composed:!0}))}#F(C,H,V){if(window.matchMedia("(prefers-reduced-motion: reduce)").matches)return;let e=p1(C,-.55,.55),r=p1(H,-.55,.55);if(Math.hypot(e,r)<.02)return;let t=performance.now(),M=o=>{let i=Math.min(32,o-t);t=o,V==="orbit"?this.#H.orbitBy(e*i,r*i):this.#H.panBy(e*i,r*i);let a=.9**(i/16);e*=a,r*=a,Math.hypot(e,r)>=.01?this.#p=window.requestAnimationFrame(M):this.#p=null};this.#p=window.requestAnimationFrame(M)}#b(){this.#p!==null&&window.cancelAnimationFrame(this.#p),this.#p=null}#_(){this.#S!==null&&window.clearTimeout(this.#S),this.#S=null}dispose(){this.#e||(this.#e=!0,this.#_(),this.#b(),this.#C.removeEventListener("pointerdown",this.#x),this.#C.removeEventListener("pointermove",this.#f),this.#C.removeEventListener("pointerup",this.#d),this.#C.removeEventListener("pointercancel",this.#d),this.#C.removeEventListener("wheel",this.#c),this.#C.removeEventListener("gesturestart",this.#Z),this.#C.removeEventListener("gesturechange",this.#w),this.#C.removeEventListener("gestureend",this.#O),this.#C.removeEventListener("dblclick",this.#g),this.#C.removeEventListener("contextmenu",this.#T),this.#C.removeEventListener("keydown",this.#k),this.#C.removeEventListener("keyup",this.#R),this.#C.removeEventListener("blur",this.#P),this.#r.clear())}};var E7=L=>L.matches(":disabled, [aria-disabled='true']"),m1=class{#C;#H;#V=null;#r=null;constructor(C,H){this.#C=C,this.#H=H,C.addController(this)}hostConnected(){this.#C.addEventListener("focusin",this.#o)}hostDisconnected(){this.#C.removeEventListener("focusin",this.#o),this.#V?.removeEventListener("keydown",this.#i),this.#V=null,this.#r=null}hostUpdated(){let C=this.#H.container();C!==this.#V&&(this.#V?.removeEventListener("keydown",this.#i),C?.addEventListener("keydown",this.#i),this.#V=C),this.#L()}#t(){let C=this.#V;return C?[...C.querySelectorAll(this.#H.items)].filter(H=>!E7(H)):[]}#L(){let C=this.#t(),H=(this.#r&&C.includes(this.#r)?this.#r:null)??C.find(e=>e.matches("[aria-pressed='true'], [aria-checked='true']"))??C[0]??null;this.#r=H;let V=this.#V?.querySelectorAll(this.#H.items)??[];for(let e of V)e.tabIndex=e===H?0:-1}#o=C=>{let H=C.composedPath()[0];!(H instanceof HTMLElement)||!this.#V?.contains(H)||H.matches(this.#H.items)&&(this.#r=H,this.#L())};#i=C=>{if(C.defaultPrevented||C.ctrlKey||C.metaKey||C.altKey)return;let H=this.#H.orientation??"horizontal",V=H!=="vertical",e=H!=="horizontal",r=this.#t();if(!r.length)return;let t=C.composedPath()[0],M=Math.max(0,r.findIndex(a=>a===this.#r||t instanceof Node&&a.contains(t))),o;switch(C.key){case"ArrowLeft":if(!V)return;o=M-1;break;case"ArrowRight":if(!V)return;o=M+1;break;case"ArrowUp":if(!e)return;o=M-1;break;case"ArrowDown":if(!e)return;o=M+1;break;case"Home":o=0;break;case"End":o=r.length-1;break;default:return}C.preventDefault();let i=r[(o+r.length)%r.length];i&&(this.#r=i,this.#L(),i.focus())}};var N1=(L,C,H)=>{let V=H.x-C.x,e=H.y-C.y,r=Math.max(0,Math.min(1,((L.x-C.x)*V+(L.y-C.y)*e)/(V*V+e*e||1)));return Math.hypot(L.x-C.x-r*V,L.y-C.y-r*e)},F7=(L,C)=>{let H=!1;for(let V=0,e=C.length-1;V<C.length;e=V++){let r=C[V],t=C[e];r.y>L.y!=t.y>L.y&&L.x<(t.x-r.x)*(L.y-r.y)/(t.y-r.y)+r.x&&(H=!H)}return H},s2=(L,C,H)=>(C.x-L.x)*(H.y-L.y)-(C.y-L.y)*(H.x-L.x),O1=({points:L,closed:C})=>{if(L.length>64||C&&L.length<3||L.some(V=>!Number.isFinite(V.x)||!Number.isFinite(V.y)||Math.abs(V.x)>1e4||Math.abs(V.y)>1e4))return!1;let H=C?L.length:L.length-1;for(let V=0;V<H;V++){let e=L[V],r=L[(V+1)%L.length];if(Math.hypot(e.x-r.x,e.y-r.y)<.01)return!1;for(let t=V+2;t<H;t++){if(C&&V===0&&t===H-1)continue;let M=L[t],o=L[(t+1)%L.length];if(Math.min(N1(e,M,o),N1(r,M,o),N1(M,e,r),N1(o,e,r))<1e-5||s2(e,r,M)*s2(e,r,o)<0&&s2(M,o,e)*s2(M,o,r)<0)return!1}}return!C||Math.abs(L.reduce((V,e,r)=>{let t=L[(r+1)%L.length];return V+e.x*t.y-t.x*e.y},0))>.01},a0=(L,C)=>{if(!L.closed||!O1(L))return[];let{points:H}=L,V=Math.min(...H.map(i=>i.x)),e=Math.max(...H.map(i=>i.x)),r=Math.min(...H.map(i=>i.y)),t=Math.max(...H.map(i=>i.y)),M=[];for(let i=0;i<32;i++)for(let a=0;a<32;a++){let n={x:Math.round((V+(a+.5)*(e-V)/32)*1e4)/1e4,y:Math.round((r+(i+.5)*(t-r)/32)*1e4)/1e4};if(!F7(n,H)||!C(n))continue;let A=Math.min(...H.map((d,m)=>N1(n,d,H[(m+1)%H.length]))),l=Math.floor(Math.min(2.5,A-1e-4)*1e4)/1e4;l>=.05&&M.push({...n,radius:l})}M.sort((i,a)=>a.radius-i.radius);let o=[];for(let i of M){if(o.length>=512)break;o.some(a=>Math.hypot(a.x-i.x,a.y-i.y)+i.radius*.5<=a.radius)||o.push(i)}return o};var d2=class{constructor(C,H,V,e,r,t){this.state=C;this.renderer=H;this.intent=V;this.update=e;this.t=r;this.focusPoint=t}#C=null;#H="";#V=null;#r(){let C=this.state();return!C.dialog&&C.workflow==="draw"&&C.draw.tool==="outline"&&_(C)&&(C.command==="idle"||C.command==="failed")}#t(C){if(!this.#r())return;if(!O1(C)){this.#H=this.t("v4_zone_invalid","Keep the outline from crossing itself."),this.update();return}let H=a0(C,V=>this.renderer()?.containsMapPoint(V)??!1);if(C.closed&&!H.length){this.#H=this.t("v4_zone_empty","Make the zone wider and keep it on mapped floor."),this.update();return}this.#H="",this.intent({type:"set-draft-circles",circles:H,outline:C})}addPoint(C){if(!this.#r()||!this.renderer()?.containsMapPoint(C))return;let H=this.state().draw.outline??{points:[],closed:!1};H.closed||H.points.length>=64||this.#t({points:[...H.points,C],closed:!1})}#L(){let C=this.state().draw.outline;C&&C.points.length>=3&&this.#t({...C,closed:!0})}#o(C){let H=this.state().draw.outline;if(!H)return;this.#V=null;let V=H.points.filter((e,r)=>r!==C);this.#t({points:V,closed:H.closed&&V.length>=3}),this.focusPoint(Math.min(C,V.length-1))}#i(C){let H=this.state().draw.outline;if(!H||H.points.length>=64)return;let V=H.points[C],e=H.points[(C+1)%H.points.length];if(!V||!e||!H.closed&&C===H.points.length-1)return;let r={x:(V.x+e.x)/2,y:(V.y+e.y)/2};this.#t({...H,points:[...H.points.slice(0,C+1),r,...H.points.slice(C+1)]}),this.focusPoint(C+1)}#a(C,H){if(!this.#r()||C.button!==0||this.#C||C.pointerType==="touch"&&!C.isPrimary)return;this.#V=H,this.update();let V=this.state().draw.outline;if(!V)return;C.stopPropagation(),C.preventDefault();let e=C.currentTarget;e.focus({preventScroll:!0}),e.setPointerCapture(C.pointerId),this.#C={index:H,pointer:C.pointerId,baseline:V,preview:V,target:e}}#A(C){let H=this.#C;if(!H||H.pointer!==C.pointerId)return;if(C.stopPropagation(),C.preventDefault(),!this.#r()||this.state().draw.outline!==H.baseline){this.cancel();return}let V=this.renderer()?.screenToMap(C.clientX,C.clientY);!V||!this.renderer()?.containsMapPoint(V)||(H.preview={...H.baseline,points:H.baseline.points.map((e,r)=>r===H.index?V:e)},this.update())}#u(C){let H=this.#C;!H||H.pointer!==C.pointerId||(C.stopPropagation(),C.preventDefault(),this.#C=null,H.target.releasePointerCapture(C.pointerId),this.state().draw.outline===H.baseline&&this.#r()&&(H.preview!==H.baseline?this.#t(H.preview):H.index===0&&!H.baseline.closed&&this.#L()),this.update())}cancel(){let C=this.#C;C&&(this.#C=null,C.target.hasPointerCapture(C.pointer)&&C.target.releasePointerCapture(C.pointer),this.update())}#M(C,H){if(C.ctrlKey||C.altKey||C.metaKey)return;if(C.key==="Escape"){C.stopPropagation(),this.cancel();return}let V=this.state().draw.outline;if(!V||!this.#r())return;if(C.key==="Delete"||C.key==="Backspace"){C.preventDefault(),C.stopPropagation(),this.#o(H);return}let e=C.shiftKey?.1:.02,r=C.key==="ArrowLeft"?e:C.key==="ArrowRight"?-e:0,t=C.key==="ArrowUp"?-e:C.key==="ArrowDown"?e:0;if(!r&&!t)return;C.preventDefault(),C.stopPropagation();let M=V.points[H],o={x:M.x+r,y:M.y+t};this.renderer()?.containsMapPoint(o)&&this.#t({...V,points:V.points.map((i,a)=>a===H?o:i)})}render(){if(!this.#r())return s;let C=this.#C?.preview??this.state().draw.outline,H=C?.points??[],V=H.map(t=>this.renderer()?.mapToScreen(t)),e=V.map((t,M)=>t?`${M?"L":"M"}${t.x},${t.y}`:"").join(" "),r=!C||O1(C);return p`
      <div class="zone-overlay">
        ...
        ${V.map((t,M)=>t?p`
          ...
          >${M+1}</button>
        `:s)}
        ${H.map((t,M)=>{let o=H[(M+1)%H.length];if(!o||!C?.closed&&M===H.length-1||H.length>=64)return s;let i={x:(t.x+o.x)/2,y:(t.y+o.y)/2},a=this.renderer()?.mapToScreen(i),n=V[M],A=V[(M+1)%V.length];return a&&n&&A&&Math.hypot(n.x-A.x,n.y-A.y)>=100?p`<button class="zone-point zone-midpoint" type="button" data-map-control
    ...
    `}};var n0={accent:["--ms-accent","Highlight",[6,120,206]],onAccent:["--ms-on-accent","HighlightText",[255,255,255]],text:["--ms-text","CanvasText",[38,50,56]],quiet:["--ms-text-quiet","GrayText",[75,92,105]],plate:["--ms-surface-card","Canvas",[250,252,253]],roomFill:["--ms-surface-sunken","Canvas",[231,238,242]]},D7=L=>Math.max(0,Math.min(255,Math.round(L))),l0=L=>{let C=L.trim(),H=C.match(/^#([\da-f]{3}|[\da-f]{4}|[\da-f]{6}|[\da-f]{8})$/i)?.[1];if(H){let a=H.length<=4?[H[0],H[1],H[2]].map(d=>Number.parseInt(`${d}${d}`,16)):[H.slice(0,2),H.slice(2,4),H.slice(4,6)].map(d=>Number.parseInt(d,16)),[n,A,l]=a;return n===void 0||A===void 0||l===void 0?null:[n,A,l]}let V=C.startsWith("color(srgb"),e=C.slice(C.indexOf("(")+1).match(/-?\d*\.?\d+/g);if(!e||e.length<3)return null;let r=V?255:1,t=e.slice(0,3).map(a=>D7(Number(a)*r)),[M,o,i]=t;return M===void 0||o===void 0||i===void 0||[M,o,i].some(a=>Number.isNaN(a))?null:[M,o,i]},T=(L,C)=>`rgba(${L[0]},${L[1]},${L[2]},${C})`,A0=L=>{let C=window.matchMedia?.("(forced-colors: active)").matches??!1;if(!C){let e=document.createElement("span"),r=document.createElement("canvas");r.width=1,r.height=1;let t=r.getContext("2d",{colorSpace:"srgb",willReadFrequently:!0});e.setAttribute("aria-hidden","true"),e.style.cssText="position:absolute;inline-size:0;block-size:0;overflow:hidden;visibility:hidden;pointer-events:none",L.append(e);let M=o=>{let[i,,a]=n0[o];e.style.color=`var(${i}, transparent)`;let n=getComputedStyle(e).color;if(t){t.clearRect(0,0,1,1),t.fillStyle="transparent",t.fillStyle=n,t.fillRect(0,0,1,1);let[A,l,d,m]=t.getImageData(0,0,1,1).data;if(A!==void 0&&l!==void 0&&d!==void 0&&m!==void 0&&m!==0)return[A,l,d]}return l0(n)??a};try{return{accent:M("accent"),onAccent:M("onAccent"),text:M("text"),quiet:M("quiet"),plate:M("plate"),roomFill:M("roomFill"),forced:C}}finally{e.remove()}}let H=document.createElement("span");H.setAttribute("aria-hidden","true"),H.style.cssText="position:absolute;inline-size:0;block-size:0;overflow:hidden;visibility:hidden;pointer-events:none",L.append(H);let V=e=>{let[,r,t]=n0[e];return H.style.color=r,l0(getComputedStyle(H).color)??t};try{return{accent:V("accent"),onAccent:V("onAccent"),text:V("text"),quiet:V("quiet"),plate:V("plate"),roomFill:V("roomFill"),forced:C}}finally{H.remove()}};var B=(L,C,H)=>Math.max(C,Math.min(H,L)),U1=L=>{let C=L;for(;C>Math.PI;)C-=Math.PI*2;for(;C<-Math.PI;)C+=Math.PI*2;return C},$7=L=>{switch(L){case"efficient":return .35;case"balanced":return .65;case"maximum":case"auto":return 1}},I7={accent:[6,120,206],onAccent:[255,255,255],text:[38,50,56],quiet:[75,92,105],plate:[250,252,253],roomFill:[231,238,242],forced:!1},d0=Math.PI/3.15,W7=1.08,z7=(L,C)=>{let H=d0/2,V=Math.atan(Math.tan(H)*Math.max(.2,C));return L/Math.sin(Math.min(H,V))*W7},N7=(L,C)=>{let H=new Float32Array(16);for(let V=0;V<4;V+=1)for(let e=0;e<4;e+=1){let r=0;for(let t=0;t<4;t+=1)r+=(L[t*4+e]??0)*(C[V*4+t]??0);H[V*4+e]=r}return H},U7=(L,C,H,V)=>{let e=1/Math.tan(L/2),r=new Float32Array(16);return r[0]=e/C,r[5]=e,r[10]=(V+H)/(H-V),r[11]=-1,r[14]=2*V*H/(H-V),r},G7=(L,C,H,V,e,r)=>{let t=new Float32Array(16);return t[0]=2/(C-L),t[5]=2/(V-H),t[10]=-2/(r-e),t[12]=-(C+L)/(C-L),t[13]=-(V+H)/(V-H),t[14]=-(r+e)/(r-e),t[15]=1,t},K7=(L,C)=>{let H=Math.hypot((L[0]??0)-(C[0]??0),(L[1]??0)-(C[1]??0),(L[2]??0)-(C[2]??0))||1,V=[((L[0]??0)-(C[0]??0))/H,((L[1]??0)-(C[1]??0))/H,((L[2]??0)-(C[2]??0))/H],e=Math.hypot(V[2]??0,V[0]??0)||1,r=[(V[2]??0)/e,0,-(V[0]??0)/e],t=[(V[1]??0)*(r[2]??0),(V[2]??0)*(r[0]??0)-(V[0]??0)*(r[2]??0),-(V[1]??0)*(r[0]??0)];return new Float32Array([r[0]??0,t[0]??0,V[0]??0,0,r[1]??0,t[1]??0,V[1]??0,0,r[2]??0,t[2]??0,V[2]??0,0,-((r[0]??0)*(L[0]??0)+(r[1]??0)*(L[1]??0)+(r[2]??0)*(L[2]??0)),-((t[0]??0)*(L[0]??0)+(t[1]??0)*(L[1]??0)+(t[2]??0)*(L[2]??0)),-((V[0]??0)*(L[0]??0)+(V[1]??0)*(L[1]??0)+(V[2]??0)*(L[2]??0)),1])},s0=(L,C,H)=>{let V=!1,e=H.at(-1);if(!e)return!1;for(let r of H){let[t,M]=r,[o,i]=e;M>C!=i>C&&L<(o-t)*(C-M)/(i-M)+t&&(V=!V),e=r}return V},p2=class{#C;#H;#V;#r=null;#t=null;#L=null;#o=null;#i=null;#a=null;#A=null;#u=null;#M=null;#y=null;#h=null;#n=null;#v=null;#l=null;#p=null;#s=null;#S;#e={yaw:-Math.PI/4,pitch:.82,distance:12,targetX:0,targetZ:0,orthographic:!1};#x=12;#f=8;#d=4;#m=new Float32Array(16);#c=null;#Z="unavailable";#w=0;#O=0;#E=0;#k=0;#R=1;#P={width:1,height:1,left:0,top:0};#g=!0;#T=!1;#B=I7;constructor(C,H,V={}){this.#C=C,this.#H=H,this.#V=V,this.#t=H.getContext("2d",{alpha:!0}),this.#C.addEventListener("webglcontextlost",this.#t1),this.#C.addEventListener("webglcontextrestored",this.#M1),this.#z(),this.#S=new ResizeObserver(()=>{let e=this.#x,r=this.#f;this.#N(),this.#g&&(e!==this.#x||r!==this.#f)?this.fit(!1):this.requestRender()}),this.#S.observe(C)}get camera(){return{...this.#e}}#F(){return{minimum:Math.max(.2,this.#d*.04),maximum:this.#d*8}}#b(){let C=this.#l?.metadata.span,H=this.#l?.metadata.metersPerCell;return!C||H===void 0?{x:this.#d,z:this.#d}:{x:Math.max(.5,C[0]*H*.55),z:Math.max(.5,C[1]*H*.55)}}setCamera(C,H=!0){let V=this.#F(),e=this.#b();this.#e={yaw:U1(C.yaw),pitch:C.orthographic?Math.PI/2-.018:B(C.pitch,.18,1.38),distance:B(C.distance,V.minimum,V.maximum),targetX:B(C.targetX,-e.x,e.x),targetZ:B(C.targetZ,-e.z,e.z),orthographic:C.orthographic},this.#g=!1,this.requestRender(),H&&this.#Q()}cameraAfterPan(C,H,V){let e=this.#D(),r=C.distance*1.75/Math.max(200,e.height),t=Math.cos(C.yaw),M=-Math.sin(C.yaw),o=-Math.sin(C.yaw),i=-Math.cos(C.yaw),a=this.#b();return{...C,targetX:B(C.targetX-H*r*t+V*r*o,-a.x,a.x),targetZ:B(C.targetZ-H*r*M+V*r*i,-a.z,a.z)}}setState(C){if(this.#T)return;let H=this.#v;this.#v=C;let V=C.resources.scene.value;V!==this.#l&&(this.#l=V,this.#H1(V)),(!H||H.quality!==C.quality)&&(this.#R=$7(C.quality),this.#k=0);let e=H?.workflow!=="draw"&&C.workflow==="draw",r=H?.workflow==="draw"&&C.workflow!=="draw";if(!H||H.view!==C.view||e||r){let t=C.workflow==="draw"?"top":C.view;this.#e=this.#_(t,C),this.#g=this.#C1(t,C)}C.workflow==="draw"&&H?.draw.zoomPercent!==C.draw.zoomPercent&&(this.#e={...this.#e,orthographic:!0,pitch:Math.PI/2-.018,distance:this.#f*100/C.draw.zoomPercent},this.#g=C.draw.zoomPercent===100&&Math.abs(this.#e.targetX)<.001&&Math.abs(this.#e.targetZ)<.001&&Math.abs(U1(this.#e.yaw))<.001),this.requestRender()}#_(C,H){let V=C==="top",e=V?this.#f:this.#x,r=H.cameras[C];return r?{yaw:r.yaw,pitch:V?Math.PI/2-.018:r.pitch,distance:B(e/B(r.zoom,.01,100),Math.max(.2,this.#d*.04),this.#d*8),targetX:B(r.targetX,-this.#d,this.#d),targetZ:B(r.targetZ,-this.#d,this.#d),orthographic:V}:V?{yaw:0,pitch:Math.PI/2-.018,distance:e,targetX:0,targetZ:0,orthographic:!0}:{yaw:-Math.PI/4,pitch:.82,distance:e,targetX:0,targetZ:0,orthographic:!1}}#C1(C,H){let V=H.cameras[C];if(!V)return!0;let e=C==="top";return Math.abs(V.zoom-1)<.001&&Math.abs(V.targetX)<.001&&Math.abs(V.targetZ)<.001&&Math.abs(U1(V.yaw-(e?0:-Math.PI/4)))<.001&&(e||Math.abs(V.pitch-.82)<.001)}#q(C,H){let V=this.#r;if(!V)throw new Error("webgl-unavailable");let e=V.createShader(C);if(!e)throw new Error("shader-unavailable");if(V.shaderSource(e,H),V.compileShader(e),!V.getShaderParameter(e,V.COMPILE_STATUS))throw V.deleteShader(e),new Error("shader-failed");return e}#z(){try{this.#r=this.#C.getContext("webgl2",{alpha:!0,antialias:!0,depth:!0,powerPreference:"high-performance"});let C=this.#r;if(!C)throw new Error("webgl2-unavailable");let H=this.#q(C.VERTEX_SHADER,`#version 300 es
      ...
      `),e=C.createProgram();if(!e)throw new Error("program-unavailable");if(C.attachShader(e,H),C.attachShader(e,V),C.linkProgram(e),C.deleteShader(H),C.deleteShader(V),!C.getProgramParameter(e,C.LINK_STATUS))throw new Error("program-failed");this.#i=e,this.#u=C.getUniformLocation(e,"uViewProjection"),this.#M=C.getUniformLocation(e,"uCenter"),this.#y=C.getUniformLocation(e,"uMetersPerCell"),this.#h=C.getUniformLocation(e,"uPointPixels"),this.#n=C.getUniformLocation(e,"uMaxPointPixels"),this.#a=C.createBuffer(),this.#A=C.createVertexArray(),C.bindVertexArray(this.#A),C.bindBuffer(C.ARRAY_BUFFER,this.#a),C.enableVertexAttribArray(0),C.vertexAttribIPointer(0,2,C.UNSIGNED_SHORT,8,0),C.enableVertexAttribArray(1),C.vertexAttribIPointer(1,1,C.UNSIGNED_BYTE,8,4),C.enableVertexAttribArray(2),C.vertexAttribPointer(2,3,C.UNSIGNED_BYTE,!0,8,5),C.bindVertexArray(null),C.enable(C.DEPTH_TEST),C.depthFunc(C.LEQUAL),C.enable(C.BLEND),C.blendFunc(C.SRC_ALPHA,C.ONE_MINUS_SRC_ALPHA),this.#Z="webgl2",this.#w+=1,this.#l&&this.#X(this.#l)}catch{this.#J(),this.#Y()}}#H1(C){if(this.#U(),!C){this.#O=0,this.requestRender();return}let[H,V]=C.metadata.span,e=C.metadata.metersPerCell,r=H*e,t=V*e;this.#d=Math.max(1,Math.hypot(r,t)/2),this.#N(),this.fit(!1),this.#Z==="webgl2"?this.#X(C):this.#$(C)}#N(){let C=this.#l;if(!C)return;let[H,V]=C.metadata.span,e=C.metadata.metersPerCell,r=H*e,t=V*e,M=this.#D(),o=Math.max(.2,M.width/Math.max(1,M.height));this.#x=z7(this.#d,o),this.#f=Math.max(t/2,r/(2*o))*1.12}#X(C){let H=this.#r;if(!H||!this.#a)return;let V=new Uint8Array(C.buffer,C.pointOffset,C.total*8);H.bindBuffer(H.ARRAY_BUFFER,this.#a),H.bufferData(H.ARRAY_BUFFER,V,H.STATIC_DRAW),this.#O=C.total}#Y(){this.#Z="canvas2d",this.#o=document.createElement("canvas"),this.#o.width=1024,this.#o.height=1024,this.#L=this.#o.getContext("2d",{alpha:!0}),this.#L?this.#l&&this.#$(this.#l):(this.#Z="unavailable",this.#V.onProblem?.("renderer-unavailable"))}#$(C){let H=this.#L;if(!H||!this.#o)return;H.clearRect(0,0,this.#o.width,this.#o.height);let V=new DataView(C.buffer,C.pointOffset,C.total*8),e=Math.min(C.total,5e4),r=Math.max(1,Math.ceil(C.total/e)),t=0,M=0,o=()=>{if(this.#T||C!==this.#l||!this.#o)return;let i=Math.min(C.total,t+r*4e3);for(;t<i;t+=r){let a=t*8,n=V.getUint16(a,!0)/Math.max(1,C.metadata.span[0])*this.#o.width,A=V.getUint16(a+2,!0)/Math.max(1,C.metadata.span[1])*this.#o.height,l=V.getUint8(a+5),d=V.getUint8(a+6),m=V.getUint8(a+7);H.fillStyle=`rgb(${l} ${d} ${m})`,H.fillRect(n,A,1.5,1.5),M+=1}this.#O=M,this.requestRender(),t<C.total?this.#s=window.setTimeout(o,0):this.#s=null};o()}#U(){this.#s!==null&&window.clearTimeout(this.#s),this.#s=null}#D(){let C=this.#C.getBoundingClientRect();return this.#P={width:C.width,height:C.height,left:C.left,top:C.top},this.#P}#I(){let C=!1,H=this.#D(),V=Math.min(window.devicePixelRatio||1,3),e=Math.max(1,Math.round(H.width*V)),r=Math.max(1,Math.round(H.height*V));for(let t of[this.#C,this.#H])(t.width!==e||t.height!==r)&&(t.width=e,t.height=r,C=!0);C&&this.#V.onViewport?.()}#G(){let C=this.#P,H=Math.max(.2,C.width/Math.max(1,C.height)),V=Math.cos(this.#e.pitch)*this.#e.distance,e=[this.#e.targetX+Math.sin(this.#e.yaw)*V,Math.sin(this.#e.pitch)*this.#e.distance,this.#e.targetZ+Math.cos(this.#e.yaw)*V],r=[this.#e.targetX,0,this.#e.targetZ],t=K7(e,r),M=this.#e.orthographic?G7(-this.#e.distance*H,this.#e.distance*H,-this.#e.distance,this.#e.distance,-this.#d*4,this.#d*4):U7(d0,H,.02,Math.max(60,this.#d*12));return N7(M,t)}requestRender(){this.#p!==null||this.#T||(this.#p=window.requestAnimationFrame(()=>{this.#p=null,this.#V1()}))}#V1(){let C=performance.now();this.#I(),this.#m=this.#G(),this.#Z==="webgl2"?this.#L1():this.#e1(),this.#o1(),this.#E=performance.now()-C,this.#E>18?(this.#k+=1,this.#k>=3&&this.#v?.quality==="auto"&&(this.#R=Math.max(.25,this.#R*.75))):this.#k=Math.max(0,this.#k-1)}#L1(){let C=this.#r,H=this.#l;if(!C||(C.viewport(0,0,this.#C.width,this.#C.height),C.clearColor(0,0,0,0),C.clear(C.COLOR_BUFFER_BIT|C.DEPTH_BUFFER_BIT),!H||!this.#i||!this.#A))return;if(this.#v?.view==="top"&&this.#v.appearance==="rooms"){this.#O=0;return}C.useProgram(this.#i),C.bindVertexArray(this.#A),C.uniformMatrix4fv(this.#u,!1,this.#m),C.uniform2f(this.#M,(H.metadata.span[0]-1)/2,(H.metadata.span[1]-1)/2),C.uniform1f(this.#y,H.metadata.metersPerCell);let V=Math.min(window.devicePixelRatio||1,3),e=Math.max(1,Math.floor(H.total*this.#R)),r=Math.min(H.floorCount,e),t=Math.min(H.surfaceCount,Math.max(0,e-r));C.uniform1f(this.#h,this.#C.height*.038),C.uniform1f(this.#n,4.5*V),C.drawArrays(C.POINTS,0,r),C.uniform1f(this.#h,this.#C.height*.05),C.uniform1f(this.#n,7*V),C.drawArrays(C.POINTS,H.floorCount,t),C.bindVertexArray(null),this.#O=r+t}#e1(){}#j(C,H,V=0){let e=this.#l;return e?[-(C-(e.metadata.span[0]-1)/2)*e.metadata.metersPerCell,V*e.metadata.metersPerCell,(H-(e.metadata.span[1]-1)/2)*e.metadata.metersPerCell]:null}#K(C,H,V=0,e=!0){let r=this.#j(C,H,V);if(!r)return null;let[t,M,o]=r,i=this.#m,a=(i[0]??0)*t+(i[4]??0)*M+(i[8]??0)*o+(i[12]??0),n=(i[1]??0)*t+(i[5]??0)*M+(i[9]??0)*o+(i[13]??0),A=(i[3]??0)*t+(i[7]??0)*M+(i[11]??0)*o+(i[15]??0);if(A<=.001)return null;let l=a/A,d=n/A;if(!Number.isFinite(l)||!Number.isFinite(d)||e&&(Math.abs(l)>1.15||Math.abs(d)>1.15))return null;let m=this.#P;return{x:(l*.5+.5)*m.width,y:(-d*.5+.5)*m.height}}#W(C,H,V=0,e=!0){let r=this.#l;if(!r)return null;let t=C/r.metadata.metersPerCell-r.metadata.origin[0],M=H/r.metadata.metersPerCell-r.metadata.origin[1];return this.#K(t,M,V,e)}#o1(){let C=this.#t,H=this.#l,V=this.#v;if(!C)return;let e=Math.min(window.devicePixelRatio||1,3),r=this.#P;if(C.setTransform(e,0,0,e,0,0),C.clearRect(0,0,r.width,r.height),!H||!V)return;let t=this.#B;if(this.#Z==="canvas2d"&&this.#o&&!(V.view==="top"&&V.appearance==="rooms")){let n=this.#f/this.#e.distance,A=r.width*n,l=r.height*n,d=(r.width-A)/2-this.#e.targetX*32*n,m=(r.height-l)/2-this.#e.targetZ*32*n;C.drawImage(this.#o,d,m,A,l)}let M=this.#i1(V);if(V.labelsVisible||V.view==="top"&&V.appearance==="rooms"){C.lineWidth=1.5,C.font="600 12px system-ui, sans-serif",C.textAlign="center",C.textBaseline="middle";let n=[];for(let A of H.metadata.rooms){let l=M.has(A.name.toLocaleLowerCase());C.strokeStyle=l?T(t.accent,1):T(t.quiet,.7),C.fillStyle=l?T(t.accent,.26):V.view==="top"&&V.appearance==="rooms"?T(t.roomFill,.94):T(t.plate,.04),C.beginPath();let d=Math.max(1,Math.ceil(A.boundary.length/512)),m=!1;for(let S=0;S<A.boundary.length;S+=d){let O=A.boundary[S];if(!O)continue;let g=this.#K(O[0],O[1],.2,!1);g&&(m?C.lineTo(g.x,g.y):C.moveTo(g.x,g.y),m=!0)}if(m&&(C.closePath(),C.fill(),C.stroke()),!V.labelsVisible)continue;let x=this.#K(A.center[0],A.center[1],1);if(!x)continue;let h=C.measureText(A.name).width,f=new DOMRect(x.x-h/2-6,x.y-10,h+12,20);n.some(S=>f.left<S.right+8&&f.right+8>S.left&&f.top<S.bottom+4&&f.bottom+4>S.top)||(n.push(f),C.fillStyle=T(t.plate,.88),C.fillRect(f.x,f.y,f.width,f.height),C.fillStyle=T(t.text,1),C.fillText(A.name,x.x,x.y))}}let o=V.draw.circles;if((V.workflow==="draw"||V.workflow==="areaReview")&&o.length)if(C.fillStyle=T(t.accent,.22),C.strokeStyle=T(t.accent,.92),C.lineWidth=1.5,V.draw.outline?.closed){C.beginPath();for(let n of o)this.#r1(C,n,!1);C.fill()}else for(let n of o)this.#r1(C,n);let i=V.draw.outline;if(i&&(V.workflow==="draw"||V.workflow==="areaReview")&&!(V.workflow==="draw"&&V.draw.tool==="outline")&&(C.beginPath(),i.points.forEach((n,A)=>{let l=this.#W(n.x,n.y,0,!1);l&&(A===0?C.moveTo(l.x,l.y):C.lineTo(l.x,l.y))}),i.closed&&C.closePath(),C.strokeStyle=T(t.accent,1),C.lineWidth=2,C.stroke()),this.#c&&V.workflow==="draw"&&(V.draw.tool==="paint"||V.draw.tool==="erase")){let n=this.#W(this.#c.x,this.#c.y),A=this.#W(this.#c.x+V.draw.brushMeters/2,this.#c.y);n&&A&&(C.beginPath(),C.arc(n.x,n.y,Math.max(2,Math.hypot(A.x-n.x,A.y-n.y)),0,Math.PI*2),C.strokeStyle=T(t.accent,1),C.lineWidth=2,C.stroke())}let a=V.resources.pose.value;if(V.map.exactPose&&a?.position&&V.dataMode==="live"){let n=this.#W(a.position[0],a.position[1],3);n&&(C.beginPath(),C.arc(n.x,n.y,7,0,Math.PI*2),C.fillStyle=T(t.accent,1),C.fill(),C.strokeStyle=T(t.onAccent,1),C.lineWidth=3,C.stroke())}}#i1(C){let H=C.resources.plans.value?.rooms||C.resources.areas.value?.rooms||[];return new Set(H.filter(V=>C.selection.roomIds.includes(V.roomId)).map(V=>V.name.toLocaleLowerCase()))}#r1(C,H,V=!0){let e=this.#W(H.x,H.y),r=this.#W(H.x+H.radius,H.y);if(!e||!r)return;let t=Math.max(1,Math.hypot(r.x-e.x,r.y-e.y));V&&C.beginPath(),C.moveTo(e.x+t,e.y),C.arc(e.x,e.y,t,0,Math.PI*2),V&&(C.fill(),C.stroke())}setPalette(C){this.#B=C,this.requestRender()}setCursor(C){this.#c=C,this.requestRender()}mapToScreen(C){let H=this.#l;if(!H||!this.#e.orthographic)return null;let V=this.#D();if(!V.width||!V.height)return null;let e=this.#e.distance*2/V.height,r=C.x/H.metadata.metersPerCell-H.metadata.origin[0],t=C.y/H.metadata.metersPerCell-H.metadata.origin[1],M=-(r-(H.metadata.span[0]-1)/2)*H.metadata.metersPerCell,o=(t-(H.metadata.span[1]-1)/2)*H.metadata.metersPerCell;return{x:V.width/2+(M-this.#e.targetX)/e,y:V.height/2+(o-this.#e.targetZ)/e}}screenToMap(C,H){let V=this.#l;if(!V||!this.#e.orthographic)return null;let e=this.#D();if(!e.width||!e.height)return null;let r=this.#e.distance*2/e.height,t=this.#e.targetX+(C-e.left-e.width/2)*r,M=this.#e.targetZ+(H-e.top-e.height/2)*r,o=-t/V.metadata.metersPerCell+(V.metadata.span[0]-1)/2,i=M/V.metadata.metersPerCell+(V.metadata.span[1]-1)/2;return{x:(o+V.metadata.origin[0])*V.metadata.metersPerCell,y:(i+V.metadata.origin[1])*V.metadata.metersPerCell}}roomAt(C,H){let V=this.screenToMap(C,H),e=this.#l,r=this.#v;if(!V||!e||!r)return null;let t=V.x/e.metadata.metersPerCell-e.metadata.origin[0],M=V.y/e.metadata.metersPerCell-e.metadata.origin[1],o=e.metadata.rooms.find(i=>s0(t,M,i.boundary));return o?this.#a1(o,r):null}containsMapPoint(C){let H=this.#l;if(!H)return!1;let V=C.x/H.metadata.metersPerCell-H.metadata.origin[0],e=C.y/H.metadata.metersPerCell-H.metadata.origin[1];return H.metadata.rooms.some(r=>s0(V,e,r.boundary))}#a1(C,H){return(H.resources.plans.value?.rooms||H.resources.areas.value?.rooms||[]).find(e=>e.name.localeCompare(C.name,void 0,{sensitivity:"base"})===0)?.roomId||C.id}selectRoomAt(C,H){let V=this.roomAt(C,H);V&&this.#V.onRoom?.(V)}fit(C=!0){let H=this.#v?.view==="top"||this.#v?.workflow==="draw";this.#e=H?{yaw:0,pitch:Math.PI/2-.018,distance:this.#f,targetX:0,targetZ:0,orthographic:!0}:{yaw:-Math.PI/4,pitch:.82,distance:this.#x,targetX:0,targetZ:0,orthographic:!1},this.#g=!0,this.requestRender(),C&&this.#Q()}zoomAt(C,H,V){let e=H===void 0||V===void 0?null:this.screenToMap(H,V),r=this.#F();if(this.#e={...this.#e,distance:B(this.#e.distance/C,r.minimum,r.maximum)},this.#g=!1,e&&H!==void 0&&V!==void 0){let t=this.screenToMap(H,V);t&&(this.#e={...this.#e,targetX:this.#e.targetX-(e.x-t.x),targetZ:this.#e.targetZ+(e.y-t.y)})}this.requestRender(),this.#Q(H,V)}panBy(C,H){this.setCamera(this.cameraAfterPan(this.#e,C,H))}orbitBy(C,H){if(this.#e.orthographic){this.panBy(C,H);return}this.#e={...this.#e,yaw:U1(this.#e.yaw+C*.006),pitch:B(this.#e.pitch-H*.004,.18,1.38)},this.#g=!1,this.requestRender(),this.#Q()}rotateBy(C){this.#e={...this.#e,yaw:U1(this.#e.yaw+C)},this.#g=!1,this.requestRender(),this.#Q()}#Q(C,H){let V=this.#e.orthographic?this.#f:this.#x,e=C===void 0||H===void 0?this.#P:this.#D(),r=C===void 0||H===void 0||!e.width||!e.height?void 0:{xPercent:B((C-e.left)/e.width*100,0,100),yPercent:B((H-e.top)/e.height*100,0,100)};this.#V.onCamera?.(this.camera,Math.round(V/this.#e.distance*100),r)}diagnostics(){return{mode:this.#Z,contextGeneration:this.#w,sceneRevision:this.#l?.revision??null,sourcePoints:this.#l?.total??0,renderedPoints:this.#O,lastFrameMs:Math.round(this.#E*100)/100,slowFrames:this.#k,cameraDistance:this.#e.distance,fitDistance:this.#e.orthographic?this.#f:this.#x,fitActive:this.#g}}#t1=C=>{C.preventDefault(),this.#J(),this.#Y(),this.requestRender()};#M1=()=>{this.#J(),this.#z(),this.requestRender()};#J(){let C=this.#r;C&&(this.#a&&C.deleteBuffer(this.#a),this.#A&&C.deleteVertexArray(this.#A),this.#i&&C.deleteProgram(this.#i)),this.#a=null,this.#A=null,this.#i=null,this.#r=null}dispose(){this.#T||(this.#T=!0,this.#S.disconnect(),this.#C.removeEventListener("webglcontextlost",this.#t1),this.#C.removeEventListener("webglcontextrestored",this.#M1),this.#p!==null&&window.cancelAnimationFrame(this.#p),this.#p=null,this.#U(),this.#J(),this.#o=null,this.#L=null,this.#t=null,this.#l=null,this.#v=null)}};var p0="component.matic_robot.common.",R=(L,C,H,V)=>{let e=V?{...V}:void 0,r=L?.(`${p0}${C}`,e);return r&&r!==`${p0}${C}`?r:V?Object.entries(V).reduce((t,[M,o])=>t.replaceAll(`{${M}}`,String(o)),H):H};var e1="matic-workspace-intent",m2="matic-workspace-action",m0="navigation-help",c0=(L,C)=>{let H=(e,r,t)=>R(C,e,r,t);if(L.dataMode==="history")return L.map.available?H("v4_saved_map_description","Saved read-only map for {floor}. Live robot position is hidden.",{floor:L.floor.displayName}):L.resources.scene.status==="loading"?H("v4_saved_map_loading_description","The saved map is loading."):H("v4_saved_map_unavailable_description","This saved map is unavailable.");if(!S1(L))return H("v4_private_map_unavailable","The current private map is not available.");let V=O5(L)?H("v4_robot_position_verified","The robot position is verified."):H("v4_robot_position_hidden","The robot position is not shown.");return H("v4_live_map_description","Live map for {floor}. {pose}",{floor:L.floor.displayName,pose:V})},i5=class extends k{constructor(){super();this.state=y();this.narrow=!1;this.#C=null;this.#H=null;this.#V=null;this.#r=!1;this.#t=!1;this.#L=null;this.#o=[];this.#i=null;this.#a=null;this.#A={capture:!0,handleEvent:H=>{H.pointerType==="touch"&&!H.isPrimary&&this.#u.cancel()}};this.#u=new d2(()=>this.state,()=>this.#H,H=>this.#s(H),()=>this.requestUpdate(),(H,V)=>this.#M(H,V),H=>{this.updateComplete.then(()=>{(this.renderRoot.querySelector(`[data-zone-index="${H}"]`)??this.renderRoot.querySelector(".map-root"))?.focus({preventScroll:!0})})});this.#v=()=>{this.#h()};new m1(this,{container:()=>this.renderRoot?.querySelector(".camera-steps")??null,items:"button"}),new m1(this,{container:()=>this.renderRoot?.querySelector(".draw-tools")??null,items:"button"})}static{this.properties={state:{attribute:!1},localize:{attribute:!1},narrow:{type:Boolean,reflect:!0}}}static{this.styles=[$,I,V1,w`
    :host {
      display: block;
      min-width: 0;
      min-height: 0;
      ...
      <div class="split room-settings">
        <label class="field ms-field">${this.#H("v4_cleaning_system","Cleaning system")}
          <select
            ...
            @change=${r=>this.#t({type:"patch-room-settings",roomId:H,cleaningMode:W(r)})}
      ...
      <div class="stack">
        <div class="split">
          <label class="field ms-field">${this.#H("v4_saved_plan","Saved plan")}
            <select
              ...
              @change=${i=>this.#t({type:"select-plan",planId:W(i)||null})}
            >
          ...
          <button class="ms-btn ms-btn--secondary" type="button" @click=${()=>this.#t({type:"select-plan",planId:null})}>${Z(H0)}<span class="ms-btn__label">${this.#H("plan_new","New plan")}</span></button>
        </div>
        <label class="field ms-field">${this.#H("plan_name","Plan name")}
          <input
            ...
            autocomplete="off"
            .value=${e.name}
            @input=${i=>this.#t({type:"patch-plan-draft",patch:{name:W(i)}})}
          >
        </label>
        <div class="split plan-meta">
          <label class="field ms-field">${this.#H("plan_run_behavior","Cleaning order")}
            <select
              .value=${e.runBehavior}
              @change=${i=>this.#t({type:"patch-plan-draft",patch:{runBehavior:W(i)==="ordered"?"ordered":"intelligent"}})}
            >
        ...
        <div class="list" role="group" aria-labelledby="plan-rooms-heading">
          ${g0(M,({room:i})=>i.roomId,({room:i,label:a,selected:n})=>{let A=n?e.rooms.findIndex(l=>l.roomId===i.roomId):-1;return p`
              <div class="room plan-room ms-row ms-row--stack" data-selected=${String(n)}>
                ...
                ${n?p`
                  <div class="split room-settings">
                    ...
                    <label class="field ms-field">${this.#H("cleaning_mode","Cleaning mode")}
                      <select aria-label=${this.#H("v4_room_cleaning_mode_named","Cleaning mode for {room}",{room:a})} .value=${i.coverageSetting} @change=${l=>this.#M(A,{coverageSetting:W(l)})}>${l5.map(l=>p`<option value=${l} ?selected=${l===i.coverageSetting}>${this.#r(l)}</option>`)}</select>
                    </label>
                  </div>
                `:s}
              </div>
        ...
        <div class="plan-options" role="group" aria-labelledby="completion-heading">
          <label class="plan-option">
            <input type="checkbox" .checked=${e.returnToBase} @change=${i=>this.#t({type:"patch-plan-draft",patch:{returnToBase:y0(i)}})}>
          ...
          <label class="plan-option">
            <input type="checkbox" .checked=${e.finishCurrentRoom} @change=${i=>this.#t({type:"patch-plan-draft",patch:{finishCurrentRoom:y0(i)}})}>
            <span class="plan-option-copy">
          ...
          ${e.finishCurrentRoom?p`
            <label class="plan-threshold ms-field">
              ...
              <input type="range" min="0" max="100" step="5" .value=${String(e.finishCurrentRoomThreshold)} aria-label=${this.#H("plan_threshold","Minimum room progress")} @input=${i=>this.#t({type:"patch-plan-draft",patch:{finishCurrentRoomThreshold:Number(W(i))}})}>
            </label>
          `:s}
        </div>
        <div class="toolbar">
    ...
    `}#v(){let H=this.state.areaDraft,V=H.canRebind||H.status==="review",e=!V&&(H.status==="stale"||H.status==="unknown");return p`
      <div class="stack">
        ...
        <label class="field ms-field">${this.#H("area_name","Area name")}
          <input maxlength="128" autocomplete="off" .value=${H.name} @input=${r=>this.#t({type:"patch-area-draft",patch:{name:W(r)}})}>
        </label>
        <div class="split">
          <label class="field ms-field">${this.#H("v4_cleaning_system","Cleaning system")}
            <select .value=${H.cleaningMode} @change=${r=>this.#t({type:"patch-area-draft",patch:{cleaningMode:W(r)}})}>${n5.map(r=>p`<option value=${r} ?selected=${r===H.cleaningMode}>${this.#V(r)}</option>`)}</select>
          </label>
          <label class="field ms-field">${this.#H("cleaning_mode","Cleaning mode")}
            <select .value=${H.coverageSetting} @change=${r=>this.#t({type:"patch-area-draft",patch:{coverageSetting:W(r)}})}>${l5.map(r=>p`<option value=${r} ?selected=${r===H.coverageSetting}>${this.#r(r)}</option>`)}</select>
          </label>
        </div>
        ...
        <div class="timeline">
          <label class="field ms-field">${this.#H("map_timeline_label","Map timeline")}
            <input
              ...
              ?disabled=${!r.length}
              @input=${i=>{let a=Number(W(i));this.#t({type:"set-history",historyId:a===r.length?null:r[a]?.id||null})}}
            >
          </label>
          <div class="list">
...
`),e=typeof navigator>"u"?void 0:navigator.clipboard;if(e&&typeof e.writeText=="function")try{await e.writeText(V),this.#S("copied");return}catch{}this.#S(this.#e(V,H instanceof HTMLElement?H:null)?"copied":"failed")}#f(){let H=this.#s(),V=this._copyStatus==="copied"?this.#H("v4_copied","Copied"):this._copyStatus==="failed"?this.#H("v4_copy_failed","The summary could not be copied. Select the text to copy it by hand."):"";return p`
    ...
    `}#U(H){let V=H.resources.plans.value?.rooms??H.resources.areas.value?.rooms??[];return H.selection.roomIds.map(e=>V.find(r=>r.roomId===e)?.name??e)}#D(H,V,e){let r=V?.enabled&&H.workflow==="rooms"&&V.id==="clean-rooms"?[this.#U(H).join(", "),H.planDraft.returnToBase?this.#C("v4_returns_to_dock","returns to the dock"):""].filter(Boolean).join(" \xB7 "):"";return u`
    ...
    `}#V1(H){let V=H.resources.history.value?.floors||[],e=V.length?V.map((r,t)=>({id:r.active?"current":r.id,label:`${r.label||(r.active?this.#C("v4_current_floor","Current floor"):this.#C("v4_saved_floor","Saved floor {number}",{number:r.ordinal??t+1}))}${!r.active&&r.snapshots.length===0?` \xB7 ${this.#C("v4_floor_not_captured","Visit floor to capture")}`:""}`,disabled:!r.active&&r.snapshots.length===0})):[{id:H.selection.floorId,label:H.floor.displayName,disabled:!1}];return u`
      ...
      `)}</select>
    `}#L1(H,V){let e=(S,O,g)=>this.#C(S,O,g),r=this.#G(e("v4_map_history","Map history"),r5,()=>this.#l("history"),e("v4_map_history_detail","Saved maps are floor-scoped and read only.")),t=this.#G(e("v4_map_diagnostics","Map diagnostics"),r0,()=>this.#l("support"),e("v4_map_support_detail","Private geometry is never included.")),{host:M}=H;if(!M.connected)return this.#I(e("v4_reconnecting_title","Reconnecting to Home Assistant"),e("v4_reconnecting_body","The last verified map stays read-only until the connection returns."));if(!M.administrator)return this.#I(e("v4_admin_title","Administrator access required"),e("v4_admin_body","Ask a Home Assistant administrator to open this map."));if(M.robotCount===0)return this.#I(e("v4_no_robot_title","No Matic robot set up"),e("v4_no_robot_body","Add the Matic integration to see a map here."),u`<a class="ms-btn ms-btn--secondary" href="/config/integrations/integration/matic_robot">${e("v4_open_integration","Open the Matic integration")}</a>`);if(!M.robotConnected)return u`
      ...
      `;let o=H.coherence==="verifying"||H.coherence==="booting",i=H.resources.plans,a=i.value,n=a!==null&&a.rooms.length===0,A=a?.plans.length??0,l=i.status==="loading",d=i.status==="error",m=o||n,x=o?e("v4_reason_locating","Waiting for the robot to confirm which floor it is on."):n?e("v4_no_rooms_reason","This floor has no named rooms yet."):null,h=o?e("v4_reason_locating","Waiting for the robot to confirm which floor it is on."):null,f=o?e("v4_reason_locating","Waiting for the robot to confirm which floor it is on."):e("v4_areas_quick_detail","Sketch a one-time zone on the map");return u`
          ...
          <div class="quick-actions" aria-label=${e("v4_cleaning_choices","Cleaning choices")}>
            ...
            >
              ...
              <span class="ms-row__body">
                ...
                <small>${x??e("v4_clean_rooms_hint","Choose rooms for this run")}</small>
              </span>
              <span class="ms-row__trail">${Z(i2)}</span>
            </button>
            <button
      ...
      `:s}
    `}#e1(H,V){return H.workflow==="none"?this.#L1(H,V):u`<${O0}
      .state=${H}
      .localize=${this.localize}
      @matic-workspace-intent=${this.#q}
    ></${O0}>`}#j(H,V){let e=w0(H,this.localize);return u`
    ...
    `}render(){let H=this.state,V=H.narrowHint||this._measuredNarrow,e=X7(H,this.localize),r=$2({...H,narrowHint:V}),t=k5(H),M=!V&&r.id==="stop"?r:!V&&t?.id==="stop"?t:null,o=M&&M===r?null:r,i=H.workflow==="draw"&&H.dataMode==="live"?{id:"clear-draft",label:"Clear drawing",labelKey:"v4_clear_drawing",kind:"neutral",enabled:H.draw.circles.length>0}:null,a=M&&M===t?null:t??i,n=H.fullMap&&(H.coherence==="verifying"||H.coherence==="booting"),A=H.fullMap||H.host.administrator&&H.host.robotCount>0&&H.map.available,l=V4(H.dialog,this.localize,H.workflow==="plan"),d=V&&!H.fullMap?`--map-sheet-offset:${this._sheetOffset}px`:"--map-sheet-offset:0px",m=V&&H.workflow==="draw",x=H.precisionOpen&&H.workflow==="draw";return u`
  ...
  `]}#C;#H;connectedCallback(){super.connectedCallback(),this.#H=this.#C.subscribe(H=>{this._workspace=H})}disconnectedCallback(){this.#H?.(),this.#H=null,super.disconnectedCallback()}willUpdate(H){H.has("scenario")?this.#C.replace({...z2(this.scenario),narrowHint:this.narrow}):H.has("narrow")&&this.#C.dispatch({type:"set-narrow-hint",value:this.narrow})}setScenario(H){N2.includes(H)&&(this.scenario=H)}getWorkspaceSnapshot(){return structuredClone(this.#C.value)}replaceWorkspaceState(H){this.#C.replace(structuredClone(H))}#V(H){u1(H.detail)&&(H.stopPropagation(),this.#C.dispatch(H.detail))}render(){return u`
      ${this.controls?u`
